...
{
	[TestFixture]
	public class BillingMessageHandlerV4Test : BillingMessageHandlerTestBase
	{
		...
		{
			Assert.IsTrue(e.Message.Contains("Billing transaction validation failed:") && e.Message.Contains("The element 'BillingTransaction' in namespace 'http://www.edi.com.au/EnterpriseService/#Billing_1.4' has invalid child element 'Invalid' in namespace 'http://www.edi.com.au/EnterpriseService/#Billing_1.4'"));
		}

		public override string SchemaName => "http://www.edi.com.au/EnterpriseService/#Billing_1.4";
