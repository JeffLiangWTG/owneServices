...
{
	[TestedType(typeof(DropTVP_GeneralLedgerDataToAddColumns))]
	sealed class DropTVP_GeneralLedgerDataToAddColumnsTest : DataTransformationTestCase
	{
		...
		{
			return new DropTVP_GeneralLedgerDataToAddColumns();
		}
