...
[TestedType(typeof(UseLossySystemEDIMessageNumberFountain))]
public class UseLossySystemEDIMessageNumberFountainTest : LossyNumberFountainTransformTest
{
	protected override LossyNumberFountainTransform GetLossyTransformationInstance()
	{
		return new UseLossySystemEDIMessageNumberFountain();
	}
}
