...
{
	[TestedType(typeof(InsertNctsPhase5DepartureRegisteredCusEntryNum))]
	public class InsertNctsPhase5DepartureRegisteredCusEntryNumTest : DataTransformationTestCase
	{
		public override string[] expectedIndex => new string[]
		{
			"NONCLUSTERED INDEX [_WTG__Insert Registered CusEntryNum for IE NCTS Departure Reports_1] ON [dbo].[EDIMessage] ([EM_MessageType], [EM_ApplicationCode], [EM_Status]) WHERE (([EM_MessageType] IN ('028', '043')) AND [EM_ApplicationCode]='IEN' AND [EM_Status]='PRS') WITH (ALLOW_PAGE_LOCKS = OFF, ONLINE = ON)"
		};
		...
		protected override void AssertPreConditions()
		{
			...
			AssertEquals("WTLILHDIE2400000046V01", resultList[0]);
		}
		...
		protected override void AssertTransformationResults()
		{
			...
			{
				Tuple.Create("TD-PRCHEA", "WTLILHDIE2400000045V01", new DateTime(2024, 6, 6, 17, 42, 0), "IE"),
				Tuple.Create("TD-PRCHEA", "WTLILHDIE2400000046V01", new DateTime(2024, 6, 6, 17, 44, 0), "IE"),
			}, resultList);
		}

		protected override DataTransformation GetNewTestTransformationInstance() => new InsertNctsPhase5DepartureRegisteredCusEntryNum();
...
DECLARE @PrincipalHeaderPK UNIQUEIDENTIFIER = NEWID();
INSERT INTO dbo.OrgHeader(OH_PK, OH_Code, OH_ISActive, OH_SystemCreateTimeUtc, OH_SystemCreateUser, OH_SystemLastEditTimeUtc, OH_SystemLastEditUser) VALUES (@PrincipalHeaderPK, 'PRCHEA', 1, '2024-06-06 12:12:00', 'AAA', '2024-06-06 12:12:00', 'AAA');
DECLARE @PrincipalAddressPK UNIQUEIDENTIFIER = NEWID();
INSERT INTO dbo.OrgAddress(OA_PK, OA_OH, OA_Code, OA_IsActive, OA_Address1, OA_RN_NKCountryCode, OA_SystemCreateTimeUtc, OA_SystemCreateUser, OA_SystemLastEditTimeUtc, OA_SystemLastEditUser) VALUES(@PrincipalAddressPK, @PrincipalHeaderPK, 'PRCADD', 1, 'Address Line 1', 'IE', '2024-06-06 12:12:00', 'AAA', '2024-06-06 12:12:00', 'AAA');
...
INSERT INTO dbo.CusInBondHeader(BH_PK, BH_GB, BH_ApplicationCode, BH_HeaderType, BH_SystemCreateTimeUtc, BH_SystemCreateUser, BH_SystemLastEditTimeUtc, BH_SystemLastEditUser)
	VALUES (@declarationPK1, @IEBranchPK, 'NC5', 'D', '2024-06-06 17:12:00', 'AAA', '2024-06-06 17:12:00', 'AAA');
DECLARE @MovementPK1 UNIQUEIDENTIFIER = NEWID();
INSERT INTO dbo.CusInBondMoveHeader(BM_PK, BM_BH, BM_SubApplicationCode, BM_PaperlessInbondNum, BM_SystemCreateTimeUtc, BM_SystemCreateUser, BM_SystemLastEditTimeUtc, BM_SystemLastEditUser)
	VALUES (@MovementPK1, @declarationPK1, 'D', 'WTLILHDIE2400000045V01', '2024-06-06 17:12:00', 'AAA', '2024-06-06 17:12:00', 'AAA');
INSERT INTO dbo.JobDocAddress(E2_PK, E2_IsValid, E2_AddressType, E2_OA_Address, E2_ParentID, E2_ParentTableCode, E2_SystemCreateTimeUtc, E2_SystemCreateUser, E2_SystemLastEditTimeUtc, E2_SystemLastEditUser)
	VALUES (NEWID(), 1, 'PRC', @PrincipalAddressPK, @declarationPK1, 'BH', '2024-06-06 17:12:00', 'AAA', '2024-06-06 17:12:00', 'AAA');
INSERT INTO dbo.EDIMessage(EM_PK, EM_IsActive, EM_ApplicationCode, EM_MessageType, EM_ReceiveTransmit, EM_Status, EM_LinkTable, EM_LinkUniqueID, EM_GB, EM_GE, EM_SystemCreateTimeUtc, EM_SystemCreateUser, EM_SystemLastEditTimeUtc, EM_SystemLastEditUser)
	VALUES (NEWID(), 1, 'IEN', '028', 'RCV', 'PRS', 'CusInBondMoveHeader', @MovementPK1, @IEBranchPK, @IEDepartmentPK, '2024-06-06 17:42:00', 'E', '2024-06-06 17:42:00', '~BP');

INSERT INTO dbo.CusInBondHeader(BH_PK, BH_GB, BH_ApplicationCode, BH_HeaderType, BH_SystemCreateTimeUtc, BH_SystemCreateUser, BH_SystemLastEditTimeUtc, BH_SystemLastEditUser)
	VALUES (@declarationPK2, @IEBranchPK, 'NC5', 'D', '2024-06-06 17:14:00', 'BBB', '2024-06-06 17:14:00', 'BBB');
DECLARE @MovementPK2 UNIQUEIDENTIFIER = NEWID();
INSERT INTO dbo.CusInBondMoveHeader(BM_PK, BM_BH, BM_SubApplicationCode, BM_PaperlessInbondNum, BM_SystemCreateTimeUtc, BM_SystemCreateUser, BM_SystemLastEditTimeUtc, BM_SystemLastEditUser)
	VALUES (@MovementPK2, @declarationPK2, 'D', 'WTLILHDIE2400000046V01', '2024-06-06 17:14:00', 'BBB', '2024-06-06 17:14:00', 'BBB');
INSERT INTO dbo.JobDocAddress(E2_PK, E2_IsValid, E2_AddressType, E2_OA_Address, E2_ParentID, E2_ParentTableCode, E2_SystemCreateTimeUtc, E2_SystemCreateUser, E2_SystemLastEditTimeUtc, E2_SystemLastEditUser)
	VALUES (NEWID(), 1, 'PRC', @PrincipalAddressPK, @declarationPK2, 'BH', '2024-06-06 17:14:00', 'AAA', '2024-06-06 17:14:00', 'AAA');
INSERT INTO dbo.EDIMessage(EM_PK, EM_IsActive, EM_ApplicationCode, EM_MessageType, EM_ReceiveTransmit, EM_Status, EM_LinkTable, EM_LinkUniqueID, EM_GB, EM_GE, EM_SystemCreateTimeUtc, EM_SystemCreateUser, EM_SystemLastEditTimeUtc, EM_SystemLastEditUser)
	VALUES (NEWID(), 1, 'IEN', '028', 'RCV', 'PRS', 'CusInBondMoveHeader', @MovementPK2, @IEBranchPK, @IEDepartmentPK, '2024-06-06 17:44:00', 'E', '2024-06-06 17:44:00', '~BP');
INSERT INTO dbo.CusEntryNum(CE_PK, CE_IsValid, CE_ParentID, CE_ParentTable, CE_EntryNum, CE_Category, CE_EntryType, CE_EntryLineReference, CE_IssueDate, CE_RN_NKCountryCode, CE_SystemCreateTimeUtc, CE_SystemCreateUser, CE_SystemLastEditTimeUtc, CE_SystemLastEditUser)
	VALUES (NEWID(), 1, @declarationPK2, 'CusInBondHeader', 'WTLILHDIE2400000046V01', 'CUS', 'REG', 'TD-PRCHEA', '2024-06-06 17:44:00', 'IE', '2024-06-06 17:44:00', 'E', '2024-06-06 17:44:00', '~BP');
";
