...
{
	[TestedType(typeof(ConvertJobServiceCompletedDateTimeToDateTimeOffset))]
	class ConvertJobServiceCompletedDateTimeToDateTimeOffsetTest : ConvertDateTimeToDateTimeOffsetTransformTestCase
	{
		protected override void PrepareTestData()
		{
			...
			new JobServiceOld_V01("WD", docketJobParent.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0), ES_OA_Location = address.PK }.AppendInsertAndReturnObject(sql);
		...
		{
			AssertEquals(new DateTimeOffset(2024, 6, 6, 0, 0, 0, TimeSpan.FromHours(10)), TestConnection.ExecuteScalar("SELECT ES_CompletedDateTimeOffset FROM JobService"));
		}

		public void TestUserDescription()
		{
			AssertEquals("Convert JobService ES_Completed DateTime to DateTimeOffset and store the new value as ES_CompletedDateTimeOffset.", GetNewTestTransformationInstance().UserDescription);
		}

		public void TestNoCompletedDate()
		{
			var sql = new SqlQueryBuilder();
			var branch = new GlbBranch("BR1") { GB_RL_NKHomePort = "AUSYD" }.InsertAndReturnObject(TestConnection);
			var whs = new WhsWarehouse("WHS", "PRW", branch.PK).WithDockDoor(TestConnection);
			...
			JobService.AssertFromDB(TestConnection, jobService.PK)
				.ExpectEquals("ES_CompletedDateTimeOffset should be equal.", d => d.ES_CompletedDateTimeOffset.HasValue, false)
				.VerifyAll();
		}
		...
		public void TestNoServiceLocation_DocketParent()
		{
			...
			var client = new OrgHeader("Client").AppendInsertAndReturnObject(sql);
			var docketJobParent = new WhsDocket(client.PK, whs.PK, "INW", "REC", "ENT", "R1").AppendInsertAndReturnObject(sql);
			var jobService = new JobServiceOld_V01("WD", docketJobParent.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_VASOrderParent()
		{
			...
			var jobService = new JobServiceOld_V01("WVO", vasOrder.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_AdHocServiceJobParent()
		{
			...
			var jobService = new JobServiceOld_V01("WSJ", adHocServiceJob.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_DtbConsignmentParent()
		{
			...
			var jobService = new JobServiceOld_V01("LTC", dtbConsignment.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_DtbConsignmentRunSheetParent()
		{
			...
			var jobService = new JobServiceOld_V01("KG", dtbConsignmentRunSheet.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_DtbBookingParent()
		{
			...
			var jobService = new JobServiceOld_V01("KM", booking.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_WhsItemDispatchConsignmentParent()
		{
			...
			var jobService = new JobServiceOld_V01("WDC", whsItemDispatchConsignment.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_WhsItemReceiveConsignmentParent()
		{
			...
			var jobService = new JobServiceOld_V01("WRC", whsItemReceiveConsignment.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_JobBookedCtgMoveParent()
		{
			...
			var jobService = new JobServiceOld_V01("EW", jobBookedCtgMove.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_CusInBondHeaderParent()
		{
			...
			var jobService = new JobServiceOld_V01("BH", cusInBondHeader.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_JobContainerParent()
		{
			...
			var jobService = new JobServiceOld_V01("JC", jobContainer.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
			...
			AssertEquals(new DateTimeOffset(2024, 6, 6, 0, 0, 0, TimeSpan.FromHours(0)), TestConnection.ExecuteScalar("SELECT ES_CompletedDateTimeOffset FROM JobService"));
		}
		...
		public void TestNoServiceLocation_CusContainerParent()
		{
			...
			var jobService = new JobServiceOld_V01("CO", container.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_WorkItemParent()
		{
			...
			var jobService = new JobServiceOld_V01("WKI", workItem.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		public void TestNoServiceLocation_JobDocsAndCartageParent()
		{
			...
			var jobService = new JobServiceOld_V01("JP", jobDocsAndCartage.PK, "FUM") { ES_Completed = new DateTime(2024, 6, 6, 0, 0, 0) }.AppendInsertAndReturnObject(sql);
		...
		protected override SchemaDateTimeColumn GetSourceDateTimeColumn() => JobServiceSchema.ES_Completed;

		protected override SchemaDateTimeOffsetColumn GetDateTimeOffsetColumnToConvert() => JobServiceSchema.ES_CompletedDateTimeOffset;

		protected override DataTransformation GetNewTestTransformationInstance() => new ConvertJobServiceCompletedDateTimeToDateTimeOffset();
