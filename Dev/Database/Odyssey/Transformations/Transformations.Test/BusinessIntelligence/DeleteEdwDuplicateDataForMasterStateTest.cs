...
{
	[TestedType(typeof(DeleteEdwDuplicateDataForMasterState))]
	class DeleteEdwDuplicateDataForMasterStateTest : EdwDataTransformationTestCase
	{
		protected override DataTransformation GetNewTestTransformationInstance() =>
			new DeleteEdwDuplicateDataForMasterState();
