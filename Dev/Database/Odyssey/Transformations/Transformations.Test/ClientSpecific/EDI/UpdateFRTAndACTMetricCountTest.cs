...
{
	[TestedType(typeof(UpdateFRTAndACTMetricCount))]
	class UpdateFRTAndACTMetricCountTest : DataTransformationTestCase
	{
		protected override DataTransformation GetNewTestTransformationInstance()
		{
			return new UpdateFRTAndACTMetricCount();
		}

		protected override void AssertTransformationResults()
		{
			var resultQuery = $"SELECT IME_MetricCount FROM dbo.IncidentMetrics WHERE IME_PK = '{incidentMetricsGuids[0]}'";
			var result = Db.Connection.ExecuteScalar(resultQuery);
			AssertEquals("IME_MetricCount should be updated to 1", 1, result);

			resultQuery = $"SELECT IME_MetricCount FROM dbo.IncidentMetrics WHERE IME_PK = '{incidentMetricsGuids[1]}'";
			...
			result = Db.Connection.ExecuteScalar(resultQuery);
			AssertEquals("IME_MetricCount should not be updated because IME_CalculatedMetric is 0", 3, result);
		}
...
VALUES
('{incidentMetricsGuids[0]}', 'FRT', 'CS99990001', '2025-01-01 12:00:00', '2025-01-01 12:00:00', 3600, 0, '2025-01-01 12:00:00', 'E', '2025-01-01 13:00:00.000', 'E'),
('{incidentMetricsGuids[1]}', 'FRT', 'CS99990002', '2025-01-01 14:00:00', '2025-01-01 15:00:00', 3600, 2, '2025-01-01 14:00:00', 'E', '2025-01-01 15:00:00.000', 'E'),
('{incidentMetricsGuids[2]}', 'ACT', 'CS99990003', '2025-01-01 16:00:00', '2025-01-01 17:00:00', 3600, 0, '2025-01-01 16:00:00', 'E', '2025-01-01 17:00:00.000', 'E'),
('{incidentMetricsGuids[3]}', 'ACT', 'CS99990004', '2025-01-01 18:00:00', '2025-01-01 19:00:00', 0, 3, '2025-01-01 18:00:00', 'E', '2025-01-01 19:00:00.000', 'E')
";
