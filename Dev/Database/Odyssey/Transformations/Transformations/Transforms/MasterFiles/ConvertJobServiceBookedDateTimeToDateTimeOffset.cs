...
{
	public class ConvertJobServiceBookedDateTimeToDateTimeOffset : ConvertDateTimeToDateTimeOffsetTransform
	{
		public override string UserDescription => "Convert JobService ES_Booked DateTime to DateTimeOffset and store the new value as ES_BookedDateTimeOffset.";

		protected override SchemaDateTimeOffsetColumn ColumnToConvert => JobServiceSchema.ES_BookedDateTimeOffset;

		protected override SchemaDateTimeColumn SourceColumn => JobServiceSchema.ES_Booked;
