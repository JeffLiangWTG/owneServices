...
{
	sealed class RestrictedWriterConnectionTest : TestCase
	{
		public void TestConstructor()
		{
			// Arrange
			// Act
			using (var connection = RestrictedWriterConnection.New("whatever"))
			{
				// Assert
		...
		public void TestExtraConstructor()
		{
			// Arrange
			// Act
			using (var connection = RestrictedWriterConnection.New(Db.ServerName, Db.DatabaseName, "whatever"))
			{
				// Assert
				AssertEquals(Db.ServerName, connection.ServerName);
				AssertEquals(Db.DatabaseName, connection.CurrentDatabase);
		...
		public void TestWriterPermission()
		{
			// Arrange
			// Act
			using (var connection = RestrictedWriterConnection.New())
			{
				// Assert
