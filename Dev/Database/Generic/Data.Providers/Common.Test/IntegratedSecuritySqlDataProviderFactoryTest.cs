...
namespace CargoWise.Data.Providers.Common.Test
{
	...
	class IntegratedSecuritySqlDataProviderFactoryForTest : IntegratedSecuritySqlDataProviderFactory
	{
	...
	public class IntegratedSecuritySqlDataProviderFactoryTest
	{
		readonly IntegratedSecuritySqlDataProviderFactory dataProviderFactory = new IntegratedSecuritySqlDataProviderFactoryForTest();

		[Test]
		public void TestSqlDataProviderFactoryConnection()
		{
			var connection = dataProviderFactory.OpenNewDbConnection("sdpftServer", "sdpftDb", "sdpftLogin", "sdpftPwd", "sdpftApp", 10, false, 0, 0, 0);
