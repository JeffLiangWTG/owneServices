...
{
	[TestedType(typeof(GlbEmploymentLocation_WithManaged))]
	class GlbEmploymentLocation_WithManagedTest : ManagedTypeTest<GlbEmploymentLocationSchema>
	{
		protected override string StaffFKColumnName => "GEL_GS_Staff";
...
INSERT INTO dbo.GlbEmploymentLocation
	(GEL_PK, GEL_GS_Staff, GEL_EffectiveDate, GEL_Address1, GEL_Address2, GEL_City, GEL_State, GEL_PostCode, GEL_RN_NKCountryCode, GEL_ValidationStatus, GEL_SystemCreateTimeUtc, GEL_SystemCreateUser, GEL_SystemLastEditTimeUtc, GEL_SystemLastEditUser, GEL_LocationSource, GEL_GB_SourceBranch, GEL_AutoEffectiveEndDate, GEL_OA_SourceOrgAddress)
VALUES
	(NEWID(), @staff0, '2021-06-27 00:00:00', 'Address 11', '', '', '', '', 'AU', 'NYV', GETDATE(), 'E', GETDATE(), 'E', 'WFH', NULL, NULL, NULL),
	(NEWID(), @staff1, '2021-09-09 00:00:00', 'Address 12', '', '', '', '', 'JP', 'NYV', GETDATE(), 'E', GETDATE(), 'E', 'WFH', NULL, NULL, NULL),
	(NEWID(), @staff2, '2021-09-02 00:00:00', 'Address 13', '', '', '', '', 'US', 'NYV', GETDATE(), 'E', GETDATE(), 'E', 'WFH', NULL, NULL, NULL),
	(NEWID(), @staff3, '2021-02-12 00:00:00', 'Address 14', '', '', '', '', 'BR', 'NYV', GETDATE(), 'E', GETDATE(), 'E', 'WFH', NULL, NULL, NULL);
",
		p =>
		{
			...
			expectedColumns.AddRange(["GEL_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
