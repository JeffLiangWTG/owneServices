...
{
	[TestedType(typeof(GlbStaffRemuneration_WithManaged))]
	class GlbStaffRemuneration_WithManagedTest : ManagedTypeTest<GlbStaffRemunerationSchema>
	{
		protected override string StaffFKColumnName => "GSR_GS_Staff";
...
INSERT INTO hrm.GlbStaffRemuneration
	(GSR_PK, GSR_GS_Staff, GSR_FullTimeEquivalent, GSR_RN_NKCountry, GSR_RX_NKCurrency, GSR_SystemCreateUser, GSR_SystemLastEditUser, GSR_EffectiveDate, GSR_SystemCreateTimeUtc, GSR_SystemLastEditTimeUtc, GSR_AutoEffectiveEndDate, GSR_LeaveLiabilityHourlyRate)
VALUES
	(NEWID(), @staff0, 0.0, 'AU', 'AUD', 'E', 'E', '2021-07-15 00:00:00', GETDATE(), GETDATE(), NULL, 1),
	(NEWID(), @staff1, 0.0, 'CN', 'CNY', 'E', 'E', '2021-08-18 00:00:00', GETDATE(), GETDATE(), NULL, 2),
	(NEWID(), @staff2, 0.0, 'JP', 'JPY', 'E', 'E', '2021-04-13 00:00:00', GETDATE(), GETDATE(), NULL, 2.2),
	(NEWID(), @staff3, 0.0, 'US', 'USD', 'E', 'E', '2021-01-08 00:00:00', GETDATE(), GETDATE(), NULL, 3);
",
		p =>
		{
			...
			expectedColumns.AddRange(["GSR_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
		...
		public void TestCannotExecuteIfLoginHasNoPermission()
		{
			...
			AssertExceptionThrown(typeof(SqlException), "The SELECT permission was denied on the object 'GlbStaffRemuneration_WithManaged', database '" + TestConnection.CurrentDatabase + "', schema 'hrm'.",
