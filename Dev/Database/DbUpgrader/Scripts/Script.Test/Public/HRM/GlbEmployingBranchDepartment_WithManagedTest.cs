...
{
	[TestedType(typeof(GlbEmployingBranchDepartment_WithManaged))]
	class GlbEmployingBranchDepartment_WithManagedTest : ManagedTypeTest<GlbEmployingBranchDepartmentSchema>
	{
		protected override string StaffFKColumnName => "GHB_GS_Staff";
...
VALUES
	(@company, 'DAN', 'AU company', 'AU', 'AUD');

INSERT INTO dbo.GlbBranch (GB_PK, GB_GC, GB_IsActive, GB_Code, GB_BranchName)
VALUES
	(@branch, @company, 1, 'BR1', 'Branch1');
...
INSERT INTO dbo.GlbEmployingBranchDepartment
	(GHB_PK, GHB_GS_Staff, GHB_EffectiveDate, GHB_GE_Department, GHB_GB_Branch, GHB_SystemCreateTimeUtc, GHB_SystemCreateUser, GHB_SystemLastEditTimeUtc, GHB_SystemLastEditUser, GHB_AutoEffectiveEndDate)
VALUES
	(NEWID(), @staff0, '2021-09-03 00:00:00', NULL, @branch, GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff1, '2021-03-18 00:00:00', NULL, @branch, GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff2, '2021-06-24 00:00:00', NULL, @branch, GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff3, '2021-02-08 00:00:00', NULL, @branch, GETDATE(), 'E', GETDATE(), 'E', NULL);
",
		p =>
		{
			p.AddParameter("@company", SqlDbType.UniqueIdentifier, company);
			p.AddParameter("@branch", SqlDbType.UniqueIdentifier, branch);
			...
			expectedColumns.AddRange(["GHB_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
