...
{
	[TestedType(typeof(GlbStaffHolidayProcessTasks_WithManaged))]
	class GlbStaffHolidayProcessTasks_WithManagedTest : DbCreateScriptTest
	{
...
INSERT INTO dbo.GlbStaff (GS_PK, GS_Code, GS_LoginName, GS_SystemCreateTimeUtc, GS_SystemLastEditTimeUtc, GS_SystemCreateUser, GS_SystemLastEditUser)
VALUES
	(@staff0, 'S00', 'Staff00', GETDATE(), GETDATE(), 'E', 'E'),
	(@staff1, 'S01', 'Staff01', GETDATE(), GETDATE(), 'E', 'E'),
	(@staff2, 'S02', 'Staff02', GETDATE(), GETDATE(), 'E', 'E'),
	(@staff3, 'S03', 'Staff03', GETDATE(), GETDATE(), 'E', 'E');
...
INSERT INTO dbo.GlbStaffHoliday
	(GA_PK, GA_GS, GA_WorkHolidayType, GA_ApprovalStatus, GA_StartTime, GA_EndTime, GA_SystemCreateTimeUtc, GA_SystemLastEditTimeUtc, GA_SystemCreateUser, GA_SystemLastEditUser)
VALUES
	(@leave0, @staff0, 'ANN', 'APP', '2020-01-01 01:00:00', '2020-01-11 01:00:00', GETDATE(), GETDATE(), 'E', 'E'),
	(@leave1, @staff1, 'ANN', 'APP', '2020-02-01 11:00:00', '2020-02-11 01:00:00', GETDATE(), GETDATE(), 'E', 'E'),
	(@leave2, @staff2, 'ANN', 'APP', '2020-03-01 03:00:00', '2020-03-11 01:00:00', GETDATE(), GETDATE(), 'E', 'E'),
	(@leave3, @staff3, 'ANN', 'APP', '2020-04-01 17:00:00', '2020-04-11 01:00:00', GETDATE(), GETDATE(), 'E', 'E');
...
VALUES
	...
	(NEWID(), @staff1, 'GS', 'APP');
			...
			using (var command = TestConnection.Command($"SELECT * FROM dbo.ProcessTasks WHERE P9_ParentTableCode = '{GlbStaffHolidaySchema.Constants.Prefix}'"))
			{
		...
		{
			using (var command = TestConnection.Command($"SELECT * FROM GlbStaffHolidayProcessTasks_WithManaged(@loggedInStaff, @managerTypes, @effectiveAsAt)"))
			{
