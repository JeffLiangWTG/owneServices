...
{
	[TestedType(typeof(GlbWorkPattern_WithManaged))]
	class GlbWorkPattern_WithManagedTest : ManagedTypeTest<GlbWorkPatternSchema>
	{
		protected override string StaffFKColumnName => "GWP_GS_Staff";
...
INSERT INTO dbo.GlbWorkPattern
	(GWP_PK, GWP_GS_Staff, GWP_Name, GWP_Comment, GWP_EffectiveDate, GWP_StandardDuration, GWP_SystemCreateTimeUtc, GWP_SystemCreateUser, GWP_SystemLastEditTimeUtc, GWP_SystemLastEditUser, GWP_GCR_ChangeRequest, GWP_IsApproved)
VALUES
	(NEWID(), @staff0, 'Work Pattern 1', 'Comment A', '2021-09-17 00:00:00', 1, GETDATE(), 'E', GETDATE(), 'E', NULL, 0),
	(NEWID(), @staff1, 'Work Pattern 2', 'Comment B', '2021-06-15 00:00:00', 2, GETDATE(), 'E', GETDATE(), 'E', NULL, 0),
	(NEWID(), @staff2, 'Work Pattern 3', 'Comment C', '2021-07-22 00:00:00', 3, GETDATE(), 'E', GETDATE(), 'E', NULL, 0),
	(NEWID(), @staff3, 'Work Pattern 4', 'Comment D', '2021-10-14 00:00:00', 4, GETDATE(), 'E', GETDATE(), 'E', NULL, 0);
",
		p =>
		{
			...
			expectedColumns.AddRange(["GWP_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
