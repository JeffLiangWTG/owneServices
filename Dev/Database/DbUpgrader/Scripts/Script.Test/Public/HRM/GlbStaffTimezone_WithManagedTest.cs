...
{
	[TestedType(typeof(GlbStaffTimezone_WithManaged))]
	class GlbStaffTimezone_WithManagedTest : ManagedTypeTest<GlbStaffTimezoneSchema>
	{
		protected override string StaffFKColumnName => "GSZ_GS_Staff";
...
INSERT INTO dbo.GlbStaffTimezone
	(GSZ_PK, GSZ_IsValid, GSZ_GS_Staff, GSZ_EffectiveDate, GSZ_AutoEffectiveEndDate, GSZ_R3_NKTimeZoneSetName, GSZ_SystemCreateTimeUtc, GSZ_SystemCreateUser, GSZ_SystemLastEditTimeUtc, GSZ_SystemLastEditUser)
VALUES
	(NEWID(), 0, @staff0, '2021-08-04 00:00:00', NULL, 'TZ1', GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), 0, @staff1, '2021-04-20 00:00:00', NULL, 'TZ2', GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), 0, @staff2, '2021-10-16 00:00:00', NULL, 'TZ3', GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), 0, @staff3, '2021-03-12 00:00:00', NULL, 'TZ4', GETDATE(), 'E', GETDATE(), 'E');
",
		p =>
		{
			...
			expectedColumns.AddRange(["GSZ_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
