...
{
	[TestedType(typeof(HrlStaffPolicy_WithManaged))]
	class HrlStaffPolicy_WithManagedTest : ManagedTypeTest<HrlStaffPolicySchema>
	{
		protected override string StaffFKColumnName => "LLS_GS_Staff";
...
INSERT INTO dbo.HrlStaffPolicy
	(LLS_PK, LLS_EffectiveDate, LLS_AutoEffectiveEndDate, LLS_GS_Staff, LLS_LLP_Policy, LLS_SystemCreateTimeUtc, LLS_SystemCreateUser, LLS_SystemLastEditTimeUtc, LLS_SystemLastEditUser)
VALUES
	(NEWID(), '2021-03-12 00:00:00', NULL, @staff0, NULL, GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), '2021-04-16 00:00:00', NULL, @staff1, NULL, GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), '2021-09-24 00:00:00', NULL, @staff2, NULL, GETDATE(), 'E', GETDATE(), 'E'),
	(NEWID(), '2021-11-03 00:00:00', NULL, @staff3, NULL, GETDATE(), 'E', GETDATE(), 'E');
",
		p =>
		{
			...
			expectedColumns.AddRange(["LLS_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
