...
{
	[TestedType(typeof(HRMStaffHistoryCompact))]
	class HRMStaffHistoryCompactTest : DbCreateScriptTest
	{
...
VALUES
	...
	(NEWID(), @staff1, '2015-06-20 10:05:23', 'WFO', @benBranch3PK, '73 ORiordan Street', 'AlexandriTwo', 'Sydney', 'NSW', '2016', 'AU', 'MAN', GETUTCDATE(), 'E', GETUTCDATE(), 'E');
		...
		DataTable Execute()
		{
			using (var command = TestConnection.Command($"SELECT * FROM hrm.HRMStaffHistoryCompact"))
			{
