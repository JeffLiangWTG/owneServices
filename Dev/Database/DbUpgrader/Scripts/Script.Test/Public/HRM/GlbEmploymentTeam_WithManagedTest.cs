...
{
	[TestedType(typeof(GlbEmploymentTeam_WithManaged))]
	class GlbEmploymentTeam_WithManagedTest : ManagedTypeTest<GlbEmploymentTeamSchema>
	{
		protected override string StaffFKColumnName => "GET_GS_Staff";
...
INSERT INTO dbo.GlbEmploymentTeam
	(GET_PK, GET_GS_Staff, GET_EffectiveDate, GET_SystemCreateTimeUtc, GET_SystemCreateUser, GET_SystemLastEditTimeUtc, GET_SystemLastEditUser, GET_AutoEffectiveEndDate, GET_GST_NKTeamCode, GET_GCR_ChangeRequest, GET_IsApproved)
VALUES
	(NEWID(), @staff0, '2021-01-21 00:00:00', GETDATE(), 'E', GETDATE(), 'E', NULL, 'DEV', NULL, 0),
	(NEWID(), @staff1, '2021-07-10 00:00:00', GETDATE(), 'E', GETDATE(), 'E', NULL, 'HRM', NULL, 0),
	(NEWID(), @staff2, '2021-11-04 00:00:00', GETDATE(), 'E', GETDATE(), 'E', NULL, 'COR', NULL, 0),
	(NEWID(), @staff3, '2021-03-01 00:00:00', GETDATE(), 'E', GETDATE(), 'E', NULL, 'TM1', NULL, 0);
",
		p =>
		{
			...
			expectedColumns.AddRange(["GET_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
