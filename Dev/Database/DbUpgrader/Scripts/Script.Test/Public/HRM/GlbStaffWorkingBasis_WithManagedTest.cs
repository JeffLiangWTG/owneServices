...
{
	[TestedType(typeof(GlbStaffWorkingBasis_WithManaged))]
	class GlbStaffWorkingBasis_WithManagedTest : ManagedTypeTest<GlbStaffWorkingBasisSchema>
	{
		protected override string StaffFKColumnName => "GSW_GS_Staff";
...
INSERT INTO hrm.GlbStaffWorkingBasis
	(GSW_PK, GSW_GS_Staff, GSW_EffectiveDate, GSW_WorkingBasis, GSW_SystemCreateTimeUtc, GSW_SystemCreateUser, GSW_SystemLastEditTimeUtc, GSW_SystemLastEditUser, GSW_AutoEffectiveEndDate)
VALUES
	(NEWID(), @staff0, '2021-08-04 00:00:00', 'CAS', GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff1, '2021-04-20 00:00:00', 'CTR', GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff2, '2021-10-16 00:00:00', 'PER', GETDATE(), 'E', GETDATE(), 'E', NULL),
	(NEWID(), @staff3, '2021-03-12 00:00:00', 'STU', GETDATE(), 'E', GETDATE(), 'E', NULL);
",
		p =>
		{
			...
			expectedColumns.AddRange(["GSW_AutoVersion", "IsSelf", "IsManaged1", "IsManaged2", "IsManaged3"]);
		...
		public void TestCannotExecuteIfLoginHasNoPermission()
		{
			...
			AssertExceptionThrown(typeof(SqlException), "The SELECT permission was denied on the object 'GlbStaffWorkingBasis_WithManaged', database '" + TestConnection.CurrentDatabase + "', schema 'hrm'.",
