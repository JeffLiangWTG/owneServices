...
{
	[TestedType(typeof(vw_GetDisableFkScripts))]
	class vw_GetDisableFkScriptsTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			AssertEquals("StmALog reference count", "ALTER TABLE [dbo].[StmNumberCache] NOCHECK CONSTRAINT [StmNumberCache_SG_SN_FK2_StmNums_CRR_120N];", command);
		}
	}
}
