...
{
	[TestedType(typeof(vw_GetDisableTriggerScripts))]
	class vw_GetDisableTriggerScriptsTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			AssertEquals("TG_CP_INS_StmALogQueue trigger", "ALTER TABLE [dbo].[StmALog] DISABLE TRIGGER [TG_CP_INS_StmALogQueue]", command);
		}
	}
}
