...
{
	[TestedType(typeof(WhsStockOnHandSummaryReport))]
	class WhsStockOnHandSummaryReportTest : DbCreateScriptTest
	{
		...
		public void TestNoArithmeticOverflowExceptionThrown_WhenStockOnHandIsMassive()
		{
			...
			AssertEquals("Total Client Units should return 0, since Stock on Hand is too large to calculate Conversion.", 0m, TestConnection.ExecuteScalar("SELECT TotalClientUnits FROM WhsStockOnHandSummaryReport(null)"));
		}
		#endregion
	}
}
