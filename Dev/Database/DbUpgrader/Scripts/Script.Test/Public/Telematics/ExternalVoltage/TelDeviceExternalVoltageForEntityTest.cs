...
{
	[TestedType(typeof(TelDeviceExternalVoltageForEntity))]
	class TelDeviceExternalVoltageForEntityTest : TelDeviceMarksForEntityTestBase
	{
		...
		{
			return $@"SELECT * FROM dbo.TelDeviceExternalVoltageForEntity('RQ', '{entityPk}', '2017-01-15', '2017-02-15') ORDER BY GDV_MeasurementTimeUtc";
		}
