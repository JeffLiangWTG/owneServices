...
{
	[TestedType(typeof(fn_NVPMGetNumberOfInvoices))]
	class fn_NVPMGetNumberOfInvoicesTest : DbCreateScriptTest
	{
		public void Testfn_NVPMGetNumberOfInvoices()
		{
			var insertSql = @"
...
INSERT INTO dbo.AccTransactionHeader (AH_PK, AH_TransactionNum, AH_Ledger, AH_TransactionType, AH_GC, AH_GB, AH_GE, AH_OH, AH_DueDate, AH_InvoiceDate, AH_InvoiceAmount, AH_OutstandingAmount) 
VALUES 
	(newid(), '001', 'AR', 'INV', @SydneyCompanyPK, @SydneyBranchPK, @DepartmentPK, @MelbourneOrgPK, '2017-2-2', '2017-2-2', 100, 0),
	(newid(), '002', 'AR', 'INV', @SydneyCompanyPK, @SydneyBranchPK, @DepartmentPK, @GoldCoastOrgPK, '2017-2-1', '2017-2-2', 200, 0),
	(newid(), '003', 'AR', 'INV', @SydneyCompanyPK, @SydneyBranchPK,  @DepartmentPK, @BrisbaneOrgPK, '2017-2-10', '2017-2-2', 300, 0),

	(newid(), '004', 'AR', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @SydneyOrgPK, '2017-2-1', '2017-2-2', 400, 0),
	(newid(), '005', 'AR', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @GoldCoastOrgPK, '2017-2-1', '2017-2-2', 500, 0),
	(newid(), '006', 'AR', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @BrisbaneOrgPK, '2017-2-1', '2017-2-2', 600, 0),

	(newid(), '007', 'AR', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @SydneyOrgPK, '2017-2-1', '2017-2-2', 700, 0),
	(newid(), '008', 'AR', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @MelbourneOrgPK, '2017-2-1', '2017-2-2', 800, 0),
	(newid(), '009', 'AR', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @BrisbaneOrgPK, '2017-2-1', '2017-2-2', 900, 0),


	(newid(), '001', 'AP', 'INV', @SydneyCompanyPK, @SydneyBranchPK, @DepartmentPK, @MelbourneOrgPK, '2017-2-2', '2017-2-2', 100, 0),
	(newid(), '002', 'AP', 'INV', @SydneyCompanyPK, @SydneyBranchPK, @DepartmentPK, @GoldCoastOrgPK, '2017-2-1', '2017-2-2', 200, 0),
	(newid(), '003', 'AP', 'INV', @SydneyCompanyPK, @SydneyBranchPK,  @DepartmentPK, @BrisbaneOrgPK, '2017-2-10', '2017-2-2', 300, 0),

	(newid(), '004', 'AP', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @SydneyOrgPK, '2017-2-1', '2017-2-2', 400, 0),
	(newid(), '005', 'AP', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @GoldCoastOrgPK, '2017-2-1', '2017-2-2', 500, 0),
	(newid(), '006', 'AP', 'INV', @MelbourneCompanyPK, @MelbourneBranchPK, @DepartmentPK, @BrisbaneOrgPK, '2017-2-1', '2017-2-2', 600, 0),

	(newid(), '007', 'AP', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @SydneyOrgPK, '2017-2-1', '2017-2-2', 700, 0),
	(newid(), '008', 'AP', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @MelbourneOrgPK, '2017-2-1', '2017-2-2', 800, 0),
	(newid(), '009', 'AP', 'INV', @BrisbaneCompanyPK, @BrisbaneBranchPK, @DepartmentPK, @BrisbaneOrgPK, '2017-2-1', '2017-2-2', 900, 0)
";

			TestConnection.ExecuteNonQuery(insertSql);

			var sqlQuery = "SELECT * FROM fn_NVPMGetNumberOfInvoices(@CompanyPKs, @Ledger, @StartDate, @EndDate, @NettingCompanyPK, @IsReciprocal)";
...
---------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- --------------------------------------- ---------------------------------------
BNE        NULL                                    1                                       1                                       NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL
MEL        2                                       NULL                                    1                                       NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL
SYD        2                                       1                                       NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL                                    NULL
";
			var testHelper = new TestDbHelperBase(TestConnection);
			testHelper.AssertTableAsTextFromSQLServerManagenentStudio("AR transactions", result, expectedResult, new List<string>() { });
