...
{
	[TestedType(typeof(NettingLineToLineLevelMatchWithoutGroupingByJobReference))]
	class NettingLineToLineLevelMatchWithoutGroupingByJobReferenceTest : DbCreateScriptTest
	{
