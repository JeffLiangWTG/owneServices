...
{
	[TestedType(typeof(NettingReceivableLineToPayableLineReferenceLevelMatch))]
	class NettingReceivableLineToPayableLineReferenceLevelMatchTest : DbCreateScriptTest
	{
