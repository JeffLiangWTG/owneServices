...
namespace Enterprise.Build.Database.Script.Public.Accounting.Testing
{
	...
	class NetARAgedBaseTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			DataTable result = DataUtils.GetDataTableFromQuery(TestConnection, "select * from NetARAgedBase (200605,'878D7ACA-FFC3-49FC-9710-969CA0C0F2AC','FDD429D2-648C-4895-8F9F-06E90DED2BE5','','')");
