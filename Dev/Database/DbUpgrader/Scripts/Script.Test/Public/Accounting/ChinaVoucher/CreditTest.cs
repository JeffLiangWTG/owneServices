...
{
	[TestedType(typeof(Credit))]
	class CreditTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			using (var cmd = TestConnection.Command("SELECT [Value] FROM [dbo].[Credit](@Ledger, @TransactionType, @ReportType, @Amount)"))
			{
