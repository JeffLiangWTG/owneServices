...
{
	[TestedType(typeof(ForeignDebit))]
	class ForeignDebitTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			using (var cmd = TestConnection.Command("SELECT [Value] FROM [dbo].[ForeignDebit](@Ledger, @TransactionType, @CompanyCurrency, @TransactionCurrency, @ReportType, @Amount)"))
			{
