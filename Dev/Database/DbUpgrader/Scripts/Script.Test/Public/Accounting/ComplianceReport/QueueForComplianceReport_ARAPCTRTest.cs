...
{
	[TestedType(typeof(QueueForComplianceReport_ARAPCTR))]
	class QueueForComplianceReport_ARAPCTRTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			DataTable result = DataUtils.GetDataTableFromQuery(TestConnection, string.Format("EXEC QueueForComplianceReport_ARAPCTR 'LIB', '{0}', NULL, 'Nov 9 2015', 'Nov 10 2015'", TestDbHelper.DefaultCompanyPK));
		...
		{
			helper.InsertTransactionHeader("AR", "CTR", "001", 100, helper.ToDate("2015-11-09"), branchPK, departmentPK);
			helper.InsertTransactionHeader("AP", "CTR", "002", 200, helper.ToDate("2015-11-09"), branchPK, departmentPK);
		}
	}
}
