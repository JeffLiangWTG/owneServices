...
{
	[TestedType(typeof(QueueForComplianceReport_ARAPJNL))]
	class QueueForComplianceReport_ARAPJNLTest : DbCreateScriptTest
	{
		public void TestSampleCall()
		{
			...
			DataTable result = DataUtils.GetDataTableFromQuery(TestConnection, string.Format("EXEC QueueForComplianceReport_ARAPJNL 'LIB', '{0}', NULL, 'Nov 9 2015', 'Nov 10 2015'", TestDbHelper.DefaultCompanyPK));
		...
		{
			helper.InsertTransactionHeader("AR", "JNL", "001", 100, helper.ToDate("2015-11-09"), branchPK, departmentPK);
			helper.InsertTransactionHeader("AP", "JNL", "002", 200, helper.ToDate("2015-11-09"), branchPK, departmentPK);
		}
	}
}
