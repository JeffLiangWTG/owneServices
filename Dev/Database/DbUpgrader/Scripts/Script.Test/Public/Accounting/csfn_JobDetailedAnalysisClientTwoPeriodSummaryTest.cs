...
{
	[TestedType(typeof(csfn_JobDetailedAnalysisClientTwoPeriodSummary))]
	class csfn_JobDetailedAnalysisClientTwoPeriodSummaryTest : DbCreateScriptTest
	{
		public void TestShipmentIsNotDuplicatedWhenAttachedToMultipleConsols()
		{
			...
			var result = DataUtils.GetDataTableFromQuery(TestConnection, "SELECT * FROM csfn_JobDetailedAnalysisClientTwoPeriodSummary (null, 'AU', '2017-01-01', '2018-01-01', '2018-01-01', '2019-01-01', '', 'F', null, null, null, null, null, null, null, null, null, null, '', '', null, null, '', 'EXP', null)");
			...
			result = DataUtils.GetDataTableFromQuery(TestConnection, "SELECT * FROM csfn_JobDetailedAnalysisClientTwoPeriodSummary (null, 'AU', '2017-01-01', '2018-01-01', '2018-01-01', '2019-01-01', '', 'F', null, null, null, null, null, null, null, null, null, null, '', '', null, null, '', 'IMP', null)");
