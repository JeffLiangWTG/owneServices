...
{
	abstract class ep_DatabaseSetInfoTest : BiCreateScriptTest
	{
	...
	internal class ep_DatabaseSetInfoForAuditTest : ep_DatabaseSetInfoTest
	{
	...
	[TestedType(typeof(ep_DatabaseSetInfo))]
	internal class ep_DatabaseSetInfoForEdwTest : ep_DatabaseSetInfoTest
	{
		protected override string ScriptDbName
		{
