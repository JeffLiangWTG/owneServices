...
namespace Enterprise.Build.Database.Script.Public.BusinessIntelligence.EDW.Model.InternationalLogistics.Testing
{
	...
	internal class vw_CUS__ShipmentEmissionsTest : BiCreateScriptTest
	{
		[ExpectNoExceptions]
		public void TestRun()
		{
			...
			CombineAssertions(() =>
			{
				AssertRowValues(resultTable, 1, 1, "SGSIN", "AUSYD", "SEA", 999.9m, 5000m, 1000.02m, "KG",
				...
				AssertRowValues(resultTable, 2, 2, "AUSYD", "AUMBE", "AIR", 1.0m, 10000m, 9.390m, "T",
		...
		HashSet<string> GetColumns()
		{
			return new HashSet<string>
			{
				...
				"CO2eStatus",
				"ConsigneeAddressKey",
				"ConsigneeOrgAddressKey",
				"ConsigneeOrgID",
				"ConsignorAddressKey",
				"ConsignorOrgAddressKey",
				"ConsignorOrgID",
				"ConsolAndShipmentTransportKey",
				"ConsolidationKey",
				"ConsolidationShipmentPivotKey",
				"ControllingCustomerAddressKey",
				"ControllingCustomerOrgAddressKey",
				"ControllingCustomerOrgID",
				"DepartureDate",
				"DistanceInKM",
				"JobHeaderKey",
				"JobSailingKey",
				"JobVoyageKey",
				"JobVoyageOrganizationKey",
				"JobVoyOriginKey",
				"LocalClientAddressKey",
				"LocalClientOrgID",
				"PortOfDestination",
				"PortOfOrigin",
				"ShipmentCO2eKey",
				"ShipmentKey",
				"ShipmentUnitOfWeight",
				"ShipmentWeight",
				"SystemCreateTimeUtc",
				"TotalCO2e",
				"TransportMode",
		...
		DataTable SelectRows()
		{
			var sqlText = string.Format(CultureInfo.InvariantCulture,
				"SELECT * FROM [{0}].[InternationalLogistics].[vw_CUS__ShipmentEmissions]",
				ScriptDbName);
