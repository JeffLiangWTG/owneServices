...
{
	[TestedType(typeof(RawPLBSHALTAccDep2))]
	class RawPLBSHALTAccDep2Test : BiCreateScriptTest
	{
		...
		public void TestRawPLBSHALTAccDep2WhenNotHitCaseWhenCondition()
		{
			PrepareData();
		...
		public void TestRawPLBSHALTAccDep2WhenHitCaseWhenCondition()
		{
			PrepareData();
			Helper.InsertGLAggregate(100, 201001, 1);
			Helper.InsertGLAggregate(200, 200910, 2);
		...
		{
			DataTable result = DataUtils.GetDataTableFromQuery(TestConnection, $@"SELECT * FROM {ScriptDbName}.dbo.RawPLBSHALTAccDep2 (0, 201000, 201009, '878D7ACA-FFC3-49FC-9710-969CA0C0F2AC', '', '')");
