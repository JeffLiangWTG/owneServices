...
{
	[TestedType(typeof(Report_OutstandingWIPACRTransactionsEDW))]
	class Report_OutstandingWIPACRTransactionsEDWTest : BiCreateScriptTest
	{
		TestDbHelper helper;
		...
		public void TestJobTypeFilter()
		{
			using (var edwConnection = Db.NewAdminConnection(ScriptDbName))
			{
				...
				var shipmentPK = helper.CreateEDWShipment(ScriptDbName, edwConnection, "S001001", "2012-07-25", 1, 41);
				...
				var shipmentJobPK2 = helper.CreateEDWJob(ScriptDbName, edwConnection, "I99999999", DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, "ET", shipmentPK, "WRK", "2012-07-25", 52, 1);
				helper.CreateEDWJobChargeAndLines(ScriptDbName, edwConnection, shipmentJobPK, chargeCode1PK, DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, debtorOrgPK, creditorOrgPK, 100, "2012-07-25", 51);
				helper.CreateEDWJobChargeAndLines(ScriptDbName, edwConnection, shipmentJobPK2, chargeCode1PK, DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, debtorOrgPK, creditorOrgPK, 111, "2012-07-25", 52);

				helper.ExecuteLoadAGGTables(ScriptDbName, edwConnection);
				helper.ExecuteLoadCUSTables(ScriptDbName, edwConnection);
		...
		public void TestJobInactive()
		{
			using (var edwConnection = Db.NewAdminConnection(ScriptDbName))
			{
				...
				var shipmentPK = helper.CreateEDWShipment(ScriptDbName, edwConnection, "S001001", "2012-07-25", 1, 41);
				var shipmentJobPK = helper.CreateEDWJob(ScriptDbName, edwConnection, "S99999999", DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, "JS", shipmentPK, "WRK", "2012-07-25", 51, 1);
				var shipmentJobPK2 = helper.CreateEDWJob(ScriptDbName, edwConnection, "I99999999", DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, "ET", shipmentPK, "WRK", "2012-07-25", 52, 0);
				helper.CreateEDWJobChargeAndLines(ScriptDbName, edwConnection, shipmentJobPK, chargeCode1PK, DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, debtorOrgPK, creditorOrgPK, 100, "2012-07-25", 51);
				helper.CreateEDWJobChargeAndLines(ScriptDbName, edwConnection, shipmentJobPK2, chargeCode1PK, DefaultCompanyKey, DefaultCompanyPK, branchPK, departmentPK, debtorOrgPK, creditorOrgPK, 111, "2012-07-25", 52);
				...
				AssertEquals("Only job active data. 2 lines come through", 2, dt.Rows.Count);
				AssertEquals("Only job active data. Both lines are shipments.", "S99999999", dt.Rows[0]["JobNum"]);
				AssertEquals("Only job active data. Both lines are shipments.", "S99999999", dt.Rows[1]["JobNum"]);
			}
		}
		...
		DataTable GetResultSetAll(AdminConnection edwConnection, Guid[] values)
		{
			string sql = string.Format(
				@"SELECT * FROM [{0}].[dbo].[Report_OutstandingWIPACRTransactionsEDW]('2023-07-31','FC4CF1FF-7FFD-4356-A3B3-6E15D8896066','ALL','','',null,null,null,null,null,null,'1900-01-01 00:00:00','2079-06-06 23:59:29',@ultimateMNGPKs, @MNGListIsEmpty)",
				ScriptDbName);
		...
		{
			string sql = string.Format(
				@"SELECT * FROM [{0}].[dbo].[Report_OutstandingWIPACRTransactionsEDW]('2023-07-31','FC4CF1FF-7FFD-4356-A3B3-6E15D8896066','ALL','','S',null,null,null,null,null,null,'1900-01-01 00:00:00','2079-06-06 23:59:29',@ultimateMNGPKs, @MNGListIsEmpty)",
				ScriptDbName);
			var command = edwConnection.Command(sql);
			helper.AddTVP_uniqueidentifierAndIsEmptyParameters(command, "@ultimateMNGPKs", "@MNGListIsEmpty", values);
			return DataUtils.GetDataTableFromCommand(command);
		...
		{
			string sql = string.Format(
				@"SELECT * FROM [{0}].[dbo].[Report_OutstandingWIPACRTransactionsEDW]('2023-07-31','FC4CF1FF-7FFD-4356-A3B3-6E15D8896066','ALL','','W',null,null,null,null,null,null,'1900-01-01 00:00:00','2079-06-06 23:59:29',@ultimateMNGPKs, @MNGListIsEmpty)",
				ScriptDbName);
			var command = edwConnection.Command(sql);
			helper.AddTVP_uniqueidentifierAndIsEmptyParameters(command, "@ultimateMNGPKs", "@MNGListIsEmpty", values);
			return DataUtils.GetDataTableFromCommand(command);
