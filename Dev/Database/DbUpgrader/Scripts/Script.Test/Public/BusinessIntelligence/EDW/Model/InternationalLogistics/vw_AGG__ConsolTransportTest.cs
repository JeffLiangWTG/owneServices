...
{
	[TestedType(typeof(vw_AGG__ConsolTransport))]
	internal class vw_AGG__ConsolTransportTest : BiCreateScriptTest
	{
		/// <summary>
		...
		HashSet<string> GetColumns()
		{
			...
			columns.Add("ATD");
			columns.Add("Carrier");
			columns.Add("ConsolAndShipmentTransportID");
			columns.Add("ConsolAndShipmentTransportKey");
			columns.Add("DepotAvailabilityDate");
			columns.Add("DepotCutOff");
			columns.Add("DepotReceivalCommences");
			columns.Add("DepotStorageDate");
			columns.Add("DestinationKey");
			columns.Add("DiscPort");
			columns.Add("DocumentaryCutoff");
			columns.Add("ETA");
			columns.Add("ETD");
			columns.Add("FCLAvailabilityDate");
			columns.Add("FCLCutOff");
			columns.Add("FCLReceivalCommences");
			columns.Add("FCLStorageDate");
			columns.Add("IsActive");
			columns.Add("IsLinked");
			columns.Add("JobVoyageKey");
			columns.Add("JobVoyOriginKey");
			columns.Add("JobSailing");
			columns.Add("JX");
			columns.Add("LegOrder");
			columns.Add("LoadPort");
			columns.Add("OrganizationAddressKey");
			columns.Add("OrganizationID");
			columns.Add("ParentGUID");
			columns.Add("TimeofArrival");
			columns.Add("TimeofDischarge");
			columns.Add("TransportMode");
			columns.Add("TransportType");
			columns.Add("Vessel");
			columns.Add("VoyageFlight");
		...
		DataTable SelectRows()
		{
			string sqlText = string.Format(CultureInfo.InvariantCulture,
					"SELECT * FROM [{0}].[InternationalLogistics].[vw_AGG__ConsolTransport]",
					ScriptDbName
			);
