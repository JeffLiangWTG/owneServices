...
{
	[TestedType(typeof(usp_IniLoad_AGG__JobParentsByControllingCustomerAndAgent2))]
	internal class usp_IniLoad_AGG__JobParentsByControllingCustomerAndAgent2Test : BiCreateScriptTest
	{
		/// <summary>
