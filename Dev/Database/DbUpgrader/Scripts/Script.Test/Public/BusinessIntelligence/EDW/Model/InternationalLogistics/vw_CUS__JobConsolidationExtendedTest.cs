...
namespace Enterprise.Build.Database.Script.Public.BusinessIntelligence.EDW.Model.InternationalLogistics.Testing
{
	...
	internal class vw_CUS__JobConsolidationExtendedTest : BiCreateScriptTest
	{
		/// <summary>
		...
		HashSet<string> GetColumns()
		{
			...
			columns.Add("CarrierAddressKey");
			columns.Add("CarrierCode");
			columns.Add("CarrierContractNumber");
			columns.Add("CarrierFullName");
			columns.Add("CarrierID");
			columns.Add("CarrierOrganizationKey");
			columns.Add("CoLoadCode");
			columns.Add("CoLoadFullName");
			columns.Add("CoLoadOrganizationKey");
			columns.Add("ConsolidationID");
			columns.Add("ConsolidationKey");
			columns.Add("CreditorAddressKey");
			columns.Add("CreditorCode");
			columns.Add("CreditorID");
			columns.Add("CreditorOrganizationKey");
			columns.Add("ReceivingAgentAddressKey");
			columns.Add("ReceivingAgentCode");
			columns.Add("ReceivingAgentFullName");
			columns.Add("ReceivingAgentID");
			columns.Add("ReceivingAgentOrganizationKey");
			columns.Add("SendingAgentAddressKey");
			columns.Add("SendingAgentCode");
			columns.Add("SendingAgentFullName");
			columns.Add("SendingAgentID");
			columns.Add("SendingAgentOrganizationKey");
		...
		{
			string sqlText = string.Format(CultureInfo.InvariantCulture,
					"SELECT * FROM [{0}].[InternationalLogistics].[vw_CUS__JobConsolidationExtended]",
					ScriptDbName
			);
