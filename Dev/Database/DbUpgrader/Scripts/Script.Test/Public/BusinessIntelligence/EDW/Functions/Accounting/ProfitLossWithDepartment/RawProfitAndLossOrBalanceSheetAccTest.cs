...
{
	[TestedType(typeof(RawProfitAndLossOrBalanceSheetAcc))]
	class RawProfitAndLossOrBalanceSheetAccTest : BiCreateScriptTest
	{
		...
		public void TestQuery()
		{
			...
			AssertEquals(-1m, result.Select("GLAccountKey = 1")[0]["CurrentAmount"]);
			AssertEquals(-2m, result.Select("GLAccountKey = 2")[0]["CurrentAmount"]);
		}
