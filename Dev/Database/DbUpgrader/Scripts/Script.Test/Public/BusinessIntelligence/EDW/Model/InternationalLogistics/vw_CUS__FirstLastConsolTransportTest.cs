...
namespace Enterprise.Build.Database.Script.Public.BusinessIntelligence.EDW.Model.InternationalLogistics.Testing
{
	...
	internal class vw_CUS__FirstLastConsolTransportTest : BiCreateScriptTest
	{
		/// <summary>
		...
		HashSet<string> GetColumns()
		{
			var columns = new HashSet<string>
			{
				...
				"FirstLoad_ATD",
				"FirstLoad_TD",
				"FirstTransportVoyageFlight",
				"FirstSailingPK",
				"LastDischarge_Port",
				"LastDischarge_ETA",
				"LastDischarge_ATA",
				"LastDischarge_TA",
				"LastTransportVoyageFlight",
				"LastSailingPK"
			};
		...
		DataTable SelectRows()
		{
			var sqlText = string.Format(CultureInfo.InvariantCulture,
					"SELECT * FROM [{0}].[InternationalLogistics].[vw_CUS__FirstLastConsolTransport]",
					ScriptDbName
			);
