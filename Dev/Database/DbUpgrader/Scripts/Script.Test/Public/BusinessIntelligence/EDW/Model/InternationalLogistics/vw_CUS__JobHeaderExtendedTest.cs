...
namespace Enterprise.Build.Database.Script.Public.BusinessIntelligence.EDW.Model.InternationalLogistics.Testing
{
	...
	internal class vw_CUS__JobHeaderExtendedTest : BiCreateScriptTest
	{
		/// <summary>
		...
		HashSet<string> GetColumns()
		{
			...
			columns.Add("BillingJobCloseDate");
			columns.Add("BranchKey");
			columns.Add("ClientPK");
			columns.Add("CompanyID");
			columns.Add("ConsolidationID");
			columns.Add("ConsolidationKey");
			columns.Add("CreateDateTimeUtc");
			columns.Add("DeclarationContainerMode");
			columns.Add("DeclarationDateAtFinalDestination");
			columns.Add("DeclarationID");
			columns.Add("DeclarationKey");
			columns.Add("DeclarationOrigin");
			columns.Add("DepartmentKey");
			columns.Add("EstimatedDepartureDate");
			columns.Add("FinalDestination");
			columns.Add("IsActive");
			columns.Add("JobBranchCode");
			columns.Add("JobBranchPK");
			columns.Add("JobDeptCode");
			columns.Add("JobDeptPK");
			columns.Add("JobHeaderAddressKey");
			columns.Add("JobHeaderBranchKey");
			columns.Add("JobHeaderConsolidationKey");
			columns.Add("JobHeaderDeclarationKey");
			columns.Add("JobHeaderDepartmentKey");
			columns.Add("JobHeaderID");
			columns.Add("JobHeaderKey");
			columns.Add("JobHeaderName");
			columns.Add("JobHeaderParentID");
			columns.Add("JobHeaderParentTableCode");
			columns.Add("JobHeaderShipmentKey");
			columns.Add("JobLocalReference");
			columns.Add("JobNum");
			columns.Add("JobOverseasAgentCode");
			columns.Add("JobOverseasAgentName");
			columns.Add("JobStatus");
			columns.Add("LocalAgentAddressKey");
			columns.Add("LocalClient");
			columns.Add("LocalClientFullName");
			columns.Add("LocalClientOrganizationKey");
			columns.Add("LocalClientPK");
			columns.Add("OperatorName");
			columns.Add("OperatorPK");
			columns.Add("OperatorStaffKey");
			columns.Add("OrganizationAddressKey");
			columns.Add("OverseasAgentAddressKey");
			columns.Add("OverseasAgentOrgHeaderKey");
			columns.Add("OverseasAgentOrgHeaderPK");
			columns.Add("SalesRepName");
			columns.Add("SalesRepPK");
			columns.Add("SalesRepStaffKey");
		...
		{
			string sqlText = string.Format(CultureInfo.InvariantCulture,
					"SELECT * FROM [{0}].[InternationalLogistics].[vw_CUS__JobHeaderExtended]",
					ScriptDbName
			);
