...
{
	class TimeZoneFunctionTests : TransactionedTestCase
	{
		...
		{
			var sql = $@"
INSERT INTO RefDatabase_RefUNLOCOUtcOffset (RLO_PK, RLO_RL_NKCode, RLO_StartTimeUtc, RLO_EndTimeUtc, RLO_OffsetMinutesFromUtc) VALUES (NEWID(), 'BRSAO', '2018-02-18 00:00:00.000', '2018-10-21 00:00:00.000', -180);
INSERT INTO RefDatabase_RefUNLOCOUtcOffset (RLO_PK, RLO_RL_NKCode, RLO_StartTimeUtc, RLO_EndTimeUtc, RLO_OffsetMinutesFromUtc) VALUES (NEWID(), 'BRSAO', '2017-10-15 00:00:00.000', '2018-02-18 00:00:00.000', -120);
INSERT INTO RefDatabase_RefUNLOCOUtcOffset (RLO_PK, RLO_RL_NKCode, RLO_StartTimeUtc, RLO_EndTimeUtc, RLO_OffsetMinutesFromUtc) VALUES (NEWID(), 'BRSAO', '2017-02-19 00:00:00.000', '2017-10-15 00:00:00.000', -180);
INSERT INTO RefDatabase_RefUNLOCOUtcOffset (RLO_PK, RLO_RL_NKCode, RLO_StartTimeUtc, RLO_EndTimeUtc, RLO_OffsetMinutesFromUtc) VALUES (NEWID(), 'BRSAO', '2016-10-16 00:00:00.000', '2017-02-19 00:00:00.000', -120);
INSERT INTO RefDatabase_RefUNLOCOUtcOffset (RLO_PK, RLO_RL_NKCode, RLO_StartTimeUtc, RLO_EndTimeUtc, RLO_OffsetMinutesFromUtc) VALUES (NEWID(), 'BRSAO', '2016-02-21 00:00:00.000', '2016-10-16 00:00:00.000', -180);
";
		...
		{
			var sql = $@"
DELETE FROM dbo.RefDatabase_RefUNLOCOUtcOffset WHERE RLO_RL_NKCode = 'BRSAO';
";
			Db.Connection.Command(sql).ExecuteNonQuery();
		}
...
";
			...
			AssertTimeZoneOffset("BRSAO", "2019-01-14", 12, new DateTime(2019, 1, 12, 14, 0, 0), new DateTime(2019, 11, 9, 14, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2019-11-11", 13, new DateTime(2019, 11, 9, 14, 0, 0), new DateTime(2020, 1, 11, 14, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2020-01-13", 12, new DateTime(2020, 1, 11, 14, 0, 0), new DateTime(2020, 12, 19, 14, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2020-12-21", 13, new DateTime(2020, 12, 19, 14, 0, 0), new DateTime(2021, 01, 16, 14, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2021-01-18", 12, new DateTime(2021, 1, 16, 14, 0, 0), new DateTime(2021, 11, 13, 14, 0, 0));
		}
...
";
			TestConnection.ExecuteScalar(sql);
			AssertTimeZoneOffset("BRSAO", "2008-10-20", -2, new DateTime(2008, 10, 19, 2, 0, 0), new DateTime(2009, 2, 15, 3, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2009-02-16", -3, new DateTime(2009, 2, 15, 3, 0, 0), new DateTime(2009, 10, 18, 2, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2018-02-17", -2, new DateTime(2017, 10, 15, 0, 0, 0), new DateTime(2018, 2, 18, 0, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2018-02-19", -3, new DateTime(2018, 2, 18, 0, 0, 0), new DateTime(2018, 10, 21, 0, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2018-11-05", -2, new DateTime(2018, 11, 4, 2, 0, 0), new DateTime(2019, 2, 17, 3, 0, 0));
			AssertTimeZoneOffset("BRSAO", "2019-02-18", -3, new DateTime(2019, 2, 17, 3, 0, 0), new DateTime(2019, 11, 10, 2, 0, 0));
		...
		{
			var sql = $"SELECT DstStart, DstEnd, Offset FROM CalculateTimeZoneOffsetFromRefUNLOCO('{unloco}', '{utctime}', 0);";
...
WHERE RL_Code = '{0}'",
		...
		void AssertTimeZoneOffset(string unloco, decimal expectedOffset, string expectedMethod = "Calculate", DateTime? referenceDate = null)
		{
			...
			{
				sql = $"SELECT Offset FROM dbo.{FunctionName}('{unloco}', '{(referenceDate ?? DateTime.Now).ToSqlFormat()}', 0)";
			}
	...
	sealed class CalculateTimeZoneOffsetFromRefUNLOCOTest : DbCreateScriptTest
	{
	}
}
