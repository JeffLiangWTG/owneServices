...
{
	[TestedType(typeof(GetTimeZoneOffset))]
	sealed class GetTimeZoneOffsetTest : DbCreateScriptTest
	{
	}

	class GetTimeZoneOffsetFunctionTest : TimeZoneFunctionTests
	{
...
";
		...
		protected override string FunctionName => "GetTimeZoneOffset";
	}
}
