...
{
	[TestedType(typeof(UpdateRelatedJobsForOrgOrDocAddress))]
	class UpdateRelatedJobsForOrgOrDocAddressTest : DbCreateScriptTest
	{
			...
			var executeProcWithErrorHandlingSql = $@"
				...
				BEGIN TRY
					EXEC {procedureName}
						...
						@updateShipments = 1,
						@updateConsols = 1,
						@jobUpdatePeriod = '1998-01-02 00:00:00',
						@userCode = '~BP',
						@freightCpwEnabled = 0;
