...
{
	[TestedType(typeof(GetScreeningStatusOfConsol))]
	class GetScreeningStatusOfConsolTest : DbCreateScriptTest
	{
		//Further tested in ScreeningUpdaterTest.

		public void TestExecuteFunctionCall()
		{
			var query = "SELECT * FROM GetScreeningStatusOfConsol(@jobPKs, @companyPK)";
