...
{
	[TestedType(typeof(GetWorstPartyScreeningStatusOfShipment))]
	class GetWorstPartyScreeningStatusOfShipmentTest : DbCreateScriptTest
	{
		//Further tested in ScreeningUpdaterTest.

		public void TestExecuteFunctionCall()
		{
			var query = "SELECT * FROM GetWorstPartyScreeningStatusOfShipment(@jobPKs, @companyPK)";
