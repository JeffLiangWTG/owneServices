...
{
	[TestedType(typeof(GetScreeningStatusOfDeclaration))]
	class GetScreeningStatusOfDeclarationTest : DbCreateScriptTest
	{
		//Further tested in ScreeningUpdaterTest.

		public void TestExecuteFunctionCall()
		{
			var query = "SELECT * FROM GetScreeningStatusOfDeclaration(@jobPKs, @companyPK)";
