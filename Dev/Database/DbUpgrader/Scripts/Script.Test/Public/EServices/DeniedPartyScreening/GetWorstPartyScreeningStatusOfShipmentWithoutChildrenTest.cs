...
{
	[TestedType(typeof(GetWorstPartyScreeningStatusOfShipmentWithoutChildren))]
	class GetWorstPartyScreeningStatusOfShipmentWithoutChildrenTest : DbCreateScriptTest
	{
		//Further tested in ScreeningUpdaterTest.

		public void TestExecuteFunctionCall()
		{
			var query = "SELECT * FROM GetWorstPartyScreeningStatusOfShipmentWithoutChildren(@jobPKs, @companyPK)";
