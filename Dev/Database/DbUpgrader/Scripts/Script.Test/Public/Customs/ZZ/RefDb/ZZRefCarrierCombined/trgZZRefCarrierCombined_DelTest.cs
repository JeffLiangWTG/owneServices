...
{
	[TestedType(typeof(trgZZRefCarrierCombined_Del))]
	class trgZZRefCarrierCombined_Del_Test : DbCreateScriptTest
	{
		public void TestDelete()
		{
			...
			var delete = "DELETE FROM dbo.ZZRefCarrierCombined WHERE ZZ4_PK = 'e1d48fb9-c002-4329-98d8-fbdc7d0d068d'";
			AssertNoExceptionThrown(() => TestConnection.ExecuteNonQuery(delete));

			var count = "SELECT COUNT(*) FROM dbo.ZZRefCarrierCombined WHERE ZZ4_PK = 'e1d48fb9-c002-4329-98d8-fbdc7d0d068d'";
			AssertEquals(0, TestConnection.ExecuteScalar<int>(count));
		}
	}
}
