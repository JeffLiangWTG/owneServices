...
namespace Enterprise.Services.Scim.Api.Auth
{
	...
	// the OpenID Connect metadata endpoint exposed by the STS by default. (https://github.com/AzureADQuickStarts/AppModelv2-NativeClient-DotNet/blob/complete/TodoListService/App_Start/OpenIdConnectSecurityTokenProvider.cs)
	public class OpenIdConnectSecurityKeyProvider : IIssuerSecurityKeyProvider
	{
		...
		string _issuer;
		ICollection<SecurityKey> _keys;

		readonly ReaderWriterLockSlim _synclock = new ReaderWriterLockSlim();
