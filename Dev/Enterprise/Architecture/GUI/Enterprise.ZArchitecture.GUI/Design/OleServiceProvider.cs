namespace Enterprise.ZArchitecture.Design
{
	...
	///     services.
	/// </summary>
	public class OleServiceProvider : IServiceProvider, IObjectWithSite {
		...
		/// </param>
		public OleServiceProvider(IOleServiceProvider sp)
		{
			serviceProvider = sp;
		}
		...
		/// </summary>
		object GetService(Guid guid, Type serviceClass) {
			...
			IntPtr pUnk;
			var iID_IUnknown = OleServiceProvider.IID_IUnknown;
			var hr = serviceProvider.QueryService(ref guid, ref iID_IUnknown, out pUnk);
