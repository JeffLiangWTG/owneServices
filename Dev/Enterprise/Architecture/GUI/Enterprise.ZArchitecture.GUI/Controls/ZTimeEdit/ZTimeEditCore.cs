...
namespace Enterprise.ZArchitecture.GUI.Internal
{
	...
	public class ZTimeEditHelper
	{
		internal string InputText = "";

		protected internal string GetTextFromTime(ZDateTime time, bool allowNegative)
		{
	...
	public class ZTimeEditCore : IDisposable
	{
		internal ZTimeEditCore(ZTimeEdit editor)
		{
			this.Editor = editor;
		...
		protected readonly ZTimeEdit Editor;
		...
		protected virtual internal ZDateTime GetTimeFromText(string value)
		{
			return Parser.GetDateTimeFromText(value, AllowNegative);
		}
		...
		protected virtual internal string GetTextFromTime(ZDateTime time, bool allowNegativeOverride)
		{
			return Helper.GetTextFromTime(time, allowNegativeOverride || AllowNegative);
		}
		...
		protected ZTimeEditHelper Helper
		{
			get
			{
				if (fHelper == null)
		...
		protected virtual ZTimeEditHelper GetNewHelper()
		{
			return new ZTimeEditHelper();
		}

		ZTimeEditHelper fHelper;
