...
namespace Enterprise.ZArchitecture.GUI
{
	...
	[ToolboxItem(true)]
	public class ZTimeEdit : ZTextBox, IGridControl
	{
		public ZTimeEdit()
		{
			Text = "";
			UpdateWidth();
			FontChanged += ZTimeEdit_FontChanged;
		}

		void ZTimeEdit_FontChanged(object sender, EventArgs e)
		{
			fFixedWidth = -1;
			UpdateWidth();
		}
		...
		{
			get { return 5; }
			set { throw new NotSupportedException("ZTimeEdit.MaxLength should not be set manually."); }
		}
		...
		{
			var value = Core.GetTextFromTime((ZDateTime)e.Value, AllowNegative);
		...
		internal virtual ZTimeEditCore GetNewCore()
		{
			return new ZTimeEditCore(this);
		}
		...
		{
			return new ControlPropertyDescriptorBuilder<ZTimeEdit>()
