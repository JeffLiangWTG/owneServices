...
namespace Enterprise.ZArchitecture.GUI
{
	...
	public class ZToolStripSplitButton : ToolStripSplitButton, IConvertedFromMenuItem, IResCaptionedControl
	{
		public ZToolStripSplitButton()
		{
			...
			//Dpi issue should be removed after upgrade to .NET 4.6
			this.DropDownButtonWidth = ControlDpiScalingHelper.ScaleToCurrentDpiX(11);
		}
