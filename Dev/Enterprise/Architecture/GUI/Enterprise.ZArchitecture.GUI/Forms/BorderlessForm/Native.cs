...
namespace Enterprise.ZArchitecture.GUI.Forms.Native
{
	...
	internal static class SafeNativeMethods
	{
		...
		static int SafeWrapNative(int result)
		{
			...
			if (result < 0 || (result > 0 && lastError != 0))
			{
				...
				{
					var errStr = $"native call result: {result} last error: {lastError}"; // not visible to user
	...
	internal static class UnsafeNativeMethods
	{
		...
		[DllImport("user32.dll")]
		internal static extern Int32 SendMessage(IntPtr hWnd, Int32 wMsg, Int32 wParam, Int32 lParam);

		[SuppressMessage("Microsoft.Portability", "CA1901:PInvokeDeclarationsShouldBePortable", MessageId = "return")]
		[DllImport("user32.dll")]
		internal static extern Int32 SendMessage(IntPtr hWnd, Int32 wMsg, IntPtr wParam, IntPtr lParam);
		...
		[DllImport("user32.dll")]
		internal static extern Int32 SetWindowRgn(IntPtr hWnd, IntPtr hrgn, [MarshalAs(UnmanagedType.Bool)] bool bRedraw);
		...
		[DllImport("gdi32.dll")]
		internal static extern Int32 GetRgnBox(IntPtr hrgn, out RECT lprc);
	...
	internal static class BFNativeConstants
	{
