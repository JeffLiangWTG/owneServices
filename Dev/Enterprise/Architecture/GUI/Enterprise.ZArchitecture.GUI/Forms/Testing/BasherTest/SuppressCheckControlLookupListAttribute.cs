...
namespace Enterprise.ZArchitecture.GUI.Testing
{
	...
	public sealed class SuppressCheckControlLookupListAttribute : Attribute
	{
		...
		{
			return component.GetType().GetCustomAttributes(typeof(SuppressCheckControlLookupListAttribute), true).Length > 0;
		}
	}
}
