...
{
	public partial class EnterpriseInformationForm : KForm, ICaptionRenderingSupport
	{
		public EnterpriseInformationForm()
		{
			InitializeComponent();

			Text = Res.GetString("EnterpriseInformationForm.Text", "About {0}", Constants.ProductName);
			CopyrightLabel.Text = CopyrightLabel.Text.Replace("CR", new string((char)169, 1));

			this.pictureBox1.Image = BrandingFactory.Instance.AboutScreenImage;
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			if (!this.IsDesignMode())
			{
				...
				CopyrightLabel.Text = CopyrightLabel.Text.Replace("XXXX", ReleaseInfo.Instance.ExeDate.Year.ToString());
