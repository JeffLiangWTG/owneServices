...
{
	sealed class ZFilterGridModuleManualSortForTest : ZFilterGridModule
	{
		public ZFilterGridModuleManualSortForTest(BusinessObjectFactory factory, ZPage page)
			: base(factory, page)
		{
		}
		...
		public override Type GridCollectionType => typeof(DummyBusinessObjectManualSortCollection);
