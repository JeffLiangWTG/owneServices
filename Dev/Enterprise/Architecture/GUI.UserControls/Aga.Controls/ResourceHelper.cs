...
namespace Aga.Controls
{
	public static class ResourceHelper
	{
		...
		private static readonly Cursor _dVSplitCursor = GetCursor(Properties.Resources.DVSplit);
		public static Cursor DVSplitCursor
		{
			get { return _dVSplitCursor; }
		}

		private static readonly GifDecoder _loadingIcon = GetGifDecoder(Properties.Resources.loading_icon);
