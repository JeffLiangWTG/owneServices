...
namespace Aga.Controls.Tree.NodeControls
{
	public partial class NodeCheckBox : InteractiveControl
	{
		...
		public override void Draw(TreeNodeAdv node, DrawContext context)
		{
			...
			{
				VisualStyleElement renderElement;

				if (IsEditEnabled(node))
				{
					if (state == CheckState.Indeterminate)
						renderElement = VisualStyleElement.Button.CheckBox.MixedNormal;
					else if (state == CheckState.Checked)
						renderElement = VisualStyleElement.Button.CheckBox.CheckedNormal;
					else
						renderElement = VisualStyleElement.Button.CheckBox.UncheckedNormal;
				}
				else
				{
					if (state == CheckState.Indeterminate)
						renderElement = VisualStyleElement.Button.CheckBox.MixedDisabled;
					else if (state == CheckState.Checked)
						renderElement = VisualStyleElement.Button.CheckBox.CheckedDisabled;
					else
						renderElement = VisualStyleElement.Button.CheckBox.UncheckedDisabled;
				}

				VisualStyleRenderer renderer = new VisualStyleRenderer(renderElement);
