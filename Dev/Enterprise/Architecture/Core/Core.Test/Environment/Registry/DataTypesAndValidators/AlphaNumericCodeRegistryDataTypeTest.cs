...
{
	[TestedType(typeof(AlphaNumericCodeRegistryDataType))]
	sealed class AlphaNumericCodeRegistryDataTypeTest : StringRegistryDataTypeTest
	{
		protected override StringRegistryDataType GetNewDataType()
		{
			return new AlphaNumericCodeRegistryDataType(0, 10);
		}
