...
{
	[TestedType(typeof(IncidentGroupEConversationParticipantsFilter<GlbGroup>))]
	public class GroupParticipantsFilterTest : ModuleFilterTestCase<IncidentGroupEConversationParticipantsFilter<GlbGroup>>
	{
		public void TestGroupParticipantsOfIncidentManagementGroupFilterQuery()
		{
			var group = Factory.NewWithValidTestData<GlbGroup>();
			var group1 = Factory.NewWithValidTestData<IncidentManagementGroup>();
			group1.EConversation.Conversation.RelatedParties.AddNewParticipant(group);
		...
		protected override IncidentGroupEConversationParticipantsFilter<GlbGroup> GetNewModuleFilter()
		{
			return new IncidentGroupEConversationParticipantsFilter<GlbGroup>("moo", ModuleIDs.GlbGroup, GetPrimaryKeyColumn(), new GlbGroupCollection(Factory), BusinessObjectType);
		}
	}
}
