...
{
	[TestedType(typeof(IncidentEConversationParticipantsFilter<OrgContact>))]
	class IncidentContactParticipantsFilterTest : ModuleFilterTestCase<IncidentEConversationParticipantsFilter<OrgContact>>
	{
		public void TestContactParticipantsOfIncidentFilterQuery()
		{
		...
		protected override IncidentEConversationParticipantsFilter<OrgContact> GetNewModuleFilter()
		{
			return new IncidentEConversationParticipantsFilter<OrgContact>("moo", ModuleIDs.OrgContacts, IncidentMainSchema.PK, new OrgContactCollection(Factory), typeof(SupportIncident));
		}
	}
}
