...
{
	[TestedType(typeof(IncidentEConversationParticipantsFilter<OrgHeader>))]
	class IncidentOrganizationParticipantsFilterTest : ModuleFilterTestCase<IncidentEConversationParticipantsFilter<OrgHeader>>
	{
		public void TestOrganizationParticipantsOfIncidentFilterQuery()
		{
			var org = Factory.NewWithValidTestData<OrgHeader>();
			var incident1 = Factory.NewWithValidTestData<SupportIncident>();
			incident1.EConversation.Conversation.RelatedParties.AddNewParticipant(org);
		...
		protected override IncidentEConversationParticipantsFilter<OrgHeader> GetNewModuleFilter()
		{
			return new IncidentEConversationParticipantsFilter<OrgHeader>("moo", ModuleIDs.Organisation, IncidentMainSchema.PK, new OrgHeaderCollection(Factory), typeof(SupportIncident));
		}
	}
}
