...
{
	[TestedType(typeof(IncidentGroupEConversationParticipantsFilter<OrgHeader>))]
	public class OrganizationParticipantsFilterTest : ModuleFilterTestCase<IncidentGroupEConversationParticipantsFilter<OrgHeader>>
	{
		public void TestOrganizationParticipantsOfIncidentManagementGroupFilterQuery()
		{
			var org = Factory.NewWithValidTestData<OrgHeader>();
			var group1 = Factory.NewWithValidTestData<IncidentManagementGroup>();
			group1.EConversation.Conversation.RelatedParties.AddNewParticipant(org);
		...
		{
			var alex = Factory.NewWithValidTestData<OrgHeader>();
			alex.OH_FullName = "Alex Org";
			var bob = Factory.NewWithValidTestData<OrgHeader>();
			bob.OH_FullName = "Bob Org";
		...
		protected override IncidentGroupEConversationParticipantsFilter<OrgHeader> GetNewModuleFilter()
		{
			return new IncidentGroupEConversationParticipantsFilter<OrgHeader>("moo", ModuleIDs.Organisation, GetPrimaryKeyColumn(), new OrgHeaderCollection(Factory), BusinessObjectType);
		}
	}
}
