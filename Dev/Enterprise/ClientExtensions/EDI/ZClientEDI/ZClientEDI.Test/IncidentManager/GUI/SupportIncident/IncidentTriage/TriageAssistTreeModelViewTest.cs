...
{
#if !WINZOR
	[TestedType(typeof(TriageAssistTreeModelView))]
	public class TriageAssistTreeModelViewTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			return new TriageAssistTreeModelView(Assist);
		}
