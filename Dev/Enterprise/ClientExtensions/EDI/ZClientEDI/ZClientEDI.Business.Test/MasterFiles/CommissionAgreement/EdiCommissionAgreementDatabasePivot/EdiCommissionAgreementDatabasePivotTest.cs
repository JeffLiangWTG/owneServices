...
{
	[TestedType(typeof(EdiCommissionAgreementDatabasePivot))]
	class EdiCommissionAgreementDatabasePivotTest : EnterpriseBusinessObjectTestCase
	{
		[ExpectNoExceptions]
		public void TestPivotNotSaveForUncommittedDraftAgreement()
		{
			...
			customization.DatabasePivots.AddNew(database);
			Factory.Save();
		...
		protected override BusinessObject GetNewBusinessObjectForDeleteTest(BusinessObjectFactory factory)
		{
			...
			return customization.DatabasePivots.AddNew(database);
		}
	}
}
