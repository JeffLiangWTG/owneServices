...
{
	[TestedType(typeof(GenPivotSubscriber))]
	class GenPivotSubscriberTest : DataScienceAuditSubscriberTestBase<GenPivotSubscriber>
	{
		public override void TestCustomFilter()
		{
			var subscriber = new GenPivotSubscriber();
		...
		public void TestAuditSubscriberParameters()
		{
			...
			// Assert
			AssertEquals("DGP", subscriber.Code);
		...
		public void TestDataSchema()
		{
			...
			CombineAssertions(
				@"
The schema of the table GenPivot required by GenPivotSubscriber has changed.
