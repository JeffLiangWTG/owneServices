...
namespace Enterprise.Client.EDI.ScavengingImportServiceTask.Business
{
	...
	public abstract class AutoClientOrgImportHistoryLookups : ZLookups
	{
		protected AutoClientOrgImportHistoryLookups(AutoClientOrgImportHistory Parent) : base(Parent)
		{
		}
