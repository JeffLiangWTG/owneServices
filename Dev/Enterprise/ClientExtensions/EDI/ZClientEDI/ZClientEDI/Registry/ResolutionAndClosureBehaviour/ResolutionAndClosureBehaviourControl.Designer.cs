...
{
	partial class ResolutionAndClosureBehaviourControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.Grid2 = new Enterprise.Client.EDI.Registry.GUI.ResolutionAndClosureBehaviourGridControl();
			this.GroupBox1 = new Enterprise.ZArchitecture.GUI.ZGroupBox();
			this.Grid1 = new Enterprise.Client.EDI.Registry.GUI.ResolutionAndClosureBehaviourGridControl();
			...
			// 
			// ResolutionAndClosureBehaviourControl
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = false;
			this.Controls.Add(this.splitContainer1);
			this.Name = "ResolutionAndClosureBehaviourControl";
		...
		private ResolutionAndClosureBehaviourGridControl Grid1;
		private ResolutionAndClosureBehaviourGridControl Grid2;
