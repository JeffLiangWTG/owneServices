namespace Enterprise.Client.EDI.Messaging
{
	...
	public class EDIEDIInterchangeModule : EDIInterchangeModule
	{
		protected override FilterBusinessObject GetNewFilterBusinessObject()
		{
			return new EDIEDIInterchangeFilterBusinessObject();
		}
		...
		void DecodeMessage_Click(object sender, EventArgs e)
		{
			...
			{
				EDIInterchange ediInterchange = bizO as EDIInterchange;
				EHubMessageDecodeForm form = new EHubMessageDecodeForm(ediInterchange);
				form.Show();
			}
		}
	}
