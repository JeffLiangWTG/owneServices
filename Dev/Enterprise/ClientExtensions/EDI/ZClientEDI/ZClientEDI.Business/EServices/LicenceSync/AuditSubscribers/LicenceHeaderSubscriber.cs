...
{
	public class LicenceHeaderSubscriber : ActualDataChangesAuditSubscriber
	{
		public override string Code => "LSH";

		public override string Description => nameof(LicenceHeaderSubscriber);
