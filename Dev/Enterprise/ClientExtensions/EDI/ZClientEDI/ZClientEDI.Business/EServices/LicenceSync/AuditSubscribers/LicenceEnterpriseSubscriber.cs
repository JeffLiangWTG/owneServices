...
{
	public class LicenceEnterpriseSubscriber : ActualDataChangesAuditSubscriber
	{
		public override string Code => "LSE";

		public override string Description => nameof(LicenceEnterpriseSubscriber);
