...
{
	public class ClientWorkProjectSubscriber : ActualDataChangesAuditSubscriber
	{
		public override string Code => "LSP";

		public override string Description => nameof(ClientWorkProjectSubscriber);

		public override ITableSchema Table => ClientWorkProjectSchema.Instance;
