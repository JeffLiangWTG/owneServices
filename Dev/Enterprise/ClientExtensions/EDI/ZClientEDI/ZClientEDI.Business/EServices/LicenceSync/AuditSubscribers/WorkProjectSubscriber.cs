...
{
	public class WorkProjectSubscriber : ActualDataChangesAuditSubscriber
	{
		public override string Code => "LSW";

		public override string Description => nameof(WorkProjectSubscriber);

		public override ITableSchema Table => WorkProjectSchema.Instance;
