...
{
	public class LicenceDatabaseSubscriber : ActualDataChangesAuditSubscriber
	{
		public override string Code => "LSD";

		public override string Description => nameof(LicenceDatabaseSubscriber);
