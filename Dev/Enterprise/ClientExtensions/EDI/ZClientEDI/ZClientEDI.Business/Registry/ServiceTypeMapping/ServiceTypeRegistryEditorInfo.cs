...
{
	[RegistryEditor("Enterprise.Client.EDI.Registry.GUI.ServiceTypeRegistryEditor, ZClientEDI")]
	public class ServiceTypeRegistryEditorInfo : IRegistryEditorInfo
	{
		public ServiceTypeRegistryEditorInfo(ModuleListType moduleListType, ZBool isSourceModuleMappingsVisible)
		{
