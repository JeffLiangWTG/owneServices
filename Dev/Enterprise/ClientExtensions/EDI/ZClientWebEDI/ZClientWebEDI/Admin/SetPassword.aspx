<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetPassword.aspx.cs" Inherits="Enterprise.ZClientWebCargoWiseEDI.SetPassword" %>
...
<head runat="server">
	<title>CargoWise | My Account > Set Password</title>
		...
		<div id="login">
			...
			<div id="login-content">
				...
				<div class="login-row">
					...
					<edi:ZTextLabel ID="OrgCodeText" runat="server" Text="" Font-Bold="true"></edi:ZTextLabel>
				</div>
				...
				<div id="GoBackMessage" runat="server" visible="true">
					<p>
