...
{
	public class BadRequestWithErrorMessages : BadRequestErrorMessageResult
	{
		public BadRequestWithErrorMessages(ErrorMessages errorMessages, ApiController controller)
