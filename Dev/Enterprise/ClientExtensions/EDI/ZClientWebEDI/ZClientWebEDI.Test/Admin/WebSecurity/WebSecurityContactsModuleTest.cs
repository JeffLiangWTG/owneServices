...
{
	[TestedType(typeof(WebSecurityContactsModule))]
	public class WebSecurityContactsModuleTest : ZFilterStripGridModuleTestCase
	{
		...
		{
			var contact = (OrgContact)base.CreateNewElementForExcelExport();
		...
		protected override WebModuleID TestID => WebModuleIDs.CargoWiseEDIWebSecurityContacts;
		...
		protected override FilterLayoutCodePairRegistryItem ExpectedDefaultLayoutRegistryItem => EDIDataRegistry.Instance.DefaultFilterLayoutForWebSecurity;
