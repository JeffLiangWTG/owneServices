...
namespace Enterprise.Client.Testing
{
	...
	public class ClientOverrideTest : Enterprise.ZArchitecture.Modules.Testing.ClientOverrideTest
	{
		...
		public void TestClient()
		{
			...
			AssertEquals("Client type is supposed to be POW", typeof(Clients), overrideForClient.Client.GetType());
		}

		public void TestClientDisplayName()
		{
			ClientOverride overrideForClient = ClientOverride.Instance;
			AssertEquals("Incorrect client display name", "POW", overrideForClient.ClientDisplayName);
		}
