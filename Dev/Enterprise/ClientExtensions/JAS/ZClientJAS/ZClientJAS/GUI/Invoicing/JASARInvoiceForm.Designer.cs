...
{
	public partial class JASARInvoiceForm : InvoiceForm, IJXCExportForm
	{
		ZPanel zPanel1;
		...
		void InvoiceDetailsTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// 
			this.CashInvoiceOnCheckbox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 23, true);
			// 
			// ReceiptPaymentOuterPanel
			// 
			this.ReceiptPaymentOuterPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 358, true);
			this.ReceiptPaymentOuterPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 163, true);
			// 
			// MainPanel
			// 
			this.MainPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 358, true);
			// 
			// InvoiceDetails
			// 
			this.InvoiceDetails.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 232, true);
			// 
			// ChargeDetailsPanel
			// 
			this.ChargeDetailsPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 232, true);
