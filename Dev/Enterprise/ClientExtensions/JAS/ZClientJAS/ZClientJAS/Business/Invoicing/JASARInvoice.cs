...
{
	public class JASARInvoice : ARInvoice, IJASInvoicingBase
	{
		public JASARInvoice(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		}
		...
		protected virtual
 FinancialMessageExportHelper GetNewFinancialMessageExportHelper()
		{
		...
		{
			get { return ZArchitecture.Core.TransactionTypes.Invoice; }
		}
