...
{
	internal class SagARExternalInvoiceDataRow : SagFlatFileDataRow
	{
		public SagARExternalInvoiceDataRow() : base(SagARExternalInvoiceDataRow.Schema.FieldCapacity)
		{
		}
		...
		public static class Schema
		{
			...
			public static readonly FlatFileFieldProperty SaleControlnValueInBaseCurrency = new FlatFileFieldProperty(3, 256);
		...
		/// <summary>
		/// aka SaleControlnValueInBaseCurrency
		/// </summary>
		public ZDecimal SaleControlnValueInBaseCurrency
		{
			get { return GetFieldAsZDecimal(Schema.SaleControlnValueInBaseCurrency, 2); }
			set { SetField(Schema.SaleControlnValueInBaseCurrency, value); }
		}
