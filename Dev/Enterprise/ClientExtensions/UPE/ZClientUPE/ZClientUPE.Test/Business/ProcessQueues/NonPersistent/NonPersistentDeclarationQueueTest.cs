...
{
	[TestedType(typeof(NonPersistentDeclarationQueue))]
	internal class NonPersistentDeclarationQueueTest : NonPersistentCustomsQueueTestCase
	{
		...
		{
			var mockQueue = new Mock<NonPersistentDeclarationQueue>(new object[] { Factory });
			var queue = (NonPersistentProcessQueue)mockQueue.Object;
			var mockValidationHelper = new Mock<UPEDeclarationQueueValidationHelper>(new object[] { queue });
			mockQueue.Protected()
