...
{
	public class UPECusHAWBConsignorMatchApproval : CusHAWBConsignorMatchApproval
	{
		public UPECusHAWBConsignorMatchApproval(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		}
		...
		{
			get { return Parent.CS_RL_NKOrigin; }
		}
		...
		OrgMatchApprovalHelper Helper
		{
			get
			{
				if (fHelper == null)
				{
					...
					{ return Parent.Level1Record._300000; }, "Consignor");
				}
				return fHelper;
			}
		}
