...
{
	[TestedType(typeof(DP2ARTransExportGUIWrapper))]
	sealed class DP2ARTransExportGUIWrapperTest : NonPersistentBusinessObjectTestCase
	{
		public void TestFormCaption()
		{
			AssertEquals("Format Caption", "Export Transactions To DP2 File", GUIWrapper.FormCaption);
		}

		public void TestDataExporter()
		{
			AssertNotNull("Data Exporter", GUIWrapper.DataExporter);
			AssertEquals("Data Exporter", typeof(DP2ARInvoiceDataExporter), GUIWrapper.DataExporter.GetType());
		}
		...
		{
			DP2DataRegistry.Instance.ARTransExportDirectory = "1234";
		...
		{
			var dataHelper = new TransactionExportTestDataHelper(Factory);
		...
		{
			return new DP2ARTransExportGUIWrapper(Factory);
		}

#region Implementation
		DP2ARTransExportGUIWrapperForTest GUIWrapper;
		string ExportDirectory;
		string ExportedFile;
		protected override void SetUp()
		{
			base.SetUp();
			GUIWrapper = new DP2ARTransExportGUIWrapperForTest(Factory);
		...
		{
			DP2DataRegistry.Instance.ARTransExportDirectory = ExportDirectory;
...
#region Setup
		class DP2ARTransExportGUIWrapperForTest : DP2ARTransExportGUIWrapper
		{
			public DP2ARTransExportGUIWrapperForTest(BusinessObjectFactory factory) : base(factory)
			{
			}
