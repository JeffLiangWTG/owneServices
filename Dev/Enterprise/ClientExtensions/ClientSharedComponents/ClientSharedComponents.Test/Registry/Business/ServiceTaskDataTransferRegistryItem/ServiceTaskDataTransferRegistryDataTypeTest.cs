...
{
	[TestedType(typeof(ServiceTaskDataTransferRegistryDataType))]
	class ServiceTaskDataTransferRegistryDataTypeTest : NonPersistentBusinessObjectRegistryDataTypeTestCase<ServiceTaskDataTransferRegistryDataType>
	{
		protected override ServiceTaskDataTransferRegistryDataType GetNewDataType()
		{
			return new ServiceTaskDataTransferRegistryDataType();
		}

		protected override string ExpectedEditorName
		{
			get { return "ServiceTaskDataTransferRegistryItemEditor"; }
		}
