...
{
	[TestedType(typeof(BranchCodeMappingRegistryItemControl))]
	public class BranchCodeMappingRegistryItemControlTest : RegistryZUserControlTestCase
	{
		protected override bool IsControlOrBusinessEntityReadOnly(RegistryZUserControl control1, IBusiness businessEntity)
		{
			BranchCodeMappingRegistryItemControl control = (BranchCodeMappingRegistryItemControl)control1;
