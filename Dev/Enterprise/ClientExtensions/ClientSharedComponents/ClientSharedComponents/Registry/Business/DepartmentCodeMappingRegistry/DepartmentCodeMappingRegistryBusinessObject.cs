...
namespace Enterprise.ClientSharedComponents.Registry
{
	...
	public class DepartmentCodeMappingRegistryBusinessObject : RegistryBusinessObjectTemplate
	{
		public DepartmentCodeMappingRegistryBusinessObject()
			: base()
		{
		}

		public DepartmentCodeMappingRegistryBusinessObject(BusinessObjectFactory factory)
			: base(factory)
		{
		}
		...
		public void ValidateCodePK()
		{
			...
			{
				ListValidation.ErrorIfInvalidPK(CodePKInfo, DepartmentCodes);
			}
		}
		#endregion
		...
		public GlbDepartment CurrentCode
		{
			get
			{
				return CurrentFactory.Load<GlbDepartment>(CodePK);
			}
		}
		...
		public GlbDepartmentCollection DepartmentCodes
		{
			get
			{
				return departmentCodes ?? (departmentCodes = new GlbDepartmentCollection(CurrentFactory));
			}
		}
