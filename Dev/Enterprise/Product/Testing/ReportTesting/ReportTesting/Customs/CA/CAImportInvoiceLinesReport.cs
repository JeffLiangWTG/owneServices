namespace Enterprise.ReportTesting.Customs.CA
{
	...
	[TemplateName("CA Import Invoice Lines Report")]
	public class TestCAImportInvoiceLinesReport : TemplateTestCase
	{
		[ExpectNoExceptions]
		[StressTest]
		[TestDate(2006, 12, 25)]
	...
	public class TestCAImportInvoiceLinesReportMenuSetup : ReportTestCase
	{
		...
		{
			get { return "CA Import Invoice Lines Report"; }
		}

		public override string Hint
		{
			get { return "This report makes import (B2, IMP, LVS, LVX, MSC) declaration invoice line information available."; }
		}

		protected override TemplateTestCase GetTemplateTestCase()
		{
			return new TestCAImportInvoiceLinesReport();
		}
