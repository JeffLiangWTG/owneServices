namespace Enterprise.ReportTesting.Customs.Shared
{
	...
	[TemplateName("Customs Entries by Broker Report")]
	public class TestCustomsEntriesLodgedbyBrokerReport : TemplateTestCase
	{
	}

	public class TestCustomsEntriesLodgedbyBrokerReportMenuSetup : ReportTestCase
	{
		...
		{
			get { return "Customs Entries Lodged by Broker Report"; }
		}
		...
		{
			return new TestCustomsEntriesLodgedbyBrokerReport();
		}
	}
}
