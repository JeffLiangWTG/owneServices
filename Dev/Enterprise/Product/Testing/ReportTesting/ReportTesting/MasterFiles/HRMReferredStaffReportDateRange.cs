...
{
	[TemplateName("HRM Referred Staff Report (Date Range)")]
	public class HRMReferredStaffReportDateRangeTemplateTest : TemplateTestCase
	{
		public void TestOnlyIncludeStaffEmployedWithinDateRange()
		{
			...
			_ = CreateStaff(person1, "teststaff01", "TS1", new DateTime(2022, 12, 12), null, "Test Staff Full Name 01", "AU");
			_ = CreateStaff(person2, "teststaff02", "TS2", new DateTime(2022, 12, 1), null, "Test Staff Full Name 02", "US");
			...
			_ = CreateStaff(person7, "teststaff07", "TS7", new DateTime(2021, 12, 12), null, "Test Staff Full Name 07", "FR");
			...
			((DateField)Report.FilterCollection["Report Start Date"]).Value = new ZDate(2022, 11, 11);
			((DateField)Report.FilterCollection["Report End Date"]).Value = new ZDate(2023, 1, 1);
			...
			using (var excelInterface = new ExcelInterface())
			{
				...
				AssertEquals(new DateTime(2022, 12, 12), DateTime.FromOADate((double)sheetContent[4, 2]));
				AssertEquals(string.Empty, sheetContent[4, 3]);
				AssertEquals("TS1", sheetContent[4, 4].ToString());
				AssertEquals("Test Staff Full Name 01", sheetContent[4, 5].ToString());
				AssertEquals("TS4", sheetContent[4, 6].ToString());
				AssertEquals("Test Staff Full Name 04", sheetContent[4, 7].ToString());
				AssertEquals("Japan", sheetContent[4, 8].ToString());

				AssertEquals(new DateTime(2022, 12, 1), DateTime.FromOADate((double)sheetContent[5, 2]));
				AssertEquals(string.Empty, sheetContent[5, 3]);
				AssertEquals("TS2", sheetContent[5, 4].ToString());
				AssertEquals("Test Staff Full Name 02", sheetContent[5, 5].ToString());
				AssertEquals("TS5", sheetContent[5, 6].ToString());
				AssertEquals("Test Staff Full Name 05", sheetContent[5, 7].ToString());
				AssertEquals("China", sheetContent[5, 8].ToString());

				AssertNotContains("TS7", sheetContent.ToString());
			}
		}

		public void TestDoNotShowNonSTFTypeApplications()
		{
			PrepareReportForRender();
			FillReportWithDefaultValues();
			...
			_ = CreateStaff(person1, "teststaff01", "TS1", new DateTime(2022, 12, 12), new DateTime(2029, 12, 12), "Test Staff Full Name 01", "AU");
			_ = CreateStaff(person2, "teststaff02", "TS2", new DateTime(2022, 12, 12), null, "Test Staff Full Name 02", "US");
			_ = CreateStaff(person3, "teststaff03", "TS3", new DateTime(2022, 12, 12), null, "Test Staff Full Name 03", "UK");
		...
		public void TestDoNotIncludeStaffNotProbationedOrProbationedNotWithinDateRange()
		{
			PrepareReportForRender();
			FillReportWithDefaultValues();
			...
			_ = CreateStaff(person1, "teststaff01", "TS1", new DateTime(2001, 11, 11), null, "Test Staff Full Name 01", "AU");
			_ = CreateStaff(person2, "teststaff02", "TS2", new DateTime(2001, 11, 11), new DateTime(2022, 12, 12), "Test Staff Full Name 02", "US");
			_ = CreateStaff(person3, "teststaff03", "TS3", new DateTime(2001, 11, 11), new DateTime(2023, 12, 12), "Test Staff Full Name 03", "UK");
