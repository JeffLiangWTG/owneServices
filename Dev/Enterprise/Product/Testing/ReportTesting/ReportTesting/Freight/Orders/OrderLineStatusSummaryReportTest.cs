namespace Enterprise.ReportTesting.Freight.Orders
{
	...
	[TemplateName("Client - Order Line Report")]
	public class TestClientOrderLineStatusSummaryReport : TemplateTestCase
	{
	}

	public class OrderLineStatusSummaryMenuSetupTest : ReportTestCase
	{
		...
		{
			get { return @"Client - Order Lines"; }
		}

		protected override TemplateTestCase GetTemplateTestCase()
		{
			return new TestClientOrderLineStatusSummaryReport();
		}
...
@"The Client Order Line Report shows order line details for a selected Client.  
