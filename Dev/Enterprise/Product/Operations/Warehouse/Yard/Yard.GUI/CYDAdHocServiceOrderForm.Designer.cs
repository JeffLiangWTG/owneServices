...
{
	partial class CYDAdHocServiceOrderForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			this.Text = Res.GetString("fa588805-460e-48e7-b757-6c4ffb56f3fd", "Service Order Form");
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.Yard.Business.CYDAdHocServiceOrder);
