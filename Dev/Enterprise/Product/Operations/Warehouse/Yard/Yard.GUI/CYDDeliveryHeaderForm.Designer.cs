...
{
	partial class CYDDeliveryHeaderForm : ZTemplateForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			this.Text = Res.GetString("e320c982-5893-4904-a847-90744a4170f3", "Bulk runs in Form");
			// 
			// MainTabControl
			//
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.Yard.Business.CYDDeliveryHeader);
			// 
			// zWorkflowTabPage
			// 
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.Yard.Business.CYDDeliveryHeader);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1220, 725, true);
			this.Name = "CYDDeliveryHeader";
		...
		private void MainTabPageInitializeTab(object sender, EventArgs e)
		{
			...
			this.GlowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Yard.GUI.Res.GetData("23a90ed8-6d6b-47da-b967-d2b173999682", "Bulk runs in data can only be accessed via the Container Yard GLOW Portal.");
