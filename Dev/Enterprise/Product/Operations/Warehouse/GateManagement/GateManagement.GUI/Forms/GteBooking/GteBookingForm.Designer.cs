...
{
	partial class GteBookingForm : ZTemplateForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.GateManagement.Business.GteBooking);
			// 
			// GlowLinkLabel
			// 
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.GateManagement.Business.GteBooking);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1220, 725, true);
			this.Name = "GteBookingForm";
