...
{
	partial class GteGateMovementBookingForm : ZTemplateForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.GateManagement.Business.GteGateMovementBooking);
			// 
			// GlowLinkLabel
			// 
			this.GlowLinkLabel.AutoSize = true;
			this.GlowLinkLabel.CaptionResourceString = Enterprise.Warehouse.GateManagement.GUI.Res.GetData("797c0307-4828-4173-a960-da9d46d4171c", "Gate bookings can only be accessed via the Gate Management Portal.");
