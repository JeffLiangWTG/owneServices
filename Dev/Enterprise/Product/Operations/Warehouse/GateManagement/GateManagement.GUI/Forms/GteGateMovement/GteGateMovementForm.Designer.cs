...
{
	partial class GteGateMovementForm : ZTemplateForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			this.GlowLinkLabel.CaptionResourceString = Enterprise.Warehouse.GateManagement.GUI.Res.GetData("8ae62ea9-a7f2-46b4-a070-2db7b3d0d319", "Gate movements can only be accessed via the Gate Management Portal.");
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.GateManagement.Business.GteGateMovement);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1220, 725, true);
			this.Name = "GteGateMovementForm";
