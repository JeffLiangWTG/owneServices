...
{
	[TestedType(typeof(GteBookingWorkflowDescriptor))]
	public class GteBookingWorkflowDescriptorTest : WorkflowDescriptorTestCase<GteBookingWorkflowDescriptor>
	{
		...
		{
			AssertEquals(WorkflowDescriptors.GteBookingWorkflowDescriptorCode, WorkflowDescriptor.Code);
		}
		...
		protected override IWorkflowProvider[] GetParentsWithConfiguredOrganisationPartiesForTest()
		{
			...
			bookingPartyMode.EK_Module = WorkflowDescriptors.GteBookingWorkflowDescriptorCode;
			...
			bookingPartyMode2.EK_Module = WorkflowDescriptors.GteBookingWorkflowDescriptorCode;
		...
		{
			var booking = workflowProvider as GteBooking;
			if (booking != null)
			{
		...
		public void TestGetMessageRecipientPartyCollectionIncludesBookingPartyWhenExists()
		{
			...
			var recipients = WorkflowDescriptor.GetMessageRecipientParty(booking, MessageRecipientPartyTypeList.Codes.BookingParty);
		...
		public void TestGetMessageRecipientPartyCollection_GivenArrivalTransitWarehousePartyType_ReturnsCorrectTransitWarehouseOrganisation()
		{
			...
			booking.GBK_WW_Facility = facility.PK;
			var recipients = WorkflowDescriptor.GetMessageRecipientParty(booking, MessageRecipientPartyTypeList.Codes.ArrivalTransitWarehouse);
			...
			recipients = WorkflowDescriptor.GetMessageRecipientParty(booking, MessageRecipientPartyTypeList.Codes.ArrivalTransitWarehouse);
		...
		public void TestGetMessageRecipientPartyCollection_GivenContainerYardPartyType_ReturnsCorrectContainerYardOrg()
		{
			...
			booking.GBK_WW_Facility = facility.PK;
			var recipients = WorkflowDescriptor.GetMessageRecipientParty(booking, MessageRecipientPartyTypeList.Codes.ContainerYard);
			...
			recipients = WorkflowDescriptor.GetMessageRecipientParty(booking, MessageRecipientPartyTypeList.Codes.ContainerYard);
