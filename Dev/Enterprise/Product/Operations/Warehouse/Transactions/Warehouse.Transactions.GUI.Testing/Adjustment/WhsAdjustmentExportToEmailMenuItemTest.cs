...
{
	public class WhsAdjustmentExportToEmailMenuItemTest : WhsDocketExportToEmailMenuItemTest<WhsAdjustment, Xsd.WhsDocket>
	{
		#region Overrides
		...
		{
			return new WhsAdjustmentExportToEmailMenuItem(Docket, (WhsAdjustmentValueObjectDataAdapter)Adapter);
		}

		protected override Type GetExpectedExportDirectorType()
		{
			return typeof(WhsAdjustmentXmlExportToEmailDirector);
		}
