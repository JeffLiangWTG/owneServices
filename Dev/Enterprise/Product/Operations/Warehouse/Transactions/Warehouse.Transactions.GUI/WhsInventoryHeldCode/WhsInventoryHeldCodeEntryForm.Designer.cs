...
{
	partial class WhsInventoryHeldCodeEntryForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// MainTabControl
			// 
			this.MainTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(623, 227, true);
			this.MainTabControl.TabIndex = 0;
			// 
			// MainTabPage
			// 
			this.MainTabPage.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(3, 20, true);
			this.MainTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(617, 204, true);
			...
			this.LogsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(450, 204, true);
			// 
			// MainPanel
			// 
			this.MainPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(623, 227, true);
			// 
			// MainStatusBar
			// 
			...
			// 
			// WhsInventoryHeldCodeEntryForm
			// 
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(623, 227, true);
			this.DataSourceType = typeof(Enterprise.Warehouse.Transactions.Business.WhsInventoryHeldCode);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(470, 320, true);
			this.Name = "WhsInventoryHeldCodeEntryForm";
		...
		ZArchitecture.ZTranslatableTextControl descriptionTextBox;
		Enterprise.MasterFiles.GUI.ZOrganisationFindBox clientFindBox;
		ZArchitecture.GUI.ZCheckBox zCheckBox1;
	}
}
