...
{
	partial class WhsDocumentInventoryOptionsForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions);
			// 
			// CancelPrintButton
			// 
			...
			this.CancelPrintButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(362, 132, true);
			...
			this.PrintButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(283, 132, true);
			...
			this.BindingSource.SetBindingMember(this.DocketLabelLinesGrid, "DocumentInventories");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions)(null)).DocumentInventories)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventory)(((System.Collections.IList)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions)(null)).DocumentInventories)).SyncRoot)).Inventory.WI_OP)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventory)(((System.Collections.IList)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions)(null)).DocumentInventories)).SyncRoot)).LabelsToPrint)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventory)(((System.Collections.IList)(((Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions)(null)).DocumentInventories)).SyncRoot)).TotalLabelsToPrintFrom)));
			...
			zGuidFindBoxColumnStyleInfo1.ColumnName = "Inventory+WI_OP";
			...
			zCalcEditColumnStyleInfo1.ColumnName = "LabelsToPrint";
			...
			zCalcEditColumnStyleInfo2.ColumnName = "TotalLabelsToPrintFrom";
			...
			this.DocketLabelLinesGrid.ColumnStyles.Add(zGuidFindBoxColumnStyleInfo1);
			...
			this.DocketLabelLinesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(428, 108, true);
			this.DocketLabelLinesGrid.TabIndex = 1;
			// 
			// WhsDocumentInventoryOptionsForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CancelButton = this.CancelPrintButton;
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(447, 186, true);
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions);
			this.DataSourceTypeName = "Enterprise.Warehouse.Transactions.Business.WhsDocumentInventoryOptions";
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle;
			this.MinimizeBox = false;
			this.Name = "WhsDocumentInventoryOptionsForm";
