// This file tests CargoWise.DbUpgrader\src\Scripts\Scripts.Definitions\Warehouse\WhsWarehouseUNDGTotalsByCountryReference.sql
...
{
	class WhsWarehouseUNDGTotalsByCountryReferenceTest : WhsTestCaseWithFactory
	{
		...
		public void TestNoUNDGStock_OtherSubstanceHasStock()
		{
			...
			data.Whs1.WW_DGThresholdPercentage = 80;
			var substance = UNDGSubstanceLoader.LoadSubstances(Factory, "0004", "a", "IMO").FirstOrDefault();
			var countryReference1 = Helper.CreateCountryReference(referenceCode: "DCR1");
			var countryReference2 = Helper.CreateCountryReference(referenceCode: "DCR2");
			Helper.CreateCountryReferencePivot(countryReference1, substance);
			Helper.CreateUNDGDataItem(data.Part1, substance, 2m, "KG", 3m, "M3", substance.DG_Class);
			Helper.CreateWhsReceiveWithInventory(data.Org1, data.Whs1, "R1", data.Part1, 10m);
			Factory.Save();

			// Act
			var results = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, data.Whs1.PK, countryReference2.PK);
		...
		public void TestHasUNDGStock_MultipleSubstance_SameUQ()
		{
			...
			Helper.CreateUNDGDataItem(data.Part1, substance1, 1m, "DT", 2m, "CC", substance1.DG_Class);
			Helper.CreateUNDGDataItem(data.Part1, substance2, 3m, "DT", 4m, "CC", substance2.DG_Class);
			Helper.CreateWhsReceiveWithInventory(data.Org1, data.Whs1, "R1", data.Part1, 10m);
			Factory.Save();
		...
		public void TestHasUNDGStock_MultipleSubstance_DifferentUQ()
		{
			...
			Helper.CreateCountryReferencePivot(countryReference, substance2);
			Helper.CreateUNDGDataItem(data.Part1, substance1, 1m, "DT", 2m, "CC", substance1.DG_Class);
			Helper.CreateUNDGDataItem(data.Part1, substance2, 3m, "G", 4m, "CF", substance2.DG_Class);
			Helper.CreateWhsReceiveWithInventory(data.Org1, data.Whs1, "R1", data.Part1, 10m);
			Factory.Save();
		...
		public void TestHasUNDGStock_SubstanceNotInTableZZUNDGSubstance()
		{
			// Arrange
			var data = new TestDataSimpleEnvironment(Factory);
			data.Whs1.WW_IsDangerousGoodsManagementEnabled = true;
		...
		public void TestUNDGStock_InnerTransfer_Entered()
		{
			...
			var resultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, data.Whs1.PK, countryReference.PK);
			...
			var resultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, data.Whs1.PK, countryReference.PK);
		...
		public void TestUNDGStock_InterWarehouseTransferSource_Entered()
		{
			...
			var whs1ResultBeforeTransferEntered = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs1.PK, countryReference.PK);
			...
			var whs2ResultBeforeTransferEntered = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs2.PK, countryReference.PK);
			...
			// Assert
			var whs1ResultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs1.PK, countryReference.PK);
			AssertEquals(1, whs1ResultAfterTransfer.Count);
			AssertQueryResult(whs1ResultBeforeTransferEntered.ElementAt(0), 20, "KG", 30, "M3");

			var whs2ResultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs2.PK, countryReference.PK);
		...
		public void TestUNDGStock_InterWarehouseTransferSource_Picked()
		{
			...
			var whs1ResultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs1.PK, countryReference.PK);
			AssertEquals(1, whs1ResultBeforeTransfer.Count);
			AssertQueryResult(whs1ResultBeforeTransfer.ElementAt(0), 20, "KG", 30, "M3");

			var whs2ResultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, whs2.PK, countryReference.PK);
		...
		public void TestUNDGStock_AdjustmentIn_Finalised()
		{
			...
			var resultBeforeAdjustment = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, data.Whs1.PK, countryReference.PK);
			...
			// Assert
			var resultAfterAdjustment = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByCountryReference(Factory, data.Whs1.PK, countryReference.PK);
