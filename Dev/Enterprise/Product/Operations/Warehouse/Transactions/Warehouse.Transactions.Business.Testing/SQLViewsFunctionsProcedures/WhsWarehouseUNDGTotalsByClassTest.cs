// This file tests CargoWise.DbUpgrader\src\Scripts\Scripts.Definitions\Warehouse\WhsWarehouseUNDGTotalsByClass.sql
...
{
	class WhsWarehouseUNDGTotalsByClassTest : WhsTestCaseWithFactory
	{
		...
		public void TestNoUNDGStock()
		{
			...
			// Act
			var results = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "1");
		...
		public void TestNoUNDGStock_OtherSubstanceHasStock()
		{
			...
			// Act
			var results = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "2");
		...
		public void TestUNDGStock_InnerTransfer_Entered()
		{
			...
			var resultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "1");
			...
			var resultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "1");
		...
		public void TestUNDGStock_InterWarehouseTransferSource_Entered()
		{
			...
			var whs1ResultBeforeTransferEntered = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs1.PK, "1");
			...
			var whs2ResultBeforeTransferEntered = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs2.PK, "1");
			...
			// Assert
			var whs1ResultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs1.PK, "1");
			AssertEquals(1, whs1ResultAfterTransfer.Count);
			AssertQueryResult(whs1ResultBeforeTransferEntered.ElementAt(0), 20, "KG", 30, "M3");

			var whs2ResultAfterTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs2.PK, "1");
		...
		public void TestUNDGStock_InterWarehouseTransferSource_Picked()
		{
			...
			var whs1ResultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs1.PK, "1");
			AssertEquals(1, whs1ResultBeforeTransfer.Count);
			AssertQueryResult(whs1ResultBeforeTransfer.ElementAt(0), 20, "KG", 30, "M3");

			var whs2ResultBeforeTransfer = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, whs2.PK, "1");
		...
		public void TestUNDGStock_AdjustmentIn_Finalised()
		{
			...
			var resultBeforeAdjustment = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "1");
			...
			// Assert
			var resultAfterAdjustment = WhsWarehouseUNDGTotalsHelper.LoadWhsWarehouseUNDGTotalsByClass(Factory, data.Whs1.PK, "1");
