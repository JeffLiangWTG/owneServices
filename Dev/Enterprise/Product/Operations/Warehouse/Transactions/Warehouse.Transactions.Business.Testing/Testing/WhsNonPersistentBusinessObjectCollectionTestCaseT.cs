...
{
	public abstract class WhsNonPersistentBusinessObjectCollectionTestCase<T> : Environment.Business.Testing.WhsNonPersistentBusinessObjectCollectionTestCase<T> where T : INonPersistentBusinessObjectCollection
	{
