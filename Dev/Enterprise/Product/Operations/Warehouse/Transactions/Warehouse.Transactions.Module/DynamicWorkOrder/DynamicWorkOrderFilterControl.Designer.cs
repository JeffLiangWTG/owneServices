...
{
	public partial class DynamicWorkOrderFilterControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((WhsDynamicWorkOrder)(null)))));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((WhsDynamicWorkOrder)(null)).WD_OH_Client)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((WhsDynamicWorkOrder)(null)).Lookups.Clients)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((WhsDynamicWorkOrder)(null)).WD_WW_Whs)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_ExternalReference)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_DocketID)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZDateTimeOffset)(((WhsDynamicWorkOrder)(null)).WD_BookingDate)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_DocketStatusDescription)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZDateTime)(((WhsDynamicWorkOrder)(null)).RequiredDate)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZDateTimeOffset)(((WhsDynamicWorkOrder)(null)).WD_FinalisedDate)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_DocketSubType)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).Pick.WP_PickNo)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((WhsDynamicWorkOrder)(null)).WD_TotalUnits)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((WhsDynamicWorkOrder)(null)).WD_TotalWeight)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_TotalWeightUnit)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((WhsDynamicWorkOrder)(null)).WD_TotalCubic)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).WD_TotalCubicUnit)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((WhsDynamicWorkOrder)(null)).WD_ExternalReferenceSplit)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((WhsDynamicWorkOrder)(null)).ClientName)));
			...
			zCalcEditColumnStyleInfo4.CaptionResourceString = Enterprise.Warehouse.Transactions.Module.Res.GetData("WorkOrderFilterControl|2e83bd8b-9c0d-4f4e-a1e9-93489b5011a0", "Split", "Split No.", "");
			...
			zTextBoxColumnStyleInfo8.ColumnName = "ClientName";
			...
			// 
			// DynamicWorkOrderFilterControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Name = "DynamicWorkOrderFilterControl";
