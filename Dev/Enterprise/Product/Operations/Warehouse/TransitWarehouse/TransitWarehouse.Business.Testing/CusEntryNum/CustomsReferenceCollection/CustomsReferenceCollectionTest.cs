...
{
	[TestedType(typeof(CustomsReferenceCollection))]
	public class CustomsReferenceCollectionTest : ActiveBusinessObjectCollectionTestCase<CustomsReferenceCollection>
	{
		public void TestDefaultValues()
		{
			var bizObj = Factory.New<DummyBusinessObject>();
			var numbers = new CustomsReferenceCollection(bizObj);
		...
		public void TestLoadAfterSave()
		{
			...
			var loadedCustomsReferences = new CustomsReferenceCollection(loadedBizObj);
			...
			AssertEquals($"Category is {TransitWarehouseReferenceCategories.Codes.PortReference}",
				CusEntryNumber.Categories.CustomsPermitClearanceNumber, customsReference.CE_Category);
		...
		protected override CustomsReferenceCollection GetCollectionToTest()
		{
			var bizObj = Factory.New<DummyBusinessObject>();
			return new CustomsReferenceCollection(bizObj);
		}
