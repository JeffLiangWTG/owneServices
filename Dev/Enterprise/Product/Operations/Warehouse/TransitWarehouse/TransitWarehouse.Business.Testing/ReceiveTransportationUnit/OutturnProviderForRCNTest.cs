...
{
	public class OutturnProviderForRCNTest : TestCaseWithFactory
	{
		...
		public void TestOverriddenAviationSecurityInspectionType()
		{
			...
			IOutturnProvider outturnProvider1 = new OutturnProviderForRCN(package1);
			var package2 = packageState2.Package;
			IOutturnProvider outturnProvider2 = new OutturnProviderForRCN(package2);
