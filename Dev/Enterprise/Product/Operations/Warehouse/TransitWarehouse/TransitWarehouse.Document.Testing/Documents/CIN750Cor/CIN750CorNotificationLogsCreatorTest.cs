...
{
	public class CIN750CorNotificationLogsCreatorTest : TestCaseWithFactory
	{
		...
		public void TestCreateMessageSentLog()
		{
			...
			var logCreator = new CIN750CorNotificationLogsCreator();
			logCreator.CreateMessageSentLog(logParent, data, "CIN750CorNotification", "Bollore");
			...
			AssertEquals("MSN logs parameters for sent CIN 750 Cor Notification", "|ARG=241210143301000|HBL=-|JOB=RC0000001|MBL=-|MST=CIN750CorNotification|OTY=5|PTP=REF|RFN=EDIDATRC0000001|WGT=10.000", msnEvents.Single().SL_Reference);
		}
		...
		public void TestCreateWithdrawalSentLog()
		{
			...
			var logCreator = new CIN750CorNotificationLogsCreator();
			AssertEquals(false, logCreator.CreateWithdrawalSentLog(logParent, data, "CIN750CorNotification", "Bollore", "Test Reason"));
		}
