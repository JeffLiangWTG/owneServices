...
{
	partial class DispatchLoadListForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// 
			// DispatchLoadListForm
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1204, 686, true);
			this.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemDispatchLoadList);
		...
		private void MainTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// zTextBox1
			// 
			this.BindingSource.SetBindingMember(this.zTextBox1, "WDL_JobID");
			this.zTextBox1.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("7d55b27d-36cc-42d1-bc47-e6917664d6de", "DLL ID");
			this.zTextBox1.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(126, 16, true);
			...
			// zTextBox2
			// 
			this.BindingSource.SetBindingMember(this.zTextBox2, "WDL_ReferenceNumber");
			this.zTextBox2.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("a50d2d4c-060f-46bd-a173-195d61d14fad", "Reference Number");
			this.zTextBox2.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(126, 46, true);
			this.zTextBox2.Name = "zTextBox2";
			this.zTextBox2.ReadOnly = true;
			this.zTextBox2.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(185, 20, true);
			this.zTextBox2.TabIndex = 5;
			// 
			// glowLinkLabel
			// 
			this.glowLinkLabel.AutoSize = true;
			this.glowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("602cb539-df2d-4f0d-923b-1be73d3131b5", "Dispatch Load List Details can only be accessed via the Transit Warehouse Desktop Portal.");
