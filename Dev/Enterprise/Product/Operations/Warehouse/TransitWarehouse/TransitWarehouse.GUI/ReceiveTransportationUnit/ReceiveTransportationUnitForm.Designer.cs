...
{
	partial class ReceiveTransportationUnitForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemReceiveTransportationUnit);
		...
		private void MainTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// WaybillTextBox
			// 
			this.BindingSource.SetBindingMember(this.WaybillTextBox, "WRH_ReferenceNumber");
			this.WaybillTextBox.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("7f1c3fd8-16a4-491f-b1d6-bddf8c68178a", "RTU ID");
			...
			// zTextBox1
			// 
			this.BindingSource.SetBindingMember(this.zTextBox1, "WRH_VehicleReference");
			this.zTextBox1.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("49e8095d-2daa-44d8-b737-83492d6dd475", "RTU Reference");
			...
			this.glowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("3683f05a-cd3a-4bf3-ad82-cf225edda003", "Receive Transportation Unit Details can only be accessed via the Transit Warehouse Desktop Portal.");
