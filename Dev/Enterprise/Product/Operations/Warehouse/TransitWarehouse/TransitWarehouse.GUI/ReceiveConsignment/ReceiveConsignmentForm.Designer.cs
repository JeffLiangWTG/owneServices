...
{
	partial class ReceiveConsignmentForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemReceiveConsignment);
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Warehouse.Transit.Business.WhsItemReceiveConsignment)(null)).WRC_JobID)));
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Warehouse.Transit.Business.WhsItemReceiveConsignment)(null)).WRC_ConsignmentID)));
			// 
			// zTabPage1
			// 
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemReceiveConsignment);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1220, 725, true);
			this.Name = "ReceiveConsignmentForm";
		...
		private void MainTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// WaybillTextBox
			// 
			this.BindingSource.SetBindingMember(this.WaybillTextBox, "WRC_JobID");
			this.WaybillTextBox.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("59b3d275-5956-4ad4-9df0-0dc8b9677e11", "RCN ID");
			...
			// zTextBox1
			// 
			this.BindingSource.SetBindingMember(this.zTextBox1, "WRC_ConsignmentID");
			this.zTextBox1.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("c878ed9e-f1f6-4121-8fcc-cbc7a5a682e9", "RCN Reference");
			...
			this.glowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("99ae8aaa-6afe-42a0-a565-05c0aabb18a4", "Receive Consignment Details can only be accessed via the Transit Warehouse Desktop Portal.");
