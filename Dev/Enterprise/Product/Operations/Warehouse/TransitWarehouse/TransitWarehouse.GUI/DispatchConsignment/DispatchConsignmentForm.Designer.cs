...
{
	partial class DispatchConsignmentForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemDispatchConsignment);
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Warehouse.Transit.Business.WhsItemDispatchConsignment)(null)).WDC_JobID)));
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Warehouse.Transit.Business.WhsItemDispatchConsignment)(null)).WDC_ConsignmentID)));
			// 
			// zWorkflowTabPage
			// 
			...
			this.DataSourceType = typeof(Enterprise.Warehouse.Transit.Business.WhsItemDispatchConsignment);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1220, 725, true);
			this.Name = "DispatchConsignmentForm";
		...
		private void MainTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// WaybillTextBox
			// 
			this.BindingSource.SetBindingMember(this.WaybillTextBox, "WDC_JobID");
			this.WaybillTextBox.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("2bb50bdf-cff7-4e2f-a274-18a480db3d38", "DCN ID");
			this.WaybillTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(107, 16, true);
			this.WaybillTextBox.Name = "WaybillTextBox";
			this.WaybillTextBox.ReadOnly = true;
			this.WaybillTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(204, 20, true);
			this.WaybillTextBox.TabIndex = 5;
			// 
			// zTextBox1
			// 
			this.BindingSource.SetBindingMember(this.zTextBox1, "WDC_ConsignmentID");
			this.zTextBox1.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("1eba7470-09e5-4c2f-b22c-29a15c09e156", "DCN Reference");
			this.zTextBox1.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(107, 42, true);
			this.zTextBox1.Name = "zTextBox1";
			this.zTextBox1.ReadOnly = true;
			this.zTextBox1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(204, 20, true);
			this.zTextBox1.TabIndex = 6;
			// 
			// glowLinkLabel
			// 
			this.glowLinkLabel.AutoSize = true;
			this.glowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("efb7965e-3016-48d8-8da3-81d59c79941c", "Dispatch Consignment Details can only be accessed via the Transit Warehouse Desktop Portal.");
			this.glowLinkLabel.IsFontBold = false;
			this.glowLinkLabel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(104, 69, true);
			this.glowLinkLabel.Name = "glowLinkLabel";
			this.glowLinkLabel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(460, 13, true);
