...
namespace Enterprise.Warehouse.Transit.GUI
{
	partial class ReceiveASNForm
	{
		...
		private void MainTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// WaybillTextBox
			// 
			this.BindingSource.SetBindingMember(this.WaybillTextBox, "WRP_ReferenceNumber");
			this.WaybillTextBox.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("c80d47f0-681d-40c0-befe-fb4e517f7373", "ASN ID");
			...
			// zTextBox1
			// 
			this.BindingSource.SetBindingMember(this.zTextBox1, "WRP_VehicleReference");
			this.zTextBox1.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("cee26b0b-c5b3-4e9d-847d-7159208365e8", "ASN Reference");
			...
			this.glowLinkLabel.CaptionResourceString = Enterprise.Warehouse.Transit.GUI.Res.GetData("e3f31d82-f4d4-4c04-9477-fec7cfeb548d", "Receive ASN Details can only be accessed via the Transit Warehouse Desktop Portal.");
