...
{
	class AssignToteForOrderDirectedPackingTest : WhsSecureServiceTestCase
	{
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking()
		{
			TestAssignToteForOrderDirectedPackingCore(allowDDLOverride: false);
		}

		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_OverrideDDL()
		{
			TestAssignToteForOrderDirectedPackingCore(allowDDLOverride: true);
		}

		void TestAssignToteForOrderDirectedPackingCore(bool allowDDLOverride)
		{
			...
			var response = webService.AssignToteForOrderDirectedPacking("ABC", order.PK.ToGuid());
			...
			AssertPackageInfo(
				...
				isUsingDirectedPackingConsolidation: true,
				allowDockDoorOverride: allowDDLOverride);
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackingInfoIsCorrect_IsUsingCarrierLabelIntegration()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			AssertEquals(response.IsInvalidToteId, false);
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly, isUsingCarrierLabelIntegration: true);
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackingInfoIsCorrect_OrgMiscServRelatedInfo()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			AssertEquals(response.IsInvalidToteId, false);
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly, packageWeightTolerance: 10m, packageWeightToleranceEnabled: true);
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackingInfoIsCorrect_ClientPickPackParamsRelatedInfo()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			AssertEquals(response.IsInvalidToteId, false);
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly, isUsingCartonSizes: false);
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackingInfoIsCorrect_RefPackTypeRelatedInfo()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			var toteRefPackType = Factory.Load<RefPackType>(new ZQuery(RefPackTypeSchema.F3_Code, PkgUnit.Tote)).Single();
			toteRefPackType.F3_Height = 1m;
			toteRefPackType.F3_Length = 2m;
			toteRefPackType.F3_Width = 3m;
			toteRefPackType.F3_UnitOfDimension = Length.Feet;
			toteRefPackType.F3_Weight = 4m;
			toteRefPackType.F3_UnitOfWeight = Weight.Pounds;
			Factory.Save();
			...
			AssertEquals(response.IsInvalidToteId, false);
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly, toteRefPackType: toteRefPackType);

			var productInfos = response.ProductInfos;
			AssertEquals("Should have 1 product related to this package.", 1, productInfos.Length);
		}

		public void TestAssignToteForOrderDirectedPacking_EmptyId()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			Factory.Save();
			...
			var webService = GetNewWebService(data.Whs1, staff: user);
			var response = webService.AssignToteForOrderDirectedPacking("", Guid.Empty);
			...
			AssertEquals(response.IsInvalidToteId, true);
		}

		public void TestAssignToteForOrderDirectedPacking_NullOrder()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			Factory.Save();
		...
		public void TestAssignToteForOrderDirectedPacking_NotAnOrder()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			Factory.Save();
			...
			var webService = GetNewWebService(data.Whs1, staff: user);
			var response = webService.AssignToteForOrderDirectedPacking("ABC", receive.PK.ToGuid());
			AssertEquals("Should error.", ErrorTypes.BusinessValidationError, response.Error);
			AssertEquals("Should be error.", "Order does not exist.", response.ErrorMessage);
			AssertEquals(response.IsInvalidToteId, false);
		}

		public void TestAssignToteForOrderDirectedPacking_PackageExists_NonTote()
		{
			TestAssignToteForOrderDirectedPacking_PackageExistsCore(isTote: false, "A non Tote Package on the order was found using Package ID 'ABC' already.");
		}

		public void TestAssignToteForOrderDirectedPacking_PackageExists_Tote()
		{
			TestAssignToteForOrderDirectedPacking_PackageExistsCore(isTote: true, "Tote 'ABC' is already used on this order, select another Tote.");
		}

		void TestAssignToteForOrderDirectedPacking_PackageExistsCore(bool isTote, string expectedErrorMessage)
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			Factory.Save();
		...
		public void TestAssignToteForOrderDirectedPacking_PackageExists_InnerPackage()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			Factory.Save();
			...
			var packageJob = PkgPackageJob.LoadOrCreatePackageJob(order);
			var innerPackage = PackingHelper.CreatePackage(packageJob, "DEF", 1, PkgUnit.Box);
			innerPackage.Pack(order.Lines[0].ReleaseLines[0], 5m);

			var package = packageJob.Packages.AddNew("ABC");
			package.Packages.Add(innerPackage);
			Factory.Save();

			Assert("Order has packages", order.PackageJob.Packages.Any());

			var webService = GetNewWebService(data.Whs1, staff: user);
			var response = webService.AssignToteForOrderDirectedPacking("DEF", order.PK.ToGuid());
			AssertEquals("Should be error.", ErrorTypes.BusinessValidationError, response.Error);
			AssertEquals("Should be error.", "A non Tote Package on the order was found using Package ID 'DEF' already.", response.ErrorMessage);
			AssertEquals(response.IsInvalidToteId, true);
		}

		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PartiallyPacked()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			var packageInfo = response.Package;
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly);
		...
		public void TestAssignToteForOrderDirectedPacking_NothingToPack()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
		...
		public void TestAssignToteForOrderDirectedPacking_OrderNotReadyToPack()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackageWithSiblingPutawayToDockDoorLocation()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
			...
			AssertEquals(response.IsInvalidToteId, false);
			AssertNotNull(packageInfo);
			AssertPackageInfo(packageInfo, order, "ABC", data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString, data.Whs1.DefaultOutboundDockDoorLocation.WLV_LocationString_UserFriendly, isUsingDirectedPackingConsolidation: true);
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_PackageWithSiblingPutawayToConsolidationLocation()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_DBHits()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
		...
		[TestDate(2024, 09, 02, 8, 25, 0)]
		public void TestAssignToteForOrderDirectedPacking_DBHits_PartiallyPacked()
		{
			var data = new TestDataSimpleEnvironment(Factory);
			var user = Helper.CreateGlbStaff("AAA", "AAAAA");
		...
		void AssertPackageInfo(PackageForPackingInfo packageInfo, WhsOrder order, string toteId,
			string expectedAssignedDockDoorLocation, string expectedAssignedDockDoorLocationUserFriendly,
			bool isUsingCarrierLabelIntegration = false, bool isUsingCartonSizes = true,
			decimal packageWeightTolerance = 0m, bool packageWeightToleranceEnabled = false,
			RefPackType toteRefPackType = null,
			bool isUsingDirectedPackingConsolidation = false,
			bool allowDockDoorOverride = false)
		{
			AssertEquals("IsTote", true, packageInfo.IsTote);
			AssertEquals("ToteID", toteId, packageInfo.ToteID);
			AssertEquals("PackageID", toteId, packageInfo.PackageID);
			...
			AssertEquals("OrderReference", order.WD_ExternalReference, packageInfo.OrderReference);
			AssertEquals("PackType", PkgUnit.Tote, packageInfo.PackType);
			...
			AssertEquals("ClientEnforceProductScan", false, packageInfo.ClientEnforceProductScan);
			AssertEquals("IsUsingCartonSizes", isUsingCartonSizes, packageInfo.IsUsingCartonSizes);
			AssertEquals("EmptyWeight", toteRefPackType?.F3_Weight ?? 0m, packageInfo.EmptyWeight);
			AssertEquals("Weight", 0m, packageInfo.Weight);
			AssertEquals("WeightUQ", toteRefPackType?.F3_UnitOfWeight ?? "KG", packageInfo.WeightUQ);
			AssertEquals("Length", toteRefPackType?.F3_Length ?? 0m, packageInfo.Length);
			AssertEquals("Width", toteRefPackType?.F3_Width ?? 0m, packageInfo.Width);
			AssertEquals("Height", toteRefPackType?.F3_Height ?? 0m, packageInfo.Height);
			AssertEquals("DimensionUQ", toteRefPackType?.F3_UnitOfDimension ?? "M", packageInfo.DimensionUQ);
			...
			AssertEquals("AllowedToOverrideDockDoorLocation", allowDockDoorOverride, packageInfo.AllowedToOverrideDockDoorLocation);
		}
