...
{
	public class RemoveTagRuleRunSqlStrategyForTest : RemoveTagRuleRunSqlStrategy
	{
		public RemoveTagRuleRunSqlStrategyForTest(IConnectionProvider connectionProvider, ILogger logger)
