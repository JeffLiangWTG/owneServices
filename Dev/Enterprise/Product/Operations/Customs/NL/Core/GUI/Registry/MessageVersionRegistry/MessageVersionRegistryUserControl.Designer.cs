...
{
	partial class MessageVersionRegistryUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.NL.Business.MessageVersionRegistry);
			// 
			// MessageVersionGrid
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.NL.Business.MessageVersionRegistry)(null)).DomainCode)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.NL.Business.MessageVersionRegistry)(null)).TargetSystemName)));
			...
			this.MessageVersionGrid.GridId = "151C4D12-F298-42CA-A8FA-0452756D2AA4";
