...
public class ExportTransportDetailsLayoutBuilder : TransportDetailsLayoutBuilder<JobDeclaration>
{
	...
	protected override void SetDefaultVisibilities()
	{
		...
		SetVisibility(CommonBag.TransportInlandRoadUserControl, x => x.IsRoadInland, transportModeInlandDependency);
