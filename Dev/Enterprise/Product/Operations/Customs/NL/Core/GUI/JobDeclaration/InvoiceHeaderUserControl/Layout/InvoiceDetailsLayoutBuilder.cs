...
public class InvoiceDetailsLayoutBuilder<TEUInvoice> : ColumnLayoutBuilder<TEUInvoice, EU.GUI.InvoiceDetailsControlBag> where TEUInvoice : Business.Declaration.JobComInvoiceHeader
{
	...
	protected override void SetDefaultCaptions()
	{
		...
		SetCaption(CommercialInvoiceDetailsControlBag.InvoiceCurrExRateCalcEdit, x => Res.GetData("43436AB8-E4FE-4E23-B888-6142FD7A83C2", "Exchange Rate", "[UCC 4/15] Exchange Rate"));
		SetCaption(CommercialInvoiceDetailsControlBag.IncoTermsUserControl , x => Res.GetData("43436AB8-E4FE-4E23-B888-6142FD7A83C1", "[UCC 4/1] Incoterm"));
	}
