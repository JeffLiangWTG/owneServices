namespace Enterprise.Customs.NL.GUI
{
	partial class ExportInvoiceLineUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.DestinationCodeFindBox.ModuleID = Enterprise.ZArchitecture.Modules.ModuleIDs.Customs.Universal.ZZRefCusCodeList;
			// 
			...
			// 
			this.zButtonMoreAdditionalProcedureCode.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(850, 42, true);
			// 
			// zTextBoxAddtionalProcedureCodeAsString
			// 
			this.zTextBoxAddtionalProcedureCodeAsString.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(685, 42, true);
			// 
			// tariffFindBox
			// 
			...
			// 
			this.NewLineDetailsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// InvoiceLineDetailsUserControl
			// 
			this.InvoiceLineDetailsUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			...
			// 
			this.StatisticalValueLocalCurrencyControl.CaptionResourceString = Enterprise.Customs.NL.GUI.Res.GetData("362B036D-DE2D-4FA6-906C-F1ECB07BB366", englishCaption: "[UCC 8/6] Stat.", englishFullDescription: "[UCC 8/6] Stat. Value");
			// 
			// Splitter
			// 
