...
public class NLOrganisationConsigneePlugInController : ZController
{
	public override ControllerID ID => ControllerIDs.Customs.NL.OrganisationConsigneePlugIn;
	...
	{
		get { return Res.GetData("PlugInTabPage|NLOrganisationConsigneePlugIn", "NL"); }
	}
