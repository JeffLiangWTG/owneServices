...
public class EntryNumberCustomisation : BillOfLadingNumberCustomisation
{
	public EntryNumberCustomisation()
	{
	}
	...
	protected override void SetCustomDefaultValuesCore()
	{
		...
		SetUnFilteredElement(BillOfLadingNumberCustomisationElement.Keys.SequenceNumber, e => { e.Order = 50; e.Include = ZBool.True; e.Detail = "8"; });
		SetUnFilteredElement(BillOfLadingNumberCustomisationElement.Keys.YearAsDigit, e => { e.Order = 1; e.Include = ZBool.True; e.Detail = "2"; });
	}
