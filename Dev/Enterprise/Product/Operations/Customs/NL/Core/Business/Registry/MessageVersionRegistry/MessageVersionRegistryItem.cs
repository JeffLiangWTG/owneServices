...
public class MessageVersionRegistryItem : StronglyTypedRegistryItem<MessageVersionRegistryCollection>
{
	public MessageVersionRegistryItem(string name, MultilingualString category, MultilingualString caption, MultilingualString hint, RegistryStorageFlags storage, MessageVersionRegistryCollection defaultValue)
		: base(new RegistryItemImpl(name, category, caption, hint, new MessageVersionRegistryDataType(), storage, RegistryOptions.Default, defaultValue))
	{
	}
...
[RegistryEditor("Enterprise.Customs.NL.GUI.MessageVersionRegistryItemEditor, Enterprise.Customs.NL.GUI")]
public class MessageVersionRegistryDataType : NonPersistentBusinessObjectRegistryDataType<MessageVersionRegistryCollection>
{
}
