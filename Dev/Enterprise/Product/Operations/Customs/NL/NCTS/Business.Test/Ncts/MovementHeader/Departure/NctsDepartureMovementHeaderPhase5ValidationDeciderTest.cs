...
sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0070Active);
	}

	public void TestIsRuleNR0072Active()
	{
		AssertEquals(true, validationDecider.IsRuleNR0072Active);
	}

	public void TestIsRuleNR0073Active()
	{
		AssertEquals(true, validationDecider.IsRuleNR0073Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRulePLR0601Active);
	}

	public void TestIsRuleR0350Active()
	{
		AssertEquals(true, validationDecider.IsRuleR0350Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0850Active);
	}
