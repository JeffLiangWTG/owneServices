...
sealed class Phase5DepartureDetailsLayoutTest : LayoutsAbstractTest
{
	...
	static IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
	{
		get
		{
			...
			yield return (Phase5DepartureDetailsControlBag.Instance.DateLimitAndCalculationUserControl, ControlWidthClass.LongNoCaption);
			yield return (Phase5DepartureDetailsControlBag.Instance.CalCalculationMethodDropEdit, ControlWidthClass.Long);
