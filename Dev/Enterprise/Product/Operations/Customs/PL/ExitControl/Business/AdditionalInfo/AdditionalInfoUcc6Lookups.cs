...
public class AdditionalInfoUcc6Lookups(AdditionalInfo parent) : EU.ExitControl.Business.AdditionalInfoUcc6Lookups(parent)
{
	public override CodeDescriptionPairList SubTypeList
	{
		get
		{
			...
			{
				return Factory.GetCachedValue("PL.ExitControl.AdditionalInfoUcc6Lookups.SubTypeList.NoDiscrepancies", () =>
				{
			...
			{
				return Factory.GetCachedValue("PL.ExitControl.AdditionalInfoUcc6Lookups.SubTypeList.Discrepancies", () =>
				{
					var result = new CodeDescriptionPairList();
					foreach (var codeDescription in new AdditionalInfoSubTypeList().Cast<CodeDescriptionPair>().Where
