...
public sealed class Phase5GoodsItemDetailsLayout : IPanelLayoutWithGridProvider
{
	public Phase5GoodsItemDetailsLayout()
	{
	...
	{
		var builder = new GoodsItemDetailsLayoutBuilder<EU.NCTS.Business.NctsDepartureCargoDesc>();
