...
sealed class CC015CProviderTest : Customs.Business.Testing.DataProviderTestCase<CC015CProvider>
{
	public void TestConstructor()
	{
		AssertExceptionThrown<ArgumentNullException>("Null NctsDepartureMovementHeader", "Value cannot be null.\r\nParameter name: movementHeader", () => new CC015CProvider(null, null));
		AssertExceptionThrown<ArgumentNullException>("Null Message Type", "Value cannot be null.\r\nParameter name: messageType", () => new CC015CProvider(movementHeader, null));
		AssertNoExceptionThrown(() => new CC015CProvider(movementHeader, string.Empty));
	}
	...
	protected override CC015CProvider GetProvider() => new CC015CProvider(movementHeader, "Type");
