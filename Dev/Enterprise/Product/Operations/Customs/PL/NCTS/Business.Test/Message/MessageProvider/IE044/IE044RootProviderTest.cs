...
sealed class IE044RootProviderTest : DataProviderTestCase<IE044RootProvider>
{
	public void TestConstructor()
	{
		CombineAssertions(() =>
		{
			AssertExceptionThrown<ArgumentNullException>("Null MessageSendingObject", "Value cannot be null.\r\nParameter name: messageSendingObject", () => new IE044RootProvider(null));
			...
			AssertExceptionThrown<ArgumentNullException>("Null NctsArrivalMovementHeader", "Value cannot be null.\r\nParameter name: messageSendingObject.NctsHeader.ArrivalMovementHeader", () => new IE044RootProvider(departureMessageSendingObject));

			AssertNoExceptionThrown("Valid constructor", () => new IE044RootProvider(messageSendingObject));
		});
	}

	public void TestCountrySpecificDataPL() { AssertNotNull(Provider.CountrySpecificDataPL); }

	public void TestCC044C() => AssertNotNull(Provider.CC044C);

	protected override IE044RootProvider GetProvider() => new IE044RootProvider(messageSendingObject);
