...
sealed class ExportPreviousDocumentCodeListTest : TestCaseWithFactory
{
	public void TestConstructor()
	{
		...
		var codeList = new ExportPreviousDocumentCodeList(Factory);
		CombineAssertions(() =>
		{
			Assert("Contains code 123", codeList.GetAllCodes().Contains("123"));
			Assert("Contains code 321", codeList.GetAllCodes().Contains("321"));
			...
			AssertEquals("Description", "Description 2", codeList.GetDescriptionFromCode("321"));
		});
	}
}
