...
sealed class ImportDeclarationMessageSendingStrategyTest : DeclarationMessageSendingStrategyTest
{
	public void TestGetMessageSender()
	{
		...
		CombineAssertions(() =>
		{
			...
			AssertType<AISMessageSender>(messageSender);
		});
	}
	...
	protected override BaseMessageSendingStrategy GetInstanceForTest(BusinessObjectFactory factory, JobDeclaration declaration)
		=> new ImportDeclarationMessageSendingStrategy(factory, declaration);
}
