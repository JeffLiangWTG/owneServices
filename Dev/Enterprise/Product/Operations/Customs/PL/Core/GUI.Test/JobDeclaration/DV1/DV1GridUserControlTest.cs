	...
	public void TestDV1DetailsGridColumnSize()
	{
		using (var control = new DV1GridUserControl())
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("CustomsDecisionNumber", 150, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_ContractNumber));
				AssertEquals("CustomsDecisionNumber", 80, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_ContractDate));
			});
		}
	}
}
