namespace Enterprise.Customs.PL.GUI.CusTempStorage
{
	partial class CusTempStorageForm
	{
		...
		private new void InitializeComponent()
		{
            ...
            this.MainTabPage.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("PLCusTempStorageForm|TemporaryStorage", "Temporary Storage");
            ...
            this.DataSourceAssemblyName = "Enterprise.Customs.PL.Business.CusTempStorage";
            this.DataSourceType = typeof(Enterprise.Customs.PL.Business.CusTempStorage.CusTempStorageJobHeader);
            this.DataSourceTypeName = "Enterprise.Customs.PL.Business.CusTempStorage.CusTempStorageJobHeader";
		...
		#endregion
		private TemporyStorageUserControlForPlugin userControlForPLugin;
