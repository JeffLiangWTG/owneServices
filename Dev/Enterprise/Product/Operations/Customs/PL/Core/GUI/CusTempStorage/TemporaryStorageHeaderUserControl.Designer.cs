namespace Enterprise.Customs.PL.GUI.CusTempStorage
{
	partial class TemporaryStorageHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.CustomsDetailsUserControl = new Enterprise.Customs.PL.GUI.CusTempStorage.CustomsDetailsUserControl();
			...
			this.TransportDetailsUserControl = new Enterprise.Customs.PL.GUI.CusTempStorage.TransportDetailsUserControl();
			...
			this.JobDetailsGroupBox.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("E71D0083-47EA-4E78-8CC2-AAB886019C94", "Job Details");
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_ReferenceNumber)));
			this.CustomersReferenceTextBox.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("FEBB1BF7-0A82-4E80-BDE8-A03FADAF6B6C", "Customer Reference");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_OH_Customer)));
			this.CustomerOrganisation.BindToOrganisations = "Lookups.Customers";
			this.CustomerOrganisation.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("C249231C-C971-4064-969F-5CEB61AA8B9C", "Customer");
        ...
        "Customer"};
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.ZArchitecture.Business.ZAddress)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_OA_Presenter_ZAddress)));
			this.PresenterOrgAddress.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("8B565CC1-3EEC-4161-AC4A-65F6002CA5DA", "Presenter");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.ZArchitecture.Business.ZAddress)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_OA_Representative_ZAddress)));
			this.RepresentativeOrgAddress.CaptionResourceString = Enterprise.Customs.PL.GUI.Res.GetData("9D002365-A095-4598-BBF6-D4A39BF0863B", "Representative");
