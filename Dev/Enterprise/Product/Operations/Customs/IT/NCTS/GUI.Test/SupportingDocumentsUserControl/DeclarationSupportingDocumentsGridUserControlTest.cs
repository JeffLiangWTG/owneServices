...
sealed class DeclarationSupportingDocumentsGridUserControlTest : TestCase
{
	public void TestCaptionRenderingEnabled()
	{
		using (var userControl = new DeclarationSupportingDocumentsGridUserControl())
		{
	...
	public void TestSupportingDocumentsGridBindingMember()
	{
		using (var userControl = new DeclarationSupportingDocumentsGridUserControl())
		{
			AssertEquals("SupportingDocumentsGrid BindingMember", "MovementHeader.SupportingDocuments", userControl.SupportingDocumentsGrid.GetBindingMember());
		}
	}
