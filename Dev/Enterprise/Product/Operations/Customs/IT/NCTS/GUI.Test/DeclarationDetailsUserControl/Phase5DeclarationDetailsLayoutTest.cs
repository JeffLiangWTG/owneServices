...
sealed class Phase5DeclarationDetailsLayoutTest : LayoutsAbstractTest
{
	...
	IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
	{
		get
		{
			...
			yield return (DeclarationDetailsControlBag.Instance.ReleaseCodeTextBox, ControlWidthClass.Long);
	...
	IEnumerable<(ControlReference, ControlWidthClass)> SecondColumnControls
	{
		get
		{
			...
			yield return (DeclarationDetailsControlBag.Instance.WriteOffDateEdit, ControlWidthClass.Auto);
			yield return (DeclarationDetailsControlBag.Instance.ControlChannelDropEdit, ControlWidthClass.Auto);
		}
	}
}
