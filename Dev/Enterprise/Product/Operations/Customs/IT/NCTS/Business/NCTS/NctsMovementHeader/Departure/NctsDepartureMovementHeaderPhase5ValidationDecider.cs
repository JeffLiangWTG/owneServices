...
public sealed class NctsDepartureMovementHeaderPhase5ValidationDecider : INctsDepartureMovementHeaderPhase5ValidationDecider
{
	...
	public bool IsRuleB1858_1Active => true;

	public bool IsRuleB1889Active => true;
	...
	public bool IsRuleB1893_1Active => true;

	public bool IsRuleB1893_2Active => true;

	public bool IsRuleB1897Active => true;
	...
	public bool IsRuleC0403_1Active => true;
	...
	public bool IsRuleCN839Active => true;
	...
	public bool IsRuleNR0056Active => true;
	...
	public bool IsRuleR0789_1Active => true;
	...
	public bool IsRuleR0911Active => true;

	public bool IsRuleR0990Active => false;

	public bool IsRuleR0994Active => true;

	public bool IsRuleR0994_1Active => true;
	...
	public bool IsRuleTR0049Active => false;

	public bool IsRuleTR0050Active => false;
