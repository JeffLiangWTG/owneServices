...
sealed class NctsGuaranteeDeparturePhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1898_1ActiveForPW_RX_NKCurrency);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0085_2Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0014Active);
	}
