...
sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1858_1Active);
	}

	public void TestIsRuleB1889Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1889Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1893_1Active);
	}

	public void TestIsRuleB1893_2Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1893_2Active);
	}

	public void TestIsRuleB1897Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1897Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0403_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleCN839Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleN0002Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0056Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0789_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0911Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0994Active);
	}

	public void TestIsRuleR0994_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleR0994_1Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleTR0049Active);
	}

	public void TestIsRuleTR0050Active()
	{
		AssertEquals(false, validationDecider.IsRuleTR0050Active);
	}
