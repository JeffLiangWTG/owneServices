...
sealed class NctsHeaderDeparturePhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1823Active);
	}
	...
	public void TestIsRuleC0001_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0001_1Active);
	}
	...
	public void TestIsRuleC0050Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0050Active);
	}
