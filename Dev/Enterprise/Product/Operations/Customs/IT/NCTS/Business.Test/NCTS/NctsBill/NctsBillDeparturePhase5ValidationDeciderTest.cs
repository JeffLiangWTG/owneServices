...
sealed class NctsBillDeparturePhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1895_1Active);
	}

	public void TestIsRuleB1896Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1896Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0001_6Active);
	}

	public void TestIsRuleC0001_7Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0001_7Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleG0026_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0078Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0474Active);
	}

	public void TestIsRuleR0474_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleR0474_1Active);
	}
