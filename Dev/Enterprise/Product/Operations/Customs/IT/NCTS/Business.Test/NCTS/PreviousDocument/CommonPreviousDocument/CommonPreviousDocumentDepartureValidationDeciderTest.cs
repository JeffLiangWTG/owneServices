...
sealed class CommonPreviousDocumentDepartureValidationDeciderTest : TestCase
{
	...
	public void TestIsRuleG0026_1Active() => AssertEquals(true, validationDecider.IsRuleG0026_1Active);
	...
	{
		base.SetUp();
		validationDecider = new CommonPreviousDocumentDepartureValidationDecider();
	}
