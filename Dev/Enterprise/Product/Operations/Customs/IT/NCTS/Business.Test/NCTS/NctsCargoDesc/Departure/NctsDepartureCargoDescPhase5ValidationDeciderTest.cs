...
sealed class NctsDepartureCargoDescPhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleB1805_1Active);
	}

	public void TestIsRuleB1875_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1875_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleB2400_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0153_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0821_1Active);
	}

	public void TestIsRuleC0837()
	{
		AssertEquals(true, validationDecider.IsRuleC0837Active);
	}

	public void TestIsRuleC0837_1()
	{
		AssertEquals(true, validationDecider.IsRuleC0837_1Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleC901Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleE1107_1Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0021Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleR0507Active);
	}
	...
	INctsDepartureCargoDescPhase5ValidationDecider validationDecider;
}
