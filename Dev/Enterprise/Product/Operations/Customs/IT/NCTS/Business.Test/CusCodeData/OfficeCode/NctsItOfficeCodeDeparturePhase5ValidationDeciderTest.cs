...
sealed class NctsItOfficeCodeDeparturePhase5ValidationDeciderTest : TestCase
{
	...
	{
		base.SetUp();
		validationDecider = new NctsItOfficeCodeDeparturePhase5ValidationDecider();
	}

	NctsItOfficeCodeDeparturePhase5ValidationDecider validationDecider;
}
