...
sealed class UCC6TemporaryStorageBillWithGridLayout : IPanelLayoutWithGridProvider
{
	...
	PanelLayout CreateUCC6TemporaryStorageLayout()
	{
		...
		var commonBag = EU.TemporaryStorage.GUI.UCC6TemporaryStorageBillDetailControlBag.Instance;
		builder.AddControlBag(commonBag);

		builder.AddColumn();
		builder.Add(itBag.GoodsDescTextBox, ControlWidthClass.Long);
		builder.Add(itBag.LrnTextBox, ControlWidthClass.Long);
		...
		builder.Add(itBag.MrnTextBox, ControlWidthClass.Long);
		builder.Add(itBag.GrossWeightCalcEdit, ControlWidthClass.Long);
		builder.Add(itBag.NetWeightCalcEdit, ControlWidthClass.Long);
		builder.Add(itBag.SuppQtyCalcEdit, ControlWidthClass.Long);
