namespace Enterprise.Customs.IT.GUI
{
	partial class MessageSendingForm
	{
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.IT.Business.JobDeclarationMessageSendingObjectParent);
			// 
			// SendSplitButton
			// 
			...
			this.SendSplitButton.CaptionResourceString = Enterprise.Customs.IT.GUI.Res.GetData("5d6aec6b-45ec-49f1-a297-41a68eacc601", "&Send");
			...
			this.DataSourceType = typeof(Enterprise.Customs.IT.Business.JobDeclarationMessageSendingObjectParent);
		...
		internal SendingModeSplitButton SendSplitButton;
