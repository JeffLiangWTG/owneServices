...
public class ETHeaderSecurityBlockConsignee
{
	public ETHeaderSecurityBlockConsignee(ITrader iTrader)
	{
	...
	[MessageFieldExportWithTransitRules("D", "C596")]
	[MessageFieldTransitRules("D", "C596")]
	[MessageFieldInternationalRoadTransportsRules("D", "C596")]
