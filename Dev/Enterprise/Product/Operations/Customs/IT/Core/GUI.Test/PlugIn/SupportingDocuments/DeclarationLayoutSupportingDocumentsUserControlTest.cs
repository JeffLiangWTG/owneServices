...
sealed class DeclarationLayoutSupportingDocumentsUserControlTest : TestCaseWithFactory
{
	public void TestAvailableGridColumnStyles()
	{
		using (var form = new ZForm(declaration))
		using (var supportingDocumentsUserControl = new DeclarationLayoutSupportingDocumentsUserControl())
		{
