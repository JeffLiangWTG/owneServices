...
sealed class EntryInstructionLayoutPreviousDocumentsUserControlTest : EU.GUI.PlugIn.Testing.PreviousDocumentUserControlAbstractTest<EntryInstructionLayoutPreviousDocumentsUserControl, JobDeclaration>
{
	public void TestISupportMultipleResourceStringDataSupporter()
	{
		using (var control = CreateControl())
		{
			...
			AssertSequencesEqual("MultipleKeysToUse", new string[] { "46A87B44-8FBC-4167-9E0E-81B2853DA6C0" }, supportMultipleResourceStringDataSupporter.SupportMultipleResourceStringData.MultipleKeysToUse);
		}
	}
