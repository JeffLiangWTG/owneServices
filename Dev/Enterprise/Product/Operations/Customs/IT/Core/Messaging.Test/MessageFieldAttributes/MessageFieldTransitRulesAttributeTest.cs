...
sealed class MessageFieldTransitRulesAttributeTest : TestCase
{
	public void TestConstructor()
	{
		var attribute1 = new MessageFieldTransitRulesAttribute();
		AssertEquals("The rules should be empty if nothing be passed to the constructor.", 0, attribute1.Rules.Length);

		var attributes2 = new MessageFieldTransitRulesAttribute("R", "R23");
