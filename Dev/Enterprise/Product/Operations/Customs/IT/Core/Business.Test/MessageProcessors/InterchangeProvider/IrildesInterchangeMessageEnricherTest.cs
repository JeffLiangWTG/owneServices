...
sealed class IrildesInterchangeMessageEnricherTest : TestCaseWithFactory
{
	public void TestEnrich()
	{
		...
		var interchangeMessageEnricher = (IEDIInterchangeEnricher)new IrildesInterchangeMessageEnricher();
		interchangeMessageEnricher.Enrich(interchange);
		AssertEquals("POST-CONDITION: EI_InterchangeType", "IRI", interchange.EI_InterchangeType);
	}
