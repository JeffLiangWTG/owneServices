...
[TestedType(typeof(ITDocSADHPageCollection))]
sealed class ITDocSADHPageCollectionTest : DocSADHPageCollectionTest<ITDocSADHPageCollection>
{
	protected override ITDocSADHPageCollection GetNewDocumentWrapperCollection()
	{
		return new ITDocSADHPageCollection(EntryLineCollection, Factory);
	}
		...
		{
			var result = ITDocSADHPage.New(Factory, EntryLineCollection.AddNew());
