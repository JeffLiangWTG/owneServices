...
sealed class AccountingSummaryDownloadMessageCreationStrategyTest : DocumentManagementServiceRequestMessageCreationStrategyAbstractTest<AccountingSummaryDownloadMessageCreationStrategy>
{
	...
	protected override string ExpectedMessageType => "PRD";

	protected override string ExpectedMessageSubType => "PRD";
  ...
  <soapenv:Body>
	...
	protected override IOutgoingCustomsMessageCreationStrategy GetMessageCreationStrategy(IDocumentManagementServiceRequestContext<CusEntryHeader, CusEntryHeader> messageGenerationContext)
		=> new AccountingSummaryDownloadMessageCreationStrategy(Factory, messageGenerationContext);
}
