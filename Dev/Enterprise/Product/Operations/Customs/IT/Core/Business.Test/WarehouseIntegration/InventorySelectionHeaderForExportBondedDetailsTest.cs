...
sealed class InventorySelectionHeaderForExportBondedDetailsTest : NonPersistentBusinessObjectTestCase
{
	...
	void AssertUpdateOutwardLinesWithInventoryDetails(Action<RefCusProcedure> setUp, Action<JobComInvoiceLine> assertion, string packType = "NO", decimal quantityToDraw = 6)
	{
		...
		var procedure = refDataHelper.CreateRefCusProcedure("IT", "A", "40", "71", "", "Test", "EXP");
