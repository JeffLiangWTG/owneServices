...
sealed class ITCompactPreviousDocumentsBuilderTest : TestCaseWithFactory
{
	public void TestGetCountrySpecificFields()
	{
		...
		var builder = new ITCompactPreviousDocumentsBuilder();
	...
	public void TestGetCountrySpecificFieldsWithEmptyFields()
	{
		var previousDocuments = new List<PreviousDocument>();

		var document1 = Factory.New<PreviousDocument>();
		document1.CSI_Procedure = "7";
		document1.CSI_SubType = "";
		document1.CSI_Code = "380";
		document1.CSI_ReferenceNumber = "34217890";
		document1.CSI_DateOfIssue = new ZDateTime(2000, 1, 2);
		document1.CSI_Status = "G";
		...
		AssertEquals("GetPreviousDocumentsFormatted", "380-7-34217890 G-02/01/2000-IT279100-1; Y-7 G-03/01/2000-IT279100", builder.GetPreviousDocumentsFormatted(previousDocuments));
	}
}
