...
sealed class AmendmentInterchangeMessageEnricherTest : TestCaseWithFactory
{
	public void TestEnrich()
	{
		...
		var interchangeMessageEnricher = (IEDIInterchangeEnricher)new AmendmentInterchangeMessageEnricher();
		interchangeMessageEnricher.Enrich(interchange);

		AssertEquals($"[POST-CONDITION] {nameof(EDIInterchange.EI_HeaderText)}", "{\"custom.MessageSubType\":\"AMD\"}", interchange.EI_HeaderText);
	}
