...
sealed class SummaryProspectusRequestMessageCreationStrategyTest : DocumentManagementServiceRequestMessageCreationStrategyAbstractTest<SummaryProspectusRequestMessageCreationStrategy>
{
	...
	protected override string ExpectedMessageType => "SPR";

	protected override string ExpectedMessageSubType => "SPR";
  ...
  <soapenv:Body>
	...
	protected override IOutgoingCustomsMessageCreationStrategy GetMessageCreationStrategy(IDocumentManagementServiceRequestContext<CusEntryHeader, CusEntryHeader> messageGenerationContext)
		=> new SummaryProspectusRequestMessageCreationStrategy(Factory, messageGenerationContext);
}
