...
sealed class AccountingSummaryInterchangeMessageEnricherTest : TestCaseWithFactory
{
	public void TestEnrich()
	{
		...
		var interchangeMessageEnricher = (IEDIInterchangeEnricher)new AccountingSummaryInterchangeMessageEnricher();
		interchangeMessageEnricher.Enrich(interchange);
		AssertEquals("POST-CONDITION: EI_InterchangeType", "PRR", interchange.EI_InterchangeType);
	}
