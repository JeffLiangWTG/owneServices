...
{
	public class OutwardReportFilterBusinessObject : FilterStripBusinessObject
	{
		protected override ModuleFilterCollection GetModuleFiltersCore()
		{
			...
			filter.MultilingualDescription = ResString.GetMultilingualString("Enterprise.Customs.NZ.Module.OutwardReportFilterBusinessObject|ConsolID", "Consol ID");
			...
			filters.AddNumberFilter("MAWB/Bill of lading", GetMasterBillNoQuery)
				.MultilingualDescription = ResString.GetMultilingualString("Enterprise.Customs.NZ.Module.OutwardReportFilterBusinessObject|MAWBBillOfLading", "MAWB/Bill of lading");

			ModuleTextFilter entryTypeFilter = filters.AddTextFilter("Entry Type", CusEntryNumSchema.CE_EntryType);
			entryTypeFilter.MultilingualDescription = ResString.GetMultilingualString("Enterprise.Customs.NZ.Module.OutwardReportFilterBusinessObject|EntryType", "Entry Type");
			entryTypeFilter.Visibility = FilterVisibility.AlwaysAppliedAndHidden;
			entryTypeFilter.Property = CusEntryNumberTypeList.Codes.OutwardReportNumber;
