...
{
	partial class ConsolICRManifestUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			| System.Windows.Forms.AnchorStyles.Right)));
			this.interpretedGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("AE60F7D0-F0B3-4C51-9F5D-B1DB37CF6D04", "Interpreted Message");
