namespace Enterprise.Customs.NZ.GUI.TradeSingleWindow
{
	partial class OCRCancelForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.AdditionalInformationGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("2F26DAD5-55A2-43EA-9847-B8775BB51A61", "Cancel Reason");
