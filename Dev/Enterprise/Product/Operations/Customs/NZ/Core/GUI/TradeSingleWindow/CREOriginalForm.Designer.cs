namespace Enterprise.Customs.NZ.GUI.TradeSingleWindow
{
	partial class CREOriginalForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.AdditionalInformationGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("C7FA9D60-1F33-4A5A-BF96-2AA01F3F9531", "Additional Information");
			...
			this.ManualProcessingGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("072D85AD-0428-4D09-9BBB-3387AA9033A3", "Manual Processing Request Reason: Enter to Request Manual Processing");
