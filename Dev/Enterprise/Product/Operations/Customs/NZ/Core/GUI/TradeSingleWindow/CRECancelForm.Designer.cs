namespace Enterprise.Customs.NZ.GUI.TradeSingleWindow
{
	partial class CRECancelForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.AdditionalInformationGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("F4C3CA48-F6D1-40BB-B69A-6D6E2DDED652", "Cancel Reason");
