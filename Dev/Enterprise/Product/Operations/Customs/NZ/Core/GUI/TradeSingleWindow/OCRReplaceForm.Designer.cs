namespace Enterprise.Customs.NZ.GUI.TradeSingleWindow
{
	partial class OCRReplaceForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.AdditionalInformationGroupBox.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("02C0F289-0E94-432B-A44C-A98C3BBBFF10", "Change Reason");
