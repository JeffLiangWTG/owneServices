...
{
	partial class TSWReplaceFormWithoutAttachments
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// OKButton
			// 
			this.OKButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(284, 382, true);
			// 
			// Cancel_Button
			// 
			this.Cancel_Button.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(362, 382, true);
			// 
			...
			// MainStatusBar
			// 
			this.MainStatusBar.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 413, true);
			// 
			...
			this.ReplaceReasonLabel.CaptionResourceString = Enterprise.Customs.NZ.GUI.Res.GetData("6015AABD-D853-4B80-9237-DC9CC87F7210", "Replace Reason");
			...
			// 
			// TSWReplaceFormWithoutAttachments
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(444, 437, true);
			this.Name = "TSWReplaceFormWithoutAttachments";
			this.Text = "TSWReplaceFormWithoutAttachments";
