...
{
	[TestedType(typeof(OutwardReportFilterBusinessObject))]
	sealed class OutwardReportFilterBusinessObjectTest : FilterStripBusinessObjectTestCase
	{
		...
		OutwardReportFilterBusinessObject filterBO;
		...
		{
			base.SetUp();
			filterBO = new OutwardReportFilterBusinessObject();
			...
			entryNumberForConsol1.CE_EntryType = CusEntryNumberTypeList.Codes.OutwardReportNumber;
			...
			entryNumberForConsol2.CE_EntryType = CusEntryNumberTypeList.Codes.OutwardReportNumber;
		}
