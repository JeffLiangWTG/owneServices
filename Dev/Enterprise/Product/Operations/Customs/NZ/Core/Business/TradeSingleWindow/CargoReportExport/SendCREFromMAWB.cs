...
{
	public class SendCREFromMAWB : SendCRE
	{
		public SendCREFromMAWB(CusMAWB mawb, IAdditionalInformation additionalMessageInformation, TSWTransactionTypes transactionType)
			: base(mawb, additionalMessageInformation, transactionType)
		{
		}

		CusMAWB MAWB => (CusMAWB)HostEntity;
		...
		protected override CREMessageBuilder GetCREMessageBuilder() => new CREMessageBuilder(new CREMawbWrapper(MAWB, AdditionalMessageInformation), TransactionType, SubmitterCode);
	}
}
