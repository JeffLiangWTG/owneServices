...
{
	public class CommodityCode : Customs.Business.CusCodeData
	{
		public CommodityCode(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		...
		protected override void SetDefaultValues()
		{
			...
			CY_Type = CusAddInfoTypeAttribute.Codes.NZTSWCommodityData;
		}
		...
		{
			CY_DataInfo.HumanReadableName = CY_Code.IsEmpty ? "CommodityLine" : "TSW (" + CY_Code + ")";
		}
