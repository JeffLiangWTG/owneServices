...
{
	public class NZCConcessionClassificationLinkLookups : AutoNZCConcessionClassificationLinkLookups
	{
		public NZCConcessionClassificationLinkLookups(AutoNZCConcessionClassificationLink parent)
			: base(parent)
		{
		}
	}
