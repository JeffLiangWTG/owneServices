...
namespace Enterprise.Customs.NZ.Business.MessageProcessors.Testing
{
	...
	public abstract class MessageProcessorTest : DeclarationsAndShipmentsCreatedCancelledTestCase
	{
		[ExpectNoExceptions]
		...
		protected abstract void SetupMessageProcessor(LoggingInformation logger);
