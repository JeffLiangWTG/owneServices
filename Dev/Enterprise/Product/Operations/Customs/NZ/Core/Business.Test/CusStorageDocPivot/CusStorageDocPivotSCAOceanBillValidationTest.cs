...
{
	sealed class CusStorageDocPivotSCAOceanBillValidationTest : BusinessObjectValidationTestCase
	{
		public void TestCheckCSD_StorageDocReference()
		{
			...
			var eDoc2 = oceanBill.DocManagerInfo.AddFileOrDocument(new byte[1], "Test2.pdf", "CIV");
			var eDoc3 = oceanBill.DocManagerInfo.AddFileOrDocument(new byte[1], "Test3.pdf", "CIV");
			var eDoc4 = oceanBill.DocManagerInfo.AddFileOrDocument(new byte[1], "Test4.pdf", "CIV");

			var doc1 = oceanBill.EDocPivotCollection.AddNew();
			...
			var doc4 = oceanBill.EDocPivotCollection.AddNew();
			CombineAssertions(() =>
			{
