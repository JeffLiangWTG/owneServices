...
namespace Enterprise.Customs.NZ.Manifest.Business.Testing
{
	...
	sealed class CusPersonCountryTest : EnterpriseBusinessObjectTestCase
	{
		public void TestICusPersonCountry()
		{
			...
			Factory.Save();
			AssertEquals(bizObj.GetType(), new BusinessObjectFactory().Load<Integration.Customs.ASYCUDA.NZManifest.ICusPersonCountry>(bizObj.PK).GetType());
		...
		protected override BusinessObject GetNewBusinessObjectForDeleteTest(BusinessObjectFactory factory)
		{
			...
			country.CPC_RN_NKCountry = Core.Constants.CountryCodes.NewZealand;
