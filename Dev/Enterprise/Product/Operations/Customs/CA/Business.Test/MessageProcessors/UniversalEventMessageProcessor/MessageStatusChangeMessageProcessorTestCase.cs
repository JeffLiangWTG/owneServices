...
{
	class MessageStatusChangeMessageProcessorTestCase : TestCaseWithFactory
	{
		public void TestGetEmailRegistryValues()
		{
			...
			var processor = new MessageStatusChangeMessageProcessorForTesting(logger, universalEvent, message, entry);
		...
		public void TestGetAssociatedBusinessObjectDescription()
		{
			...
			var expectedAssociatedBusinessObjectDescription = "A Status Information message has been received from the CBSA for a(n) Test IID Declaration.";
		...
		protected class MessageStatusChangeMessageProcessorForTesting : MessageStatusChangeMessageProcessor
		{
			public MessageStatusChangeMessageProcessorForTesting(IXmlSessionTracker logger, UniversalEvent universalEvent, UniversalEventMessage message, CusEntryHeader entry)
