...
{
	sealed class MiscellaneousEventMessageProcessorTestCase : TestCaseWithFactory
	{
		public void TestGetEmailRegistryValues()
		{
			...
			var processor = new MiscellaneousEventMessageProcessorForTesting(logger, universalEvent, message, entry);
		...
		public void TestGetAssociatedBusinessObjectDescription()
		{
			...
			var expectedAssociatedBusinessObjectDescription = "An information message has been received from the CBSA for a(n) Test IID Declaration.";
		...
		class MiscellaneousEventMessageProcessorForTesting : MiscellaneousEventMessageProcessor
		{
			public MiscellaneousEventMessageProcessorForTesting(IXmlSessionTracker logger, UniversalEvent universalEvent, UniversalEventMessage message, CusEntryHeader entry)
