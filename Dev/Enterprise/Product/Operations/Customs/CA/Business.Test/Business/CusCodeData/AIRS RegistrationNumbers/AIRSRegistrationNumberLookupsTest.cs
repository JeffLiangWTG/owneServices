...
{
	sealed class AIRSRegistrationNumberLookupsTest : BusinessObjectLookupsTestCase
	{
		public void TestLookups()
		{
			var regNum = Factory.New<AIRSRegistrationNumber>();
			AssertEquals("AIRSRegTypes type", typeof(ZZRefCusCodeListCombinedCollection), regNum.Lookups.AIRSRegTypes.GetType());
		}
		...
		public void TestCY_DataList()
		{
			...
			var number = cfiaPGAHeader.AIRSRegistrationNumbers.AddNew();
