...
{
	[TestedType(typeof(InvoiceHeaderCusLinkPackageCollection))]
	sealed class InvoiceHeaderCusLinkPackageCollectionTest : NonPersistentBusinessObjectCollectionTestCase<InvoiceHeaderCusLinkPackageCollection>
	{
		public void TestCheckPackageUnitCount()
		{
			...
			var npbos = invoice.PackagesForInvoicesForBindingOnly.OfType<InvoiceHeaderCusLinkPackage>();
		...
		public void TestOnPackageParentChanged()
		{
			...
			var collection = new InvoiceHeaderCusLinkPackageCollection(invoice);
		...
		protected override InvoiceHeaderCusLinkPackageCollection GetCollectionToTest()
		{
			var invoice = Factory.New<JobComInvoiceHeader>();
			return new InvoiceHeaderCusLinkPackageCollection(invoice);
		}

		protected override BusinessObject GetNewElementToAddToTheCollection()
		{
			var invoice = Factory.New<JobComInvoiceHeader>();
			return new InvoiceHeaderCusLinkPackage(invoice);
		}
	}
}
