...
{
	sealed class AQReleaseMessageBuilderTest : TestCaseWithFactory
	{
		public void TestAQReleaseMessageBuilder()
		{
			var mock = GetMock();
...
CST++125:105+1:117+987654321RM001:58++2:110
...
NAD+OS+++U.S. SHIPPING CO.+800 SHIPPER WAYXXXXXXXXXXXXXXX12345:801 SHIPPER WAYXXXXXXXXXXXXXXX12345+NEW YORK+NY+123456789+US
...
UNT+79+<<MSGNO PLACEHOLDER>>";
		...
		public Mock<IEDIReleaseOGD> GetMock()
		{
			...
			mock.Setup(m => m.ServiceOptionID).Returns("125");
			...
			shipper.E2_Address1 = "800 SHIPPER WAYXXXXXXXXXXXXXXX123456";
			shipper.E2_Address2 = "801 SHIPPER WAYXXXXXXXXXXXXXXX123456";
			...
			mockInvoice1.Setup(m => m.HeaderOrigin).Returns("CA");
			...
			mockInvoice2.Setup(m => m.HeaderOrigin).Returns("US");
