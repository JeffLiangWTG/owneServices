...
{
	[TestedType(typeof(IntegratedImportDeclarationDataContextManager))]
	sealed class IntegratedImportDeclarationDataContextManagerTest : DataContextManagerTestCase<IntegratedImportDeclarationDataContextManager, CusEntryHeader>
	{
...
";
			...
			var finder = new IntegratedImportDeclarationEventParentFinder(Factory.BOFactory, new IntegratedImportDeclarationDataContextManager(), new XmlSessionTracker(new ServiceTaskLogForTesting()));
