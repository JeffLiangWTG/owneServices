...
{
	sealed class VetDrugUserControlTestCase : HCProgramsBasedUserUserControlTestCase
	{
		...
		protected override HCProgramsBasedUserUserControl GetUserControl() => new VetDrugUserControl(true);
	}
}
