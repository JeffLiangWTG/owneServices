...
{
	partial class TCVCRUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// TCSplitContainer
			// 
			this.TCSplitContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(124);
			// 
			// CommodityGroupBox
			// 
			this.CommodityGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1084, 124, true);
			// 
			// TitleStatusDropEdit
			// 
			this.TitleStatusDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(16, 214, true);
			// 
			...
			// 
			this.OriginCountryFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(395, 217, true);
			// 
			// MakeTextBox
			// 
			...
			// ODOReadingTextBox
			// 
			this.ODOReadingTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(63, 188, true);
			// 
			// ModelTextBox
			// 
			...
			// 
			this.VehicleStatusDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(729, 198, true);
			// 
			// ImporterDeclarationCheckBox
			// 
			this.ImporterDeclarationCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(941, 171, true);
			// 
			// ClassisMakeTextBox
			// 
			...
			// LPCOsGroupBox
			// 
			this.LPCOsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1084, 446, true);
			// 
			// LPCOsGridUserControl
			// 
			this.LPCOsGridUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1078, 427, true);
			// 
			// ManufacturerLetterCheckBox
			// 
			this.ManufacturerLetterCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(792, 96, true);
			...
			// 
			this.StatementLabelCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(792, 73, true);
			...
			// 
			this.BottomSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1084, 493, true);
			// 
			// ChassisYearDropEdit
			// 
