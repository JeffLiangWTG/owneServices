...
{
	partial class NRCanUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.TabControl.Name = "NRCanTabControl";
			this.TabControl.SelectedIndex = 0;
			this.TabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1856, 796, true);
			...
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1856, 796, true);
