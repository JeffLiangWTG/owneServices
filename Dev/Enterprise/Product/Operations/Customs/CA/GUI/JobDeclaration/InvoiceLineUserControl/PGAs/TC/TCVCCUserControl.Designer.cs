...
{
	partial class TCVCCUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// TCSplitContainer
			// 
			this.TCSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1058, 621, true);
			this.TCSplitContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(129);
			// 
			// CommodityGroupBox
			// 
			this.CommodityGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1058, 129, true);
			// 
			// TitleStatusDropEdit
			// 
			this.TitleStatusDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(93, 201, true);
			// 
			...
			// VINNumberTextBox
			// 
			this.VINNumberTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(444, 19, true);
			this.VINNumberTextBox.Visible = true;
			// 
			// OriginCountryFindBox
			// 
			this.OriginCountryFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(472, 199, true);
			// 
			// MakeTextBox
			// 
			this.MakeTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(444, 45, true);
			this.MakeTextBox.Visible = true;
			// 
			// ODOReadingTextBox
			// 
			this.ODOReadingTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(472, 173, true);
			// 
			// ModelTextBox
			// 
			this.ModelTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(444, 71, true);
			this.ModelTextBox.Visible = true;
			// 
			// VehicleStatusDropEdit
			// 
			this.VehicleStatusDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(811, 185, true);
			// 
			// ImporterDeclarationCheckBox
			// 
			this.ImporterDeclarationCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(477, 226, true);
			// 
			// ClassisMakeTextBox
			// 
			this.ClassisMakeTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(444, 14, true);
			// 
			// ChassisModelTextBox
			// 
			this.ChassisModelTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(678, 14, true);
			// 
			// LPCOsGroupBox
			// 
			this.LPCOsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1058, 441, true);
			// 
			// LPCOsGridUserControl
			// 
			this.LPCOsGridUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1052, 422, true);
			// 
			// StateButton
			// 
			this.StateButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(617, 225, true);
			// 
			...
			this.ManufacturerLetterCheckBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(234, 17, true);
			...
			// 
			this.BottomSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1058, 488, true);
			// 
			// ChassisYearDropEdit
			// 
			this.ChassisYearDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(913, 14, true);
			// 
			// ModelYearDropEdit
			// 
