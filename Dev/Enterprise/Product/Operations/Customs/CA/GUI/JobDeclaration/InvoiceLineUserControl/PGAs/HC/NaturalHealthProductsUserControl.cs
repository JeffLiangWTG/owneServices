...
{
	public partial class NaturalHealthProductsUserControl : HCProgramsBasedUserUserControl
	{
		public NaturalHealthProductsUserControl(bool isOnInvoiceLine) : base(isOnInvoiceLine)
		{
			InitializeComponent();
		}
