namespace Enterprise.Customs.CA.GUI
{
	partial class DFOUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1080, 796, true);
			...
			this.Name = "DFOUserControl";
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1080, 796, true);
