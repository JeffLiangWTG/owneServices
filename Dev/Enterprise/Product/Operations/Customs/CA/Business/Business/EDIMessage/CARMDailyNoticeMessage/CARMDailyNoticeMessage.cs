...
{
	public class CARMDailyNoticeMessage : EDIMessage, IControllerIDProvider
	{
		public CARMDailyNoticeMessage(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		}
		...
		protected override void SetDefaultValues()
		{
			...
			EM_MessageType = MessageTypeList.Codes.CARMDailyNotice;
		}
