namespace Enterprise.Customs.CA.Business
{
	...
	partial class CusClassPartPivot : IDutyAndTaxData
	{
		...
		{
			get { return CCA_99TariffCode.IsEmpty ? CI_CC_CA_99TariffCode : CCA_99TariffCode; }
		}
		...
		ZString IDutyAndTaxData.TreatmentCode
		{
			get
			{
				var result = CCA_TreatmentCode.IsEmpty ? CI_CC_CA_TreatmentCode : CCA_TreatmentCode;
				return result.IsEmpty ? new ZString(TariffTreatmentCodes.Codes.MostFavouredNation) : result;
			}
		}
