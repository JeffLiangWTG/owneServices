...
{
	[CusAddInfoType(CusAddInfoTypeAttribute.Codes.CAPHACPGAHeader)]
	public class PHACPGAHeaderAddInfo : AutoPHACPGAHeaderAddInfo
	{
		public PHACPGAHeaderAddInfo(ZPropertyInfo addInfoProperty) : base(addInfoProperty.BizObj.Factory)
		{
