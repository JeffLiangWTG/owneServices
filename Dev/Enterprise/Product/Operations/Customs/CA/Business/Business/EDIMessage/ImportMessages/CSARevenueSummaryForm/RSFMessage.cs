...
{
	public class RSFMessage : EDIMessageWithBatchNumber
	{
		public RSFMessage(BusinessObjectFactory factory, DataRow row) : base(factory, row)
		{
		}
		...
		protected override void SetDefaultValues()
		{
			...
			EM_MessageType = MessageTypeList.Codes.CSARevenueSummaryForm;
		}
		...
		public override EDIMessage OriginalMessage
		{
			get
			{
				...
				if (fOriginalMessage == null && !batchNumber.IsEmpty)
				{
					...
					query.AddToFilter(EDIMessageSchema.EM_MessageType, MessageTypeList.Codes.CSARevenueSummaryForm);
