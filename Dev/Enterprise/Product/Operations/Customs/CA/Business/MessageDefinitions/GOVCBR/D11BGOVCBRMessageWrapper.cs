...
{
	public class D11BGOVCBRMessageWrapper : GOVCBRMessageWrapper
	{
		public D11BGOVCBRMessageWrapper(ACIForwarderMessage message)
			: base(message)
		{
			Argument.NotNull(message, "message");
			GOVCBR = Argument.NotNull(message.GOVCBR, "message", "Supported EDIFACT message type is D11B GOVCBR");
		}
