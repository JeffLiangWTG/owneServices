...
namespace Enterprise.Customs.TR.GUI
{
	partial class ExportOrganizationUserControl
	{
		...
		void InitializeComponent()
		{
			...
			// 
			this.RepresentativeAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(110, 47, true);
			// 
			// DeclarantOfficeAddressControl
			// 
			this.DeclarantOfficeAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(110, 69, true);
			// 
			// BindingSource
			// 
			...
			this.ToWarehouseAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(110, 91, true);
			...
			this.ToWarehouseAddressControl.TabIndex = 4;
			// 
			...
			this.FromWarehouseAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(110, 113, true);
			...
			this.FromWarehouseAddressControl.TabIndex = 5;
			// 
			// TradersGroupBox
			// 
			this.TradersGroupBox.Controls.Add(this.TradersGrid);
			this.TradersGroupBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(3, 140, true);
			...
			this.TradersGroupBox.TabIndex = 9;
			...
			this.TradersGrid.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.TradersGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(449, 108, true);
