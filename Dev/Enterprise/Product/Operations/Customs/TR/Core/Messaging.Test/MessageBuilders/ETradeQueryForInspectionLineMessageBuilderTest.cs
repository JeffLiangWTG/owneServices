...
{
	class ETradeQueryForInspectionLineMessageBuilderTest : TestCaseWithFactory
	{
  ...
  <soapenv:Body>
    <tem:BeyannameDurumSorgula>
      ...
      <tem:tescilNo>22066666GI0000000036</tem:tescilNo>
			...
			var messageHeaderBuilder = new ETradeQueryForInspectionLineMessageBuilder();
			var mock = new Mock<IETradeQueryForInspectionLine>();
