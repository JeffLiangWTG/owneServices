...
{
	class ETradeQueryRemainingBillsforImpDecMessageBuilderTest : TestCaseWithFactory
	{
  ...
  <soapenv:Body>
    <tem:AyrilanTasimaSenediSorgula>
      ...
      <tem:beyannameNo>22066666GI0000000036</tem:beyannameNo>
			...
			var messageHeaderBuilder = new ETradeQueryRemainingBillsforImpDecMessageBuilder();
			var mock = new Mock<IETradeQueryRemainingBillsforImpDec>();
