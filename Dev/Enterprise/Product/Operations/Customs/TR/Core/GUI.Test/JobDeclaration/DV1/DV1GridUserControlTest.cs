...
{
	class DV1GridUserControlTest : TestCaseWithFactory
	{
		public void TestDV1DetailsGridColumnSize()
		{
			using (var control = new DV1GridUserControl())
			{
				...
				CombineAssertions(() =>
				{
					...
					AssertEquals("CloseApproximation", 100, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_CloseApproximation));
					...
					AssertEquals("ContractNumber", 150, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_ContractNumber));
					AssertEquals("ContractDate", 80, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_ContractDate));
					AssertEquals("Place", 150, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_Place));
					AssertEquals("CustomsDecisionDate", 80, detailsGrid.GetColumnWidth(CusDV1DetailSchema.Constants.DV1_CustomsDecisionDate));
				});
			}
		}
	}
