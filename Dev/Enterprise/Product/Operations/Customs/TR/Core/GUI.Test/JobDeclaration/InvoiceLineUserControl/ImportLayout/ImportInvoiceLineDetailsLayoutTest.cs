...
namespace Enterprise.Customs.TR.GUI.Testing
{
	...
	sealed class ImportInvoiceLineDetailsLayoutTest : LayoutsAbstractTest
	{
		...
		public void TestVisibility()
		{
			...
			invoiceLine2.JI_Procedure = "5300";
		...
		public void TestCaptions()
		{
			...
			CombineAssertions("Below assertions are only for label captions!", () =>
			{
				Layout.TryGetCaption(EU.GUI.InvoiceLineDetailsControlBag.Instance.PreferenceCodeDropEdit, invoiceLine, out var resourceStringDataForPreference);
				AssertEquals("[36] Preference Code", resourceStringDataForPreference.Caption);

				Layout.TryGetCaption(EU.GUI.InvoiceLineDetailsControlBag.Instance.EntryExitPurposeCodeDropEdit, invoiceLine, out var resourceStringDataForEntryCode);
				AssertEquals("Entry Purpose Code", resourceStringDataForEntryCode.Caption);

				Layout.TryGetCaption(EU.GUI.InvoiceLineDetailsControlBag.Instance.EntryExitPurposeDetailTextBox, invoiceLine, out var resourceStringDataForEntryDetail);
				AssertEquals("Entry Purpose Detail", resourceStringDataForEntryDetail.Caption);
			});
		}
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (InvoiceLineDetailsControlBag.Instance.BrandNameTextBox, ControlWidthClass.Long);
		...
		IEnumerable<(ControlReference, ControlWidthClass)> SecondColumnControls
		{
			get
			{
				...
				yield return (EU.GUI.InvoiceLineDetailsControlBag.Instance.UsedGoodsCodeDropEdit, ControlWidthClass.Long);
				yield return (EU.GUI.InvoiceLineDetailsControlBag.Instance.ReturnToOriginCheckBox, ControlWidthClass.Long);
				yield return (EU.GUI.InvoiceLineDetailsControlBag.Instance.SecondaryTreatedProductCheckBox, ControlWidthClass.Long);
		...
		IEnumerable<(ControlReference, ControlWidthClass)> ThirdColumnControls
		{
			get
			{
				...
				yield return (EU.GUI.InvoiceLineDetailsControlBag.Instance.ExcessStockCheckBox, ControlWidthClass.Auto);
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new ImportInvoiceLineDetailsLayoutBuilder();
