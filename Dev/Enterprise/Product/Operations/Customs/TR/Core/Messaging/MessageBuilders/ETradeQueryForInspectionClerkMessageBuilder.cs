...
{
	public class ETradeQueryForInspectionClerkMessageBuilder
	{
		public ETradeQueryForInspectionClerkMessageBuilder()
		{
		}

		public ZString GetMessageText(IETradeQueryForInspectionClerk provider)
		{
			...
			var envelope = new Envelope()
			{
				...
				{
					EtgbMuayeneMemuruSorgula = new EtgbMuayeneMemuruSorgula()
					{
