...
{
	public class ETradeQueryForInspectionLineMessageBuilder
	{
		public ETradeQueryForInspectionLineMessageBuilder()
		{
		}

		public ZString GetMessageText(IETradeQueryForInspectionLine provider)
		{
			...
			var envelope = new Envelope()
			{
				...
				{
					BeyannameDurumSorgula = new BeyannameDurumSorgula()
					{
						TescilNo = provider.RegistrationNo,
