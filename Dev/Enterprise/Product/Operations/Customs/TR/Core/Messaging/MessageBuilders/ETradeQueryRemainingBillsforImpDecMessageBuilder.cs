...
{
	public class ETradeQueryRemainingBillsforImpDecMessageBuilder
	{
		public ETradeQueryRemainingBillsforImpDecMessageBuilder()
		{
		}

		public ZString GetMessageText(IETradeQueryRemainingBillsforImpDec provider)
		{
			...
			var envelope = new Envelope()
			{
				...
				{
					AyrilanTasimaSenediSorgula = new AyrilanTasimaSenediSorgula()
					{
						BeyannameNo = provider.RegistrationNo,
