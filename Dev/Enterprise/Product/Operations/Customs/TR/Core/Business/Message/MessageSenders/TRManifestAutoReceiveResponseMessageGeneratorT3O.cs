...
{
	public class TRManifestAutoReceiveResponseMessageGeneratorT3O : TRBaseMessageGenerator<TRManifestMessage>
	{
		public TRManifestAutoReceiveResponseMessageGeneratorT3O(IMessageSender sender, ZString guID, EDIMessage originalMessage) : base(sender)
		{
		...
		public override ZString MessageType => TRMessageTypes.Codes.T3O;
