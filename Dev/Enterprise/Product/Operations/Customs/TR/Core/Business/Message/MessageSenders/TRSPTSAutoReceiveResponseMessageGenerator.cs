...
{
	public class TRSPTSAutoReceiveResponseMessageGenerator : TRAutoReceiveResponseMessageGenerator<SPTSMessage>
	{
		public TRSPTSAutoReceiveResponseMessageGenerator(IMessageSender sender, ZString queryGuid, EDIMessage originalMessage) : base(sender, queryGuid, originalMessage)
		{
		}

		public override ZString MessageType => TRMessageTypes.Codes.T1P;
