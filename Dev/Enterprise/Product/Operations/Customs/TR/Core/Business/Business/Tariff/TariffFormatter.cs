...
namespace Enterprise.Customs.TR.Business
{
	public class TariffFormatter : Customs.Business.TariffFormatter
	{
		...
		protected override ZString DottedFormat(ZString unformattedTariff)
		{
			...
			var dottedTariff = newTariff.IsEmpty ? "" : newTariff.SubstringSafe(0, 4) + "." + newTariff.SubstringSafe(4, 2) + "." + newTariff.SubstringSafe(6, 2) + "." + newTariff.SubstringSafe(8, 2) + "." + newTariff.SubstringSafe(10, 2) + ".".Trim();
