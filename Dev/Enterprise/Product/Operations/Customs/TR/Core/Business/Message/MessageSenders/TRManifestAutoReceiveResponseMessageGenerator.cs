...
{
	public class TRManifestAutoReceiveResponseMessageGenerator : TRAutoReceiveResponseMessageGenerator<TRManifestMessage>
	{
		public TRManifestAutoReceiveResponseMessageGenerator(IMessageSender sender, ZString queryGuid, EDIMessage originalMessage) : base(sender, queryGuid, originalMessage)
		{
		}

		public override ZString MessageType => TRMessageTypes.Codes.T1O;
