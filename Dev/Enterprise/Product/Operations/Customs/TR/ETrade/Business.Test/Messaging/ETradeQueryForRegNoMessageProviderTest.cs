...
{
	class ETradeQueryForRegNoMessageProviderTest : TestCaseWithFactory
	{
		public void TestIETradeQueryForRegNo()
		{
			var header = CreateHeader();
			IETradeQueryForRegNo provider = new ETradeQueryForRegNoMessageProvider(header);

			CombineAssertions(() =>
			{
				AssertExceptionThrown<System.ArgumentNullException>("Null Arg Exception expected", () => new ETradeQueryForRegNoMessageProvider(null));
