...
{
	class ETradeQueryForInspectionClerkMessageProviderTest : TestCaseWithFactory
	{
		public void TestIETradeQueryForInspectionClerk()
		{
			...
			CombineAssertions(() =>
			{
				AssertExceptionThrown<System.ArgumentNullException>("Null Arg Exception expected", () => new ETradeQueryForInspectionClerkMessageProvider(null));
