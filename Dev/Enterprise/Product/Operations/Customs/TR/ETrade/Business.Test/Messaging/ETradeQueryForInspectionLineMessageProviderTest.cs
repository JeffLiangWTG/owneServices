...
{
	class ETradeQueryForInspectionLineMessageProviderTest : TestCaseWithFactory
	{
		public void TestIETradeQueryForInspectionLine()
		{
			var header = CreateHeader();
			IETradeQueryForInspectionLine provider = new ETradeQueryForInspectionLineMessageProvider(header);

			CombineAssertions(() =>
			{
				AssertExceptionThrown<System.ArgumentNullException>("Null Arg Exception expected", () => new ETradeQueryForInspectionLineMessageProvider(null));
