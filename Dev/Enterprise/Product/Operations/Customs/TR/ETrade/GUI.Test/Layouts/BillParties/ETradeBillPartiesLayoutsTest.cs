...
{
	[TestedType(typeof(ETradeBillPartiesLayouts))]
	sealed class ETradeBillPartiesLayoutsTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> ThirdColumnControls
		{
			get
			{
				yield return (ETradeBillPartiesControlBag.Instance.DeliveryPartyDetailsSeparatorUserControl, ControlWidthClass.Long);
				yield return (ETradeBillPartiesControlBag.Instance.SupplementaryDeclarationNameTextBox, ControlWidthClass.Long);
				yield return (ETradeBillPartiesControlBag.Instance.SupplementaryDeclarationRegNoIdNoTextBox, ControlWidthClass.Long);
				yield return (ETradeBillPartiesControlBag.Instance.SupplementaryDeclarationDeliveryDateDateEdit, ControlWidthClass.Long);
			}
		}
	}
}
