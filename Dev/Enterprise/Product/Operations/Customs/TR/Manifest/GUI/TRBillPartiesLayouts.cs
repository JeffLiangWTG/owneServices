...
{
	public class TRBillPartiesLayouts : IPanelLayoutProvider
	{
		PanelLayout BillParties { get; }

		PanelLayout IPanelLayoutProvider.Layout => BillParties;

		public TRBillPartiesLayouts()
		{
		...
		PanelLayout CreateBillPartiesLayout()
		{
			...
			var tr = TRBillPartiesControlBag.Instance;
			...
			builder.Add(tr.ToOrderCheckBox, ControlWidthClass.Long);
			builder.Add(tr.NotOwnedCheckBox, ControlWidthClass.Long);
