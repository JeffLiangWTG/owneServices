...
{
	partial class ManifestsToOpenUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.ManifestsToOpenGroupBox.Text = Enterprise.Customs.TR.NCTS.GUI.Res.GetString("70619D9E-3336-4B8C-935C-9973906AA81C", "Manifests To Open Details");
			// 
			// IsPartialCheckBox
			// 
			...
			this.DeclarationNoTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(127, 56, true);
			...
			this.DeclarationNoTextBox.TabIndex = 2;
			// 
			// BillNoTextBox
			// 
			...
			this.BillNoTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(127, 84, true);
			...
			this.BillLineNoCalcEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(127, 112, true);
			...
			this.BillLineNoCalcEdit.TabIndex = 4;
			...
			this.QuantityCalcEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(127, 140, true);
			...
			this.AtWarehouseCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(14, 168, true);
			...
			this.AtWarehouseCheckBox.TabIndex = 6;
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TR.NCTS.Business.NctsManifestsToOpen)(((System.Collections.IList)(((Enterprise.Customs.TR.NCTS.Business.NctsHeader)(null)).ManifestsToOpenList)).SyncRoot)).CSI_CustomsOffice)));
			this.WarehouseCodeDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(127, 196, true);
			...
			this.WarehouseCodeDropEdit.TabIndex = 7;
			// 
			// ManifestsToOpenUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.ManifestsToOpenSplitContainer);
			this.Name = "ManifestsToOpenUserControl";
