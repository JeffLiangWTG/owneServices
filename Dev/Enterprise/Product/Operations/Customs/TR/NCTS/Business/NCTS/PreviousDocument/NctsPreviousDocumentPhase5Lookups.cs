...
{
	public class NctsPreviousDocumentPhase5Lookups : EU.NCTS.Business.NctsPreviousDocumentPhase5Lookups,INctsPreviousDocumentLookups
	{
		public NctsPreviousDocumentPhase5Lookups(NctsPreviousDocument parent) : base(parent)
		{
		}
