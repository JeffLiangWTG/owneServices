...
namespace Enterprise.Customs.TR.NCTS.GUI.Testing
{
	...
	sealed class NctsPhase5LayoutProviderTest : EU.NCTS.GUI.Testing.NctsPhase5LayoutProviderAbstractTest
	{
		...
		protected override Type ExpectedTransportDeparturePanelLayoutType => typeof(Phase5TransportDepartureLayout);
		...
		protected override string CountryOrGroupingCode => Core.Constants.CountryCodes.Turkey;
