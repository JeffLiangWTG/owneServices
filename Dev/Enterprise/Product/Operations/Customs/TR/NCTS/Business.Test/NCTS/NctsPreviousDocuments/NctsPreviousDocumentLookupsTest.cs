...
{
	class NctsPreviousDocumentLookupsTest : BusinessObjectLookupsTestCase
	{
		...
		public void TestLookups()
		{
			...
			AssertEquals("Ncts Previous Document Lookups", typeof(NctsPreviousDocumentLookups), document.Lookups.GetType());
		}
