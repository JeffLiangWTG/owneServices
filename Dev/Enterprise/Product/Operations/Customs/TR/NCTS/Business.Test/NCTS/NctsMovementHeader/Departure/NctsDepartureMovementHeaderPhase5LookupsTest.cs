...
{
	class NctsDepartureMovementHeaderPhase5LookupsTest : BusinessObjectLookupsTestCase
	{
		...
		{
			var tankerStatusList = departureMovement.Lookups.TankerStatusList;
			CombineAssertions("TankerStatusList Code ", () =>
			{
				Assert("0 is valid", tankerStatusList.ContainsCode("0"));
				Assert("1 is valid", tankerStatusList.ContainsCode("1"));
				Assert("2 is invalid", !tankerStatusList.ContainsCode("2"));
			});
		}
