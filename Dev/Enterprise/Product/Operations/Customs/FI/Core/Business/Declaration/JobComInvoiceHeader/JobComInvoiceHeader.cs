...
public class JobComInvoiceHeader : EU.Business.Declaration.JobComInvoiceHeader, Integration.Customs.FI.IJobComInvoiceHeader
{
	...
	protected override CargoWise.Types.ZString LocalCurrencyCodeCore => Core.Constants.CurrencyCodes.Finland;
