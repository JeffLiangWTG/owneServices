...
using CusTempStorageRegHeader = Enterprise.Customs.EFTA.TemporaryStorageRegister.Business.CusTempStorageRegHeader;
...
sealed class SumARegisterFilterBusinessObjectTest : FilterStripBusinessObjectTestCase
{
	...
	{
		var header1 = Factory.NewWithValidTestData<CusTempStorageRegHeader>();
		var line1 = Factory.New<CusTempStorageRegLine>();
		header1.CusTempStorageRegLines.Add(line1);
		line1.SRL_LineNumber = 1;
		line1.SRL_OwnerReferenceType = "REG";

		var header2 = Factory.NewWithValidTestData<CusTempStorageRegHeader>();
		var line2 = Factory.New<CusTempStorageRegLine>();
		header2.CusTempStorageRegLines.Add(line2);
		line2.SRL_LineNumber = 1;
		line2.SRL_OwnerReferenceType = "AWB";
	...
	public void TestLineStatusFilter()
	{
		...
		header1.CusTempStorageRegLines.Add(line1);
		line1.SRL_LineNumber = 1;
		line1.SRL_CustomsStatus = "DEL";

		var header2 = Factory.NewWithValidTestData<CusTempStorageRegHeader>();
		var line2 = Factory.New<CusTempStorageRegLine>();
		header2.CusTempStorageRegLines.Add(line2);
		line2.SRL_LineNumber = 1;
		line2.SRL_CustomsStatus = "FIN";
