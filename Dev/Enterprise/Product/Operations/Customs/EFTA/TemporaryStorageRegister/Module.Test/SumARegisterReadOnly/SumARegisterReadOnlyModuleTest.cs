...
sealed class SumARegisterReadOnlyModuleTest : ZModuleBasherTest
{
	...
	public void TestGetNewGridCollection() => AssertType<CusTempStorageRegHeaderCollection<CusTempStorageRegHeader>>(module.GetNewBusinessObjectCollection());

	protected override ModuleIdentifier GetModuleID() => ModuleIDs.Customs.SumARegisterReadOnly;
