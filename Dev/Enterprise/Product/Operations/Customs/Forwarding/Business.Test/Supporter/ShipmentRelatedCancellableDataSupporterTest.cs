...
{
	sealed class ShipmentRelatedCancellableDataSupporterTest : RelatedCancellableDataSupporterAbstractTest
	{
		[ExpectNoExceptions]
...
In-Bond I0000: This record cannot be deactivated as there are Movements that are still waiting for a response from Customs.";
		...
		{
			return new ShipmentRelatedCancellableDataSupporter();
		}
