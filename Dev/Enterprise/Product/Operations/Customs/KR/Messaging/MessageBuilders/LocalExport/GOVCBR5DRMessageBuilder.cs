...
using CargoWise.Customs.KR.MessageDefinitions.GOVCBR5DR;
...
{
	[MessageType(ElectronicDocumentTypeList.Codes._5DR)]
	public class GOVCBR5DRMessageBuilder : MessageBuilder<Declaration>
	{
		...
		public GOVCBR5DRMessageBuilder(ILocalExportAmendEntryHeader dataProvider, IAmendmentDetails amendmentDetails, MessageFunctions.MessageFunctionCode messageType)
		{
		...
		{
			return new DeclarationTypeCodeType { Value = GOVCBR + ElectronicDocumentTypeList.Codes._5DR };
		}
		...
		Collection<SubmitterIdentificationIdType> PopulateSubmitter()
		{
			...
			var unipassID = dataProvider.Supplier?.UnipassIDForOrganization ?? ZString.Empty;
			var businessRegNo = dataProvider.Supplier?.BusinessRegNo ?? ZString.Empty;
