...
namespace Enterprise.Customs.KR.Business
{
	...
	[MultiPurposeResponseSupportMessageType(ElectronicDocumentTypeList.Codes._5TM)]
	class GOVCBRR20_5TMSupporter : GOVCBRR20Supporter
	{
		...
		{
			var entry = (CusEntryHeader)header;
