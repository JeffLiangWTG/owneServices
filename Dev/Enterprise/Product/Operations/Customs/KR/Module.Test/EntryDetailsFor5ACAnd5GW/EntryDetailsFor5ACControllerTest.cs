...
{
	[TestedType(typeof(EntryDetailsFor5ACController))]
	sealed class EntryDetailsFor5ACControllerTest : ZControllerBasherTest
	{
		protected override ControllerID GetControllerID() => ControllerIDs.Customs.KR.ExportEntryDetails;
