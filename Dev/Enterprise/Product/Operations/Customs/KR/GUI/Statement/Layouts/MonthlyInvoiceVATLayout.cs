...
{
	public sealed class MonthlyInvoiceVATLayout : IPanelLayoutProvider
	{
		...
		static PanelLayout CreateLayout()
		{
			...
			builder.Add(controlBag.ProcessDateEdit, ControlWidthClass.Auto);
			builder.Add(controlBag.PaymentDateEdit, ControlWidthClass.Auto);
			builder.Add(controlBag.TotalVATAmountCalcEdit, ControlWidthClass.Auto);
			...
			builder.Add(controlBag.PaymentTypeDropEdit, ControlWidthClass.Auto);
