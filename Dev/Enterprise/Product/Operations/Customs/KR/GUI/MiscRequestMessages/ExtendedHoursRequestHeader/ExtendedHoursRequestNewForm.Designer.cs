...
{
	partial class ExtendedHoursRequestNewForm
	{
		/// <summary>
		...
		{
            this.extendedHoursRequestNewUserControl = new Enterprise.Customs.KR.GUI.ExtendedHoursRequestNewUserControl();
            ...
            this.extendedHoursRequestNewUserControl.SuspendLayout();
            ...
            // 
            this.extendedHoursRequestNewUserControl.AllowDrop = true;
            this.BindingSource.SetBindingMember(this.extendedHoursRequestNewUserControl, ".");
            this.extendedHoursRequestNewUserControl.Dock = System.Windows.Forms.DockStyle.Fill;
            this.extendedHoursRequestNewUserControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 0, true);
            this.extendedHoursRequestNewUserControl.Name = "extendedHoursRequestNewUserControl";
            this.extendedHoursRequestNewUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(853, 464, true);
            this.extendedHoursRequestNewUserControl.TabIndex = 0;
            // 
            // ButtonsPanel
            // 
            ...
            this.Controls.Add(this.extendedHoursRequestNewUserControl);
            this.Controls.Add(this.ButtonsPanel);
            this.DataSourceType = typeof(Enterprise.Customs.KR.Business.ExtendedHoursRequestHeader);
            this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(867, 559, true);
            this.Name = "ExtendedHoursRequestNewForm";
            this.ShouldSerializeTabPageMethods = false;
            this.Text = "ExtendedHoursRequestForm";
            this.Controls.SetChildIndex(this.MainStatusBar, 0);
            this.Controls.SetChildIndex(this.ButtonsPanel, 0);
            this.Controls.SetChildIndex(this.extendedHoursRequestNewUserControl, 0);
            ((System.ComponentModel.ISupportInitialize)(this.MessageStatusBarPanel)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.ErrorStatusBarPanel)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.BindingSource)).EndInit();
            this.extendedHoursRequestNewUserControl.ResumeLayout(true);
            this.extendedHoursRequestNewUserControl.PerformLayout();
		...
		private ExtendedHoursRequestNewUserControl extendedHoursRequestNewUserControl;
