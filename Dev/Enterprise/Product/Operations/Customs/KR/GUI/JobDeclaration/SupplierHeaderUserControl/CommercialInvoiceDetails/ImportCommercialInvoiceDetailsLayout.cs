...
{
	public sealed class ImportCommercialInvoiceDetailsLayout : IPanelLayoutProvider
	{
		PanelLayout IPanelLayoutProvider.Layout => PanelLayout;
		PanelLayout PanelLayout { get; }
		public ImportCommercialInvoiceDetailsLayout()
		{
		...
		PanelLayout CreatePanelLayout()
		{
			...
			builder.Add(krBag.ValuationCodeDropEdit, ControlWidthClass.Auto);
