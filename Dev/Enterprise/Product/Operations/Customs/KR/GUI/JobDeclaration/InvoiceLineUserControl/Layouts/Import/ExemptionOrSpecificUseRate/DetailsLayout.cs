...
{
	public sealed class DetailsLayout : IPanelLayoutProvider
	{
		...
		{
			var common = DetailsControlBag.InstanceForDeclaration;
			...
			layout.Include(ruler1, common.RemarkLongTextControl);
