...
{
	public class MethodTwoToSixGoodsPricingBasisSendingObjectLayout : IPanelLayoutProvider
	{
		PanelLayout IPanelLayoutProvider.Layout => PanelLayout;

		PanelLayout PanelLayout { get; }

		public MethodTwoToSixGoodsPricingBasisSendingObjectLayout()
		{
		...
		PanelLayout CreatePanelLayout()
		{
			var controlBag = MethodTwoToSixControlBag.InstanceForSendingObject;
