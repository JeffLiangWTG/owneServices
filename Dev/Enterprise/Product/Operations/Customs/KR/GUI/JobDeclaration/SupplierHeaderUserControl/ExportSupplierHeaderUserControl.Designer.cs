...
namespace Enterprise.Customs.KR.GUI
{
	partial class ExportSupplierHeaderUserControl
	{
		...
		{
      this.CustomsValueKRW = new Enterprise.ZArchitecture.ZCalcEdit();
      this.CustomsValueUSD = new Enterprise.ZArchitecture.ZCalcEdit();
      this.SEDDetailsTabPage = new Enterprise.ZArchitecture.GUI.ZTabPage();
      this.SEDDetailsDynamicLayoutPanel = new Enterprise.ZArchitecture.GUI.DynamicLayoutPanel();
      ...
      this.SEDDetailsTabPage.SuspendLayout();
      this.SuspendLayout();
      // 
      // DetailsGroupBox
      // 
      this.DetailsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(378, 247, true);
      // 
      // InvoiceDetailUserControl
      // 
      this.InvoiceDetailUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(376, 232, true);
      // 
      // BottomPanel
      // 
      this.BottomPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 296, true);
      // 
      // ApportionmentPendingLabel
      // 
      this.ApportionmentPendingLabel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(587, 32, true);
      // 
      // RightBottomPanel
      // 
      this.RightBottomPanel.Controls.Add(this.CustomsValueUSD);
      this.RightBottomPanel.Controls.Add(this.CustomsValueKRW);
      ...
      this.RightBottomPanel.Controls.SetChildIndex(this.CustomsValueKRW, 0);
      this.RightBottomPanel.Controls.SetChildIndex(this.CustomsValueUSD, 0);
      // 
      // InvoiceTabControl
      // 
      this.InvoiceTabControl.Controls.Add(this.SEDDetailsTabPage);
      this.InvoiceTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 296, true);
      this.InvoiceTabControl.Controls.SetChildIndex(this.SEDDetailsTabPage, 0);
      ...
      // 
      this.ComInvoiceDetailsTabPage.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(4, 19, true);
      this.ComInvoiceDetailsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 247, true);
      // 
      // ChargesGroupBox
      // 
      ...
      // ChargesTabControl
      // 
      this.ChargesTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(606, 112, true);
      // 
      // InvoiceChargesTabPage
      // 
      this.InvoiceChargesTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(598, 89, true);
      // 
      // InvoiceChargesGrid
      // 
      this.InvoiceChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(598, 89, true);
      // 
      // BaseGroupChargesGroupBox
      // 
      this.BaseGroupChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 114, true);
      // 
      // BaseGroupChargesGrid
      // 
      this.BaseGroupChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(606, 100, true);
      // 
      // JZ_FOBAmountBoundCurrencyControl
      // 
      this.JZ_FOBAmountBoundCurrencyControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(83, 6, true);
      // 
      ...
      this.JobComInvoiceHeadersBoundGrid.InnerGrid.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(1, 1, true);
      this.JobComInvoiceHeadersBoundGrid.InnerGrid.Name = "Grid";
      this.JobComInvoiceHeadersBoundGrid.InnerGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(992, 112, true);
      this.JobComInvoiceHeadersBoundGrid.InnerGrid.TabIndex = 0;
      // 
      // InvCustomFieldsDisplayControl
      // 
      this.InvCustomFieldsDisplayControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 273, true);
      // 
      // CustomFieldsTabPage
      // 
      this.CustomFieldsTabPage.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(4, 19, true);
      this.CustomFieldsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 273, true);
      // 
      // Splitter
      // 
      this.Splitter.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(360);
      // 
      // InvDetailLeftPanel
      // 
      this.InvDetailLeftPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(378, 247, true);
      // 
      // InvDetailRightPanel
      // 
      this.InvDetailRightPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 247, true);
      // 
      // ChargesGroupsSplitterContainer
      // 
      this.ChargesGroupsSplitterContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 247, true);
      ...
      // CustomsValueKRW
      // 
      this.BindingSource.SetBindingMember(this.CustomsValueKRW, "Invoices.CustomsValueKRW");
      // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
      CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.KR.Business.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.KR.Business.JobDeclaration)(null)).Invoices)).SyncRoot)).CustomsValueKRW)));
      this.CustomsValueKRW.DecimalPlaces = 2;
      this.CustomsValueKRW.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(358, 6, true);
      this.CustomsValueKRW.Name = "CustomsValueKRW";
      this.CustomsValueKRW.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(73, 15, true);
      this.CustomsValueKRW.TabIndex = 7;
      this.CustomsValueKRW.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
      this.CustomsValueKRW.TrackDisposedAccess = true;
      // 
      // CustomsValueUSD
      // 
      this.BindingSource.SetBindingMember(this.CustomsValueUSD, "Invoices.CustomsValueUSD");
      // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
      CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.KR.Business.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.KR.Business.JobDeclaration)(null)).Invoices)).SyncRoot)).CustomsValueUSD)));
      this.CustomsValueUSD.DecimalPlaces = 2;
      this.CustomsValueUSD.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(561, 6, true);
      this.CustomsValueUSD.Name = "CustomsValueUSD";
      this.CustomsValueUSD.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(73, 15, true);
      this.CustomsValueUSD.TabIndex = 8;
      this.CustomsValueUSD.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
      this.CustomsValueUSD.TrackDisposedAccess = true;
      // 
      // SEDDetailsTabPage
      // 
      this.SEDDetailsTabPage.CaptionResourceString = Enterprise.Customs.KR.GUI.Res.GetData("e5125326-86cc-4ff2-9630-b4b45c27df2a", "SED Details");
      this.SEDDetailsTabPage.Controls.Add(this.SEDDetailsDynamicLayoutPanel);
      this.SEDDetailsTabPage.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(4, 19, true);
      this.SEDDetailsTabPage.Name = "SEDDetailsTabPage";
      this.SEDDetailsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 273, true);
      this.SEDDetailsTabPage.TabIndex = 100;
      // 
      // SEDDetailsDynamicLayoutPanel
      // 
      this.SEDDetailsDynamicLayoutPanel.AllowDrop = true;
      this.SEDDetailsDynamicLayoutPanel.AutoValidate = System.Windows.Forms.AutoValidate.EnablePreventFocusChange;
      this.SEDDetailsDynamicLayoutPanel.Dock = System.Windows.Forms.DockStyle.Left;
      this.SEDDetailsDynamicLayoutPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 0, true);
      this.SEDDetailsDynamicLayoutPanel.Name = "SEDDetailsDynamicLayoutPanel";
      this.SEDDetailsDynamicLayoutPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(509, 273, true);
      this.SEDDetailsDynamicLayoutPanel.TabIndex = 0;
      // 
      ...
      this.SEDDetailsTabPage.ResumeLayout(false);
      this.SEDDetailsTabPage.PerformLayout();
      ...
      this.PerformLayout();
		...
		private ZArchitecture.ZCalcEdit CustomsValueUSD;
		private ZArchitecture.ZCalcEdit CustomsValueKRW;
		private ZArchitecture.GUI.ZTabPage SEDDetailsTabPage;
		private ZArchitecture.GUI.DynamicLayoutPanel SEDDetailsDynamicLayoutPanel;
	}
}
