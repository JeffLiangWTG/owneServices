...
{
	public sealed class MessageSendingPostClearanceDetailsLayout : IPanelLayoutProvider
	{
		...
		{
			var common = PostClearanceDetailsControlBag.InstanceForMessageSendingObject;
