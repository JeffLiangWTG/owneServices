...
{
	public class ResponsiblePersonLayout : IPanelLayoutProvider
	{
		...
		static PanelLayout CreateLayout()
		{
			...
			layout.Include(0, captionRuler1, controlBag.AuditorGuidDropEdit, columnWidthRuler1);
			layout.AddColumn();
			layout.Include(1, captionRuler2, controlBag.AuditorNameTextBox, columnWidthRuler2);
			layout.AddColumn();
			layout.Include(2, captionRuler3, controlBag.AuditorPhoneTextBox, columnWidthRuler3);
			layout.AddColumn();
			layout.Include(3, captionRuler4, controlBag.AuditorJobTitleTextBox, columnWidthRuler4);
