...
{
	public class ImportDHSMessageSendingFormBuilder : ImportAmendmentMessageSendingFormBuilder
	{
		protected override ZTextBoxColumnStyleInfo[] GetAdditionalColumnStyles()
		{
			...
			result.AddRange(new ZTextBoxColumnStyleInfo[]
			{
				...
				new ZTextBoxColumnStyleInfo
				{
					ColumnName = nameof(JobDeclarationAmendmentMessageSendingObject.AmendmentTypeForInvoiceLine),
