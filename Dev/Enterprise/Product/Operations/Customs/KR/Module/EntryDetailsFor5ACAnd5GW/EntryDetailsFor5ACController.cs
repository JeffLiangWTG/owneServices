...
{
	public class EntryDetailsFor5ACController : ZController
	{
		public override ControllerID ID => ControllerIDs.Customs.KR.ExportEntryDetails;
		public override ModuleIdentifier ModuleID => ModuleIDs.Customs.KR.ExportEntryDetails;
