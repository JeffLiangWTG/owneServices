...
{
	public class EntryDetailsFor5GWController : ZController
	{
		public override ControllerID ID => ControllerIDs.Customs.KR.ImportEntryDetails;
		public override ModuleIdentifier ModuleID => ModuleIDs.Customs.KR.ImportEntryDetails;
