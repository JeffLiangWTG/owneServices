...
{
	partial class EntryDetailsFor5ACFilterControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.KR.Business.KREntryHeaderDetailsView)(null)).KEH_ExportPackQty)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.KR.Business.KREntryHeaderDetailsView)(null)).KEH_TotalWeightInKG)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Customs.KR.Business.KREntryHeaderDetailsView)(null)).KEH_OA_SupplierAddress)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.KR.Business.KREntryHeaderDetailsView)(null)).KEH_SupplierName)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZDateTime)(((Enterprise.Customs.KR.Business.KREntryHeaderDetailsView)(null)).KEH_EntryCreatedLocalTime)));
			zTextBoxColumnStyleInfo1.ColumnName = "FormattedEntryNum";
			zTextBoxColumnStyleInfo1.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(120);
			zCalcEditColumnStyleInfo1.CaptionResourceString = Enterprise.Customs.KR.Module.Res.GetData("7712712F-DED5-4B59-9C85-ED7C65B7B084", "Total Customs Value (KRW)");
			...
			// 
			// EntryDetailsFor5ACAnd5GWFilterControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.Name = "EntryDetailsFor5ACAnd5GWFilterControl";
