...
{
	sealed class GOVCBR5DRCancellationSenderTest : TestCaseWithFactory
	{
		IEnumerable<JobDeclarationMiscMessageSendingObject> GetMessageParents() => MessageSendingObjects;

		MessageSender GetMessageSender() => IsExceptionTest ? new GOVCBR5DRCancellationSenderForTest(MessageSendingObjects, ElectronicDocumentTypeList.Codes._5DR, Factory) : new GOVCBR5DR5DSCancellationSender(MessageSendingObjects, ElectronicDocumentTypeList.Codes._5DR, Factory);
		...
		ZString MessageType => ElectronicDocumentTypeList.Codes._5DR;
		...
		class GOVCBR5DRCancellationSenderForTest : GOVCBR5DR5DSCancellationSender
		{
			public GOVCBR5DRCancellationSenderForTest(IEnumerable<JobDeclarationMiscMessageSendingObject> sendingObjects, string messageType, BusinessObjectFactory factory) : base(sendingObjects, messageType, factory)
			{
			}
