...
{
	sealed class GOVCBR5DSAmendmentSenderTest : CusEntryHeaderAmendmentMessageSenderTest<GOVCBR5DS5DRAmendmentSender>
	{
		protected override IEnumerable<JobDeclarationAmendmentMessageSendingObject> GetMessageParents() => MessageSendingObjects;

		protected override MessageSender GetMessageSender() => IsExceptionTest ? new GOVCBR5DS5DRAmendmentSenderForTest(MessageSendingObjects, ElectronicDocumentTypeList.Codes._5DS, Factory) : new GOVCBR5DS5DRAmendmentSender(MessageSendingObjects, ElectronicDocumentTypeList.Codes._5DS, Factory);
		...
		protected override ZString MessageType => ElectronicDocumentTypeList.Codes._5DS;
