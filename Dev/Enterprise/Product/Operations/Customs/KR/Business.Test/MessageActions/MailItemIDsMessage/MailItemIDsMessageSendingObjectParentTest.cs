...
{
	[TestedType(typeof(MailItemIDsMessageSendingObjectParent))]
	sealed class MailItemIDsMessageSendingObjectParentTest : NonPersistentBusinessObjectTestCase
	{
		...
		public void TestSendingObjectsCollection()
		{
			...
			var objectParent1 = new MailItemIDsMessageSendingObjectParent(declaration1);
			...
			declaration2.CustomsEntryHeaders.AddNew();
			var objectParent2 = new MailItemIDsMessageSendingObjectParent(declaration2);
		...
		public void TestObjectsToSend()
		{
			...
			var objectParent = new MailItemIDsMessageSendingObjectParent(declaration);
