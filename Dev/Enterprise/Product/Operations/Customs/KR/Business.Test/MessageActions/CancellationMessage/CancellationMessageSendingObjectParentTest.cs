...
{
	[TestedType(typeof(CancellationMessageSendingObjectParent))]
	sealed class CancellationMessageSendingObjectParentTest : NonPersistentBusinessObjectTestCase
	{
		...
		public void TestSendingObjectsCollection()
		{
			...
			var objectParent1 = new CancellationMessageSendingObjectParent(declaration1);
			...
			declaration2.CustomsEntryHeaders.AddNew();
			var objectParent2 = new CancellationMessageSendingObjectParent(declaration2);
		...
		public void TestObjectsToSend()
		{
			...
			var objectParent = new CancellationMessageSendingObjectParent(declaration);
