...
{
	[TestedType(typeof(ValuationDeclarationMessageSendingObjectParent))]
	sealed class ValuationDeclarationMessageSendingObjectParentTest : NonPersistentBusinessObjectTestCase
	{
		...
		public void TestSendingObjectsCollection()
		{
			...
			var objectParent1 = new ValuationDeclarationMessageSendingObjectParent(declaration1);
			...
			declaration2.CustomsEntryHeaders.AddNew();
			var objectParent2 = new ValuationDeclarationMessageSendingObjectParent(declaration2);
		...
		public void TestObjectsToSend()
		{
			...
			var objectParent = new ValuationDeclarationMessageSendingObjectParent(declaration);
