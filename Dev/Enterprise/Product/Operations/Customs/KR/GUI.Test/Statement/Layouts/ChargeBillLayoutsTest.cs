...
{
	[TestedType(typeof(ChargeBillLayouts))]
	sealed class ChargeBillLayoutsTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (StatementHeaderControlBag.Instance.ProcessAndDueDateUserControl, ControlWidthClass.Auto);
				...
				yield return (StatementHeaderControlBag.Instance.PayerFromCustomsTextBox, ControlWidthClass.Auto);
			}
		}
