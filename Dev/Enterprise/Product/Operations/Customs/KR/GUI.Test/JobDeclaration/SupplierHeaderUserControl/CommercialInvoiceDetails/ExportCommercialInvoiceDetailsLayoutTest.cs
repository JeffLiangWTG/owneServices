...
{
	[TestedType(typeof(ExportCommercialInvoiceDetailsLayout))]
	sealed class ExportCommercialInvoiceDetailsLayoutTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (CommercialInvoiceDetailsControlBag.Instance.PaymentTermsCodeDropEdit, ControlWidthClass.Auto);
				yield return (CommercialInvoiceDetailsControlBag.Instance.LetterOfCreditNumberTextBox, ControlWidthClass.Auto);
				yield return (CommercialInvoiceDetailsControlBag.Instance.NoteTextLongTextControl, ControlWidthClass.Auto);
			}
		}
	}
}
