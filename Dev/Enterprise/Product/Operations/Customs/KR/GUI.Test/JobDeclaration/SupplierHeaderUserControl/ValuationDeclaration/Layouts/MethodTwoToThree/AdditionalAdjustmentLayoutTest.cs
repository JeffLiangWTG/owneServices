...
{
	[TestedType(typeof(AdditionalAdjustmentLayout))]
	sealed class AdditionalAdjustmentLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new AdditionalAdjustmentLayout();
