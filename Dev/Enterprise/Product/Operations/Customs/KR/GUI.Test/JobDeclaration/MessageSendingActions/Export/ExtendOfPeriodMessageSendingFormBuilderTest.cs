...
{
	class ExtendOfPeriodMessageSendingFormBuilderTest : TestCaseWithFactory
	{
		public void TestGetColumnStyle()
		{
			var builder = new ExtendOfPeriodMessageSendingFormBuilder();
			...
			AssertEquals(nameof(JobDeclarationMiscMessageSendingObject.CurrentDate), list[7].ColumnName);
			AssertEquals(nameof(JobDeclarationMiscMessageSendingObject.NewDate), list[8].ColumnName);
		}
	...
	class ExtendOfPeriodMessageSendingActionFormTest : Customs.GUI.Testing.MessageSendingObjectFormTest
	{
		protected override Form GetFormToBashCore()
		{
			return new MessageSendingActionForm(new JobDeclarationMiscMessageSendingObjectParent(declaration, ElectronicDocumentTypeList.Codes._5AS, MessageFunctions.MessageFunctionCode.Extend), new ExtendOfPeriodMessageSendingFormBuilder());
		}
