...
{
	[TestedType(typeof(CertificateOfOriginIssueLayout))]
	sealed class CertificateOfOriginIssueLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new CertificateOfOriginIssueLayout();
