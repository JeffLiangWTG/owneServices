...
{
	[TestedType(typeof(MethodTwoToSixGoodsPricingBasisSendingObjectLayout))]
	sealed class MethodTwoToSixGoodsPricingBasisSendingObjectLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new MethodTwoToSixGoodsPricingBasisSendingObjectLayout();
