...
{
	[TestedType(typeof(AmountAgreedUponWithCustomsLayout))]
	sealed class AmountAgreedUponWithCustomsLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new AmountAgreedUponWithCustomsLayout();
