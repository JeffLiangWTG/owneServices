...
{
	[TestedType(typeof(DeductionAdjustmentLayout))]
	sealed class DeductionAdjustmentLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new DeductionAdjustmentLayout();
