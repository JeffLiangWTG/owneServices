...
{
	[TestedType(typeof(MethodTwoToSixItemUseCodeSendingObjectLayout))]
	sealed class MethodTwoToSixItemUseCodeSendingObjectLayoutTest : LayoutsAbstractTest
	{
		...
		{
			IPanelLayoutProvider layout = new MethodTwoToSixItemUseCodeSendingObjectLayout();
