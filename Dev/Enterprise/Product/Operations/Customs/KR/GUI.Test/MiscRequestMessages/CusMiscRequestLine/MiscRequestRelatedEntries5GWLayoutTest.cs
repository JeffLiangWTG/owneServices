...
{
	[TestedType(typeof(MiscRequestRelatedEntries5GWLayout))]
	sealed class MiscRequestRelatedEntries5GWLayoutTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				yield return (MiscRequestRelatedEntriesControlBag.Instance.EntryTypeDropEdit, ControlWidthClass.Long);
