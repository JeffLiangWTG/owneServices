...
{
	partial class FrDeclarationSendValideeActionApplicatorControl
	{
		/// <summary> 
		...
		void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.FR.Business.OperationalActions.FrDeclarationSendValideeMessageApplicator);
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Customs.FR.Business.OperationalActions.FrDeclarationSendValideeMessageApplicator)(null)).SendMessagesEvenWithMessageErrors)));
			this.sendMessagesEvenWithMessageErrorsCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(114, 78, true);
