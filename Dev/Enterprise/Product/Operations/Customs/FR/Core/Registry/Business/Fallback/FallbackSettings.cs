...
{
	[DebuggerDisplay("FallbackSettings. Start={Start}; End={End} InvocationReason={InvocationReason}; RevocationReason={RevocationReason}; Regularisation={Regularisation};" +
	...
	public class FallbackSettings : RegistryBusinessObjectTemplate
	{
		#region Constants
		...
		{
			return new FallbackSettings(fallbackLevel, factory);
		}
		...
		public FallbackSettings(BusinessObjectFactory factory)
		: base(factory)
		{
		}
		public FallbackSettings(FallbackLevel fallbackLevel, BusinessObjectFactory factory)
		...
		public static MultilingualString StartDateNotEmpty => ResString.GetMultilingualString("FallbackSettings-StartDateNotEmpty", "Start date cannot be empty.");

		public static MultilingualString EndDateNotEmpty => ResString.GetMultilingualString("FallbackSettings-EndDateNotEmpty", "End date cannot be empty.");

		public static MultilingualString EndAfterStart => ResString.GetMultilingualString("FallbackSettings-EndAfterStart", "End date should be after start date.");

		public static MultilingualString InvocationReasonNotEmpty => ResString.GetMultilingualString("FallbackSettings-InvocationReasonNotEmpty", "Invocation reason cannot be empty.");

		public static MultilingualString RevocationReasonNotEmpty => ResString.GetMultilingualString("FallbackSettings-RevocationReasonNotEmpty", "End fallback is given, revocation reason cannot be empty.");

		public static MultilingualString RegularisationNotEmpty => ResString.GetMultilingualString("FallbackSettings-RegularisationNotEmpty", "End fallback is given, regularization date cannot be empty.");

		public static MultilingualString RegularisationPeriodNotEmpty => ResString.GetMultilingualString("FallbackSettings-RegularisationPeriodNotEmpty", "End fallback is given, regularization period cannot be empty.");

		public static MultilingualString RegularisationAfterEnd => ResString.GetMultilingualString("FallbackSettings-RegularisationAfterEnd", "Fallback regularization date should be after Fallback End date.");
