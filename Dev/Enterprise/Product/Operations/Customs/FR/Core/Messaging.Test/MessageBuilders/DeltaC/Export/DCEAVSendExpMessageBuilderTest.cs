...
{
	public class DCEAVSendExpMessageBuilderTest : DCSendMessageBuilderTest<DCEAVSendExpMessageBuilder>
	{
		...
		protected override ZString[] ItemsContains => new ZString[] { "<Entete><codact>6</codact>" };
