...
{
	class ECSSendMessageIE618Test : TestCaseWithFactory
	{
		public void TestBuild()
		{
			...
			var messageBuilder = messageBuilderManager.NewMessageBuilder(MessageSubTypeList.Codes.DEP);
			var message = messageBuilder.GetMessage();

			AssertContains("<EnveloppeMessage><schemaID>MessageIE618</schemaID><schemaVersion>01012012</schemaVersion><partyId>39433691100042</partyId><transactionId>" + GlbCompany.CurrentCompany.LicenceKeyIdentifier + "+ECS+&lt;&lt;INTERCHANGENUMBERPLACEHOLDER&gt;&gt;</transactionId><numseq>0</numseq></EnveloppeMessage>", message);
			AssertContains("<Gen><mrnecs>20FRD4440053891480</mrnecs><bureausortie>FR002650</bureausortie><opeben>40433691100042</opeben><numagr>00001909</numagr><locagr>39433691100042/1</locagr></Gen>", message);
