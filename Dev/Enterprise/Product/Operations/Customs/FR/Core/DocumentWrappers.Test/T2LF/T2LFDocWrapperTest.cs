...
sealed class T2LFDocWrapperTest : DocBaseWrapperTest
{
	public void TestT2LDocLines()
	{
		AssertType<T2LFDocWrapper>("Wrapper should be of type T2LFDocWrapper", Wrapper);
		AssertEquals("Wrapper.Lines should populate elements for the T2LFApplicableEntryLines in entry header.", 3, Wrapper.T2LDocLines.Count);
	}
	...
	protected override DocBaseWrapper GetNewDocumentWrapper()
	{
		...
		invoiceLine1.SupportingDocuments.AddNew().CSI_Code = UniversalReferenceConstants.RefCusCodeList.SupportingDocumentsCodes.T2LFDocument;
		...
		invoiceLine4.SupportingDocuments.AddNew().CSI_Code = UniversalReferenceConstants.RefCusCodeList.SupportingDocumentsCodes.T2LFDocument;
		...
		return T2LFDocWrapper.New(entryHeader, Factory);
	}

	new T2LFDocWrapper Wrapper => (T2LFDocWrapper)base.Wrapper;
}
