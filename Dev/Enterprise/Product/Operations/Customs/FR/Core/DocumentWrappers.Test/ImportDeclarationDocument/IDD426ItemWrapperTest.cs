...
class IDD426ItemWrapperTest : Enterprise.DocumentWrappers.Testing.DocBaseWrapperTest
{
	protected override DocBaseWrapper GetNewDocumentWrapper()
	{
		return IDD426ItemWrapper.New(1, goodsShipmentItem, Factory);
	}
	...
	public void TestItemAmountInvoiced()
	{
		...
		var wrapper = new IDD426ItemWrapper(1, goodsShipmentItem, Factory);
	...
	public void TestLiquidation()
	{
		...
		var wrapper = new IDD426ItemWrapper(1, goodsShipmentItem, goodsShipmentItemFromDetailedTaxation, new List<DutiesAndTaxesSummariesType>(), Factory);
		AssertEquals("Liquidation", "ABC", (wrapper.Liquidation.DutiesAndTax.FirstOrDefault() as IDD426DutiesAndTaxWrapper).TaxType);
	}
