...
class IDD429DutiesAndTaxesWrapperTest : Enterprise.DocumentWrappers.Testing.DocBaseWrapperTest
{
	protected override DocBaseWrapper GetNewDocumentWrapper()
	{
		var dutiesAndTaxes = new DutiesAndTaxesType();
		var dutiesAndTaxesSummaries = new List<DutiesAndTaxesSummariesType>();
		return IDD429DutiesAndTaxWrapper.New(dutiesAndTaxes, dutiesAndTaxesSummaries, Factory);
	}
	...
	public void TestNationalTaxType()
	{
		...
		var wrapper = IDD429DutiesAndTaxWrapper.New(dutiesAndTaxes, dutiesAndTaxesSummaries, Factory);
