...
{
	public class FrDeclarationSendValideeActionApplicatorControlTest : TestCaseWithFactory
	{
		public void TestControls()
		{
			using (var zForm = new ZForm())
			using (var applicatorControl = new FrDeclarationSendValideeActionApplicatorControl())
			{
