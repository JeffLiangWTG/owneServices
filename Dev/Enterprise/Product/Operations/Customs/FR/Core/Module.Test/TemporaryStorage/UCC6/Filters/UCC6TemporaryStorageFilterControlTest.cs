...
{
	class UCC6TemporaryStorageFilterControlTest : TestCaseWithFactory
	{
		public void TestColumns()
		{
			using (var form = new ZForm())
			{
				...
				AssertColumn(columnStyles, AsycudaManifestHeaderSchema.Constants.AMA_ManifestType, "Declaration Type");
			}
