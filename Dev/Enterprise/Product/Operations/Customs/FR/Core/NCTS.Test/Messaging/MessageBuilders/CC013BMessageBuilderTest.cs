...
{
	class CC013BMessageBuilderTest : TestCaseWithFactory
	{
		...
		public void TestSecHEA358()
		{
			...
			AssertContains("<SecHEA358>", messageBuilder.GetXMLMessageWithoutNamespaces());
		...
		{
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("0", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("1", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("2", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("3", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("4", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("9", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() { MessageBuilderUtilities.SetupGuarantee("B", "12346789", "AAAAAAAAAA", "ABCD", 12.68m) });
			...
			dataProviderMock.Setup(m => m.Guarantees)
				.Returns(new List<IGuarantee>() {
					MessageBuilderUtilities.SetupGuarantee("5", "12346789", "AAAAAAAAAA", "ABCD", 12.68m),
					MessageBuilderUtilities.SetupGuarantee("6", "987654321", "BBBBB", "WXYZ", 32.33m),
					MessageBuilderUtilities.SetupGuarantee("7", "987654321", "BBBBB", "WXYZ", 32.33m),
					MessageBuilderUtilities.SetupGuarantee("8", "987654321", "BBBBB", "WXYZ", 32.33m),
					MessageBuilderUtilities.SetupGuarantee("A", "987654321", "BBBBB", "WXYZ", 32.33m) });
		...
		public void TestDoNotPopulateValFacGDS1013_IfBillValueIsZero()
		{
			var goodsItemMock = SetupGoodsItem(
				...
				ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty,
				null, null, Enumerable.Empty<ZString>(), Enumerable.Empty<EU.NCTS.Business.PackageWrapper>(), null, null);
		...
		public void TestCC013BMessageBuilder()
		{
			var expectedXml = MessageBuilderUtilities.GetEmbeddedResourceFile("CC013BMessageXml.xml");
		...
		public void TestRoundingOfBillValue()
		{
			...
			CombineAssertions(() =>
			{
				AssertContains("Bill Value shouldn't how any decimal in the message", "<ValFacGDS1013>123</ValFacGDS1013>", xmlMsgWithNoNamespaces);
			});
		}
		...
		public void TestDatPreDepEnTraHEA1019()
		{
			CombineAssertions(() =>
			{
				...
				dataProviderMock.Setup(m => m.PrelodgeDeclarationIndicator).Returns(new ZBool("1"));
		...
		public void TestNamPC17PresenceIfTIR()
		{
			...
			principalMock.Setup(m => m.Name).Returns("STEPHEN BRENNAN PERSONAL SHIPMENTS SPECIALISTS");
			principalMock.Setup(m => m.CompanyName).Returns("STEPHEN BRENNAN COMPANY NAME  ");
			principalMock.Setup(m => m.NameAndAddressLanguage).Returns("EN-EN");
			principalMock.Setup(m => m.StreetAndNumber).Returns("10 MOYANGUL DRIVE");
			principalMock.Setup(m => m.PostalCode).Returns("3033");
			principalMock.Setup(m => m.City).Returns("KEILOR EAST");
    ...
    <TINPC159>GB13131313131313</TINPC159>
			...
			dataProviderMock.Setup(m => m.IsTIRDeclaration).Returns(true);
			AssertContains(@"<TRAPRIPC1>
    <NamPC17>STEPHEN BRENNAN COMPANY NAME</NamPC17>
    <TINPC159>GB13131313131313</TINPC159>
    ...
    <HITPC126>AU0123456789348</HITPC126>
		...
		public void TestPopulateTRACONCO1_NameAddAddress()
		{
			...
			consignorMock.Setup(m => m.CompanyName).Returns("STEPHEN BRENNAN COMPANY NAME  ");
    ...
    <NamCO17>STEPHEN BRENNAN COMPANY NAME</NamCO17>
  ...
  </TRACONCO1>", messageBuilder.GetXMLMessageWithoutNamespaces());
		}
  ...
  </TRACONCE1>", messageBuilder.GetXMLMessageWithoutNamespaces());
		}
    ...
    <RepCapREP18>THE BOSS</RepCapREP18>
		...
		public void TestPopulateTRACONCO2_NameAddAddress()
		{
			...
			var goodsItem = SetupGoodsItem(ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, consignorMock.Object, null, Enumerable.Empty<ZString>(), Enumerable.Empty<IPackage>(), null, null).Object;
			dataProviderMock.Setup(m => m.GoodsItems).Returns(new IDepartureGoodsItem[] { goodsItem });
      ...
      <NADLNGGTCO>EN</NADLNGGTCO>
		...
		public void TestPopulateTRACONCE2_NameAddAddress()
		{
			...
			var goodsItem = SetupGoodsItem(ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, null, consigneeMock.Object, Enumerable.Empty<ZString>(), Enumerable.Empty<IPackage>(), null, null).Object;
			dataProviderMock.Setup(m => m.GoodsItems).Returns(new IDepartureGoodsItem[] { goodsItem });
      ...
      <NADLNGGICE>EN</NADLNGGICE>
		...
		{
			var package = MessageBuilderUtilities.SetupPackage(ZString.Empty, "BX", 0, 15, false, false);
			var goodsItem = SetupGoodsItem(ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, null, null, Enumerable.Empty<ZString>(), new IPackage[] { package }, null, null).Object;
			dataProviderMock.Setup(m => m.GoodsItems).Returns(new IDepartureGoodsItem[] { goodsItem });
			var xmlMsgWithNoNamespaces = messageBuilder.GetXMLMessageWithoutNamespaces();
			CombineAssertions(() =>
			{
				AssertContains("tag NumOfPacGS24 is present even with 0 package", "<NumOfPacGS24>0</NumOfPacGS24>", xmlMsgWithNoNamespaces);
				AssertNotContains("Number of Pieces for BX", "<NumOfPieGS25>15</NumOfPieGS25>", xmlMsgWithNoNamespaces);
			});

			package = MessageBuilderUtilities.SetupPackage(ZString.Empty, "NG", 0, 15, true , true);
			goodsItem = SetupGoodsItem(ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, ZString.Empty, null, null, Enumerable.Empty<ZString>(), new IPackage[] { package }, null, null).Object;
			dataProviderMock.Setup(m => m.GoodsItems).Returns(new IDepartureGoodsItem[] { goodsItem });
			xmlMsgWithNoNamespaces = messageBuilder.GetXMLMessageWithoutNamespaces();
			CombineAssertions(() =>
			{
				AssertNotContains("no tag NumOfPacGS24 for NG type", "<NumOfPacGS24>0</NumOfPacGS24>", xmlMsgWithNoNamespaces);
				AssertContains("tag NumOfPieGS25 for NG type", "<NumOfPieGS25>15</NumOfPieGS25>", xmlMsgWithNoNamespaces);
			});
		}
      ...
      <TRACORSECGOO021LNG>EN</TRACORSECGOO021LNG>
		...
		public void TestPopulateTRACORSECGOO021_Null()
		{
			...
			CombineAssertions(() =>
			{
				AssertNotContains("No Group", "<TRACORSECGOO021>", messageBuilder.GetXMLMessageWithoutNamespaces());
    ...
    <TRACORSEC037LNG>EN</TRACORSEC037LNG>
		...
		public void TestPopulateTRACORSEC037_Null()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("There should be no error when lack of consignor security.", 0, errorCollector.ErrorCount);
			});
		}
    ...
    <TRACONSEC029LNG>EN</TRACONSEC029LNG>
		...
		public void TestCommentIsNotPopulateInTheMessageIfIsEmpty()
		{
			messageBuilder = new CC013BMessageBuilder(dataProviderMock.Object, new DeclarationAmendmentMessage("explanationToCustomsForWhyCancelling", ""), errorCollector);
			AssertNotContains("<ComHEA1018>", messageBuilder.GetXMLMessageWithoutNamespaces());
		}

		public void TestPopulateDonSurSecHEA1001()
		{
			dataProviderMock.Setup(m => m.ProvisionalTransitDepartureDate).Returns("07122020");
			dataProviderMock.Setup(m => m.PrelodgeDeclarationIndicator).Returns(false);
			dataProviderMock.Setup(m => m.SafetyAndSecurityData).Returns(false);
			...
			dataProviderMock.Setup(m => m.PrelodgeDeclarationIndicator).Returns(true);
			dataProviderMock.Setup(m => m.SafetyAndSecurityData).Returns(false);
			AssertContains(@"<DonSurSecHEA1001>0</DonSurSecHEA1001>", messageBuilder.GetXMLMessageWithoutNamespaces());
		...
		protected override void SetUp()
		{
			...
			carrierMock = new Mock<ITrader>();
			carrierMock.Setup(m => m.TIN).Returns("ES3149375789002");
			...
			dataProviderMock = new Mock<ICC013BDeclaration>();
			...
			dataProviderMock.Setup(m => m.ContainerisedIndicator).Returns(new ZBool("1"));
			dataProviderMock.Setup(m => m.DialogLanguageIndicatorAtDeparture).Returns(ZString.Empty);
			dataProviderMock.Setup(m => m.NctsAccompanyingDocumentLanguageCode).Returns("EN");
			...
			dataProviderMock.Setup(m => m.TotalGrossMass).Returns(20.2468);
			...
			dataProviderMock.Setup(m => m.AmendmentDate).Returns("20210518");
			...
			dataProviderMock.Setup(m => m.SafetyAndSecurityData).Returns(true);
			dataProviderMock.Setup(m => m.PrelodgeDeclarationIndicator).Returns(new ZBool("0"));
			...
			dataProviderMock.Setup(m => m.ControlResultDateLimit).Returns("20200527");
			dataProviderMock.Setup(m => m.Declarant).Returns(declarantMock.Object);
			dataProviderMock.Setup(m => m.NumberOfSeals).Returns(new ZInt("3"));
			...
			messageBuilder = new CC013BMessageBuilder(dataProviderMock.Object, new DeclarationAmendmentMessage("explanationToCustomsForWhyCancelling", "commentOnTheCancelling"), errorCollector);
		}
		...
		Mock<ICC013BDeclaration> dataProviderMock;
		ErrorCollector errorCollector;
		CC013BMessageBuilder messageBuilder;
