...
{
	class CC013CWrapperTest : Customs.Business.Testing.DataProviderTestCase<CC013CWrapper>
	{
		...
		{
			AssertContainsExactElementsInAnyOrder("Authorisation should be using AuthorisationUsageWrapper.", new string[] { "AUT1", "AUT2" }, Provider.Authorisation.Select(x => x.Type));
		}
		...
		{
			AssertEquals("CustomsOfficeOfDestinationDeclared should be using CustomsOfficeWrapper.", "FR000001", Provider.CustomsOfficeOfDestinationDeclared.ReferenceNumber);
		}

		public void TestCustomsOfficeOfTransitDeclared()
		{
			AssertContainsExactElementsInAnyOrder("CustomsOfficeOfTransitDeclared should be using CustomsOfficeOfTransitWrapper.", new string[] { "FR000002, 2/02/2024 12:00:00 AM", "FR000003, 3/03/2024 12:00:00 AM" }, Provider.CustomsOfficeOfTransitDeclared.Select(x => x.ReferenceNumber + ", " + x.ArrivalDateAndTimeEstimated));
		}

		public void TestCustomsOfficeOfExitForTransitDeclared()
		{
			AssertContainsExactElementsInAnyOrder("CustomsOfficeOfExitForTransitDeclared should be using CustomsOfficeWrapper.", new string[] { "FR000004", "FR000005" }, Provider.CustomsOfficeOfExitForTransitDeclared.Select(x => x.ReferenceNumber));
		}
		...
		{
			AssertEquals("Representative should be using RepresentativeWrapper.", "BN CORP", Provider.Representative.Name);
		}

		public void TestGuarantee()
		{
			AssertContainsExactElementsInAnyOrder("Guarantee should be using GuaranteeWrapper.", new string[] { "GUA1", "GUA2" }, Provider.Guarantee.Select(x => x.OtherGuaranteeReference));
		}
		...
		public void TestMessageEnveloppe()
		{
			...
			AssertEquals("MessageEnveloppe should be using MessageEnveloppeWrapper - SchemaId.", "IE013", Provider.MessageEnveloppe.SchemaId);
		}

		protected override CC013CWrapper GetProvider()
		{
			...
			representative.OH_FullName = "BN CORP";
			...
			guarantee1.PW_BondNumber2 = "GUA1";
			var guarantee2 = nctsHeader.MovementHeader.Guarantees.AddNew();
			guarantee2.PW_BondNumber2 = "GUA2";

			return CC013CWrapper.New(new TP5MessageSendingObject(nctsHeader));
		}
	}
}
