...
{
	class CC015CWrapperTest : Customs.Business.Testing.DataProviderTestCase<CC015CWrapper>
	{
		...
		public void TestMessageEnveloppe()
		{
			...
			AssertEquals("MessageEnveloppe should be using MessageEnveloppeWrapper - SchemaId.", "IE015", Provider.MessageEnveloppe.SchemaId);
		}

		protected override CC015CWrapper GetProvider()
		{
			...
			return CC015CWrapper.New(new TP5MessageSendingObject(nctsHeader));
		}
	}
}
