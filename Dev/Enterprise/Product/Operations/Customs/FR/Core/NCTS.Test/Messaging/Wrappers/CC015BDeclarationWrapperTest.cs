...
{
	[TestedType(typeof(CC015BWrapper))]
	class CC015BDeclarationWrapperTest : DeclarationWrapperAbstractTest<CC015BWrapper>
	{
		...
		{
			var org = DeclarationWrapperHelperTest.CreateOrgHeaderWithDTA(Factory, "CC0003");
			header.Principal.E2_OA_Address = org.MainAddress.PK;
			AssertEquals("CC0003", wrapper.AgreementNumber);
		}

		public void TestIsPrelodge()
		{
			header.IsPrelodgedMovement = true;
			AssertEquals(true, wrapper.IsPrelodge);
		}
		...
		protected override void SetUp()
		{
			...
			wrapper = new CC015BWrapper(header);
		}
		NctsHeader header;
		ICC015BDeclaration wrapper;

		protected override CC015BWrapper GetProvider() => (CC015BWrapper)wrapper;
	}
}
