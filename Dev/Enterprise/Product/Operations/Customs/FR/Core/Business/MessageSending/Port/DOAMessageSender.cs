...
{
	public class DOAMessageSender : MessageSender<DOAMessageSendingObject>
	{
		public DOAMessageSender(DOAMessageSendingObject objectToSend, ErrorCollector errorCollector) : base(objectToSend, errorCollector)
		{
		}

		protected override MessageBuilderManager<DOAMessageSendingObject> GetBuilderManager()
		{
			return new DOAMessageBuilderManager(errorCollector);
		}
