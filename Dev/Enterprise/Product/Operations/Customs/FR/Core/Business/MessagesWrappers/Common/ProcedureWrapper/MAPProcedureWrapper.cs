...
{
	public class MAPProcedureWrapper : CusProcedureWrapper
	{
		public MAPProcedureWrapper(CusEntryHeader entryHeader, ZString actionCode, ZDateTime messageSentDate, EU.Business.ErrorCollector errorCollector)
