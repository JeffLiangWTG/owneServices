...
namespace Enterprise.Customs.FR.Business.EdiMessages
{
	...
	public class DeltaCExportResponsePrettier : FREDIMessagePrettier<TMessage>
	{
		public DeltaCExportResponsePrettier(DeltaCExportResponseMessageDataObject messageDataObject)
					: base(messageDataObject)
		{
		}

		public new DeltaCExportResponseMessageDataObject MessageDataObject => (DeltaCExportResponseMessageDataObject)base.MessageDataObject;
