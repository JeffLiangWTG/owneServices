...
{
	public class MDAProcedureWrapper : CusProcedureWrapper
	{
		public MDAProcedureWrapper(CusEntryHeader entryHeader, ZString actionCode, ZDateTime messageSentDate, EU.Business.ErrorCollector errorCollector)
