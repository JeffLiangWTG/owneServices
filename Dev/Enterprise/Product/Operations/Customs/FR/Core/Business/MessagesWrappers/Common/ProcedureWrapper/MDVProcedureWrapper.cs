...
{
	public class MDVProcedureWrapper : CusProcedureWrapper
	{
		public MDVProcedureWrapper(CusEntryHeader entryHeader, ZString actionCode, ZDateTime messageSentDate, EU.Business.ErrorCollector errorCollector)
