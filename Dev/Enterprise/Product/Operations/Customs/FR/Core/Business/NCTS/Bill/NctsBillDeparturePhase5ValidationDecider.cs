...
{
	public sealed class NctsBillDeparturePhase5ValidationDecider : EU.NCTS.Business.INctsBillDeparturePhase5ValidationDecider
	{
		...
		public bool IsRuleR0506Active => true;
