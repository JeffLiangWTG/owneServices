...
{
	public class DDSendExpMessageWrapper : IDeclarationImportExport
	{
		public DDSendExpMessageWrapper(DeltaGJobDeclarationMessageSendingObject messageToSend, EU.Business.ErrorCollector errorCollector)
		{
		...
		public IMessageEnvelope MessageEnvelope => messageEnvelope ?? (messageEnvelope = new EntryMessageEnvelopeWrapper(entryHeader, MessageSubTypeList.Codes.EXD));
		...
		{
			return new MetaDataWrapper(cusEntryHeader, MessageSubTypeList.Codes.EXD);
		}
