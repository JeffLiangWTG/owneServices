...
{
	public class NctsGuaranteeDeparturePhase5ValidationDecider : INctsGuaranteeDeparturePhase5ValidationDecider
	{
		...
		public bool IsRuleNAT086Active => true;

		public bool IsRuleNAT085Active => true;
