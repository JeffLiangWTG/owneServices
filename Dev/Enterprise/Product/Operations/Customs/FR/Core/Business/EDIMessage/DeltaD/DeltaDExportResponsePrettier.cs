...
namespace Enterprise.Customs.FR.Business.EdiMessages
{
	...
	public class DeltaDExportResponsePrettier : FREDIMessagePrettier<TMessage>
	{
		public DeltaDExportResponsePrettier(DeltaDExportResponseMessageDataObject messageDataObject)
			: base(messageDataObject)
		{
		}
		public new DeltaDExportResponseMessageDataObject MessageDataObject => (DeltaDExportResponseMessageDataObject)base.MessageDataObject;
		...
		public override ZString GetMessageInterpretation()
		{
			...
			if (ResponseMessage != null)
			{
				...
				+ ToH3IfNotEmpty("Entry ECS status: ", etat?.EtatEcs)
