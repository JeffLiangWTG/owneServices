...
{
	public class DDSendExpMessageWrapperTest : DCSendMessageWrapperTest
	{
		...
		protected override ZString SchemaID => "MessageDecExp";
		...
		protected override ZString MessageSubType => MessageSubTypeList.Codes.EXD;
