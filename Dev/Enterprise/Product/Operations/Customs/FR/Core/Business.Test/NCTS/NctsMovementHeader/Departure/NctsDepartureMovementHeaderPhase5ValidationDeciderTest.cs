...
namespace Enterprise.Customs.FR.Business.NCTS.Testing
{
	sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
	{
		...
		{
			AssertEquals(true, validationDecider.IsRuleB1858Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleC0191_2Active);
		}
		...
		public void TestIsRuleNAT050Active()
		{
			AssertEquals(true, validationDecider.IsRuleNAT050Active);
		}
		...
		public void TestIsRuleNAT103Active()
		{
			AssertEquals(true, validationDecider.IsRuleNAT103Active);
		}
