...
{
	sealed class IETS029_TIIProcessorTest : PNTSBaseProcessorTest<Iets029, IETS029Processor>
	{
		...
		protected override ZString GetMessageText() => resourceRetriever.Value.GetString("Enterprise.Customs.FR.Business.Testing.EDIMessage.TestFiles.PNTS_IETS029_TIIResponseMessage.xml");
