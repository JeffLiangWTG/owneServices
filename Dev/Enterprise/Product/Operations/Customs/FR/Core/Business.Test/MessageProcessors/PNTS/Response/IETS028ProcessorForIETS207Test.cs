...
{
	sealed class IETS028ProcessorForIETS207Test : PNTSBaseProcessorTest<Iets028, IETS028Processor>
	{
		protected override void AddPropertiesForTemporaryStorageHeader(TemporaryStorageHeader header)
		{
			header.LRN = "IETS207VALIDMESSAGE001";
		}
		...
		protected override ZString GetMessageText() => resourceRetriever.Value.GetString("Enterprise.Customs.FR.Business.Testing.EDIMessage.TestFiles.PNTS_IETS028ResponseMessageForIETS207.xml");
