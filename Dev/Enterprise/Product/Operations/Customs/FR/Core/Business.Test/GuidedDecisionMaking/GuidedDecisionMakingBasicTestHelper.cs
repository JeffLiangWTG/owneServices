...
namespace Enterprise.Customs.FR.Business.GDM.Testing
{
	...
	{
		public static GuidedDecisionMakingBasic CreateGuidedDecisionMakingBasicForTest(BusinessObjectFactory factory)
		{
			...
			gDMBasicSource.Setup(x => x.RegionOrTerritoryOfDestination).Returns("CONTI");
