...
{
	sealed class IETS030Processor_PNLTest : PNTSBaseProcessorTest<Iets030, IETS030Processor>
	{
		...
		protected override ZString GetExpectedMessageInterpretation() => new ZString(@"<style>body, p, td {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px;}</style><p style=""font-size: 120%""><strong>Status: </strong>Presentation Notification Not Linked<br><strong>MRN: </strong>21BEPT00000000QGU7<br><strong>CRN: </strong>CRN21BETS00000000QFU2<br><strong>FRN: </strong>FRN21BEPN000000C3FLU1<br><strong>Notification Date: </strong>1/05/2021 12:34:56 PM<br><strong>Remarks: </strong>The remark</p><p><strong>Linking Errors: </strong><table border=""1"" cellpadding=""1"" cellspacing=""0"" width=""100%"" class=""table""><tr align=""center""><td width=""100px"">Error reason</td><td width=""200px"">Remarks</td></tr><tr><td>Error Reason 1</td><td>Remark 1</td></tr><tr><td>Error Reason 2</td><td>Remark 2</td></tr></table></p>");

		protected override ZString GetExpectedCustomsStatus() => Enterprise.Customs.EU.Business.UniversalReferenceConstants.PNTS.CustomsStatus.PresentationNotificationNotLinked;
		...
		protected override ZString GetMessageText() => resourceRetriever.Value.GetString("Enterprise.Customs.FR.Business.Testing.EDIMessage.TestFiles.PNTS_IETS030_PNLResponseMessage.xml");
