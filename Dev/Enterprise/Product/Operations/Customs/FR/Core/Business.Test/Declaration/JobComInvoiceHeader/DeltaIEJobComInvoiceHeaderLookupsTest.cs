...
{
	class DeltaIEJobComInvoiceHeaderLookupsTest : TestCaseWithFactory
	{
		public void TestValuationCodeList()
		{
			...
			var list = invoiceheader.Lookups.ValuationCodeList;
			...
			declaration.JE_ApplicationCode = DeclarationApplicationCodeList.Codes.DeltaIE;
			list = invoiceheader.Lookups.ValuationCodeList;
