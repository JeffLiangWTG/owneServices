...
{
	sealed class CC025C_RI1_ProcessorTest : TP5BaseProcessorTest<Cc025CType, CC025CProcessor>
	{
		...
		protected override ZString ExpectedArrivalCustomsStatus => NCTS5ArrivalCustomsStatusList.Codes.ClosedFullRelease;
	}
}
