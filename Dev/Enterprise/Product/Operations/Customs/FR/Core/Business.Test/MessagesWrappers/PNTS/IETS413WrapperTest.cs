...
{
	class IETS413WrapperTest : Customs.Business.Testing.DataProviderTestCase<IETS413Wrapper>
	{
		[TestDate(2023, 01, 18)]
		...
		public void TestCrn()
		{
			AssertEquals("Crn should equal CE_EntryNum of CustomsRegistrationNumber entry number type with storageHeader parent", "7654321", Provider.Crn);
		}
		
		public void TestMrn()
		{
			AssertEquals("Mrn should equal CE_EntryNum of MovementReferenceNumber entry number type with storageHeader parent", "1234567", Provider.Mrn);
		}

		public void TestMessageType()
		{
			AssertEquals("MessageType should equal to MessageType of storageHeader", PNTSMessageTypeList.Codes.CombinedTemporaryStorage, Provider.MessageType);
		}
		...
		public void TestEnsReUseIndicator_FalseValue()
		{
			...
			var wrapper = IETS413Wrapper.New(storageHeader);
		...
		public void TestConsignmentHeaderMasterLevel()
		{
			...
			var storageHeader = Factory.NewWithValidTestData<TemporaryStorageHeader>();
			var provider = IETS413Wrapper.New(storageHeader);
		...
		protected override IETS413Wrapper GetProvider()
		{
			...
			newEntryNum.CE_EntryType = CusEntryNumberTypes.Standard.MovementReferenceNumber;
			...
			var newEntryNum3 = Factory.New<CusEntryNumber>();
			newEntryNum3.Parent = storageHeader;
			newEntryNum3.CE_EntryType = CusEntryNumberTypes.EU.LocalReferenceNumber;
			newEntryNum3.CE_EntryNum = "1234568";
			newEntryNum3.CE_IssueDate = new ZDateTime(2021, 12, 22, 5, 48, 28, 120);
			...
			storageHeader.AMA_MessageType = PNTSMessageTypeList.Codes.CombinedTemporaryStorage;

			return IETS413Wrapper.New(storageHeader);
		}
