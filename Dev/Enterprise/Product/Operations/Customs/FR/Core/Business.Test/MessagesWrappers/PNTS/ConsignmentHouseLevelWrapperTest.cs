...
{
	public class ConsignmentHouseLevelWrapperTest : ConsignmentDataProviderTestCase<ConsignmentHouseLevelWrapper>
	{
		...
		public void TestConsignmentItemHouseLevel()
		{
			AssertEquals("ConsignmentItemHouseLevel has 2 elements", 2, Provider.ConsignmentItemHouseLevel.Count);
			AssertType<ConsignmentItemWrapper>("First Consignment Item has a correct wrapper", Provider.ConsignmentItemHouseLevel.First());
			AssertType<ConsignmentItemWrapper>("Second Consignment Item has a correct wrapper", Provider.ConsignmentItemHouseLevel.Skip(1).First());
		}
		...
		protected override ConsignmentHouseLevelWrapper GetProvider()
		{
			bill = GetBill();
			return ConsignmentHouseLevelWrapper.New(bill);
		}
