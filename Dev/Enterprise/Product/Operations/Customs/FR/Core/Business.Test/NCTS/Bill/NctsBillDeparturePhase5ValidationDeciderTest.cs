...
namespace Enterprise.Customs.FR.Business.Testing.NCTS.Bill
{
	sealed class NctsBillDeparturePhase5ValidationDeciderTest : TestCase
	{
		...
		public void TestIsRuleN0002Active_1Active()
		{
		...
		public void TestIsRuleR0364Active()
		{
			AssertEquals(true, validationDecider.IsRuleR0364Active);
		}
