...
{
	class SupplierBuyerLinkBCMChargeRuleTest : TestCaseWithFactory
	{
		public void TestChargeCode()
		{
			AssertEquals("ChargeCode should be BCM.", UCCCustomsChargeTypeList.Codes.BuyingCommissionsCharge, testItem.GetChargeCode(null));
		}
		...
		public void TestGetPercentage()
		{
			...
			AssertEquals("Should get correct OL_BuyingCommissionPercentage.", 1.22m, testItem.GetPercentage(link));
		}
		...
		public void TestShouldApplyRule()
		{
			...
			AssertEquals("Should not apply for EXP jobs.", false, testItem.ShouldApplyRule(declaration));
		...
		{
			base.SetUp();
			testItem = new SupplierBuyerLinkBCMChargeRule();
		}
	}
}
