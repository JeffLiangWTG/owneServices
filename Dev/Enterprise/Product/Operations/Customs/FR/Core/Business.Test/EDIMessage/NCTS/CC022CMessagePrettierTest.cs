...
{
	sealed class CC022CMessagePrettierTest : NCTSMessagePrettierTest<Cc022CType, CC022CMessageDataObject>
	{
		protected override ZString GetExpectedMessageInterpretation() => new ZString(@"<style>body, p, td {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px;}</style><p style=""font-size: 120%""><strong>Status: </strong>Notification to Amend Declaration<br><strong>MRN: </strong>MRN1<br><strong>Amendment Notification Date and Time: </strong>7/11/2024 12:20:30 PM</p><p><strong>Functional Errors: </strong><table border=""1"" cellpadding=""1"" cellspacing=""0"" width=""100%"" class=""table""><tr align=""center""><td width=""75px"">Level</td><td width=""100px"">Error Code</td><td width=""100px"">Field Code</td><td width=""150px"">Error Reason</td><td width=""125px"">Original Value</td><td width=""150px"">Remarks</td></tr><tr><td>&nbsp;</td><td>12</td><td>errorPointer1</td><td>errorR1</td><td>originalAttributeValue1</td><td>Remark12</td></tr><tr><td>&nbsp;</td><td>13</td><td>errorPointer2</td><td>errorR2</td><td>originalAttributeValue2</td><td>A mandatory/required element is missing in the received data following the validation of Rule or Condition , e.g. a required element is not present.</td></tr><tr><td>&nbsp;</td><td>14</td><td>errorPointer3</td><td>errorR3</td><td>originalAttributeValue3</td><td>&nbsp;</td></tr></table></p>");
