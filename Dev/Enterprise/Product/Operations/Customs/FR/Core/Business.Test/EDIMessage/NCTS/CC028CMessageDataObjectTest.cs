...
{
	class CC028CMessageDataObjectTest : NCTSMessageDataObjectTest<CC028CMessageDataObject, Cc028CType>
	{
		protected override Type ExpectedPrettierType => typeof(CC028CMessagePrettier);
