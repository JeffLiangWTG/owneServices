...
{
	public class LADTCusTempStorageLineValidationTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			line = (LADTCusTempStorageLine)header.CusTempStorageDec.CusTempStorageLines.AddNew();
		}

		CusTempStorageJobHeader header;
		LADTCusTempStorageLine line;
	}
}
