...
{
	public class LADTCusTempStorageDecValidationTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			tempStorageDec = Factory.New<LADTCusTempStorageDec>();
		}

		LADTCusTempStorageDec tempStorageDec;
	}
}
