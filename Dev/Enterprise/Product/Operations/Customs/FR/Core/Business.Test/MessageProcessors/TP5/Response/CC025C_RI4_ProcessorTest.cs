...
{
	sealed class CC025C_RI4_ProcessorTest : TP5BaseProcessorTest<Cc025CType, CC025CProcessor>
	{
		protected override ZString GetMessageSubType() => TP5ResponseMessageSubTypeList.Codes.GoodsReleaseNotification;

		protected override ZString GetMessageText() => resourceRetriever.Value.GetString("Enterprise.Customs.FR.Business.Testing.EDIMessage.TestFiles.NCTS_CC025C_RI4_ResponseMessage.xml");
		...
		protected override ZString ExpectedArrivalCustomsStatus => NCTS5ArrivalCustomsStatusList.Codes.DiscrepancyResolutionNoRelease;
	}
}
