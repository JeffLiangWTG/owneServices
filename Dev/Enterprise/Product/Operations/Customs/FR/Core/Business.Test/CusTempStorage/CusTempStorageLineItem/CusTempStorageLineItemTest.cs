...
namespace Enterprise.Customs.FR.Business.CusTempStorage.Testing
{
	...
	public class CusTempStorageLineItemTest : EnterpriseBusinessObjectTestCase
	{
		public void TestValidation()
		{
			...
			AssertType<CusTempStorageLineItemValidation>(lineItem.Validation);
		}
		...
		{
			var lineItem = (CusTempStorageLineItem)GetNewBusinessObject(Factory);
			AssertEquals("Goods Origin", DataBoundResourceStrings.GetDataForProperty(lineItem.TSI_GoodsOriginInfo).Caption);
		}
