...
{
	public class DeltaIEIncomingMessageProcessorTest : TestCaseWithFactory
	{
		...
		public void TestIE404EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE404Processor>(DeltaIEResponseMessageSubTypeList.Codes.AmendmentConfirmation);
		}

		public void TestIE410EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE410Processor>(DeltaIEResponseMessageSubTypeList.Codes.InvalidationApprovalNotificationFeedback);
		}

		public void TestIE426EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE426Processor>(DeltaIEResponseMessageSubTypeList.Codes.PrelodgedDeclarationAcceptance);
		}

		public void TestIE428EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE428Processor>(DeltaIEResponseMessageSubTypeList.Codes.DeclarationAcceptance);
		}

		public void TestIE429EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE429Processor>(DeltaIEResponseMessageSubTypeList.Codes.ReleaseNotification);
		}

		public void TestIE431EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE431Processor>(DeltaIEResponseMessageSubTypeList.Codes.TimerExpirySupplementaryDeclaration);
		}

		public void TestIE456EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE456Processor>(DeltaIEResponseMessageSubTypeList.Codes.FunctionalRejection);
		}

		public void TestFRA102EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<FRA102Processor>(DeltaIEResponseMessageSubTypeList.Codes.RegistrationOfTheInvalidationOrAmendment);
		}

		public void TestFRA103EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<FRA103Processor>(DeltaIEResponseMessageSubTypeList.Codes.ValidationRequestExtension);
		}

		public void TestIE917EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE917Processor>(DeltaIEResponseMessageSubTypeList.Codes.TechnicalRejection);
		}

		public void TestIE451EDIMessageCreatedAndProcessed()
		{
			AssertEDIMessageCreatedAndProcessed<IE451Processor>(DeltaIEResponseMessageSubTypeList.Codes.ReleaseRejection);
		}
