...
{
	sealed class IETS028ProcessorForIETS215Test : PNTSBaseProcessorTest<Iets028, IETS028Processor>
	{
		protected override void AddPropertiesForTemporaryStorageHeader(TemporaryStorageHeader header)
		{
			header.LRN = "IETS215VALIDMESSAGE001";
		}
		...
		protected override ZString GetExpectedMessageInterpretation() => new ZString(@"<style>body, p, td {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 13px;}</style><p style=""font-size: 120%""><strong>Status: </strong>Temporary Storage Activated<br><strong>MRN: </strong>21BEPT00000000QGU5<br><strong>Notification Date: </strong>15/05/2021 12:34:56 PM</p>");
		...
		protected override ZString GetExpectedMRN() => "21BEPT00000000QGU5";

		protected override ZString GetExpectedFRN() => ZString.Empty;

		protected override ZString GetMessageSubType() => "028";

		protected override ZString GetMessageText() => resourceRetriever.Value.GetString("Enterprise.Customs.FR.Business.Testing.EDIMessage.TestFiles.PNTS_IETS028ResponseMessageForIETS215.xml");
