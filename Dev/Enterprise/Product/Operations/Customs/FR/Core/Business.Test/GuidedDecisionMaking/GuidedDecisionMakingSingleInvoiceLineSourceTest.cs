...
{
	sealed class GuidedDecisionMakingSingleInvoiceLineSourceTest : TestCaseWithFactory
	{
		public void TestRegionOrTerritoryOfDestination()
		{
			...
			var gdmWrapper = new GuidedDecisionMakingSingleInvoiceLineSource(invoiceLine);
			...
			gdmWrapper = new GuidedDecisionMakingSingleInvoiceLineSource(invoiceLineWithoutDeclaration);
