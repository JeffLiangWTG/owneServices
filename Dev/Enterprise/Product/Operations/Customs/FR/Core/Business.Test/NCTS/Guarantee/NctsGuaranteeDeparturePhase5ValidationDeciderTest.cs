...
namespace Enterprise.Customs.FR.Business.NCTS.Testing
{
	sealed class NctsGuaranteeDeparturePhase5ValidationDeciderTest : TestCase
	{
		...
		public void TestIsRuleNAT086Active()
		{
			AssertEquals(true, validationDecider.IsRuleNAT086Active);
		}

		public void TestIsRuleNAT085Active()
		{
			AssertEquals(true, validationDecider.IsRuleNAT085Active);
		}
		...
		public void TesIsRuleTR0096Active()
		{
