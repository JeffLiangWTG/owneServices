...
{
	sealed class CCF02CProcessor_ANTICIPEETest : TP5BaseProcessorTest<Ccf02CType, CCF02CProcessor>
	{
		...
		protected override ZString ExpectedDepartureCustomsStatus => NCTS5DepartureCustomsStatusList.Codes.PreLodged;
