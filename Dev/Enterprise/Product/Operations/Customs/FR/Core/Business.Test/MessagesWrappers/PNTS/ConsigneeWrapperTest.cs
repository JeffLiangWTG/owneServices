...
{
	public class ConsigneeWrapperTest : Customs.Business.Testing.DataProviderTestCase<ConsigneeWrapper>
	{
		...
		{
			AssertEquals("IdentificationNumber should equal EORI from  bill consignee address.", "FR12345678900001", Provider.IdentificationNumber);
			...
			var wrapper = ConsigneeWrapper.New(bill);

			AssertEquals("IdentificationNumber should equal EORI from bill consignee.", "FR1", wrapper.IdentificationNumber);
		}
		...
		{
			AssertEquals("TypeOfPerson should equal bill.ABL_ConsigneeRegNoType", (byte)2, Provider.TypeOfPerson);
		}
		...
		protected override ConsigneeWrapper GetProvider()
		{
			...
			return ConsigneeWrapper.New(bill);
		}
	}
}
