...
{
	class IETS115WrapperTest : Customs.Business.Testing.DataProviderTestCase<IETS115Wrapper>
	{
		[TestDate(2023, 01, 18)]
		...
		public void DateAndTimeOfPresentationOfTheGoods_ShouldBeNull_WhenAMA_DateAtCustomsOfficeOfTempHeaderIsEmpty()
		{
			var storageHeader = Factory.NewWithValidTestData<TemporaryStorageHeader>();
			storageHeader.AMA_DateAtCustomsOffice = ZDateTime.Empty;
			var wrapper = IETS115Wrapper.New(storageHeader);
			AssertNull("IETS115Wrapper.DateAndTimeOfPresentationOfTheGoods should be null when wrapped header.AMA_DateAtCustomsOffice is empty.", wrapper.DateAndTimeOfPresentationOfTheGoods);
		}
		...
		protected override IETS115Wrapper GetProvider()
		{
			...
			return IETS115Wrapper.New(storageHeader);
		}
