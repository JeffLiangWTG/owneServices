...
public class IDD429DutiesAndTaxWrapper : IDDDutiesAndTaxWrapper<DutiesAndTaxesType>
{
	public static IDD429DutiesAndTaxWrapper New(DutiesAndTaxesType dutiesAndTaxes, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factoryToWrap)
	{
		return new IDD429DutiesAndTaxWrapper(dutiesAndTaxes, dutiesAndTaxesSummaries, factoryToWrap);
	}

	protected IDD429DutiesAndTaxWrapper(DutiesAndTaxesType dutiesAndTaxes, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factory) : base(dutiesAndTaxes, factory)
	{
