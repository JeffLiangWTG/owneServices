...
public class IDD428DutiesAndTaxWrapper : IDDDutiesAndTaxWrapper<DutiesAndTaxesType>
{
	public static IDD428DutiesAndTaxWrapper New(DutiesAndTaxesType dutiesAndTaxes, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factoryToWrap)
	{
		return new IDD428DutiesAndTaxWrapper(dutiesAndTaxes, dutiesAndTaxesSummaries, factoryToWrap);
	}

	protected IDD428DutiesAndTaxWrapper(DutiesAndTaxesType dutiesAndTaxes, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factory) : base(dutiesAndTaxes, factory)
	{
