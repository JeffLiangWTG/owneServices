...
public class IDD428ItemWrapper : DocBaseWrapper, IIDDItem<IDD428LiquidationWrapper, IDD428DutiesAndTaxWrapper>
{
	public static IDD428ItemWrapper New(ZInt itemNumber, MGoodsShipmentItemType05FR goodsShipmentItem, GoodsShipmentItemType goodsShipmentItemFromDetailedTaxation, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factoryToWrap)
	{
		return new IDD428ItemWrapper(itemNumber, goodsShipmentItem, goodsShipmentItemFromDetailedTaxation, dutiesAndTaxesSummaries, factoryToWrap);
	}

	internal static IDD428ItemWrapper New(ZInt itemNumber, MGoodsShipmentItemType05FR goodsShipmentItem, BusinessObjectFactory factoryToWrap)
	{
		return New(itemNumber, goodsShipmentItem, new GoodsShipmentItemType(), new List<DutiesAndTaxesSummariesType>(), factoryToWrap);
	}

	public IDD428ItemWrapper(ZInt itemNumber, MGoodsShipmentItemType05FR goodsShipmentItem, GoodsShipmentItemType goodsShipmentItemFromDetailedTaxation, ICollection<DutiesAndTaxesSummariesType> dutiesAndTaxesSummaries, BusinessObjectFactory factory) : base(goodsShipmentItem, factory)
	{
	...
	internal IDD428ItemWrapper(ZInt itemNumber, MGoodsShipmentItemType05FR goodsShipmentItem, BusinessObjectFactory factory)
	...
	public IDD428LiquidationWrapper Liquidation => liquidation ?? (liquidation = GetLiquidation());
	IDD428LiquidationWrapper liquidation;

	IDD428LiquidationWrapper GetLiquidation() => IDD428LiquidationWrapper.New(goodsShipmentItemFromDetailedTaxation, dutiesAndTaxesSummaries, Factory);
