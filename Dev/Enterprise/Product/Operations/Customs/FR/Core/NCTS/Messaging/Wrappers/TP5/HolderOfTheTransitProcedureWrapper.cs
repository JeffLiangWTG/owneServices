...
{
	public class HolderOfTheTransitProcedureWrapper : IHolderOfTheTransitProcedure
	{
		HolderOfTheTransitProcedureWrapper(OrgHeader orgHeader)
		{
		...
		public static HolderOfTheTransitProcedureWrapper New(OrgHeader orgHeader) => orgHeader == null ? null : new HolderOfTheTransitProcedureWrapper(orgHeader);

		public string TIRHolderIdentificationNumber => tirHolderIdentificationNumber ?? (tirHolderIdentificationNumber = orgHeader.GetRegoCodeOfThisOrg(OrgCusCode.CodeTypes.TIR_TransportsInternationauxRoutiers).Left(17));
