...
{
	public class CC015CWrapper : ICC015C
	{
		public CC015CWrapper(TP5MessageSendingObject sendingObject)
		{
		...
		public static CC015CWrapper New(TP5MessageSendingObject sendingObject) => sendingObject == null ? null : new CC015CWrapper(sendingObject);
		...
		public IMessageEnveloppe MessageEnveloppe => messageEnveloppe ?? (messageEnveloppe = MessageEnveloppeWrapper.New(nctsHeader, "IE015"));
