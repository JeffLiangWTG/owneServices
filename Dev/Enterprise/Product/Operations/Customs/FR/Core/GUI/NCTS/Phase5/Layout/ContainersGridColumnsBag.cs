...
namespace Enterprise.Customs.FR.GUI.NCTS
{
	public sealed class ContainersGridColumnsBag
	{
		...
		public ContainersGridColumnsBag()
		{
			...
			TypeContainerFindBoxColumn = new GridColumnReference<ZGuidFindBoxColumnStyleInfo>(nameof(NctsDepartureHeaderContainer.BC_RC), 100, c => c.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper);
		...
		public IGridColumnReference TypeContainerFindBoxColumn { get; }
	}
}
