namespace Enterprise.Customs.FR.GUI.CusTempStorage
{
	partial class TemporaryStorageHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.CustomsDetailsUserControl = new Enterprise.Customs.FR.GUI.CusTempStorage.CustomsDetailsUserControl();
			...
			this.TransportDetailsUserControl = new Enterprise.Customs.FR.GUI.CusTempStorage.TransportDetailsUserControl();
			...
			this.JobDetailsGroupBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("E87EB43D-3CC8-4B58-9AB1-70AB8294CC35", "Job Details");
			// 
			...
			this.CustomersReferenceTextBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("DC9FE324-8423-4E2E-A5E7-599FE6999E99", "Customer Reference");
			...
			this.CustomerOrganisation.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("E04F3161-7402-4CEB-8C1B-A244023E62BA", "Customer");
        ...
        "Customer"};
			...
			this.PresenterOrgAddress.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("74EC84D4-CF1B-4656-97B7-00E3319BDDDC", "Presenter");
			...
			this.RepresentativeOrgAddress.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("73C05927-503A-4E83-9345-2F6CE2587E39", "Representative");
