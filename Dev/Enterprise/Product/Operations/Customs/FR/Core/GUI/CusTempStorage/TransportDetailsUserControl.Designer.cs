namespace Enterprise.Customs.FR.GUI.CusTempStorage
{
	partial class TransportDetailsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TransportDetailsGroupBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("071FB698-496B-4FFE-A531-85662798CE5E", "Transport Details");
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_ContainerCount)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_ArrivalDate)));
			this.ArrivalDateDateEdit.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("81153de8-cc9b-4a04-8bd6-b47174d6b0a7", "Arrival Date");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_RL_NKLoading)));
			this.LoadingPlaceCodeFindBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("764bbd6f-74a3-4591-87b3-eb33ac201789", "Loading Place");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_TransportMeansDescription)));
			this.BorderTransportMeansDescriptionTextBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("2d065dcc-0d2c-4feb-8778-d6f4f53e0502", "Border Transport Info.");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_DepartureDate)));
			this.DepartureDateDateEdit.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("45713594-56F8-495A-8802-E16317769E54", "Departure Date");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_TransportMode)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_TransportRegNo)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).Lookups.RefVesselList)));
			this.VesselCodeFindBox.BindToList = "Lookups.RefVesselList";
			this.VesselCodeFindBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("1545A90B-6445-4D85-8ABC-ACFC11418D05", "Vessel");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_TransportRegNo)));
			this.TransportRegistrationNumTextBox.CaptionResourceString = Enterprise.Customs.FR.GUI.Res.GetData("104D9D91-FB10-4E9D-923E-F18AF45411C1", "Transport Reg. No.");
