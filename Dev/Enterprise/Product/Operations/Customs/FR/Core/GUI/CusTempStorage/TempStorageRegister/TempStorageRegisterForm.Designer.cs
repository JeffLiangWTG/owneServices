namespace Enterprise.Customs.FR.GUI.CusTempStorage
{
	partial class TempStorageRegisterForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.FR.Business.CusTempStorage.CusTempStorageRegHeader);
			// 
			...
			this.DataSourceType = typeof(Enterprise.Customs.FR.Business.CusTempStorage.CusTempStorageRegHeader);
		...
		private void MainTabPage_InitializeTab(object sender, System.EventArgs e)
		{
			...
			this.TempStorageRegisterControl = new Enterprise.Customs.FR.GUI.CusTempStorage.TempStorageRegisterUserControl();
