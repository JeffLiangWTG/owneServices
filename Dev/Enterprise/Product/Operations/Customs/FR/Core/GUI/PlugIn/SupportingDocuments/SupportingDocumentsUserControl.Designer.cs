namespace Enterprise.Customs.FR.GUI.PlugIn
{
	partial class SupportingDocumentsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.SupportingDocumentsFieldsControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(935, 203, true);
			// 
			...
			// BottomPanel
			// 
			this.BottomPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 37, true);
			this.BottomPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(935, 222, true);
			// 
			// gridSplitter
			// 
			...
			this.gridSplitter.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 34, true);
			this.gridSplitter.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(935, 3, true);
			// 
			// SupportingDocumentsGrid
			// 
			this.SupportingDocumentsGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(935, 34, true);
			// 
			// BindingSource
			// 
			...
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(935, 240, true);
