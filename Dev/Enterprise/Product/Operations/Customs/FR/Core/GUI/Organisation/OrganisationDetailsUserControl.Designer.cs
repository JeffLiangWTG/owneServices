namespace Enterprise.Customs.FR.GUI
{
	partial class OrganisationDetailsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.BindingSource.SetBindingMember(this.OrgCusAccountCollectionUserControl, "DeltaAgreementNumberCollection");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.MasterFiles.Business.OrgCusAccountCollection)(((Enterprise.MasterFiles.Business.OrgHeader)(null)).DeltaAgreementNumberCollection)));
