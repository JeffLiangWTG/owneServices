...
{
	[TestedType(typeof(UYManifestLayouts))]
	sealed class UYManifestLayoutsTest : LayoutsAbstractTest
	{
		...
		public void TestUYManifestLayoutVisibilty()
		{
			...
			using (var form = new ManifestForm(manifest))
			{
				...
				AssertNotNull("DateAtCustomsOfficeDateEdit", manifestGroupBox.FindSingleOrDefault<Control>(commonBag.DateAtCustomsOfficeDateEdit.Name));
			}
		}
	}
}
