...
namespace Enterprise.Customs.CH.Business
{
	...
	public abstract class AutoCHCusEntryHeader : Customs.Business.CusEntryHeader, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.CusEntryHeader.Schema
		{
			public const string CH_LastEComplaintStatus = "CH_LastEComplaintStatus";

			public const int CH_LastEComplaintStatusMaxLength = 3;
		}

		public ITableSchema AddInfoTableSchema => CHCusEntryHeaderSchema.Instance;

		#endregion

		protected AutoCHCusEntryHeader(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoCHCusEntryHeader>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoCHCusEntryHeader source)
			{
		...
		{
			{"LastEComplaintStatus", CH_LastEComplaintStatusData},
		};
		...
		public virtual ZString CH_LastEComplaintStatus
		{
			get => CH_LastEComplaintStatusData.Value;
			set
			{
				SetNonPersistentPropertyValue(CH_LastEComplaintStatusInfo, ref CH_LastEComplaintStatusData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateCH_LastEComplaintStatus();
				}
			}
		}
		public ZPropertyInfo CH_LastEComplaintStatusInfo => GetZPropertyInfo(Schema.CH_LastEComplaintStatus);
		AddInfoPropertyData<ZString> CH_LastEComplaintStatusData => lastEComplaintStatusData ?? (lastEComplaintStatusData = new AddInfoPropertyData<ZString>(Schema.CH_LastEComplaintStatus));
		AddInfoPropertyData<ZString> lastEComplaintStatusData;
		...
		public new AutoCHCusEntryHeaderValidation Validation => (AutoCHCusEntryHeaderValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => CHCusEntryHeaderSchema.Instance;
