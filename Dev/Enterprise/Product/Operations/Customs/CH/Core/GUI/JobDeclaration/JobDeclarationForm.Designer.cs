...
partial class JobDeclarationForm
{
    ...
    protected override void InitializeComponent()
    {
		...
		this.DataSourceAssemblyName = "Enterprise.Customs.CH.Business";
        this.DataSourceType = typeof(Enterprise.Customs.CH.Business.JobDeclaration);
        this.DataSourceTypeName = "Enterprise.Customs.CH.Business.JobDeclaration";
