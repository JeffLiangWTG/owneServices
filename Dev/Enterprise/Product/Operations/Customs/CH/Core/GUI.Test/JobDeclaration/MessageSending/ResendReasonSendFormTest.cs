...
[TestedType(typeof(ResendReasonSendForm))]
class ResendReasonSendFormTest : ZFormBasherTest
{
	...
	const string expectedWaringMessage = @"Please note that you have not received a response for the message that you have submitted previously.
...
If you are sure you want to submit another message, please enter reasons: ";
	...
	protected override Form GetFormToBashCore() => new ResendReasonSendForm();
}
