...
sealed class NT513MessageManagerTest : BasePassarDepartureMessageManagerTest<NT513MessageManager>
{
	protected override string MessageSendingObjectMessageType => PassarMessageTypeList.Codes.NT513;

	protected override string ExpectedMovementHeaderPhase => "013";
	protected override string ExpectedMessageSubType => "513";
	...
	protected override NT513MessageManager CreateMessageManager(NctsHeader nctsHeader) => new NT513MessageManager(CreateMessageSendingObject(nctsHeader));
