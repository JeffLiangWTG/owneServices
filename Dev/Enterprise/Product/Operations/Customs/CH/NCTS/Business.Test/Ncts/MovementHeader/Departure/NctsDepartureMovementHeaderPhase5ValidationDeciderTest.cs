...
sealed class InNCTSTransitionPeriodNctsDepartureMovementHeaderPhase5ValidationDeciderTest : NctsDepartureMovementHeaderPhase5ValidationDeciderTest
{
	protected override bool IsNCTSTransitionPeriod => true;
}

sealed class AfterNCTSTransitionPeriodNctsDepartureMovementHeaderPhase5ValidationDeciderTest : NctsDepartureMovementHeaderPhase5ValidationDeciderTest
{
	protected override bool IsNCTSTransitionPeriod => false;
}

abstract class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
{
	public void TestIsRuleB1091Active()
	{
		AssertEquals(true, validationDecider.IsRuleB1091Active);
	}
	...
	public void TestIsRuleB1858_2Active()
	{
		AssertEquals(true, (validationDecider as IRuleB1858_2Decider).IsActive);
	}

	public void TestIsRuleB1891_1Active()
	{
		AssertEquals(false, validationDecider.IsRuleB1891_1Active);
	}

	public void TestIsRuleB1892Active()
	{
		AssertEquals(false, validationDecider.IsRuleB1892Active);
	}

	public void TestIsRuleB1893Active()
	{
		AssertEquals(false, validationDecider.IsRuleB1893Active);
	}
	...
	public void TestsRuleC0191Active()
	{
		AssertEquals(false, validationDecider.IsRuleC0191Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleC035Active);
	}

	public void TestIsRuleC0035_1Active()
	{
		AssertEquals(true, (validationDecider as IRuleC0035_1Decider).IsActive);
	}

	public void TestIsRuleC0337_2Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0337_2Active);
	}

	public void TestIsRuleC0387Active()
	{
		AssertEquals(false, validationDecider.IsRuleC0387Active);
	}

	public void TestIsRuleC0403Active()
	{
		AssertEquals(false, validationDecider.IsRuleC0403Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleC0599_1Active);
	}

	public void TestIsRuleC0599_2Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0599_2Active);
	}

	public void TestIsRuleC0806Active()
	{
		AssertEquals(false, validationDecider.IsRuleC0806Active);
	}
	...
	public void TestIsRuleC0191_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleC0191_1Active);
	}

	public void TestIsRuleC0191_2Active()
	{
	...
	{
		AssertEquals(false, validationDecider.IsRuleC0599Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleC547Active);
	}

	public void TestIsRuleC589Active()
	{
		AssertEquals(false, validationDecider.IsRuleC589Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0018Active);
	}

	public void TestIsRuleNR0031Active()
	{
		AssertEquals(true, validationDecider.IsRuleNR0031Active);
	}

	public void TestIsRuleNR0035Active()
	{
		AssertEquals(false, validationDecider.IsRuleNR0035Active);
	}

	public void TestIsRuleNR0036Active()
	{
		AssertEquals(true, validationDecider.IsRuleNR0036Active);
	}

	public void TestIsRuleNR0037Active()
	{
		AssertEquals(true, validationDecider.IsRuleNR0037Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0039Active);
	}
	...
	public void TestIsRuleNR0080Active()
	{
		AssertEquals(false, validationDecider.IsRuleNR0080Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleR0020Active);
	}

	public void TestIsRuleR0020_1Active()
	{
		AssertEquals(true, validationDecider.IsRuleR0020_1Active);
	}

	public void TestIsRuleR0789Active()
	{
		AssertEquals(false, validationDecider.IsRuleR0789Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleTR0048Active);
	}
	...
	{
		AssertEquals(expected: false, validationDecider.IsRuleTR0086Active);
	}
	...
	protected NctsDepartureMovementHeaderPhase5ValidationDecider validationDecider;
