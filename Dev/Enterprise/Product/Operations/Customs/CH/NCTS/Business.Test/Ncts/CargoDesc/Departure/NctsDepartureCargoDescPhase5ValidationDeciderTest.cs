...
sealed class NctsDepartureCargoDescPhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0020Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0025Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleR0507_1Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleTR0096Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleTR0068Active);
	}

	public void TestIsRuleTR0076Active()
	{
		AssertEquals(false, validationDecider.IsRuleTR0076Active);
	}

	public void TestIsRuleTR0100Active()
	{
		AssertEquals(false, validationDecider.IsRuleTR0100Active);
	}
