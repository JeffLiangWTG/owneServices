...
[TestedType(typeof(NctsBillDeparturePhase5ValidationDecider))]
sealed class AfterCHNT015V4PeriodNctsBillDeparturePhase5ValidationDeciderTest : BaseNctsBillDeparturePhase5ValidationDeciderTest
{
	public override void TestIsRuleNS30018Active()
	{
		AssertEquals(true, ValidationDecider.IsRuleNS30018Active);
	}
...
[TestedType(typeof(NctsBillDeparturePhase5ValidationDecider))]
sealed class InCHNT015V4PeriodNctsBillDeparturePhase5ValidationDeciderTest : BaseNctsBillDeparturePhase5ValidationDeciderTest
{
	public override void TestIsRuleNS30018Active()
	{
		AssertEquals(false, ValidationDecider.IsRuleNS30018Active);
	}

	protected override bool IsCHNT015V4Active => true;
}

public abstract class BaseNctsBillDeparturePhase5ValidationDeciderTest : TestCase
{
	...
	{
		AssertEquals(expected: true, validationDecider.IsRuleR0221Active);
	}

	public void TestIsRuleR0364()
	{
		AssertEquals(expected: false, validationDecider.IsRuleR0364Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleR0506Active);
	}

	public void TestIsRuleR0983Active()
	{
		AssertEquals(false, validationDecider.IsRuleR0983Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleTR0077Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleTR0094Active);
	}

	public abstract void TestIsRuleNS30018Active();
	...
	protected NctsBillDeparturePhase5ValidationDecider ValidationDecider => validationDecider;
