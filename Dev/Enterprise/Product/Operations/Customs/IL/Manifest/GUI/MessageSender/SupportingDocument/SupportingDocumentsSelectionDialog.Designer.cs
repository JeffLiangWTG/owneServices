...
{
	partial class SupportingDocumentsSelectionDialog
	{
		/// <summary> 
		...
		protected new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(AsycudaManifestHeaderWrapper);
			// 
			// ItemsGrid
			// 
			this.ItemsGrid.AllowNavigation = false;
			this.BindingSource.SetBindingMember(this.ItemsGrid, "SupportingDocuments");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((SupportingDocumentWrapper)(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)).SyncRoot)).IsSelected)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((SupportingDocumentWrapper)(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)).SyncRoot)).Type)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((SupportingDocumentWrapper)(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)).SyncRoot)).Description)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((SupportingDocumentWrapper)(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)).SyncRoot)).CustomsNotes)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((SupportingDocumentWrapper)(((System.Collections.IList)(((AsycudaManifestHeaderWrapper)(null)).SupportingDocuments)).SyncRoot)).EDoc)));
			...
			zTextBoxColumnStyleInfo4.ColumnName = "CustomsNotes";
			...
			zGuidDropEditColumnStyleInfo1.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(390);
			...
			this.ItemsGrid.ColumnStyles.Add(zGuidDropEditColumnStyleInfo1);
			this.ItemsGrid.Dock = System.Windows.Forms.DockStyle.Fill;
			this.ItemsGrid.GridId = "370B1215-154E-4A8A-B346-542AEF1C5B56";
			...
			this.ItemsGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(513, 340, true);
			...
			this.DeselectAllButton.CaptionResourceString = Enterprise.Customs.IL.Manifest.GUI.Res.GetData("52BCED2D-371A-4FCD-9CF7-1CC153B8DE21", "Deselect All");
			...
			this.SelectAllButton.CaptionResourceString = Enterprise.Customs.IL.Manifest.GUI.Res.GetData("8458B38F-66D2-4D03-864C-33101717B4B8", "Select All");
			...
			this.SendButton.CaptionResourceString = Enterprise.Customs.IL.Manifest.GUI.Res.GetData("B1662B95-251E-4D81-896C-ED544CDBA081", "&Send");
			...
			this.ButtonCancel.CaptionResourceString = Enterprise.Customs.IL.Manifest.GUI.Res.GetData("B3A8F044-9F2E-41BE-9B86-CF3457E7F76C", "&Cancel");
			...
			// ItemsGroupBox
			// 
			this.ItemsGroupBox.CaptionResourceString = Enterprise.Customs.IL.Manifest.GUI.Res.GetData("D49AC5B2-9AD1-41EA-8576-D9781B14D7BE", "Supporting Documents");
			...
			// 
			// SupportingDocumentsSelectionDialog
			// 
			...
			this.DataSourceType = typeof(Enterprise.Customs.IL.Manifest.Business.SupportingDocumentWrapper);
			this.DataSourceTypeName = "Enterprise.Customs.IL.Manifest.Business.SupportingDocumentWrapper";
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(900, 427, true);
			this.Name = "SupportingDocumentsSelectionDialog";
