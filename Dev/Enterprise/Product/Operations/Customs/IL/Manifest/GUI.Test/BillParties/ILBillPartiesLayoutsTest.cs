...
{
	[TestedType(typeof(ILBillPartiesLayouts))]

	public class ILBillPartiesLayoutsTest : LayoutsAbstractTest
	{
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new ILBillPartiesBuilder();
