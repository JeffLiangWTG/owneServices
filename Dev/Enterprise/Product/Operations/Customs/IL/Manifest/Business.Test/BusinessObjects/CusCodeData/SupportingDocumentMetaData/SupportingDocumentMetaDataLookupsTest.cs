...
namespace Enterprise.Customs.IL.Manifest.Business.Testing
{
	...
	{
		public void TestGetCY_CodeListInEnglish()
		{
			var factory = Factory;
			...
			AssertEquals("380 have two meta datas", 2, supportingDocument.SupportingDocumentMetadataItems.Count);
			...
			AssertEquals("18 in English", "Exporter Name", values.GetDescriptionFromCode("18"));

			supportingDocument.CSI_Code = "830";
			AssertEquals("830 have one meta data", 1, supportingDocument.SupportingDocumentMetadataItems.Count);
			...
			AssertEquals("3 in English", "Invoice Country", values.GetDescriptionFromCode("3"));
		}
	}
}
