...
namespace Enterprise.Customs.IL.Business
{
	...
	public abstract class AutoILJobComInvoiceLine : Enterprise.Customs.Business.BaseJobComInvoiceLine, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Enterprise.Customs.Business.BaseJobComInvoiceLine.Schema
		{
			public const string JI_PreferenceDocNumber = "JI_PreferenceDocNumber";

			public const int JI_PreferenceDocNumberMaxLength = 35;
		}

		public ITableSchema AddInfoTableSchema => ILJobComInvoiceLineSchema.Instance;

		#endregion

		protected AutoILJobComInvoiceLine(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoILJobComInvoiceLine>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoILJobComInvoiceLine source)
			{
		...
		{
			{"PreferenceDocNumber", JI_PreferenceDocNumberData},
		};
		...
		public virtual ZString JI_PreferenceDocNumber
		{
			get => JI_PreferenceDocNumberData.Value;
			set
			{
				SetNonPersistentPropertyValue(JI_PreferenceDocNumberInfo, ref JI_PreferenceDocNumberData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateJI_PreferenceDocNumber();
				}
			}
		}
		public ZPropertyInfo JI_PreferenceDocNumberInfo => GetZPropertyInfo(Schema.JI_PreferenceDocNumber);
		AddInfoPropertyData<ZString> JI_PreferenceDocNumberData => preferenceDocNumberData ?? (preferenceDocNumberData = new AddInfoPropertyData<ZString>(Schema.JI_PreferenceDocNumber));
		AddInfoPropertyData<ZString> preferenceDocNumberData;
		...
		public new AutoILJobComInvoiceLineValidation Validation => (AutoILJobComInvoiceLineValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => ILJobComInvoiceLineSchema.Instance;
