...
namespace Enterprise.Customs.IL.Business.Testing
{
	...
	class InvoiceLineChargeTest : Customs.Business.Testing.BaseInvoiceLineChargeTest
	{
		...
		{
			AssertType<InvoiceLineCharge>("Update BaseInvoiceChargeTypeDecider to include a decider for this class", Factory.New(typeof(Customs.Business.BaseInvoiceLineCharge)));
		}
	}
}
