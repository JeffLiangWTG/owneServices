namespace Enterprise.Customs.IL.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			this.DataSourceAssemblyName = "Enterprise.Customs.IL.Business";
			this.DataSourceType = typeof(Enterprise.Customs.IL.Business.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs.IL.Business.JobDeclaration";
