...
namespace Enterprise.Customs.GB.EMCS.Business
{
	...
	{
		protected PartyTransporterProvider(JobDocAddress jobDocAddress) : base(jobDocAddress)
		{
		...
		public new static PartyTransporterProvider NewOrNull(JobDocAddress jobDocAddress) => jobDocAddress != null && jobDocAddress.IsValidAddress ? new PartyTransporterProvider(jobDocAddress) : null;
