...
{
	public sealed class IE801PartyGuarantorProvider : IEMCSPartyGuarantor
	{
		public static IE801PartyGuarantorProvider NewOrNull(GuarantorTraderType guarantorTrader) => guarantorTrader != null ? new IE801PartyGuarantorProvider(guarantorTrader) : null;
