...
{
	public sealed class IE829Provider : IIE829
	{
		...
		IEMCSEvent ExciseMovementEad
		{
			get
			{
				if (exciseMovementEad == null)
				{
					...
					{
						exciseMovementEad = new CachedValue<IEMCSEvent>(() => exciseMovementEads[0]);
					}
				}

				return exciseMovementEad?.Value;
			}
		}
		CachedValue<IEMCSEvent> exciseMovementEad;
	}

	sealed class IE829EventProvider : IEMCSEvent
	{
