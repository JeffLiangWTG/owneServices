...
{
	public sealed class IE813Provider : IIE813
	{
		...
		public ZString JourneyTime
		{
			get
			{
				if (journeyTime == null)
				{
					...
					journeyTime = new CachedValue<ZString>(() => journeyTimeString.SubstringSafe(1, 2) + journeyTimeString.SubstringSafe(0, 1));
				}
				return journeyTime.Value;
			}
		}
		...
		public IEMCSPartyGuarantor Guarantor => guarantor ?? (GuarantorTypeCode == CargoWise.Customs.GB.MessageDefinitions.EMCS.Version4_1.tcl.GuarantorTypeCode.Item3.XmlEnumToString() ? guarantor = IE813PartyGuarantorProvider.NewOrNull(message.Body.ChangeOfDestination.DestinationChanged.MovementGuarantee.GuarantorTrader?.FirstOrDefault()) : null);
		...
		bool CanHaveTransportArranger => TransportArrangement == CargoWise.Customs.GB.MessageDefinitions.EMCS.Version4_1.tcl.TransportArrangement.Item3.XmlEnumToString() || TransportArrangement == CargoWise.Customs.GB.MessageDefinitions.EMCS.Version4_1.tcl.TransportArrangement.Item4.XmlEnumToString();

		sealed class IE813EventProvider : IEMCSEvent
		{
