...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	...
	sealed class IE813HeaderProviderTest : HeaderProviderAbstractTest<IE813HeaderProvider>
	{
		...
		public void TestDateAndTimeOfValidationOfChangeOfDestination()
		{
			...
			{
				AssertNull(HeaderProvider.DateAndTimeOfValidationOfChangeOfDestination);
			}
			...
			{
				AssertNotNull(HeaderProvider.DateAndTimeOfValidationOfChangeOfDestination);
				CombineAssertions(() =>
				{
					AssertEquals(0, HeaderProvider.DateAndTimeOfValidationOfChangeOfDestination.Value.Millisecond);
					AssertEquals(DateTimeKind.Unspecified, HeaderProvider.DateAndTimeOfValidationOfChangeOfDestination.Value.Kind);
				});
			}
		}
		...
		protected override IEnumerable<Expression<Func<IE813HeaderProvider, object>>> GetPropertiesNeedToBeCached()
		{
		...
		new IIE813Header HeaderProvider => base.HeaderProvider;
	}
}
