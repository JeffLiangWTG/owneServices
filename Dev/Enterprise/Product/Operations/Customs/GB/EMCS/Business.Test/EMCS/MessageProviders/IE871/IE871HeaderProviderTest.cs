...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	...
	sealed class IE871HeaderProviderTest : HeaderProviderAbstractTest<IE871HeaderProvider>
	{
		...
		public void TestDateAndTimeOfValidationOfExplanationOnShortage()
		{
			...
			{
				AssertNotNull(HeaderProvider.DateAndTimeOfValidationOfExplanationOnShortage);
				CombineAssertions(() =>
				{
					AssertEquals(0, HeaderProvider.DateAndTimeOfValidationOfExplanationOnShortage.Value.Millisecond);
					AssertEquals(DateTimeKind.Unspecified, HeaderProvider.DateAndTimeOfValidationOfExplanationOnShortage.Value.Kind);
				});
			}
		}
		...
		new IIE871Header HeaderProvider => base.HeaderProvider;
