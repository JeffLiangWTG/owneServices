...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	...
	sealed class IE818HeaderProviderTest : HeaderProviderAbstractTest<IE818HeaderProvider>
	{
		...
		public void TestDateAndTimeOfValidationOfReportOfReceiptExport()
		{
			...
			{
				AssertNotNull(HeaderProvider.DateAndTimeOfValidationOfReportOfReceiptExport);
				CombineAssertions(() =>
				{
					AssertEquals(0, HeaderProvider.DateAndTimeOfValidationOfReportOfReceiptExport.Value.Millisecond);
					AssertEquals(DateTimeKind.Unspecified, HeaderProvider.DateAndTimeOfValidationOfReportOfReceiptExport.Value.Kind);
				});
			}
		}
		...
		new IIE818Header HeaderProvider => base.HeaderProvider;
