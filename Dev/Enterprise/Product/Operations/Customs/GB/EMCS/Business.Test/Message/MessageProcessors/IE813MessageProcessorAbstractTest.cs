...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	...
	abstract class IE813MessageProcessorAbstractTest<TMessageType> : EMCSMessageProcessorAbstractTest<IE813MessageProcessor, IIE813>
	{
		...
		protected abstract void UpdateTraderIdNotMatchImporter();

		public void TestUpdateDeclarationSequenceNumber_TraderIdNotMatchImporter()
		{
			UpdateTraderIdNotMatchImporter();
			CreateSetupData();
		...
		protected override ZString MessageText => EMCSXmlObjectSerializer.Serialize(ie813);

		protected override ZString MessageType => EMCSGBIncomingMessageTypeList.Codes.IE813;
		...
		protected override void AssertProcessResult(EMCSJobDeclaration declaration, EMCSInboundEDIMessage incomingMessage)
		{
			...
			MessageProcessorNotificationTestHelper.AssertEmail("EMCS Change of Destination Response", new[] { "Your EMCS Declaration for Job E00000810 received a notification of a changed destination. For details please follow the link to the Job." }, new string[] { "staff1@where.com" });
		}
