...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	...
	sealed class IE819HeaderProviderTest : HeaderProviderAbstractTest<IE819HeaderProvider>
	{
		...
		public void TestDateAndTimeOfValidationOfAlertRejection()
		{
			...
			{
				AssertNull(HeaderProvider.DateAndTimeOfValidationOfAlertRejection);
			}
			...
			{
				AssertNotNull("DateAndTimeOfValidationOfAlertRejection provided", HeaderProvider.DateAndTimeOfValidationOfAlertRejection);
				CombineAssertions(() =>
				{
					AssertEquals("DateAndTimeOfValidationOfAlertRejection has no milliseconds part", HeaderProvider.DateAndTimeOfValidationOfAlertRejection.Value.Millisecond, 0);
					AssertEquals("DateAndTimeOfValidationOfAlertRejection has no time offset", HeaderProvider.DateAndTimeOfValidationOfAlertRejection.Value.Kind, DateTimeKind.Unspecified);
				});
			}
		}
