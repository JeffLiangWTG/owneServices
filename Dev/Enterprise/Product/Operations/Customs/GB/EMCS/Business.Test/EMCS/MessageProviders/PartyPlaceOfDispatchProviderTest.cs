...
namespace Enterprise.Customs.GB.EMCS.Business.Testing
{
	sealed class PartyPlaceOfDispatchProviderTest : Customs.Business.Testing.DataProviderTestCase<PartyPlaceOfDispatchProvider>
	{
		...
		public void TestEORINumber()
		{
			...
			_ = organisation.CustomsCodes.AddNew(OrgCusCode.EuropeanUnionSharedCodeTypes.Eori, "EOR001", Core.Constants.CountryCodes.UnitedKingdom);
			jobDocAddress.OrganisationPK = organisation.PK;
			var placeOfDispatchTrader = PartyPlaceOfDispatchProvider.NewOrNull(jobDocAddress);
			CombineAssertions(() =>
			{
				AssertEquals(nameof(PartyPlaceOfDispatchProvider.EORINumber), "GBEOR001", placeOfDispatchTrader.EORINumber);
				_ = organisation.MainAddress.CustomsCodes.AddNew(OrgCusCode.EuropeanUnionSharedCodeTypes.Eori, "EOR002", Core.Constants.CountryCodes.Greece);
				jobDocAddress.E2_AddressOverride = true;
				jobDocAddress.E2_GovRegNumType = OrgCusCode.EuropeanUnionSharedCodeTypes.Eori;
				jobDocAddress.E2_GovRegNum = "EOR002";
				jobDocAddress.E2_State = "HAM";
				placeOfDispatchTrader = PartyPlaceOfDispatchProvider.NewOrNull(jobDocAddress);
				AssertEquals(nameof(PartyPlaceOfDispatchProvider.EORINumber), "EOR002", placeOfDispatchTrader.EORINumber);
			});
		}
		...
		public void TestPlaceOfDispatch_OrgAddress()
		{
			...
			organisation.CustomsCodes.AddNew(OrgCusCode.EuropeanUnionSharedCodeTypes.TraderID, "TID999", Core.Constants.CountryCodes.UnitedKingdom);
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("Address", "12 MITCHELL ST", placeOfDispatchTrader.Address);
