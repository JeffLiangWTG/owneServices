...
namespace Enterprise.Customs.GB.EMCS.Messaging.Version4_1.Testing
{
	sealed class IE801ProviderTest : TestCaseWithFactory
	{
		...
		{
			AssertEquals("19GB587500026773M4", dataProvider.LocalReferenceNumber);
		}
		...
		public void TestDispatchTime()
		{
			...
			message.Body.EadesadContainer.EadEsad.TimeOfDispatch = new DateTime(2020, 7, 9, 1, 1, 0);
			dataProvider = new IE801Provider(message);
			AssertEquals(new ZDateTime(2020, 7, 9, 1, 1, 0), dataProvider.DispatchTime);

			message.Body.EadesadContainer.EadEsad.TimeOfDispatchValueSpecified = false;
			dataProvider = new IE801Provider(message);
		...
		{
			message.Body.EadesadContainer.MovementGuarantee.GuarantorTypeCode = GuarantorTypeCode.Item2;
			...
			message = new Ie801Type
			{
				...
				Body = new BodyType
				{
					EadesadContainer = new EadesadContainerType
					{
						...
						{
							LocalReferenceNumber = "19GB587500026773M4",
							DateOfDispatch = new DateTime(2020, 7, 9, 0, 0, 0),
							TimeOfDispatch = new DateTime(2020, 7, 9, 7, 9, 23),
