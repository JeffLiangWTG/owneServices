...
{
	public sealed class BillLayouts : IPanelLayoutProvider
	{
		...
		{
			var builder = new ASYCUDA.GUI.BillLayoutBuilder<EU.Manifest.Business.AsycudaBill>();
			var common = builder.CommonBag;
			var ics = BillControlBag.Instance;
			builder.AddControlBag(ics);
			...
			builder.Add(ics.SpecialMentionsDropEdit, ControlWidthClass.Long);
