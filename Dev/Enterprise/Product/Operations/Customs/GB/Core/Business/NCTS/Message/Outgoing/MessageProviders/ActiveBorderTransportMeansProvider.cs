...
namespace Enterprise.Customs.GB.Business.NCTS
{
	public class ActiveBorderTransportMeansProvider : IActiveBorderTransportMeans
	{
		...
		public string CustomsOfficeAtBorderReferenceNumber => ValueOrNull(depHeader?.BM_CustomsOfficeAtBorder ?? departureCusTransportMeans.TPM_CustomsOffice);
		...
		string ValueOrNull(string value) => string.IsNullOrEmpty(value) ? null : value;
