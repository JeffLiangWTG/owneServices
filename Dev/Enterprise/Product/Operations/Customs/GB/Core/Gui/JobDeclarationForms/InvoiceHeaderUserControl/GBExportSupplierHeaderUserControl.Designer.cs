...
namespace Enterprise.Customs.GB.GUI
{
	...
	{
		ZArchitecture.ZTextBox customsAuthorisationNumber;

		void InitializeComponent()
		{
			this.customsAuthorisationNumber = new ZArchitecture.ZTextBox();
			...
			// 
			this.NoOfPacksCalcDropEdit.TabIndex = 18;
			// 
			...
			// 
			this.JobComInvoiceHeadersBoundGrid.GridId = "GridLayoutXhlaSBYEIdPouOG6FNhrog==";
			// 
			// 
			// 
			...
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.GridId = "GridLayoutXhlaSBYEIdPouOG6FNhrog==";
			...
			// InvDetailLeftPanel
			// 
			this.InvDetailLeftPanel.Controls.Add(this.customsAuthorisationNumber);
			...
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.TransportChargesMethodOfPaymentDropEdit, 0);
			...
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.customsAuthorisationNumber, 0);
			// 
			// InvDetailRightPanel
			// 
			...
			// 
			// customsAuthorisationNumber
			// 
			this.BindingSource.SetBindingMember(this.customsAuthorisationNumber, "Invoices.ZG_CustomsAuthorisationReferenceForExportFallback");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((JobComInvoiceHeader)(((System.Collections.IList)(((JobDeclaration)(null)).Invoices)).SyncRoot)).ZG_CustomsAuthorisationReferenceForExportFallback);
			this.customsAuthorisationNumber.CaptionResourceString = Enterprise.Customs.GB.GUI.Res.GetData("159e4a56-e079-48d0-a3f6-5f90b99cbb31", "Customs Auth. Ref.", "Customs Authorization Reference", "Customs Authorization Reference Number.");
			this.customsAuthorisationNumber.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 271, true);
			this.customsAuthorisationNumber.Name = "customsAuthorisationNumber";
			this.customsAuthorisationNumber.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(100, 20, true);
			this.customsAuthorisationNumber.TabIndex = 17;
			// 
			// GBExportSupplierHeaderUserControl
			// 
			this.Name = "GBExportSupplierHeaderUserControl";
