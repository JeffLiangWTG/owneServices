namespace Enterprise.Customs.GB.GUI
{
	partial class ImportOrganizationUserControl
	{
		...
		void InitializeComponent()
		{
			...
			// 
			this.DefermentPartyDocAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(140, 134, true);
			...
			this.SupervisingOfficePanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(503, 44, true);
			...
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(503, 191, true);
