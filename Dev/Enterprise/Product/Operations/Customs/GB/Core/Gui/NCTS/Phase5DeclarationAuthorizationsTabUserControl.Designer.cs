...
namespace Enterprise.Customs.GB.GUI.NCTS
{
	partial class Phase5DeclarationAuthorizationsTabUserControl
	{
		...
		void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((CusAuthorizationUsage)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).CusAuthorizationUsages)).SyncRoot)).CustomsCode)));
