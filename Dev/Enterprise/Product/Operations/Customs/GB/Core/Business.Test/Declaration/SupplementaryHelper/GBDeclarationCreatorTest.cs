...
namespace Enterprise.Customs.GB.Business.Declaration.SupplementaryHelper.Testing
{
	sealed class GBDeclarationCreatorTest : TestCaseWithFactory
	{
		public void TestGetDeclarationCreator()
		{
			AssertEquals(typeof(GBDeclarationCreator), declarationCreator.GetType());
		}
		...
		public void TestRelatedDeclaration()
		{
			...
			AssertHasPreviousDocument("New declaration 1 Invoice 1 Line 1", ((JobComInvoiceLine)dec1.Invoices[0].InvoiceLines[0]).PreviousDocuments, "MRN0001");
			...
			AssertHasPreviousDocument("New declaration 2 Invoice 1 Line 1", ((JobComInvoiceLine)dec2.Invoices[0].InvoiceLines[0]).PreviousDocuments, "MRN0002");
			AssertHasPreviousDocument("New declaration 2 Invoice 2 Line 1", ((JobComInvoiceLine)dec2.Invoices[1].InvoiceLines[0]).PreviousDocuments, "MRN0002");
			...
			AssertHasPreviousDocument("New declaration 3 Invoice 1 Line 1", ((JobComInvoiceLine)dec3.Invoices[0].InvoiceLines[0]).PreviousDocuments, "MRN0004");
		}
		...
		public void TestNewInstruction()
		{
			...
			AssertEquals("Invoice 1 Line 1 Previous Documents Count", 0, invHeader1.InvoiceLines[0].PreviousDocuments.Count);
			AssertEquals("Invoice 1 Line 2 Previous Documents Count", 0, invHeader1.InvoiceLines[1].PreviousDocuments.Count);
			AssertHasPreviousDocument("Invoice 1 Line 3", invHeader1.InvoiceLines[2].PreviousDocuments, "MRN0001");
			AssertHasPreviousDocument("Invoice 1 Line 4", invHeader1.InvoiceLines[3].PreviousDocuments, "MRN0002");
			AssertEquals("Invoice 2 Line 1 Previous Documents Count", 0, invHeader2.InvoiceLines[0].PreviousDocuments.Count);
			AssertEquals("Invoice 2 Line 2 Previous Documents Count", 0, invHeader2.InvoiceLines[1].PreviousDocuments.Count);
			AssertHasPreviousDocument("Invoice 2 Line 3", invHeader2.InvoiceLines[2].PreviousDocuments, "MRN0002");
			AssertEquals("Invoice 3 Line 1 Previous Documents Count", 0, invHeader3.InvoiceLines[0].PreviousDocuments.Count);
			AssertEquals("Invoice 3 Line 2 Previous Documents Count", 0, invHeader3.InvoiceLines[1].PreviousDocuments.Count);
			AssertHasPreviousDocument("Invoice 3 Line 3", invHeader3.InvoiceLines[2].PreviousDocuments, "MRN0004");
		}
		...
		public void TestReuseInstruction()
		{
			...
			AssertHasPreviousDocument("Invoice 1 Line 1", declaration.Invoices[0].InvoiceLines[0].PreviousDocuments, "MRN0001");
			AssertHasPreviousDocument("Invoice 1 Line 2", declaration.Invoices[0].InvoiceLines[1].PreviousDocuments, "MRN0002");
			AssertHasPreviousDocument("Invoice 2 Line 1", declaration.Invoices[1].InvoiceLines[0].PreviousDocuments, "MRN0002");
			AssertEquals("Invoice 2 Line 2 Previous Documents Count", 0, declaration.Invoices[1].InvoiceLines[1].PreviousDocuments.Count);
			AssertEquals("Invoice 3 Line 1 Previous Documents Count", 0, declaration.Invoices[2].InvoiceLines[0].PreviousDocuments.Count);
			AssertHasPreviousDocument("Invoice 3 Line 2", declaration.Invoices[2].InvoiceLines[1].PreviousDocuments, "MRN0004");
		...
		void AssertHasPreviousDocument(string message, PreviousDocumentCollection documents, ZString expectedReference)
		{
			...
			AssertEquals(message + " Previous Document SubType", "Y", documents[0].CSI_SubType);
			AssertEquals(message + " Previous Document Code", "SDE", documents[0].CSI_Code);
