...
using Enterprise.Customs.GB.GUI.NCTS;
using Enterprise.ZArchitecture.GUI;
using NUnit.Framework;

namespace Enterprise.Customs.GB.GUI.Testing.NCTS
{
	...
	sealed class NctsPhase5LayoutProviderTest : EU.NCTS.GUI.Testing.NctsPhase5LayoutProviderAbstractTest
	{
		...
		protected override Type ExpectedDeclarationAuthorizationsTabControlType => typeof(GUI.NCTS.Phase5DeclarationAuthorizationsTabUserControl);
