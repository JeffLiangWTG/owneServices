...
{
	class CcsukAirConsignmentUserControlMawbManyTest : TestCaseWithFactory
	{
		public void TestRemovalsTabsVisibility()
		{
			...
			mAWB1.CM_MAWB = "12387654321";
			mAWB1.Profile = "CUKFFW98000ABC";
			Factory.Save();
			using (var consolForm = new ConsolForm(consol))
			{
				...
				using (var plugin = consolForm.PlugIns.GetPlugIn(ControllerIDs.Customs.GB.CcsukAirInventory))
				{
					...
					var grid = control.Controls.Find("MawbsGrid", true)[0] as ZGrid;
					grid.Select(0);
