namespace Enterprise.Customs.Common.Testing
{
	...
	class FOBFOBOverseasFreightTest : CustomsChargeCodeTest
	{
		...
		protected override ICustomsChargeCode GetChargeCodeToTest() => new FOBFOBIncoTermAndCustomsChargeFactory().GetCharge(CustomsChargeTypeList.Codes.OverseasFreight);
	...
	class FOBFOBOverseasInsuranceTest : CustomsChargeCodeTest
	{
		...
		protected override ICustomsChargeCode GetChargeCodeToTest() => new FOBFOBIncoTermAndCustomsChargeFactory().GetCharge(CustomsChargeTypeList.Codes.OverseasInsurance);
	...
	class FOBFOBIncoTermAndCustomsChargeFactoryTest : IncoTermAndCustomsChargeFactoryTest
	{
	}
}
