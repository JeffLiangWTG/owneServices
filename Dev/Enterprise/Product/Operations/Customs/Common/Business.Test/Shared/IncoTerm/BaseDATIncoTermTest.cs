...
{
	class BaseDATIncoTermTest : IncoTermTest
	{
		[ExpectNoExceptions]
		...
		public override void TestITOTIncoterm()
		{
			...
			NUnit.Framework.Assert.That(IncoTermAndChargeFactory.ITOTIncoTerm(IncotermToTest, invoice), Is.EqualTo(IncotermToTest).Using(CustomComparers.TypeComparison), "With LCH in lines, ITOT Incoterm should be DAT");
		}
		...
		{
			get { return Core.Constants.IncoTerms.DeliveredAtTerminal; }
		}
