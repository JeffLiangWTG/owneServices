...
{
	public class BaseCPTIncoTermTest : IncoTermTest
	{
		[ExpectNoExceptions]
		...
		public override void TestITOTIncoterm()
		{
			...
			NUnit.Framework.Assert.That(IncoTermAndChargeFactory.ITOTIncoTerm(IncotermToTest, invoice), Is.EqualTo(IncotermToTest).Using(CustomComparers.TypeComparison), "With OFT in lines, ITOT Incoterm should be CPT");
		}
		...
		{
			get { return Core.Constants.IncoTerms.CarriagePaidTo; }
		}
