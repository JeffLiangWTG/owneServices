...
namespace Enterprise.Customs.AR.Manifest.Business
{
	public class ApplicationBusinessProvider : ASYCUDA.Business.ApplicationBusinessProvider
	{
		...
		protected override IReadOnlyList<ZString> CreateCountryCodes() => new[] { (ZString)Core.Constants.CountryCodes.Argentina };

		protected override IReadOnlyList<IManifestType> CreateManifestTypes()
		{
			return ARCustomsDataRegistry.Instance.EnableARManifests.Value ? new ARManifestTypes().All : (Array.Empty<IManifestType>());
		}
