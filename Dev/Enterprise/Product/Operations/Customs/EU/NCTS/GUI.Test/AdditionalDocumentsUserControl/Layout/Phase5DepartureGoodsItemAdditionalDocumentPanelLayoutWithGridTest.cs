...
{
	[TestedType(typeof(Phase5DepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid))]
	sealed class Phase5DepartureGoodsItemAdditionalDocumentPanelLayoutWithGridTest : LayoutsAbstractTest
	{
		...
		{
			var layout = new Phase5DepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid().Layout;
