...
{
	sealed class Phase5GoodsItemPreviousDocumentsGridColumnsLayoutTest : Phase5GoodsItemPreviousDocumentsGridColumnsLayoutTest<Phase5GoodsItemPreviousDocumentsGridColumnsLayout>;

	public abstract class Phase5GoodsItemPreviousDocumentsGridColumnsLayoutTest<TPhase5GoodsItemPreviousDocumentsGridColumnsLayout>
		: GridColumnLayoutProviderAbstractTest<TPhase5GoodsItemPreviousDocumentsGridColumnsLayout>
		where TPhase5GoodsItemPreviousDocumentsGridColumnsLayout : Phase5GoodsItemPreviousDocumentsGridColumnsLayout
	{
