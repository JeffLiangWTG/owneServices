...
{
	sealed class HouseConsignmentAdditionalDocumentsGridUserControlTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			userControl = new HouseConsignmentAdditionalDocumentGridUserControl();
			additionalDocumentsGrid = userControl.AdditionalDocumentsGrid;
			userControl.SetDataBinding(nctsHeader, "");
		}
		HouseConsignmentAdditionalDocumentGridUserControl userControl;
