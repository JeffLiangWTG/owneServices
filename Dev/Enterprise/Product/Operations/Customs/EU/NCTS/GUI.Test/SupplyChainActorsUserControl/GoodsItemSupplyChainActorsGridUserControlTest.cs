...
{
	class GoodsItemSupplyChainActorsGridUserControlTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			userControl = new GoodsItemSupplyChainActorsGridUserControl();
			selectedSupplyChainActorsGrid = userControl.SelectedSupplyChainActorsGrid;
		}
		GoodsItemSupplyChainActorsGridUserControl userControl;
