...
{
	sealed class GoodsItemSupportingDocumentsGridUserControlTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			userControl = new GoodsItemSupportingDocumentsGridUserControl();
			supportingDocumentsGrid = userControl.SupportingDocumentsGrid;
			userControl.SetDataBinding(nctsHeader, "");
		}
		GoodsItemSupportingDocumentsGridUserControl userControl;
