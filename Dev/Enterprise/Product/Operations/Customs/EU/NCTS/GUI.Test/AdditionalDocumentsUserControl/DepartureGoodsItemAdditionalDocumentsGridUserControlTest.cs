...
{
	sealed class DepartureGoodsItemAdditionalDocumentsGridUserControlTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			userControl = new DepartureGoodsItemAdditionalDocumentsGridUserControl();
			additionalDocumentsGrid = userControl.AdditionalDocumentsGrid;
			userControl.SetDataBinding(nctsHeader, "");
		}
		DepartureGoodsItemAdditionalDocumentsGridUserControl userControl;
