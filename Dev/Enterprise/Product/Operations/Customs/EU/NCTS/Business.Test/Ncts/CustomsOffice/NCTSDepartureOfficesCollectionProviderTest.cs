...
{
	[TestedType(typeof(NCTSDepartureOfficesCollectionProvider))]
	class NCTSDepartureOfficesCollectionProviderTest : CollectionProviderWithCodeSupportBaseTest
	{
		...
		public void TestCollection()
		{
			...
			collection.Load();
			AssertContainsExactElementsInAnyOrder(new ZString[] { "DE004323", "IT009278", "GB001234", "TR001234", "XI001234" }, collection.Cast<ZZRefCusCodeListCombined>().Select(x => x.ZZD_Code));
		}
		...
		void SetupCustomsOffices()
		{
			...
			helper.CreateCusCodeListWithAttribute(Core.Constants.CountryCodes.UnitedKingdom, Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsOffice, "GB001234", "UK OFFICE NCTSOfficeOfDeparture", ZDateTime.MinSmallDateTimeValue, ZDateTime.MaxSmallDateTimeValue, RefCusCodeListAttributeTypes.Codes.ROLE, OfficeCodes_NCTS.Codes.NCTSOfficeOfDeparture);
			...
			helper.CreateCusCodeListWithAttribute(Core.Constants.CountryCodes.Turkey, Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsOffice, "TR001234", "TR OFFICE NCTSOfficeOfDeparture", ZDateTime.MinSmallDateTimeValue, ZDateTime.MaxSmallDateTimeValue, RefCusCodeListAttributeTypes.Codes.ROLE, OfficeCodes_NCTS.Codes.NCTSOfficeOfDeparture);
			...
			helper.CreateCusCodeListWithAttribute(IrelandXI, Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsOffice, "XI001234", "XI OFFICE NCTSOfficeOfDeparture", ZDateTime.MinSmallDateTimeValue, ZDateTime.MaxSmallDateTimeValue, RefCusCodeListAttributeTypes.Codes.ROLE, OfficeCodes_NCTS.Codes.NCTSOfficeOfDeparture);
			...
			helper.CreateCusCodeListWithAttribute(Core.Constants.CountryCodes.Australia, Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsOffice, "AU001234", "AU OFFICE NCTSOfficeOfDeparture", ZDateTime.MinSmallDateTimeValue, ZDateTime.MaxSmallDateTimeValue, RefCusCodeListAttributeTypes.Codes.ROLE, OfficeCodes_NCTS.Codes.NCTSOfficeOfDeparture);
