...
namespace Enterprise.Customs.EU.NCTS.Business.Testing
{
	...
	{
		public void TestIsRuleIsRuleB1895_1()
		{
		...
		public void TestIsRuleC0001_4()
		{
			AssertEquals(expected: false, validationDecider.IsRuleC0001_4Active);
		}

		public void TestIsRuleC0001_6()
		{
			AssertEquals(expected: false, validationDecider.IsRuleC0001_6Active);
		}

		public void TestIsRuleC0001_7()
		{
			AssertEquals(expected: false, validationDecider.IsRuleC0001_7Active);
		}

		public void TestIsRuleC0502()
		{
			AssertEquals(expected: true, validationDecider.IsRuleC0502Active);
		}

		public void TestIsRuleE1301Active()
		{
			AssertEquals(expected: false, validationDecider.IsRuleE1301Active);
		}

		public void TestIsRuleG0001_1()
		{
		...
		{
			AssertEquals(expected: true, validationDecider.IsRuleC0909Active);
		}
		...
		{
			AssertEquals(expected: false, validationDecider.IsRuleNR0078Active);
		}

		public void TestIsRuleNR0079Active()
		{
			AssertEquals(expected: false, validationDecider.IsRuleNR0079Active);
		}
		...
		{
			AssertEquals(expected: false, validationDecider.IsRuleTR0094Active);
		}
		...
		INctsBillDeparturePhase5ValidationDecider validationDecider;
	}
}
