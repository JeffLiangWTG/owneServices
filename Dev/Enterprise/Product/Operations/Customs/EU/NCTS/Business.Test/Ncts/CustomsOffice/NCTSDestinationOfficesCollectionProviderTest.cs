...
{
	[TestedType(typeof(NCTSDestinationOfficesCollectionProvider))]
	class NCTSDestinationOfficesCollectionProviderTest : CollectionProviderWithCodeSupportBaseTest
	{
