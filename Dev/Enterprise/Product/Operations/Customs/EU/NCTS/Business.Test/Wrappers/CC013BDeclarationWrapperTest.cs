...
{
	[TestedType(typeof(CC013BDeclarationWrapper))]
	class CC013BDeclarationWrapperTest : DeclarationWrapperAbstractTest<CC013BDeclarationWrapper>
	{
		...
		public void TestCountryOfDispatchExportCode()
		{
			...
			using (ObjectFactory.Substitute("NCTS.NctsConfiguration", nctsConfiguration))
			{
				...
				var wrapper2 = new CC013BDeclarationWrapper(header2);
		...
		public void TestContainerisedIndicator()
		{
			...
			var containerPivot1 = item1.ContainersPivots.AddNew();

			containerPivot1.Container = container;
			containerPivot1.ContainerSelected = true;
			containerPivot1.Container.BC_Seal1 = "123456";
			CombineAssertions(() =>
			{
				AssertEquals("Container Not linked to Goods item", false, wrapper.ContainerisedIndicator);
				goodsItems[0].ContainersPivots[0].ContainerNumber = "num";
				header.DepartureHeaderContainers.Add(container);
				AssertEquals("Linked to goods item", true, wrapper.ContainerisedIndicator);
			});
		}
		...
		public void TestNctsAccompanyingDocumentLanguageCode()
		{
			AssertEquals("EN", wrapper.NctsAccompanyingDocumentLanguageCode);
		}
		...
		public void TestTotalGrossMass_Phase4()
		{
			...
			AssertEquals(55.0m, wrapper.TotalGrossMass);
		}
		...
		public void TestProvisionalTransitDepartureDate()
		{
			...
			var wrapper = new CC013BDeclarationWrapper(nctsHeader);
			...
			wrapper = new CC013BDeclarationWrapper(nctsHeader);
		...
		public void TestModeOfRepresentation()
		{
			...
			wrapper = new CC013BDeclarationWrapper(nctsHeader.Object);
		...
		public void TestSealsNumber()
		{
			...
			AssertEquals(2, wrapper.SealsNumber);
		...
		void TestContainerSeals()
		{
			...
			containerPivot.Container = container;
			containerPivot.ContainerSelected = true;
			var wrapper2 = new CC013BDeclarationWrapper(header);
		...
		protected override void SetUp()
		{
			...
			wrapper = new CC013BDeclarationWrapper(header);
		}
		NctsHeader header;
		CC013BDeclarationWrapper wrapper;

		protected override CC013BDeclarationWrapper GetProvider()
		{
