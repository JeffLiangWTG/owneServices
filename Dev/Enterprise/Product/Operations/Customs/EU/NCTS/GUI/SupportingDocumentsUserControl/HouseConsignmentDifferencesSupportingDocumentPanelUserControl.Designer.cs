...
{
	partial class HouseConsignmentDifferencesSupportingDocumentPanelUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.SupportingDocumentsSplitContainer.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(125);
			// 
			...
			this.Name = "HouseConsignmentSupportingDocumentsPanelUserControl";
