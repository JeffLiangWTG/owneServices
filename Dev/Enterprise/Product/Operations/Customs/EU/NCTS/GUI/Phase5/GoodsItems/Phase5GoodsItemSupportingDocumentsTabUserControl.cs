...
{
	partial class Phase5GoodsItemSupportingDocumentsTabUserControl : ZUserControl
	{
		public Phase5GoodsItemSupportingDocumentsTabUserControl()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterFirstBinding(EventArgs e)
		{
			...
			var panelLayoutWithGrid = provider.GoodsItemSupportingDocumentPanelLayoutWithGrid;
