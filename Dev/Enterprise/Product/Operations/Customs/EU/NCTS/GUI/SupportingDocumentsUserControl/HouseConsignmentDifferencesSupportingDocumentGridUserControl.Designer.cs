...
{
	partial class HouseConsignmentDifferencesSupportingDocumentGridUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsSupportingDocument)(null)))));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.NCTS.Business.NctsSupportingDocument)(null)).CSI_LineNo)));
			...
			this.SupportingDocumentsGrid.GridId = "05afd5ce-a9f5-446e-8494-e73b5f3a4f89";
			...
			// 
			// HouseConsignmentDifferencesSupportingDocumentGridUserControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.SupportingDocumentsGrid);
			this.Name = "HouseConsignmentDifferencesSupportingDocumentGridUserControl";
