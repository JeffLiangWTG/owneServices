...
{
	public partial class NctsPackagePanelUserControl : ZUserControl
	{
		public NctsPackagePanelUserControl()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterFirstBinding(EventArgs e)
		{
			...
			var panelLayoutWithGrid = provider.NctsPackageLayoutWithGrid;
			SetPackagesGrid();
			SetPackagesLayout();

			void SetPackagesGrid()
			{
				var userControl = (ZUserControl)Activator.CreateInstance(panelLayoutWithGrid.GridUserControlType);
				PackagesSplitContainer.Panel1.Controls.Add(userControl);
				BindingSource.SetBindingMember(userControl, ".");
				userControl.Dock = System.Windows.Forms.DockStyle.Fill;
			}

			void SetPackagesLayout()
			{
				PackagesDynamicLayoutPanel.UpdateLayout(panelLayoutWithGrid);
			}
		}
	}
}
