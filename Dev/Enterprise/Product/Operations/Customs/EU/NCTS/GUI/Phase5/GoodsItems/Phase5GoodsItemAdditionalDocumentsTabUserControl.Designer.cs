...
{
	partial class Phase5GoodsItemAdditionalDocumentsTabUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.AdditionalDocumentsSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1046, 747, true);
			this.AdditionalDocumentsSplitContainer.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(100);
			this.AdditionalDocumentsSplitContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(1000);
			...
			this.AdditionalDocumentDynamicLayoutPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1046, 483, true);
			this.AdditionalDocumentDynamicLayoutPanel.TabIndex = 0;
			// 
			// Phase5GoodsItemAdditionalDocumentsTabUserControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.AdditionalDocumentsSplitContainer);
			this.Name = "Phase5GoodsItemAdditionalDocumentsTabUserControl";
