...
{
	partial class Phase5GoodItemsAdditionalDocumentPanelUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.AdditionalDocumentsSplitContainer.Name = "GoodItemsAdditionalDocumentsPanelSplitContainer";
			...
			this.AdditionalDocumentsSplitContainer.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(75);
			// 
			...
			this.AdditionalDocumentDynamicLayoutPanel.Name = "GoodItemsAdditionalDocumentsPanelDynamicLayoutPanel";
			...
			// 
			// GoodItemsAdditionalDocumentsPanelUserControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.AdditionalDocumentsSplitContainer);
			this.Name = "GoodItemsAdditionalDocumentsPanelUserControl";
