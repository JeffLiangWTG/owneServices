...
{
	partial class HouseConsignmentSupplyChainActorsTabUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.SupplyChainActorsSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(522, 295, true);
			...
			this.Name = "HouseConsignmentSupplyChainActorsTabUserControl";
