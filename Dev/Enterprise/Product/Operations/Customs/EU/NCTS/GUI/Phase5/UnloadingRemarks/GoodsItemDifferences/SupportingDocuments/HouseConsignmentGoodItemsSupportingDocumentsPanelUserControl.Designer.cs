...
{
	partial class HouseConsignmentGoodItemsSupportingDocumentsPanelUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.SupportingDocumentsSplitContainer.Name = "HouseConsignmentSupportingDocumentsPanelSplitContainer";
			...
			this.SupportingDocumentsSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1322, 747, true);
			this.SupportingDocumentsSplitContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(130);
			this.SupportingDocumentsSplitContainer.TabIndex = 0;
			this.SupportingDocumentsSplitContainer.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(100);
			// 
			...
			this.SupportingDocumentDynamicLayoutPanel.Name = "HouseConsignmentSupportingDocumentsPanelDynamicLayoutPanel";
			this.SupportingDocumentDynamicLayoutPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1322, 483, true);
			...
			this.Name = "HouseConsignmentGoodItemsSupportingDocumentsPanelUserControl";
