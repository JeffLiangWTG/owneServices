...
{
	partial class Phase5CustomsOfficesUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZShort)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).CY_Order)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).CY_Code)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).Lookups.CodeList)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).CY_Data)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).CY_OfficeDescription)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZDateTime)(((Enterprise.Customs.EU.NCTS.Business.NctsEuOfficeCode)(((System.Collections.IList)(((Enterprise.Customs.EU.NCTS.Business.NctsHeader)(null)).MovementHeader.CustomsOfficesForDeparture)).SyncRoot)).CY_Date)));
			...
			zTextBoxColumnStyleInfo1.ColumnName = "CY_Order";
			...
			zTextBoxColumnStyleInfo2.CaptionResourceString = Enterprise.Customs.EU.NCTS.GUI.Res.GetData("2a681460-de50-452d-8e34-614973ad795c", "Desc.", "Office Desc.", "Office Desc.", "Office Description");
			zTextBoxColumnStyleInfo2.ColumnName = "CY_OfficeDescription";
			zTextBoxColumnStyleInfo2.DefaultCollectionIndex = 0;
			zTextBoxColumnStyleInfo2.GroupName = Enterprise.Customs.EU.NCTS.GUI.Res.GetData("f88fbdf9-a7e0-4bf5-81a7-5ed84543f9de", "Office Code");
			...
			// 
			// Phase5CustomsOfficesUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.BackColor = System.Drawing.SystemColors.Control;
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.CustomsOfficesGrid);
			this.Name = "Phase5CustomsOfficesUserControl";
