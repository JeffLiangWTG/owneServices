...
{
	public partial class Phase5GoodsItemAdditionalDocumentsTabUserControl : ZUserControl
	{
		public Phase5GoodsItemAdditionalDocumentsTabUserControl()
		{
			InitializeComponent();
		}
		...
		protected override void OnAfterFirstBinding(EventArgs e)
		{
			...
			var panelLayoutWithGrid = ArrivalOrDepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid(provider);
		...
		protected virtual IPanelLayoutWithGridProvider ArrivalOrDepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid(INctsPhase5LayoutProvider provider)
		{
			return (DataSource?.IsArrivalMovement ?? false) ? provider.ArrivalGoodsItemAdditionalDocumentPanelLayoutWithGrid : provider.DepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid;
		}
	}
}
