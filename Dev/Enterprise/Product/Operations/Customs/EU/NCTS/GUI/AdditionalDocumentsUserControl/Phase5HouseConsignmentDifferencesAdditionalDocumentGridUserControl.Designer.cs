...
{
	partial class Phase5HouseConsignmentDifferencesAdditionalDocumentGridUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.AdditionalDocumentsGrid.ColumnStyles.Add(zCalcEditColumnStyleInfo1);
			...
			this.AdditionalDocumentsGrid.ColumnStyles.Add(zTextBoxColumnStyleInfo3);
			...
			// 
			// Phase5HouseConsignmentDifferencesAdditionalDocumentGridUserControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.AdditionalDocumentsGrid);
			this.Name = "Phase5HouseConsignmentDifferencesAdditionalDocumentGridUserControl";
