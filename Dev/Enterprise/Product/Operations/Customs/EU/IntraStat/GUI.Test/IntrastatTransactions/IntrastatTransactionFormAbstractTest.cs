...
{
	[TestsSubclassesOf(typeof(IntrastatTransactionForm))]
	public abstract class IntrastatTransactionFormAbstractTest<TParent> : ZFormBasherTest
		where TParent : CusIntrastatHeader
	{
		protected override Form GetFormToBashCore()
		{
			var report = IntrastatTestDataHelper.New(Factory).NewCusIntrastatHeaderWithValidData<TParent>();
			Factory.Save();

			var form = new IntrastatTransactionForm(report);
