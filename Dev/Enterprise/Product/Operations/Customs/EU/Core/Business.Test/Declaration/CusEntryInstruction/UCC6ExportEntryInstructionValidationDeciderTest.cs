...
namespace Enterprise.Customs.EU.Business.Declaration.Testing
{
	...
	{
		public void TestIRuleG0128Configuration_IsActive() => AssertEquals(false, ((IRuleG0128ForCEI_ProcedureDecider)validationDecider).IsActive);

		public void TestIRuleR0028EForCEI_SubStyleDecider_IsActive()
		{
			AssertEquals(false, ((IRuleR0028EForCEI_SubStyleDecider)validationDecider).IsActive);
		}
