...
{
	sealed class DeclarationCreatorTest : TestCaseWithFactory
	{
		public void TestGetDeclarationCreator()
		{
			AssertEquals(typeof(DeclarationCreator), declarationCreator.GetType());
		}
		...
		public void TestRelatedDeclaration()
		{
			...
			AssertEquals("New declaration 1 EntryAuthorisationDate", new ZDateTime(2024, 9, 21), dec1.JE_EntryAuthorisationDate);
			AssertEquals("New declaration 2 EntryAuthorisationDate", new ZDateTime(2024, 9, 22), dec2.JE_EntryAuthorisationDate);
			AssertEquals("New declaration 3 EntryAuthorisationDate", new ZDateTime(2024, 9, 24), dec3.JE_EntryAuthorisationDate);
		...
		public void TestRelatedDeclaration_RelationshipType()
		{
			declarationCreator.RelatedDeclaration();

			var supplementaryDeclaration = declaration.RelatedDeclarations[0];
			var relationship = (ManyToManyRelationship)declaration.RelatedDeclarations.Relationship;
			AssertEquals("The RelationshipType between a declaration and its RelatedDeclarations is SUP.", EUCommonConstants.DeclarationRelationshipType.SupplementaryDeclaration, ((GenPivot)relationship.GetPivotObject(supplementaryDeclaration)).XX_RelationType);
		}
		...
		public void TestNewInstruction()
		{
			...
			AssertEquals("EntryAuthorisationDate", new ZDateTime(2024, 9, 24), declaration.JE_EntryAuthorisationDate);
			...
			AssertEquals("New EntryInstruction 1 SubStyle", "Y", newInstruction1.CEI_SubStyle);
			AssertEquals("New EntryInstruction 2 Style", "H4", newInstruction2.CEI_Style);
			AssertEquals("New EntryInstruction 2 SubStyle", "Y", newInstruction2.CEI_SubStyle);
			AssertEquals("New EntryInstruction 4 Style", "H1", newInstruction4.CEI_Style);
			AssertEquals("New EntryInstruction 4 SubStyle", "Y", newInstruction4.CEI_SubStyle);
		...
		public void TestReuseInstruction()
		{
			...
			AssertEquals("EntryInstruction 3 SubStyle - unchanged", ZString.Empty, declaration.CustomsEntryInstructions[2].CEI_SubStyle);
			AssertEquals("EntryInstruction 4 Style", "H1", declaration.CustomsEntryInstructions[3].CEI_Style);
			AssertEquals("EntryInstruction 4 SubStyle", "Y", declaration.CustomsEntryInstructions[3].CEI_SubStyle);
		...
		public void TestEntryAuthorisationDate()
		{
			...
			entry1.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 20));
			entry2.Logs.RemoveAndDeleteAll();
			var l1 = entry2.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 20));
			var l2 = entry2.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 22));
			entry4.Logs.RemoveAndDeleteAll();
			entry4.Logs.AddNew(Events.CustomsEntryStatus, Events.CustomsCommenced.Code, new ZDateTimeOffset(2024, 9, 24));
			declarationCreator.RelatedDeclaration();
			...
			AssertEquals("New declaration 1 EntryAuthorisationDate", new ZDateTime(2024, 9, 21), dec1.JE_EntryAuthorisationDate);
			AssertEquals("New declaration 2 EntryAuthorisationDate", new ZDateTime(2024, 9, 22), dec2.JE_EntryAuthorisationDate);
			AssertEquals("New declaration 3 EntryAuthorisationDate", ZDateTime.Empty, dec3.JE_EntryAuthorisationDate);
		}
		...
		protected override void SetUp()
		{
			...
			var package2 = declaration.Bills.AddNew().PackingGroups.AddNew().Packages.AddNew();
			package2.CW_PackQty = 16;
			package2.CW_PackType = "AA";
			package2.CW_MarksAndNos = "AA2";

			var package3 = declaration.Bills.AddNew().PackingGroups.AddNew().Packages.AddNew();
			...
			invLine21.PackagesForInvoiceLinesForBindingOnly[2].IsLinked = true;
			invLine21.PackagesForInvoiceLinesForBindingOnly[2].PackQty = 4;
			...
			invLine31.PackagesForInvoiceLinesForBindingOnly[2].IsLinked = true;
			invLine31.PackagesForInvoiceLinesForBindingOnly[2].PackQty = 32;
			invLine32.PackagesForInvoiceLinesForBindingOnly[0].IsLinked = true;
			invLine32.PackagesForInvoiceLinesForBindingOnly[0].PackQty = 8;
			invLine32.PackagesForInvoiceLinesForBindingOnly[1].IsLinked = true;
			invLine32.PackagesForInvoiceLinesForBindingOnly[1].PackQty = 16;
			...
			eh1.EntryNumber = "EN0001";
			eh2.CH_EntryStatus = EntryStatusList.Codes.Clear;
			eh2.MovementReferenceNumberSetter("MRN0002");
			eh2.EntryNumber = "EN0002";
			eh3.CH_EntryStatus = EntryStatusList.Codes.Clear;
			eh3.MovementReferenceNumberSetter("MRN0003");
			eh3.EntryNumber = "EN0003";
			eh4.CH_EntryStatus = EntryStatusList.Codes.Clear;
			eh4.MovementReferenceNumberSetter("MRN0004");
			eh4.EntryNumber = "EN0004";

			eh1.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 21));
			eh2.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 22));
			eh3.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 23));
			eh4.Logs.AddNew(Events.CustomsEntryStatus, DeclarationAcceptedCode, new ZDateTimeOffset(2024, 9, 24));
