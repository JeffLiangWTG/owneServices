...
namespace Enterprise.Customs.EU.Business.Declaration
{
	public class CusEntryLineConfirmedFeeWrapper : NonPersistentBusinessObject
	{
		...
		public ZString CF_MethodOfCalculation => CF_MethodOfCalculationCore;
		protected virtual ZString CF_MethodOfCalculationCore => cusEntryLineFee.CF_MethodOfCalculation;
		...
		public ZString NationalFeeTypeCode => cusEntryLineFee.NationalFeeTypeCode;
	}
}
