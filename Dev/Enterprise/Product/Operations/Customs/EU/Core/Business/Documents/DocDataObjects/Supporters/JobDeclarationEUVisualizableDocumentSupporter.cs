...
{
	public class JobDeclarationEUVisualizableDocumentSupporter : CustomsVisualizableDocumentSupporter<JobDeclaration>
	{
		public JobDeclarationEUVisualizableDocumentSupporter(JobDeclaration parent) : base(parent)
		{
		}
