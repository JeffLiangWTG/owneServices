...
namespace Enterprise.Customs.EU.Business
{
	...
	public class CusCalculationRule : Customs.Business.CusCalculationRule
	{
		...
		[ResourceStringData("EU|CusCalculationRule|CCR_RuleType", Caption = "Rule Type")]
		public override ZString CCR_RuleType { get => base.CCR_RuleType; set => base.CCR_RuleType = value; }

		[ResourceStringData("EU|CusCalculationRule|CCR_OH_Importer", Caption = "Importer", FullDescription = "If blank, this will be used as the fallback rate.")]
		public override ZGuid CCR_OH_Importer { get => base.CCR_OH_Importer; set => base.CCR_OH_Importer = value; }

		[ResourceStringData("EU|CusCalculationRule|CCR_TransportMode", Caption = "Transport Mode")]
		public override ZString CCR_TransportMode { get => base.CCR_TransportMode; set => base.CCR_TransportMode = value; }

		[ResourceStringData("EU|CusCalculationRule|CCR_BasedOn", Caption = "Based On", FullDescription = "Subject to the Rule Type of INS - ‘The Incoterm structure used to evaluate the value’.")]
		...
		[ResourceStringData("EU|CusCalculationRule|CCR_RX_NKCurrency", Caption = "Currency")]
		public override ZString CCR_RX_NKCurrency { get => base.CCR_RX_NKCurrency; set => base.CCR_RX_NKCurrency = value; }

		[ResourceStringData("EU|CusCalculationRule|CCR_StartDate", Caption = "Start Date")]
		public override ZDateTimeOffset CCR_StartDate { get => base.CCR_StartDate; set => base.CCR_StartDate = value; }

		[ResourceStringData("EU|CusCalculationRule|CCR_EndDate", Caption = "End Date")]
		...
		public CusCalculationRuleRateCollection CalculationRuleRateCollection
		{
			get
			{
				if (calculationRuleRateCollection == null)
				{
					...
					{
						calculationRuleRateCollection = new CusCalculationRuleRateCollection(Factory);
					}
		...
		{
			base.OnSaving();
			if (CCR_RuleType == "INS" && CalculationRuleRateCollection.Count > 0 && CalculationRuleRateCollection.HasChanges)
			{
		...
		public new CusCalculationRuleValidation Validation => (CusCalculationRuleValidation)base.Validation;
		...
		public new class Loader : BusinessObject.Loader
		{
			...
			public CusCalculationRule LoadApplicableInsuranceRule(ZGuid importerPK, ZString transportMode, ZDateTimeOffset effectiveDate)
			{
				...
				query.OrderBy = CusCalculationRuleSchema.Constants.CCR_OH_Importer + OrderByClause.Descending +
					"," + CusCalculationRuleSchema.Constants.CCR_TransportMode + OrderByClause.Descending;
