...
namespace Enterprise.Customs.EU.DataTransfer.Universal
{
	public class CusSupplyChainActorReferencesDataObjectReader : DataObjectReader
	{
		...
		public void Read(ICusSupplyChainActorReferenceCollection<CusSupplyChainActorReference> cusSupplyChainActorReferences, IDictionary<ZString, List<CustomsReference>> customsReferenceGroupByType)
		{
