...
{
	public sealed class InvoicePaymentLayouts : IPanelLayoutProvider
	{
		...
		{
			var builder = new InvoicePaymentLayoutBuilder<JobComInvoiceHeader>();
			var euBag = InvoicePaymentControlBag.Instance;
