...
{
	partial class TransportIDAndNationalityRailUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.TransportIDTextBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("2DCA075B-ED50-47B9-B4CF-521C2CE9C2FA", "Trans. ID", "Transport ID", "[UCC 7/9] Transport ID");
			...
			this.TransportNationalityFindBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("C1D3C66E-AA13-4D9B-A899-68F279C92ED7", "Nat.", "Nationality", "[UCC 7/15] Nationality");
			...
			// 
			// TransportIDAndNationalityRailUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.TransportIDTextBox);
			this.Controls.Add(this.TransportNationalityFindBox);
			this.Name = "TransportIDAndNationalityRailUserControl";
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(346, 23, true);
