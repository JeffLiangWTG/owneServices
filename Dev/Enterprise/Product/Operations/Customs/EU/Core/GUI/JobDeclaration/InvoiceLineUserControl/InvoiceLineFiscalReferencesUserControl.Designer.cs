...
{
	public partial class InvoiceLineFiscalReferencesUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.BindingSource.SetBindingMember(this.FiscalReferencesUserControl, "FilteredInvoiceLines.FiscalReferences");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.Customs.EU.Business.Declaration.ICusFiscalReferenceCollection<CusFiscalReference>)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceLine)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).FilteredInvoiceLines)).SyncRoot)).FiscalReferences)));
			...
			this.FiscalReferencesUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(673, 172, true);
			this.FiscalReferencesUserControl.TabIndex = 1;
			// 
			// InvoiceLineFiscalReferencesUserControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.FiscalReferencesUserControl);
			this.Name = "InvoiceLineFiscalReferencesUserControl";
