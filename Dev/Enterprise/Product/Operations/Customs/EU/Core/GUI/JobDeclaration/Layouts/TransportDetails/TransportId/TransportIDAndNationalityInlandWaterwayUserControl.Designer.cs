...
{
	partial class TransportIDAndNationalityInlandWaterwayENIUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.TransportNationalityFindBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("B3ED93CB-E66E-4E16-89ED-9E6A921591BC", "Nat.", "Nationality", "[UCC 7/15] Nationality");
			...
			this.TransportIDTextBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("B370EBDD-AD38-40DC-BF8A-BDF40C0F748D", "ENI Code");
