namespace Enterprise.Customs.EU.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			// BottomButtonPanel
			// 
			this.BottomButtonPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 809, true);
			this.BottomButtonPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1350, 28, true);
			// 
			// MainStatusBar
			// 
			this.MainStatusBar.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 837, true);
			...
			this.DataSourceType = typeof(Enterprise.Customs.EU.Business.Declaration.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs.EU.Business.JobDeclaration";
