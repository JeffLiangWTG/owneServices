namespace Enterprise.Customs.EU.GUI
{
	partial class CusPermitForm
	{
		...
		private new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.EU.Business.CusPermitHeader);
			// 
			// CusPermitForm
			// 
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(976, 623, true);
			this.DataSourceType = typeof(Enterprise.Customs.EU.Business.CusPermitHeader);
