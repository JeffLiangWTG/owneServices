...
{
	partial class EUNonLayoutImportSupplierHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.JZ_InvoiceNumberBoundTextBox = new Enterprise.ZArchitecture.ZTextBox();
			...
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit = new Enterprise.ZArchitecture.ZCalcEdit();
			...
			// 
			this.SupportingDocumentsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			// InvoicePaymentTabPage
			// 
			this.InvoicePaymentTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			// AdditionalInfoTabPage
			// 
			this.AdditionalInfoTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			...
			// 
			this.ValueIndicatorsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			...
			// 
			this.ValueIndicatorsUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(980, 293, true);
			// 
			// GroupChargesButton
			// 
			this.GroupChargesButton.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(67, 117, true);
			// 
			// DetailsGroupBox
			// 
			this.DetailsGroupBox.Dock = System.Windows.Forms.DockStyle.None;
			this.DetailsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(0, 0, true);
			this.DetailsGroupBox.Visible = false;
			// 
			// InvoiceDetailUserControl
			// 
			this.InvoiceDetailUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(0, 0, true);
			// 
			// InvoiceTabControl
			// 
			this.InvoiceTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 385, true);
			// 
			// ChargesGroupBox
			// 
			this.ChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 157, true);
			// 
			// ChargesTabControl
			// 
			this.ChargesTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(602, 138, true);
			// 
			// InvoiceChargesTabPage
			// 
			this.InvoiceChargesTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(594, 111, true);
			// 
			// InvoiceChargesGrid
			// 
			this.InvoiceChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(525, 111, true);
			// 
			// BaseGroupChargesGroupBox
			// 
			this.BaseGroupChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 136, true);
			// 
			// BaseGroupChargesGrid
			// 
			this.BaseGroupChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(535, 117, true);
			// 
			...
			this.JobComInvoiceHeadersBoundGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 147, true);
			// 
			// InvCustomFieldsDisplayControl
			// 
			this.InvCustomFieldsDisplayControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 358, true);
			// 
			// CustomFieldsTabPage
			// 
			this.CustomFieldsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 358, true);
			// 
			// Splitter
			// 
			this.Splitter.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 573, true);
			this.Splitter.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(390);
			this.Splitter.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(147);
			// 
			// InvDetailLeftPanel
			// 
			this.InvDetailLeftPanel.Controls.Add(this.JZ_ValuationCodeDropEdit);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_IncoTermPlaceTextBox);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_IncoTermBoundDropDownEdit);
			this.InvDetailLeftPanel.Controls.Add(this.AgreedPlaceCodeFindBox);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_InvoiceAmountBoundCurrencyControl);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_InvoiceNumberBoundTextBox);
			this.InvDetailLeftPanel.Controls.Add(this.NetWeightCalcDropEdit);
			this.InvDetailLeftPanel.Controls.Add(this.GrossWeightCalcDropEdit);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_InvoiceCurrExRateCalcEdit);
			this.InvDetailLeftPanel.Controls.Add(this.IncoTermExplainButton);
			this.InvDetailLeftPanel.Controls.Add(this.GroupInvoiceDropEdit);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_InvoiceCurrLandedCostExRateCalcEdit);
			this.InvDetailLeftPanel.Controls.Add(this.NoOfPacksCalcDropEdit);
			this.InvDetailLeftPanel.Controls.Add(this.JZ_InvoiceDateEdit);
			...
			// 
			this.ChargesGroupsSplitterContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(157);
			// 
			// BottomPanel
			// 
			this.BottomPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 385, true);
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_ValuationCode)));
			this.JZ_ValuationCodeDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 178, true);
			this.JZ_ValuationCodeDropEdit.Name = "JZ_ValuationCodeDropEdit";
			this.JZ_ValuationCodeDropEdit.PreBoundMaxLength = 2;
			this.JZ_ValuationCodeDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(239, 20, true);
			this.JZ_ValuationCodeDropEdit.TabIndex = 8;
			// 
			// JZ_InvoiceDateEdit
			// 
			this.JZ_InvoiceDateEdit.AllowDrop = true;
			this.JZ_InvoiceDateEdit.AutoCompleteMonthThreshold = 1;
			this.BindingSource.SetBindingMember(this.JZ_InvoiceDateEdit, "Invoices.JZ_InvoiceDate");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_InvoiceDate)));
			this.JZ_InvoiceDateEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 31, true);
			this.JZ_InvoiceDateEdit.Name = "JZ_InvoiceDateEdit";
			this.JZ_InvoiceDateEdit.TabIndex = 1;
			// 
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).ZG_AgreedPlaceCode)));
			this.AgreedPlaceCodeFindBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("EUCustomsSupplierHeaderUserControl|749DBB6C-59A7-4ACA-B623-741A73071ECB", "Incoterm Place Code");
			this.AgreedPlaceCodeFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 151, true);
			...
			this.AgreedPlaceCodeFindBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(188, 20, true);
			this.AgreedPlaceCodeFindBox.TabIndex = 7;
			// 
			// IncoTermExplainButton
			// 
			this.IncoTermExplainButton.IsCaptionOverridden = true;
			this.IncoTermExplainButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(174, 126, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_InvoiceCurrExRate)));
			this.JZ_InvoiceCurrExRateCalcEdit.CaptionResourceString = null;
			this.JZ_InvoiceCurrExRateCalcEdit.DecimalPlaces = 2;
			this.JZ_InvoiceCurrExRateCalcEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 102, true);
			this.JZ_InvoiceCurrExRateCalcEdit.Name = "JZ_InvoiceCurrExRateCalcEdit";
			this.JZ_InvoiceCurrExRateCalcEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(112, 20, true);
			this.JZ_InvoiceCurrExRateCalcEdit.TabIndex = 3;
			...
			// 
			this.JZ_InvoiceNumberBoundTextBox.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.JZ_InvoiceNumberBoundTextBox, "Invoices.JZ_InvoiceNumber");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_InvoiceNumber)));
			this.JZ_InvoiceNumberBoundTextBox.CaptionResourceString = null;
			this.JZ_InvoiceNumberBoundTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 8, true);
			this.JZ_InvoiceNumberBoundTextBox.Name = "JZ_InvoiceNumberBoundTextBox";
			this.JZ_InvoiceNumberBoundTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(239, 20, true);
			this.JZ_InvoiceNumberBoundTextBox.TabIndex = 0;
			// 
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_IncoTerm)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).Lookups.JZ_IncoTerm_List)));
			this.JZ_IncoTermBoundDropDownEdit.BindToList = "Invoices.Lookups.JZ_IncoTerm_List";
			this.JZ_IncoTermBoundDropDownEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 126, true);
			...
			this.JZ_IncoTermBoundDropDownEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(53, 20, true);
			this.JZ_IncoTermBoundDropDownEdit.TabIndex = 4;
			// 
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_Calc_GroupInvoice)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).Lookups.JZ_JZ_GroupInvoiceFK_List)));
			this.GroupInvoiceDropEdit.BindToList = "Invoices.Lookups+JZ_JZ_GroupInvoiceFK_List";
			this.GroupInvoiceDropEdit.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("EUNonLayoutImportSupplierHeaderUserControl|ac57f9ee-5b96-422a-8d8b-4aca92f641cd", "Group Invoice", "Immediate Group Invoice.");
			this.GroupInvoiceDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 54, true);
			...
			this.GroupInvoiceDropEdit.Visible = false;
			// 
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_InvoiceCurrLandedCostExRate)));
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.CaptionResourceString = null;
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.DecimalPlaces = 2;
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 250, true);
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.Name = "JZ_InvoiceCurrLandedCostExRateCalcEdit";
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(112, 20, true);
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.TabIndex = 11;
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.Text = "0.000000";
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_NoOfPacks)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).NoOfPacksPackType)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_Weight)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_WeightUQ)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).Lookups.JZ_WeightUQ_List)));
			...
			this.GrossWeightCalcDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(239, 20, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_NetWeight)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_NetWeightUQ)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).Lookups.JZ_WeightUQ_List)));
			...
			this.NetWeightCalcDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(239, 20, true);
			...
			this.JZ_InvoiceAmountBoundCurrencyControl.BindToAmount = "Invoices.JZ_InvoiceAmount";
			this.JZ_InvoiceAmountBoundCurrencyControl.BindToList = "Lookups.CurrencyList";
			this.JZ_InvoiceAmountBoundCurrencyControl.BindToUnit = "Invoices.JZ_RX_NKInvoice_Currency";
			this.JZ_InvoiceAmountBoundCurrencyControl.FindBoxType = Enterprise.ZArchitecture.GUI.FindBoxType.Code;
			this.JZ_InvoiceAmountBoundCurrencyControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 78, true);
			this.JZ_InvoiceAmountBoundCurrencyControl.ModuleID = Enterprise.ZArchitecture.Modules.ModuleIDs.RefCurrency;
			this.JZ_InvoiceAmountBoundCurrencyControl.Name = "JZ_InvoiceAmountBoundCurrencyControl";
			this.JZ_InvoiceAmountBoundCurrencyControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(239, 20, true);
			this.JZ_InvoiceAmountBoundCurrencyControl.TabIndex = 2;
			// 
			// JZ_IncoTermPlaceTextBox
			// 
			this.BindingSource.SetBindingMember(this.JZ_IncoTermPlaceTextBox, "Invoices.JZ_IncoTermPlace");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.Business.Declaration.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.EU.Business.Declaration.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_IncoTermPlace)));
			this.JZ_IncoTermPlaceTextBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("5453de3f-ad55-4e22-a977-18be82272a02", "Agreed Place", "Place where the seller will deliver the goods to the carrier or another person nominated, based on an agreement between the parties.");
			this.JZ_IncoTermPlaceTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(277, 126, true);
			this.JZ_IncoTermPlaceTextBox.Name = "JZ_IncoTermPlaceTextBox";
			this.JZ_IncoTermPlaceTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(80, 20, true);
			this.JZ_IncoTermPlaceTextBox.TabIndex = 6;
			// 
			// EUNonLayoutImportSupplierHeaderUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Name = "EUNonLayoutImportSupplierHeaderUserControl";
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 573, true);
		...
		protected Enterprise.ZArchitecture.ZTextBox JZ_InvoiceNumberBoundTextBox;
		protected Enterprise.ZArchitecture.GUI.ZDropEdit JZ_IncoTermBoundDropDownEdit;
		protected Enterprise.ZArchitecture.GUI.ZDropEdit GroupInvoiceDropEdit;
		protected ZArchitecture.ZCalcEdit JZ_InvoiceCurrLandedCostExRateCalcEdit;
		protected ZArchitecture.GUI.ZCalcDropEdit NoOfPacksCalcDropEdit;
		...
		protected Customs.GUI.ConvertToLocalCurrencyControl JZ_InvoiceAmountBoundCurrencyControl;
		protected ZArchitecture.ZTextBox JZ_IncoTermPlaceTextBox;
		protected Enterprise.ZArchitecture.GUI.ZDropEdit JZ_ValuationCodeDropEdit;
		protected Enterprise.ZArchitecture.GUI.ZDateEdit JZ_InvoiceDateEdit;
		protected Enterprise.ZArchitecture.GUI.ZCodeFindBox AgreedPlaceCodeFindBox;
