...
{
	partial class EUImportSupplierHeaderUserControl
	{
		...
		{
			this.HeaderDescriptionsTabPage = new Enterprise.ZArchitecture.GUI.ZTabPage();
			...
			// GroupChargesButton
			// 
			this.GroupChargesButton.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(67, 116, true);
			// 
			// DetailsGroupBox
			// 
			...
			// InvoiceTabControl
			// 
			this.InvoiceTabControl.Controls.Add(this.HeaderDescriptionsTabPage);
			this.InvoiceTabControl.Controls.SetChildIndex(this.HeaderDescriptionsTabPage, 0);
			...
			// ChargesGroupBox
			// 
			this.ChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 158, true);
			// 
			// ChargesTabControl
			// 
			this.ChargesTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(602, 139, true);
			// 
			// InvoiceChargesTabPage
			// 
			this.InvoiceChargesTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(594, 112, true);
			// 
			// InvoiceChargesGrid
			// 
			this.InvoiceChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(525, 112, true);
			// 
			// BaseGroupChargesGroupBox
			// 
			this.BaseGroupChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 135, true);
			// 
			// BaseGroupChargesGrid
			// 
			this.BaseGroupChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(535, 116, true);
			// 
			...
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(988, 135, true);
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.TabIndex = 0;
			// 
			// InvCustomFieldsDisplayControl
			// 
			this.InvCustomFieldsDisplayControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			// CustomFieldsTabPage
			// 
			this.CustomFieldsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			// 
			// Splitter
			// 
			// 
			...
			this.ChargesGroupsSplitterContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(158);
			// 
			// HeaderDescriptionsTabPage
			// 
			this.HeaderDescriptionsTabPage.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("BE4CB6C8-5D51-49EF-AE71-3610CBB967BD", "Descriptions");
			this.HeaderDescriptionsTabPage.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(4, 23, true);
			this.HeaderDescriptionsTabPage.Name = "HeaderDescriptionsTabPage";
			this.HeaderDescriptionsTabPage.Padding = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPadding(3, true);
			this.HeaderDescriptionsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 299, true);
			this.HeaderDescriptionsTabPage.TabIndex = 100;
			this.HeaderDescriptionsTabPage.UseVisualStyleBackColor = true;
			// 
			// EUImportSupplierHeaderUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Name = "EUImportSupplierHeaderUserControl";
		...
		protected Enterprise.ZArchitecture.GUI.ZTabPage HeaderDescriptionsTabPage;
	}
}
