...
{
	partial class TransportIDAndNationalityUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.TransportIDTextBox.CaptionResourceString = Enterprise.Customs.EU.GUI.Res.GetData("17BCE255-2599-42CA-B0A4-E343613B9D27", "Trans. ID", "Transport ID", "[UCC 7/9] Transport ID");
