...
{
	class TransportIDAndNationalityInlandWaterwayENIUserControlTest : TestCase
	{
		...
		public void TestTransportIDTextBox()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("Caption", "ENI Code", transportIDTextBox.CaptionResourceString.Caption);
		...
		{
			base.SetUp();
			control = new TransportIDAndNationalityInlandWaterwayENIUserControl();
		}
		...
		TransportIDAndNationalityInlandWaterwayENIUserControl control;
	}
}
