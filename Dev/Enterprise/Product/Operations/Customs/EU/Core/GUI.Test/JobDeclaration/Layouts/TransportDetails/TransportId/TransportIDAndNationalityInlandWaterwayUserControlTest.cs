...
{
	class TransportIDAndNationalityInlandWaterwayUserControlTest : TestCase
	{
		...
		public void TestTransportIDTextBox()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("Caption", "Vessel Name", transportIDTextBox.CaptionResourceString.Caption);
		...
		{
			base.SetUp();
			control = new TransportIDAndNationalityInlandWaterwayUserControl();
		}
		...
		TransportIDAndNationalityInlandWaterwayUserControl control;
	}
}
