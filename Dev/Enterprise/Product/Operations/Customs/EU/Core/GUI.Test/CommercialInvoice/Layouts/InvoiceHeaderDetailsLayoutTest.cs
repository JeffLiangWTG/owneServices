...
using InvoiceHeaderDetailsLayout = Enterprise.Customs.EU.GUI.CommercialInvoice.InvoiceHeaderDetailsLayout;
...
namespace Enterprise.Customs.EU.GUI.Testing.CommercialInvoice.Layouts
{
	...
	sealed class InvoiceHeaderDetailsLayoutTest : LayoutsAbstractTest
	{
		public void TestControlsVisibility()
		{
			...
			AssertEquals("Should be visible InvoiceNumberBoundTextBox", true, Layout.IsVisible(EUInvoiceHeaderDetailsControlBag.Instance.AgreedPlaceCodeFindBox, invoiceHeader));
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (EUInvoiceHeaderDetailsControlBag.Instance.AgreedPlaceCodeFindBox, ControlWidthClass.Auto);
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new Customs.GUI.CommercialInvoiceDetailsLayoutBuilder<JobComInvoiceHeader>();
