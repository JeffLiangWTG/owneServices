...
{
	[TestedType(typeof(InvoiceUCC6AndExportSupportingDocumentFieldsLayout))]
	sealed class InvoiceUCC6AndExportSupportingDocumentFieldsLayoutTest : LayoutsAbstractTest
	{
