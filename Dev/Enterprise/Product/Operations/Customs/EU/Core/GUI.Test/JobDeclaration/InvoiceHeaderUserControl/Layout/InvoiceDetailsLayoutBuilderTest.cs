...
namespace Enterprise.Customs.EU.GUI.Testing
{
	...
	sealed class InvoiceDetailsLayoutBuilderTest : ColumnLayoutBuilderAbstractTest<InvoiceDetailsLayoutBuilder<JobComInvoiceHeader>, JobComInvoiceHeader, InvoiceDetailsControlBag>
	{
		public void TestSetDefaultVisibility_IncoTermPlaceTextBox_IMP()
		{
			AssertUcc6ControlVisibility(CommercialInvoiceDetailsControlBag.Instance.IncoTermPlaceTextBox, x => x.JZ_IncoTerm != IncoTerms.Other, false, messageType: MessageTypeList.Codes.Import);
		}

		public void TestSetDefaultVisibility_IncoTermPlaceTextBox_EXP()
		{
			AssertUcc6ControlVisibility(CommercialInvoiceDetailsControlBag.Instance.IncoTermPlaceTextBox, x => x.JZ_IncoTerm != IncoTerms.Other, false, messageType: MessageTypeList.Codes.Export);
		}

		public void TestSetDefaultVisibility_IncoTermsAgreedPlaceLongTextControl_IMP()
		{
			AssertUcc6ControlVisibility(InvoiceDetailsControlBag.Instance.IncoTermsAgreedPlaceLongTextControl, x => x.JZ_IncoTerm == IncoTerms.Other, false, messageType: MessageTypeList.Codes.Import);
		}

		public void TestSetDefaultVisibility_IncoTermsAgreedPlaceLongTextControl_EXP()
		{
			AssertUcc6ControlVisibility(InvoiceDetailsControlBag.Instance.IncoTermsAgreedPlaceLongTextControl, x => x.JZ_IncoTerm == IncoTerms.Other, false, messageType: MessageTypeList.Codes.Export);
		}
