...
{
	sealed class InvoiceLineAuthorizationsComputedUserControlTest : TestCaseWithFactory
	{
		public void TestControls()
		{
			...
			using (var control = new InvoiceLineAuthorizationsComputedUserControl())
			{
				...
				CombineAssertions(() =>
				{
					...
					AssertEquals("Grid binding", "FilteredInvoiceLines.CusAuthorizationUsages", authorisationsGrid.GetBindingMember());
