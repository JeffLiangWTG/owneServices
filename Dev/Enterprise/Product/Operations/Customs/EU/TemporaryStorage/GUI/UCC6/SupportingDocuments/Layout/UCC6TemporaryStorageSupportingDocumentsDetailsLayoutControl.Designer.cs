...
{
	public partial class UCC6TemporaryStorageSupportingDocumentsDetailsLayoutControl
    {
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// 
			// SupportingDocumentsDetailsLayoutControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Controls.Add(this.DetailsPanel);
			this.Name = "SupportingDocumentsDetailsLayoutControl";
