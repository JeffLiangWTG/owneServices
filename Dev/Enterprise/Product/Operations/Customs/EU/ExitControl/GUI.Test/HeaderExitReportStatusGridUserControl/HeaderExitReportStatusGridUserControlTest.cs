...
{
	sealed class HeaderExitReportStatusGridUserControlTest : TestCaseWithFactory
	{
		...
		public void TestReportTypeDescription()
		{
			CombineAssertions(() =>
			{
		...
		public void TestHeaderExitReportStatusGroupBox()
		{
		...
		{
			base.SetUp();
			userControl = new HeaderExitReportStatusGridUserControl();
		...
		HeaderExitReportStatusGridUserControl userControl;
