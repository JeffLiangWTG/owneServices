namespace Enterprise.Customs.EU.ExitControl.GUI
{
	partial class ConsignmentsGridUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.EU.ExitControl.Business.CusExitConsignment)(null)).CXC_LocalReference)));
			...
			zTextBoxColumnStyleInfo3.ColumnName = "CXC_UniqueConsignmentReference";
			...
			this.ConsignmentsGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(490, 150, true);
