...
sealed class CusExitConsignmentPackageUcc6LookupsTest : BusinessObjectLookupsTestCase
{
	public void TestStatusList() => CombineAssertions(() =>
	{
		var lookups = new CusExitConsignmentPackageUcc6Lookups(Factory.New<CusExitConsignmentPackage>());
