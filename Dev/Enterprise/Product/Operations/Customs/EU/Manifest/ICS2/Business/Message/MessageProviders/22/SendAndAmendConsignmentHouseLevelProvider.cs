...
{
	public class SendAndAmend22ConsignmentHouseLevelProvider :  IConsignmentHouseLevel
	{
		public static SendAndAmend22ConsignmentHouseLevelProvider NewOrNull(AsycudaBill bill) =>
			bill is null ? null : new (bill);

		public SendAndAmend22ConsignmentHouseLevelProvider(AsycudaBill bill)
		{
