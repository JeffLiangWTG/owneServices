...
using CargoWise.Customs.EU.MessageContracts.ICS2.SendAndAmend40;
using CargoWise.EntityFramework;
using Enterprise.Customs.ManifestBase;

namespace Enterprise.Customs.EU.Manifest.ICS2.Business
{
	public class SendAndAmendHeader40Provider : ICS2BaseMessageProvider, ISendAndAmendHeader40
	{
		public SendAndAmendHeader40Provider(AsycudaManifestHeader header)
			: base(header)
		{
