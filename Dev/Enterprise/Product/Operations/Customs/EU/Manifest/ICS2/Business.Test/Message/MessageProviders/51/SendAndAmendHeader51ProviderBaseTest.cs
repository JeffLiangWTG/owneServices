...
{
	abstract class SendAndAmendHeader51ProviderBaseTest<T> : ICS2BaseMessageProviderTest<T> where T : SendAndAmendHeader51Provider
	{
		public void TestConstructor()
		{
			CombineAssertions(() =>
			{
				AssertExceptionThrown<ArgumentException>("ManifestHeader missing", () => new SendAndAmendHeader51Provider(null));
				AssertNoExceptionThrown(() => new SendAndAmendHeader51Provider(manifestHeader));
			});
		}
		...
		public void TestConsignments()
		{
			...
			AssertType<SendAndAmend51ConsignmentHouseLevelProvider>("Consignments provider is not empty and in the correct type.", Provider.Consignments.Single());
		}
