...
{
	sealed class SendAndAmend51GoodsItemProviderTest : DataProviderTestCase<SendAndAmend51GoodsItemProvider>
	{
		...
		public void TestGrossMass()
		{
			...
			AssertEquals("GrossMass", 0.001m, Provider.GrossMass);
		}
		...
		SendAndAmend51GoodsItemProvider GenerateProvider(AsycudaPack pack) => new(pack);
		...
		protected override SendAndAmend51GoodsItemProvider GetProvider()
		{
