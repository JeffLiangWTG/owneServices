...
{
	public class SendAndAmend51GoodsItemProvider : CargoWise.Customs.EU.MessageContracts.ICS2.SendAndAmend51.IGoodsItem
	{
		public SendAndAmend51GoodsItemProvider(AsycudaPack pack)
		{
