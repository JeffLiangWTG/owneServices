...
{
	public class SendAndAmendHeader50Provider : ICS2BaseMessageProvider, ISendAndAmendHeader50
	{
		public SendAndAmendHeader50Provider(AsycudaManifestHeader header) : base(header)
		{
		...
		public IReadOnlyCollection<IConsignmentHouseLevel> Consignments => consignments ??= manifestHeader.Bills.ToArray<AsycudaBill, IConsignmentHouseLevel>(SendAndAmend50ConsignmentHouseLevelProvider.NewOrNull);
