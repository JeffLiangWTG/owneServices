...
[TestedType(typeof(DestinationToRouteEntrySynchroniser))]
sealed class DestinationToRouteEntrySynchroniserTest : TestCaseWithFactory
{
	public void TestSynchronise()
	{
		...
		shipment.JS_RL_NKDestination = "ATSLZ";

		var manifestHeader = Factory.NewWithValidTestData<AsycudaManifestHeader>();
		manifestHeader.SetParent(sourceConsol);
		var itinerary = manifestHeader.Itinerary.AddNew();

		var synchroniser = new DestinationToRouteEntrySynchroniser(itinerary, shipment);
