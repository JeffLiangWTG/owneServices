...
{
	sealed class SendAndAmend26ConsignmentHouseLevelProviderTest : DataProviderTestCase<SendAndAmend26ConsignmentHouseLevelProvider>
	{
		...
		SendAndAmend26ConsignmentHouseLevelProvider GenerateProvider(AsycudaBill bill) => new SendAndAmend26ConsignmentHouseLevelProvider(bill);
		...
		protected sealed override SendAndAmend26ConsignmentHouseLevelProvider GetProvider()
		{
