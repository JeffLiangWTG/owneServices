...
{
	sealed class SendAndAmend13ConsignmentMasterLevelProviderTest : DataProviderTestCase<SendAndAmend13ConsignmentMasterLevelProvider>
	{
		public void TestNewOrNull()
		{
			CombineAssertions(() =>
			{
				AssertNull(SendAndAmend13ConsignmentMasterLevelProvider.NewOrNull(null));
				AssertNotNull(SendAndAmend13ConsignmentMasterLevelProvider.NewOrNull(manifestHeader));
			});
		}
		...
		public void TestCarrier()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("IE", Provider.Carrier.Address.Country);
			});
		}
		...
		public void TestConsignmentHouseLevel()
		{
			...
			AssertType<SendAndAmend13ConsignmentHouseLevelProvider>(Provider.ConsignmentHouseLevel);
		}
		...
		public void TestTransportDocumentMasterLevel()
		{
			...
			manifestHeader.MasterBill.TransportDocumentType = "PDF";
			CombineAssertions(() =>
			{
				...
				AssertEquals("PDF", Provider.TransportDocumentMasterLevel.Type);
			});
		}
		...
		protected override SendAndAmend13ConsignmentMasterLevelProvider GetProvider() => SendAndAmend13ConsignmentMasterLevelProvider.NewOrNull(manifestHeader);
	}
}
