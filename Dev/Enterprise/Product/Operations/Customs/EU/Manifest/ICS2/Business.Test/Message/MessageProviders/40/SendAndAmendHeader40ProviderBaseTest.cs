...
{
	abstract class SendAndAmendHeader40ProviderBaseTest<T> : ICS2BaseMessageProviderTest<T> where T : SendAndAmendHeader40Provider
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentException>(() => new SendAndAmendHeader40Provider(null));
			AssertNoExceptionThrown(() => new SendAndAmendHeader40Provider(manifestHeader));
		}
		...
		public void TestSpecificCircumstanceIndicator()
		{
			...
			AssertEquals(EUICS2SpecificCircumstanceList.Codes.F40, Provider.SpecificCircumstanceIndicator);
		}
