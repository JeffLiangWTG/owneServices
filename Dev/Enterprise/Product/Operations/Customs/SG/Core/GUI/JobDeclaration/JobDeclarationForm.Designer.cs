...
namespace Enterprise.Customs.SG.V4.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			// BottomButtonPanel
			// 
			this.BottomButtonPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 619, true);
			...
			this.DataSourceType = typeof(Enterprise.Customs.SG.V4.Business.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs.SG.V4.Business.JobDeclaration";
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1048, 710, true);
