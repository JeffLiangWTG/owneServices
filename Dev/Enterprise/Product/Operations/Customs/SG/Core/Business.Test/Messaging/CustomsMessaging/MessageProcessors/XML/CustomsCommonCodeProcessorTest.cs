...
{
	sealed class CustomsCommonCodeProcessorTest : BaseResponseSectionProcessorTest
	{
		[TestDate(2020, 6, 4)]
		...
		public void TestProcess()
		{
			...
			var messageText = LoadXmlFile("CustomsCommonCode.xml");
			...
			AssertContains("CLASET", interchanges[0].EI_BodyText);
		}

		protected override MessageProcessor GetMessageProcessor(TradenetResponse tradenetResponse) => new CustomsCommonCodeProcessor(new LoggingInformation(), tradenetResponse.OutboundMessage.CustomsCommonCode);
	}
}
