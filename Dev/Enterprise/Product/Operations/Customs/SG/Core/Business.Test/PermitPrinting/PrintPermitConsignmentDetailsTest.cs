...
{
	[TestedType(typeof(PrintPermitConsignmentDetails))]
	public class PrintPermitConsignmentDetailsTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			...
			return new PrintPermitConsignmentDetails(pmt.Permit.ConsignmentDetails[0], Factory);
		}
	}
}
