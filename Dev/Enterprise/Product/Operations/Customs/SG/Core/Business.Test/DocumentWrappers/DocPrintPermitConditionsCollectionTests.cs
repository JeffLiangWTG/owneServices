...
{
	[TestedType(typeof(DocPrintPermitConditionsCollection))]
	sealed class DocPrintPermitConditionsCollectionTests : NonPersistentBusinessObjectCollectionTestCase<DocPrintPermitConditionsCollection>
	{
		protected override BusinessObject GetNewElementToAddToTheCollection()
		{
			...
			PrintPermitConditions conditions = new PrintPermitConditions(cuspmt.CustomsConditions[0], Factory);
			return DocPrintPermitConditions.New(conditions, Factory);
		}

		protected override DocPrintPermitConditionsCollection GetCollectionToTest()
		{
			return new DocPrintPermitConditionsCollection(Factory);
		}
	}
}
