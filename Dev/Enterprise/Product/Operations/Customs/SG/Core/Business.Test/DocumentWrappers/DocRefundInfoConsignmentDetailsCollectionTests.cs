...
{
	[TestedType(typeof(DocRefundInfoConsignmentDetailsCollection))]
	sealed class DocRefundInfoConsignmentDetailsCollectionTests : NonPersistentBusinessObjectCollectionTestCase<DocRefundInfoConsignmentDetailsCollection>
	{
		protected override BusinessObject GetNewElementToAddToTheCollection()
		{
			...
			RefundInfoConsignmentDetails consignmentDetails = new RefundInfoConsignmentDetails(iptupt.ConsignmentDetails[0], Factory);
			return DocRefundInfoConsignmentDetails.New(consignmentDetails, Factory);
		}

		protected override DocRefundInfoConsignmentDetailsCollection GetCollectionToTest()
		{
			return new DocRefundInfoConsignmentDetailsCollection(Factory);
		}
	}
}
