...
{
	[TestedType(typeof(DocPrintPermitContainersCollection))]
	sealed class DocPrintPermitContainersCollectionTests : NonPersistentBusinessObjectCollectionTestCase<DocPrintPermitContainersCollection>
	{
		protected override BusinessObject GetNewElementToAddToTheCollection()
		{
			...
			PrintPermitContainers containers = new PrintPermitContainers(cuspmt.ContainerIdentifiers[0], Factory);
			return DocPrintPermitContainers.New(containers, Factory);
		}

		protected override DocPrintPermitContainersCollection GetCollectionToTest()
		{
			return new DocPrintPermitContainersCollection(Factory);
		}
	}
}
