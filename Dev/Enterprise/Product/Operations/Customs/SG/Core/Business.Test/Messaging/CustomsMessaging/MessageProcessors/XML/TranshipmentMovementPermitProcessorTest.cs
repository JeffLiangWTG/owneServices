...
{
	sealed class TranshipmentMovementPermitProcessorTest : BasePermitSectionProcessorTest<TranshipmentMovementPermit>
	{
		[DatCapabilityRequirement("SOURCE_CODE")]
		public void TestProcess()
		{
			var applicationReference = "199702247W202005208000";
			var messageText = LoadXmlFile("TNPPMT.xml");
			...
			CombineAssertions(() =>
			{
				var tradeNetOutSection = tradenetResponse.OutboundMessage.TranshipmentMovementPermit;
		...
		protected override MessageProcessor GetMessageProcessor(TradenetResponse tradenetResponse) => new TranshipmentMovementPermitProcessor(new LoggingInformation(), tradenetResponse.OutboundMessage.TranshipmentMovementPermit);
	}
}
