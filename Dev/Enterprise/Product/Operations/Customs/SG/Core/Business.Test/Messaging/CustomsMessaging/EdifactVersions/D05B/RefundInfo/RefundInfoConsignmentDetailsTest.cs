...
{
	[TestedType(typeof(RefundInfoConsignmentDetails))]
	public class RefundInfoConsignmentDetailsTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			...
			RefundInfo pmt = new RefundInfo(iptupt, Factory);
			return new RefundInfoConsignmentDetails(pmt.Refund.ConsignmentDetails[0], Factory);
		}
	}
}
