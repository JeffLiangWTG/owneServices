...
{
	[TestedType(typeof(PrintPermitConditions))]
	public class PrintPermitConditionsTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			...
			return new PrintPermitConditions(((IPrintPermitTN4)pmt.Permit).CustomsConditions[0], Factory);
		}
	}
}
