...
{
	public class Tnpdec09bTest : TestCaseWithFactory
	{
		...
		public void TestCountryOfFinalDestination()
		{
			...
			Assert("This requirement appears to have changed, (refer CS00187631). Message should have Country of Final Dest. even if Place of Storage entered.", msg.LOC.ToString(new UNOASGCharacterSet()).Contains("LOC+36+HK'"));
			ResetMessageBuilder();
		...
		public void TestGenerateEQDAndSELSegments()
		{
			...
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			AssertEquals("EQD+CN+101:1+913:::FCL13'EQD+CN+202:2+517:::LCL77'", msg.EQD.ToString(new UNOASGCharacterSet()));
			AssertEquals("SEL+NA'SEL+SHP1233445'", msg.SEL.ToString(new UNOASGCharacterSet()));
		}

		public void TestGenerateSegmentGroup3ForSeastores()
		{
			...
			AssertMultilineEquals("Group 1 for Seastores with TNP/IGM CPC code", "RFF+ABE:7723000'PAC+++++ZZZ'PCI+ZZZ'FTX+AAX+++12:6'", MessageBuilder.CusdecMessage.Group1[1].ToString(new UNOASGCharacterSet()), '\'');
			AssertMultilineEquals("Group 2 required for Seastores", "PAC+++++ZZZ'PCI+ZZZ'FTX+AAX+++12:6'", MessageBuilder.CusdecMessage.Group1[1].Group2[0].ToString(new UNOASGCharacterSet()), '\'');
			AssertMultilineEquals("Group 3 required for Seastores", "PCI+ZZZ'FTX+AAX+++12:6'", MessageBuilder.CusdecMessage.Group1[1].Group2[0].Group3[0].ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup5()
		{
			...
			DataProvider.OutwardTransportCode = SGConstants.TransportCodes.Sea;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			AssertEquals("DOC+704+77777'DOC+741+5555'DOC+916+001::ATTDOC_0001'DOC+916+002::ATTDOC_0002'", msg.Group5.ToString(new UNOASGCharacterSet()));
			DataProvider.InwardMasterBill = "77777";
			DataProvider.InwardTransportCode = SGConstants.TransportCodes.Sea;
			DataProvider.OutwardMasterBill = "5555";
			DataProvider.OutwardTransportCode = SGConstants.TransportCodes.Air;
		...
		public void TestGenerateSegmentGroup6()
		{
			...
			DataProvider.HasOutwardTransport = true;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("TNPDEC SG6", "NAD+AE+AAA374M++EAGLE DATAMATION INTERNATIONAL:::::1'NAD+DT'CTA+IC+DEC0012SA:DECLARER'COM+322223:TE'NAD+CG+1235552223B++INWARD CARRIER:::::1'NAD+CA+4321567891C++OUTWARD CARRIER:::::1'NAD+IM+1234567890C++IMPORTER ORGANISATION:::::2'NAD+AH+2224567890D++HANDLING AGENT:::::1'NAD+UC+++CONSIGNEE NAME:::::1+ADDRESS, ADDRESS, POSTCODE'NAD+CN+++CONSIGNEE NAME:::::2+ADDRESS, ADDRESS, POSTCODE'NAD+FW+1234567890J++FORWARDER ORG:::::1'NAD+BB'RFF+DAN:I'", msg.Group6.ToString(new UNOASGCharacterSet()), '\'');
			DataProvider.DeclarationType = DeclarationTypeCodeList.Codes.IGM;
			DataProvider.BGIndicator = "D";
			ResetMessageBuilder();
			msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("TNPDEC SG6", "NAD+AE+AAA374M++EAGLE DATAMATION INTERNATIONAL:::::1'NAD+DT'CTA+IC+DEC0012SA:DECLARER'COM+322223:TE'NAD+CG+1235552223B++INWARD CARRIER:::::1'NAD+CA+4321567891C++OUTWARD CARRIER:::::1'NAD+IM+1234567890C++IMPORTER ORGANISATION:::::2'NAD+AH+2224567890D++HANDLING AGENT:::::1'NAD+UC+++CONSIGNEE NAME:::::1+ADDRESS, ADDRESS, POSTCODE'NAD+CN+++CONSIGNEE NAME:::::2+ADDRESS, ADDRESS, POSTCODE'NAD+FW+1234567890J++FORWARDER ORG:::::1'NAD+BB'RFF+DAN:D'", msg.Group6.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup32_LineDetailSegments()
		{
			...
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			ZString str1 = "CST+1+01011000'FTX+AAA+++MISC THINGS'FTX+PRD+++SONIC:SRFT123FG'FTX+AAC+++Y'LOC+27+AU'LOC+18+AA7'LOC+281+BB3'MEA+AAF++KGM:5.0000'MEA+AAE++KGM:13.0000'MEA+AAG++PER:40.000'MEA+AAI++KGM:2.0000'MEA+ABA++KGM:2.0000'PAC+12+3+CRT'PAC+256+2+BOX'PAC+24+1+CTN'PAC+40+5+STK'PCI+19+Y'MOA+63:0.00'RFF+AEA:CS00001'DOC+703+IN-HAWB'DOC+714+OUT-HAWB'";
			AssertMultilineEquals("Group 30", str1, msg.Group32.ToString(new UNOASGCharacterSet()), '\'');
			ResetMessageBuilder();
			DataProvider.DeclarationType = DeclarationTypeCodeList.Codes.TTI;
			ZString str2 = "CST+1+01011000'FTX+AAA+++MISC THINGS'FTX+PRD+++SONIC:SRFT123FG'FTX+AAC+++Y'LOC+27+AU'LOC+18+AA7'LOC+281+BB3'MEA+AAF++KGM:5.0000'MEA+AAE++KGM:13.0000'MEA+AAG++PER:40.000'MEA+AAI++KGM:2.0000'MEA+ABA++KGM:2.0000'PAC+12+3+CRT'PAC+256+2+BOX'PAC+24+1+CTN'PAC+40+5+STK'PCI+19+Y'RFF+AEA:CS00001'DOC+704+MAW1'DOC+741+MAW2'DOC+703+IN-HAWB'DOC+714+OUT-HAWB'";
			msg = MessageBuilder.CusdecMessage;
			...
			DataProvider.IsStoredInLicensedPremise = true;
			ZString str3 = "CST+1+01011000'FTX+AAA+++MISC THINGS'FTX+PRD+++SONIC:SRFT123FG'FTX+AAC+++Y'LOC+27+AU'LOC+18+AA7'LOC+281+BB3'MEA+AAF++KGM:5.0000'MEA+AAE++KGM:13.0000'MEA+AAG++PER:40.000'MEA+AAI++KGM:2.0000'MEA+ABA++KGM:2.0000'PAC+12+3+CRT'PAC+256+2+BOX'PAC+24+1+CTN'PAC+40+5+STK'PCI+19+Y'RFF+AEA:CS00001'DOC+703+IN-HAWB'";
			msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("", str3, msg.Group32.ToString(new UNOASGCharacterSet()), '\'');
			ResetMessageBuilder();
			DataProvider.IsSeaStoreDeclaration = true;
			DataProvider.NumberOfCrew = 15;
			DataProvider.VoyageDuration = 22;
			msg = MessageBuilder.CusdecMessage;
			ZString str5 = "CST+1+01011000'FTX+AAA+++MISC THINGS'FTX+PRD+++SONIC:SRFT123FG'FTX+AAC+++Y'LOC+27+AU'LOC+18+AA7'LOC+281+BB3'MEA+AAF++KGM:5.0000'MEA+AAE++KGM:13.0000'MEA+AAG++PER:40.000'MEA+AAI++KGM:2.0000'MEA+ABA++KGM:2.0000'PAC+12+3+CRT'PAC+256+2+BOX'PAC+24+1+CTN'PAC+40+5+STK'PCI+19+Y'RFF+AEA:CS00001'DOC+703+IN-HAWB'";
			AssertMultilineEquals("", str5, msg.Group32.ToString(new UNOASGCharacterSet()), '\'');
			DataProvider.IsSeaStoreDeclaration = false;
			ResetMessageBuilder();
			DataProvider.DeclarationType = "BRE";
			DataProvider.OutwardTransportCode = SGConstants.TransportCodes.Sea;
			...
			DataProvider.Items = items;
			ZString str4 = "CST+1+01011000'FTX+AAA+++MISC THINGS'FTX+PRD+++SONIC:SRFT123FG'FTX+AAC+++Y'LOC+27+AU'LOC+18+AA7'LOC+281+BB3'MEA+AAF++KGM:5.0000'MEA+AAE++KGM:13.0000'MEA+AAG++PER:40.000'MEA+AAI++KGM:2.0000'MEA+ABA++KGM:2.0000'PAC+12+3+CRT'PAC+256+2+BOX'PAC+24+1+CTN'PAC+40+5+STK'PCI+19+Y'MOA+63:0.00'RFF+AEA:CS00001'GIN+AV+CS11111+CS22222+CS33333'GIN+AV+444444+555555+666666'RFF+SE'IMD++8+:::1600.00:CC'DOC+703+IN-HAWB'DOC+714+OUT-HAWB'";
			msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("Motor Vehicles", str4, msg.Group32.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup37()
		{
			...
			DataProvider.Items = items;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			ZString resultExpected = "RFF+AEA:PRODCODE_00001'GIN+AV+JKUE903JRM3499EMDFJF93EIKR30RFF+V83945030EIF9GT8D903KDFMRK93IK'RFF+SE'IMD++8+:::4800.00:CC'RFF+AEA:XY09348TFZ'GIN+AV+NMU+GOV+NMD'IMD++5+:::COMMERCIAL APPLICATION'";
			AssertMultilineEquals("Group 37 - Strategic / Seastores / Motor Vehicle", resultExpected, msg.Group32[0].Group37.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup37Strategic()
		{
			...
			DataProvider.Items = items;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			ZString resultExpected = "RFF+AEA:XY09348TFZ'GIN+AV+NMU+NGU+NMD'IMD++5+:::COMMERCIAL AIRCRAFT SPARES";
			AssertMultilineEquals("Group 37 - Strategic Goods", resultExpected, msg.Group32[0].Group37.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup37NoProductCode()
		{
			...
			DataProvider.Items = items;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("Group 35 - Chemical Concentration limit", "RFF+AVM'GIN+AV+5+50'", msg.Group32[0].Group37.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		public void TestGenerateSegmentGroup37NoProductCodeButOtherG37()
		{
			...
			DataProvider.VoyageDuration = 15;
			CUSDECMessage msg = MessageBuilder.CusdecMessage;
			AssertMultilineEquals("Group 37 - No Product code but with other CASC values & Seastores", "RFF+AVM'GIN+AV+5+50'", msg.Group32[0].Group37.ToString(new UNOASGCharacterSet()), '\'');
		}
		...
		Tnpdec09b MessageBuilder
		{
			get
			{
				if (fMessageBuilder == null)
				{
					fMessageBuilder = new Tnpdec09b(DataProvider);
				}
