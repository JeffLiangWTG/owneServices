...
namespace Enterprise.Customs.SG.Access.Business.Testing
{
	...
	sealed class AsycudaEDIMessageTest : ASYCUDA.Business.Testing.AsycudaEDIMessageTest
	{
		public override void TestEM_MessageInterpretation()
		{
			...
			var messageTextMFA = string.Format(ValidMessageText, "MFA");
			...
			AssertEquals("EM_MessageInterpretation should be original EM_MessageText", messageTextMFA, message.EM_MessageInterpretation);
			AssertNostmNote(message);
			var messageTextAEP = string.Format(ValidMessageText, "AEP");
		...
		public override void TestEM_MessageInterpretation_ErrorDescription()
		{
			var header = (AsycudaManifestHeader)Factory.New<Integration.Customs.ASYCUDA.SGAccess.IAsycudaManifestHeader>();
			var mrrLog = header.Logs.AddNew(Events.MessageReceived);
			var message = Factory.New<AsycudaEDIMessage>();
			...
			var formattedHtml = ExpectedHTMLErr.Replace("\r\n", "");
			AssertMultilineASCIIEquals("EM_MessageInterpretation", formattedHtml, message.EM_MessageInterpretation);
			...
			AssertNotNull(stmNote);
			AssertMultilineASCIIEquals("ST_NoteText", formattedHtml, stmNote.ST_NoteText);
		}

		public override void TestEM_MessageInterpretation_ErrorDescription_WithCommentary()
		{
			...
			var code = helper.CreateNewOrGetExistingCusCodeList(Core.Constants.CountryCodes.Singapore, Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.GlobalManifestErrorCommentary, "R01", ErrorCommentaryText, ZDateTime.Today.AddDays(-1), ZDateTime.Today.AddDays(1));
			Factory.Save();
			var header = (AsycudaManifestHeader)Factory.New<Integration.Customs.ASYCUDA.SGAccess.IAsycudaManifestHeader>();
			var mrrLog = header.Logs.AddNew(Events.MessageReceived);
			var message = Factory.New<AsycudaEDIMessage>();
			...
			message.EM_ReceiveTransmit = EDIInterchange.Direction.Receive;
			message.EM_MessageText = MessageTextErr;
			AssertContains("", ErrorCommentaryText, message.EM_MessageInterpretation);
			var formattedHtml = string.Format(ExpectedHTMLErrWithCommentary.Replace("\r\n", ""), ErrorCommentaryText);
			AssertMultilineASCIIEquals("EM_MessageInterpretation", formattedHtml, message.EM_MessageInterpretation);
			var query = new ZQuery(StmNoteSchema.ST_ParentID, message.PK);
			query.AddToFilter(StmNoteSchema.ST_Table, EDIMessageSchema.Constants.TableName);
			query.AddToFilter(StmNoteSchema.ST_Description, "Message Interpretation");
		...
		const string MessageTextErr = @"<UniversalEvent version=""2.0"" xmlns=""http://www.cargowise.com/Schemas/Universal/2012/11"">
      <Event>
        <DataContext>
          <Workflow>
...
";
		...
		const string ExpectedHTMLErr = @"<table border=""1"" cellpadding=""1"" cellspacing=""0"" class=""table"">
<tr><td colspan=""7"" font-weight=""bold"" align=""center"">Response Details</td></tr>
<tr><td colspan=""7"" align=""center"">A response message has been received from Customs.<br />The message type is:  ERR – AIRERR SG ACCESS</td></tr><tr><td colspan=""2"" font-weight=""bold"">Job Number</td><td colspan=""5"">MAN0000003</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Manifest Country</td><td colspan=""5"">SG</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Original Interchange Number</td><td colspan=""5"">6183</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">UEN Number</td><td colspan=""5"">198801949D</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Original Create Date</td><td colspan=""5"">20180118</td></tr><tr><td colspan=""2"" font-weight=""bold"">Original Serial Number</td><td colspan=""5"">2125</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Batch Date</td><td colspan=""5"">&nbsp;</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Master Bill</td><td colspan=""3"">6726767267</td><td colspan=""2"">ERR</td></tr>
<tr></tr><tr><td colspan=""2"" font-weight=""bold"">House Bill</td><td colspan=""2"">BADBILL</td><td colspan=""2"">ERR</td><td>&nbsp;</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Consignment</td><td colspan=""5"">00003</td></tr>
<tr><td>ERR</td><td>R01</td><td>COUNTRY CODE/ORIGIN OF GOODS IS INVALID</td><td>2</td><td>2</td><td>14</td><td>CTY</td></tr>
<tr></tr><tr><td colspan=""2"" font-weight=""bold"">House Bill</td><td colspan=""2"">BADBILL</td><td colspan=""2"">ERR</td><td>&nbsp;</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Consignment</td><td colspan=""5"">00005</td></tr>
<tr><td>ERR</td><td>R01</td><td>COUNTRY CODE/ORIGIN OF GOODS IS INVALID</td><td>2</td><td>4</td><td>14</td><td>CTY</td></tr>
</table>";

		const string ExpectedHTMLErrWithCommentary = @"<table border=""1"" cellpadding=""1"" cellspacing=""0"" class=""table"">
<tr><td colspan=""7"" font-weight=""bold"" align=""center"">Response Details</td></tr>
<tr><td colspan=""7"" align=""center"">A response message has been received from Customs.<br />The message type is:  ERR – AIRERR SG ACCESS</td></tr><tr><td colspan=""2"" font-weight=""bold"">Job Number</td><td colspan=""5"">MAN0000003</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Manifest Country</td><td colspan=""5"">SG</td></tr>
<tr><td colspan=""2"" font-weight=""bold"">Original Interchange Number</td><td colspan=""5"">6183</td></tr>
