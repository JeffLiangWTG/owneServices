...
namespace Enterprise.Customs.IE.ExitControl.Business.Testing
{
	...
	class DocumentsSendingActionCollectionTest : NonPersistentBusinessObjectCollectionTestCase<DocumentsSendingActionCollection>
	{
		...
		protected override DocumentsSendingActionCollection GetCollectionToTest()
			=> (DocumentsSendingActionCollection)new DocumentsSendingActionParent(cusExitReport, AESOutgoingMessageTypeList.Codes.DocumentUpload).SendingObjectsCollection;
