...
{
	sealed class ConsignmentItemUserControlDetailsTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			userControl = new ConsignmentItemUserControlDetails();
		}
		...
		ConsignmentItemUserControlDetails userControl;
	}
}
