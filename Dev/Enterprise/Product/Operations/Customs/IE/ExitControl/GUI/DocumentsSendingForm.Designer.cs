namespace Enterprise.Customs.IE.ExitControl.GUI
{
	partial class DocumentsSendingForm
	{
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent);
			// 
			// LrnTextBox
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).LocalReference)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).MovementReference)));
			...
			// 
			this.SupportingDocumentsGroupBox.CaptionResourceString = Enterprise.Customs.IE.ExitControl.GUI.Res.GetData("5F7B29A9-2BE8-4FAA-9816-D2EFD83BF161", "Supporting Documents");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).SupportingDocuments)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Customs.IE.ExitControl.Business.DocumentSendingObject)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).SupportingDocuments)).SyncRoot)).EDoc)));
			...
			// 
			this.AdditionalInformationsGroupBox.CaptionResourceString = Enterprise.Customs.IE.ExitControl.GUI.Res.GetData("4A17B25D-1F66-4255-8AEF-355926AB37C9", "Additional Information");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).AddInfoCollection)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.IE.ExitControl.Business.AdditionalInfoSendingObject)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).AddInfoCollection)).SyncRoot)).DocumentType)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.IE.ExitControl.Business.AdditionalInfoSendingObject)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingAction)(((System.Collections.IList)(((Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).AddInfoCollection)).SyncRoot)).DocumentInformation)));
			...
			this.DataSourceType = typeof(Enterprise.Customs.IE.ExitControl.Business.DocumentsSendingActionParent);
