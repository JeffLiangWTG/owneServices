...
namespace Enterprise.Customs.IE.H7.GUI.Testing
{
	...
	sealed class CusGoodsLocationLayoutTest : LayoutsAbstractTest
	{
		...
		{
			CusGoodsLocationLayoutAssertions.AssertControlVisibleForCertainQualifiers(layout, CusGoodsLocationControlBag.Instance.AdditionalIdentifierTextBox, cusGoodsLocation,
