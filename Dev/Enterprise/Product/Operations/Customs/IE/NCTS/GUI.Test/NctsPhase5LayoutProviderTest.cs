...
namespace Enterprise.Customs.IE.NCTS.GUI.Testing
{
	...
	sealed class NctsPhase5LayoutProviderTest : EU.NCTS.GUI.Testing.NctsPhase5LayoutProviderAbstractTest
	{
		...
		protected override IEnumerable<ITabPage> ExpectedAdditionalDeclarationDetailTabPages
		{
			get
			{
		...
		protected override IEnumerable<string> ExpectedReorderDeclarationDetailTabPageNames => DefaultDeclarationDetailTabPagesNames.Concat(new[] { nameof(EU.NCTS.GUI.DocumentsRequestedTabPage) });
		...
		protected override Type ExpectedMessageSendingGridColumnLayout => typeof(Phase5MessageSendingGridColumnLayout);
