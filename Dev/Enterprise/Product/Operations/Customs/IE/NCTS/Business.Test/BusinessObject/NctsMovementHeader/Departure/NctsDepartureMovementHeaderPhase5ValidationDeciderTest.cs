...
namespace Enterprise.Customs.IE.NCTS.Business.Testing
{
	sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
	{
		...
		{
			AssertEquals(true, validationDecider.IsRuleBR5410Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleC0343_2Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleC0710Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleR902Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleR0990Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleR0601_1Active);
		}
