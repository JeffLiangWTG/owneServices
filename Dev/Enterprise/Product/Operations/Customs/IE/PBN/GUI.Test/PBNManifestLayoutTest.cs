...
{
	[TestedType(typeof(PBNManifestLayout))]
	class PBNManifestLayoutTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (PBNManifestControlBag.Instance.IsEmptyVehicleCheckBox, ControlWidthClass.Medium);
		...
		IEnumerable<(ControlReference, ControlWidthClass)> SecondColumnControls
		{
			get
			{
				...
				yield return (PBNManifestControlBag.Instance.CarrierCodeDropEdit, ControlWidthClass.Long);
				yield return (PBNManifestControlBag.Instance.CustomsReferencesGroupBox, ControlWidthClass.LongNoCaption);
				yield return (PBNManifestControlBag.Instance.TransitReferencesGroupBox, ControlWidthClass.LongNoCaption);
			}
		}
		...
		IEnumerable<(ControlReference, ControlWidthClass)> ThirdColumnControls
		{
			get
			{
				yield return (PBNManifestControlBag.Instance.PersonsGroupBox, ControlWidthClass.LongNoCaption);
			}
		}

		protected override int ControlBagCount => 2;

		protected override ICommonLayoutBuilder CommonLayoutBuilder => new PBNManifestLayoutBuilder<AsycudaManifestHeader>();
	}
}
