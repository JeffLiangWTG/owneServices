...
{
	sealed class InvoiceLineLayoutSupportingDocumentsFieldsControlTest : TestCaseWithFactory
	{
		public void TestSetCaption()
		{
			...
			using var control = new InvoiceLineLayoutSupportingDocumentsFieldsControlForTesting(declaration);
	...
	sealed class InvoiceLineLayoutSupportingDocumentsFieldsControlForTesting : InvoiceLineLayoutSupportingDocumentsFieldsControl
	{
		public InvoiceLineLayoutSupportingDocumentsFieldsControlForTesting(JobDeclaration declaration)
			: base(declaration)
		{
		}
