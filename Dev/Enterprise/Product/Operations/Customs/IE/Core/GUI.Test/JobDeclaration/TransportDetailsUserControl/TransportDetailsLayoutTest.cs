	...
	sealed class TransportDetailsLayoutTest : LayoutsAbstractTest
	{
		...
		static IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (EU.GUI.TransportDetailsControlBag.Instance.TransportIDAndNationalityUserControl, ControlWidthClass.Auto);
				yield return (EU.GUI.TransportDetailsControlBag.Instance.TransportIDAndNationalityRailUserControl, ControlWidthClass.Auto);
				yield return (EU.GUI.TransportDetailsControlBag.Instance.TransportIDAndNationalityInlandWaterwayUserControl, ControlWidthClass.Auto);
				yield return (EU.GUI.TransportDetailsControlBag.Instance.TransportIDAndNationalityInlandWaterwayENIUserControl, ControlWidthClass.Auto);
				yield return (EU.GUI.TransportDetailsControlBag.Instance.FlightAndNationalityUserControl, ControlWidthClass.Auto);
				yield return (EU.GUI.TransportDetailsControlBag.Instance.AircraftRegistrationNumberTextBox, ControlWidthClass.Auto);
