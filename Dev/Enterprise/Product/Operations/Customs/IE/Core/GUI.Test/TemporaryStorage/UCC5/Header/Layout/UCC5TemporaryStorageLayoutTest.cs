...
{
	[TestedType(typeof(UCC5TemporaryStorageLayout))]
	public class UCC5TemporaryStorageLayoutTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (IEInstance.BorderTransportTypeDropEdit, ControlWidthClass.Long);
				yield return (IEInstance.BorderTransportIDTextBox, ControlWidthClass.Long);
				...
				yield return (IEInstance.RepresentativeStatusDropEdit, ControlWidthClass.Long);
				...
				yield return (IEInstance.CustomsOfficeOfFirstEntryCodeFindBox, ControlWidthClass.Long);
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new UCC5TemporaryStorageLayoutBuilder();
	}
}
