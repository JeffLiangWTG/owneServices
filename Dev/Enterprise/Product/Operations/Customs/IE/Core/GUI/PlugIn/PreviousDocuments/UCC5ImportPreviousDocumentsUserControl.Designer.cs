...
{
	partial class UCC5ImportPreviousDocumentsUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// PrevDocsGroupBox
			// 
			this.PrevDocsGroupBox.CaptionResourceString = Enterprise.Customs.IE.GUI.Res.GetData("169C957D-23B4-4FB8-B8C6-2ABA9D971BD2", "Previous Document");
			// 
			// UCC5ImportPreviousDocumentsUserControl
			// 
			this.Name = "UCC5ImportPreviousDocumentsUserControl";
