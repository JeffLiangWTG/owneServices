...
namespace Enterprise.Customs.IE.GUI
{
	partial class ConfirmSendForm
	{
		...
		private new void InitializeComponent()
		{
			...
			this.ReasonTextBox.CaptionResourceString = Enterprise.Customs.IE.GUI.Res.GetData("18436AFB-A9FD-4987-9218-A7232C28BC1B", "Reason");
			...
			this.OKButton.CaptionResourceString = Enterprise.Customs.IE.GUI.Res.GetData("FC709E7F-A953-4960-81BC-B64E568CCEA6", "OK");
			...
			this.ZCancelButton.CaptionResourceString = Enterprise.Customs.IE.GUI.Res.GetData("73B3F98C-D408-4EC0-AD3F-5E0DED6E7DD8", "Cancel");
			...
			this.CaptionResourceString = Enterprise.Customs.IE.GUI.Res.GetData("D79AFB6F-76F9-4CE1-9ECC-676988AD01CD", "Warning - Continue submitting?");
