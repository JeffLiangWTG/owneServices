...
namespace Enterprise.Customs.IE.Business.AIS
{
	public class GoodsLocationProvider : IGoodsLocation
	{
		...
		public string AuthorisationNumber => null; //TODO: bind to CGL_Authorisation when available.
		...
		public string CustomsOffice => customsOffice ?? (customsOffice = goodsLocation.CGL_Qualifier == Customs.Business.CusGoodsLocationQualifierList.Codes.CustomsOfficeIdentifier ? goodsLocation.CGL_AdditionalIdentifier.ToString() : string.Empty);
