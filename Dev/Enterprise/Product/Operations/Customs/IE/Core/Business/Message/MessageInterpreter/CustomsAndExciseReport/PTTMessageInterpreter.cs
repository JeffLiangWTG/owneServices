...
{
	public class PTTMessageInterpreter : BaseInboundMessageInterpreter<PTTProvider>
	{
		public PTTMessageInterpreter(CustomsAndExciseReportInboundMessage message, PTTProvider messageProvider) : base(message, messageProvider)
		{
		}

		protected override string Summary => CommonResStrings.PTTMessageFriendlyName;
