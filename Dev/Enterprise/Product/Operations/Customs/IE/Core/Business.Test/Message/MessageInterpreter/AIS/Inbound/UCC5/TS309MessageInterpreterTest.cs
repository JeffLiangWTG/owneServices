...
using TS309Provider = Enterprise.Customs.IE.Messaging.UCC5.TS309Provider;

namespace Enterprise.Customs.IE.Business.AIS.UCC5.Testing
{
	[TestedType(typeof(TS309MessageInterpreter))]
	sealed class TS309MessageInterpreterTest : InboundMessageInterpreterAbstractTest<AISUCC5InboundEDIMessage, TS309MessageInterpreter, TS309Provider>
	{
		...
		protected override AISUCC5InboundEDIMessage CreateIncomingMessageToTest()
		{
			...
			return AISInterchangeProcessorTestHelper.GetAISMailboxMessage<AISUCC5InboundEDIMessage>(Factory, messageText: AISUCC5InterchangeProcessorTestHelper.GetTS309Text("21IEDUB11A782454R2", new DateTime(2023, 9, 5, 12, 30, 30)));
		}

		protected override ZString GetExpectedInterpretation(AISUCC5InboundEDIMessage message) => @"A Temporary Storage Declaration Invalidation Decision (TS309) message has been received for TSD B00001000.<br />
