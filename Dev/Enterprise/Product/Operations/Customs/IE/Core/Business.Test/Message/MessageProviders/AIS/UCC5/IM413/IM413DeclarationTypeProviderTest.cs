...
{
	class IM413DeclarationTypeProviderTest : DataProviderTestCase<IM413DeclarationTypeProvider>
	{
		public void TestMRN()
		{
			SetUpTestData();
		...
		public void TestRemarks()
		{
			...
			AssertEquals("Remarks", "TestDetailsAmended", Provider.Remarks);
		}
		...
		protected override IM413DeclarationTypeProvider GetProvider()
		{
			SetUpTestData();
			return new IM413DeclarationTypeProvider(new EntryHeaderWrapper(entryHeader));
		}
