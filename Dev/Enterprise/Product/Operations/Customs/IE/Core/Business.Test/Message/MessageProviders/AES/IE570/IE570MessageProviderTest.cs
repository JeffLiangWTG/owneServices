...
{
	class IE570MessageProviderTest : Customs.Business.Testing.DataProviderTestCase<IE570MessageProvider>
	{
		...
		protected override IE570MessageProvider GetProvider() => new IE570MessageProvider(entryHeader);
