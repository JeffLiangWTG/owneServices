...
{
	[TestedType(typeof(IM447MessageInterpreter))]
	class IM447MessageInterpreterTest : InboundMessageInterpreterAbstractTest<AISInboundEDIMessage, IM447MessageInterpreter, IM447Provider>
	{
		...
		protected override AISInboundEDIMessage CreateIncomingMessageToTest()
		{
			...
			return AISInterchangeProcessorTestHelper.GetAISMailboxMessage(Factory, "B00000012", @"<q1:IM447 xmlns:q1=""http://www.ros.ie/schemas/customs"">
  <ImportOperation>
    <LRN>LRN001</LRN>
  ...
  <ControlResult>
    ...
    <SupportingDocumentsProvided>0</SupportingDocumentsProvided>
  </ControlResult>
  <ControlResults>
  ...
  <ControlResults>
    ...
    <ResultsOfControl>
      ...
      <ControlDetails>
		...
		protected override ZString GetExpectedInterpretation(AISInboundEDIMessage message) => @"A Documentary Control Result (IM447) message has been received for Job B00000012.<br />
