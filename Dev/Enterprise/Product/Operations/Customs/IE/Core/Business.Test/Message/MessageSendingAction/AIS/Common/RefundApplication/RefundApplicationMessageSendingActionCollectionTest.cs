...
{
	[TestedType(typeof(RefundApplicationMessageSendingActionCollection))]
	class RefundApplicationMessageSendingActionCollectionTest : NonPersistentBusinessObjectCollectionTestCase<RefundApplicationMessageSendingActionCollection>
	{
		...
		protected override RefundApplicationMessageSendingActionCollection GetCollectionToTest()
		=> (RefundApplicationMessageSendingActionCollection)new RefundApplicationMessageSendingActionParent(testBizObjs.entryHeaderWrapper.Declaration).SendingObjectsCollection;
