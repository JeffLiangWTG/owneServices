...
namespace Enterprise.Customs.IE.Business.AIS.UCC5.Testing
{
	...
	sealed class TS304ProcessorTest : TemporaryStorageHeaderMessageProcessorTest<TS304Processor, AISUCC5InboundEDIMessage, AISUCC5OutboundEDIMessage, Messaging.UCC5.TS304Provider>
	{
		protected override void AssertProcessResultCore(TemporaryStorageHeader temporaryStorageHeader, AISUCC5InboundEDIMessage incomingMessage)
		{
		...
		protected override ZString MessageText => AISUCC5InterchangeProcessorTestHelper.GetTS304Text("21IEDUB11A782454R2", new DateTime(2023, 9, 5, 12, 15, 30), "Test Remarks");
	}
}
