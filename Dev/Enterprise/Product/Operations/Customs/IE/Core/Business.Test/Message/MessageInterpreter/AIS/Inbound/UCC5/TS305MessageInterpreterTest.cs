...
using TS305Provider = Enterprise.Customs.IE.Messaging.UCC5.TS305Provider;

namespace Enterprise.Customs.IE.Business.AIS.UCC5.Testing
{
	[TestedType(typeof(TS305MessageInterpreter))]
	sealed class TS305MessageInterpreterTest : InboundMessageInterpreterAbstractTest<AISUCC5InboundEDIMessage, TS305MessageInterpreter, TS305Provider>
	{
		...
		protected override AISUCC5InboundEDIMessage CreateIncomingMessageToTest()
		{
			...
			return AISInterchangeProcessorTestHelper.GetAISMailboxMessage<AISUCC5InboundEDIMessage>(Factory, messageText: AISUCC5InterchangeProcessorTestHelper.GetTS305Text("21IEDUB11A782454R2", new DateTime(2023, 9, 5, 12, 30, 30), "Test Reason"));
		}

		protected override ZString GetExpectedInterpretation(AISUCC5InboundEDIMessage message) => @"An Amendment Request Rejection (TS305) message has been received for TSD B00001000.<br />
