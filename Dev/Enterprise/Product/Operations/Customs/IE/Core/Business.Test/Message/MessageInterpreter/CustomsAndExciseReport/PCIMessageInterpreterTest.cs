...
{
	[TestedType(typeof(PCIMessageInterpreter))]
	sealed class PCIMessageInterpreterTest : CustomsAndExciseReportInboundMessageInterpreterTest<PCIMessageInterpreter, PCIProvider>
	{
		protected override ZString MessageType => CustomsAndExciseReportTypeList.Codes.PCI;

		protected override PCIProvider GetProvider(TextReader reader) => new PCIProvider(CustomsAndExciseReportInterchangeProcessorTestHelper.CreatePCIMessage());

		protected override ZString ExpectedInterpretation => GetExpectedInterpretation();

		internal static ZString GetExpectedInterpretation() => @"Period (monthly) details – combined taxes report for Importers<br />
			<br />
			...
			<table border=""1"" cellpadding=""1"" cellspacing=""0"" class=""table"">
				...
				<tr><td>Payer Name</td><td>MR Test ONeill</td></tr>
