...
namespace Enterprise.Customs.IE.EMCS.GUI.Testing
{
	sealed class DeclarationOrganizationsUserControlTest : TestCase
	{
		...
		public void TestCertificateIdentifierDropEdit()
		{
			CombineAssertions(() =>
			{
				var certificateIdentifierDropEdit = control.CertificateIdentifierDropEdit;
				...
				AssertEquals("ShowInDropDown", ZDropEdit.ShowInDropDownList.OnlyShowCode, certificateIdentifierDropEdit.ShowInDropDown);
		...
		public void TestCertificateIdentifierGroupBox()
		{
			CombineAssertions(() =>
			{
				...
				Assert("GroupBox contains CertificateIdentifierDropEdit", certificateIdentifierGroupBox.Controls.Contains(control.CertificateIdentifierDropEdit));
