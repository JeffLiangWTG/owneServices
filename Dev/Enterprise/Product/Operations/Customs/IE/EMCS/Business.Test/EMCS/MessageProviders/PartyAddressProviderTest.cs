...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	sealed class PartyAddressProviderTest : Customs.Business.Testing.DataProviderTestCase<PartyAddressProvider>
	{
		...
		public void TestStreetAndNumber()
		{
			...
			AssertEquals("Street Name", "12 MITCHELL STPART2", partyAddressProvider.StreetAndNumber);
		}
		...
		public void TestAddressOverride()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("Street Name", "23 CROWN STPART2OV", partyAddressWrapper.StreetAndNumber);
