...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	...
	{
		protected override ZString MessageType => EMCSIncomingMessageTypeList.Codes.IE818;

		protected override ZString MessageFriendlyName => "EMCS IE818 Message Processor";
		...
		protected override void AssertProcessResult(EMCSJobDeclaration declaration, EMCSInboundEDIMessage incomingMessage)
		{
			...
			MessageProcessorNotificationTestHelper.AssertEmail(
				"EMCS Report of Receipt",
				new[] { "Your EMCS Declaration for Job E00000810 received a report of receipt. For details please follow the link to the Job." },
