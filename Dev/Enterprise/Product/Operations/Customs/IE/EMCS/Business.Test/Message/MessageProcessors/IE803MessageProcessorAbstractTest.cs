...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	...
	{
		protected override ZString MessageType => EMCSIncomingMessageTypeList.Codes.IE803;

		protected override ZString MessageFriendlyName => "EMCS IE803 Message Processor";
		...
		protected override void AssertProcessResult(EMCSJobDeclaration declaration, EMCSInboundEDIMessage incomingMessage)
		{
			...
			MessageProcessorNotificationTestHelper.AssertEmail(
				"EMCS Notification of diverted e-AD",
				new[] { "Your EMCS Declaration for Job E00000810 received a notification of diverted e-AD. For details please follow the link to the Job." },
