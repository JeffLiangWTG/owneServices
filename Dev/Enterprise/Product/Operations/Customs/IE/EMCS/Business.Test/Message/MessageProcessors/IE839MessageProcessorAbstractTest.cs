...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	...
	{
		protected override ZString MessageType => EMCSIncomingMessageTypeList.Codes.IE839;

		protected override ZString MessageFriendlyName => "EMCS IE839 Message Processor";
		...
		protected override void AssertProcessResult(EMCSJobDeclaration declaration, EMCSInboundEDIMessage incomingMessage)
		{
			...
			MessageProcessorNotificationTestHelper.AssertEmail(
				"EMCS e-AD rejected",
				new[] { "Your EMCS Declaration for Job E00000810 was rejected by customs. For details please follow the link to the Job." },
		...
		public void TestEndToEndProcessing_WhenMultipleDeclarationsAreMatched()
		{
			...
			using (incomingMessage.Factory.AddDisposableService())
			{
				...
				CombineAssertions("Process", () =>
				{
					...
					MessageProcessorNotificationTestHelper.AssertEmail(
						"EMCS e-AD rejected Response for E00000810",
						new[] { "Your EMCS Declaration for Job E00000810 was rejected by customs. For details please follow the link to the Job." },
						new string[] { "staff1@where.com" });
					MessageProcessorNotificationTestHelper.AssertEmail(
						"EMCS e-AD rejected Response for E00000811",
						new[] { "Your EMCS Declaration for Job E00000811 was rejected by customs. For details please follow the link to the Job." },
						new string[] { "staff1@where.com" });
				});
			}
		}
