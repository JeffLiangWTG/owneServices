...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	...
	{
		protected override ZString MessageType => EMCSIncomingMessageTypeList.Codes.IE829;

		protected override ZString MessageFriendlyName => "EMCS IE829 Message Processor";
		...
		protected override void AssertProcessResult(EMCSJobDeclaration declaration, EMCSInboundEDIMessage incomingMessage)
		{
			...
			MessageProcessorNotificationTestHelper.AssertEmail(
				"EMCS Notification of Accepted Export",
				new[] { "Your EMCS Declaration for Job E00000810 received a notification of accepted export. For details please follow the link to the Job." },
		...
		public void TestEndToEndProcessing_WhenMultipleDeclarationsMatched()
		{
			...
			var incomingMessage = CreateNewIncomingMessage();
			incomingMessage.EM_MessageText = InterchangeProcessorTestHelper.GetMailboxItemText(TransactionID, MessageTextMRN, includeResponseWrap: false);
			...
			using (incomingMessage.Factory.AddDisposableService())
			{
				...
				CombineAssertions("Process", () =>
				{
					...
					MessageProcessorNotificationTestHelper.AssertEmail(
						"EMCS Notification of Accepted Export Response for E00000810",
						new[] { "Your EMCS Declaration for Job E00000810 received a notification of accepted export. For details please follow the link to the Job." },
						new string[] { "staff1@where.com" });
					MessageProcessorNotificationTestHelper.AssertEmail(
						"EMCS Notification of Accepted Export Response for E00000811",
						new[] { "Your EMCS Declaration for Job E00000811 received a notification of accepted export. For details please follow the link to the Job." },
						new string[] { "staff1@where.com" });
				});
			}
		}
