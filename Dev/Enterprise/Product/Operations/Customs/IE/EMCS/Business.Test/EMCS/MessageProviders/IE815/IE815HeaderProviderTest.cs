...
namespace Enterprise.Customs.IE.EMCS.Business.Testing
{
	...
	public class IE815HeaderProviderTest : HeaderProviderAbstractTest<IE815HeaderProvider>
	{
		...
		public void TestPlaceOfDispatchTrader_OriginTypeIsTaxWarehouse()
		{
			...
			AssertNotNull(HeaderProvider.PlaceOfDispatchTrader);
		}

		public void TestPlaceOfDispatchTrader_OriginTypeIsDutyPaid()
		{
			emcsDeclaration.SupplierDocumentaryAddress.OrganisationPK = GetPartyTraderIdOrg("TWH874").PK;
			emcsDeclaration.DispatchWarehouseDocumentaryAddress.OrganisationPK = GetPartyTraderIdOrg("TWH923").PK;
		...
		public void TestPlaceOfDispatchTrader_OriginTypeNotTaxWarehouseOrDutyPaid()
		{
			emcsDeclaration.SupplierDocumentaryAddress.OrganisationPK = GetPartyTraderIdOrg("TWH874").PK;
			emcsDeclaration.DispatchWarehouseDocumentaryAddress.OrganisationPK = GetPartyTraderIdOrg("TWH923").PK;
		...
		protected new IIE815Header HeaderProvider => base.HeaderProvider;
