	...
	sealed class IE801LineProviderTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			line = new BodyEadEsadType
			{
				...
				FiscalMarkUsedFlag = CargoWise.Customs.IE.MessageDefinitions.EMCSPhase4_1.tcl.Flag.Item1,
				...
				WineProduct = new WineProductType
				{
					...
					WineProductCategory = CargoWise.Customs.IE.MessageDefinitions.EMCSPhase4_1.tcl.CategoryOfWineProduct.Item1,
