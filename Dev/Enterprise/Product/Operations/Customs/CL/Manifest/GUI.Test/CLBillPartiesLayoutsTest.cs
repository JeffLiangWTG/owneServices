...
using AsycudaManifestHeader = Enterprise.Customs.CL.Manifest.Business.AsycudaManifestHeader;

namespace Enterprise.Customs.CL.Manifest.GUI.Testing
{
	[TestedType(typeof(CLBillPartiesLayouts))]
	sealed class CLBillPartiesLayoutsTest : LayoutsAbstractTest
	{
		public void TestCLSpecificFieldsVisibilty()
		{
