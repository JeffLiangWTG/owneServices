...
namespace Enterprise.Customs.ZA.Business.Testing
{
	sealed class TransportModeTranslatorTest : TestCase
	{
		...
		public void TestTranslateToWCOCode_Empty()
		{
			AssertEquals(TransportModeCodeList.Codes.Unknown, transportModeTranslator.TranslateToWCOCode(string.Empty));
		}
		...
		public void TestCargoWiseToWCO_ExpectedList()
		{
			var expectedValues = new[]
			{
				...
				Core.Constants.TransportModes.Unknown,
				string.Empty
			};
		...
		public void TestWCOToCargoWise_ExpectedList()
		{
			var expectedValues = new[]
			{
				TransportModeCodeList.Codes.Air,
				TransportModeCodeList.Codes.FixedInstallations,
				TransportModeCodeList.Codes.InlandWater,
				TransportModeCodeList.Codes.Mail,
				TransportModeCodeList.Codes.Other,
				TransportModeCodeList.Codes.Rail,
				TransportModeCodeList.Codes.Road,
				TransportModeCodeList.Codes.Sea,
				TransportModeCodeList.Codes.Unknown
			};
