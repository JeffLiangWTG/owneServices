...
{
	class CUSCARMessageTextBuilder_FWB : CUSCARMessageTextBuilder
	{
		public CUSCARMessageTextBuilder_FWB(CUSCARMessage edifactMessage, ICusCarHeader dataSource, MessageSubTypes subType, ZString billIssuerCode)
		...
		{
			if (!string.IsNullOrEmpty(billIssuerCode))
			{
				base.AddHeaderPartyGroupingFZ();
			}
		}
		...
		protected override ZString GetTransportDocumentNumber(ICusCarLine line) => line.BillNumberWithHyphen;
	}
}
