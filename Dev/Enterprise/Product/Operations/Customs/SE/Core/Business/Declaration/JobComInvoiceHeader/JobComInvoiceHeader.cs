...
{
	public class JobComInvoiceHeader : EU.Business.Declaration.JobComInvoiceHeader, Integration.Customs.SE.IJobComInvoiceHeader
	{
		...
		protected override CargoWise.Types.ZString LocalCurrencyCodeCore => Core.Constants.CurrencyCodes.Sweden;
