...
namespace Enterprise.Customs.SE.NCTS.GUI.Testing
{
	...
	sealed class NctsPhase5LayoutProviderTest : EU.NCTS.GUI.Testing.NctsPhase5LayoutProviderAbstractTest
	{
		...
		protected override Type ExpectedDepartureDetailsLayoutType => typeof(EU.NCTS.GUI.Phase5DepartureDetailsLayout);
		...
		protected override string CountryOrGroupingCode => Core.Constants.CountryCodes.Sweden;
