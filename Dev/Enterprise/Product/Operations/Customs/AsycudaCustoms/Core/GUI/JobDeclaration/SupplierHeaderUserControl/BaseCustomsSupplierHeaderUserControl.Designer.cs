namespace Enterprise.Customs.AsycudaCustoms.GUI
{
	partial class BaseCustomsSupplierHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.SupportingDocumentsTabPage.CaptionResourceString = Enterprise.Customs.AsycudaCustoms.GUI.Res.GetData("f815e0d8-3b4a-4c1c-bb16-d8c231e69dc4", "Supporting Documents");
			...
			this.SupportingDocumentsTabPage.TabIndex = 100;
			// 
			// SupportingDocumentsUserControl
			// 
			this.SupportingDocumentsUserControl.AllowDrop = true;
			this.BindingSource.SetBindingMember(this.SupportingDocumentsUserControl, "Invoices");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.Customs.AsycudaCustoms.Business.ISupportingDocumentsProvider)(((Enterprise.Customs.AsycudaCustoms.Business.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.AsycudaCustoms.Business.JobDeclaration)(null)).Invoices)).SyncRoot)))));
			...
			this.SupportingDocumentsUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 243, true);
