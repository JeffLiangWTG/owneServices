	...
	sealed class MessagesTabUserControlTest : TestCaseWithFactory
	{
		public void TestResetDefaultOrderAndVisibleColumnsForMessagesBoundGrid()
		{
			using (var form = new JobDeclarationForm(declaration))
			{
				...
				declarationAndEntryMessageTabUserControl.FindSingleOrDefault<ZTabControl>("EntryDeclarationTabControl").SelectedTab = declarationAndEntryMessageTabUserControl.FindSingle<ZTabPage>("EntryTabPage");
				var messagesTabUserControl = declarationAndEntryMessageTabUserControl.FindSingle<MessagesTabUserControl>("EntryMessagesTabUserControl");
