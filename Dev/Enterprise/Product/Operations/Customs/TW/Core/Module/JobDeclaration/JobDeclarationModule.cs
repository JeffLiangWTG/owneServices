...
namespace Enterprise.Customs.TW.Module
{
	public class JobDeclarationModule : Customs.Module.JobDeclarationModule
	{
		...
		protected override Customs.Business.ImportJobDeclaration GetImportJobDeclarationForCreateAndImportDeclarationFromAnotherDeclaration() => new ImportJobDeclaration(Factory);
	}
}
