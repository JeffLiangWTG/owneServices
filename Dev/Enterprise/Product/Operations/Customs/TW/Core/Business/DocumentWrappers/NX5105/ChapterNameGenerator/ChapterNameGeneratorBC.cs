...
{
	class ChapterNameGeneratorBC : ChapterNameGeneratorB
	{
		public ChapterNameGeneratorBC(ImportCustomsDeclarationDocumentWrapper wrapper)
			: base(wrapper)
		{ }
		...
		protected override TariffChapter GetTariffChapter(ZInt prefix4, ZString classificationId)
		{
			...
			if ((100 <= prefix4 && prefix4 < 700) ||
				(1300 <= prefix4 && prefix4 < 1700))
			{
				result = TariffChapter.FirstTariffChapter;
			}
			else if ((700 <= prefix4 && prefix4 < 1300) ||
				(1700 <= prefix4 && prefix4 < 2500))
			{
			...
			else if (4100 <= prefix4 && prefix4 < 7100)
			{
				result = TariffChapter.FourthTariffChapter;
			}
			else if ((7100 <= prefix4 && prefix4 < 8400) ||
