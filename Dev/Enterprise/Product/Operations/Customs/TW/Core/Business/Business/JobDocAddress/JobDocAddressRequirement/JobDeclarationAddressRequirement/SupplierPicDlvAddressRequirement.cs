...
{
	public class SupplierPicDlvAddressRequirement : TWJobDocAddressRequirement
	{
		public SupplierPicDlvAddressRequirement(DocAddressType defaultDocAddressType, AddressType defaultAddressType)
