...
{
	[TestedType(typeof(NX101MessageSendingObjectAdditionalMessageErrorCollector))]
	sealed class NX101MessageSendingObjectAdditionalMessageErrorCollectorTest : TestCaseWithFactory
	{
		[ExpectNoExceptions]
		...
		protected override void SetUp()
		{
			...
			sendingObjectParent = LicensingMessageSendingObjectParent.GetLicensingMessageSendingObjectParent(declaration, ControllingMessageTypeList.Codes.NX101);
			collector = new NX101MessageSendingObjectAdditionalMessageErrorCollector(sendingObjectParent);
		}

		JobDeclaration declaration;
		LicensingMessageSendingObjectParent sendingObjectParent;
		NX101MessageSendingObjectAdditionalMessageErrorCollector collector;
	}
}
