...
{
	partial class ControllingMessageSendingForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.TW.Business.ControllingMessageSendingObjectParent);
			// 
			// ControllingMessageSendingForm
			// 
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(784, 311, true);
			this.DataSourceType = typeof(Enterprise.Customs.TW.Business.ControllingMessageSendingObjectParent);
			this.Name = "ControllingMessageSendingForm";
