namespace Enterprise.Customs.TW.GUI
{
	partial class ImportSupplierHeaderUserControl
	{
		...
		{
			this.TW_CustomsOfficeDropEdit = new Enterprise.ZArchitecture.GUI.ZDropEdit();
			this.IsFixedRateCheckBox = new Enterprise.ZArchitecture.GUI.ZCheckBox();
			this.TW_MarksAndNumbersLongTextBox.SuspendLayout();
			this.JZ_RemarksLongTextBox.SuspendLayout();
			this.JZ_DescriptionLongTextBox.SuspendLayout();
			...
			this.TW_CustomsOfficeDropEdit.SuspendLayout();
			this.SuspendLayout();
			// 
			// TW_MarksAndNumbersLongTextBox
			// 
			this.TW_MarksAndNumbersLongTextBox.TabIndex = 12;
			// 
			// JZ_RemarksLongTextBox
			// 
			this.JZ_RemarksLongTextBox.TabIndex = 13;
			// 
			// JZ_DescriptionLongTextBox
			// 
			this.JZ_DescriptionLongTextBox.TabIndex = 14;
			// 
			...
			// 
			this.JZ_InvoiceCurrLandedCostExRateCalcEdit.TabIndex = 10;
			// 
			...
			// InvoiceTabControl
			// 
			this.InvoiceTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 342, true);
			// 
			// ComInvoiceDetailsTabPage
			// 
			this.ComInvoiceDetailsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 264, true);
			// 
			// ChargesGroupBox
			// 
			this.ChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 136, true);
			// 
			// ChargesTabControl
			// 
			this.ChargesTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(602, 117, true);
			// 
			// InvoiceChargesTabPage
			// 
			this.InvoiceChargesTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(594, 90, true);
			// 
			// InvoiceChargesGrid
			// 
			this.InvoiceChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(594, 90, true);
			// 
			// BaseGroupChargesGroupBox
			// 
			this.BaseGroupChargesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 122, true);
			// 
			// BaseGroupChargesGrid
			// 
			this.BaseGroupChargesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(602, 103, true);
			// 
			// JZ_FOBAmountBoundCurrencyControl
			// 
			this.JZ_FOBAmountBoundCurrencyControl.CaptionResourceString = Enterprise.Customs.TW.GUI.Res.GetData("34044492-6B13-4640-874E-5F4BCC7C5868", "CIF");
			// 
			...
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(988, 119, true);
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.TabIndex = 0;
			this.JobComInvoiceHeadersBoundGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 157, true);
			// 
			// InvCustomFieldsDisplayControl
			// 
			this.InvCustomFieldsDisplayControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 315, true);
			// 
			// CustomFieldsTabPage
			// 
			this.CustomFieldsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(986, 315, true);
			// 
			// Splitter
			// 
			this.Splitter.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 540, true);
			this.Splitter.Panel2MinSize = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(374);
			this.Splitter.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(157);
			// 
			// InvDetailLeftPanel
			// 
			this.InvDetailLeftPanel.Controls.Add(this.IsFixedRateCheckBox);
			this.InvDetailLeftPanel.Controls.Add(this.TW_CustomsOfficeDropEdit);
			this.InvDetailLeftPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(378, 264, true);
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.TW_CustomsOfficeDropEdit, 0);
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.IsFixedRateCheckBox, 0);
			...
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.JZ_DescriptionLongTextBox, 0);
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.JZ_RemarksLongTextBox, 0);
			this.InvDetailLeftPanel.Controls.SetChildIndex(this.TW_MarksAndNumbersLongTextBox, 0);
			// 
			// InvDetailRightPanel
			// 
			this.InvDetailRightPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 264, true);
			// 
			// ChargesGroupsSplitterContainer
			// 
			this.ChargesGroupsSplitterContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(608, 264, true);
			this.ChargesGroupsSplitterContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(136);
			// 
			// BottomPanel
			// 
			this.BottomPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 342, true);
			// 
			// TW_CustomsOfficeDropEdit
			// 
			this.TW_CustomsOfficeDropEdit.AllowDrop = true;
			this.BindingSource.SetBindingMember(this.TW_CustomsOfficeDropEdit, "Invoices.JZ_RelatedIndicator");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.TW.Business.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.TW.Business.JobDeclaration)(null)).Invoices)).SyncRoot)).JZ_RelatedIndicator)));
			this.TW_CustomsOfficeDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(118, 300, true);
			this.TW_CustomsOfficeDropEdit.Name = "TW_CustomsOfficeDropEdit";
			this.TW_CustomsOfficeDropEdit.PreBoundMaxLength = 3;
			this.TW_CustomsOfficeDropEdit.ShouldResizeByMaxLength = false;
			this.TW_CustomsOfficeDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(232, 20, true);
			this.TW_CustomsOfficeDropEdit.TabIndex = 15;
			// 
			// IsFixedRateCheckBox
			// 
			this.IsFixedRateCheckBox.AutoSize = true;
			this.BindingSource.SetBindingMember(this.IsFixedRateCheckBox, "Invoices.IsJZ_InvoiceCurrExRateUserEnterable");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Customs.TW.Business.JobComInvoiceHeader)(((System.Collections.IList)(((Enterprise.Customs.TW.Business.JobDeclaration)(null)).Invoices)).SyncRoot)).IsJZ_InvoiceCurrExRateUserEnterable)));
			this.IsFixedRateCheckBox.CaptionResourceString = Enterprise.Customs.TW.GUI.Res.GetData("17C089E5-0328-4E73-8239-3801B6477D02", "Fixed Rate?");
			this.IsFixedRateCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(271, 82, true);
			this.IsFixedRateCheckBox.Name = "IsFixedRateCheckBox";
			this.IsFixedRateCheckBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(15, 14, true);
			this.IsFixedRateCheckBox.TabIndex = 4;
			this.IsFixedRateCheckBox.UseVisualStyleBackColor = true;
			// 
			...
			this.JZ_DescriptionLongTextBox.ResumeLayout(true);
			this.JZ_DescriptionLongTextBox.PerformLayout();
			...
			this.TW_CustomsOfficeDropEdit.ResumeLayout(true);
			this.TW_CustomsOfficeDropEdit.PerformLayout();
		...
		internal ZArchitecture.GUI.ZDropEdit TW_CustomsOfficeDropEdit;
		private ZArchitecture.GUI.ZCheckBox IsFixedRateCheckBox;
	}
}
