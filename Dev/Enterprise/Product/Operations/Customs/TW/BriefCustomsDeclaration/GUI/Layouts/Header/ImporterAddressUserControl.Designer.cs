...
{
	partial class ImporterAddressUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.AddressTabPage.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("18fa465a-bd50-484c-a67a-014da5e824dd", "Address");
			...
			// CityTextBox
			// 
			this.BindingSource.SetBindingMember(this.CityTextBox, "MasterBill.ABL_ConsigneeCity");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeCity)));
			this.CityTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("35fe2a50-bef9-4bef-8133-cc93dc80d45b", "City");
			...
			// Street1TextBox
			// 
			this.BindingSource.SetBindingMember(this.Street1TextBox, "MasterBill.ABL_ConsigneeStreet1");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeStreet1)));
			this.Street1TextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("38da0ea6-9cc9-4c42-98ce-b88e3eb8281d", "Address");
			...
			// Street2TextBox
			// 
			this.BindingSource.SetBindingMember(this.Street2TextBox, "MasterBill.ABL_ConsigneeStreet2");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeStreet2)));
			...
			// PostCodeTextBox
			// 
			this.BindingSource.SetBindingMember(this.PostCodeTextBox, "MasterBill.ABL_ConsigneePostcode");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneePostcode)));
			this.PostCodeTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("8c930d12-df4d-47dd-a7bb-71efd2525717", "Post Code");
			...
			// NameTextBox
			// 
			this.BindingSource.SetBindingMember(this.NameTextBox, "MasterBill.ABL_ConsigneeName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeName)));
			this.NameTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("fa160bf6-10ae-41e8-b175-cfb69b3dc04c", "Name");
			...
			// StateTextBox
			// 
			this.BindingSource.SetBindingMember(this.StateTextBox, "MasterBill.ABL_ConsigneeState");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeState)));
			this.StateTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("805fae43-1ece-4303-8fc0-5651821ea81b", "State");
			...
			this.BindingSource.SetBindingMember(this.CountryFindBox, "MasterBill.ABL_RN_NKConsigneeCountry");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_RN_NKConsigneeCountry)));
			this.CountryFindBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("2ff53ddc-1b75-4e23-9015-70fa8a9fbac7", "Country");
			...
			this.LocalAddressTabPage.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("64dd7517-4889-4a00-bdb6-1bba391d921c", "Local Address");
			...
			// LocalCityTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalCityTextBox, "MasterBill.ABL_ConsigneeLocalCity");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeLocalCity)));
			this.LocalCityTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("51428e86-9580-422b-adef-92aadf1c961a", "City");
			...
			// LocalStreet1TextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStreet1TextBox, "MasterBill.ABL_ConsigneeLocalStreet1");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeLocalStreet1)));
			this.LocalStreet1TextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("82fad2d1-b821-462d-954f-6c37969d2a00", "Address");
			...
			// LocalStreet2TextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStreet2TextBox, "MasterBill.ABL_ConsigneeLocalStreet2");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeLocalStreet2)));
			...
			// 
			this.BindingSource.SetBindingMember(this.LocalPostCodeTextBox, "MasterBill.ABL_ConsigneePostcode");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneePostcode)));
			this.LocalPostCodeTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("27d90041-7654-4048-b46d-2e3360699c6e", "Post Code");
			...
			// LocalNameTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalNameTextBox, "MasterBill.ABL_ConsigneeLocalName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeLocalName)));
			this.LocalNameTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("df4ebb31-d912-4910-8bd8-0cdd529c4b2e", "Name");
			...
			// LocalStateTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStateTextBox, "MasterBill.ABL_ConsigneeLocalState");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeLocalState)));
			this.LocalStateTextBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("348f4917-502c-427d-8f21-54049a131870", "State");
			...
			this.BindingSource.SetBindingMember(this.LocalCountryCodeFindBox, "MasterBill.ABL_RN_NKConsigneeCountry");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_RN_NKConsigneeCountry)));
			this.LocalCountryCodeFindBox.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("96b499b3-e10a-49e5-a29d-27d76dbca218", "Country");
			...
			this.CodeTabPage.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("8a623693-ae18-4af8-a7f8-c03e502f614c", "Code");
			...
			// RegNoTextBox
			// 
			this.BindingSource.SetBindingMember(this.RegNoTextBox, "MasterBill.ABL_ConsigneeRegNo");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeRegNo)));
			...
			this.BindingSource.SetBindingMember(this.RegNoTypeDropEdit, "MasterBill.ABL_ConsigneeRegNoType");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_ConsigneeRegNoType)));
			this.RegNoTypeDropEdit.CaptionResourceString = Enterprise.Customs.TW.BriefCustomsDeclaration.GUI.Res.GetData("a8f863ba-90bb-4e55-82d7-34be7acc3a6a", "ID");
			...
			this.BindingSource.SetBindingMember(this.ConsigneeAddressControl, "MasterBill.ABL_OA_Consignee");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Customs.TW.BriefCustomsDeclaration.Business.AsycudaManifestHeader)(null)).MasterBill.ABL_OA_Consignee)));
