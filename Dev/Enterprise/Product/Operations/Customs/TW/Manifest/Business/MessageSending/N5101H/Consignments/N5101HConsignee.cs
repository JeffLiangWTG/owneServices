...
{
	public class N5101HConsignee : IPartyDetails
	{
		public N5101HConsignee(AsycudaBill bill)
		{
			this.bill = bill;
		}
		...
		public ZString ID => SharedHelper.GetIDStartWithNO(bill.ABL_ConsigneeRegNo, TypeCode);

		public ZString Name => bill.ABL_ConsigneeName;

		public ZString ChineseName => bill.ABL_ConsigneeLocalName;

		public ZString TypeCode => N5101HHelpers.RegNoTypeToTypeCode(bill.ABL_ConsigneeRegNoType);
		...
		public IAddress Address => new N5101HConsigneeAddress(bill);
