...
{
	partial class NotifyPartyAddressUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.AddressTabPage.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("aadb3fe6-6e28-41b7-a7a5-4cf9309fc638", "Address");
			...
			// CityTextBox
			// 
			this.BindingSource.SetBindingMember(this.CityTextBox, "ABL_NotifyPartyCity");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyCity)));
			this.CityTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("e52eb414-13f0-4810-b96e-fe4310e19a2c", "City");
			...
			// Street1TextBox
			// 
			this.BindingSource.SetBindingMember(this.Street1TextBox, "ABL_NotifyPartyStreet1");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyStreet1)));
			this.Street1TextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("252935e9-c34c-4d3d-b190-67a9cc1312f9", "Address");
			...
			// Street2TextBox
			// 
			this.BindingSource.SetBindingMember(this.Street2TextBox, "ABL_NotifyPartyStreet2");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyStreet2)));
			...
			// PostCodeTextBox
			// 
			this.BindingSource.SetBindingMember(this.PostCodeTextBox, "ABL_NotifyPartyPostcode");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyPostcode)));
			this.PostCodeTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("90cebcc2-6123-4d7e-be60-4736f9d5c08d", "Post Code");
			...
			// NameTextBox
			// 
			this.BindingSource.SetBindingMember(this.NameTextBox, "ABL_NotifyPartyName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyName)));
			this.NameTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("e010df24-0887-45f2-aa82-75f3806c3468", "Name");
			...
			// StateTextBox
			// 
			this.BindingSource.SetBindingMember(this.StateTextBox, "ABL_NotifyPartyState");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyState)));
			this.StateTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("d05454fc-ca50-4c94-8f65-8185cb8b7d8a", "State");
			...
			this.BindingSource.SetBindingMember(this.CountryFindBox, "ABL_RN_NKNotifyPartyCountry");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_RN_NKNotifyPartyCountry)));
			this.CountryFindBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("ecadeff9-4600-4b05-92e3-617b744802de", "Country");
			...
			this.LocalAddressTabPage.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("61202bfa-c23b-43c8-84ee-ce276c5570a5", "Local Address");
			...
			// LocalCityTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalCityTextBox, "ABL_NotifyPartyLocalCity");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyLocalCity)));
			this.LocalCityTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("ec0302e4-57d2-4658-9c3c-011043094b97", "City");
			...
			// LocalStreet1TextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStreet1TextBox, "ABL_NotifyPartyLocalStreet1");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyLocalStreet1)));
			this.LocalStreet1TextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("09ab2b5d-caee-47ab-8e9f-f2638071762b", "Address");
			...
			// LocalStreet2TextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStreet2TextBox, "ABL_NotifyPartyLocalStreet2");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyLocalStreet2)));
			...
			// 
			this.BindingSource.SetBindingMember(this.LocalPostCodeTextBox, "ABL_NotifyPartyPostcode");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyPostcode)));
			this.LocalPostCodeTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("48fd9c5e-3a45-4c7e-a0ab-00a15773adc0", "Post Code");
			...
			// LocalNameTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalNameTextBox, "ABL_NotifyPartyLocalName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyLocalName)));
			this.LocalNameTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("971aa84f-ab1e-47f5-9de1-e9d47fc1ab69", "Name");
			...
			// LocalStateTextBox
			// 
			this.BindingSource.SetBindingMember(this.LocalStateTextBox, "ABL_NotifyPartyLocalState");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyLocalState)));
			this.LocalStateTextBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("adfef343-56a8-4344-b5f2-00c6ed324831", "State");
			...
			this.BindingSource.SetBindingMember(this.LocalCountryCodeFindBox, "ABL_RN_NKNotifyPartyCountry");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_RN_NKNotifyPartyCountry)));
			this.LocalCountryCodeFindBox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("717fdcb8-40c3-4848-aa35-ee7eb1c3adab", "Country");
			...
			this.CodeTabPage.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("ed431117-db81-49cf-9b48-f632c9bad787", "Code");
			...
			// RegNoTextBox
			// 
			this.BindingSource.SetBindingMember(this.RegNoTextBox, "ABL_NotifyPartyRegNo");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyRegNo)));
			...
			this.BindingSource.SetBindingMember(this.RegNoTypeDropEdit, "ABL_NotifyPartyRegNoType");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_NotifyPartyRegNoType)));
			this.RegNoTypeDropEdit.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("dfc3c0e1-c1f3-434c-bde5-25490f010fcc", "ID");
			...
			// OrganisationPanel
			// 
			this.OrganisationPanel.Controls.Add(this.NotifyPartyAddressControl);
			...
			this.BindingSource.SetBindingMember(this.NotifyPartyAddressControl, "ABL_OA_NotifyParty");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZGuid)(((Enterprise.Customs.TW.Manifest.Business.AsycudaBill)(null)).ABL_OA_NotifyParty)));
			this.NotifyPartyAddressControl.BindToOrgList = "Lookups.Consignors";
			this.NotifyPartyAddressControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(10, 4, true);
			...
			this.NotifyPartyAddressControl.TabIndex = 2;
			// 
			...
			this.Name = "NotifyPartyAddressUserControl";
