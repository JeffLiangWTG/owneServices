...
{
	partial class ForwarderCertificateUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.ForwarderCertificateGroupbox = new Enterprise.ZArchitecture.GUI.ZGroupBox();
			...
			this.ForwarderCertificateGroupbox.SuspendLayout();
			...
			// BrokeragePanel
			// 
			this.BrokeragePanel.Controls.Add(this.ForwarderCertificateGroupbox);
			...
			// 
			// ForwarderCertificateGroupbox
			// 
			this.ForwarderCertificateGroupbox.CaptionResourceString = Enterprise.Customs.TW.Manifest.GUI.Res.GetData("ce9af816-ac71-4790-8225-d4b300631335", "Forwarder Certificate");
			this.ForwarderCertificateGroupbox.Controls.Add(this.CertificateStatusTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.ReceiveAutomaticallyLabel);
			this.ForwarderCertificateGroupbox.Controls.Add(this.ReceiveAutomaticallyCheckBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.StatusReasonTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.StatusTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.CertificatePasswordTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.SenderIDTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.MailBoxPasswordTextBox);
			this.ForwarderCertificateGroupbox.Controls.Add(this.CertificateLoaderUserControl);
			this.ForwarderCertificateGroupbox.Controls.Add(this.MailBoxTextBox);
			this.ForwarderCertificateGroupbox.Dock = System.Windows.Forms.DockStyle.Fill;
			this.ForwarderCertificateGroupbox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 0, true);
			this.ForwarderCertificateGroupbox.Name = "ForwarderCertificateGroupbox";
			this.ForwarderCertificateGroupbox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(467, 267, true);
			this.ForwarderCertificateGroupbox.TabIndex = 1;
			this.ForwarderCertificateGroupbox.TabStop = false;
			// 
			// CertificateStatusTextBox
			// 
			this.BindingSource.SetBindingMember(this.CertificateStatusTextBox, "ForwarderCertificate.CertificateStatus");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.CertificateStatus)));
			...
			// 
			this.BindingSource.SetBindingMember(this.ReceiveAutomaticallyCheckBox, "ForwarderCertificate.GP_ReceiveAutomatically");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_ReceiveAutomatically)));
			...
			// StatusReasonTextBox
			// 
			this.BindingSource.SetBindingMember(this.StatusReasonTextBox, "ForwarderCertificate.GP_StatusReason");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_StatusReason)));
			...
			// StatusTextBox
			// 
			this.BindingSource.SetBindingMember(this.StatusTextBox, "ForwarderCertificate.GP_PasswordStatus");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_PasswordStatus)));
			...
			// 
			this.BindingSource.SetBindingMember(this.CertificatePasswordTextBox, "ForwarderCertificate.CurrentDecryptedCertificatePassphrase");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.CurrentDecryptedCertificatePassphrase)));
			...
			// SenderIDTextBox
			// 
			this.BindingSource.SetBindingMember(this.SenderIDTextBox, "ForwarderCertificate.GP_UserID");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_UserID)));
			...
			// 
			this.BindingSource.SetBindingMember(this.MailBoxPasswordTextBox, "ForwarderCertificate.CurrentDecryptedPassword");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.CurrentDecryptedPassword)));
			...
			this.BindingSource.SetBindingMember(this.CertificateLoaderUserControl, "ForwarderCertificate.GP_Certificate");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_Certificate)));
			...
			// MailBoxTextBox
			// 
			this.BindingSource.SetBindingMember(this.MailBoxTextBox, "ForwarderCertificate.GP_MailBoxID");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.TW.Manifest.Business.TWGlbCompanyWrapper)(null)).ForwarderCertificate.GP_MailBoxID)));
			...
			this.Name = "ForwarderCertificateUserControl";
			...
			this.ForwarderCertificateGroupbox.ResumeLayout(false);
			this.ForwarderCertificateGroupbox.PerformLayout();
		...
		private ZArchitecture.GUI.ZGroupBox ForwarderCertificateGroupbox;
