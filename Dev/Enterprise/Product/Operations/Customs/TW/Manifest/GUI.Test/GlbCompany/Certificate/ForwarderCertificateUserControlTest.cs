...
{
	sealed class ForwarderCertificateUserControlTest : TestCaseWithFactory
	{
		public void TestCertificateUpload()
		{
			...
			using (var form = new ZForm(companyWrapper))
			{
				...
				var forwarderCertificateUserControl = brokerageControl.FindSingle<ForwarderCertificateUserControl>("ForwarderCertificateUserControl");
				var certLoader = forwarderCertificateUserControl.FindSingle<Registry.GUI.DigitalCertificateControl_p12>("CertificateLoaderUserControl");
				certLoader.SetFileData(validCert);

				forwarderCertificateUserControl.CertificateLoaderUserControl_DataChanged(null, null);
		...
		public void TestCertificatePassword()
		{
			...
			using (var form = new ZForm(companyWrapper))
			{
				...
				form.Show();
				var forwarderCertificateUserControl = brokerageControl.FindSingle<ForwarderCertificateUserControl>("ForwarderCertificateUserControl");
				AssertEquals("Certificate password", validCertPassword, forwarderCertificateUserControl.CertificateLoaderUserControl.CertificatePassword);
			}
		}
		...
		(GlbCompany company, TWGlbCompanyWrapper companyWrapper, GlbCompanyCredential password) SetUpData()
		{
			...
			var password = companyWrapper.ForwarderCertificate;
