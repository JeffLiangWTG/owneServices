...
namespace Enterprise.Customs.TW.Manifest.Business.Testing
{
	...
	sealed class MessageStatusProviderTest : ASYCUDA.Business.Testing.MessageStatusProviderTest
	{
		...
		public void TestGetMessageStatusList()
		{
			...
			AssertSame(Factory.GetCachedValue<TWMessageStatusCodeList>(), messageStatusList);
		}

		public void TestGetRegistrationStatusList()
		{
			new TestTWCreator(Factory).CreateCustomsManifestStatus();
			var registrationStatusList = statusProvider.GetRegistrationStatusList(Factory, Core.Constants.CountryCodes.Taiwan, string.Empty);
			AssertEquals("AK, AP, EX, RE", registrationStatusList.CodesAsString);
		}
