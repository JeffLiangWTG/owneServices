namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.ACE.Output
{
	...
	[OutputBlock("SE94")]
	public partial class ASESSE94 : MessageBlock
	{
		public ASESSE94()
			: base("SE94")
		{
		...
		/// <summary>
		/// The quantity associated with the bill of lading number being reported.	It is the smallest exterior packaging unit.
		/// </summary>
		[MessageBlockInt(8, 60, "O")]
		public ZInt Quantity;

		/// <summary>
		/// The unit of measure corresponding to the quantity.
		/// </summary>
