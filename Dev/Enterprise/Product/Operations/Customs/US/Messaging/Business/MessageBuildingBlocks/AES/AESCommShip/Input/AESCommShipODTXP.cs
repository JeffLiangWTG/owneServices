namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.AES.Input
{
	...
	public partial class AESCommShipODTXP : AESCommShipODTXPBase
	{
	}

	[InputBlock("ODT")]
	public abstract class AESCommShipODTXPBase : MessageBlock
	{
		protected AESCommShipODTXPBase()
			: base("ODT")
		{
		}
		...
		/// </summary>
		[MessageBlockDecimal(7, 37, "M", 0)]
		public ZDecimal DDTCQuantity;
		...
		/// </summary>
		[MessageBlockString(3, 44, "M")]
		public ZString FUTUREUSEDDTCLicenseLineNumber;

		/// <summary>
		/// You must provide the unique case number of the Category XXI Determination Number in order to submit a USML Category XXI subparagraph.
		/// 
		/// Report spaces only as this time.
		/// </summary>
		[MessageBlockString(10, 47, "C")]
		public ZString DDTCCategoryXXIDeterminationNumber;
	}
}
