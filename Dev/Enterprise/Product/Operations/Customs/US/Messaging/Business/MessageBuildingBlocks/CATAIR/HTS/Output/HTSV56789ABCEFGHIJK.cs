namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.Output
{
	...
	[OutputBlock("V")]
	public sealed partial class HTSV56789ABCEFGHIJK : MessageBlock
	{
		public HTSV56789ABCEFGHIJK()
			: base("V")
		{
		}
		...
		public ZDecimal SpecificSpecialRate;
		...
		public ZDecimal AdValoremSpecialRate;
		...
		public ZDecimal OtherSpecialRate;

		/// <summary>
		/// A code representing the tax/fee class. Valid tax/fee class codes are listed in Appendix B.
		/// </summary>
		[MessageBlockString(3, 51, "C")]
		public ZString TaxFeeClassCode;

		/// <summary>
		/// A code that indicates the tax/fee computation formula. Computation formulas are presented in Appendix F.
		/// </summary>
		...
		public ZDecimal TaxFeeSpecificRate;
		...
		public ZDecimal TaxFeeAdValorem;
	}
}
