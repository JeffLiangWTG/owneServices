namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.ACE.Output
{
	...
	[OutputBlock("E0")]
	public partial class ARECE0 : MessageBlock
	{
		public ARECE0()
			: base("E0")
		{
		...
		/// 
		/// See Table 1 'Returned Reconciliation Reference Data' for a list of codes.
		/// </summary>
		...
		/// 
		/// See Table 1 'Returned Reconciliation Reference Data' for details of the returned data.
		/// </summary>
