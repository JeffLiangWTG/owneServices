...
//    [InputBlock("ZCR")]
//    [OutputBlock("ZCR")]
//    public partial class PTTZCR : MessageBlock
//    {
//        public PTTZCR()
//            : base("ZCR")
//        {
...
//        /// <summary>
//        /// Output application identifier. This data element is not included in input transactions (TI) but is returned to the ACE M1 participant in output transaction trailer records. Application Identifier is TR for response to TI.
//        /// </summary>
