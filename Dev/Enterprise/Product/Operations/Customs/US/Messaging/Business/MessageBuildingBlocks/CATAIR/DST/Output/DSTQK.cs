namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.Output
{
	...
	[OutputBlock("QK")]
	public partial class DSTQK : MessageBlock
	{
		public DSTQK()
			: base("QK")
		{
		...
		/// <summary>
		/// A value representing the total watermelon fee amount. Two decimal places are implied. If the fee is a whole number, the two low-order (cents) positions contain zeros.
		/// </summary>
		[MessageBlockDecimal(9, 46, "C", 2)]
		public ZDecimal TotalWatermelonFee;

		/// <summary>
		/// A value representing the total sheep fee amount. Two decimal places are implied. If the fee is a whole number, the two low-order (cents) positions contain zeros.
		/// </summary>
