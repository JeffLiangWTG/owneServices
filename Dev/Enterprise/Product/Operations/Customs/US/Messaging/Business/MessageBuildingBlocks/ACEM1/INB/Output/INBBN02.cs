namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.ACE.Output
{
	...
	public partial class INBBN02 : MessageBlock
	{
		...
		/// <summary>
		/// The USCBP line number when the Header Identifier is 'E' (Entry Summary). This will only apply to entries sent via 'EI', 'HI' or 'HN'. Otherwise, space fill.
		/// </summary>
		[MessageBlockInt(3, 5, "C")]
		public ZInt USCBPLine;
		...
		/// </summary>
		[MessageBlockString(16, 64, "C", ShouldTrimBegining = false)]
