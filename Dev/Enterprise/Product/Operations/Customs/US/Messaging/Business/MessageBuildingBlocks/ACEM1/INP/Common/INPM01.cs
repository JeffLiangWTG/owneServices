namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.ACE.Common
{
	...
	public partial class INPM01 : MessageBlock
	{
		...
		/// </summary>
		[MessageBlockString(23, 12, "C", ShouldTrimBegining = false)]//Should not trim beginning it affect matching
		...
		/// </summary>
		[MessageBlockString(5, 35, "M", ShouldTrimBegining = false, OnLengthViolation = LengthViolationAction.Substring)]//Should not trim beginning it affect matching
