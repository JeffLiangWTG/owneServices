// use Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.Output.HTSV1 instead
...
//	[OutputBlock("V1")]
//	public partial class AHTSV1 : MessageBlock
//	{
//		public AHTSV1()
//			: base("V1")
//		{
...
//		/// <summary>
//		/// A code representing the first unit of measure. If the reporting unit is X, no unit of measure is required except for certain tariff numbers in Chapter 99. Valid unit of measure codes are listed in Appendix C of this publication.
//		/// </summary>
...
//		/// <summary>
//		/// A code indicating the formula to be used to compute the duty. Valid Duty Computation Codes are listed in Appendix F of this publication.
//		/// </summary>
...
//		/// <summary>
//		/// A code indicating if the rate contains a base rate. If the base rate indicator is B, the duty rate is a base rate; otherwise, space fill.
//		/// </summary>
