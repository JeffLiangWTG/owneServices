namespace Enterprise.Customs.US.Messaging.Business.MessageBuildingBlocks.AMS.Common
{
	...
	[InputBlock("C01")]
	[OutputBlock("C01")]
	public partial class EQUC01 : MessageBlock
	{
		public EQUC01()
			: base("C01")
		{
		...
		/// <summary>
		/// A code identifying the type of container/equipment. A container/ equipment type code alone may be used in lieu of the container/equipment length, height, and width.
		/// </summary>
