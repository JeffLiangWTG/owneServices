...
{
	sealed class DISInvoiceLineRangeWrapperTest : TestCaseWithFactory
	{
		public void TestInvoiceLines()
		{
			...
			var wrapper = new DISInvoiceLineRangeWrapper(invoiceLineRange, hostWrapper);
			var lines = wrapper.InvoiceLines;
