...
{
	sealed class CusInBondMoveDetailProcessHandlingInfoTest : TestCaseWithFactory
	{
		public void TestMoveHeaderEventsCascadeToHeaderAndHeaderParent()
		{
			...
			Factory.Save();
			moveDetail.Logs.AddNew(Events.MessageStatusChange, ImportMessageStatusList.Codes.ClearDepartureOriginal);
