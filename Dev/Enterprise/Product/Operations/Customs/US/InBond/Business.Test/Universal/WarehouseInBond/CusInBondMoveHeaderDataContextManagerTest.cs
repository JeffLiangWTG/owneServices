...
{
	[TestedType(typeof(WarehouseInBondDataContextManager))]
	sealed class CusInBondMoveHeaderDataContextManagerTest : ShipmentDataContextManagerTestCase<WarehouseInBondDataContextManager, CusInBondMoveHeader>
	{
...
";
		...
		protected override CusInBondMoveHeader GetNewBusinessObjectForTesting()
		{
			var header = Factory.NewWithValidTestData<CusInBondHeader>();
			var moveHeader = Factory.NewWithValidTestData<CusInBondMoveHeader>();
