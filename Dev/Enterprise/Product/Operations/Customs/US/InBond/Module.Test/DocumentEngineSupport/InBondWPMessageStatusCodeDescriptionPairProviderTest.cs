...
{
	sealed class InBondWPMessageStatusCodeDescriptionPairProviderTest : CodeDescriptionPairListProviderTest
	{
		public override void TestIsReturningCorrectCollection()
		{
			ReadOnlyCodeDescriptionPairList actualList = CreateCodeDescriptionPairListProvider().GetCodeDescriptionPairList();
			CodeDescriptionPairList expectedList = new CusInBondHeaderFilterStripBusinessObject().Lookups.InbondWPMessageStatusListForFilter;
		...
		protected override DocumentEngine.RuntimeOptions.ICodeDescriptionPairListProvider CreateCodeDescriptionPairListProvider() => new InBondWPMessageStatusCodeDescriptionPairProvider();
	}
}
