...
namespace Enterprise.Customs.US.InBond.Module.Testing
{
	...
	sealed class CusInBondHeaderModuleTest : ZModuleBasherTest
	{
		...
		public void TestSendArrivalMessagesMenuItem()
		{
			...
			Factory.Save();
			using (var module = (CusInBondHeaderModule)ZModuleFactory.Instance.Create(ModuleID))
		...
		protected override ModuleIdentifier GetModuleID() => ModuleIDs.Customs.US.InBond;
