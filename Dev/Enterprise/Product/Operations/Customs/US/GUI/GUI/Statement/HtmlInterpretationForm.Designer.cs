...
namespace Enterprise.Customs.US.GUI
{
	partial class HtmlInterpretationForm
	{
		...
		protected new void InitializeComponent()
		{
			...
			// MainStatusBar
			// 
			this.MainStatusBar.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 399, true);
			this.MainStatusBar.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(936, 24, true);
			...
			this.ButtonPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 360, true);
			this.ButtonPanel.Name = "ButtonPanel";
			this.ButtonPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(936, 39, true);
			this.ButtonPanel.TabIndex = 1;
			// 
			// OKButton
			// 
			this.OKButton.Anchor = System.Windows.Forms.AnchorStyles.Bottom;
			this.OKButton.CaptionResourceString = Enterprise.Customs.US.GUI.Res.GetData("073F8FB2-321D-4A7B-8A33-F4D10EABDB8C", "OK");
			this.OKButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(431, 8, true);
			...
			// 
			// HtmlInterpretationForm
			// 
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(936, 423, true);
