...
{
	partial class USCustomsNumberViewStmNumsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.ThresholdRunOutWarningGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(873, 114, true);
			// 
			// ThresholdRunOutWarningGrid
			// 
			this.ThresholdRunOutWarningGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(863, 91, true);
			// 
			// NumberRangesGroupBox
			// 
			this.NumberRangesGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(873, 200, true);
			// 
			// NumberRangesGrid
			// 
			this.NumberRangesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(863, 147, true);
			// 
			// NumberRangesButtonsPanel
			// 
			this.NumberRangesButtonsPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(5, 165, true);
			this.NumberRangesButtonsPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(863, 30, true);
			// 
			// NumberRangesOtherButtonsPanel
			// 
			this.NumberRangesOtherButtonsPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(673, 30, true);
			// 
			// NumberRangeSplitContainer
			// 
			this.NumberRangeSplitContainer.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(873, 318, true);
			this.NumberRangeSplitContainer.SplitterDistance = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiY(200);
			// 
			// NumberRangesEditButton
			// 
			this.NumberRangesEditButton.TabIndex = 2;
			// 
			// NumberRangesDeleteButton
			// 
			this.NumberRangesDeleteButton.TabIndex = 3;
			// 
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.US.GUI.USCustomsNumberViewStmNumsCompanyProvider);
			// 
			// USCustomsNumberViewStmNumsUserControl
			// 
			this.Name = "USCustomsNumberViewStmNumsUserControl";
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(873, 318, true);
