...
{
	partial class QueryCarrierForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.US.Business.QueryCarrierOption);
			// 
			// zGroupBox1
			// 
			...
			this.zGroupBox1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(413, 159, true);
			...
			this.BindingSource.SetBindingMember(this.zTextBox2, "US_CarrierName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((string)(((Enterprise.Customs.US.Business.QueryCarrierOption)(null)).US_CarrierName)));
			...
			this.BindingSource.SetBindingMember(this.zTextBox1, "US_CarrierCode");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((string)(((Enterprise.Customs.US.Business.QueryCarrierOption)(null)).US_CarrierCode)));
			...
			this.zLabel3.Text = "Carrier Name:";
			// 
			// zLabel1
			// 
			...
			this.zLabel1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(72, 13, true);
			this.zLabel1.TabIndex = 0;
			this.zLabel1.Text = "Carrier Code:";
			// 
			// zLabel2
			// 
			this.zLabel2.IsFontBold = true;
			this.zLabel2.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(12, 91, true);
			this.zLabel2.Name = "zLabel2";
			this.zLabel2.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(393, 62, true);
			this.zLabel2.TabIndex = 6;
			this.zLabel2.Text = "Carriers can be queried by specifying Carrier Code or Carrier Name (includes " +
					"all transport modes).\r\n\r\nLeave all blank in order to query the entire list of Ai" +
					"r Carriers..";
			...
			this.Cancel_Button.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(342, 169, true);
			...
			this.SendButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(261, 169, true);
			...
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(423, 222, true);
			this.Controls.Add(this.zGroupBox1);
			this.Controls.Add(this.Cancel_Button);
			this.Controls.Add(this.SendButton);
			this.DataSourceType = typeof(Enterprise.Customs.US.Business.QueryCarrierOption);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			this.Name = "QueryCarrierForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Query Carrier";
