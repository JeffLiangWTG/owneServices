...
{
	partial class USCustomsSupplierHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.JZ_FOBAmountBoundCurrencyControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(48, 5, true);
			// 
			// JZ_Calc_TNIBoundInvoiceCurrencyControl
			// 
			this.JZ_Calc_TNIBoundInvoiceCurrencyControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(433, 5, true);
			// 
			// JZ_CIFAmountBoundCurrencyControl
			// 
			this.JZ_CIFAmountBoundCurrencyControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(49, 6, true);
			// 
			...
			// 
			// USCustomsSupplierHeaderUserControl
			// 
			this.Name = "USCustomsSupplierHeaderUserControl";
