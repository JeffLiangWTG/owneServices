...
{
	partial class PSTDisclaimControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// PSTDisclaimGroupBox
			// 
			this.PSTDisclaimGroupBox.CaptionResourceString = Enterprise.Customs.US.GUI.Res.GetData("04B5A91D-C2CA-4E0D-9545-370B3238C5AC", "PST Disclaim");
			...
			this.BindingSource.SetBindingMember(this.PSTProgramDropEdit, "US_PSTDisclaimProgram");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.US.Business.JobComInvoiceLine)(null)).US_PSTDisclaimProgram)));
			this.PSTProgramDropEdit.BindToList = null;
			this.PSTProgramDropEdit.CaptionResourceString = Enterprise.Customs.US.GUI.Res.GetData("EC9E4533-BD1D-4CE3-A777-BAA57DB07A0F", "Program Message Code");
