...
{
	[TestedType(typeof(InBondNumberRangeRegistryItemEditor))]
	sealed class InBondNumberRangeRegistryItemEditorTest : RegistryItemEditorTestCase
	{
		...
		{
			return new InBondNumberRangeRegistryItemEditor(RegistryItem.DataType, null, null);
		}

		protected override Type GetExpectedEditorPaneType()
		{
			return typeof(InBondNumberRangeControl);
		}

		protected override object[] GetValidRegistryValues()
		{
			InBondNumberRange range = new InBondNumberRange();
			range.StartNumber = 1;
			range.LastNumber = 9999999;
			return new object[] { range };
		}

		protected override bool GetEditorPaneEnabledState(System.Windows.Forms.Control editorPane)
		{
			return !((InBondNumberRangeControl)editorPane).ReadOnly;
		}
