...
{
	[TestedType(typeof(FRCBillBlockGenerator))]
	class FRCBillBlockGeneratorTest : AIMBlockGeneratorTest
	{
		protected override AIMBlockGenerator GetGenerator() => new FRCBillBlockGenerator(GetMessageHeaderMock().Object);
