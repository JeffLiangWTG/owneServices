...
{
	[TestedType(typeof(FRXBlockGenerator))]
	class FRXBlockGeneratorTest : AIMBlockGeneratorTest
	{
		protected override AIMBlockGenerator GetGenerator() => new FRXBlockGenerator(GetMessageHeaderMock().Object);
