...
{
	[TestedType(typeof(FXCBlockGenerator))]
	class FXCBlockGeneratorTest : AIMBlockGeneratorTest
	{
		protected override AIMBlockGenerator GetGenerator() => new FXCBlockGenerator(GetMessageHeaderMock().Object);
