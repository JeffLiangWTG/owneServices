...
{
	[TestedType(typeof(FXXBlockGenerator))]
	class FXXBlockGeneratorTest : AIMBlockGeneratorTest
	{
		protected override AIMBlockGenerator GetGenerator() => new FXXBlockGenerator(GetMessageHeaderMock().Object);
