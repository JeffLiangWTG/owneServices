...
{
	[TestedType(typeof(FXIBillBlockGenerator))]
	class FXIBillBlockGeneratorTest : AIMBlockGeneratorTest
	{
		protected override AIMBlockGenerator GetGenerator() => new FXIBillBlockGenerator(GetMessageHeaderMock().Object);
