...
{
	[TestedType(typeof(USExportCommercialInvoiceWrapper))]
	sealed class USExportCommercialInvoiceWrapperTest : GenericWrapperTest
	{
...
";
		...
		protected override string ExpectedFieldMap
		{
			...
			{
				return @"
USExportCommercialInvoice               (Default Field: InvoiceNumber)
======================================================================
Name                                    Type
----------------------------------------------------------------------
...
";
		...
		public void TestGetSupplier()
		{
			...
			org1.MainAddress.Address1 = "SOMEWHERE";
			var org2 = Factory.NewWithValidTestData<OrgHeader>();
			org2.MainAddress.Address1 = "SOMEWHERE ELSE";
			...
			var invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Supplier.AddressLine1", "SOMEWHERE", invoiceWrapper.Supplier.MainAddress.AddressLine1);

			var usppi = invoiceHeader.US_USPPI;
			usppi.ZO_OH_Organisation = org2.PK;

			invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Supplier.AddressLine1", "SOMEWHERE ELSE", invoiceWrapper.Supplier.MainAddress.AddressLine1);

			invoiceHeader.USPPIDocAddress.E2_AddressOverride = true;
			invoiceHeader.USPPIDocAddress.E2_Address1 = "ANOTHER SOMEWHERE";

			invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Supplier.AddressLine1", "ANOTHER SOMEWHERE", invoiceWrapper.Supplier.MainAddress.AddressLine1);
		}
		...
		public void TestGetImporter()
		{
			...
			var invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Importer.AddressLine1", "SOMEWHERE", invoiceWrapper.Importer.MainAddress.AddressLine1);

			var consignee = invoiceHeader.US_ExportUltimateConsignee;
			consignee.ZO_OH_Organisation = org2.PK;

			invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Importer.AddressLine1", "SOMEWHERE ELSE", invoiceWrapper.Importer.MainAddress.AddressLine1);

			invoiceHeader.UltimateConsigneeDocAddress.E2_AddressOverride = true;
			invoiceHeader.UltimateConsigneeDocAddress.E2_Address1 = "ANOTHER SOMEWHERE";

			invoiceWrapper = new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
			AssertEquals("invoiceWrapper.Importer.AddressLine1", "ANOTHER SOMEWHERE", invoiceWrapper.Importer.MainAddress.AddressLine1);
		}

		public override void TestWrapperMappingsEmpty()
		{
			var nullInvoiceHeader = Factory.GetNull<JobComInvoiceHeader>();
			var wrapperEmpty = new USExportCommercialInvoiceWrapper(null, Factory);
		...
		protected override GenericWrapper GetSetupWrapperForDefaultFormatting()
		{
			...
			return new USExportCommercialInvoiceWrapper(invoiceHeader, Factory);
		}

		protected override Enterprise.DocumentWrappers.DocBaseWrapper GetNewDocumentWrapper()
		{
			return new USExportCommercialInvoiceWrapper(null, Factory);
		}
	}
}
