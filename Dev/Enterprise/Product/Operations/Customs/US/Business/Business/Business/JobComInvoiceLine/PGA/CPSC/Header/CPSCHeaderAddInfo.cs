...
{
	[CusAddInfoType(CusAddInfoTypeAttribute.Codes.USCPSCHeader)]
	public class CPSCHeaderAddInfo : AutoUSCPSCAddInfo
	{
		public CPSCHeaderAddInfo(ZPropertyInfo addInfoProperty)
		...
		public new CPSCHeader Parent
		{
			get { return (CPSCHeader)base.Parent; }
		}
