...
{
	public class BIRDCargoReleaseMessageBuilder : CargoReleaseMessageBuilderBase<BIRDInputBlockControlGenerator>
	{
		public BIRDCargoReleaseMessageBuilder(ICargoReleaseCusEntryHeader entryHeader)
