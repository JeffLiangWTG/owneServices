...
{
	class ODSDataCorrection : InvoiceLineLevelPGADataCorrection, ITSCAData
	{
		public ODSDataCorrection(JobComInvoiceLine invoiceLine)
			: base(invoiceLine)
		{
		}
		...
		{
			return InvoiceLine.US_ODSTrackingStatusInfo;
		}
		...
		{
			return new[] { JobComInvoiceLine.Schema.US_ODSInd };
		}

		protected override string[] GetDislaimReasonFields()
		{
			return new[] { JobComInvoiceLine.Schema.US_ODSDisclaimReason };
		}
		...
		{
			get { return InvoiceLine.US_ODSLineNumber; }
		}
	}
}
