...
namespace Enterprise.Customs.US.Business.Testing
{
	sealed class CusAttributeFilterValidationTest : BusinessObjectValidationTestCase
	{
		...
		{
			AssertAttributeValue1(x => x.Attributes1, x => x.Attributes2, x => x.Attributes3, "Attribute 1");
			AssertAttributeValue1(x => x.Attributes2, x => x.Attributes1, x => x.Attributes3, "Attribute 2");
			AssertAttributeValue1(x => x.Attributes3, x => x.Attributes2, x => x.Attributes1, "Attribute 3");
		}
		...
		void AssertAttributeValue1(GetAttributesDelegate getAttributesToTest, GetAttributesDelegate getOtherAttributes1, GetAttributesDelegate getOtherAttributes2, string attributeType)
		{
			...
			string messageError = ValidationConstants.Part.AttributeValueShouldBeUniqueFor(attributeType);
