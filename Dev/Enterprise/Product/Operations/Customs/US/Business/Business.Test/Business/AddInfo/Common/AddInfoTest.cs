...
{
	[TestedType(typeof(AddInfoDummyBO))]
	sealed class AddInfoTest : NonPersistentBusinessObjectTestCase
	{
		...
		protected override BusinessObject GetNewBusinessObject() => new AddInfoDummyBO(classification.CC_AddInfoInfo);
		...
		protected override void SetUp()
		{
			...
			addInfoDummy = new AddInfoDummyBO(classification.CC_AddInfoInfo);
		}

		CusClassification classification;
		AddInfoDummyBO addInfoDummy;

		sealed class AddInfoDummyBO : AddInfo
		{
			public AddInfoDummyBO(ZPropertyInfo addInfoProperty) : base(addInfoProperty)
			{
			}
