...
{
	[TestedType(typeof(USAPHISIdentityNumberRangeAddInfo))]
	public class USAPHISIdentityNumberRangeAddInfoTest : NonPersistentBusinessObjectTestCase
	{
		#region Implementation

		protected override BusinessObject GetNewBusinessObject()
		{
			return new USAPHISIdentityNumberRangeAddInfo(Identity.NumberRanges.AddNew().B7_AddInfoDataInfo);
		}
