...
{
	[TestedType(typeof(ACEQuotaQuerySendingActionCollection))]
	sealed class ACEQuotaQuerySendingActionCollectionTest : NonPersistentBusinessObjectCollectionTestCase<ACEQuotaQuerySendingActionCollection>
	{
		...
		protected override ACEQuotaQuerySendingActionCollection GetCollectionToTest()
		{
			Actions.RemoveAll();
			return Actions;
		}

		protected override BusinessObject GetNewElementToAddToTheCollection() => new ACEQuotaQuerySendingAction("1", "", "AU", Actions);
