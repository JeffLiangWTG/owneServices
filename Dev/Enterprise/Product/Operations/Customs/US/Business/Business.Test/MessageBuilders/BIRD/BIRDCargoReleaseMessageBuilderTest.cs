...
{
	sealed class BIRDCargoReleaseMessageBuilderTest : TestCaseWithFactory
	{
		public void TestBuild()
		{
			...
			AssertContains("H1A8888XJ5 <E#PLCH>69-9999999JC10      81                   OTT1123401891       ", message.EM_MessageText);
			AssertContains("H2        69-9999999JC V123W0000015000                     DONGSNICKNAMEISRICHI ", message.EM_MessageText);
			...
			AssertNotContains("PlaceHolder is replaced", "<E#PLCH>", message.EM_MessageText);
		...
		public void TestGenerateWhenExternalBrokerExists()
		{
			JobDeclaration declaration = CreateDeclaration();
