...
namespace Enterprise.Customs._EUCustomsTemplate_.Business.Declaration.Testing
{
	...
	sealed class JobDeclarationTest : EU.Business.Declaration.Testing.JobDeclarationAbstractTest<JobDeclaration>
	{
		...
		{
			AssertEquals("Replace this with the correct currency code when implemented in a real country", Core.Constants.CurrencyCodes.EuropeanUnion, declaration.LocalCurrencyCode);
		}
