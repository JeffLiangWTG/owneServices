...
namespace Enterprise.Customs._EUCustomsTemplate_.GUI
{
	partial class ExportInvoiceLineUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.PrincipalsRepresentativeGroupBox.SuspendLayout();
			...
			this.organizationsUserControl1.SuspendLayout();
			...
			this.AuthorisationsUserControl.SuspendLayout();
			...
			// TaxGroupBox
			// 
			this.TaxGroupBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(3, 227, true);
			// 
			// TaxGrid
			// 
			this.TaxGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(720, 224, true);
			// 
			// packagesPivotUserControl
			// 
			this.packagesPivotUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(720, 292, true);
			// 
			// SupportingDocumentsTabPage
			// 
			this.SupportingDocumentsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// InvoiceLinePaymentTabPage
			// 
			this.InvoiceLinePaymentTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// AdditionalInfosTabPage
			// 
			this.AdditionalInfosTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// PreviousDocumentsTabPage
			// 
			this.PreviousDocumentsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// OrganizationsTabPage
			// 
			this.OrganizationsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// PackagesPivotTabPage
			// 
			this.PackagesPivotTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// TaxTabPage
			// 
			this.TaxTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// organizationsUserControl1
			// 
			this.organizationsUserControl1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// StatValueManualOverrideCheckBox
			// 
			this.StatValueManualOverrideCheckBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(44, 17, true);
			// 
			// tariffFindBox
			// 
			...
			// 
			this.FiscalReferencesTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// FiscalReferencesUserControl
			// 
			this.FiscalReferencesUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// AuthorisationsTabPage
			// 
			this.AuthorisationsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// AuthorisationsUserControl
			// 
			this.AuthorisationsUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(720, 292, true);
			// 
			// ValueIndicatorsTabPage
			// 
			this.ValueIndicatorsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(726, 298, true);
			// 
			// TopPanel
			// 
			this.TopPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 51, true);
			this.TopPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(990, 533, true);
			// 
			...
			this.CantCreateInvoiceLinesLabel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(990, 533, true);
			// 
			// CustomsInvoiceLinesBoundGrid
			// 
			this.CustomsInvoiceLinesBoundGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(990, 533, true);
			// 
			// Splitter
			// 
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs._EUCustomsTemplate_.Business.Declaration.JobDeclaration);
			// 
			...
			this.PrincipalsRepresentativeGroupBox.ResumeLayout(false);
			this.PrincipalsRepresentativeGroupBox.PerformLayout();
			...
			this.organizationsUserControl1.ResumeLayout(true);
			this.organizationsUserControl1.PerformLayout();
			...
			this.AuthorisationsUserControl.ResumeLayout(true);
			this.AuthorisationsUserControl.PerformLayout();
