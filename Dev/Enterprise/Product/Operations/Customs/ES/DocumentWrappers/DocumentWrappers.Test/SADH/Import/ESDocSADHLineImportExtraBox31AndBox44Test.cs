...
{
	sealed class ESDocSADHLineImportExtraBox31AndBox44Test : DocBaseWrapperTest
	{
		public void TestConstructor()
		{
			...
			invoiceLine.JI_PrimaryPreference = "40";
			...
			CombineAssertions(() =>
			{
				...
				ESDocSADHLineImportExtraBox31AndBox44 line = ESDocSADHLineImportExtraBox31AndBox44.New(entryLine, Factory, "Box31", "Box44");
				...
				AssertEquals("Box36Preference Empty", ZString.Empty, line.Box36Preference);
				...
				AssertEquals("Box43ValuationMethod Empty", ZString.Empty, line.Box43ValuationMethod);
				AssertEquals("Box44AddInfoAndDocuments is the second parameter", "Box44", line.Box44AddInfoAndDocuments);
				AssertEquals("Box45Adjustment Empty", ZString.Empty, line.Box45Adjustment);
		...
		protected override DocBaseWrapper GetNewDocumentWrapper()
		{
			...
			return ESDocSADHLineImportExtraBox31AndBox44.New(entryLine, Factory);
		}
	}
}
