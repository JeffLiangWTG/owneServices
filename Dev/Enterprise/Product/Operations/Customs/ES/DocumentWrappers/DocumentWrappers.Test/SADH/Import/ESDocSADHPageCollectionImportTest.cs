...
{
	[TestedType(typeof(ESDocSADHPageCollectionImport))]
	sealed class ESDocSADHPageCollectionImportTest : DocSADHPageCollectionTest<ESDocSADHPageCollectionImport>
	{
		public void TestPagesGenerated()
		{
			...
			var pagesCollection = new ESDocSADHPageCollectionImport(entryHeader.MergedLines, Factory);
		...
		protected override ESDocSADHPageCollectionImport GetNewDocumentWrapperCollection()
		{
			return new ESDocSADHPageCollectionImport(EntryLineCollection, Factory);
		}
		...
		{
			var result = ESDocSADHPageImport.New(Factory, EntryLineCollection.AddNew());
