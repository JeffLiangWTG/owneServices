...
{
	[TestedType(typeof(ESDocSADHLineCollectionImport))]
	sealed class ESDocSADHLineCollectionImportTest : DocSADHLineCollectionTest<ESDocSADHLineCollectionImport>
	{
		protected override ESDocSADHLineCollectionImport GetNewDocumentWrapperCollection()
		{
			return new ESDocSADHLineCollectionImport(EntryLineCollection, Factory);
		}
		...
		{
			var result = ESDocSADHLineImport.New(EntryLineCollection.AddNew(), Factory);
