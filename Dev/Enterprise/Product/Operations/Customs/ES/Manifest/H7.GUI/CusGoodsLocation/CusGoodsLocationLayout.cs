...
namespace Enterprise.Customs.ES.Manifest.H7.GUI
{
	public sealed class CusGoodsLocationLayout : IPanelLayoutProviderWithExtensions
	{
		...
		PanelLayout CreateCusGoodsLocationLayout()
		{
			...
			builder.AddControlBehaviour<ZCodeFindBox>(commonBag.AuthorizationCodeFindBox, UpdateZCodeFindBoxControlShowDescriptionBox);

			return builder.Build();
		}

		void UpdateZCodeFindBoxControlShowDescriptionBox(ZCodeFindBox control, CusGoodsLocation cusGoodsLocation)
		{
			control.ShowDescriptionBox = true;
		}
	}
}
