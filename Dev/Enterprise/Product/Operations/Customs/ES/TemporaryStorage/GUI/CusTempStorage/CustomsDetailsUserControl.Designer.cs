namespace Enterprise.Customs.ES.TemporaryStorage.GUI
{
	partial class CustomsDetailsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.CustomsDetailsGroupBox.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("B589EA13-8FB3-438A-A769-9DFC0EC2CDD5", "Customs Details");
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_CustomsOfficeOfEntryIntoEU)));
			this.EntryCustomsOfficeCodeFindBox.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("212898DA-B87B-4669-8B76-FF3C8466148F", "Entry Customs Office");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_CustomsOffice)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_PreviousReferenceType)));
			this.PreviousRefTypeDropEdit.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("C55102C1-85EA-4745-BF84-277C6D25E3E0", "Previous Ref. Type");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_PreviousReferenceNumber)));
			this.PreviousRefNumTextBox.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("845258BE-6E8B-489C-9927-1C229B480277", "Previous Ref. Number");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_NCTSFlag)));
			this.NCTSFlagCheckBox.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("333FA759-007D-406C-8824-78FA9CA83C78", "NCTS-Flag");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_AdditionalInformation)));
			this.AdditionalInfoTextBox.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("A40A63DD-AE70-4703-8BAD-B75D4ADB777C", "Additional Information");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.ES.Business.CusTempStorage.CusTempStorageJobHeader)(null)).SJH_PresentationDate)));
			this.PresentationDateDateEdit.CaptionResourceString = Enterprise.Customs.ES.TemporaryStorage.GUI.Res.GetData("54992B62-6819-4B75-A636-0C49297600AD", "Presentation Date");
