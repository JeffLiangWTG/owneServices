...
{
	public class TNNNCTS5CommodityWrapperTest : WrapperHelperTest<TNNNCTS5CommodityWrapper>
	{
		public void TestDangerousGoods()
		{
			CombineAssertions(() =>
			{
				...
				wrapper = new TNNNCTS5CommodityWrapper(goodsItem);
		...
		TNNNCTS5CommodityWrapper wrapper;

		protected override TNNNCTS5CommodityWrapper GetProvider() => wrapper;
	}
}
