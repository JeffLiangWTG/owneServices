...
sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
{
	...
	public void IsRuleB1858_1Active()
	{
	...
	public void TestIsRuleB5R410Active()
	{
	...
	{
		AssertEquals(false, validationDecider.IsRuleE1103Active);
	}
	...
	{
		AssertEquals(true, validationDecider.IsRuleNR0080Active);
	}
	...
	{
		AssertEquals(expected: true, validationDecider.IsRuleTR0050Active);
	}

	public void TestIsRuleTR0051Active()
	{
		AssertEquals(true, validationDecider.IsRuleTR0051Active);
	}

	public void TestIsRuleTR0053Active()
	{
		AssertEquals(true, validationDecider.IsRuleTR0053Active);
	}
	...
	{
		AssertEquals(false, validationDecider.IsRuleTR0092Active);
	}
