...
namespace Enterprise.Customs.ES.NCTS.Messaging.MessageBuilders.Testing
{
	...
	public class ArrivalAVOMessageBuilderTest : ArrivalBaseMessageBuilderTest
	{
		protected override ZString ExpectedMessageType => DeclarationMessageTypeList.Codes.NctsArrivalNotificationWithUnloadingRemarksAviPlusObs;
		...
		protected override ZString GetTestFile() => GetTestFileContents(NCTSTestFileConstants.TestFilePath, "TestArrivalAVOMessage.txt");
