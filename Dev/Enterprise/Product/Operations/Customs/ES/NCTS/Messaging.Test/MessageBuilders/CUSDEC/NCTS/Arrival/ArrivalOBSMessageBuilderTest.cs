...
namespace Enterprise.Customs.ES.NCTS.Messaging.MessageBuilders.Testing
{
	...
	public class ArrivalOBSMessageBuilderTest : ArrivalBaseMessageBuilderTest
	{
		protected override ZString ExpectedMessageType => DeclarationMessageTypeList.Codes.NctsUnloadingRemarks;

		protected override ZBool IsOnlyArrivalNotification => false;

		protected override ZBool IsOnlyUnloadingRemarks => true;

		protected override ZBool IsArrivalWithAVI => false;

		protected override ZBool IsArrivalWithOBS => true;

		protected override ZBool IsArrivalWithTNN => false;

		protected override ZString GetTestFile() => GetTestFileContents(NCTSTestFileConstants.TestFilePath, "TestArrivalOBSMessage.txt");
		...
		public override void TestAddCSTSegmentOnSG30_NoGoodsCustomsProcedureCategory1()
		{
			...
			AssertContains("CST+1+++M3:ZZZ:148+HB12345678901+12345678'", messageText);
		}
		...
		public override void TestAddCSTSegmentOnSG30_NoGoodsCustomsProcedureCategory3()
		{
			...
			var messageText = CreateMessageBuilder().GetSignedMessageText();
			AssertContains("CST+1+88033090:122:148+++HB12345678901+12345678'", messageText);
		}
		...
		public override void TestAddCSTSegmentOnSG30_NoGoodsCustomsProcedureCategory4()
		{
			...
			var messageText = CreateMessageBuilder().GetSignedMessageText();
			AssertContains("CST+1+88033090:122:148++M3:ZZZ:148++12345678'", messageText);
		}
		...
		public override void TestAddCSTSegmentOnSG30_NoGoodsCustomsProcedureCategory5()
		{
			...
			var messageText = CreateMessageBuilder().GetSignedMessageText();
			AssertContains("CST+1+88033090:122:148++M3:ZZZ:148+HB12345678901'", messageText);
		}
