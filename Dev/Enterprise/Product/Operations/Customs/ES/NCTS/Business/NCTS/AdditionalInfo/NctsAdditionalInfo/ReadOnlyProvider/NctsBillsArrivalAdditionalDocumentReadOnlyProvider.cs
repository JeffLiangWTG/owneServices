...
namespace Enterprise.Customs.ES.NCTS.Business
{
	...
	{
		public NctsBillsArrivalAdditionalDocumentReadOnlyProvider(NctsBillAdditionalDocument additionalDocument, IAdditionalDocumentReadOnlyProvider baseReadOnlyProvider)
		{
		...
		NctsArrivalMovementHeader NctsArrivalMovementHeader => ((NctsBill)additionalDocument.Parent).Header.ArrivalMovementHeader;
	}
}
