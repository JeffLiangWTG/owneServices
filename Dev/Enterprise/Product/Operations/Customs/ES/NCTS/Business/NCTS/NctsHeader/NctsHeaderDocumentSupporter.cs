...
namespace Enterprise.Customs.ES.NCTS.Business
{
	public class NctsHeaderDocumentSupporter : EU.NCTS.Business.NctsHeaderDocumentSupporter
	{
		...
		DocumentWrapper[] CreateDocumentWrappers(DataContext dataContext, BusinessObject businessObjectToWrap)
		{
			...
			return new[] { DocumentWrapperFactory.CreateWrapperWithoutException(wrapperStrongName, businessObjectToWrap, DocumentWrapperConstants.DocumentWrappersAssembly) }
					.WhereNotNull()
					.ToArray();
		}
		...
		{
			{ DataContext.EuNcts,  DocumentWrapperConstants.NctsHeaderDocumentWrapperType },
