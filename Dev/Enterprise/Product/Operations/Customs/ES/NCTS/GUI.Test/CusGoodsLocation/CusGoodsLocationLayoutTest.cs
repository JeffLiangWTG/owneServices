...
namespace Enterprise.Customs.ES.NCTS.GUI.Testing
{
	...
	sealed class CusGoodsLocationLayoutTest : LayoutsAbstractTest
	{
		...
		public void TestTypeVisibility_Phase5ArrivalIncident()
		{
			...
			var location = (NctsCusGoodsLocation)nctsHeader.EnRouteIncidents.AddNew().GoodsLocation;
		...
		{
			var location = Factory.New<NctsCusGoodsLocation>();
			var layout = ((IPanelLayoutProvider)new CusGoodsLocationLayout()).Layout;
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new CusGoodsLocationLayoutBuilder<NctsCusGoodsLocation>();
