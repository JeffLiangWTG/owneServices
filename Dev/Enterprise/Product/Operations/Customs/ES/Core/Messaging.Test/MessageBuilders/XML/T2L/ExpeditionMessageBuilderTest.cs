...
{
	[TestedType(typeof(ExpeditionMessageBuilder))]
	public class ExpeditionMessageBuilderTest : T2LExpeditionCommonMessageBuilderTest<ExpeditionMessageBuilder, IExpeditionMessageDataProvider, T2LexpedicionV2Ent, IExpeditionHeader, IExpeditionLine>
	{
		...
		protected override ZString ExpectedMessageType => DeclarationMessageTypeList.Codes.T2lExpedition;

		protected override ZString GetSignedMessageTestFileContent() => GetTestFileContents(XMLTestFileConstants.T2LTestFilePath, "TestExpeditionMessageSigned.txt");
		protected override ZString GetUnsignedMessageTestFileContent() => GetTestFileContents(XMLTestFileConstants.T2LTestFilePath, "TestExpeditionMessage.txt");

		protected override ExpeditionMessageBuilder CreateMessageBuilder() => MockRandomGenerator(new ExpeditionMessageBuilder(mockProvider.Object, ExpectedMessageType, ExpectedMessageSubType));
		protected override ExpeditionMessageBuilder CreateMessageBuilderWithNullProvider() => new ExpeditionMessageBuilder(default, ExpectedMessageType, ExpectedMessageSubType);

		protected Mock<IExpeditionHeader> mockHeader;
		...
		protected Mock<IExpeditionHeader> SetUpCommonHeader()
		{
			var mockHeader = new Mock<IExpeditionHeader>();
