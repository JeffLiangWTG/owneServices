...
[TestedType(typeof(ExpAmendmentG5MessageBuilder))]
class ExpAmendmentG5MessageBuilderTest : G5CommonMessageBuilderTest<ExpAmendmentG5MessageBuilder, IExpAmendmentG5MessageDataProvider, G5ExpAmendV1Ent>
{
	#region Test
	...
	protected override ZString ExpectedMessageType => DeclarationMessageTypeList.Codes.G5v1ExpeditionAmendment;

	protected override ExpAmendmentG5MessageBuilder CreateMessageBuilder() => MockRandomGenerator(new ExpAmendmentG5MessageBuilder(mockProvider.Object, ExpectedMessageType, ExpectedMessageSubType));

	protected override ExpAmendmentG5MessageBuilder CreateMessageBuilderWithNullProvider() => new ExpAmendmentG5MessageBuilder(default, ExpectedMessageType, ExpectedMessageSubType);

	protected override ZString GetTestFile() => GetTestFileContents(XMLTestFileConstants.G5TestFilePath, "TestG5ExpAmendmentMessage.txt");
