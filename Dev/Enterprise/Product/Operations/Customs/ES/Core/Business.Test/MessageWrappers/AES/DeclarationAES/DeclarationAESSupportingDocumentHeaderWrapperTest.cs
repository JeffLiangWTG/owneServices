...
{
	public class DeclarationAESSupportingDocumentHeaderWrapperTest : WrapperHelperTest<DeclarationAESSupportingDocumentHeaderWrapper>
	{
		public void TestConstructor()
		{
			AssertExceptionThrown("Constructor Throws Exception if doc is null", typeof(NullReferenceException),
			"Object reference not set to an instance of an object.", () => new DeclarationAESSupportingDocumentHeaderWrapper(null, 0));
		}
		...
		DeclarationAESSupportingDocumentHeaderWrapper wrapper;

		DeclarationAESSupportingDocumentHeaderWrapper GetWrapper(SupportingDocument doc, ZShort seqNum) => new DeclarationAESSupportingDocumentHeaderWrapper(doc, seqNum);

		protected override DeclarationAESSupportingDocumentHeaderWrapper GetProvider() => wrapper;
	}
}
