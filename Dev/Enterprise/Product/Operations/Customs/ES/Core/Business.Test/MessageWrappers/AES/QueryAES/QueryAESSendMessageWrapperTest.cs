...
{
	public class QueryAESSendMessageWrapperTest : WrapperHelperTest<QueryAESSendMessageWrapper>
	{
		...
		protected override void SetUp()
		{
			...
			wrapper = new QueryAESSendMessageWrapper(entryHeader, Certificate);
		}

		QueryAESSendMessageWrapper wrapper;

		protected override QueryAESSendMessageWrapper GetProvider() => wrapper;
	}
}
