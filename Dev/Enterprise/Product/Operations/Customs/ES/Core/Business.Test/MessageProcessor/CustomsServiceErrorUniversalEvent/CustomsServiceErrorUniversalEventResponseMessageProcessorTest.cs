...
{
	public class CustomsServiceErrorUniversalEventResponseMessageProcessorTest : ESCommonResponseMessageProcessorTest<CustomsServiceErrorUniversalEventResponseMessageProcessor, BusinessObject, UniversalEventWrapper>
	{
		...
		protected override CustomsServiceErrorUniversalEventResponseMessageProcessor GetNewResponseMessageProcessor(LoggingInformation logger) => new CustomsServiceErrorUniversalEventResponseMessageProcessor(logger);

		protected override ZString GetExpectedProcessorFriendlyName() => "Customs Service Error UniversalEvent Declaration Message Processor";

		protected override ZString[] GetExpectedProcessorMessageTypesToInclude() => new ZString[] { DeclarationMessageTypeList.Codes.CustomsServiceErrorUniversalEvent, DeclarationMessageTypeList.Codes.CustomsServiceErrorUniversalEventBadRequest };
		...
		{
			return ESTestFileReader.GetEmbeddedFileText(MessageProcessorTestFileConstants.CustomsServiceErrorUniversalEventTestFilePath, "ServiceErrorUniversalEventMessage.txt");
		}
	}
}
