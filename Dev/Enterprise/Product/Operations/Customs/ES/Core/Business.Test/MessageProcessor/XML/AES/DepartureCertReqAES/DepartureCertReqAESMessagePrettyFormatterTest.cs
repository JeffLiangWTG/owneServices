...
{
	public class DepartureCertReqAESMessagePrettyFormatterTest : TestCaseWithFactory
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentNullException>("Null response", () => new DepartureCertReqAESMessagePrettyFormatter(null));
		}

		public void TestCreateMessageDetailsAcceptedDeclaration()
		{
			var declarationResponse = new Cccsecv1Sal();
			declarationResponse.DatosRespuestaCorrecta = new DatosRespuestaCorrectaTypeCsec()
			{
				Mrn = "21ES00999912345678",
				CsvCertificadoSalida = "3AG5G6SSCJJ93NML",
				CsvDeclaracionElectronica = "ABCDEFGHIJKLMNOP",
				EstadoAes = "SA"
			};

			var messagePrettyFormatter = new DepartureCertReqAESMessagePrettyFormatter(declarationResponse);
			...
			var expectedMessageInterpretation = "<H3>Accepted Declaration</H3>" +
				...
				"<br><table border=\"0\"><tr><td>CSV Exit Certificate:</td><td>&nbsp;&nbsp;</td><td>3AG5G6SSCJJ93NML</td></tr></table>" +
		...
		{
			var declarationResponse = new Cccsecv1Sal();
			declarationResponse.ControlRespuesta = new Cccsecv1SalControlRespuesta()
			{
				TipoRespuesta = "EF"
			};
