...
{
	public class T2LClearanceDocumentRequestTest : EntryHeaderDocumentRequestTest<T2LClearanceDocumentRequest>
	{
		...
		public void TestRequestMissingDocuments_CLRDoc_WithBroker()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertDocumentRequestEDIMessage(businessObject, T2C_MRN + "_I_AEAT_T2L_CLR.pdf", "34YEUXEP8E7GE9XD", certificate.CertificatePK);

				AssertNoDuplicatedDocumentRequests(T2C_MRN + "_I_AEAT_T2L_CLR.pdf", "34YEUXEP8E7GE9XD", certificate.CertificatePK);
			});
		}
		...
		public void TestRequestMissingDocuments_CLRDoc_WithoutBroker()
		{
			CombineAssertions(() =>
			{
				...
				AssertDocumentRequestEDIMessage(businessObject, T2C_MRN + "_I_AEAT_T2L_CLR.pdf", "34YEUXEP8E7GE9XD", ZGuid.Empty);

				AssertNoDuplicatedDocumentRequests(T2C_MRN + "_I_AEAT_T2L_CLR.pdf", "34YEUXEP8E7GE9XD", ZGuid.Empty);
			});
		}
		...
		protected override T2LClearanceDocumentRequest GetDocumentRequestClass(CusEntryHeader businessObject, ZString certName) => new T2LClearanceDocumentRequest(businessObject, certName);
