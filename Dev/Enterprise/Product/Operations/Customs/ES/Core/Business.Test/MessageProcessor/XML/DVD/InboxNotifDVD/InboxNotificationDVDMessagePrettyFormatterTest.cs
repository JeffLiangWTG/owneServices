...
using TdRespuesta = CargoWise.Customs.ES.MessageDefinitions.Version1.DVD.ActivaPDCVinculacionV1Sal.TdRespuesta;

namespace Enterprise.Customs.ES.Business.Testing
{
	public class InboxNotificationDVDMessagePrettyFormatterTest : TestCaseWithFactory
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentNullException>("Null response", () => new InboxNotificationDVDMessagePrettyFormatter(null));
		}
		...
		public void TestCreateMessageDetailsAcceptedCompleteDeclaration()
		{
			...
			var declarationResponse = SetResponseData("DVD", "0", "22ES009999D04136R3", TdCircuito.V, TdCircuito.R, "MYT5CUUEVP4QF7CJ", "20221002", "131240", 0.31m, 0.13m, guaranteesAEAT, guaranteesATC, goodsItems);
		...
		{
			var declarationResponse = new ActivaPdcVinculacionV1Sal();
			...
			var messagePrettyFormatter = new InboxNotificationDVDMessagePrettyFormatter(declarationResponse);
		...
		{
			var declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
			var messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);

			var expectedDVDTypeText = "<H3>Accepted Declaration</H3><table border=\"0\"><tr><td>Declaration Type:</td><td>&nbsp;&nbsp;</td><td>DVD - Into Warehouse Declaration</td></tr></table><br><br>";
			var expectedIDATypeText = "<H3>Accepted Declaration</H3><table border=\"0\"><tr><td>Declaration Type:</td><td>&nbsp;&nbsp;</td><td>IDA - Into Declarant's Records Warehouse Declaration</td></tr></table><br><br>";
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData("DVD", ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				...
				declarationResponse = SetResponseData("IDA", ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestOperationData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, "0", ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test 0 Operation", expected0OperationText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, "1", ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test 1 Operation", expected1OperationText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, "2", ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test 2 Operation", expected2OperationText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, "3", ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestCircuitAEATData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, TdCircuito.V, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test Green Circuit", expectedGreenCircuitText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, TdCircuito.N, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test Orange Circuit", expectedOrangeCircuitText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, TdCircuito.R, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestCircuitATCData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, TdCircuito.V, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test Green Circuit ATC", expectedGreenCircuitText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, TdCircuito.N, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test Orange Circuit ATC", expectedOrangeCircuitText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, TdCircuito.R, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestCSVClearanceData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, "3AG5G6SSCJJ93NML", ZString.Empty, ZString.Empty, null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestReleaseDate()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, "3AG5G6SSCJJ93NML", "20210220", "055030", null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, "20210220", "055030", null, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestGuaranteedTotalData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, 0.31m, null, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestATCGuaranteedTotalData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, 0.31m, null, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestGuaranteesData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, guaranteesAEAT, null, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test GuaranteesAEAT data", expectedGuaranteesAEATText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, guaranteesATC, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test GuaranteesATC data", expectedGuaranteesATCText, messageInterpretationText);

				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, guaranteesAEAT, guaranteesATC, null);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
		...
		public void TestTaxesAndFeesResponseData()
		{
			...
			CombineAssertions(() =>
			{
				...
				declarationResponse = SetResponseData(ZString.Empty, ZString.Empty, ZString.Empty, null, null, ZString.Empty, ZString.Empty, ZString.Empty, null, null, null, null, goodsItems);
				messageInterpretationText = GetAcceptedInterpretationText(declarationResponse);
				AssertContains("Test TaxesAndFeesResponse data", expectedTaxesAndFeesResponseText, messageInterpretationText);
			});
		}

		ZString GetAcceptedInterpretationText(ActivaPdcVinculacionV1Sal response)
		{
			var messagePrettyFormatter = new InboxNotificationDVDMessagePrettyFormatter(response);
			return messagePrettyFormatter.CreateMessageDetailsAccepted();
		}

		ActivaPdcVinculacionV1Sal SetResponseData(ZString declarationType, ZString operationCode, ZString mrn, TdCircuito? circuitAEAT, TdCircuito? circuitATC, ZString csvClearance, ZString csvClearanceDate, ZString csvClearanceTime,
		...
		{
			var response = new ActivaPdcVinculacionV1Sal();
