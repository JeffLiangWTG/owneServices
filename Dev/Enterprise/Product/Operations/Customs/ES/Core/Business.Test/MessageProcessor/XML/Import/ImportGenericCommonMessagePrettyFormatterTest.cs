...
{
	class ImportGenericCommonMessagePrettyFormatterTest : TestCaseWithFactory
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentNullException>("Null response", () => new ImportGenericCommonMessagePrettyFormatter<IImportCommon>(null, Factory.New<CusEntryHeader>()));
			AssertExceptionThrown<ArgumentNullException>("Null entry header", () => new ImportGenericCommonMessagePrettyFormatter<IImportCommon>(new ImportacionCompletaV1Sal(), null));
		}
		...
		public void TestCreateMessageDetailsAcceptedCompleteDeclarationNotDeferred()
		{
			...
			var declarationResponse = new ImportacionCompletaV1Sal();
			...
			declarationResponse.NumJustificantePagoAtc = "JUSTPAGOATC";
			...
			var messagePrettyFormatter = new ImportGenericCommonMessagePrettyFormatter<IImportCommon>(declarationResponse, entryHeader);
			...
			var expectedMessageInterpretation = "<H3>Accepted Declaration</H3>" +
					...
					"<tr><td>Payment date limit:</td><td>&nbsp;&nbsp;</td><td>25-10-2022</td></tr>" +
