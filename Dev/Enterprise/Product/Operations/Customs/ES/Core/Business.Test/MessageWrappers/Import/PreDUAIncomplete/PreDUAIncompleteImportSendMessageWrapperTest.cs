...
{
	[TestedType(typeof(PreDUAIncompleteImportSendMessageWrapper))]
	class PreDUAIncompleteImportSendMessageWrapperTest : ImportCommonSendMessageWrapperAbstractTest<PreDUAIncompleteImportSendMessageWrapper>
	{
		public void TestConstructorPreDUAIncomplete()
		{
		...
		protected override PreDUAIncompleteImportSendMessageWrapper GetWrapper(CusEntryHeader cusEntryHeader, ICertificateProvider certificateData) => new PreDUAIncompleteImportSendMessageWrapper(cusEntryHeader, certificateData);
	}
}
