...
sealed class GuidedDecisionMakingSingleInvoiceLineSourceTest : TestCaseWithFactory
{
	public void TestDestinationStateIsCanaryIsland() => CombineAssertions(() =>
	{
		...
		var gdmSourceWrapper = new GuidedDecisionMakingSingleInvoiceLineSource(noDecInvLine);
		...
		using (CustomsFunctionalityTemporarySetterHelper.SetESFUNCSImportMessageVersionUCC6(false))
		{
			...
			gdmSourceWrapper = new GuidedDecisionMakingSingleInvoiceLineSource(line);
