...
{
	class RequestAndReceptionT2LPOUSMessagePrettyFormatterTest : TestCaseWithFactory
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentNullException>("Null response", () => new RequestAndReceptionT2LPOUSMessagePrettyFormatter(null));
		}
		...
		{
			var declarationResponse = new Iep01SalType();
			...
			var messagePrettyFormatter = new RequestAndReceptionT2LPOUSMessagePrettyFormatter(declarationResponse);
		...
		Iep01SalType SetResponseData(ZString acceptanceDate, ZString mrn, ZString circuit, ZString declarationCSV, ZString csvCode)
		{
			var response = new Iep01SalType();
			...
			response.Csvt2L = csvCode;
			response.CsVeDeclaration = declarationCSV;
			return response;
		}

		ZString GetAcceptedInterpretationText(Iep01SalType response)
		{
			var messagePrettyFormatter = new RequestAndReceptionT2LPOUSMessagePrettyFormatter(response);
