...
class ImportH1CommonRepresentativeWrapperWithContactPersonTest : WrapperHelperTest<ImportH1CommonRepresentativeWrapperWithContactPerson>
{
	public void TestGetNewCommonRepresentativeWrapper()
	{
		CombineAssertions(() =>
		{
			...
			AssertNull("Declaration with JE_DeclarantType = 1, result null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_OA_Representative = orgAddress.PK;
			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._2Direct;
			AssertNotNull("Declaration with JE_DeclarantType = 2 with representant, result not null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._3Indirect;
			AssertNull("Declaration with JE_DeclarantType = 3 with representant, result null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._2Direct;
			declaration.JE_OA_DeclarantAddress = orgAddress.PK;
			declaration.JE_OA_Representative = ZGuid.Empty;
			AssertNotNull("JobDeclaration with representant is null and declarant not null and JE_DeclarantType = 2, result not null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._5IndirectATC;
			declaration.JE_OA_DeclarantAddress = ZGuid.Empty;
			AssertNull("JobDeclaration with representant and declarant is null and JE_DeclarantType = 5, result null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_OA_Representative = orgAddress.PK;
			AssertNotNull("JobDeclaration with representant is not null and declarant is null and JE_DeclarantType = 5, result not null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			declaration.JE_OA_DeclarantAddress = orgAddress.PK;
			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._2Direct;
			AssertNotNull("JobDeclaration with representant is not null and declarant is not null and JE_DeclarantType = 2, result not null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration));

			AssertNull("JobDeclaration without DeclarationType", ImportH1CommonRepresentativeWrapperWithContactPerson.New(Factory.New<JobDeclaration>()));

			AssertNull("JobDeclaration with null", ImportH1CommonRepresentativeWrapperWithContactPerson.New(null));
		});
	}
	...
	public void TestIdForRepresentativeOrDeclarantWhenRepresentativeTypeEqualTo2Or5()
	{
		CombineAssertions(() =>
		{
			...
			declaration.JE_OA_Representative = ZGuid.Empty;
			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._2Direct;
			var wrapper = ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration);
			...
			declaration.JE_DeclarantType = ESRepresentationTypeList.Codes._2Direct;
			wrapper = ImportH1CommonRepresentativeWrapperWithContactPerson.New(declaration);
	...
	ImportH1CommonRepresentativeWrapperWithContactPerson wrapper;
	JobDeclaration declaration;

	protected override ImportH1CommonRepresentativeWrapperWithContactPerson GetProvider() => wrapper;
}
