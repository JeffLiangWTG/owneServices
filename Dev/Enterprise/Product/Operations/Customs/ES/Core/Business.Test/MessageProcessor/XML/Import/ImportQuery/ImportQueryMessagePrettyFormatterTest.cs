...
{
	class ImportQueryMessagePrettyFormatterTest : TestCaseWithFactory
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentNullException>("Null response", () => new ImportQueryMessagePrettyFormatter(null, Factory.New<CusEntryHeader>()));
			AssertExceptionThrown<ArgumentNullException>("Null entry header", () => new ImportQueryMessagePrettyFormatter(new ConsultaImportacionV2Sal(), null));
		}

		public void TestCreateMessageDetailsAcceptedCompleteDeclarationNotDeferredAEAT()
		{
			...
			var declarationResponse = new ConsultaImportacionV2Sal();
			declarationResponse.Administracion = "AEAT";
			declarationResponse.TipoDeDeclaracion = "DUA";
			declarationResponse.DescripTipoDeDeclaracion = "Declaración Completa de Importación";
			...
			declarationResponse.DescripEstadoContable = "Contractado";
			declarationResponse.TienePendenciasSinUltimar = "N";
			declarationResponse.DescripPendenciasSinUltimar = "No tiene";
			...
			declarationResponse.NumJustificantePago = "JUSTPAGO";
			...
			line1.C47TributoLiquidado = new Collection<Cas47TributoLiquidadoTd> { tribute1 };
			...
			var messageInterpretationText = GetAcceptedInterpretationText(declarationResponse, entryHeader);

			AssertEquals("<H3>Accepted Declaration</H3><br><table border=\"0\"></table><table border=\"0\"></table><br><table border=\"0\"></table><br>" +
					...
					"<table border=\"0\"><tr><td>Payment Proof Number:</td><td>&nbsp;&nbsp;</td><td>JUSTPAGO</td></tr>" +
					"<tr><td>Payment date limit:</td><td>&nbsp;&nbsp;</td><td>25-10-2022</td></tr></table><br>" +
					...
					"<tr><td>AEAT</td><td>16ESAGL9990000095</td><td>1.15</td><td>1.15</td><td>1.15</td></tr></table>" +
					...
					"<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Total: </td><td>363.90</td><td>363.90</td></tr></table><br>" +
					...
					"<tr><td>2</td><td>SNM</td><td>SIF06 -  Sanidad Interior - M&#186; Sanidad</td><td>N853, C657, C678, 1405, 1413, C640</td></tr>" +
					"</table>", messageInterpretationText);
		}

		public void TestCreateMessageDetailsAcceptedCompleteDeclarationNotDeferredATC()
		{
			var helper = new Universal.Testing.UniversalReferenceTestDataHelper(Factory);
			helper.CreateCusMapType(Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsUQ, MapDirectionList.Codes.BTH, "Description", false);
			helper.CreateCusMap(Core.Constants.Customs.Universal.RefCusCodeListTypes.Codes.CustomsUQ, "KGM", "KN", ZDateTime.BrettsBirthday, ZDateTime.Now.AddMonths(2), CountryCodes.Spain);
			...
			entryHeader.TotalAmount = 1.15;
			var declarationResponse = new ConsultaImportacionV2Sal();
			declarationResponse.Administracion = "ATC";
			declarationResponse.TipoDeDeclaracion = "DUA";
			declarationResponse.DescripTipoDeDeclaracion = "Declaración Completa de Importación";
			declarationResponse.EstadoDelDespacho = "L";
			declarationResponse.DescripEstadoDelDespacho = "Accepted with Customs Clearance";
			...
			declarationResponse.TotalAgarantizar = 1.15M;
			declarationResponse.TotalIvAdiferido = 1.15M;
			declarationResponse.NumJustificantePago = "JUSTPAGOATC";
			declarationResponse.FechaLimitePago = "20221025";
			...
			var tribute1 = SetTribute("3IG", 42.560M, 2.700000M, "MA", "%", 1.15M, 1.15M);
			line1.C47TributoLiquidado = new Collection<Cas47TributoLiquidadoTd> { tribute1 };
			...
			var tribute3 = SetTribute("400", 1219.350M, 17.600000M, ZString.Empty, "%", 214.61M, 214.61M);
			var tribute4 = SetTribute("300", 1481.380M, 10.000000M, ZString.Empty, "%", 148.14M, 148.14M);
			line2.C47TributoLiquidado = new Collection<Cas47TributoLiquidadoTd> { tribute3, tribute4 };
			...
			AssertEquals("<H3>Accepted Declaration</H3><br><table border=\"0\"></table><table border=\"0\"></table><br><table border=\"0\"></table><br>" +
					...
					"<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" class=\"table\">" +
					"<thead><tr class=\"tableheadings\"><th>Customs</th><th>GRN</th><th>Real Debt</th><th>Potential Debt</th><th>Undetermined Real Debt</th></tr></thead>" +
					"<tr><td>ATC</td><td>16ESAGL9990000096</td><td>45.13</td><td>0</td><td>0</td></tr>" +
					"<tr><td>ATC</td><td>16ESAGL9990000095</td><td>1.15</td><td>1.15</td><td>1.15</td></tr></table>" +
					"<br><br><H2>Taxes and fees response (Spanish Customs)</H2><br>" +
					"<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" class=\"table\">" +
					"<thead><tr class=\"tableheadings\"><th>Item</th><th>Type</th><th>MAX/MIN Rate</th><th>Base Amount</th><th>Tax Rate</th><th>Total Amount</th><th>Total Guaranteed Amount</th></tr></thead>" +
					"<tr><td>1</td><td>3IG</td><td>MA</td><td>42.560</td><td>2.700000 %</td><td>1.15</td><td>1.15</td></tr>" +
					"<tr><td>2</td><td>400</td><td>&nbsp;</td><td>1219.350</td><td>17.600000 %</td><td>214.61</td><td>214.61</td></tr>" +
					"<tr><td>2</td><td>300</td><td>&nbsp;</td><td>1481.380</td><td>10.000000 %</td><td>148.14</td><td>148.14</td></tr>" +
					"<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Total: </td><td>363.90</td><td>363.90</td></tr></table><br>" +
					"<br><H2>Required Certificates</H2><br>" +
					"<table border=\"1\" cellpadding=\"1\" cellspacing=\"0\" class=\"table\">" +
					"<thead><tr class=\"tableheadings\"><th>Item</th><th>Measure</th><th>Agency</th><th>Documents</th></tr></thead>" +
		...
		public void TestCreateMessageDetailsRejected()
		{
			...
			var messagePrettyFormatter = new ImportQueryMessagePrettyFormatter(declarationResponse, entryHeader);
		...
		public void TestGuaranteeStatusData()
		{
			...
			var expectedGuaranteeStatusText = "<tr><td>Guarantee Status:</td><td>&nbsp;&nbsp;</td><td>Status from processor</td></tr>";
		...
		ZString GetAcceptedInterpretationText(ConsultaImportacionV2Sal declarationResponse, CusEntryHeader entryHeader)
		{
			var messagePrettyFormatter = new ImportQueryMessagePrettyFormatter(declarationResponse, entryHeader);
			return messagePrettyFormatter.CreateMessageDetailsAccepted("GuaranteeStatus:Not written Off (status not IT)*");
		}
