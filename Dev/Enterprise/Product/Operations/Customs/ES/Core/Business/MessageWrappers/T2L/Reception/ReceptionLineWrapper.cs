...
public class ReceptionLineWrapper : IT2LLineCommon
{
	public ReceptionLineWrapper(CusEntryLine cusEntryLine)
	{
	...
	public ZString GoodsCode => entryLine.RandomLine.JI_Tariff.SubstringSafe(0, 8);
