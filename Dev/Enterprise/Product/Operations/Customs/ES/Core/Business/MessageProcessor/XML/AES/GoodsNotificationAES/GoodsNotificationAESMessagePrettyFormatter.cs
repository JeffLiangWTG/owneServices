...
{
	public class GoodsNotificationAESMessagePrettyFormatter : AESCommonMessagePrettyFormatter, IMessagePrettyFormatter
	{
		public GoodsNotificationAESMessagePrettyFormatter(Cc511Cv1Sal response)
		{
			this.response = Argument.NotNull(response, nameof(response));
		}
		readonly Cc511Cv1Sal response;
