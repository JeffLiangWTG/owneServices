...
{
	public static class EdifactProcessorHelper
	{
		...
		public static ICUSRESMessageProvider ProcessEdifactErrorResponse(EDIMessage message)
		{
			using (var textReader = message.GetEM_MessageTextReader())
			{
				...
				return new EdifactErrorMessageHelper(message.Factory, errorResponse.DeclarationStatus, errorResponse.ErrorStatus);
			}
		}
	}
}
