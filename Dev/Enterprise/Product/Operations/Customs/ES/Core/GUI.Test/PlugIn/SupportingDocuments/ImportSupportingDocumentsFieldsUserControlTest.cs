...
{
	sealed class ImportSupportingDocumentsFieldsUserControlTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			control = new ImportSupportingDocumentsFieldsUserControl();
		}
		...
		ImportSupportingDocumentsFieldsUserControl control;
	}
}
