...
sealed class InvoiceLineExportSupportingDocumentsFieldsControlTest : TestCaseWithFactory
{
	...
	IEnumerable<(string ControlName, int TabIndex, Type ControlType)> FieldsDetails => new (string, int, Type)[]
	{
		...
		("PackQuantityAndUnitUserControl", 7, typeof(PackQuantityAndUnitUserControl)),
	};

	protected override void SetUp()
	{
		base.SetUp();
		control = new InvoiceLineExportSupportingDocumentsFieldsControl();
	}
	...
	InvoiceLineExportSupportingDocumentsFieldsControl control;
}
