namespace Enterprise.Customs.ES.GUI
{
	partial class JobDeclarationUserControl
	{
		...
		void InitializeComponent()
		{
			...
			this.CTStatusIDDropEdit.TabIndex = 7;
			// 
			// BadgeCodeDropEdit
			// 
			...
			// 
			this.GoodsLocationDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(115, 143, true);
			...
			// 
			this.BindingSource.SetBindingMember(this.EarliestCustomsIssueDateEdit, "LatestEntryAcceptanceDate");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.ES.Business.Declaration.JobDeclaration)(null)).LatestEntryAcceptanceDate)));
			// 
			// SpecificCircumstanceDropEdit
			// 
			this.SpecificCircumstanceDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(95, 214, true);
			this.SpecificCircumstanceDropEdit.TabIndex = 9;
			// 
			// CustomsOfficesUserControl
			// 
			this.CustomsOfficesUserControl.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(255, 732, true);
			this.CustomsOfficesUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(468, 140, true);
			...
			this.IsHighValueOvrdCheckBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(95, 260, true);
			// 
			// JE_ContainerModeBoundDropDownEdit
			// 
			this.JE_ContainerModeBoundDropDownEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(95, 126, true);
			...
			// 
			this.GoodsDescriptionTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(115, 118, true);
			this.GoodsDescriptionTextBox.TabIndex = 9;
			// 
			// ShipmentDetailsGroupBox
			// 
			this.ShipmentDetailsGroupBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(255, 374, true);
			this.ShipmentDetailsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(468, 352, true);
			// 
			// IncoTermDropEdit
			// 
			...
			// RightTabControl
			// 
			this.RightTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(329, 824, true);
			// 
			// JE_RS_NKServiceLevelBoundFindBox
			// 
			this.JE_RS_NKServiceLevelBoundFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(95, 148, true);
			this.JE_RS_NKServiceLevelBoundFindBox.TabIndex = 6;
			// 
			// DocsTabPage
			// 
			this.DocsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(321, 797, true);
			// 
			...
			// 
			this.JE_ApplicationCodeBoundDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(95, 192, true);
			this.JE_ApplicationCodeBoundDropEdit.TabIndex = 8;
			// 
			// TransportDetailsGroupBox
			// 
			this.TransportDetailsGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(468, 313, true);
			// 
			// BindingSource
			// 
			...
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1057, 894, true);
