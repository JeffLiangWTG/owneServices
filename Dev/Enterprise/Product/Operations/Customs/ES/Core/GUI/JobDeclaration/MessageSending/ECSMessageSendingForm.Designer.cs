...
{
	partial class ECSMessageSendingForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// SendButton
			// 
			this.SendButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(586, 424, true);
			// 
			// CancelButton2
			// 
			this.CancelButton2.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(682, 424, true);
			// 
			// MainStatusBar
			// 
