...
{
	public partial class SCDMessageUserControl
	{
		private void InitializeComponent()
		{
			...
			this.messagesGrid.GridId = "5054e568-0143-4e87-a8d4-949e1e21f85a";
			...
			// 
			// SCDMessageUserControl
			// 
			this.CaptionRenderingEnabled = false;
			this.Controls.Add(this.bottomPanel);
			this.Controls.Add(this.topPanel);
			this.Name = "SCDMessageUserControl";
