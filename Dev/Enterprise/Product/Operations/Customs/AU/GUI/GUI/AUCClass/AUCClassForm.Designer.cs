...
{
	public partial class AUCClassForm
	{
		void InitializeComponent()
		{
			this.label1 = new CargoWise.Windows.UI.KLabel();
			this.zTextBoxUnitOfQuantity = new Enterprise.ZArchitecture.ZTextBox();
			this.label2 = new CargoWise.Windows.UI.KLabel();
			this.zTextBoxFullDescription = new Enterprise.ZArchitecture.ZTextBox();
			this.SuspendLayout();
			// 
			// TreeView
			// 
			...
			// 
			this.zTextBoxUnitOfQuantity.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			...
			// 
			this.zTextBoxFullDescription.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)
			...
			this.Name = "AUCClassForm";
			this.Text = "Select an Import Tariff";
			this.VisibleChanged += new System.EventHandler(this.AUCClassForm_VisibleChanged);
