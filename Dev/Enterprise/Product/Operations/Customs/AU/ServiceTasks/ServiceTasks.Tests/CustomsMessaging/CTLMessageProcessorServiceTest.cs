...
{
	[TestedType(typeof(CTLMessageProcessorService))]
	sealed class CTLMessageProcessorServiceTest : BaseMultiCompanyCustomsMessagingServiceTest<CTLMessageProcessorService>
	{
		public void TestMessageProcessorServiceOverride()
		{
			AssertEquals(typeof(AUCCTLMessageProcessor), testServiceTask.ProcessTypeForTesting);
		}
