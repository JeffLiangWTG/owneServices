...
{
	partial class AirCargoDepotStandAloneFilterControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.grid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(728, 344, true);
			// 
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.AU.Declaration.Business.CusMAWB);
			// 
			// AirCargoDepotStandAloneFilterControl
			// 
			this.Name = "AirCargoDepotStandAloneFilterControl";
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(728, 560, true);
