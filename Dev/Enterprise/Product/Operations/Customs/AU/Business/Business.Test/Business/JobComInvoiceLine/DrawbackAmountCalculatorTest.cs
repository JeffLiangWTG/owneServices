...
{
	public class DrawbackAmountCalculatorTest : TestCaseWithFactory
	{
		[ExpectNoExceptions]
		...
		public void TestDrawbackMethodValueRateAndAmountWithDeclarationLinkedToConsolidatedEntry()
		{
			...
			leadDeclaration.JE_OH_Importer = importer1.PK;

			var leadInvoiceHeader = leadDeclaration.Invoices.AddNew();
			var leadInvoiceLine1 = leadInvoiceHeader.JobComInvoiceLines.AddNew();
			leadInvoiceLine1.JI_LineNo = 1;
			var leaderEntryHeader = leadDeclaration.CustomsEntryHeaders[0];
			leaderEntryHeader.EntryNumber = "AAAGMM44C";
			var leadEntryLine1 = leaderEntryHeader.AllEntryLines.AddNew();
			leadEntryLine1.CL_LineNumber = 1;
			leadEntryLine1.ZA_AggregateEntryLineNumber = 1;
			leadEntryLine1.InvoiceLines.Add(leadInvoiceLine1);
			leadDeclaration.EntryHeader.MergedLines.Add(leadEntryLine1);

			var leadEntryLine2 = leaderEntryHeader.AllEntryLines.AddNew();
			leadEntryLine2.CL_LineNumber = 2;
			leadEntryLine2.ZA_AggregateEntryLineNumber = 2;
			leadEntryLine2.CL_CustomsValue = 1000m;
			leadEntryLine2.CL_DutyPercent = 5m;
			leadEntryLine2.Fees.AddOrUpdate(Core.Constants.Customs.CusEntryFeeTypes.DutyAmount, 50m);
			leadDeclaration.EntryHeader.MergedLines.Add(leadEntryLine2);

			var leadInvoiceLine2 = leadInvoiceHeader.JobComInvoiceLines.AddNew();
			leadInvoiceLine2.JI_CL = leadEntryLine2.PK;
			leadInvoiceLine2.JI_LineNo = 2;
			leadInvoiceLine2.JI_PartNo = "PART1";
			leadInvoiceLine2.JI_CustomsUnitQty = "KG";
			leadInvoiceLine2.JI_CustomsQuantity = 4m;
			...
			memberDeclaration.JE_OH_Importer = importer1.PK;

			var memberInvoiceHeader = memberDeclaration.Invoices.AddNew();
			var memberInvoiceLine1 = memberInvoiceHeader.JobComInvoiceLines.AddNew();
			memberInvoiceLine1.JI_LineNo = 1;

			var memberEntryHeader = memberDeclaration.CustomsEntryHeaders[0];
			memberEntryHeader.CH_BGMReference = "B00000002";
			memberEntryHeader.EntryNumber = "AAAGMM44C";
			var memberEntryLine1 = memberEntryHeader.AllEntryLines.AddNew();
			memberEntryLine1.CL_LineNumber = 1;
			memberEntryLine1.ZA_AggregateEntryLineNumber = 3;
			memberDeclaration.EntryHeader.MergedLines.Add(memberEntryLine1);

			var memberEntryLine2 = memberEntryHeader.AllEntryLines.AddNew();
			memberEntryLine2.CL_LineNumber = 2;
			memberEntryLine2.ZA_AggregateEntryLineNumber = 4;
			memberEntryLine2.CL_CustomsValue = 10000m;
			memberEntryLine2.CL_DutyPercent = 10m;
			memberEntryLine2.Fees.AddOrUpdate(Core.Constants.Customs.CusEntryFeeTypes.DutyAmount, 100m);
			var memberInvoiceLine2 = memberInvoiceHeader.JobComInvoiceLines.AddNew();
			memberInvoiceLine2.JI_CL = memberEntryLine2.PK;
			memberInvoiceLine2.JI_LineNo = 2;
			memberInvoiceLine2.JI_PartNo = "PART1";
			memberInvoiceLine2.JI_CustomsUnitQty = "KG";
			memberInvoiceLine2.JI_CustomsQuantity = 1m;
			memberDeclaration.EntryHeader.MergedLines.Add(memberEntryLine2);
			...
			drawbackDeclaration.JE_OH_Importer = importer1.PK;
			var drawbackHeader = drawbackDeclaration.JobComInvoiceGroupHeaders[0].JobComInvoiceHeaders.AddNew();
			drawbackHeader.JZ_RX_NKInvoice_Currency = JobDeclaration.LocalCurrencyConstantCode;
			var drawbackInvoiceLine = drawbackHeader.JobComInvoiceLines.AddNew();
			drawbackInvoiceLine.JI_IsPackToBondForLine = true;
			drawbackInvoiceLine.AddInfo.ZA_DAM_Hidden = "A";
			drawbackInvoiceLine.JI_PartNo = "PART1";
			drawbackInvoiceLine.JI_CustomsUnitQty = "KG";
			drawbackInvoiceLine.JI_CustomsQuantity = 2m;

			drawbackInvoiceLine.AddInfo.ZA_DDN_Hidden = "AAAGMM44C-2";
			AssertEquals("Method A CustomsValue", 500m, drawbackInvoiceLine.DrawbackCustomsValue);
			AssertEquals("Method A Duty Rate", 5m, drawbackInvoiceLine.DrawbackDutyRate);
			AssertEquals("Method A Claim Duty Amount", 25m, drawbackInvoiceLine.DrawbackDutyAmount);

			drawbackInvoiceLine.AddInfo.ZA_DDN_Hidden = "AAAGMM44C-4";
			AssertEquals("Method A CustomsValue", 20000m, drawbackInvoiceLine.DrawbackCustomsValue);
			AssertEquals("Method A Duty Rate", 10m, drawbackInvoiceLine.DrawbackDutyRate);
			AssertEquals("Method A Claim Duty Amount", 200m, drawbackInvoiceLine.DrawbackDutyAmount);
		}
		...
		protected override void SetUp()
		{
			...
			var tariff1 = helper.LoadOrCreateNewTariff(Core.Constants.CountryCodes.Australia, impTariffType.PK, "1704900044", ZDateTime.MinSmallDateTimeValue, ZDateTime.MaxSmallDateTimeValue, description: "Tariff Code Description", taxOrFeeCode: "GST");
