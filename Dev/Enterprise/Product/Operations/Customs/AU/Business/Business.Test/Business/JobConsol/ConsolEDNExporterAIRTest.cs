...
namespace Enterprise.Customs.AU.Declaration.Business.Testing
{
	...
	public class ConsolEDNExporterAIRTest : CMRDataExporterCSVTest
	{
		...
		protected override CMRDataExporterCSV GetNewExporter()
		{
			...
			supplier.PrimaryRegistrationNumber.Number = "121312123131";
			...
			dec1.JE_JS = ship1.PK;
			dec1.JE_TransportMode = Core.Constants.TransportModes.Air;
			...
			dec2.JE_JS = ship2.PK;
			dec2.JE_TransportMode = Core.Constants.TransportModes.Air;
			...
			dec4.JE_JS = ship4.PK;
			dec4.JE_TransportMode = Core.Constants.TransportModes.Air;
		...
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,21344199,Pink shorts,L111333,123.45,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,12134355,Purple shorts,L325235235,666.66,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,98784444,Lime shorts,L00001111,444.44,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S4,M325235,H888,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF888,88888888,Lemon shorts,,888.00,AUMEL,\r\n";
			}
		}
#else
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,21344199,Pink shorts,L111333,123.450,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,12134355,Purple shorts,L325235235,666.660,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S2,M325235,H222,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF444,98784444,Lime shorts,L00001111,444.440,AUBNE,\r\n" +
"Eagle Datamation International,123 441,test@example.com,S4,M325235,H888,I am a supplier,121312123131,I am an importer,IN,20051126,AIR,QF888,88888888,Lemon shorts,,888.000,AUMEL,\r\n";
			}
		}
#endif
