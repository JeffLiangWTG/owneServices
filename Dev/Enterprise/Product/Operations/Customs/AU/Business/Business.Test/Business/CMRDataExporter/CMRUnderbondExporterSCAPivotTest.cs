...
namespace Enterprise.Customs.AU.Declaration.Business.Testing
{
	...
	public class CMRUnderbondExporterSCAPivotTest : CMRDataExporterCSVTest
	{
		...
		protected override CMRDataExporterCSV GetNewExporter()
		{
			...
			house.CA_ConsigneeSuburb = "CITY";
			house.CA_ConsigneeState = "STATE";
		...
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"123 441,test@example.com,1234567,4321,OBL,HOUSE,FCL,OCLU1234567,GOODS DESCRIPION,CONSIGNOR,CONSIGNEE,STREET STREET 2 CITY STATE 2233,AUPER,YES,YES,MOV,,1234X,5678A,7,U999999\r\n";
			}
		}
