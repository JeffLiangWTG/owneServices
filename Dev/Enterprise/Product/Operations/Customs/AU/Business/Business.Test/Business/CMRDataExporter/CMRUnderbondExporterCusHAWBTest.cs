...
namespace Enterprise.Customs.AU.Declaration.Business.Testing
{
	...
	public class CMRUnderbondExporterCusHAWBTest : CMRDataExporterCSVTest
	{
		...
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"123 441,test@example.com,,QF32,08111112222,HOUSEBILL,,,GOODS DESC.,THE CONSIGNOR,THE CONSIGNEE,STREET STREET 2 CITY STATE 2222,AUMEL,,YES,MOV,,1234X,5678A,7,U999999\r\n";
			}
		}
