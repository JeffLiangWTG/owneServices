...
{
	[TestedType(typeof(NEXDOCProductTypeCollection))]
	sealed class NEXDOCProductTypeCollectionTest : EXDOCRefCodeCollectionTest<NEXDOCProductTypeCollection>
	{
		public void TestNEXDocProductTypeCreateRelationshipFilter()
		{
		...
		protected override BusinessObjectCollection GetCollectionToTest()
		{
			...
			return new NEXDOCProductTypeCollection(helper.Header1.QuarantineExDocHeader);
		}
	}
}
