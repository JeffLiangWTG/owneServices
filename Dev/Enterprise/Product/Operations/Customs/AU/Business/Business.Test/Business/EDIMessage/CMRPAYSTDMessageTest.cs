...
{
	[TestedType(typeof(CMRPAYSTDMessage))]
	public class CMRPAYSTDMessageTest : EnterpriseBusinessObjectTestCase
	{
		public void TestSetDefaultValues()
		{
			CMRPAYSTDMessage message = Factory.New<CMRPAYSTDMessage>();
