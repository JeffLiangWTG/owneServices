...
{
	[TestedType(typeof(AirReportMAWBExporter))]
	sealed class AirReportMAWBExporterTest : CMRDataExporterCSVTest
	{
		...
		protected override CMRDataExporterCSV GetNewExporter()
		{
			...
			hAWB2.CS_PiecesManifested = 8;

			return new AirReportMAWBExporter(mAWB);
		}
		...
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"123 441,test@example.com,123,20051126,918525,992233,,,These are my 'goods ok'?,Manually Entered Consignor,My Consignee,18 Henricks Avenue Newington NSW 2127,,,,AUBNE,AUSYD,Y,,,Y,EM18N,7,\r\n" +
"123 441,test@example.com,123,20051126,918525,1233,,,SOme other goods,SOme Other Consignor OK?,My Consignee,18 Henricks Avenue Newington NSW 2127,,,,AUBNE,AUMEL,N,,,N,EM18N,8,\r\n";
			}
		}
