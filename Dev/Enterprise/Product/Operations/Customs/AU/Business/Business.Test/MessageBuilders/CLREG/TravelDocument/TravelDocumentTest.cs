...
{
	[TestedType(typeof(TravelDocument))]
	sealed class TravelDocumentTest : Customs.Business.MultiLineAddInfos.Testing.CusAddInfoTest<TravelDocument>
	{
		protected override BusinessObject GetNewBusinessObjectForDeleteTest(BusinessObjectFactory factory)
		{
			...
			var result = factory.New<TravelDocument>();
