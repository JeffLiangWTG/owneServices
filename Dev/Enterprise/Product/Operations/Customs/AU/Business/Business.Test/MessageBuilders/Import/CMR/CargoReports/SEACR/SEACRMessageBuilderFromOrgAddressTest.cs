...
{
	sealed class SEACRMessageBuilderFromOrgAddressTest : SEACRMessageBuilderTest
	{
		public void TestIdentificationFromAddress()
		{
			...
			scaHouse.CA_OA_ConsigneeAddress = otherConsigneeAddress.PK;
			...
			scaHouse.CA_OA_ConsignorAddress = otherConsignorAddress.PK;
		...
		protected override void SetConsignee(CusSCAHouse house, OrgHeader consignee)
		{
			house.CA_OA_ConsigneeAddress = consignee.MainAddress.PK;
		}

		protected override void SetConsignor(CusSCAHouse house, OrgHeader consignor)
		{
