...
namespace Enterprise.Customs.AU.Declaration.Business.Testing
{
	...
	public class CMRAirArrivalActualArrivalExporterTest : CMRDataExporterCSVTest
	{
		...
		{
			get { return "Contingency Actual Arrival Report - Air"; }
		}
		...
		protected override CMRDataExporterCSV GetNewExporter()
		{
			...
			voyage.JV_FlightDate = new ZDateTime(2004, 2, 29, 03, 46, 00);

			VoyageOrigin origin = voyage.Origins.AddNew();
			origin.JA_RL_NKPortOfLoading = "NZAKL";
			origin.JA_A_DEP = new ZDateTime(2004, 2, 29, 03, 45, 00);
			...
			destination1.JB_A_ARV = new ZDateTime(2004, 3, 2, 10, 16, 00);
			destination1.JB_E_ARV = new ZDateTime(2004, 3, 1, 10, 15, 00);
			...
			destination2.JB_A_ARV = new ZDateTime(2004, 3, 2, 18, 31, 00);
			destination2.JB_E_ARV = new ZDateTime(2004, 3, 1, 18, 30, 00);
			...
			return new CMRAirArrivalExporter(voyageWrapper, "AA");
		}
		...
		protected override string ExpectedCSVResult
		{
			...
			{
				return
"123 441,test@example.com,QF123,NZAKL,20040301,2316,AUSYD,SENDREF1\r\n" +
"123 441,test@example.com,QF123,NZAKL,20040302,0731,AUMEL,SENDREF2\r\n";
			}
		}
