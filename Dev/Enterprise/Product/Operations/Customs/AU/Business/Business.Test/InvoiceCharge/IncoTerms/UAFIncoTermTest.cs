...
{
	sealed class UAFIncoTermTest : UnpackedIncoTermTest
	{
		...
		protected override string IncotermToTest => Core.Constants.IncoTerms.UnpackedAtFactory;

		protected override bool ExpectedValueForCanThisIncoTermHaveThisCharge(ICustomsChargeCode charge)
			=> base.ExpectedValueForCanThisIncoTermHaveThisCharge(charge) || charge.Code == AUChargeCodeList.Codes.ExWorks;

		protected override bool ExpectedValueForThisChargeMandatory(ICustomsChargeCode charge)
			=> base.ExpectedValueForThisChargeMandatory(charge) || charge.Code == AUChargeCodeList.Codes.ForeignInlandFreight;
	}
}
