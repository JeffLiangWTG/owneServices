...
{
	[TestedType(typeof(ReadRexResponseReaderRC4))]
	sealed class ReadRexResponseReaderRC4Test : TestCaseWithFactory
	{
		...
		ReadRexResponseReaderRC4 Reader => reader ??= new ReadRexResponseReaderRC4(Factory, new LoggingInformation());
		ReadRexResponseReaderRC4 reader;
	}
}
