...
{
	public class RequestForPermitEggsHeaderMessageBuilder : RequestForPermitHeaderMessageBuilder
	{
		public RequestForPermitEggsHeaderMessageBuilder(JobComInvoiceHeader invoiceHeader, string messageTypeToSend)
		...
		{
			return DocumentMessageNameCodedList.GetFromString(EXDOCCommodityCodesSingleChar.Codes.Eggs);
		}
		...
		{
			var eggsLineMessageBuilder = new RequestForPermitEggsLineMessageBuilder(sANCRT, MessageTypeToSend);
			...
			{
				eggsLineMessageBuilder.GenerateLine(invoiceLine.JI_LineNo, invoiceLine);
			}
		}
