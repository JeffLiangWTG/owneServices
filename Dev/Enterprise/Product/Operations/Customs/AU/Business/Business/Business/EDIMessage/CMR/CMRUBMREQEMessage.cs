...
{
	public class CMRUBMREQEMessage : CMRCUSRESMessage
	{
		public CMRUBMREQEMessage(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		}
		...
		protected override void SetDefaultValues()
		{
			...
			EM_MessageType = CMRMessageTypes.UBMREQE;
		}
	}
}
