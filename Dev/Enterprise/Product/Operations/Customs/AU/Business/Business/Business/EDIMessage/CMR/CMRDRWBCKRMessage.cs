...
{
	public class CMRDRWBCKRMessage : CMRCUSRESMessage
	{
		public CMRDRWBCKRMessage(BusinessObjectFactory factory, DataRow row)
			: base(factory, row)
		{
		}
		...
		protected override void SetDefaultValues()
		{
			...
			EM_MessageType = CMRMessageTypes.DRWBCK;
		}
