...
{
	[TestedType(typeof(JisUtility))]
	sealed class JisUtilityTest : TestCaseWithFactory
	{
		public void TestIsJISX0208()
		{
			foreach(var a in jisX0208CharsWithoutLevel3Kanjis)
			{
				Assert(JisUtility.IsJISX0208(a));
			}
			Assert(!JisUtility.IsJISX0208('俱'));
		}

		readonly HashSet<char> jisX0208CharsWithoutLevel3Kanjis =
		[
			' ','、','。','，','．','・','：','；','？','！','゛','゜','´','｀','¨',
			'＾','￣','＿','ヽ','ヾ','ゝ','ゞ','〃','仝','々','〆','〇','ー','―','‐','／',
			'＼','～','∥','｜','…','‥','‘','’','“','”','（','）','〔','〕','［','］',
