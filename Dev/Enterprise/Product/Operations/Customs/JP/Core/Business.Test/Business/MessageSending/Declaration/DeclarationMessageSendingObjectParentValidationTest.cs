...
{
	[TestedType(typeof(DeclarationMessageSendingObjectParentValidation))]
	sealed class DeclarationMessageSendingObjectParentValidationTest : BusinessObjectValidationTestCase
	{
