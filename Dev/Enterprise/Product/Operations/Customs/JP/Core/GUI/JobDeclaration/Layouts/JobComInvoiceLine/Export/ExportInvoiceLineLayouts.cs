...
{
	public class ExportInvoiceLineLayouts : IPanelLayoutProvider
	{
		public PanelLayout Layout
		{
			get
			{
				var builder = new ExportInvoiceLineLayoutBuilder();
				var jpExportBag = builder.JPExportBag;
				var commonBag = builder.CommonBag;
				var jpCommonBag = builder.JPCommonBag;
				builder.AddControlBag(jpExportBag);
				builder.AddControlBag(jpCommonBag);

				builder.AddColumn();
				builder.Add(jpCommonBag.EntryInstructionGuidDropEdit, ControlWidthClass.Auto);
				builder.Add(jpExportBag.TariffFindBox, ControlWidthClass.Auto);
