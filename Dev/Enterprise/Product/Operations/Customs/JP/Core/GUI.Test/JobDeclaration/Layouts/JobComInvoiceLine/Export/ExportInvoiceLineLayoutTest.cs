...
{
	[TestedType(typeof(ExportInvoiceLineLayouts))]
	sealed class ExportInvoiceLineLayoutTest : LayoutsAbstractTest
	{
		...
		IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
		{
			get
			{
				...
				yield return (ExportInvoiceLineControlBag.Instance.TariffFindBox, ControlWidthClass.Auto);
		...
		protected override ICommonLayoutBuilder CommonLayoutBuilder => new ExportInvoiceLineLayoutBuilder();
	}
}
