...
namespace Enterprise.Customs.JP.Business
{
	...
	public abstract class AutoJPCusEntryHeader : Customs.Business.CusEntryHeader, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.CusEntryHeader.Schema
		{
			public const string CH_InspectionStatus = "CH_InspectionStatus";

			public const int CH_InspectionStatusMaxLength = 4;
		}

		public ITableSchema AddInfoTableSchema => JPCusEntryHeaderSchema.Instance;

		#endregion

		protected AutoJPCusEntryHeader(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoJPCusEntryHeader>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoJPCusEntryHeader source)
			{
		...
		{
			{"InspectionStatus", CH_InspectionStatusData},
		};
		...
		public virtual ZString CH_InspectionStatus
		{
			get => CH_InspectionStatusData.Value;
			set
			{
				SetNonPersistentPropertyValue(CH_InspectionStatusInfo, ref CH_InspectionStatusData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateCH_InspectionStatus();
				}
			}
		}
		public ZPropertyInfo CH_InspectionStatusInfo => GetZPropertyInfo(Schema.CH_InspectionStatus);
		AddInfoPropertyData<ZString> CH_InspectionStatusData => inspectionStatusData ?? (inspectionStatusData = new AddInfoPropertyData<ZString>(Schema.CH_InspectionStatus));
		AddInfoPropertyData<ZString> inspectionStatusData;
		...
		public new AutoJPCusEntryHeaderValidation Validation => (AutoJPCusEntryHeaderValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => JPCusEntryHeaderSchema.Instance;
