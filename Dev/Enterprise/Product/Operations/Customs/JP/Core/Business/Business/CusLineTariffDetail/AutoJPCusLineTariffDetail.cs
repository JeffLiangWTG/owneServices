...
namespace Enterprise.Customs.JP.Business
{
	...
	public abstract class AutoJPCusLineTariffDetail : Customs.Business.CusLineTariffDetail, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.CusLineTariffDetail.Schema
		{
			public const string BZ_ExemptionReductionCode = "BZ_ExemptionReductionCode";

			public const int BZ_ExemptionReductionCodeMaxLength = 3;
		}

		public ITableSchema AddInfoTableSchema => JPCusLineTariffDetailSchema.Instance;

		#endregion

		protected AutoJPCusLineTariffDetail(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoJPCusLineTariffDetail>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoJPCusLineTariffDetail source)
			{
		...
		{
			{"ExemptionReductionCode", BZ_ExemptionReductionCodeData},
		};
		...
		public virtual ZString BZ_ExemptionReductionCode
		{
			get => BZ_ExemptionReductionCodeData.Value;
			set
			{
				SetNonPersistentPropertyValue(BZ_ExemptionReductionCodeInfo, ref BZ_ExemptionReductionCodeData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateBZ_ExemptionReductionCode();
				}
			}
		}
		public ZPropertyInfo BZ_ExemptionReductionCodeInfo => GetZPropertyInfo(Schema.BZ_ExemptionReductionCode);
		AddInfoPropertyData<ZString> BZ_ExemptionReductionCodeData => exemptionReductionCodeData ?? (exemptionReductionCodeData = new AddInfoPropertyData<ZString>(Schema.BZ_ExemptionReductionCode));
		AddInfoPropertyData<ZString> exemptionReductionCodeData;
		...
		public new AutoJPCusLineTariffDetailValidation Validation => (AutoJPCusLineTariffDetailValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => JPCusLineTariffDetailSchema.Instance;
