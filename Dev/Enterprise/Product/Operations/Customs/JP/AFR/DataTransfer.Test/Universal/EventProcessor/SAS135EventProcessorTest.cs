...
{
	[TestedType(typeof(SAS135EventProcessor))]
	class SAS135EventProcessorTest : AFREventProcessorAbstractTest<SAS135EventProcessor>
	{
		protected override SAS135EventProcessor GetNewProcessor(IXmlEventValueObject eventDataObject, IXmlImportLogger logger, BusinessObjectFactory factory)
		{
			return new SAS135EventProcessor(eventDataObject, logger, factory);
		}

		protected override bool ExpectEmailToPostmasterOnError => false;

		public void TestSAS135EventProcessor()
		{
...
<UniversalEvent>
	<Event>
		<DataContext>
			<ActionPurpose>
				<Code>NRC</Code>
				<Description>SAS135</Description>
			</ActionPurpose>
...
";
			...
			AssertHasEmail(MessagingTypeList.Descriptions.NotificationOfHouseBillOfLadingRegisterCompletion + " Response for " + header1.JPH_JobReference, "<table><tr><td>Message</td><td>HELLO WORLD</td></tr></table><br>", Staff1.GS_EmailAddress);
...
";
			...
			AssertEquals(MessageStatusList.Codes.ClearHouseBillRegistration, bill.JPB_MessageStatus);
			AssertEquals(string.Empty, logger.Logs);
			AssertHasEmail(MessagingTypeList.Descriptions.NotificationOfHouseBillOfLadingRegisterCompletion + " Response", @"<table border=""1"" cellpadding=""1"" cellspacing=""0"" class=""table""><thead><tr class=""tableheadings""><th colspan=""2"">Manifest Details</th></tr></thead><tr><td>Carrier Code</td><td>SPQB</td></tr><tr><td>Vessel Call Sign</td><td>xxxxxxx</td></tr><tr><td>Voyage Number</td><td>009p</td></tr><tr><td>Port Of Loading</td><td>AUSYD</td></tr><tr><td>Port Of Loading Suffix</td><td>1</td></tr><tr><td>Master Bill</td><td>SPQAVICTM002</td></tr></table>", Staff1.GS_EmailAddress);
		}
	}
}
