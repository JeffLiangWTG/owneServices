...
namespace Enterprise.Customs.ASYCUDAManifest.Business.Testing
{
	...
	sealed class AsycudaPackageContainerLinkTest : EnterpriseBusinessObjectTestCase
	{
		public void TestIAsycudaPackageContainerLink()
		{
			...
			Factory.Save();
			AssertEquals(bizObj.GetType(), new BusinessObjectFactory().Load<Integration.Customs.ASYCUDA.ASYCUDAManifest.IAsycudaContainerBillOrPackageLink>(bizObj.PK).GetType());
