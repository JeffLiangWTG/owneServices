...
sealed class CusTempStorageRegLineTransactionTest : EnterpriseBusinessObjectTestCase
{
	...
	public void TestCanDelete()
	{
		...
		var transaction2 = line.CusTempStorageRegLineTransactions.AddNew();
		AssertEquals(CusTempStorageRegLineTransactionTypeList.Codes.Adjustment, transaction2.SRT_TransactionType);
	...
	public void TestTransactionTypeDescription()
	{
		...
		transaction.SRT_TransactionType = CusTempStorageRegLineTransactionTypeList.Codes.Adjustment;
		AssertEquals(CusTempStorageRegLineTransactionTypeList.Descriptions.Adjustment, transaction.TransactionTypeDescription);
	}
	...
	public void TestSRT_BondAmount_Attributes() => CombineAssertions(() =>
	{
		_ = AssertEntity<CusTempStorageRegLineTransaction>()
			...
			.WithCaption("Goods Value in NOKs");
	});
