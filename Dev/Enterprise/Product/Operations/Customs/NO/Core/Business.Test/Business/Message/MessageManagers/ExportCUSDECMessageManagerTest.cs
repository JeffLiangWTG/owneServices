...
sealed class ExportCUSDECMessageManagerTest : EDIFACTMessageManagerTestCase
{
	public override void TestCanSendThisMessage()
	{
		...
		var manager = new ExportCUSDECMessageManagerForTest(testWrapper, notification);
		...
		Factory.Save();
		manager = new ExportCUSDECMessageManagerForTest(testWrapper, notification);
	...
	{
		var manager = ((ExportCUSDECMessageManagerForTest)messageManager);
	...
	public override void TestPopulateMessages()
	{
		...
		declaration.JE_MessageSubType = ShipmentTypeExport.Codes.ExportOfGoodsToAllOtherNotCoveredByEu;
		declaration.JE_GoodsNumber = "123456789";
		declaration.JE_Position = "12345";
		declaration.JE_RL_NKOrigin = "NOBGO";
		declaration.JE_LocationOfGoods = ExportGoodsLocationCodeList.Codes.CustomsWarehouseA;
		...
		invoiceLine.JI_StateOrRegionOfOrigin = "11";
		...
		importer.OH_FullName = "MyCorp";
		importer.MainAddress.OA_Address1 = "Address line 1";
		importer.MainAddress.OA_Address2 = "Address line 2";
		importer.MainAddress.OA_PostCode = "28320";
		importer.MainAddress.OA_City = "Madrid";
		importer.MainAddress.OA_RN_NKCountryCode = Core.Constants.CountryCodes.Spain;
	...
	{
		return new ExportCUSDECMessageManagerForTest(new MessageSendingObject(dataWrapper as CusEntryHeader), new MessageNotificationCollector_ForTest());
	}
	...
	const string PopulateMessagesOriginal =
		"""
		UNH+B00001001+CUSDEC:1:902:UN:NEP+<<JOB REFERENCE NUMBER PLACE HOLDER>>'
		BGM+830++137:20240810:102+ZZ'
		CST++EX11:104:1+01:112:NO1'
		RFF+CO:04049962'
		RFF+XC:123456789'
		RFF+LAR:12345'
		RFF+AEI:123456789'
		...
		TDT+11++20+:::::DK'
		GIS+1::NO1'
		NAD+EX+1212121212::NO1'
		NAD+CN++MyCorp:Address line 1:Address line 2:28320 Madrid ES'
...
sealed class ExportCUSDECMessageManagerForTest : CUSDECMessageManager
{
	public ExportCUSDECMessageManagerForTest(MessageSendingObject sendingObject, IMessageNotificationCollector notification) : base(sendingObject, notification) { }
