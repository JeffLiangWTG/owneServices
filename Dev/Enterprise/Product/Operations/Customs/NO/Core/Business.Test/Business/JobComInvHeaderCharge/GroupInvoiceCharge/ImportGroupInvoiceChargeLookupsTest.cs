...
{
	[TestedType(typeof(ImportGroupInvoiceChargeLookups))]
	sealed class ImportGroupInvoiceChargeLookupsTest : GroupInvoiceChargeLookupsAbstractTest<ImportGroupInvoiceChargeLookups>
	{
