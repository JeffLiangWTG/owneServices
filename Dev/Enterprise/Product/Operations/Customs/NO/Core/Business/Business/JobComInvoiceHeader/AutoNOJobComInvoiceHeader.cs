...
namespace Enterprise.Customs.NO.Business
{
	...
	public abstract class AutoNOJobComInvoiceHeader : Customs.Business.BaseJobComInvoiceHeader, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.BaseJobComInvoiceHeader.Schema
		{
			public const string JZ_ValuationMethod = "JZ_ValuationMethod";
		}

		public ITableSchema AddInfoTableSchema => NOJobComInvoiceHeaderSchema.Instance;

		#endregion

		protected AutoNOJobComInvoiceHeader(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoNOJobComInvoiceHeader>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoNOJobComInvoiceHeader source)
			{
		...
		{
			{"ValuationMethod", JZ_ValuationMethodData},
		};
		...
		public virtual ZString JZ_ValuationMethod
		{
			get => JZ_ValuationMethodData.Value;
			set
			{
				SetNonPersistentPropertyValue(JZ_ValuationMethodInfo, ref JZ_ValuationMethodData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateJZ_ValuationMethod();
				}
			}
		}
		public ZPropertyInfo JZ_ValuationMethodInfo => GetZPropertyInfo(Schema.JZ_ValuationMethod);
		AddInfoPropertyData<ZString> JZ_ValuationMethodData => valuationMethodData ?? (valuationMethodData = new AddInfoPropertyData<ZString>(Schema.JZ_ValuationMethod));
		AddInfoPropertyData<ZString> valuationMethodData;
		...
		public new AutoNOJobComInvoiceHeaderValidation Validation => (AutoNOJobComInvoiceHeaderValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => NOJobComInvoiceHeaderSchema.Instance;
