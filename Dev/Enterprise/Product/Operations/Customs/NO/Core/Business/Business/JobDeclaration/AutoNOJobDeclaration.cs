...
namespace Enterprise.Customs.NO.Business
{
	...
	public abstract class AutoNOJobDeclaration : Customs.Business.BaseJobDeclaration, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.BaseJobDeclaration.Schema
		{
			public const string JE_CustomsTransportMode = "JE_CustomsTransportMode";

			public const int JE_CustomsTransportModeMaxLength = 2;
		}

		public ITableSchema AddInfoTableSchema => NOJobDeclarationSchema.Instance;

		#endregion

		protected AutoNOJobDeclaration(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoNOJobDeclaration>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoNOJobDeclaration source)
			{
		...
		{
			{"CustomsTransportMode", JE_CustomsTransportModeData},
		};
		...
		public virtual ZString JE_CustomsTransportMode
		{
			get => JE_CustomsTransportModeData.Value;
			set
			{
				SetNonPersistentPropertyValue(JE_CustomsTransportModeInfo, ref JE_CustomsTransportModeData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateJE_CustomsTransportMode();
				}
			}
		}
		public ZPropertyInfo JE_CustomsTransportModeInfo => GetZPropertyInfo(Schema.JE_CustomsTransportMode);
		AddInfoPropertyData<ZString> JE_CustomsTransportModeData => customsTransportModeData ?? (customsTransportModeData = new AddInfoPropertyData<ZString>(Schema.JE_CustomsTransportMode));
		...
		public new AutoNOJobDeclarationValidation Validation => (AutoNOJobDeclarationValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => NOJobDeclarationSchema.Instance;
