...
namespace Enterprise.Customs.NO.Business
{
	...
	public abstract class AutoNOCusClassPartPivot : Enterprise.Customs.Business.BaseCusClassPartPivot, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Enterprise.Customs.Business.BaseCusClassPartPivot.Schema
		{
			public const string CI_ReducedCustomsFlag = "CI_ReducedCustomsFlag";
		}

		public ITableSchema AddInfoTableSchema => NOCusClassPartPivotSchema.Instance;

		#endregion

		protected AutoNOCusClassPartPivot(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoNOCusClassPartPivot>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoNOCusClassPartPivot source)
			{
		...
		{
			{"ReducedCustomsFlag", CI_ReducedCustomsFlagData},
		};
		...
		public virtual ZString CI_ReducedCustomsFlag
		{
			get => CI_ReducedCustomsFlagData.Value;
			set
			{
				SetNonPersistentPropertyValue(CI_ReducedCustomsFlagInfo, ref CI_ReducedCustomsFlagData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateCI_ReducedCustomsFlag();
				}
			}
		}
		public ZPropertyInfo CI_ReducedCustomsFlagInfo => GetZPropertyInfo(Schema.CI_ReducedCustomsFlag);
		AddInfoPropertyData<ZString> CI_ReducedCustomsFlagData => reducedCustomsFlagData ?? (reducedCustomsFlagData = new AddInfoPropertyData<ZString>(Schema.CI_ReducedCustomsFlag));
		...
		public new AutoNOCusClassPartPivotValidation Validation => (AutoNOCusClassPartPivotValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => NOCusClassPartPivotSchema.Instance;
