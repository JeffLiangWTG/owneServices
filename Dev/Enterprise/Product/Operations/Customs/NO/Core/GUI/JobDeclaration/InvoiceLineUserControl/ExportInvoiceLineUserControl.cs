...
{
	partial class ExportInvoiceLineUserControl : BaseInvoiceLineUserControl
	{
		public static class CaptionStrings
		{
			public static ResourceStringData MergedLineNumber => Res.GetData("7a7068d3-9cde-4d06-9722-7c442522e6c1", "Merged Ln. #");
		}
		...
		void AddColumnsToGrid()
		{
			...
			AddColumnToGrid<ZDropEditColumnStyleInfo>(JobComInvoiceLine.Schema.JI_StateOrRegionOfOrigin, 76);
