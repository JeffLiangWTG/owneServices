...
namespace Enterprise.Customs.NO.GUI
{
	partial class SupportingDocumentsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// BindingSource
			//
			this.BindingSource.DataSourceType = typeof(SupportingDocument);
			//
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.NO.Business.JobComInvoiceLine)(((System.Collections.IList)(((Enterprise.Customs.NO.Business.JobDeclaration)(null)).FilteredInvoiceLines)).SyncRoot)).SupportingDocuments)));
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.NO.Business.SupportingDocument)(((System.Collections.IList)(((Enterprise.Customs.NO.Business.JobComInvoiceLine)(((System.Collections.IList)(((Enterprise.Customs.NO.Business.JobDeclaration)(null)).FilteredInvoiceLines)).SyncRoot)).SupportingDocuments)).SyncRoot)).DocumentDescription)));
			...
			this.SupportingDocumentsGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(599, 259, true);
