...
{
	partial class CommercialInvoiceHeaderUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// 
			this.InvCustomFieldsUserControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(315, 422, true);
			// 
			// BindingSource
			// 
