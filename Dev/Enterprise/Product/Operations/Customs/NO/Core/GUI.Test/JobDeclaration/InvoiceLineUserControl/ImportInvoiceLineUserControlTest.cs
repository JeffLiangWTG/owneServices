...
sealed class ImportInvoiceLineUserControlTest : BaseInvoiceLineUserControlTest<ImportInvoiceLineUserControl>
{
	public void TestInvoiceLineDetails_CommonDetailsAvailable()
	{
		using var invLinesForm = new ImportInvoiceLineUserControlForTest();
	...
	protected override ZString GetJE_MessageType() => Enterprise.Customs.Business.JobMessageTypeList.Codes.Import;
