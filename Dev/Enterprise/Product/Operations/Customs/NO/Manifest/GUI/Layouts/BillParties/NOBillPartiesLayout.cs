...
sealed class NOBillPartiesLayout : IPanelLayoutProvider
{
	public NOBillPartiesLayout()
	{
	...
	static PanelLayout CreateBillPartiesLayout()
	{
		var builder = new BillPartiesLayoutBuilder<AsycudaBill>();
		var common = builder.CommonBag;
		var noBillPartiesBag = NOBillPartiesControlBag.Instance;
		builder.AddControlBag(noBillPartiesBag);
		...
		builder.Add(noBillPartiesBag.ShipperEmailTextBox, ControlWidthClass.Long);
		...
		builder.Add(noBillPartiesBag.ConsigneeEmailTextBox, ControlWidthClass.Long);
		builder.Add(common.ConsigneeRegoNoTextBox, ControlWidthClass.Long);

		builder.AddColumn();
		builder.Add(noBillPartiesBag.RepresentativeSeparatorUserControl, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeAddressControl, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeNameTextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeStreet1TextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeStreet2TextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeCityTextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeCountryCodeFindBox, ControlWidthClass.Auto);
		builder.Add(noBillPartiesBag.RepresentativeStateDropEdit, ControlWidthClass.Auto);
		builder.Add(noBillPartiesBag.RepresentativePostCodeTextBox, ControlWidthClass.Auto);
		builder.Add(noBillPartiesBag.RepresentativePhoneTextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeEmailTextBox, ControlWidthClass.Long);
		builder.Add(noBillPartiesBag.RepresentativeRegNoTextBox, ControlWidthClass.Long);
