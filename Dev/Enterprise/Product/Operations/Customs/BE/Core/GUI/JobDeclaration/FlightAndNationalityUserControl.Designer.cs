namespace Enterprise.Customs.BE.GUI
{
	partial class FlightAndNationalityUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TransportNationalityFindBox.CaptionResourceString = Enterprise.Customs.BE.GUI.Res.GetData("0803279A-D132-4EA5-BCFE-B6992C60C1A6", "Nationality", "[UCC 7/8] Nationality");
			...
			this.FlightNumberTextBox.CaptionResourceString = Enterprise.Customs.BE.GUI.Res.GetData("CDBB56FF-9B7C-4B91-A552-FEFCFF77E1B9", "Flight", "[UCC 7/9] Flight No.", "");
