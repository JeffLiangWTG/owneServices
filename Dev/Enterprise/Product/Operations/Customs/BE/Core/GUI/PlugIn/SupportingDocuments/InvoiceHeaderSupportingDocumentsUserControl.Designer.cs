...
{
	partial class InvoiceHeaderSupportingDocumentsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			// InvoiceHeaderSupportingDocumentsUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Name = "InvoiceHeaderSupportingDocumentsUserControl";
