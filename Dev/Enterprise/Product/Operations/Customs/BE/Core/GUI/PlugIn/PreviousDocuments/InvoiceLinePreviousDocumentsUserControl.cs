...
public partial class InvoiceLinePreviousDocumentsUserControl : EU.GUI.PlugIn.PreviousDocumentsUserControl
{
	public InvoiceLinePreviousDocumentsUserControl()
	{
		InitializeComponent();
	...
	protected override void InitializeGridLayoutCore()
	{
		...
		PreviousDocumentsGrid.ColumnStyles.AddRange(new IZColumnStyleInfo[]
		{
			...
			new ZTextBoxColumnStyleInfo
			{
				...
				CharacterCasing = CharacterCasing.Normal,
				CaptionResourceString = Res.GetData("D631E4EF-702B-4054-97C3-83EC4DE01448", "Complement")
			},
		});
	}
}
