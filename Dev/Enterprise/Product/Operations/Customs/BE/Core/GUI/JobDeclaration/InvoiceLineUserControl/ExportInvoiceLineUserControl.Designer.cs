namespace Enterprise.Customs.BE.GUI
{
	partial class ExportInvoiceLineUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.StatisticalValueLocalCurrencyControl.CaptionResourceString = Enterprise.Customs.BE.GUI.Res.GetData("A1A93995-E7A7-4C38-9D29-9B643A57CF83", englishCaption: "[UCC 8/6] Stat.", englishFullDescription: "[UCC 8/6] Stat. Value");
		}
