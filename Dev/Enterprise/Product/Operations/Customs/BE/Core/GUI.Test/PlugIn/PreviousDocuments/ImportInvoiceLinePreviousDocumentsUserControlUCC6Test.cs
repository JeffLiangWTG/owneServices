...
sealed class ImportInvoiceLinePreviousDocumentsUserControlUCC6Test : TestCaseWithFactory
{
	public void TestControls_PrevDocsGroupBox()
	{
		using (var control = new ImportInvoiceLinePreviousDocumentsUserControlUCC6())
		{
