...
{
	public sealed class CC019CMessageInterpreter : BaseMessageInterpreter<ICC019CDataProvider>
	{
		public override string Interpret(ICC019CDataProvider dataProvider, EDIMessage ediMessage)
		{
			var note = new ZStringBuilder();
			note.Append((NoResString)"Discrepancies for NCTS departure received at " + dataProvider.WriteOffDate.ToString(BE.Business.Constants.DateTimeFormats.LongTimeIncludingSecondsFormat));
