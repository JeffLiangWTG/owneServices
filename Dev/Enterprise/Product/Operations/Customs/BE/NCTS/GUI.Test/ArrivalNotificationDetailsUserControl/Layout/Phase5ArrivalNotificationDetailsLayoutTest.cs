...
sealed class Phase5ArrivalNotificationDetailsLayoutTest : LayoutsAbstractTest
{
	...
	static IEnumerable<(ControlReference, ControlWidthClass)> FirstColumnControls
	{
		get
		{
			...
			yield return (ArrivalNotificationDetailsControlBag.Instance.DischargeTypeDropEdit, ControlWidthClass.Long);
			yield return (ArrivalNotificationDetailsControlBag.Instance.CarnetTotalPagesDropEdit, ControlWidthClass.Long);
		}
	}
