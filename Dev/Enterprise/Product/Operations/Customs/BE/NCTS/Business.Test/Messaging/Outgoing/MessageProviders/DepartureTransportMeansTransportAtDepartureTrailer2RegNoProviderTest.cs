...
{
	sealed class DepartureTransportMeansTransportAtDepartureTrailer2RegNoProviderTest : Customs.Business.Testing.DataProviderTestCase<DepartureTransportMeansTransportAtDepartureTrailer2RegNoProvider>
	{
		...
		protected override void SetUp()
		{
			...
			provider = new DepartureTransportMeansTransportAtDepartureTrailer2RegNoProvider(movementHeader, 1);
		}

		protected override DepartureTransportMeansTransportAtDepartureTrailer2RegNoProvider GetProvider() => provider;

		NctsDepartureMovementHeader movementHeader;
		DepartureTransportMeansTransportAtDepartureTrailer2RegNoProvider provider;
	}
}
