...
{
	sealed class DepartureTransportMeansAircraftIDAtDepartureProviderTest : Customs.Business.Testing.DataProviderTestCase<DepartureTransportMeansAircraftIDAtDepartureProvider>
	{
