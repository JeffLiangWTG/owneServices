...
namespace Enterprise.Customs.BE.NCTS.GUI
{
	partial class MessageSendingFormBottomSectionUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent);
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).Justification)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).TCI11)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).QueryInformation)));
			this.QueryInformationTextBox.CaptionResourceString = null;
			...
			this.QueryInformationTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(560, 196, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).PresentationDateTime)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).ActualOfficeOfDestination)));
			this.ActualOfficeOfDestinationFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(850, 18, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((Enterprise.MasterFiles.Business.JobDocAddress)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).ActualConsignee)));
			this.ActualConsigneeDocAddressControl.BindToOrganisations = "SendingObjectsCollection.Lookups.Consignees";
			this.ActualConsigneeDocAddressControl.CaptionResourceString = Enterprise.Customs.BE.NCTS.GUI.Res.GetData("3200DE10-B1B5-47EF-A394-6784E79185D0", "Actual Consignee");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingAction)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.MessageSendingActionParent)(null)).SendingObjectsCollection)).SyncRoot)).AgreeWithMinorDiscrepancies)));
