...
{
	public sealed partial class DeclarationPreviousDocumentsGridUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs.BE.NCTS.Business.NctsHeader);
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.NctsHeader)(null)).PreviousDocuments)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.CommonPreviousDocument)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.NctsHeader)(null)).PreviousDocuments)).SyncRoot)).CSI_Code)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.CommonPreviousDocument)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.NctsHeader)(null)).PreviousDocuments)).SyncRoot)).CSI_ReferenceNumber)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BE.NCTS.Business.CommonPreviousDocument)(((System.Collections.IList)(((Enterprise.Customs.BE.NCTS.Business.NctsHeader)(null)).PreviousDocuments)).SyncRoot)).CSI_ReferenceNumber2)));
