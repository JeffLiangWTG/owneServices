...
{
	public class PermitTypeModuleFilter : ModuleCodeFilter
	{
		public delegate ZQuery GetPermitTypeQuery(ZString value0, ZString value1, ZString value2);
			...
			: base(description, DummyDelegate, DummyGetList, DummyGetList)
		{
			...
			this.getCountries = Argument.NotNull(getCountries, nameof(getCountries));
		...
		public virtual bool Property2_ReadOnly => PermitSubTypes.Count == 0;

		#endregion

		#region Validation

		public new PermitTypeModuleFilterValidation Validation
		{
			get { return (PermitTypeModuleFilterValidation)base.Validation; }
		}
		...
		public PermitTypeList PermitTypes => CountrySpecificInstruction?.GetTypeList() ?? Factory.GetCachedValue<PermitTypeList>();

		public CodeDescriptionPairList PermitSubTypes => CountrySpecificInstruction?.GetSubTypeList(Property1) ?? Factory.GetCachedValue<PermitSubTypeList>();
		#endregion
	...
	public class PermitTypeModuleFilterValidation : ModuleCodeFilterValidation
	{
		public PermitTypeModuleFilterValidation(PermitTypeModuleFilter parent)
			: base(parent)
		{
			this.Parent = parent;
		}
		...
		protected new readonly PermitTypeModuleFilter Parent;
