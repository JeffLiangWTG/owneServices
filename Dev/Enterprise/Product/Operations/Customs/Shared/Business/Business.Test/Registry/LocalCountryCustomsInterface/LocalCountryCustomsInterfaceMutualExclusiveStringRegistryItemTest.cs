...
{
	[TestedType(typeof(LocalCountryCustomsInterfaceMutualExclusiveStringRegistryItem))]
	sealed class LocalCountryCustomsInterfaceMutualExclusiveStringRegistryItemTest : StronglyTypedRegistryItemTestCase<string>
	{
		public void TestIsVisible()
		{
			...
			factory.Save();
			var registryItem = new LocalCountryCustomsInterfaceMutualExclusiveStringRegistryItem("Name", (NoResString)"Category", (NoResString)"Caption", (NoResString)"Hint", RegistryStorageFlags.Company);
		...
		{
			var registryItem = new LocalCountryCustomsInterfaceMutualExclusiveStringRegistryItem("Name", (NoResString)"Category", (NoResString)"Caption", (NoResString)"Hint", RegistryStorageFlags.System);
		...
		{
			return new LocalCountryCustomsInterfaceMutualExclusiveStringRegistryItem("", null, null, null, RegistryStorageFlags.Company);
		}
	}
}
