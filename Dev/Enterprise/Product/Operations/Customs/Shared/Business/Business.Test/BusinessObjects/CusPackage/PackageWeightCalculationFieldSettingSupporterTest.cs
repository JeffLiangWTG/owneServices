...
{
	sealed class PackageWeightCalculationFieldSettingSupporterTest : TestCase
	{
		public void TestStartAndStop()
		{
			...
			using (new PackageWeightCalculationFieldSettingSupporter(bizObj, type1))
			{
		...
		class dummyBizObj : IPackageWeightCalculationFieldSettingSupporter
		{
			#region IPackageWeightCalculationFieldSettingSupporter Members
