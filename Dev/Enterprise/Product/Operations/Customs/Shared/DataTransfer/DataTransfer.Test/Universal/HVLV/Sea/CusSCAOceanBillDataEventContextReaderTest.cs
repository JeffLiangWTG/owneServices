...
{
	sealed class CusSCAOceanBillDataEventContextReaderTest : TestCaseWithFactory
	{
		public void TestEventContextValues()
		{
			...
			var manager = oceanBill.GetUniversalDataContextManager() as IEventDataContextManager;
