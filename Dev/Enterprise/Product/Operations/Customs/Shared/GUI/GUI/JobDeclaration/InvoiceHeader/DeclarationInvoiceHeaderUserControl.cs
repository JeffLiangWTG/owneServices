...
{
	public partial class DeclarationInvoiceHeaderUserControl : NonLayoutCustomsSupplierHeaderUserControl, IJobDeclarationGuiHandler
	{
		public DeclarationInvoiceHeaderUserControl()
		{
			InitializeComponent();
		}
		...
		protected virtual void ChangeControlsVisibility()
		{
			...
			{
				JZ_InvoiceCurrLandedCostExRateCalcEdit.Visible = !JobDeclaration.IsExport;
			}
		}
