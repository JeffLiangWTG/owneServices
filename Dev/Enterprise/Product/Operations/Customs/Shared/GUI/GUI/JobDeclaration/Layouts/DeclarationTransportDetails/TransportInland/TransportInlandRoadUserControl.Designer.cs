namespace Enterprise.Customs.GUI
{
	partial class TransportInlandRoadUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.Trailer1NationalityCodeFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(287, 0, true);
			...
			this.TransportIDTextBox.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("b56f4896-e32b-44ec-a970-5fcb8eb1bb04", "ID", "Transport ID", "");
			...
			this.Trailer1IDTextBox.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("b6430874-c447-4251-8400-1eafa1765c35", "Trailer 1", "Trailer 1 ID", "");
			this.Trailer1IDTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(205, 0, true);
			this.Trailer1IDTextBox.Name = "Trailer1IDTextBox";
			this.Trailer1IDTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(78, 20, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.Business.BaseJobDeclaration)(null)).JE_Trailer2RegNo)));
			this.Trailer2IDTextBox.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("3b63d083-2915-4391-95b7-71b4566872af", "Trailer 2", "Trailer 2 ID", "");
			this.Trailer2IDTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(205, 22, true);
			this.Trailer2IDTextBox.Name = "Trailer2IDTextBox";
			this.Trailer2IDTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(78, 20, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.Business.BaseJobDeclaration)(null)).JE_RN_NKTrailer2Nationality)));
			this.Trailer2NationalityCodeFindBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(287, 22, true);
