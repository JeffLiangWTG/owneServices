...
namespace Enterprise.Customs.GUI
{
	partial class MessageEditForm
	{
		...
		private new void InitializeComponent()
		{
			...
			this.zTextBoxMessage.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("E814AAE9-709C-44D1-A278-B55E09D6B6F0", "Message Text");
			...
			this.zButtonOK.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("62F5C90D-334B-4D39-9628-C960CB8E6D5C", "OK");
			...
			this.zButtonCancel.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("CB64FF6B-5DCA-4DBC-A169-72363652A7FF", "Cancel");
			...
			this.CaptionResourceString = Enterprise.Customs.GUI.Res.GetData("E814AAE9-709C-44D1-A278-B55E09D6B6F0", "Message Text");
