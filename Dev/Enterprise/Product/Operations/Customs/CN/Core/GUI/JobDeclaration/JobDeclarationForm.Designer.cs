namespace Enterprise.Customs.CN.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			// BottomButtonPanel
			// 
			this.BottomButtonPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 704, true);
			// 
			// MainStatusBar
			// 
			...
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1216, 756, true);
			this.DataSourceAssemblyName = "Enterprise.Customs.CN.Business";
			this.DataSourceType = typeof(Enterprise.Customs.CN.Business.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs.CN.Business.JobDeclaration";
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1224, 860, true);
