...
public partial class JobComInvoiceLine
{
	...
	protected override Customs.Business.JobComInvoiceLineValidation GetNewValidation() => IsExport ? new ExportJobComInvoiceLineValidation(this) : new JobComInvoiceLineValidation(this);
