...
sealed class ExportSbTableSwCtrlDataProviderTest : ExportSbTableSwCtrlDataProviderAbstractClassBase
{
	public override void TestControlEndDate()
	{
		AssertEquals("TBA", CreateDataProvider().ControlEndDate);
	}

	public override void TestControlLocation()
	{
		AssertEquals("TBA", CreateDataProvider().ControlLocation);
	}

	public override void TestControlResultCode()
	{
		AssertEquals("TBA", CreateDataProvider().ControlResultCode);
	}

	public override void TestControlResultRemarks()
	{
		AssertEquals("TBA", CreateDataProvider().ControlResultRemarks);
	}

	public override void TestControlStartDate()
	{
		AssertEquals("TBA", CreateDataProvider().ControlStartDate);
	}

	public override void TestControlTypeCode()
	{
		AssertEquals("TBA", CreateDataProvider().ControlTypeCode);
	}
	...
	protected override TableSwCtrlDataProviderAbstractClass CreateDataProvider()
	{
		return ExportSbCACHE01DataProvider.CreateProvider(header, new ExportSbCACHE01AdditionalDataProvider(messageSendingObject)).Sb.TableSwCtrl.First();
	}
