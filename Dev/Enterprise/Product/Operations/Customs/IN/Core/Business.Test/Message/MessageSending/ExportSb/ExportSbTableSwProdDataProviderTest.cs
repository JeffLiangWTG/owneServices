...
sealed class ExportSbTableSwProdDataProviderTest : ExportSbTableSwProdDataProviderAbstractClassBase
{
	public override void TestBestBefore()
	{
		AssertEquals("TBA", CreateDataProvider().BestBefore);
	}

	public override void TestDateOfExpiry()
	{
		AssertEquals("TBA", CreateDataProvider().DateOfExpiry);
	}

	public override void TestDateOfManufacturing()
	{
		AssertEquals("TBA", CreateDataProvider().DateOfManufacturing);
	}
	...
	public override void TestProductionBatchIdentifier()
	{
		AssertEquals("TBA", CreateDataProvider().ProductionBatchIdentifier);
	}

	public override void TestProductionBatchQuantity()
	{
		AssertEquals("TBA", CreateDataProvider().ProductionBatchQuantity);
	}
	...
	public override void TestUnitQuantityCode()
	{
		AssertEquals("TBA", CreateDataProvider().UnitQuantityCode);
	}

	protected override TableSwProdDataProviderAbstractClass CreateDataProvider()
	{
		return ExportSbCACHE01DataProvider.CreateProvider(header, new ExportSbCACHE01AdditionalDataProvider(messageSendingObject)).Sb.TableSwProd.First();
	}
