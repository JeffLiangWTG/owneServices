...
sealed class ExportSbTableCessDataProviderTest : ExportSbTableCessDataProviderAbstractClassBase
{
	...
	public override void TestCessActCodeItemSerialNoInExportTariff()
	{
		Assert("to do in future WI", true);
	}
	...
	protected override TableCessDataProviderAbstractClass CreateDataProvider()
	{
		return ExportSbCACHE01DataProvider.CreateProvider(header, AdditionalDataProviderMock.Object).Sb.TableCess.First();
	}
