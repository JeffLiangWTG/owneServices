...
sealed class ExportSbTableDbkDataProviderTest : ExportSbTableDbkDataProviderAbstractClassBase
{
	...
	public override void TestDbkSerialNumber()
	{
		Assert("to do in future WI", true);
	}

	public override void TestDrawbackQuantity()
	{
		Assert("to do in future WI", true);
	}
	...
	protected override TableDbkDataProviderAbstractClass CreateDataProvider()
	{
		return ExportSbCACHE01DataProvider.CreateProvider(header, AdditionalDataProviderMock.Object).Sb.TableDbk.First();
	}
