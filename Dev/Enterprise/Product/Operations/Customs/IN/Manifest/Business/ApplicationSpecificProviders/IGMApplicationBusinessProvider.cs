...
public sealed class IGMApplicationBusinessProvider : ApplicationBusinessProvider
{
	public override Type AsycudaManifestHeaderType => typeof(IGMAsycudaManifestHeader);

	public override MessagingProvider MessagingProvider => null;

	public override FeatureProvider FeatureProvider => new IGMFeatureProvider();
	...
	protected override IReadOnlyList<IManifestType> CreateManifestTypes()
	{
		...
		result.Add(new INManifestTypes().IGM);
		return result;
	}
	...
	protected override IAsycudaManifestHeaderDataObjectWriter
		...
		new AsycudaManifestHeaderDataObjectWriter<IGMAsycudaManifestHeader>(manager);
