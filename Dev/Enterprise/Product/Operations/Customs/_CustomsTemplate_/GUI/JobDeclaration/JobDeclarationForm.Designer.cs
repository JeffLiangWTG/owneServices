namespace Enterprise.Customs._CustomsTemplate_.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			this.BottomButtonPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1350, 28, true);
			// 
			// MainStatusBar
			// 
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Customs._CustomsTemplate_.Business.JobDeclaration);
			// 
			// JobDeclarationForm
			// 
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1350, 686, true);
			this.DataSourceAssemblyName = "Enterprise.Customs._CustomsTemplate_.Business";
			this.DataSourceType = typeof(Enterprise.Customs._CustomsTemplate_.Business.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs._CustomsTemplate_.Business.JobDeclaration";
