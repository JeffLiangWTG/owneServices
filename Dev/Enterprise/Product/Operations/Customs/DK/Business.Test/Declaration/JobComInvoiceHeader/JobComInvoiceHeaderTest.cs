...
namespace Enterprise.Customs.DK.Business.Declaration.Testing
{
	...
	sealed class JobComInvoiceHeaderTest : EU.Business.Declaration.Testing.JobComInvoiceHeaderTest<JobDeclaration, JobComInvoiceHeader, JobComInvoiceLine>
	{
		...
		{
			AssertEquals(Core.Constants.CurrencyCodes.Denmark, Factory.New<JobComInvoiceHeader>().LocalCurrencyCode);
		}

		public override string GetLocalCurrencyCode() => Core.Constants.CurrencyCodes.Denmark;
