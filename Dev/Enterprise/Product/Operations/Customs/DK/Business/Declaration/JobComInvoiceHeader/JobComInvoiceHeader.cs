...
{
	public class JobComInvoiceHeader : EU.Business.Declaration.JobComInvoiceHeader, Integration.Customs.DK.IJobComInvoiceHeader
	{
		...
		protected override CargoWise.Types.ZString LocalCurrencyCodeCore => Core.Constants.CurrencyCodes.Denmark;
