...
{
	sealed public class ManifestLayouts : IPanelLayoutProvider
	{
		...
		PanelLayout CreateManifestDetailsLayout()
		{
			...
			var aeBag = ManifestControlBag.Instance;
			...
			builder.Add(common.CustomsOriginPortCodeFindBox, ControlWidthClass.Long);
			...
			builder.AddColumn();
			builder.Add(aeBag.CarrierMPCITextBox, ControlWidthClass.Medium, common.CarrierAddressControl);
			builder.Add(aeBag.ShippingAgentMPCITextBox, ControlWidthClass.Medium, common.ShippingAgentAddressControl);
