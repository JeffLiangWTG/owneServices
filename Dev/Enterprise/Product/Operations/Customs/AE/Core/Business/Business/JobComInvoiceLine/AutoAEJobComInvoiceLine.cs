...
namespace Enterprise.Customs.AE.Business
{
	...
	public abstract class AutoAEJobComInvoiceLine : Customs.Business.BaseJobComInvoiceLine, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema
		...
		public ITableSchema AddInfoTableSchema => AEJobComInvoiceLineSchema.Instance;

		#endregion

		protected AutoAEJobComInvoiceLine(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoAEJobComInvoiceLine>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoAEJobComInvoiceLine source)
			{
		...
		public new AutoAEJobComInvoiceLineValidation Validation => (AutoAEJobComInvoiceLineValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => AEJobComInvoiceLineSchema.Instance;
