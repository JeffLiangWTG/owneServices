...
[TestedType(typeof(DOCERRMessageProcessor))]
sealed class DOCERRMessageProcessorTest : BaseMessageProcessorAbstractTest<DOCERRMessageProcessor, IDOCERRDataProvider>
{
	public void TestProcessPreProcessOKMessage() => CombineAssertions(() =>
	{
		...
		AssertEquals("EM_Status - SentEDIMessage", EDIMessageStatusList.Codes.Failed, outboundMessage.EM_Status);
