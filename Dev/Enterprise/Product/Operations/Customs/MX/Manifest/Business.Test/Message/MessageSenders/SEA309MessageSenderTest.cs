...
{
	public class SEA309MessageSenderTest : TestCaseWithFactory
	{
		...
		public void TestSendManifest()
		{
			...
			var messageSender = new SEA309MessageSender(header.Bills[0], new SEA309Wrapper(header.Bills[0], MessageSubTypeCodes.Codes.Original, ZString.Empty), MessageSubTypeCodes.Codes.Original);
