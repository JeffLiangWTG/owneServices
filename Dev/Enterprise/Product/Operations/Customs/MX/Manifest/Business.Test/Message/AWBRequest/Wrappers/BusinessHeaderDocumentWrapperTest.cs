...
{
	public class BusinessHeaderDocumentWrapperTest : TestCaseWithFactory
	{
		...
		public void TestBusinessHeaderDocumentWrapper()
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("K. WILSON", businessHeader.SignatoryConsignorAuthentication);

				AssertEquals("2002-07-01T00:00:00", carrierAuthentication.ActualDateTime.ToString("yyyy-MM-ddTHH:mm:ss"));
