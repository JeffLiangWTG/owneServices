...
{
	public class SEA309MessageSender : BaseMessageSender
	{
		public SEA309MessageSender(AsycudaBill bill, ISea309SOManifest dataProvider, ZString messageSubType)
			: base(bill)
		{
		...
		readonly ISea309SOManifest dataProvider;
		...
		protected override ZString MessageType => MessageTypes.Codes.MXA;

		protected override ZString MessageText => MXMessageFormatting.FormatWithXMLRepresentation(((IXmlMessageBuilder)new BLMessageBuilder(dataProvider)).GenerateXmlMessage().GetSerializedString());
