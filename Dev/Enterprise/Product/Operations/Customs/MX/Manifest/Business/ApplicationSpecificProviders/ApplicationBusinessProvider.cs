...
namespace Enterprise.Customs.MX.Manifest.Business
{
	public class ApplicationBusinessProvider : ASYCUDA.Business.ApplicationBusinessProvider
	{
		...
		protected override IReadOnlyList<ZString> CreateCountryCodes() => new[] { (ZString)Core.Constants.CountryCodes.Mexico };

		protected override IReadOnlyList<IManifestType> CreateManifestTypes()
		{
			if (MXCustomsDataRegistry.Instance.EnableMXManifests.Value)
			{
				return new MXManifestTypes().All;
			}
