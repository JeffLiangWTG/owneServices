namespace Enterprise.Customs.MX.GUI
{
	partial class JobDeclarationForm
	{
		...
		protected override void InitializeComponent()
		{
			...
			this.DataSourceAssemblyName = "Enterprise.Customs.MX.Business";
			this.DataSourceType = typeof(Enterprise.Customs.MX.Business.JobDeclaration);
			this.DataSourceTypeName = "Enterprise.Customs.MX.Business.JobDeclaration";
