namespace Enterprise.Customs.MX.GUI
{
	partial class ImportSupplierHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.JobComInvoiceHeadersBoundGrid.GridId = "GridLayoutT+oYGAheR1633dT3oeP+lw==";
			// 
			// 
			// 
			...
			this.JobComInvoiceHeadersBoundGrid.InnerGrid.GridId = "GridLayoutT+oYGAheR1633dT3oeP+lw==";
			...
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(994, 500, true);
