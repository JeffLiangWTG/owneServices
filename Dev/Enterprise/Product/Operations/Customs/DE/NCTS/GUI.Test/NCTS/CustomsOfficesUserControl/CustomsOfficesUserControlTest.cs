...
namespace Enterprise.Customs.DE.NCTS.GUI.Testing
{
	sealed class CustomsOfficesUserControlTest : TestCaseWithFactory
	{
		...
		public void TestCustomsOfficesGrid()
		{
			...
			CombineAssertions(() =>
			{
				AssertSequencesEqual("Sequences", new[] { Customs.Business.AutoCusCodeData.Schema.CY_Code, Customs.Business.AutoCusCodeData.Schema.CY_Data, EU.Business.EuOfficeCode.Schema.CY_OfficeDescription, Customs.Business.AutoCusCodeData.Schema.CY_Date }
				...
				AssertEquals("CY_OfficeDescription", 200, customsOfficesGrid.GetColumnStyle(EU.Business.EuOfficeCode.Schema.CY_OfficeDescription).Width);
