...
namespace Enterprise.Customs.DE.NCTS.GUI.Testing
{
	...
	sealed class NctsPhase5LayoutProviderTest : EU.NCTS.GUI.Testing.NctsPhase5LayoutProviderAbstractTest
	{
		...
		protected override Type ExpectedTransportAndPackagingPanelLayoutType => typeof(EU.NCTS.GUI.Phase5TransportAndPackagingLayout);
		...
		protected override Type ExpectedGoodsItemDetailsLayoutType => typeof(GoodsItemDetailsLayoutWithGrid);
		...
		protected override Type ExpectedArrivalNotificationDetailsPanelLayoutType => typeof(EU.NCTS.GUI.Phase5ArrivalNotificationDetailsLayout);
		...
		protected override IEnumerable<ITabPage> ExpectedAdditionalGoodsItemTabPages
		{
			get
			{
				yield return new EU.NCTS.GUI.WarehouseTabPage();
				yield return new PreviousProcedureTabPage();
			}
		}

		protected override IEnumerable<string> ExpectedReorderGoodsItemTabPageNames => DefaultGoodsItemTabPageNames.Concat(new[] { nameof(EU.NCTS.GUI.WarehouseTabPage), nameof(PreviousProcedureTabPage) });
		...
		protected override Type ExpectedArrivalGoodItemsAdditionalDocumentsLayoutType => typeof(EU.NCTS.GUI.Phase5DepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid);
