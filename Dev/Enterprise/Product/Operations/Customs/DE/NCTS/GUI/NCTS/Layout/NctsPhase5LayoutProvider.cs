...
namespace Enterprise.Customs.DE.NCTS.GUI
{
	public class NctsPhase5LayoutProvider : EU.NCTS.GUI.INctsPhase5LayoutProvider
	{
		...
		public IPanelLayoutWithGridProvider GoodsItemDetailsPanelLayoutWithGrid => new GoodsItemDetailsLayoutWithGrid();
		...
		public IEnumerable<ITabPage> AdditionalGoodsItemTabPages
		{
			get
			{
		...
		public IPanelLayoutWithGridProvider ArrivalGoodsItemAdditionalDocumentPanelLayoutWithGrid => new EU.NCTS.GUI.Phase5DepartureGoodsItemAdditionalDocumentPanelLayoutWithGrid();
