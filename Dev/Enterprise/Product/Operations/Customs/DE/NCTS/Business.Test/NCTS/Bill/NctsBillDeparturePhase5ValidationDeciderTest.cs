...
namespace Enterprise.Customs.DE.NCTS.Business.Testing
{
	sealed class NctsBillDeparturePhase5ValidationDeciderTest : TestCase
	{
		...
		{
			AssertEquals(false, validationDecider.IsRuleR0221Active);
		}
		...
		{
			AssertEquals(expected: false, validationDecider.IsRuleTR0057Active);
		}

		public void TestIsRuleTR0058Active()
		{
			AssertEquals(false, validationDecider.IsRuleTR0058Active);
		}

		public void TestIsRuleTR0059Active()
		{
			AssertEquals(false, validationDecider.IsRuleTR0059Active);
		}
