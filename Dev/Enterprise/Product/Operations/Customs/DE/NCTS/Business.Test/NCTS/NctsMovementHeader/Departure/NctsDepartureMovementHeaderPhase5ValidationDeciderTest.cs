...
namespace Enterprise.Customs.DE.NCTS.Business.Testing
{
	sealed class NctsDepartureMovementHeaderPhase5ValidationDeciderTest : TestCase
	{
		...
		{
			AssertEquals(false, validationDecider.IsRuleB1091Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleB1838Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleB1848_1Active);
		}

		public void TestIsRuleB1850Active()
		{
			AssertEquals(false, validationDecider.IsRuleB1850Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleC0839_1Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleC0586Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleNR0007Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleNR0038Active);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleNR0088Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleR0473Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleTR0017Active);
		}
