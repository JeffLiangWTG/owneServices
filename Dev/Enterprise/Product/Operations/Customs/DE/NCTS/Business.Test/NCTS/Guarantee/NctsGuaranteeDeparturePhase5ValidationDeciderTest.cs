...
namespace Enterprise.Customs.DE.NCTS.Business.Testing
{
	sealed class NctsGuaranteeDeparturePhase5ValidationDeciderTest : TestCase
	{
		...
		{
			AssertEquals(false, validationDecider.IsRuleC0085Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleC0130Active);
		}

		public void TestIsRuleNR0005Active()
		{
			AssertEquals(false, validationDecider.IsRuleNR0005Active);
		}
		...
		{
			AssertEquals(false, validationDecider.IsRuleR0318Active);
		}

		public void TestIsRuleNR0064Active()
		{
			AssertEquals(true, validationDecider.IsRuleNR0064Active);
		}

		public void TestIsRuleNR0065Active()
		{
			AssertEquals(true, validationDecider.IsRuleNR0065Active);
		}
		...
		public void TestIsRuleTR0089Active()
		{
			AssertEquals(true, (validationDecider as IRuleTR0089Decider).IsActive);
		}
		...
		{
			AssertEquals(true, validationDecider.IsRuleTR0093Active);
		}
