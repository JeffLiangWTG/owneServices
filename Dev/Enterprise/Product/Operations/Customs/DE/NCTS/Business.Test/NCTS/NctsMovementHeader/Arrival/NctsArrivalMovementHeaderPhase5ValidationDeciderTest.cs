...
namespace Enterprise.Customs.DE.NCTS.Business.Testing
{
	...
	{
		public void TestIsRuleB18538Active() => AssertEquals(expected: false, validationDecider.IsRuleB1858Active);

		public void TestIsRuleC0191Active() => AssertEquals(expected: false, validationDecider.IsRuleC0191Active);

		public void TestIsRuleNR0009Active() => AssertEquals(expected: true, validationDecider.IsRuleNR0009Active);
		...
		public void TestIsRuleTR0034Active() => AssertEquals(expected: true, validationDecider.IsRuleTR0034Active);
		...
		public void TestIsRuleTR0072Active() => AssertEquals(expected: true, validationDecider.IsRuleTR0072Active);

		public void TestIsRuleTR0091Active() => AssertEquals(expected: true, validationDecider.IsRuleTR0091Active);

		public void TestIsRuleTR0098Active() => AssertEquals(expected: false, validationDecider.IsRuleTR0098Active);

		public void TestIsInBondEntryTypeListValidationActive() => AssertEquals(expected: true, validationDecider.IsInBondEntryTypeListValidationActive);
