...
{
	public void TestIsRuleNR0015Active() => AssertEquals(expected: true, validationDecider.IsRuleNR0015Active);

	public void TestIsRuleTR0035Active() => AssertEquals(expected: false, validationDecider.IsRuleTR0035Active);
