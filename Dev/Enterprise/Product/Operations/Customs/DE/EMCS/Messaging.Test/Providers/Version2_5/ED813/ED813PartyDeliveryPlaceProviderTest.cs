...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_5.Testing
{
	class ED813PartyDeliveryPlaceProviderTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			deliveryPlaceTrader = new ED813FBodyChangeOfDestinationDestinationChangedDeliveryPlaceTrader();
			eD813PartyDeliveryPlaceProvider = ED813PartyDeliveryPlaceProvider.NewOrNull(deliveryPlaceTrader);
		}
		ED813FBodyChangeOfDestinationDestinationChangedDeliveryPlaceTrader deliveryPlaceTrader;
