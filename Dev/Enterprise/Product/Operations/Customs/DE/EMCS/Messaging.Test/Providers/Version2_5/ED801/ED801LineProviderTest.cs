...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_5.Testing
{
	...
	class ED801LineProviderTest : InboundDataProviderTestCase<IED801Line, ED801LineProvider>
	{
		...
		{
			AssertEquals("12 Months", dataProvider.MaturationPeriodOrAgeOfProducts);
		}
		...
		protected override void SetUp()
		{
			...
			line = new ED801EBodyEadContainerBodyEadEsad
			{
				BodyRecordUniqueReference = "1",
				ExciseProductCode = "B000",
				CnCode = "22030001100",
				FiscalMarkUsedFlagSpecified = true,
				FiscalMarkUsedFlag = ED801EBodyEadContainerBodyEadEsadFiscalMarkUsedFlag.Item1,
				FiscalMark = "FM001",
				...
				Package = new ED801EBodyEadContainerBodyEadEsadPackage[2]
				{
					new ED801EBodyEadContainerBodyEadEsadPackage
					{
					},
					new ED801EBodyEadContainerBodyEadEsadPackage
					{
				...
				WineProduct = new ED801EBodyEadContainerBodyEadEsadWineProduct
				{
					WineGrowingZoneCode = "Z1",
					WineProductCategory = ED801EBodyEadContainerBodyEadEsadWineProductWineProductCategory.Item1,
					ThirdCountryOfOrigin = "NZ",
					OtherInformation = "Other Info 001",
					WineOperation = new ED801EBodyEadContainerBodyEadEsadWineProductWineOperation[2]
					{
						new ED801EBodyEadContainerBodyEadEsadWineProductWineOperation
						{
				...
				MaturationPeriodOrAgeOfProducts = "12 Months"
			};
			dataProvider = new ED801LineProvider(line);
		}
		IED801Line dataProvider;
		ED801EBodyEadContainerBodyEadEsad line;
