...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_5.Testing
{
	class ED813PartyNewTransportArrangerProviderTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			newTransportArrangerTrader = new ED813FBodyChangeOfDestinationNewTransportArrangerTrader();
			eD813PartyNewTransportArrangerProvider = ED813PartyNewTransportArrangerProvider.NewOrNull(newTransportArrangerTrader);
		}
		ED813FBodyChangeOfDestinationNewTransportArrangerTrader newTransportArrangerTrader;
