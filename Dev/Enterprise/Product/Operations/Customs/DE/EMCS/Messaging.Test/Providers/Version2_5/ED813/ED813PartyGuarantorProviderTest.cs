...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_5.Testing
{
	class ED813PartyGuarantorProviderTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			guarantorTrader = new ED813FBodyChangeOfDestinationDestinationChangedMovementGuaranteeGuarantorTrader();
			eD813PartyGuarantorProvider = ED813PartyGuarantorProvider.NewOrNull(guarantorTrader);
		}
		ED813FBodyChangeOfDestinationDestinationChangedMovementGuaranteeGuarantorTrader guarantorTrader;
