...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_5.Testing
{
	class ED813PartyConsigneeProviderTest : TestCaseWithFactory
	{
		...
		{
			base.SetUp();
			newConsigneeTrader = new ED813FBodyChangeOfDestinationDestinationChangedNewConsigneeTrader();
			eD813PartyNewConsigneeProvider = ED813PartyNewConsigneeProvider.NewOrNull(newConsigneeTrader);
		}
		ED813FBodyChangeOfDestinationDestinationChangedNewConsigneeTrader newConsigneeTrader;
