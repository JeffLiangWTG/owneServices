...
{
	[TestedType(typeof(ED815LineProvider))]
	class ED815LineProviderTest : LineProviderAbstractTest<ED815LineProvider>
	{
		...
		{
			emcsInvoiceLine.ZG_MaturationPeriodOrAgeOfProducts = "3 Weeks";
			AssertEquals("MaturationPeriodOrAgeOfProducts", "3 Weeks", LineProvider.MaturationPeriodOrAgeOfProducts.Text);
		}

		protected override ED815LineProvider GetLineProvider() => new ED815LineProvider(emcsInvoiceLine);

		protected override ED815LineProvider GetProvider()
		{
			emcsInvoiceLine.ZG_FiscalMark = "FISCAL MARK TEXT";
			emcsInvoiceLine.ZG_Origin = "DESIGNATION OF ORIGIN TEXT";
			emcsInvoiceLine.JI_NDescription = "DESCRIPTION TEXT";
			...
			emcsInvoiceLine.ZG_ExciseProductCode = EMCSJobComInvoiceLine.ExciseProductCode_W200;
			emcsInvoiceLine.ZG_WineCategory = EMCSWineCategoryList.Codes.ImportedWine;
			return new ED815LineProvider(emcsInvoiceLine);
		}

		protected override IEnumerable<Expression<System.Func<ED815LineProvider, object>>> GetPropertiesNeedToBeCached()
		{
