...
{
	class DEMInboundInterchangeProcessorVersion2_4Test : TestCaseWithFactory
	{
		...
		public void TestCreateMessage()
		{
			...
			var messageNames = EmcsResponseMessageDetails.Instance.Version2_4ResponseMessages.Select(x => x.Key);
		...
		public void TestLogbookTime()
		{
			...
			AssertEquals("interchangeInDiffFactory.EI_DeliveredTime", "2020-04-30T15:51:10.5208000+02:00", interchangeInDiffFactory.EI_DeliveredTime.ToISO8601String());
		}
...
";
		...
		const string LogBookTime = "2020-04-30T15:51:10.520793+02:00";
	}
}
