...
namespace Enterprise.Customs.DE.EMCS.Business.Testing
{
	sealed class PartyDeliveryPlaceProviderTest : Customs.Business.Testing.DataProviderTestCase<PartyDeliveryPlaceProvider>
	{
		...
		public void TestTraderId()
		{
			...
			organisation.CustomsCodes.AddNew(OrgCusCode.EuropeanUnionSharedCodeTypes.TraderID, "TID123", Core.Constants.CountryCodes.Germany);
			orgAddress.Address.CustomsCodes.AddNew(OrgCusCode.EuropeanUnionSharedCodeTypes.TraderID, "TID234", Core.Constants.CountryCodes.Germany);
		...
		public void TestTraderId_NotDECountry()
		{
			jobDeclaration.JE_MessageSubType = EMCSDestinationTypeList.Codes.DestinationTaxWarehouse;
		...
		public void TestTraderId_JE_MessageSubTypeNot1AndNot11()
		{
		...
		public void TestTraderId_JE_MessageSubType11()
		{
			orgAddress.E2_AddressOverride = true;
			jobDeclaration.JE_MessageSubType = EMCSDestinationTypeList.Codes.DestinationReturnPlaceOfDispatchConsignor;

			var deliveryPlaceTrader = PartyDeliveryPlaceProvider.NewOrNull(orgAddress);
			AssertEquals("TraderId", string.Empty, deliveryPlaceTrader.TraderId);
		}
