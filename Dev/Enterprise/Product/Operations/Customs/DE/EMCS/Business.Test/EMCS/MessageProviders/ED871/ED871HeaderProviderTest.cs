...
{
	[TestedType(typeof(ED871HeaderProvider))]
	class ED871HeaderProviderTest : HeaderProviderAbstractTest<ED871HeaderProvider>
	{
		...
		[TestDate(2022, 5, 3, 14, 58, 14)]
		public void TestDateOfAnalysisCET()
		{
			AssertEquals("Returns Correct value", new DateTime(2022, 5, 3, 16, 58, 14), HeaderProvider.DateOfAnalysisCET.DateAndTime);
		}
		...
		new IED871Header HeaderProvider => base.HeaderProvider;

		protected override ED871HeaderProvider GetHeaderProvider() => new ED871HeaderProvider(emcsDeclaration, "Reason for Shortage Explanation");

		protected override IEnumerable<Expression<Func<ED871HeaderProvider, object>>> GetPropertiesNeedToBeCached()
		{
