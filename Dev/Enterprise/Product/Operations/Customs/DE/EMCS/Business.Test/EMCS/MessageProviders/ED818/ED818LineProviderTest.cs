...
{
	[TestedType(typeof(ED818LineProvider))]
	class ED818LineProviderTest : LineProviderAbstractTest<ED818LineProvider>
	{
		...
		protected override ED818LineProvider GetLineProvider() => new ED818LineProvider(emcsInvoiceLine);
	}
}
