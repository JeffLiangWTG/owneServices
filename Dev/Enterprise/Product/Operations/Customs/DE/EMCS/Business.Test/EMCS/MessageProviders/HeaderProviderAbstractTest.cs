...
namespace Enterprise.Customs.DE.EMCS.Business.Testing
{
	...
	abstract class HeaderProviderAbstractTest<T> : Customs.Business.Testing.DataProviderTestCase<T>
		where T : HeaderProvider
	{
		...
		protected OrgHeader GetPartyGuarantorOrg(ZString exciseNumber, ZString vatNumber)
		{
			...
			orgHeader.CustomsCodes.AddNew(GermanyOrgCusCodeInfo.OrgCusCodes.UST, vatNumber, Core.Constants.CountryCodes.Germany);
