...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_4
{
	...
	{
		public static ED813PartyGuarantorProvider NewOrNull(ED813EBodyChangeOfDestinationDestinationChangedMovementGuaranteeGuarantorTrader guarantorTrader)
			=> guarantorTrader != null ? new ED813PartyGuarantorProvider(guarantorTrader) : null;

		ED813PartyGuarantorProvider(ED813EBodyChangeOfDestinationDestinationChangedMovementGuaranteeGuarantorTrader guarantorTrader)
		{
			this.guarantorTrader = Argument.NotNull(guarantorTrader, nameof(guarantorTrader));
		}
		readonly ED813EBodyChangeOfDestinationDestinationChangedMovementGuaranteeGuarantorTrader guarantorTrader;
