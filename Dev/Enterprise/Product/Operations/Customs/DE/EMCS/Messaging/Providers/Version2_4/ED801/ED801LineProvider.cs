...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_4
{
	...
	{
		public ED801LineProvider(ED801DBodyEadContainerBodyEad line)
		{
			this.line = Argument.NotNull(line, nameof(line));
		}
		readonly ED801DBodyEadContainerBodyEad line;
		...
		public ZBool FiscalMarkUsedFlag => line.FiscalMarkUsedFlagSpecified && line.FiscalMarkUsedFlag == ED801DBodyEadContainerBodyEadFiscalMarkUsedFlag.Item1;
		...
		public ZDecimal GrossWeight => line.GrossWeight;
		public ZDecimal NetWeight => line.NetWeight;
		...
		public ZString MaturationPeriodOrAgeOfProducts => throw new NotImplementedException();
	}
}
