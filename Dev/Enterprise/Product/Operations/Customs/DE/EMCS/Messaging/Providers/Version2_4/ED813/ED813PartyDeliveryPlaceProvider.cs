...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_4
{
	...
	{
		public static ED813PartyDeliveryPlaceProvider NewOrNull(ED813EBodyChangeOfDestinationDestinationChangedDeliveryPlaceTrader deliveryPlaceTrader)
			=> deliveryPlaceTrader != null ? new ED813PartyDeliveryPlaceProvider(deliveryPlaceTrader) : null;

		ED813PartyDeliveryPlaceProvider(ED813EBodyChangeOfDestinationDestinationChangedDeliveryPlaceTrader deliveryPlaceTrader)
		{
			this.deliveryPlaceTrader = Argument.NotNull(deliveryPlaceTrader, nameof(deliveryPlaceTrader));
		}
		readonly ED813EBodyChangeOfDestinationDestinationChangedDeliveryPlaceTrader deliveryPlaceTrader;
