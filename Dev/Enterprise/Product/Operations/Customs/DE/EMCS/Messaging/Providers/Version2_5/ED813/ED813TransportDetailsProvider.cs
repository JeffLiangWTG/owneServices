...
{
	public class ED813TransportDetailsProvider : IEMCSTransportDetails
	{
		public ED813TransportDetailsProvider(ED813FBodyChangeOfDestinationTransportDetails transportDetails)
		{
			this.transportDetails = Argument.NotNull(transportDetails, nameof(transportDetails));
		}
		readonly ED813FBodyChangeOfDestinationTransportDetails transportDetails;
