...
namespace Enterprise.Customs.DE.EMCS.Messaging.Version2_4
{
	...
	{
		public ED813TransportDetailsProvider(ED813EBodyChangeOfDestinationTransportDetails transportDetails)
		{
			this.transportDetails = Argument.NotNull(transportDetails, nameof(transportDetails));
		}
		readonly ED813EBodyChangeOfDestinationTransportDetails transportDetails;
