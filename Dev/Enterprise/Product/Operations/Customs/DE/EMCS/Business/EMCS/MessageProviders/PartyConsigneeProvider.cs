...
namespace Enterprise.Customs.DE.EMCS.Business
{
	...
	{
		public static new PartyConsigneeProvider NewOrNull(JobDocAddress jobDocAddress)
			=> jobDocAddress != null && jobDocAddress.IsValidAddress ? new PartyConsigneeProvider(jobDocAddress) : null;

		PartyConsigneeProvider(JobDocAddress jobDocAddress)
			: base(jobDocAddress)
		{
