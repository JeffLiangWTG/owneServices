...
{
	public class DEEOutgoingMessageProcessor : OutgoingMessageProcessor
	{
		public DEEOutgoingMessageProcessor(LoggingInformation logger)
			: base(logger)
		{
		}
		...
		ZQuery GetMessageFilterQuery()
		{
			...
			result.AddToFilter(EDIMessageSchema.EM_ApplicationCode, EDIMessage.ApplicationCodes.DECustomsAesSystem);
