...
{
	public class CUSTSTProvider : ICUSTST
  {
		public CUSTSTProvider(SCTSTJ message)
		{
			this.message = Argument.NotNull(message, nameof(message));
		}
		readonly SCTSTJ message;
		...
		public ZString RecipientReferenceNumber => message.MetaData.InterchangeRecipient?.Identification?.ReferenceNumber ?? ZString.Empty;
		...
		public IReadOnlyCollection<IUnderCustomsControlGoodsItem> GoodsItems => goodsItems ?? (goodsItems = message.Body.Select(x => new CUSTSTGoodsItemProvider(x)).ToArray());
