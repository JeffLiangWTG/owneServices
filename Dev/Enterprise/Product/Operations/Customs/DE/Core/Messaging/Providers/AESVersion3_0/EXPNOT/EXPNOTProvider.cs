...
{
	public class EXPNOTProvider : IEXPNOT
	{
		public EXPNOTProvider(DEXPNF message)
		{
			this.message = Argument.NotNull(message, nameof(message));
		}
		readonly DEXPNF message;
		...
		public DateTime? ExitDateTime => DateTime.TryParse(message.ExportOperation.exitDateAndTime, out var converted) ? converted : null;
