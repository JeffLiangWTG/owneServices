...
{
	[TestedType(typeof(ImportFromSumARegisterFilterStripBusinessObject))]
	sealed class ImportFromSumARegisterFilterStripBusinessObjectTest : FilterStripBusinessObjectTestCase
	{
		public void TestRegistrationNumberFilterProperties()
		{
			var registrationNumberFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.RegistrationNumber];
			CombineAssertions(() =>
			{
		...
		{
			var customerReferenceFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.CustomerReference];
			CombineAssertions(() =>
			{
		...
		{
			var lineNumberFilter = (ModuleNumberRangeFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.LineNumber];
			CombineAssertions(() =>
			{
		...
		{
			var ownerReferenceNumberFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.LineOwnerReferenceNumber];
			CombineAssertions(() =>
			{
		...
		{
			var ownerReferenceTypeFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.LineOwnerReferenceType];
			CombineAssertions(() =>
			{
		...
		{
			var goodsDescriptionFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.LineGoodsDescription];
			CombineAssertions(() =>
			{
		...
		public void TestGoodsDescriptionFilter()
		{
			...
			var ownerReferenceTypeFilter = (ModuleTextFilter)filter[ImportFromSumARegisterFilterStripBusinessObject.Schema.LineGoodsDescription];
			ownerReferenceTypeFilter.IsActive = true;
			ownerReferenceTypeFilter.ComparisonOperator = ModuleNumberFilter.ComparisonConstants.Exact;
		...
		protected override FilterStripBusinessObject GetNewFilterStripBusinessObject() => new ImportFromSumARegisterFilterStripBusinessObject();

		protected override void SetUp()
		{
			base.SetUp();
			filter = new ImportFromSumARegisterFilterStripBusinessObject();
		}
		ImportFromSumARegisterFilterStripBusinessObject filter;
