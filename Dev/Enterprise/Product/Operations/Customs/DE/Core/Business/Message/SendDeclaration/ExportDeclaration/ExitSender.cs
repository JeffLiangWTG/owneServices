...
{
	public class ExitSender : ExportDeclarationSender
	{
		public ExitSender(ExportEntryMessageSendingAction action)
			: base(action.MessagingObject, ExportDeclarationMessageBuilderLoader.ExportExit)
		{
			this.action = action;
		}
