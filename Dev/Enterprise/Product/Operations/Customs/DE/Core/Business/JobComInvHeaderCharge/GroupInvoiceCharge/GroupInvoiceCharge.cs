...
{
	public sealed class GroupInvoiceCharge : EU.Business.Declaration.GroupInvoiceCharge, Integration.Customs.DE.IGroupInvoiceCharge
	{
		...
		{
			public const string IsJ7_ExchangeRateIATA = nameof(GroupInvoiceCharge.IsJ7_ExchangeRateIATA);
		}

		[ResourceStringData("17A5FCA7-62CB-4B62-B269-960A0B0E869D", Caption = "IATA")]
		...
		ZBool IsImport => JobDeclaration?.IsImport ?? ZBool.False;

		ZBool IsHighValueOvrd => JobDeclaration.ZG_IsHighValueOvrd;
