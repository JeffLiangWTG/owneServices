...
{
	public class SCIRECEntryLineSnapshotProvider : IMonthlyClosingEntryLineSnapshot
	{
		public SCIRECEntryLineSnapshotProvider(ISCIRECLine line, ISCIRECHeader header)
		{
			this.line = line;
			this.header = header;
		}
		readonly ISCIRECLine line;
