...
{
	public class CUSPCSSplitCusTempStorageLineProvider : CusTempStorageLineProvider, ICUSPCSSplitTempStorageLine
	{
		public CUSPCSSplitCusTempStorageLineProvider(CusTempStorageLine storageLine)
			: base(storageLine)
		{
		}
