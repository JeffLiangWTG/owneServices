...
{
	partial class ImportInvoiceLineSupportingDocumentsUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.BottomPanel.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(0, 137, true);
			...
			// 
			// ImportInvoiceLineSupportingDocumentsUserControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Name = "ImportInvoiceLineSupportingDocumentsUserControl";
