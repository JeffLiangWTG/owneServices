...
{
	public partial class LineToSplitDynamicUserControl : ZUserControl
	{
		public LineToSplitDynamicUserControl()
		{
			InitializeComponent();
		}
		...
		protected override void OnCurrentDataItemChanged(EventArgs e)
		{
			...
			var storageDec = CurrentDataItem as CUSPCSCusTempStorageDec;
			if (storageDec != null)
			{
		...
		void OnSTH_IdentificationIndicatorChanged(object sender, EventArgs e)
		{
			...
			{
				AWBLineToSplitUserControl.Visible = storageDec.IsAWBDeclaration;
				REGLineToSplitUserControl.Visible = storageDec.IsREGDeclaration;
			}
		}

		protected override void Dispose(bool disposing)
		{
			var storageDec = DataSource as CUSPCSCusTempStorageDec;
