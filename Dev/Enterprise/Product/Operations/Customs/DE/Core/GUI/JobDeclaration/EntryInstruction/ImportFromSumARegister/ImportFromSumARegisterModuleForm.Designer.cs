...
{
	partial class ImportFromSumARegisterModuleForm
	{
		/// <summary>
		...
		private new void InitializeComponent()
		{
			...
			// OK_Button
			// 
			this.OK_Button.CaptionResourceString = Enterprise.Customs.DE.GUI.Res.GetData("F5C95740-9CF0-44FB-993E-07CBA4602E9F", "Select");
			...
			// Cancel_Button
			// 
			this.Cancel_Button.CaptionResourceString = Enterprise.Customs.DE.GUI.Res.GetData("5332AD22-06F7-48A5-8902-A3E94A6B09FB", "Cancel");
			...
			// 
			// ImportFromSumARegisterModuleForm
			// 
			...
			this.Name = "ImportFromSumARegisterModuleForm";
