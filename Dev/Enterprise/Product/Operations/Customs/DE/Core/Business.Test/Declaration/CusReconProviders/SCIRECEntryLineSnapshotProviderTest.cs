...
{
	sealed class SCIRECEntryLineSnapshotProviderTest : TestCaseWithFactory
	{
		public void TestCessionManagementFlag()
		{
			var line = new Mock<ISCIRECLine>();
			var header = new Mock<ISCIRECHeader>();
			var provider = new SCIRECEntryLineSnapshotProvider(line.Object, header.Object);
		...
		public void TestForeignTradeFlag()
		{
			...
			var header = new Mock<ISCIRECHeader>();
			var provider = new SCIRECEntryLineSnapshotProvider(line.Object, header.Object);
			AssertNull(provider.ForeignTradeFlag);
		}
