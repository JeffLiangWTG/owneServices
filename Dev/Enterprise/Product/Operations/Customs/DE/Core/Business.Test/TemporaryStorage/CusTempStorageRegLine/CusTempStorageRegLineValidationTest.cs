...
{
	public class CusTempStorageRegLineValidationTest : BusinessObjectValidationTestCase
	{
		public void TestCheckSRL_OwnerReferenceType()
		{
			ValidationTestHelper.AssertInvalidCodeOrEmptyMessageError(line.SRL_OwnerReferenceTypeInfo, "~", OwnerReferenceTypeList.Codes.AWB);
		}
		...
		public void TestCheckSRL_UnionStatus()
		{
			ValidationTestHelper.AssertInvalidCodeOrEmptyMessageError(line.SRL_UnionStatusInfo, "~", DEUnionStatusList.Codes.C);
		}
