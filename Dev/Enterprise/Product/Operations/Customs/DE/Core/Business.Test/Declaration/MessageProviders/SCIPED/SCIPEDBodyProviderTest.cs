...
{
	[TestedType(typeof(SCIPEDBodyProvider))]
	class SCIPEDBodyProviderTest : MonthlyClosingDecBodyProviderAbstractTest<SCIPEDBodyProvider>
	{
		public void TestConstructor()
		{
			AssertExceptionThrown<ArgumentException>(() => new SCIPEDBodyProvider(null, isModificationMessage: false));
		}
		...
		protected override SCIPEDBodyProvider GetProvider() => new SCIPEDBodyProvider(entry, isModificationMessage);

		bool isModificationMessage;

		new ISCIPEDBody Provider => base.Provider;
	}
}
