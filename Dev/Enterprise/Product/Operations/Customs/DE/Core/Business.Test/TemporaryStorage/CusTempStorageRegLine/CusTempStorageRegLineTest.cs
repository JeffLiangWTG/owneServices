	...
	sealed class CusTempStorageRegLineTest : EnterpriseBusinessObjectTestCase
	{
		...
		public void TestHeaderRegNo()
		{
			CombineAssertions(() =>
			{
				...
				regLine.RegHeader.SRH_Reference = "ATB150000010320006000";
				AssertEquals("Should equal Header.SRH_Reference formatted", "AT/B/15/000001/03/2000/6000", regLine.HeaderRegNo);
			});
		}
