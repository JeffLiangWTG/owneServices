...
{
	sealed class SCIRECReconEntryBuilderTest : TestCaseWithFactory
	{
		...
		protected override void SetUp()
		{
			...
			mockHeader = new Mock<ISCIRECHeader>();
			...
			mockHeader.Setup(m => m.Lines).Returns(Array.Empty<ISCIRECLine>());
			...
			entryBuilder = new SCIRECReconEntryBuilder(cusEntryHeader, mockHeader.Object);
		}
		Mock<ISCIRECHeader> mockHeader;
		CusEntryHeader cusEntryHeader;
		SCIRECReconEntryBuilder entryBuilder;
	}
}
