...
{
	sealed class UniversalDateAndTimeProviderTest : TestCase
	{
		[TestDate(2022, 4, 27, 17, 09, 33, 245)]
		[ExpectNoExceptions]
		public void TestNoMilliseconds()
		{
			NUnit.Framework.Assert.That(preparationDateTimeProvider.DateAndTime, Is.EqualTo(new DateTime(2022, 4, 27, 17, 09, 33)));
		}
		...
		{
			preparationDateTimeProvider = new UniversalDateAndTimeProvider(true);
			NUnit.Framework.Assert.That(preparationDateTimeProvider.DateAndTime, Is.EqualTo(new DateTime(2022, 4, 27, 17, 11, 00)));
		}
		...
		{
			NUnit.Framework.Assert.That(preparationDateTimeProvider.Time, Is.EqualTo("17:11:48"));
		}
		...
		{
			preparationDateTimeProvider = new UniversalDateAndTimeProvider(true);
			NUnit.Framework.Assert.That(preparationDateTimeProvider.Time, Is.EqualTo("17:11:00"));
		}
		...
		{
			base.SetUp();
			preparationDateTimeProvider = new UniversalDateAndTimeProvider();
		}
		UniversalDateAndTimeProvider preparationDateTimeProvider;
	}
}
