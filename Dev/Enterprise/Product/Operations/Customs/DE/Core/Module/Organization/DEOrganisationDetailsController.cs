...
{
	public class DEOrganisationDetailsController : ZController
	{
		...
		public override ControllerID ID => ControllerIDs.Customs.DE.OrganisationDetailsPlugIn;
		...
		protected override ZArchitecture.PlugIn.ZPlugIn GetPlugIn(IBusiness businessEntity) => new GUI.OrganisationDetailsPlugIn((OrgHeader)businessEntity);
		public override ResourceStringData PluginTabPageCaption => Res.GetData("PlugInTabPage|DEOrganisationDetailsController", "Germany");
	}
}
