...
{
	public class ImportEntryInstructionDetailsUserControlTest : Customs.GUI.Testing.EntryInstructionDetailsUserControlTest
	{
		public void TestChangeControlsVisibilityImport()
		{
			...
			using (var form = new JobDeclarationForm(declaration))
			{
				...
				var instrUserControl = customsBrokerageUserControl.EntryInstructionDetailsTabPage.Controls.OfType<ImportEntryInstructionDetailsUserControl>().First();
				CombineAssertions(() =>
				{
					Assert("BillNumberTextBox should be Visible", instrUserControl.BillNumberTextBox.Visible);
					Assert("BillTypeDropEdit should be Visible", instrUserControl.BillTypeDropEdit.Visible);
					...
					Assert("BillNumberTextBox should NOT be Visible", !instrUserControl.BillNumberTextBox.Visible);
					Assert("BillTypeDropEdit should NOT be Visible", !instrUserControl.BillTypeDropEdit.Visible);
