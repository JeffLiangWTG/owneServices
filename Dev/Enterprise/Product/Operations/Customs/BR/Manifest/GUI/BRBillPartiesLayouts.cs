...
{
	public sealed class BRBillPartiesLayouts : IPanelLayoutProvider
	{
		PanelLayout BillParties { get; }

		PanelLayout IPanelLayoutProvider.Layout => BillParties;

		public BRBillPartiesLayouts()
		{
		...
		PanelLayout CreateBillPartiesLayout()
		{
			...
			builder.SetVisibility(common.ConsigneeRegNoTypeDropEdit, b => b.IsMercante, b => b.Header?.AMA_ManifestTypeInfo);
			builder.SetVisibility(common.NotifyPartyRegNoTypeDropEdit, b => b.IsMercante, b => b.Header?.AMA_ManifestTypeInfo);
