...
{
	public class BRDataObjectReaderHelper : UniversalDataObjectReaderHelper
	{
		public BRDataObjectReaderHelper(UniversalObjectFactory factory, ZString sourceCountryCode, string dataProviderForCodeMapping = null)
			: base(factory, Core.Constants.CountryCodes.Brazil, sourceCountryCode, dataProviderForCodeMapping)
		{
		}
		...
		CusEntryNumber CreateEntryNumberForEntryInstruction(ZGuid parentPK, ZString entryType)
		{
			...
			using (result.SuspendSettingHasChanges())
			{
				...
				result.CE_RN_NKCountryCode = Core.Constants.CountryCodes.Brazil;
			}
			return result;
		}
	}
