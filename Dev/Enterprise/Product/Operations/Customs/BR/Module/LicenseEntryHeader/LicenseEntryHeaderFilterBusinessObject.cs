...
{
	public class LicenseEntryHeaderFilterBusinessObject : EntryHeaderFilterBusinessObject
	{
		public override ZQuery Filter => base.Filter.AddToFilter(CusEntryHeaderSchema.CH_MessageType, BRJobMessageTypeList.Codes.ImportLicense);
		...
		protected override ModuleFilterCollection GetModuleFiltersCore()
		{
			...
			collection[Constants.EntryNumber].MultilingualDescription = LicenseFilterStripBusinessObject.LicenseNumberText;
			collection[Constants.EntryStatus].MultilingualDescription = LicenseFilterStripBusinessObject.LicenseStatusText;
		...
		protected override EntryHeaderFilterLookups GetNewLookups() => new LicenseEntryHeaderFilterLookups(this);
		public new LicenseEntryHeaderFilterLookups Lookups => (LicenseEntryHeaderFilterLookups)base.Lookups;
	}
}
