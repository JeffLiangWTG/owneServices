...
{
	public partial class LicenseEntryHeaderFilterControl : Customs.Module.EntryHeaderFilterUserControl
	{
		...
		public LicenseEntryHeaderFilterControl() : base()
		{
		}

		public LicenseEntryHeaderFilterControl(IBusinessObjectCollection gridCollection, FilterStripBusinessObject filterBusinessObject)
				...
				new ZTextBoxColumnStyleInfo
					{
						...
						ColumnName = LicenseSchema.Screening,
						IsReadOnly = true,
						IsVisible = false,
				...
				new ZTextBoxColumnStyleInfo
					{
						...
						ColumnName = LicenseSchema.LicenseAuth,
						IsReadOnly = true,
						IsVisible = false,
						Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(120)
					},
				new ZTextBoxColumnStyleInfo
					{
						...
						ColumnName = LicenseSchema.LicenseStyle,
						IsReadOnly = true,
						IsVisible = false,
						Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(120)
					},
				new ZTextBoxColumnStyleInfo
					{
						...
						ColumnName = LicenseSchema.LicenseSubmitted,
						IsReadOnly = true,
						IsVisible = false,
						Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(120)
					},
				new ZTextBoxColumnStyleInfo
					{
						...
						ColumnName = LicenseSchema.IssueDate,
						IsReadOnly = true,
						IsVisible = false,
						Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(120)
					},
		...
		readonly string[] availableColumnsForGrid = new string[]
		{
			...
			CusEntryHeader.Schema.MessageStatusDescription,
			LicenseSchema.IssueDate,
			LicenseSchema.LicenseAuth,
			LicenseSchema.LicenseStyle,
			LicenseSchema.LicenseSubmitted
		};
	}
}
