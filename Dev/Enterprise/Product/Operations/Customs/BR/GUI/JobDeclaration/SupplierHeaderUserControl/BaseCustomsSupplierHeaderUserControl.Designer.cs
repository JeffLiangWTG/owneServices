namespace Enterprise.Customs.BR.GUI
{
	partial class BaseCustomsSupplierHeaderUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.JZ_FOBAmountBoundCurrencyControl.CaptionResourceString = Enterprise.Customs.BR.GUI.Res.GetData("d3f12ec6-a452-4a1c-9142-98574a4197a5", "FOB Value");
			// 
			// JZ_CIFAmountBoundCurrencyControl
			// 
			this.JZ_CIFAmountBoundCurrencyControl.CaptionResourceString = Enterprise.Customs.BR.GUI.Res.GetData("7aea0454-6b93-458b-8cb2-23977306ce43", "Customs Value");
			// 
