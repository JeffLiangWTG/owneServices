...
{
	partial class LPCOCollectionForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.BindingSource.SetBindingMember(this.invoiceRefGrid, "LPCOJobComInvLineRefsCollection");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Customs.BR.Business.JobComInvoiceLine)(null)).LPCOJobComInvLineRefsCollection)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Customs.BR.Business.LPCOJobComInvLineRefs)(((System.Collections.IList)(((Enterprise.Customs.BR.Business.JobComInvoiceLine)(null)).LPCOJobComInvLineRefsCollection)).SyncRoot)).JG_ReferenceNumber)));
			...
			this.CloseButton.CaptionResourceString = Enterprise.Customs.BR.GUI.Res.GetData("LPCOCollectionForm|4f2e0a66-00a0-4e6e-981a-76bf17695620", "Cancel");
			...
			this.OKButton.CaptionResourceString = Enterprise.Customs.BR.GUI.Res.GetData("LPCOCollectionForm|ee61cd73-4a50-4b77-bba0-eb403e52c5e7", "OK");
			...
			this.CaptionResourceString = Enterprise.Customs.BR.GUI.Res.GetData("LPCOCollectionForm|b46e57ab-4635-4be8-895e-1cbc17fddbb7", "LPCO Number");
