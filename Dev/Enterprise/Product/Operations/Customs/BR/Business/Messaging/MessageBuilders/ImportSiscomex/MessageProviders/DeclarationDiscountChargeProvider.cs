...
{
	public class DeclarationDiscountChargeProvider : IDeclarationDiscountCharge
	{
		public DeclarationDiscountChargeProvider(IEnumerable<JobComInvCharge> charges)
		{
		...
		public static DeclarationDiscountChargeProvider New(IEnumerable<JobComInvCharge> charges)
		{
			return charges == null || !charges.Any() ? null : new DeclarationDiscountChargeProvider(charges);
		}
