...
{
	public class ImportLicenseIncoTermAndCustomsChargeFactory : IncoTermAndCustomsChargeFactory
	{
		protected override ICustomsChargeCode[] GetCharges()
		{
			...
			result.Add(ImportLicenseChargesProvider.FreightInNationalTerritory);
		...
		public override CustomsChargeCode GetOverseasInsurance() => ImportLicenseChargesProvider.OverseasInsurance;
		...
		protected override void SetupDeliveredAtPlaceConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.DAP, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupDeliveredAtTerminalConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.DAT, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupExWorksConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.EXW, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupDeliveredDutyPaidConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.DDP, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCarriageAndInsurancePaidToConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CIP, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCarriagePaidToConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CPT, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCostInsuranceAndFreightConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CIF, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCostAndFreightConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CFR, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupFreeAlongsideShipConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.FAS, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupFreeOnBoardConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.FOB, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupFreeCarrierConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.FCA, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCNIConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CPLUSI, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupCNFConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.CPLUSF, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupOCVConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.OCV, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
		...
		protected override void SetupDeliveredAtPlaceUnloadedConfiguration()
		{
			...
			AddChargeConfiguration(BRIncoTermList.Codes.DPU, ImportLicenseChargesProvider.FreightInNationalTerritory, new ChargeConfiguration() { IsIncludedInInvoice = false, IsIncludedInInvoiceAmountFixed = true, IsMandatory = false, IsRecommended = false });
		}
	}
}
