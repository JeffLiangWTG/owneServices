...
namespace Enterprise.Customs.BR.Business
{
	...
	public abstract class AutoBRCusLineTariffDetail : Customs.Business.CusLineTariffDetail, Customs.Business.IAddInfoManagerWithSchema, IOriginalValueProvider, IConcurrencyExceptionDecorator, IAddInfoSchemaProvider
	{
		#region Schema

		public new class Schema : Customs.Business.CusLineTariffDetail.Schema
		{
			public const string BZ_LegalActSubject = "BZ_LegalActSubject";
		}

		public ITableSchema AddInfoTableSchema => BRCusLineTariffDetailSchema.Instance;

		#endregion

		protected AutoBRCusLineTariffDetail(BusinessObjectFactory Factory, DataRow Row) : base(Factory, Row)
		{
			addInfo = new Enterprise.Customs.Business.AddInfoWrapper<AutoBRCusLineTariffDetail>(this
		...
		protected override void CopyAdditionalPersistentValuesFrom(BusinessObject sourceObject, BusinessObjectCloneArgs args)
		{
			...
			if (sourceObject is AutoBRCusLineTariffDetail source)
			{
		...
		{
			{"LegalActSubject", BZ_LegalActSubjectData},
		};
		...
		public virtual ZString BZ_LegalActSubject
		{
			get => BZ_LegalActSubjectData.Value;
			set
			{
				SetNonPersistentPropertyValue(BZ_LegalActSubjectInfo, ref BZ_LegalActSubjectData.Value, value);
				if (!IsValidationSuspended)
				{
					Validation.ValidateBZ_LegalActSubject();
				}
			}
		}
		public ZPropertyInfo BZ_LegalActSubjectInfo => GetZPropertyInfo(Schema.BZ_LegalActSubject);
		AddInfoPropertyData<ZString> BZ_LegalActSubjectData => legalActSubjectData ?? (legalActSubjectData = new AddInfoPropertyData<ZString>(Schema.BZ_LegalActSubject));
		AddInfoPropertyData<ZString> legalActSubjectData;
		...
		public new AutoBRCusLineTariffDetailValidation Validation => (AutoBRCusLineTariffDetailValidation)base.Validation;
		...
		ITableSchema Enterprise.Customs.Business.IAddInfoManagerWithSchema.AddInfoSchema => BRCusLineTariffDetailSchema.Instance;
