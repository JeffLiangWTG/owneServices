...
namespace Enterprise.Customs.BR.Business
{
	partial class JobDeclaration
	{
		...
		protected override Customs.Business.JobDeclarationValidation GetNewValidation()
		{
			...
			if (IsImportSiscomex)
			{
				result = new ImportSiscomexJobDeclarationValidation(this);
			}
			else if (IsImportLicense)
			{
				result = new ImportLicenseJobDeclarationValidation(this);
			}
			else if (IsImport)
			{
			...
			{
				result = new LPCOJobDeclarationValidation(this);
			}
			else
			{
