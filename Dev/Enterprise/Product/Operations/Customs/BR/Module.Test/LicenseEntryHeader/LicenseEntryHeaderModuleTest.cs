...
{
	[TestedType(typeof(LicenseEntryHeaderModule))]
	class LicenseEntryHeaderModuleTest : Customs.Module.Testing.EntryHeaderModuleTest
	{
		public void TestGetNewController()
		{
			using (var module = new LicenseEntryHeaderModule())
			{
				AssertType<LicenseEntryHeaderController>("Controller must be of type LicenseDetailingEntryHeaderController", module.GetNewController());
			}
		}
		...
		protected override ModuleIdentifier GetModuleID() => ModuleIDs.Customs.BR.LicenseEntryHeader;

		public override Type ModuleToBashType => typeof(LicenseEntryHeaderModule);
	}
}
