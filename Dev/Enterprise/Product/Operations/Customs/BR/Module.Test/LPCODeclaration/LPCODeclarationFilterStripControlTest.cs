...
{
	class LPCODeclarationFilterStripControlTest : TestCaseWithFactory
	{
		public void TestColumns()
		{
			var decs = new JobDeclarationCollection(Factory, GlbCompany.CurrentCompany.PK);
			var filterBO = new LPCODeclarationFilterStripBusinessObject();

			using (var filterControl = new LPCODeclarationFilterStripControl(decs, filterBO))
			{
