...
{
	public class DtbConsignmentDataContextManager : ShipmentDataContextManager<DtbConsignment>
	{
		...
		{
			return new DtbConsignmentEventParentFinder(this, factory, logger);
		}
		...
		protected override ITopLevelDataObjectReader GetShipmentDataObjectReader(UniversalShipment universalShipment, IXmlImportLogger logger, UniversalObjectFactory factory)
		{
			...
			return new DtbConsignmentDataObjectReader(consignmentDataObject, logger, factory, ParentBO, universalShipment);
		}

		protected override ITopLevelDataObjectWriter GetShipmentDataObjectWriter(IDataWritingManager writeManager)
		{
			return new DtbConsignmentDataObjectWriter(writeManager);
		}
