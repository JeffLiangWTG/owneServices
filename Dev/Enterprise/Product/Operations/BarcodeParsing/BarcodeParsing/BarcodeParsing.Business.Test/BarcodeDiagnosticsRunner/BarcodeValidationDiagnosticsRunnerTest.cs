...
{
	[TestedType(typeof(BarcodeValidationDiagnosticsRunner))]
	class BarcodeValidationDiagnosticsRunnerTest : BarcodeParsingTestCase
	{
		public void TestRun_WhenConsumerIsNull()
		{
			var runner = new BarcodeValidationDiagnosticsRunner();
