...
partial class HVLVTestConsignmentDataCreatorForm
{
	...
	private new void InitializeComponent()
	{
		...
		this.textBoxShipmentReference = new Enterprise.ZArchitecture.ZTextBox();
		...
		this.groupBoxConsignmentDataSetting.Controls.Add(this.textBoxShipmentReference);
		...
		// 
		this.textBoxShipmentReference.CaptionResourceString = Enterprise.eTail.GUI.Res.GetData("01326e90-1882-48b8-bcda-b2ee6bd9fbe2", "Shipment Reference");
		this.textBoxShipmentReference.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(110, 20, true);
		this.textBoxShipmentReference.Name = "textBoxShipmentReference";
		this.textBoxShipmentReference.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(100, 20, true);
		this.textBoxShipmentReference.TabIndex = 1;
		// 
		// btnOK
		// 
	...
	private ZArchitecture.ZTextBox textBoxShipmentReference;
