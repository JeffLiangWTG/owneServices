...
{
	public class ITH7DeclarationCommandTest : BaseHVLVRelatedJobCommandTest
	{
		protected override string ExpectedRelatedJobName => "Low Value (H7)";

		protected override Type ExpectedRelatedJobConverterType => typeof(ITH7DeclarationConverter);

		protected override string[] ExpectedApplicableLoginCountries => new[] { CountryCodes.Italy };
		...
		protected override Type ExpectedCustomsJobsType => ObjectFactory.GetType<Enterprise.Integration.Customs.ITH7.IAsycudaManifestHeader>();
