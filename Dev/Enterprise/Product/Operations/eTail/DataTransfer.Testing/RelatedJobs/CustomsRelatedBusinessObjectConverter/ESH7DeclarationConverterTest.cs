...
{
	class ESH7DeclarationConverterTest : BaseH7DeclarationConverterTest<ESH7DeclarationConverter>
	{
		...
		protected override ZString LoginCountry => CountryCodes.Spain;
		...
		protected override BaseHVLVRelatedJobCommand GetRelatedJobCommand(ForwardingShipment shipment) => new ESH7DeclarationCommand(shipment);
