...
{
	public class WorkItemDocumentSupporter : DocumentSupporter
	{
		public WorkItemDocumentSupporter(WorkItem workItem)
			: base(workItem)
		{
		}
		...
		{
			get { return (WorkItem)BusinessObject; }
		}
		...
		{
			get { return Env.Security.WorkItemCustomiseDocuments; }
		}
