...
{
	[TestedType(typeof(ProjectCategoryMap))]
	class ProjectCategoryMapTest : RegistryBusinessObjectTemplateTestCase<ProjectCategoryMap>
	{
		public void TestValidationWorksWell()
		{
			...
			item1.SelectionCriterionFieldName = WorkProjectSchema.Constants.WKP_Priority;
		...
		protected override ProjectCategoryMap GetBusinessObjectToClone()
		{
			return ProcessMgmtTestHelper.GetDummyProjectCategoryMap();
		}

		protected override ProjectCategoryMap GetBusinessObjectToSerialise()
		{
			return ProcessMgmtTestHelper.GetDummyProjectCategoryMap();
		}
	}
