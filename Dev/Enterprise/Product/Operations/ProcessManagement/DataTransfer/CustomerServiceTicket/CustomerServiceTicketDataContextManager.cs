...
{
	public class CustomerServiceTicketDataContextManager : ActivityDataContextManager<WorkRequest>
	{
		protected override ZQuery GetDataContextKeyMatchingQuery(IDataContextMatchingKey matchingValues, BusinessObjectFactory factory, IXmlImportLogger logger)
		{
			return new ZQuery(WorkRequestSchema.WKR_RequestNumber, matchingValues.Key);
		}
		...
		{
			return new CustomerServiceTicketDataObjectWriter(writeManager, shouldOnlyIncludeBasicDetails);
		}
		...
		{
			return new CustomerServiceTicketDataObjectReader((Activity)activity, logger, (UniversalObjectFactory)factory);
		}
	}
}
