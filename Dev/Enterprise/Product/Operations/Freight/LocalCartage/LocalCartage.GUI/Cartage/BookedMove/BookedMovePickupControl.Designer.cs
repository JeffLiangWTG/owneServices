...
{
	partial class BookedMovePickupControl
	{
		/// <summary> 
		...
		{
			this.PickupBookingDetailsPanel = new Enterprise.ZArchitecture.GUI.ZPanel();
			...
			this.PickupBookingDetailsPanel.SuspendLayout();
			...
			// 
			// PickupBookingDetailsPanel
			// 
			this.PickupBookingDetailsPanel.Controls.Add(this.zPanel5);
			this.PickupBookingDetailsPanel.Controls.Add(this.RequestedPickupPanel);
			this.PickupBookingDetailsPanel.Controls.Add(this.RequestedDeliveryPanel);
			this.PickupBookingDetailsPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(193, 19, true);
			this.PickupBookingDetailsPanel.Name = "PickupBookingDetailsPanel";
			this.PickupBookingDetailsPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(221, 105, true);
			this.PickupBookingDetailsPanel.TabIndex = 41;
			// 
			// zPanel5
			// 
			...
			this.zPanel5.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(221, 21, true);
			...
			this.RequestedPickupPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(221, 42, true);
			...
			this.RequestedDeliveryPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(221, 42, true);
			...
			// 
			this.BookingAddressGroupBox.Controls.Add(this.PickupBookingDetailsPanel);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Freight.LocalCartage.Business.CommonBookedCtgMove)(null)).PickupFromDocAddress.AddressCaption)));
			...
			this.AddressGroupBoxCaption.TabIndex = 2;
			// 
			// zLabel14
			// 
			this.BindingSource.SetBindingMember(this.zLabel14, "PickupFromDocAddress+E2_CompanyName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Freight.LocalCartage.Business.CommonBookedCtgMove)(null)).PickupFromDocAddress.E2_CompanyName)));
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Freight.LocalCartage.Business.CommonBookedCtgMove)(null)).PickupFromDocAddress.AddressSummaryWithCode)));
		...
		private Enterprise.ZArchitecture.GUI.ZPanel PickupBookingDetailsPanel;
