...
{
	public class CartageBookingMessageAction : ImportMessageAction
	{
		public CartageBookingMessageAction(BusinessObjectFactoryProvider factoryProvider)
			: base(factoryProvider)
		{ }

		protected override IDataImporterControllingSave GetDataImporter()
		{
			return new XmlDataImporter(FactoryProvider, new CommonCartageBookingValueObjectDataAdapter());
		}
