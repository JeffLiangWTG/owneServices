...
{
	public class BookedMovePickupControlTest : TestCaseWithFactory
	{
		public void TestContextMenus()
		{
			...
			using (var control = new BookedMovePickupControl())
			{
				...
				var cydMenu = control.AddressHelper.ContextForTest.MenuItems.FindByText("Container Yard");
