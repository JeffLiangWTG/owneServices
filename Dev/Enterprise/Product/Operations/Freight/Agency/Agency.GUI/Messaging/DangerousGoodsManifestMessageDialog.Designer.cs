...
{
	partial class DangerousGoodsManifestMessageDialog
	{
		...
		protected new void InitializeComponent()
		{
            ...
            // MainStatusBar
            // 
            this.MainStatusBar.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 630, true);
            this.MainStatusBar.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(673, 17, true);
            // 
            // BindingSource
            // 
            this.BindingSource.DataSourceType = typeof(Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage);
            // 
            // tableLayoutPanel1
            // 
            ...
            this.tableLayoutPanel1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(673, 647, true);
            ...
            this.statusPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(2, 174, true);
            this.statusPanel.Name = "statusPanel";
            this.statusPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(670, 451, true);
            ...
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).Issues)));
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Freight.Agency.Business.PortMessageIssue)(((System.Collections.IList)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).Issues)).SyncRoot)).Text)));
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.Freight.Agency.Business.PortMessageIssue)(((System.Collections.IList)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).Issues)).SyncRoot)).Detail)));
            this.issuesGrid.CaptionVisible = false;
            zTextBoxColumnStyleInfo1.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("a5ae6da2-9eb1-4074-b917-836bb79582f7", "Errors");
            ...
            zMultiLineTextBoxColumnInfo1.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("a6cbb608-9706-450d-b029-da0f8125dce0", "Detail");
            ...
            this.issuesGrid.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(670, 451, true);
            this.issuesGrid.TabIndex = 0;
            this.issuesGrid.KeyDown += new System.Windows.Forms.KeyEventHandler(this.IssuesGridKeyDown);
            this.issuesGrid.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.IssuesGridDoubleClick);
            // 
            // logTextBox
            // 
            this.logTextBox.CaptionResourceString = null;
            ...
            this.logTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(670, 451, true);
            ...
            this.panel1.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(590, 35, true);
            this.panel1.Name = "panel1";
            this.panel1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(82, 71, true);
            this.panel1.TabIndex = 1;
            // 
            // cancelButton
            // 
            this.cancelButton.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("e79c3b4a-ea09-4690-9e4b-f90b94f2fa3f", "Cancel");
            this.cancelButton.DialogResult = System.Windows.Forms.DialogResult.Cancel;
            this.cancelButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(5, 47, true);
            ...
            // sendButton
            // 
            this.sendButton.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("42af3979-98fb-4c7c-aac4-d9cbc46832ee", "Send");
            this.sendButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(5, 19, true);
            ...
            this.messageDetailsGroup.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("bef44cd5-0c89-4256-8a08-0e29c3eb9c16", "Message details");
            ...
            this.messageDetailsGroup.Dock = System.Windows.Forms.DockStyle.Fill;
            ...
            this.messageDetailsGroup.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(585, 135, true);
            this.messageDetailsGroup.TabIndex = 2;
            ...
            // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).PrincipalPK)));
            this.principalBoundDropEdit.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("789e8e8f-37f4-4278-95c9-38daff40bc3e", "Principal");
            this.principalBoundDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(98, 47, true);
            ...
            this.principalBoundDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(118, 17, true);
            this.principalBoundDropEdit.TabIndex = 1;
            // 
            // portBoundDropEdit
            // 
            ...
            // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).Port)));
            ...
            this.portBoundDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(73, 17, true);
            this.portBoundDropEdit.TabIndex = 0;
            // 
            ...
            // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).MessageType)));
            this.messageTypeBoundDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(98, 103, true);
            this.messageTypeBoundDropEdit.Name = "messageTypeBoundDropEdit";
            this.messageTypeBoundDropEdit.PreBoundMaxLength = 3;
            this.messageTypeBoundDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(168, 17, true);
            this.messageTypeBoundDropEdit.TabIndex = 3;
            // 
            ...
            // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
            CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage)(null)).Direction)));
            this.directionBoundDropEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(98, 75, true);
            ...
            this.directionBoundDropEdit.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(94, 17, true);
            this.directionBoundDropEdit.TabIndex = 2;
            // 
            // warningText
            // 
            ...
            this.warningText.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(585, 33, true);
            ...
            // 
            // DangerousGoodsManifestMessageDialog
            // 
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
            this.CaptionRenderingEnabled = true;
            this.CaptionResourceString = Enterprise.Freight.Agency.GUI.Res.GetData("d55dd39d-25c7-4d52-a775-7ec370605172", "Dangerous Goods Manifest");
            this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(673, 647, true);
            this.Controls.Add(this.tableLayoutPanel1);
            this.DataSourceType = typeof(Enterprise.Freight.Agency.Business.DangerousGoodsManifestMessage);
            this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(500, 400, true);
            this.Name = "DangerousGoodsManifestMessageDialog";
		...
		ZArchitecture.GUI.ZGuidDropEdit principalBoundDropEdit;
	}
}
