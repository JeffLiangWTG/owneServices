...
{
	public class PortManifestPortRegistryItemEditor : NonPersistentBusinessObjectBindingRegistryItemEditor
	{
		public PortManifestPortRegistryItemEditor(IRegistryDataType dataType, FallbackLevel fallbackLevel, BusinessObjectFactory factory)
			: base(dataType, fallbackLevel, factory) { }

		protected override RegistryZUserControl NewBoundWinFormsEditorPane()
		{
			return new PortManifestPortControl();
		}
