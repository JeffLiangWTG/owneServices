...
{
	public class EIDOMessagingRegistryItemEditor : NonPersistentBusinessObjectBindingRegistryItemEditor
	{
		public EIDOMessagingRegistryItemEditor(EIDOMessagingRegistryDataType dataType, FallbackLevel fallbackLevel, BusinessObjectFactory factory)
			: base(dataType, fallbackLevel, factory) { }

		protected override RegistryZUserControl NewBoundWinFormsEditorPane()
		{
			return new EIDOMessagingRegistryItemControl();
		}
