...
{
	public class PortAuthorityPortRegistryItemEditor : NonPersistentBusinessObjectBindingRegistryItemEditor
	{
		public PortAuthorityPortRegistryItemEditor(IRegistryDataType dataType, FallbackLevel fallbackLevel, BusinessObjectFactory factory)
			: base(dataType, fallbackLevel, factory) { }

		protected override RegistryZUserControl NewBoundWinFormsEditorPane()
		{
			return new PortAuthorityPortControl();
		}
