...
{
	public partial class BillOfLadingImageControl : RegistryZUserControl
	{
		public BillOfLadingImageControl()
		{
			InitializeComponent();

			ImageSelectionControl.ImageObjectChangedByUser += (sender, e) =>
			{
				NotifyChanges();
			};
		}
		...
		protected override void SetControlOrBusinessEntityReadOnly(bool readOnly)
		{
			...
			this.ImageSelectionControl.ReadOnly = readOnly;
