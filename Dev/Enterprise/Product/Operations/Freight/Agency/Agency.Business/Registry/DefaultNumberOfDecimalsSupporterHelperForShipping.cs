...
{
	public static class DefaultNumberOfDecimalsSupporterHelperForShipping
	{
			...
			where T : BusinessObject, IDefaultNumberOfDecimalsSupporter
		{
			...
			int result = AgencyRegistry.Instance.DefaultNumberOfDecimalPlaces.Value.GetNumberOfDecimals(parent.TransportMode, unitOfMeasure);
			...
			where T : BusinessObject, IDefaultNumberOfDecimalsSupporter
		{
			...
			var unitOfMeasure = parent.GetUnitOfMeasure(property);
			var result = AgencyRegistry.Instance.DefaultNumberOfDecimalPlaces.Value.GetRoundingMode(parent.TransportMode, unitOfMeasure);
