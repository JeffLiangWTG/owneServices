...
{
	public sealed class PortManifestPortLookups : ZLookups
	{
		public PortManifestPortLookups(PortManifestPort parent, BusinessObjectFactory currentFactory)
			: base(parent)
		{
		...
		readonly PortManifestPort parent;
		...
		public RefUNLOCOCollection Port_List
		{
			get
			{
				if (port_List == null)
				{
					...
					filter.AddToFilter(RefUNLOCOSchema.RL_Code, PortManifestCountryList.EnabledPorts);
