...
{
	public class BookingVisualizableDocumentSupporter : AgencyShipmentVisualizableDocumentSupporter<AgencyBooking>
	{
		public BookingVisualizableDocumentSupporter(AgencyBooking parent) : base(parent)
		{
		}
