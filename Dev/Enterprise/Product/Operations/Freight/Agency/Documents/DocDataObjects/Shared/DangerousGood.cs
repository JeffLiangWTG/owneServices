...
{
	public class DangerousGood : DocDataObject, IDangerousGood, IAdHocValidationProvider
	{
		#region Quantity
		...
		#region IAdHocValidationProvider

		public Func<IEnumerable<string>> Validator { get; set; }
