...
{
	class AgencyHouseBillLogoTest : TestCaseWithFactory
	{
		public void TestImage()
		{
			...
			{
				AssertNotNull(new AgencyHouseBillLogo(billOfLading).Image);

				billOfLading.JS_OH_DeliveryAgent = ZGuid.Empty;
				AssertNull(new AgencyHouseBillLogo(billOfLading).Image);
			}
