...
{
	sealed class SundryChargesFilterControlTest : TestCaseWithFactory
	{
		...
		SundryChargesFilterControl GetFilterControl() => new (new SundryChargesCollection(Factory), new SundryChargesFilterStrip());
	}
}
