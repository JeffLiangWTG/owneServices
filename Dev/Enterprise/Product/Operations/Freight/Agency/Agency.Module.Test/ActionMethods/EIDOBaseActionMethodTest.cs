...
{
	internal abstract class EIDOBaseActionMethodTest<T> : OperationalActionMethodTest<T> where T : EIDOBaseActionMethod
	{
		...
		public void TestRequirements()
		{
			...
			AssertContainsExactElementsInAnyOrder("Constraint Names", new string[] { FilterConstants.Country }, new List<FilterRequirement>(requirements).ConvertAll((r) => r.ConstraintName));
			AssertContainsExactElementsInAnyOrder("Countries", new string[] { Constants.CountryCodes.Australia }, requirements[FilterConstants.Country]);
		}
	}
}
