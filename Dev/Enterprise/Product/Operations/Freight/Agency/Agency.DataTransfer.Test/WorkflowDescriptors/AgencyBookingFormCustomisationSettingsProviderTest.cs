...
{
	[TestedType(typeof(AgencyBookingFormCustomisationSettingsProvider))]
	public class AgencyBookingFormCustomisationSettingsProviderTest : FormCustomisationSettingsProviderTest<AgencyBookingFormCustomisationSettingsProvider>
	{
		public override AgencyBookingFormCustomisationSettingsProvider GetNewProvider() => new AgencyBookingFormCustomisationSettingsProvider();
