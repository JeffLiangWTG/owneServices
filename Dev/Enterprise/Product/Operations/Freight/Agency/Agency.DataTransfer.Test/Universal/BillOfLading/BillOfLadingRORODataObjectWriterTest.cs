...
{
	sealed class BillOfLadingRORODataObjectWriterTest : UniversalShipmentDataObjectWriterTest
	{
		...
		protected override string GetExpectedDataObjectXml()
		{
			...
			{
				return retriever.GetString("Enterprise.Freight.Agency.DataTransfer.Test.Universal.BillOfLading.TestFiles.BillOfLading_UniversalShipment_Roro.xml");
			}
		}
		...
		protected override BusinessObject GetShipmentBusinessObject()
		{
			...
			container2.JC_VehicleModel = "HUMP ZAPOROZHETS";
