...
{
	class AgencyBookingStatusDataObjectWriter : AgencyBookingDataObjectWriter
	{
		public AgencyBookingStatusDataObjectWriter(IDataWritingManager manager, AgencyBookingContainer container = null) : base(manager, container)
		{
		}
		...
		protected override void WriteNotes(AgencyBooking sourceBO, Shipment dataObject)
		{
