...
{
	public sealed partial class FreightShipmentVsConsolMessageHelper : ShipmentVsConsolMessageHelper
	{
		public static IShipmentVsConsolMessageHelper Instance
		{
			get
			{
				...
				if (instance == null)
				{
					instance = new FreightShipmentVsConsolMessageHelper();
				}
				return instance;
			}
		}
...
namespace Enterprise.Freight.Business
{
	public sealed partial class FreightShipmentVsConsolMessageHelper
	{
		[ThreadStatic]
