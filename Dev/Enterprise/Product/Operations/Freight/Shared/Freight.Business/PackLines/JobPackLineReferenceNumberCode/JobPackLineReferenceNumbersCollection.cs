...
{
	public sealed class JobPackLineReferenceNumbersCollection : ActiveBusinessObjectCollection<CusEntryNumber>
	{
		public JobPackLineReferenceNumbersCollection(BusinessObject parent)
			: base(parent.Factory, parent, new ZQuery(), CusEntryNumSchema.CE_ParentID)
		{
		}

		public JobPackLineReferenceNumbersCollection(BusinessObject parent, ZQuery query)
			: base(parent.Factory, parent, query, CusEntryNumSchema.CE_ParentID)
		{
		}
		...
		protected override void SetDefaultsForNewElementCore(CusEntryNumber newElement)
		{
			...
			newElement.CE_ParentTable = PackLine.Schema.TableName;
