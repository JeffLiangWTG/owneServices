...
{
	public class CusISFHeaderScheduleRelatedJobType : ScheduleRelatedJobType
	{
		public CusISFHeaderScheduleRelatedJobType(string code, MultilingualString description)
