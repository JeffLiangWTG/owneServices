...
{
	sealed class JobSeaSailingModuleStripTest : BaseFreightTest
	{
		public void TestVessalVoyageFilterControl()
		{
			...
			using (TestJobSeaSailingModuleStrip strip = new TestJobSeaSailingModuleStrip())
			{
		...
		class TestJobSeaSailingModuleStrip : JobSeaSailingModuleStrip
		{
		...
		void AssertControl<T>(TestJobSeaSailingModuleStrip strip, Control control, string bindingMember)
		{
