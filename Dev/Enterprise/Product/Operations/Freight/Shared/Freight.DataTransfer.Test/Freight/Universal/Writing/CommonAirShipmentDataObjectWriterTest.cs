...
{
	sealed class CommonAirShipmentDataObjectWriterTest : UniversalShipmentDataObjectWriterTest
	{
		...
		protected override string GetExpectedDataObjectXml()
		{
			...
			{
				return resourceRetriever.GetString("Enterprise.Freight.DataTransfer.Test.Freight.Universal.TestFiles.CommonAirShipment_UniversalShipment.xml");
			}
		}
