...
{
	public class JobCartageRunSheetLookups : AutoJobCartageRunSheetLookups
	{
		public JobCartageRunSheetLookups(AutoJobCartageRunSheet parent)
			: base(parent)
		{
		}

		#region CartageBindingLists
