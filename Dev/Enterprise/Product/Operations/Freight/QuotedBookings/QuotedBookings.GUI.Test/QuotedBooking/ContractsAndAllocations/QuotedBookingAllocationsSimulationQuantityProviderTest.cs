...
{
	sealed class QuotedBookingAllocationsSimulationQuantityProviderTest : TestCaseWithFactory
	{
		public void TestGetTotalCNQuantityForAllocation()
		{
			...
			var container4 = quotedBooking.QuotedBookingContainers.AddNew();
			...
			var quantityProvider = new QuotedBookingAllocationSimulationQuantityProvider(quotedBooking);
