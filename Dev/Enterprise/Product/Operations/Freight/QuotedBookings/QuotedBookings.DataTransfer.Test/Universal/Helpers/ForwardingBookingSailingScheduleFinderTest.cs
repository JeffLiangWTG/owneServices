...
{
	public class ForwardingBookingSailingScheduleFinderTest : TestCaseWithUniversalObjectFactory
	{
		public void TestGetTransportSailing()
		{
			...
			var finder = new ForwardingBookingSailingScheduleFinder(Factory, sailingLeg, logger);
