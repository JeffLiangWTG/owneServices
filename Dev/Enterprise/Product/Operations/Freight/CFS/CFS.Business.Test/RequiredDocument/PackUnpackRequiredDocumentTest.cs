...
{
	[TestedType(typeof(PackUnpackRequiredDocument))]
	sealed class PackUnpackRequiredDocumentTest : EnterpriseBusinessObjectTestCase
	{
		...
		{
			var document = bizo as PackUnpackRequiredDocument;
			if (document != null)
			{
				document.ParentType = typeof(PackUnpackDocsAndCartage);
			}
		}
	}
}
