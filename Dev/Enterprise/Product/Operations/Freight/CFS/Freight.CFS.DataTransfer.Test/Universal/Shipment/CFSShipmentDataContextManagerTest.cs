...
{
	[TestedType(typeof(CFSShipmentDataContextManager))]
	class CFSShipmentDataContextManagerTest : BaseShipmentDataContextManagerTest<CFSShipmentDataContextManager, CFSShipment>
	{
		...
		protected override void MakeShipmentUsableForThisRole(RecipientRoleType recipientRoleType, Shipment shipmentWithRecipientRole)
		{
			if (recipientRoleType == RecipientRoleType.ACF || recipientRoleType == RecipientRoleType.DCF)
			{
				...
				shipmentWithRecipientRole.DataContext.AddDataSource(DataContextType.CFSShipment, null);
			}
		}
  ...
  <Shipment>
    <DataContext>
      ...
      <Workflow>
        ...
        <TriggerDate>2015-01-22T08:54:22.77</TriggerDate>
    ...
    <ParentShipmentCollection>
      ...
      <ParentShipment>
		...
		public void TestPopulateUniversalShipmentXML_ForwardingShipmentDataSource_AvoidImportingTwice()
		{
...
Successfully saved Shipment H00001000 (House Bill='HOUSE1111111').
