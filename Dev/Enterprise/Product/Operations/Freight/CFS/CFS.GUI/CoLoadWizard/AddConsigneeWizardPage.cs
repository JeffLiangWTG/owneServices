	...
	public partial class AddConsigneeWizardPage : WizardPage
	{
		...
		void StartWizardPictureBox_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			using (var brush = new LinearGradientBrush(StartWizardPictureBox.Bounds, SystemColors.ActiveCaption, SystemColors.ControlLight, 90.0f, false))
			{
				...
				var point = new Point(ControlDpiScalingHelper.ScaleToCurrentDpiX(8), StartWizardPictureBox.Bottom - (CoLoadWizardForm.ConsigneeImage.Height + ControlDpiScalingHelper.ScaleToCurrentDpiY(10)));
				e.Graphics.DrawImage(CoLoadWizardForm.ConsigneeImage, point);
			}
