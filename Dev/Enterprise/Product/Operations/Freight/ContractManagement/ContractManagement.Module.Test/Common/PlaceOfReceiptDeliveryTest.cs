...
{
	[TestedType(typeof(PlaceOfReceiptDeliveryFilter))]
	sealed class PlaceOfReceiptDeliveryFilterTest : NonPersistentBusinessObjectTestCase
	{
		public void TestClear()
		{
			...
			var filter = (PlaceOfReceiptDeliveryFilter)GetNewBusinessObject();
  ...
  <Property2>AUSYD</Property2>
		...
		{
			return new PlaceOfReceiptDeliveryFilter(AllocationRouteFilterConstants.LoadDischargePort, new LocationCollection(Factory));
		}
	}
}
