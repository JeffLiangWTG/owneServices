...
{
	public sealed class DoorToDoorDeliveryDueDateCalculator : DeliveryDueDateCalculator
	{
		public DoorToDoorDeliveryDueDateCalculator(DeliveryDueDateCalculationContext context) : base(context)
		{
		}
