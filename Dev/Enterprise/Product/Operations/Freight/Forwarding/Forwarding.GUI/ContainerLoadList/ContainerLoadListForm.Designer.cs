...
{
	partial class ContainerLoadListForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.CustomFieldsUserControl = new ContainerLoadListCustomFieldsUserControl();
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Freight.Forwarding.Orders.Business.CommonContainerLoadList);
			// 
			// WorkflowTabPage
			// 
			this.WorkflowTabPage.CaptionResourceString = Enterprise.Freight.Forwarding.GUI.Res.GetData("ContainerLoadListForm|006912C2-4720-4156-8BB1-7C15E0A55CE9", "Workflow & Tracking");
			...
			// CustomFieldsTabPage
			//
			this.CustomFieldsTabPage.CaptionResourceString = Enterprise.Freight.Forwarding.GUI.Res.GetData("ContainerLoadListUserControl|9F210052-1D92-48F4-9854-E4978D977EE4", "Additional Details");
			...
			// 
			// ContainerLoadListForm
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(980, 508, true);
			this.DataSourceType = typeof(Enterprise.Freight.Forwarding.Orders.Business.CommonContainerLoadList);
			this.Name = "ContainerLoadListForm";
		...
		private ContainerLoadListCustomFieldsUserControl CustomFieldsUserControl;
		#endregion

		private ContainerLoadListUserControl containerLoadListUserControl;
	}
}
