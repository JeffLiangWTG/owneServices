...
{
	sealed class ConsolDashboardContractAllocationNotificationProvider : IRatingContractSimulationNotificationProvider
	{
		public ConsolDashboardContractAllocationNotificationProvider(ForwardingConsol consol)
		{
		...
		{
			var assignmentValidator = new CCARouteConsolAssignmentValidator(true);
