...
{
	partial class ContainerLoadPlanCustomFieldsUserControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.CustomFieldsUserControl.NothingSetupMessageLabelText = Enterprise.Freight.Forwarding.GUI.Res.GetString("BACD8E3B-B138-497D-8898-EB04CA2C9334", "To make use of custom fields, please set up Container Load Plan custom fields in Workflow Manager.");
			...
			// 
			// ContainerLoadPlanCustomFieldsUserControl
			//
			this.CaptionRenderingEnabled = true;
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Controls.Add(this.CustomFieldsUserControl);
			this.Name = "ContainerLoadPlanCustomFieldsUserControl";
