...
{
	partial class ContainerLoadPlanForm
	{
		...
		new void InitializeComponent()
		{
			...
			this.CustomFieldsUserControl = new ContainerLoadPlanCustomFieldsUserControl();
			...
			// WorkflowTabPage
			// 
			this.WorkflowTabPage.CaptionResourceString = Enterprise.Freight.Forwarding.GUI.Res.GetData("ContainerLoadPlanForm|31CC7BD8-8C1C-4E60-B73D-0EDEE340729C", "Workflow & Tracking");
			...
			// CustomFieldsTabPage
			//
			this.CustomFieldsTabPage.CaptionResourceString = Enterprise.Freight.Forwarding.GUI.Res.GetData("ContainerLoadPlanUserControl|AA7AA89F-9147-4FF7-B082-CA4E4F037066", "Additional Details");
			...
			this.DataSourceType = typeof(Enterprise.Freight.Forwarding.Orders.Business.CFSContainerLoadList);
			this.Name = "ContainerLoadPlanForm";
		...
		private ContainerLoadPlanCustomFieldsUserControl CustomFieldsUserControl;
		#endregion

		private ContainerLoadPlanUserControl containerLoadPlanUserControl;
	}
}
