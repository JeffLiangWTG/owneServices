...
{
	public class ControlTowerModuleTest : TestCaseWithFactory
	{
		public void TestControlTowerModuleUrl()
		{
			...
			using (var module = new ControlTowerModule())
			{
				var url = module.Url?.ToString();

				AssertContains(glowPortalsUrl, url);
				AssertContains("/goto/ControlTower", url);
			}
		}
		...
		public void TestSecurityCheckpoint()
		{
			using (var module = new ControlTowerModule())
			{
				Assertion.AssertEquals(Env.Security.ControlTowerPlus, module.SecurityCheckpoint);
			}
		}
	}
}
