...
{
	public class LoadListLineRequestSupportedAddressTypesProvider : IExternalRequestSupportedAddressTypesProvider
	{
		public CodeDescriptionPairList SupportedAssigneeAddressTypes
		{
			get
			{
				return supportedAssigneeAddressTypes ?? (supportedAssigneeAddressTypes = new CodeDescriptionPairList()
				{
					...
					new CodeDescriptionPair(DocAddressTypes.Codes.LoadListParty, DocAddressTypes.Descriptions.LoadListParty)
				});
			}
		}
