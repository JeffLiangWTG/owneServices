...
{
	[TestedType(typeof(ContainerLoadListWorkflowDescriptor))]
	public class ContainerLoadListWorkflowDescriptorTest : WorkflowDescriptorTestCase<ContainerLoadListWorkflowDescriptor>
	{
		public override void TestDescription()
		{
			AssertEquals("Correct Desc", "Container Load List", WorkflowDescriptor.Description);
		}

		public override void TestID()
		{
			AssertEquals("Correct Code", WorkflowDescriptors.ContainerLoadListWorkflowDescriptorCode, WorkflowDescriptor.Code);
		}
		...
		protected override IWorkflowProvider[] GetParentsWithConfiguredOrganisationPartiesForTest()
		{
			...
			{
				ContainerLoadListHeaderWithOrganisationParties,
			};
		}

		protected CYContainerLoadList ContainerLoadListHeaderWithOrganisationParties
		{
			get { return containerLoadListHeaderWithOrganisationParties ?? (containerLoadListHeaderWithOrganisationParties = GetOrgWithCommunicationModes()); }
		}
		CYContainerLoadList containerLoadListHeaderWithOrganisationParties;

		CYContainerLoadList GetOrgWithCommunicationModes()
		{
		...
		{
			AssertType<ContainerLoadListValidationToolSettings>(WorkflowDescriptor.ValidationToolSettings);
		}
	}
}
