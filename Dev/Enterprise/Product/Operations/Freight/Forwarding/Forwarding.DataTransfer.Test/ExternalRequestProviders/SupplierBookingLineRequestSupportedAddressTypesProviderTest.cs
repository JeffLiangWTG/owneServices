...
{
	[TestedType(typeof(SupplierBookingLineRequestSupportedAddressTypesProvider))]
	internal class SupplierBookingLineRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new SupplierBookingLineRequestSupportedAddressTypesProvider();
			...
			AssertArrayEqualsByElements(new string[] {
				...
				DocAddressTypes.Codes.BookingPartyDocumentaryAddress
			...
			AssertArrayEqualsByElements(new string[] {
				...
				DocAddressTypes.Descriptions.BookingPartyDocumentaryAddress
