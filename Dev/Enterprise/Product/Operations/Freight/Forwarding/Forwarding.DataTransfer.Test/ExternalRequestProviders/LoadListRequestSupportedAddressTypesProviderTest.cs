...
{
	[TestedType(typeof(LoadListRequestSupportedAddressTypesProvider))]
	internal class LoadListRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new LoadListRequestSupportedAddressTypesProvider();
