...
{
	[TestedType(typeof(LoadPlanLineRequestSupportedAddressTypesProvider))]
	internal class LoadPlanLineRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new LoadPlanLineRequestSupportedAddressTypesProvider();
