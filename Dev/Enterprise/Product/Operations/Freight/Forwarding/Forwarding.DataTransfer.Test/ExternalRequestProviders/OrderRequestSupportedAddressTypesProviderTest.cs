...
{
	[TestedType(typeof(OrderRequestSupportedAddressTypesProvider))]
	internal class OrderRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new OrderRequestSupportedAddressTypesProvider();
