...
{
	[TestedType(typeof(SupplierBookingRequestSupportedAddressTypesProvider))]
	internal class SupplierBookingRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new SupplierBookingRequestSupportedAddressTypesProvider();
