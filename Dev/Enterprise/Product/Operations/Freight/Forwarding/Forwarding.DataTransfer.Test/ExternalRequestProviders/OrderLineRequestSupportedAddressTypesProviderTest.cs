...
{
	[TestedType(typeof(OrderLineRequestSupportedAddressTypesProvider))]
	internal class OrderLineRequestSupportedAddressTypesProviderTest : TestCaseWithFactory
	{
		public void TestSupportedAssigneeAddressTypes()
		{
			var provider = new OrderLineRequestSupportedAddressTypesProvider();
