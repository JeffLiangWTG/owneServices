...
{
	sealed class ACASShipmentReportSendingProviderTest : DocDataObjectReportSendingProviderTest
	{
		protected override ZString ExpectedMessageSenderFullName => "Enterprise.Freight.Forwarding.Documents.DataObjects.AirCargoAdvanceScreeningMessageSender";
		...
		protected override BusinessObject GetValidBusinessObjectForSending()
		{
			...
			return testHelper.CreateShipmentWithoutErrors("08135025185", "S0000011", "AUSYD", "USCHI");
		}
