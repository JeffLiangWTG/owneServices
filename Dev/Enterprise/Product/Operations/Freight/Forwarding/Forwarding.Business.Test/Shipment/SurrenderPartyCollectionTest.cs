...
{
	[TestedType(typeof(SurrenderPartyCollection))]
	public class SurrenderPartyCollectionTest : BusinessObjectCollectionTestCase
	{
		protected override BusinessObjectCollection GetCollectionToTest()
		{
			return new SurrenderPartyCollection(Factory);
		}

		public void TestAddNotificationWhenAdditionalFilterNotMet()
		{
			var collection = new SurrenderPartyCollection(Factory);
