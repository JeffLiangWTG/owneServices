...
{
	[TestedType(typeof(Aanzfta))]
	sealed class AanzftaTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			return new Aanzfta("ForwardingShipment", "S00001015")
			{
				LineItems = new[]
				{
					new AanzftaLineItem("990134e1-1186-49c1-833b-5a72b92a210c")
					{
						ItemNumber = 1,
