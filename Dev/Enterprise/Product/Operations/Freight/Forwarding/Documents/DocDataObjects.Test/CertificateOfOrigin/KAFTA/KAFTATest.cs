...
{
	[TestedType(typeof(KAFTA))]
	sealed class KAFTATest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			return new KAFTA("ForwardingShipment", "S00001015")
			{
				LineItems = new[]
				{
					new KAFTALineItem("990134E1-1186-49C1-833B-5A72B92A210C")
					{
						ItemNumber = 1,
