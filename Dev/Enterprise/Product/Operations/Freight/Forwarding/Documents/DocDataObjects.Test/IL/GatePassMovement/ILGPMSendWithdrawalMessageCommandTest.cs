...
{
	sealed class ILGPMSendWithdrawalMessageCommandTest : ILSendWithdrawalCustomCommandBaseTest
	{
		protected override ILCustomCommandBase CreateCommand(ForwardingShipment shipment)
			=> new ILGPMSendWithdrawalMessageCommand(shipment?.GatePassMovementProvider);
