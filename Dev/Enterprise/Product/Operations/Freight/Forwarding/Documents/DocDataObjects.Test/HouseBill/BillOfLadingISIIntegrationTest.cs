...
{
	sealed class BillOfLadingISIIntegrationTest : BillOfLadingTemplateBaseTest
	{
		public override string TemplateName
		{
			get
			{
				return "Bill Of Lading ISI";
			}
		}
		...
		public override ForwardingShipment GetNewShipment()
		{
			...
			shipment.JS_HouseBillOfLadingType = Constants.HouseBillOfLadingTypes.Code.ITClubAustraliaNoTerms;
...
[44,4] Hbol-ITC";
		...
		public override void TestDocumentContent()
		{
			...
			var templatePK = new ZGuid("11a14682-9d02-46a7-a800-b82121e748be");
