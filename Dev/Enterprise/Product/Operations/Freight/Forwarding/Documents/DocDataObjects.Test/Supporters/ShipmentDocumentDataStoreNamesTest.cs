...
{
	sealed class ShipmentDocumentDataStoreNamesTest : TestCaseWithFactory
	{
		public void TestDataStoreNames()
		{
			var dataStoreNames = typeof(ShipmentDocumentDataStoreNamesTest).GetFields()
			...
			AssertContainsExactElementsInAnyOrder($"all data store names in {nameof(ShipmentDocumentDataStoreNamesTest)} are present",
