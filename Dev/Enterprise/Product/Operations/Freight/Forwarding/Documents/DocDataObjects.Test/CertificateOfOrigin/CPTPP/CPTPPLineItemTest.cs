...
{
	[TestedType(typeof(CPTPPLineItem))]
	sealed class CPTPPLineItemTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			return new CPTPPLineItem("990134e1-1186-49c1-833b-5a72b92a210c")
			{
				ItemNumber = 1,
