...
{
	[TestedType(typeof(IAECTALineItem))]
	sealed class IAECTALineItemTest : NonPersistentBusinessObjectTestCase
	{
		protected override BusinessObject GetNewBusinessObject()
		{
			return new IAECTALineItem("31F17125-E523-4627-9B0C-EBE169ADDD5B")
			{
				ItemNumber = 1,
