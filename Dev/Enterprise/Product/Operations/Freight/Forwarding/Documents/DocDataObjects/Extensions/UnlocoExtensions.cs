...
{
	static class UnlocoExtensions
	{
		public static bool IsInCountry(this Unloco unloco, string countryCode)
		{
			return unloco?.Country != null
				&& unloco.Country.Code == countryCode;
		}
