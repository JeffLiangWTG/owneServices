...
{
	sealed class DGNPackingLine : DocDataObject, IPackingLine
	{
		public DGNPackingLine(object identifier)
			: base(identifier)
		{
		}
		...
		public IReadOnlyCollection<DGNDangerousGood> DangerousGoods
		{
			get => dangerousGoods;
			set => dangerousGoods = SetChildCollection(dangerousGoods, value);
		}

		IReadOnlyCollection<DGNDangerousGood> dangerousGoods;
