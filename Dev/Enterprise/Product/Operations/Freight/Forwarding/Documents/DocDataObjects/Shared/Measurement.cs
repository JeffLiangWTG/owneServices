...
{
	public sealed class Measurement : DocDataObject, IMeasurement
	{
		#region Value
		...
		public override string ToString() => FormattableString.Invariant($"{Value:0.00} {Unit?.Code}"); // untranslatable value
