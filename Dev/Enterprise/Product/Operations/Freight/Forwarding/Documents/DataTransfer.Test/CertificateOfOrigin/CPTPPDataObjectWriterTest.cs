...
{
	sealed class CPTPPDataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<CPTPP, CPTPPLineItem, OriginCriterionListCPTPP>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.CPTPPCertificateOfOrigin;

		protected override CPTPP CreateCertificate(ZString sourceType, ZString sourceId)
		{
			return new CPTPP(sourceType, sourceId);
		}

		protected override CPTPPLineItem CreateLineItem(object lineItemId) => new CPTPPLineItem(lineItemId);

		protected override Documents.DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<CPTPP, CPTPPLineItem> CreateWriter(IDataWritingManager writeManager, DocumentVisualizer.Core.IDocument document)
		{
			return new CPTPPDataObjectWriter(writeManager, document);
		}
		...
		protected override string SecondLineItemOriginCode => Core.Constants.CountryCodes.Canada;
		protected override string SecondLineItemOrigin => nameof(Core.Constants.CountryCodes.Canada);
