...
{
	sealed class PAFTADataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<PAFTA, PAFTALineItem, OriginCriterionListPAFTA>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.PAFTACertificateOfOrigin;

		protected override PAFTA CreateCertificate(ZString sourceType, ZString sourceId)
		{
			return new PAFTA(sourceType, sourceId);
		}

		protected override PAFTALineItem CreateLineItem(object lineItemId) => new PAFTALineItem(lineItemId);

		protected override DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<PAFTA, PAFTALineItem> CreateWriter(IDataWritingManager writeManager, IDocument document)
		{
			return new PAFTADataObjectWriter(writeManager, document);
		}
