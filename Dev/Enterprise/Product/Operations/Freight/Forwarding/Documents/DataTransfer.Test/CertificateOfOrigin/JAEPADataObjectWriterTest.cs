...
{
	sealed class JAEPADataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<JAEPA, JAEPALineItem, OriginCriterionListJAEPA>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.JAEPACertificateOfOrigin;

		protected override JAEPA CreateCertificate(ZString sourceType, ZString sourceId)
		{
			return new JAEPA(sourceType, sourceId);
		}

		protected override JAEPALineItem CreateLineItem(object lineItemId) => new JAEPALineItem(lineItemId);

		protected override Documents.DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<JAEPA, JAEPALineItem> CreateWriter(IDataWritingManager writeManager, IDocument document)
		{
			return new JAEPADataObjectWriter(writeManager, document);
		}
		...
		protected override string SecondLineItemOriginCode => Core.Constants.CountryCodes.Japan;
		protected override string SecondLineItemOrigin => nameof(Core.Constants.CountryCodes.Japan);
