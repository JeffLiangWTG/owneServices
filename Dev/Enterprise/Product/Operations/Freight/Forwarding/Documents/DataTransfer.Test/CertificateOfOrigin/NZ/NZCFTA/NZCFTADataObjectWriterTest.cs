...
namespace Enterprise.Freight.Forwarding.Documents.Testing.DataTransfer.NZ
{
	sealed class NZCFTADataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<NZCFTA, NZCFTALineItem, OriginCriterionListNZCFTA>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.NZCFTACertificateOfOrigin;

		protected override Documents.DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<NZCFTA, NZCFTALineItem> CreateWriter(IDataWritingManager writeManager, IDocument document)
			=> new NZCFTADataObjectWriter(writeManager, document);
		...
		protected override IUnloco DefaultPortOfLoading => new DummyUnloco { Code = "NZAKL", Name = "Auckland", IATACode = "AKL" };
		protected override IUnloco DefaultPortOfDischarge => new DummyUnloco { Code = "CNCAN", Name = "Guangzhou", IATACode = "CAN" };
		protected override IUnloco DefaultPortOfOrigin => new DummyUnloco { Code = "CNCAN", Name = "Guangzhou", IATACode = "CAN" };
		protected override IUnloco DefaultPortOfDestination => new DummyUnloco { Code = "NZAKL", Name = "Auckland", IATACode = "AKL" };
		...
		protected override void PopulateCertificate(NZCFTA certificate)
		{
			var quantityUnitList = new NZCustomsTariffQuantityUnitList();
			var lineItems = certificate.LineItems.ToArray();

			lineItems[0].QuantityNumber = 10;
			lineItems[0].QuantityUnit = new CodeDescription(quantityUnitList)
			{
				Code = NZCustomsTariffQuantityUnitList.Codes.NMP
			};

			lineItems[1].QuantityNumber = 15;
			lineItems[1].QuantityUnit = new CodeDescription(quantityUnitList)
			{
				Code = NZCustomsTariffQuantityUnitList.Codes.GRM
			};
			lineItems[1].PackageType = new DummyCodeDescription
			{
				Code = "PKG",
				Description = "Package"
			};
...
<UniversalShipment xmlns=""http://www.cargowise.com/Schemas/Universal/2012/11"" version=""2.0"">
  <Shipment>
          ...
          <CommercialInvoiceLineCollection>
            <CommercialInvoiceLine>
              ...
              <AddInfoCollection>
                ...
                <AddInfo>
                  <Key>QuantityUnit</Key>
                  <Value>NMP</Value>
                </AddInfo>
                <AddInfo>
                  <Key>QuantityNumber</Key>
                  <Value>10</Value>
                </AddInfo>
              </AddInfoCollection>
            </CommercialInvoiceLine>
    ...
    <PortOfOrigin Name=""Guangzhou"">CNCAN</PortOfOrigin>
