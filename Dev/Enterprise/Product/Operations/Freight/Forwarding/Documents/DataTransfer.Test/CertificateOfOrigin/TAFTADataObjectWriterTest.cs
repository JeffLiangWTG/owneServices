...
{
	sealed class TAFTADataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<TAFTA, TAFTALineItem, OriginCriterionListTAFTA>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.TAFTACertificateOfOrigin;

		protected override TAFTA CreateCertificate(ZString sourceType, ZString sourceId)
		{
			return new TAFTA(sourceType, sourceId);
		}

		protected override TAFTALineItem CreateLineItem(object packlineId)
		{
			return new TAFTALineItem(packlineId);
		}

		protected override void PopulateCertificate(TAFTA tafta)
		{
			tafta.BuyerAddress = CreateAddress(nameof(tafta.BuyerAddress));
		}

		protected override Documents.DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<TAFTA, TAFTALineItem> CreateWriter(IDataWritingManager writeManager, IDocument document)
		{
			return new TAFTADataObjectWriter(writeManager, document);
		}
		...
		protected override string SecondLineItemOriginCode => Core.Constants.CountryCodes.Thailand;
		protected override string SecondLineItemOrigin => nameof(Core.Constants.CountryCodes.Thailand);
...
<UniversalShipment xmlns=""http://www.cargowise.com/Schemas/Universal/2012/11"" version=""2.0"">
  <Shipment>
    ...
    <OrganizationAddressCollection>
      ...
      <OrganizationAddress>
        <AddressType>BuyerAddress</AddressType>
        <AdditionalAddressInformation>BuyerAddress additional info</AdditionalAddressInformation>
        <Address1>BuyerAddress address line 1</Address1>
        <Address2>BuyerAddress address line 2</Address2>
        <AddressOverride>false</AddressOverride>
        <City>BuyerAddress city</City>
        <CompanyName>BuyerAddress</CompanyName>
        <Contact>BuyerAddress contact</Contact>
        <Country Name=""Australia"">AU</Country>
        <Email>BuyerAddress email</Email>
        <Fax>BuyerAddress fax</Fax>
        <GovRegNum>BuyerAddress tax number</GovRegNum>
        <GovRegNumType Description=""Goods and Services Tax"">GST</GovRegNumType>
        <Phone>BuyerAddress phone</Phone>
        <Port Name=""Sydney"">AUSYD</Port>
        <Postcode>BuyerAddre</Postcode>
