...
{
	sealed class ChaftaDataObjectWriterTest : CertificateOfOriginDataObjectWriterBaseTest<Chafta, ChaftaLineItem, OriginCriterionList>
	{
		protected override string ShipmentDocumentName => ShipmentDocumentNames.ChaftaCertificateOfOrigin;

		protected override Documents.DataTransfer.CertificateOfOrigin.Base.CertificateOfOriginDataObjectWriter<Chafta, ChaftaLineItem> CreateWriter(IDataWritingManager writeManager, IDocument document)
			=> new ChaftaDataObjectWriter(writeManager, document);
		...
		protected override IUnloco DefaultPortOfOrigin => null;

		#region TestPopulateDataObject

		protected override void PopulateCertificate(Chafta certificate)
		{
			certificate.ArrivalDate = ZDateTime.Empty;
			certificate.PlaceOfDelivery = new DummyUnloco { Code = "HKHKG", Name = "Hong Kong", IATACode = "HKG" };
			certificate.PlaceOfIssue = new DummyUnloco { Code = "AUSYD", Name = "Sydney", IATACode = "SYD" };
			certificate.PlaceOfReceipt = new DummyUnloco { Code = "AUSYD", Name = "Sydney", IATACode = "SYD" };

			var lineItems = certificate.LineItems.ToArray();
			lineItems[0].Invoice = new Invoice
			{
				Number = "AAA0001",
				Date = new ZDateTime(2021, 08, 01)
			};
			lineItems[1].Invoice = new Invoice
			{
				Number = "BBB0002",
				Date = new ZDateTime(2021, 08, 02)
			};
		}
		...
		protected override string SecondLineItemOriginCode => Core.Constants.CountryCodes.Australia;
		protected override string SecondLineItemOrigin => nameof(Core.Constants.CountryCodes.Australia);
  ...
  <Shipment>
    ...
    <CommercialInfo>
      <CommercialInvoiceCollection>
        <CommercialInvoice>
          <InvoiceNumber>AAA0001</InvoiceNumber>
          <InvoiceDate>2021-08-01T00:00:00</InvoiceDate>
        ...
        <CommercialInvoice>
          <InvoiceNumber>BBB0002</InvoiceNumber>
          <InvoiceDate>2021-08-02T00:00:00</InvoiceDate>
          <CommercialInvoiceLineCollection>
            <CommercialInvoiceLine>
              <LineNo>200</LineNo>
    ...
    <PlaceOfDelivery Name=""Hong Kong"">HKHKG</PlaceOfDelivery>
    <PlaceOfIssue Name=""Sydney"">AUSYD</PlaceOfIssue>
    ...
    <PackingLineCollection>
      <PackingLine>
        ...
        <AddInfoCollection>
          ...
          <AddInfo>
            <Key>InvoiceDate</Key>
            <Value>2021-08-01T00:00:00</Value>
          </AddInfo>
        </AddInfoCollection>
      </PackingLine>
      <PackingLine>
        ...
        <AddInfoCollection>
          ...
          <AddInfo>
            <Key>InvoiceDate</Key>
            <Value>2021-08-02T00:00:00</Value>
          </AddInfo>
        </AddInfoCollection>
      </PackingLine>
    </PackingLineCollection>
