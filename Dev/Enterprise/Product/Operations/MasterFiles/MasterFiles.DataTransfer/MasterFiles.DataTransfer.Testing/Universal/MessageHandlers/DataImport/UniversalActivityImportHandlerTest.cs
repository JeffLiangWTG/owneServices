...
{
	class UniversalActivityImportHandlerTest : TestCaseWithFactory
	{
		public void TestProcess()
		{
			...
			const string inboundXml = @"<UniversalActivity xmlns=""http://www.cargowise.com/Schemas/Universal/2011/11"" version=""1.1"">
  <Activity>
  </Activity>
</UniversalActivity>";

			var handler = new UniversalActivityImportHandler(new XmlSessionTracker(new SimpleLogger()));
