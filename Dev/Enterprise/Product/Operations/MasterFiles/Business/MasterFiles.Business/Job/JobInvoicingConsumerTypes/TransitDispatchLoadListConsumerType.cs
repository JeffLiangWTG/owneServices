...
{
	public class TransitDispatchLoadListConsumerType : JobInvoicingConsumerType
	{
		public TransitDispatchLoadListConsumerType(string code, MultilingualString description)
		...
		{
			get { return ObjectFactory.GetType<ITransitDispatchLoadList>(); }
		}
