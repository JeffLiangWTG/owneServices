...
{
	public class CusUnderbondConsumerType : JobInvoicingConsumerType
	{
		public CusUnderbondConsumerType(string code, MultilingualString description)
		...
		{
			get { return ObjectFactory.GetType<Enterprise.Integration.Customs.AU.ICusUnderbond>(); }
		}
