...
{
	public class CFSShipmentConsumerType : JobInvoicingConsumerType
	{
		public CFSShipmentConsumerType(string code, MultilingualString description)
		...
		{
			get { return ObjectFactory.GetType<CFS.ICFSShipment>(); }
		}
