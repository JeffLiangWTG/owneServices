...
{
	public class FinlandOrgCusCodeInfo : OrgCusCodeInfo, IOrgCusCodeCustomsRegNoValidationProvider, IOrgCusCodeProvider
	{
		...
		{
			var result = GetPrimaryCusCodes(Core.Constants.CountryCodes.Finland);
			return result;
		}

		HashSet<string> IOrgCusCodeProvider.GetMainOrganizationNumberTypes()
		{
			var result = GetMainOrganizationNumberTypes(Core.Constants.CountryCodes.Finland);
			return result;
		}
		...
		void IOrgCusCodeCustomsRegNoValidationProvider.Validate(OrgCusCode orgCusCode)
		{
			...
			{
				new FIVATCodeValidator().Validate(orgCusCode.OK_CustomsRegNoInfo);
			}
