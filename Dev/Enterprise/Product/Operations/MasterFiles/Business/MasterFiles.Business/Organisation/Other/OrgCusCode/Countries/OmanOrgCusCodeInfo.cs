...
{
	public class OmanOrgCusCodeInfo : OrgCusCodeInfo, IOrgCusCodeProvider
	{
		...
		{
			var result = GetPrimaryCusCodes(Core.Constants.CountryCodes.Oman);
		...
		{
			var result = GetMainOrganizationNumberTypes(Core.Constants.CountryCodes.Oman);
			return result;
		}
	}
}
