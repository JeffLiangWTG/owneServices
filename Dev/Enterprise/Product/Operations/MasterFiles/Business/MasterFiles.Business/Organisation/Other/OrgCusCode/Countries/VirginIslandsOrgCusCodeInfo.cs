...
{
	public class VirginIslandsOrgCusCodeInfo : OrgCusCodeInfo, IOrgCusCodeProvider
	{
		...
		{
			var result = GetPrimaryCusCodes(Core.Constants.CountryCodes.VirginIslands);
			return result;
		}

		HashSet<string> IOrgCusCodeProvider.GetMainOrganizationNumberTypes()
		{
			var result = GetMainOrganizationNumberTypes(Core.Constants.CountryCodes.VirginIslands);
			return result;
		}
	}
}
