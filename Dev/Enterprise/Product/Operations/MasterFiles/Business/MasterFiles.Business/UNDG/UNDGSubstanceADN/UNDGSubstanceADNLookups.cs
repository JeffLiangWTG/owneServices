...
//    THIS CLASS SHOULD ALWAYS INHERIT FROM AutoUNDGSubstanceADNLookups
//
//    This class should be used for overriding collections in AutoUNDGSubstanceADNLookups
...
{
	public class UNDGSubstanceADNLookups : AutoUNDGSubstanceADNLookups
	{
		public UNDGSubstanceADNLookups(AutoUNDGSubstanceADN parent) : base(parent)
		{
		}

		public CodeDescriptionPairList ADNClassList
		{
