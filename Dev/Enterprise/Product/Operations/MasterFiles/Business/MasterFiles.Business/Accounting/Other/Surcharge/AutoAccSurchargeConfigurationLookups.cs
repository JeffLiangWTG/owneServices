...
namespace Enterprise.MasterFiles.Business
{
	...
	public abstract class AutoAccSurchargeConfigurationLookups : ZLookups
	{
		protected AutoAccSurchargeConfigurationLookups(AutoAccSurchargeConfiguration Parent) : base(Parent)
		{
		}
