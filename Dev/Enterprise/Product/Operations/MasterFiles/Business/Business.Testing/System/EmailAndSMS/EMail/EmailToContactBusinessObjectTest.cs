...
{
	[TestedType(typeof(EmailToContactBusinessObject))]
	sealed class EmailToContactBusinessObjectTest : EmailToContactBusinessObjectTestCase<EmailToContactBusinessObject>
	{
		public void TestSetupPreviewFile_NonHTML()
		{
			EmailToContactBusinessObjectForTest emailContactObject = new EmailToContactBusinessObjectForTest(BusinessObjectSendingEmail, EmailContentTypes.PlainText);
		...
		public void TestSetupPreviewFile_HTML()
		{
			...
			try
			{
				...
				EmailToContactBusinessObjectForTest emailContactObject = new EmailToContactBusinessObjectForTest(BusinessObjectSendingEmail, EmailContentTypes.HTML);
		...
		{
			var emailContactObject = new EmailToContactBusinessObjectForTest(BusinessObjectSendingEmail, EmailContentTypes.HTML);
