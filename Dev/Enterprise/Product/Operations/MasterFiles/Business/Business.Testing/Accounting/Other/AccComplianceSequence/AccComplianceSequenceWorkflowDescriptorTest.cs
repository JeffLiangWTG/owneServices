...
{
	[TestedType(typeof(AccComplianceSequenceWorkflowDescriptor))]
	sealed class AccComplianceSequenceWorkflowDescriptorTest : WorkflowDescriptorTestCase<AccComplianceSequenceWorkflowDescriptor>
	{
		public override void TestID()
		{
			AssertEquals("Correct Code", "CSQ", WorkflowDescriptor.Code);
		}

		public override void TestDescription()
		{
			AssertEquals("Correct Desc", "Compliance Sequence", WorkflowDescriptor.Description);
		}
		...
		protected override IWorkflowProvider[] GetParentsWithConfiguredOrganisationPartiesForTest()
		{
			...
			{
				Factory.New<AccComplianceSequence>()
			};
		}
	}
}
