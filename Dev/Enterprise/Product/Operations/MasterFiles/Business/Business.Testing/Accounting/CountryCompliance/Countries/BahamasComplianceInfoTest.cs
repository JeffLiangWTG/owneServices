...
{
	[TestedType(typeof(BahamasComplianceInfo))]
	sealed class BahamasComplianceInfoTest : CountryComplianceInfoTest
	{
		protected override string CountryCode => Core.Constants.CountryCodes.Bahamas;
