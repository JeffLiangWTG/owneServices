...
{
	[TestedType(typeof(SuperActivityRelatedChildActivityPivotCollection))]
	sealed class SuperActivityRelatedChildActivityPivotCollectionTest : ActiveBusinessObjectCollectionTestCase<SuperActivityRelatedChildActivityPivotCollection>
	{
		public void TestAddActivity()
		{
			...
			var collection = new SuperActivityRelatedChildActivityPivotCollection(superActivity);
			...
			AssertCollectionContains("Should link opportunity to subActivity", opportunity2, subActivity.RelatedChildActivityPivotCollection.Activities);
		}

		#region Implementation

		protected override SuperActivityRelatedChildActivityPivotCollection GetCollectionToTest()
		{
			var superActivity = Factory.NewWithValidTestData<DummySuperRelatableActivity>();
			return new SuperActivityRelatedChildActivityPivotCollection(superActivity);
		}
