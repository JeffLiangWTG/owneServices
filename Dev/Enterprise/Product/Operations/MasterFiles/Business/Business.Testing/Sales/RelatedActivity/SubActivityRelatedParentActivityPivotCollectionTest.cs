...
{
	[TestedType(typeof(SubActivityRelatedParentActivityPivotCollection))]
	sealed class SubActivityRelatedParentActivityPivotCollectionTest : ActiveBusinessObjectCollectionTestCase<SubActivityRelatedParentActivityPivotCollection>
	{
		public void TestAddActivity()
		{
			...
			var collection1 = new SubActivityRelatedParentActivityPivotCollection(subActivity1);
			...
			AssertCollectionContains("Should have added communication to superActivity instead of subActivity1", communication, superActivity.RelatedParentActivityPivotCollection.Activities);
			...
			AssertCollectionContains("Should have added opportunity2 to subActivity2 instead of subActivity1", opportunity2, subActivity2.RelatedParentActivityPivotCollection.Activities);
		}

		#region Implementation

		protected override SubActivityRelatedParentActivityPivotCollection GetCollectionToTest()
		{
			var subActivity = Factory.NewWithValidTestData<DummySubRelatableActivity>();
			return new SubActivityRelatedParentActivityPivotCollection(subActivity);
		}
