...
{
	sealed class RelatedParentActivityPivotCollectionForTest : RelatedParentActivityPivotCollection
	{
		public RelatedParentActivityPivotCollectionForTest(IRelatableActivity master)
			: base(master)
		{
		}
