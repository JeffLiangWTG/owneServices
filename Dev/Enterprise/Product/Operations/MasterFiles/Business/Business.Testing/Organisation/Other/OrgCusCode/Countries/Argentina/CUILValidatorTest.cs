...
{
	sealed class CUILValidatorTest : TestCaseWithFactory
	{
		string CodeType => ArgentinaOrgCusCodeInfo.OrgCusCodes.CUIL;
		...
		public void TestCUILCodeLengthValidation()
		{
		...
		public void TestCUILCodePatternValidation()
		{
		...
		public void TestCUILCodeCheckDigitValidation()
		{
		...
		string InvalidLengthMessage => @"The CUIL registration code length is invalid. 
CUIL codes must be 11 or 13 digits long.";
		string InvalidPatternMessage => @"The CUIL registration code pattern is invalid.
...
Please verify that you are entering a correct number.";
		string InvalidCheckDigitMessage => "The check digit in the CUIL registration code is incorrect.";
