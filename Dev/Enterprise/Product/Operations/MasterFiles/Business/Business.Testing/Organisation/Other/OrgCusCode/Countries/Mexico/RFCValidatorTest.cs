...
{
	sealed class RFCValidatorTest : TestCaseWithFactory
	{
		...
		public void TestRFCCodeLengthValidation()
		{
		...
		public void TestRFCCodePatternValidation()
		{
		...
		{
			get { return @"The RFC registration code length is invalid.

RFC codes must be 12 or 13 digits long."; }
		}

		string InvalidPatternMessage
		{
			get { return @"The RFC registration code pattern is invalid.
