...
{
	[TestedType(typeof(SeaCTOAndDepotCollection))]
	sealed class SeaCTOAndDepotCollectionTest : BusinessObjectCollectionTestCase
	{
		protected override BusinessObjectCollection GetCollectionToTest()
		{
			OrganisationDefaults orgDefaults = new OrganisationDefaults();
			return new SeaCTOAndDepotCollection(Factory, orgDefaults);
		}
		...
		public void TestValidateEntityOnSaving()
		{
			...
			Assert("SeaCTO dose not have error", !organisation.OH_IsSeaCTOInfo.HasErrors());
		...
		public void TestFilter()
		{
			...
			Assert("Collection should not contain AirCTO", !TestCollection.Contains(airCTO));
			Assert("Collection should contain SeaCTO", TestCollection.Contains(seaCTO));
		}

		#region Implementation

		SeaCTOAndDepotCollection TestCollection;

		protected override void SetUp()
		{
			base.SetUp();
			TestCollection = new SeaCTOAndDepotCollection(Factory);
		}
