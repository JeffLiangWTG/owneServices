...
public sealed class GlbReleaseNoteCombinedLookupsTest : BusinessObjectLookupsTestCase
{
	...
	{
		base.SetUp();
		parent = Factory.New<GlbReleaseNoteCombined>();
	}

	GlbReleaseNoteCombinedLookups Lookups
	{
		get { return parent.Lookups; }
	}

	GlbReleaseNoteCombined parent;
