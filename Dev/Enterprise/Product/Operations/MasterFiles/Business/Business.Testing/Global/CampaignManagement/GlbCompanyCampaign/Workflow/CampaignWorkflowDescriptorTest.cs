...
{
	[TestedType(typeof(CRMCampaignWorkflowDescriptor))]
	sealed class CampaignWorkflowDescriptorTest : WorkflowDescriptorTestCase<CRMCampaignWorkflowDescriptor>
	{
		public override void TestID()
		{
			AssertEquals("Correct Code", "CAM", WorkflowDescriptor.Code);
		}

		public override void TestDescription()
		{
			AssertEquals("Correct Desc", "Campaign", WorkflowDescriptor.Description);
		}

		public override void TestSubTypes()
		{
			ICodeDescriptionPairList type1List = OrganisationsDataRegistry.Instance.CampaignCategory1List.Value;
			ICodeDescriptionPairList type2List = OrganisationsDataRegistry.Instance.CampaignCategory2List.Value;
			OrganisationsDataRegistry.Instance.CampaignCategory1Label.SetValue(Guid.Empty, Guid.Empty, Guid.Empty, "My Category 1");
			OrganisationsDataRegistry.Instance.CampaignCategory2Label.SetValue(Guid.Empty, Guid.Empty, Guid.Empty, "My Category 2");
		...
		protected override IWorkflowProvider[] GetParentsWithConfiguredOrganisationPartiesForTest()
		{
			...
			{
				(IWorkflowProvider)Factory.New<IGlbCompanyCampaign>()
			};
		}
