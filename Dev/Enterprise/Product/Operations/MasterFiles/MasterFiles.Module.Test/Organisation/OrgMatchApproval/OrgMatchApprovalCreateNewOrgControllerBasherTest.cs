...
{
	[TestedType(typeof(OrgMatchApprovalCreateNewOrgController))]
	sealed class OrgMatchApprovalCreateNewOrgControllerBasherTest : ZControllerBasherTest
	{
		protected override ControllerID GetControllerID()
		{
			return ControllerIDs.OrgMatchApprovalCreateNewOrg;
		}
