...
{
	[TestedType(typeof(RefAccessorialModule))]
	sealed class RefAccessorialModuleTest : ZModuleBasherTest
	{
		...
		public void TestSecurityCheckpoint()
		{
			using (var module = GetModule())
			{
				AssertEquals(Env.Security.RefAccessorial, module.SecurityCheckpoint);
			}
		}

		protected override ModuleIdentifier GetModuleID()
		{
			return ModuleIDs.RefAccessorial;
		}
	}
}
