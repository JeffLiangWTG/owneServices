...
namespace Enterprise.MasterFiles.GUI.Testing
{
	...
	sealed class AccChargeGovtChargeCodeOverrideConfigurationControlTest : BasherTest
	{
		...
		ZChildForm CreateFormForTest()
		{
			...
			var userControl = new AccChargeGovtChargeCodeOverrideConfigurationControl();
			userControl.Dock = DockStyle.Fill;
			form.Controls.Add(userControl);
			form.SetDataBinding(chargeCode, nameof(AccChargeCode.GovtChargeCodeOverrides));
			return form;
		}
