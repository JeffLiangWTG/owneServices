...
namespace Enterprise.MasterFiles.GUI.Testing
{
	...
	sealed class CurrentQueueUserControlBasherTest_IProcessQueueParent_ActiveQueueIsCustomsQueue : CurrentQueueUserControlBasherTestCase
	{
		...
		protected override BusinessObject BusinessEntity
		{
			get
			{
				...
				result.ActiveProcessQueueForBinding[0].QueueType = ProcessQueueType.Enum.Customs;
				return result;
			}
		}
