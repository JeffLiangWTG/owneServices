...
{
	[TestedType(typeof(UNDGSubstanceADRForm))]
	sealed class UNDGSubstanceADRFormTest : ZFormBasherTest
	{
		#region Implementation

		protected override Form GetFormToBashCore()
		{
			return new UNDGSubstanceADRForm(Factory.New<UNDGSubstanceADR>());
		}
		...
		{
			using var control = new UNDGSubstanceADRControl();
