...
{
	[TestedType(typeof(UNDGSubstanceJTTForm))]
	sealed class UNDGSubstanceJTTFormTest : ZFormBasherTest
	{
		#region Implementation

		protected override Form GetFormToBashCore()
		{
			return new UNDGSubstanceJTTForm(Factory.New<UNDGSubstanceJTT>());
		}
		...
		{
			using var control = new UNDGSubstanceJTTControl();
