...
{
	partial class ExternalRequestTypeForm
	{
		...
		{
            this.externalRequestTypeDetails = new ExternalRequestTypeDetails();
            ...
            this.externalRequestTypeDetails.SuspendLayout();
            this.SuspendLayout();
            // 
            // MainTabControl
            // 
            ...
            // MainTabPage
            // 
            this.MainTabPage.Controls.Add(this.externalRequestTypeDetails);
            ...
            // 
            this.externalRequestTypeDetails.AllowDrop = true;
            this.BindingSource.SetBindingMember(this.externalRequestTypeDetails, ".");
            // The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
            this.externalRequestTypeDetails.Dock = System.Windows.Forms.DockStyle.Fill;
            this.externalRequestTypeDetails.Name = "externalRequestTypeDetails";
            this.externalRequestTypeDetails.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(957, 443, true);
            this.externalRequestTypeDetails.TabIndex = 0;
            // 
            ...
            this.externalRequestTypeDetails.ResumeLayout(true);
            this.externalRequestTypeDetails.PerformLayout();
		...
		private ExternalRequestTypeDetails externalRequestTypeDetails;
	}
}
