...
{
	partial class DeniedPartyScreeningMonitoringForm
	{
		/// <summary>
		...
		private new void InitializeComponent()
		{
			...
			this.ButtonClear.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SystemDefault;
			...
			this.ButtonToggleStartStop.IsCaptionOverridden = true;
			...
			this.ButtonToggleStartStop.ShouldSetReadOnlyWhenSettingIncludingChildren = false;
			...
			this.ButtonToggleStartStop.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SystemDefault;
			...
			// 
			// DeniedPartyScreeningMonitoringForm
			// 
			...
			this.MaximumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(816, 679, true);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(816, 679, true);
			this.Name = "DeniedPartyScreeningMonitoringForm";
			this.Text = "Denied Party Screening Diagnostics Form";
