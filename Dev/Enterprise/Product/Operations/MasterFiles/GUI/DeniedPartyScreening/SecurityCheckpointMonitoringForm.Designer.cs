...
{
	partial class SecurityCheckpointMonitoringForm
	{
		/// <summary>
		...
		private new void InitializeComponent()
		{
			...
			this.ButtonClear.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(650, 6, true);
			this.ButtonClear.Name = "ButtonClear";
			this.ButtonClear.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(140, 30, true);
			this.ButtonClear.TabIndex = 6;
			this.ButtonClear.Text = "Clear all lines";
			...
			this.ButtonToggleStartStop.Text = "Start tracking";
			...
			this.Name = "SecurityCheckpointMonitoringForm";
			this.Text = "Security Checkpoint Monitoring Form";
			this.TopMost = true;
