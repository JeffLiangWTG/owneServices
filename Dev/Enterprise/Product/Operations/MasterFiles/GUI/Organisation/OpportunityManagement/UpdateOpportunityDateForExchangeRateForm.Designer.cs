...
{
	partial class UpdateOpportunityDateForExchangeRateForm
	{
		/// <summary>
		...
		protected new void InitializeComponent()
		{
			...
			this.useExistingDateButton = new Enterprise.ZArchitecture.GUI.ZButton();
			...
			this.zPanel1.Controls.Add(this.useExistingDateButton);
			this.zPanel1.Controls.Add(this.updateDateButton);
			this.zPanel1.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(82, 2, true);
			this.zPanel1.Name = "zPanel1";
			this.zPanel1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(236, 60, true);
			...
			this.DateEdit.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(70, 2, true);
			this.DateEdit.Name = "DateEdit";
			this.DateEdit.TabIndex = 0;
			// 
			// useExistingDateButton
			// 
			this.useExistingDateButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.useExistingDateButton.CaptionResourceString = Enterprise.MasterFiles.GUI.Res.GetData("5d6fb8b9-eb09-444b-a217-0037eaaf520c", "Use Existing");
			this.useExistingDateButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(120, 32, true);
			this.useExistingDateButton.Name = "useExistingDateButton";
			this.useExistingDateButton.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(100, 23, true);
			this.useExistingDateButton.TabIndex = 2;
			this.useExistingDateButton.UseVisualStyleBackColor = true;
			this.useExistingDateButton.Click += new System.EventHandler(this.UseExistingDateButton_Click);
			// 
			// updateDateButton
			// 
			...
			this.updateDateButton.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(16, 32, true);
			...
			// zLabel1
			// 
			this.zLabel1.CaptionResourceString = Enterprise.MasterFiles.GUI.Res.GetData("00268328-a262-408d-8704-4c0ff1ee3695", "The Opportunity\'s estimate value currency has been changed. Do you wish to set a new exchange rate date? The total opportunity\'s estimate value will be converted into the new currency as per date set.");
			...
			this.zLabel1.Padding = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPadding(8, true);
			this.zLabel1.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(401, 67, true);
			this.zLabel1.TabIndex = 0;
			this.zLabel1.TextAlign = System.Drawing.ContentAlignment.BottomLeft;
			// 
			// UpdateOpportunityDateForExchangeRateForm
			// 
			...
			this.Name = "UpdateOpportunityDateForExchangeRateForm";
		...
		private ZArchitecture.GUI.ZButton useExistingDateButton;
