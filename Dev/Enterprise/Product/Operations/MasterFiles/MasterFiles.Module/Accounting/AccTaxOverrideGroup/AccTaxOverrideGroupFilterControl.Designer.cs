...
{
	public partial class AccTaxOverrideGroupFilterControl
	{
		private void InitializeComponent()
		{
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.MasterFiles.Business.AccTaxOverrideGroup)(null)))));
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.MasterFiles.Business.AccTaxOverrideGroup)(null)).AX_GroupType)));
			zTextBoxColumnStyleInfo1.ColumnName = "AX_Code";
			zTextBoxColumnStyleInfo1.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(80);
			zTextBoxColumnStyleInfo2.ColumnName = "AX_Description";
			zTextBoxColumnStyleInfo2.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(300);
			zTextBoxColumnStyleInfo3.ColumnName = "AX_GroupType";
			...
			// 
			// AccTaxOverrideGroupFilterControl
			// 
			this.CaptionRenderingEnabled = true;
			this.Name = "AccTaxOverrideGroupFilterControl";
