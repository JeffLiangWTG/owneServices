...
namespace Enterprise.MasterFiles.Module
{
	...
	public partial class RefCityTownFilterStrip : ZFilterStrip
	{
		public RefCityTownFilterStrip()
		{
		}
		...
		{
			Control[] result;
			if (currentModuleFilter is RefCityTownCountryStateModuleFilter)
			{
				result = GetRefCityTownCountryStateModuleFilterControls();
			}
			else
			{
		...
		Control[] GetRefCityTownCountryStateModuleFilterControls()
		{
			Control[] result;
			...
			ZCodeFindBoxWithSelectedEvent stateFindBox = new ZCodeFindBoxWithSelectedEvent();
