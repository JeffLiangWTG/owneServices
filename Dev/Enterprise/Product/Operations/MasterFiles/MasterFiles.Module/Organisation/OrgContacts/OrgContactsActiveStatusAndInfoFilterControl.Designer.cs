...
{
	partial class OrgContactsActiveStatusAndInfoFilterControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.MasterFiles.Module.OrgContactsActiveStatusAndInfoModuleFilter);
			// 
			// AddressTextBox
			// 
			this.BindingSource.SetBindingMember(this.ContactTextBox, "Property");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.MasterFiles.Module.OrgContactsActiveStatusAndInfoModuleFilter)(null)).Property)));
			this.ContactTextBox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(308, 0, true);
			this.ContactTextBox.Name = "ContactTextBox";
			this.ContactTextBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(300, 17, true);
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.MasterFiles.Module.OrgContactsActiveStatusAndInfoModuleFilter)(null)).ActiveStatus)));
			this.ActiveStatusDropEdit.CaptionResourceString = Enterprise.MasterFiles.Module.Res.GetData("686429bb-a71d-47bd-8c9d-e4e574e39c77", "Active Status");
			...
			this.Name = "OrgContactsActiveStatusAndInfoModuleFilter";
		...
		private Enterprise.ZArchitecture.ZTextBox ContactTextBox;
	}
}
