...
{
	partial class ExternalRequestInfoTemplateFilterControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			zTextBoxColumnStyleInfo1.ColumnName = "RIT_Code";
			...
			zTextBoxColumnStyleInfo2.ColumnName = "RIT_Description";
			...
			zCodeFindBoxColumnStyleInfo1.ColumnName = "RIT_JobType";
			...
			zCheckBoxColumnStyleInfo1.ColumnName = "RIT_IsActive";
			...
			zCheckBoxColumnStyleInfo2.ColumnName = "RIT_IsSystem";
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Business.ExternalRequestInfoTemplateCollection);
			// 
			// ExternalRequestInfoTemplateFilterControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.Name = "ExternalRequestInfoTemplateFilterControl";
