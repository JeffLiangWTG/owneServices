...
namespace Enterprise.EquipmentManagement.Module.Testing
{
	sealed class EquipmentManagementPortalModuleTest : TransactionedTestCase
	{
		public void TestModule()
		{
			using (var module = new EquipmentManagementPortalModule())
			{
				AssertEquals(ModuleIDs.EquipmentManagementPortal, module.ID);
...
Registry: GLOW/Services/GLOW Portals Root URL", UnitTestUserNotification.Instance.LastMessage.Text);
		...
		public void TestModule_Show()
		{
			...
			using (var module = new EquipmentManagementPortalModule())
			{
				...
				AssertEquals("/EQM", uri.AbsolutePath);
			}
		}
	}
}
