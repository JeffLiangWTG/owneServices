...
{
	public abstract class TransportPackageRelationshipTest<T> : ActiveBusinessObjectCollectionTestCase<PackageCollectionForTransport>
			where T : DtbTransport
	{
		...
		public void TestAddRemove()
		{
			...
			var packageDivot3 = (DtbTransportInstructionPkgDivot)instruction3.PackageDivots.AddNew();
