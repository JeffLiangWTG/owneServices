...
{
	class PatternMatchingOrgCusCodeMaintenanceTest : PatternMatchingSourceTest<OrgCusCode, PatternMatchingOrgCusCodeMaintenance>
	{
		protected override OrgCusCode BizO => regCode ?? (regCode = CreateOrganisation().CustomsCodes.AddNew());
		OrgCusCode regCode;

		protected override PatternMatchingOrgCusCodeMaintenance MaintenanceObject => new PatternMatchingOrgCusCodeMaintenance(BizO);
		...
		protected override void AssertPatternMatchingDataExists()
		{
			...
			var valueRegCodeToHash = "ABN12834";
			...
			AssertEquals(regCode.PK, patternRegCode.PMR_ParentId);
		}

		protected override void SetupBizO()
		{
			BizO.OK_CustomsRegNo = "ABN12834";
