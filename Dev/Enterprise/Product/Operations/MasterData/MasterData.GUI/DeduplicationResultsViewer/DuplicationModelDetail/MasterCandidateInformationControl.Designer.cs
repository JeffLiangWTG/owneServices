...
{
	partial class MasterCandidateInformationControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.MainTableLayoutPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(440, 440, true);
			...
			this.ContentPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(438, 397, true);
			this.ContentPanel.TabIndex = 1;
			// 
			// MasterCandidateInformationControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.MainTableLayoutPanel);
			this.Margin = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPadding(0, true);
			this.Name = "MasterCandidateInformationControl";
			this.Padding = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPadding(5, true);
			this.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(450, 450, true);
		...
		private NoDeduplicationTipUserControl NoDeduplicationTipUserControl;
	}
}
