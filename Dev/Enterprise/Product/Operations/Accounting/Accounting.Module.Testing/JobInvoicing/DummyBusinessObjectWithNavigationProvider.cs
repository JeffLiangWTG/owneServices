...
{
	public class DummyBusinessObjectWithNavigationProvider : DummyBusinessObject, INavigationControllerIDProvider, IJobCostingPlugIn
	{
	...
	class DummyObjectWithGenericJobCostSupporter : IGenericJobCostSupporter
	{
		...
		public SecurityCheckpoint JobConsolCostingCheckPoint => Env.Security.SystemFeatureTest;
