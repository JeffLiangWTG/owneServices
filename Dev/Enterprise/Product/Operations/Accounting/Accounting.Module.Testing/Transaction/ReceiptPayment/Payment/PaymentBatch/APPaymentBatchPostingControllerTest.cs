...
{
	[TestedType(typeof(APPaymentBatchPostingController))]
	public class APPaymentBatchPostingControllerTest : ZControllerBasherTest
	{
		protected override ControllerID GetControllerID()
		{
			return ControllerIDs.APPaymentBatchPosting;
		}
