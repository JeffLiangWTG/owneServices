...
{
	public partial class AdjustmentReasonForm : ZChildForm
	{
		public AdjustmentReasonForm(MTDSubmissionDataRow submissionDataRow) : base(submissionDataRow)
		{
		}

		MTDSubmissionDataRow SubmissionDataRow => BusinessEntity as MTDSubmissionDataRow;
		...
		public ZArchitecture.ZCalcEdit ErrorsBox => errorsBox;
