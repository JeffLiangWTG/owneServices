...
{
	public class BankReconDirectReceiptForm : DirectReceiptForm, IDoDisplayModeEditOverride
	{
		public BankReconDirectReceiptForm(BankReconDirectReceipt directReceipt) : base(directReceipt)
		{
			InitializeComponent();
		}
