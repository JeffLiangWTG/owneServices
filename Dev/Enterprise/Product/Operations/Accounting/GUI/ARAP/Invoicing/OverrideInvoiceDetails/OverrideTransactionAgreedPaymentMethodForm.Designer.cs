...
{
	partial class OverrideTransactionAgreedPaymentMethodForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			Enterprise.ZArchitecture.GUI.ZDropEditColumnStyleInfo paymentMethodDropEditStyleInfo = new Enterprise.ZArchitecture.GUI.ZDropEditColumnStyleInfo();
			Enterprise.ZArchitecture.ZDateEditColumnStyleInfo dueDateEditStyleInfo = new Enterprise.ZArchitecture.ZDateEditColumnStyleInfo();
			...
			zTextBoxColumnStyleInfo1.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("OverrideTransactionAgreedPaymentMethodForm|5ddcd984-ec93-4fbd-99c7-a0eadbe61a27", "Account Full Name");
			...
			paymentMethodDropEditStyleInfo.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("72DE91DF-B8A5-4314-9E55-45778CD2FFD8", "Agreed Payment Method");
			paymentMethodDropEditStyleInfo.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(60);
			paymentMethodDropEditStyleInfo.ColumnName = "AH_AgreedPaymentMethodOverride";
			dueDateEditStyleInfo.ColumnName = "AH_DueDate";
			dueDateEditStyleInfo.Width = CargoWise.Windows.UI.ControlDpiScalingHelper.ScaleToCurrentDpiX(80);
			...
			this.InvoicesGrid.ColumnStyles.Add(paymentMethodDropEditStyleInfo);
			this.InvoicesGrid.ColumnStyles.Add(dueDateEditStyleInfo);
			...
			// 
			// OverrideTransactionAgreedPaymentMethodForm
			// 
			this.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("OverrideTransactionAgreedPaymentMethodForm|F21589CE-4406-4FCC-BD34-9C09D333DCAF", "Override Agreed Payment Method and Due Date");
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(543, 241, true);
			this.Name = "OverrideTransactionAgreedPaymentMethodForm";
