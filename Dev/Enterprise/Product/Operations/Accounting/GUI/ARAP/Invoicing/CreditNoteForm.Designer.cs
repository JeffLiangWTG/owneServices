...
namespace Enterprise.Accounting.GUI
{
	public partial class CreditNoteForm
	{
		...
		new void InitializeComponent()
		{
			...
			// MainTabControl
			// 
			this.MainTabControl.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1009, 567, true);
			// 
			// InvoiceDetailsTabPage
			// 
			this.InvoiceDetailsTabPage.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("CreditNoteForm|e594bf95-ae92-467d-9a81-891a6255a78b", "Credit Note Details");
			this.InvoiceDetailsTabPage.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 540, true);
			this.InvoiceDetailsTabPage.RunWhenBindingOrFirstShown(new EventHandler(this.InvoiceDetailsTabPage_InitializeTab));
			// 
			// ButtonsPanel
			// 
			this.ButtonsPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 567, true);
			...
			// MainStatusBar
			// 
			this.MainStatusBar.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 545, true);
			this.MainStatusBar.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1009, 22, true);
			// 
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(ARCreditNote);
			// 
			// CreditNoteForm
			// 
			this.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("CreditNoteForm|99f5fa03-e202-43b6-9048-96195f31957f", "Credit Note Form");
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1009, 604, true);
			this.DataSourceType = typeof(ARCreditNote);
			this.DataSourceTypeName = "Enterprise.Accounting.Business.ARAP.Invoicing.ARCreditNote";
		...
		void InvoiceDetailsTabPage_InitializeTab(object sender, EventArgs e)
		{
			...
			// 
			this.ReceiptPaymentOuterPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 540, true);
			this.ReceiptPaymentOuterPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 0, true);
			// 
			// MainPanel
			// 
			this.MainPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 540, true);
			// 
			// InvoiceDetails
			// 
			this.InvoiceDetails.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(1001, 414, true);
			// 
			// ChargeDetailsPanel
			// 
			this.ChargeDetailsPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 414, true);
