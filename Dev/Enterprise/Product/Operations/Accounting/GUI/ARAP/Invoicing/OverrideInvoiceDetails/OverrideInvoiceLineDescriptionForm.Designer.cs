...
{
	partial class OverrideInvoiceLineDescriptionForm
	{
		/// <summary>
		...
		new void InitializeComponent()
		{
			...
			// InvoicesGrid
			// 
			zTextBoxColumnStyleInfo1.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("OverrideInvoiceLineDescriptionForm|e60b34e2-066f-49cd-8239-f22a36b0c364", "Original Description");
			zTextBoxColumnStyleInfo1.ColumnName = "OriginalDescription";
			...
			zTextBoxColumnStyleInfo3.ColumnName = "AL_RX_NKTransactionCurrency";
			zCalcEditColumnStyleInfo9.BindToDecimalPlaces = null;
			zCalcEditColumnStyleInfo9.ColumnName = "AL_ExchangeRate";
			zTextBoxColumnStyleInfo4.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("OverrideInvoiceLineDescriptionForm|013c56ae-f769-4514-b5fd-a39a10a281f5", "Charge Type");
			zTextBoxColumnStyleInfo4.ColumnName = "ChargeTypeWithOverride";
			...
			zTextBoxColumnStyleInfo5.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("OverrideInvoiceLineDescriptionForm|63861230-a9de-4c0a-8050-7e5771944c11", "Job Local Reference");
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Accounting.Business.ARAP.Invoicing.InvoiceLineOverrideForEditingDescriptionAdaptor);
			// 
			// OverrideInvoiceLineDescriptionForm
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.CaptionResourceString = Enterprise.Accounting.GUI.Res.GetData("38dd2d61-cd6d-4b1c-aeac-5c0c50f77bf5", "Override Line Charge Description");
			this.ClientSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(543, 182, true);
			this.DataSourceType = typeof(Enterprise.Accounting.Business.ARAP.Invoicing.InvoiceLineOverrideForEditingDescriptionAdaptor);
			this.Name = "OverrideInvoiceLineDescriptionForm";
