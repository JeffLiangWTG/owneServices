...
{
	public class InvoicePaymentUserControlTestCase : TestCaseWithFactory
	{
		public void TestReceiptPaymentAH_DescTextbox()
		{
			using (var form = new ZForm())
			{
				var control = new InvoicePaymentUserControl();
				form.Controls.Add(control);
				control.SetDataBinding(Factory.NewWithValidTestData<APInvoice>(), null);
				form.Show();
