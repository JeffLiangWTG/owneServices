...
namespace Enterprise.Accounting.GUI.Testing
{
	...
	public class APIncompleteCreditNoteFormTest : APCreditNoteFormTest
	{
		...
		public void TestShouldReopenWithCorrectControllerID()
		{
			...
			using (var form2 = GetFormByInvoice(invoice2))
			{
				...
				AssertEquals("Postcondition: form1 is APIncompleteCreditNote.", ControllerIDs.APIncompleteCreditNote, form1.ControllerID);

				AssertEquals("Postcondition: invoice2 is AP.", LedgerTypes.AccountsPayable, invoice2.AH_Ledger);
				AssertEquals("Postcondition: form2 is APIncompleteCreditNote.", ControllerIDs.APIncompleteCreditNote, form2.ControllerID);
				...
				AssertEquals("form2: Should create an APCreditNote ZController.", ControllerIDs.APCreditNote, result2.ID);
