...
{
	public class MalaysiaCredentialLoader : ICredentialsLoader
	{
		...
		{
			var registryLoader = new RegistryCredentialLoader(AccountingElectronicMessagingRegistry.Instance.MalaysiaEInvoicingCredentials);
