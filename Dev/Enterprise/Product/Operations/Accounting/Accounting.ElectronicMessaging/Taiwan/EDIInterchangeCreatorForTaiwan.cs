...
{
	public class EDIInterchangeCreatorForTaiwan : GEIEDIInterchangeCreatorForComplianceDocuments
	{
		public EDIInterchangeCreatorForTaiwan(GlbCompany company)
			: base(company)
		{ }
		...
		protected override IAccEInvoiceBatchToGEIConverter BatchToGEIConverter =>
			new ComplianceDocumentBatchToGEIConverterForTaiwan();
