...
{
	public class Header1_10Test : TestCaseWithFactory
	{
		[TestDate(2022, 9, 20)]
		public void TestHeader1_10()
		{
			...
			var header = new Header1_10();

			Factory.Save();
			var additionalDataCollector = new SAFTAdditionalDataCollector(report, ComplianceReportDataCollectionMode.SAFT1_10, this.Creator.ABIGAS.PK, this.Creator.ABIGAS.OH_Code);
