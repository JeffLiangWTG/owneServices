...
{
	sealed class SAFTXMLWriter1_10Test : SAFTXMLWriterBaseTest
	{
		protected override ISAFTXMLWriter GetWriter(AccComplianceReport report, AccComplianceReport[] reports, ReportModeAndCreditorSelector reportModeAndCreditorSelector)
		{
			if (report == null)
			{
				return new SAFTXMLWriter1_10(reports, reportModeAndCreditorSelector, null);
			}
			else
			{
				return new SAFTXMLWriter1_10(report, reportModeAndCreditorSelector, null);
			}
		}
...
";
		...
		public override void TestWriteAnnualReportXmlToStream()
		{
			using (GlbCompany.CurrentCompany.TemporarilySetCountry(Core.Constants.CountryCodes.Norway))
			{
				var filePath = @"Enterprise\Product\Operations\Accounting\Accounting.DataTransfer.Testing\ComplianceReport\SAFT\TestFiles\SAFT1_10\SAFT-NO Annual.xml";
		...
		public void TestWriteSAFTAnnualReport_WriteReportToSeparateXMLAndZip()
		{
			using (GlbCompany.CurrentCompany.TemporarilySetCountry(CountryCodes.Norway))
			{
				...
				var filePath = BaseSourcePath + @"Enterprise\Product\Operations\Accounting\Accounting.DataTransfer.Testing\ComplianceReport\SAFT\TestFiles\SAFT1_10\SAFT-NO Annual_Split.xml";
				...
				try
				{
					...
					using (var stream = new MemoryStream())
					{
						...
						var expectXml1 = $@"<?xml version=""1.0"" encoding=""utf-8""?><AuditFile xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""urn:StandardAuditFile-Taxation-Financial:NO""><Header><AuditFileVersion>1.10</AuditFileVersion><AuditFileCountry>NO</AuditFileCountry><AuditFileDateCreated>2023-02-22</AuditFileDateCreated><SoftwareCompanyName>Wisetech Global Limited</SoftwareCompanyName><SoftwareID>CargoWise</SoftwareID><SoftwareVersion>{ReleaseInfo.Instance.VersionNumber}</SoftwareVersion><Company><RegistrationNumber /><Name>Eagle Datamation International</Name><Address><StreetName>184 Bourke Road</StreetName><City>Alexandria</City><Country>NO</Country><AddressType>PostalAddress</AddressType></Address><Contact><ContactPerson><FirstName>NotUsed</FirstName><LastName>CargoWise Support</LastName></ContactPerson><Telephone></Telephone></Contact><TaxRegistration><TaxRegistrationNumber>NA</TaxRegistrationNumber><TaxAuthority>Skatteetaten</TaxAuthority></TaxRegistration><BankAccount><BankAccountNumber></BankAccountNumber></BankAccount></Company><DefaultCurrencyCode>NOK</DefaultCurrencyCode><SelectionCriteria><SelectionStartDate>2023-02-01</SelectionStartDate><SelectionEndDate>2023-03-31</SelectionEndDate></SelectionCriteria><TaxAccountingBasis>A</TaxAccountingBasis></Header><MasterFiles><GeneralLedgerAccounts><Account><AccountID>6210.00.00</AccountID><AccountDescription>TRADE DEBTORS CONTROL</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate></AccountCreationDate><OpeningDebitBalance>0.00</OpeningDebitBalance><ClosingDebitBalance>1020.00</ClosingDebitBalance></Account><Account><AccountID>6240.00.00</AccountID><AccountDescription>WIP CONTROL</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate></AccountCreationDate><OpeningDebitBalance>123.00</OpeningDebitBalance><ClosingDebitBalance>533.00</ClosingDebitBalance></Account><Account><AccountID>8310.00.00</AccountID><AccountDescription>OUTPUT TAX PAYABLE</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate></AccountCreationDate><OpeningDebitBalance>0.00</OpeningDebitBalance><ClosingCreditBalance>120.00</ClosingCreditBalance></Account><Account><AccountID>8410.10.00</AccountID><AccountDescription>ACCRUAL - JOB COSTING</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate></AccountCreationDate><OpeningCreditBalance>123.00</OpeningCreditBalance><ClosingCreditBalance>443.00</ClosingCreditBalance></Account><Account><AccountID>8888.10.00</AccountID><AccountDescription>Test GL Account1</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate>2023-02-22</AccountCreationDate><OpeningDebitBalance>0.00</OpeningDebitBalance><ClosingCreditBalance>1000.00</ClosingCreditBalance></Account><Account><AccountID>ZUSDHeader</AccountID><AccountDescription></AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate>2023-02-22</AccountCreationDate><OpeningDebitBalance>0.00</OpeningDebitBalance><ClosingDebitBalance>300.00</ClosingDebitBalance></Account><Account><AccountID>8888.20.00</AccountID><AccountDescription>Test GL Account2</AccountDescription><StandardAccountID></StandardAccountID><AccountType>GL</AccountType><AccountCreationDate>2023-02-22</AccountCreationDate><OpeningDebitBalance>0.00</OpeningDebitBalance><ClosingCreditBalance>200.00</ClosingCreditBalance></Account></GeneralLedgerAccounts><Customers><Customer><RegistrationNumber></RegistrationNumber><Name>A.A.L. SHIPPING AGENCIES P/L</Name><Address><StreetName>PO BOX 10446</StreetName><AdditionalAddressDetail>ADELAIDE ST, BRISBANE  QLD</AdditionalAddressDetail><PostalCode>4000</PostalCode><Country>AU</Country><AddressType>PostalAddress</AddressType></Address><Contact><ContactPerson><FirstName>NotUsed</FirstName><LastName /></ContactPerson><Telephone /><Email /></Contact><TaxRegistration><TaxRegistrationNumber>NA</TaxRegistrationNumber><TaxAuthority>Skatteetaten</TaxAuthority></TaxRegistration><CustomerID>AALSHI</CustomerID><AccountID>6210.00.00</AccountID><OpeningDebitBalance>0</OpeningDebitBalance><ClosingDebitBalance>330.0000</ClosingDebitBalance></Customer><Customer><RegistrationNumber></RegistrationNumber><Name>ABI GAS &amp; TOOLS</Name><Address><StreetName>171 ABBOTSFORD ROAD</StreetName><AdditionalAddressDetail>MAYNE, QLD</AdditionalAddressDetail><PostalCode>4006</PostalCode><Country>PT</Country><AddressType>PostalAddress</AddressType></Address><Contact><ContactPerson><FirstName>NotUsed</FirstName><LastName /></ContactPerson><Telephone /><Email /></Contact><TaxRegistration><TaxRegistrationNumber>NA</TaxRegistrationNumber><TaxAuthority>Skatteetaten</TaxAuthority></TaxRegistration><CustomerID>ABIGAS</CustomerID><AccountID>6210.00.00</AccountID><OpeningDebitBalance>0</OpeningDebitBalance><ClosingDebitBalance>690.0000</ClosingDebitBalance></Customer></Customers><TaxTable><TaxTableEntry><TaxType>MVA</TaxType><Description>Merverdiavgift</Description></TaxTableEntry></TaxTable></MasterFiles></AuditFile>";
