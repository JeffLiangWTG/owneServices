...
{
	public class GEIErrorNotificationEmailForBatchTest : EInvoicingTransactionErrorNotificationEmailTest
	{
		protected override EInvoicingTransactionErrorNotificationEmail GetNewBusinessObject()
		{
			...
			{
				IncorrectTransactionDetails.FromBizo(transaction1, null),
				IncorrectTransactionDetails.FromBizo(transaction2, new [] { (ZString)"Transaction the second was not successful because..." }),
				IncorrectTransactionDetails.FromBizo(transaction3, new [] { (ZString)"Some kind of error for the third transaction" })
			};
			var incorrectTransactionDetails = IncorrectTransactionDetails.FromBizo(batch, errors);
			return new GEIErrorNotificationEmail(ediMessage, incorrectTransactionDetails, transactions);
		}

		protected override ZString GetExpectedSubject()
		{
			return "E-Reporting error notification for Electronic Invoicing Batch 3627 [EDI]";
		}
...
<br/><br/>
<span style='text-decoration: underline;'>Electronic Invoicing Batch 3627</span><br/>
<b>
&nbsp;&nbsp;
Error Details:
</b>
...
<div style='width:1200px; margin-left:30px;'>
Transaction the second was not successful because...
</div>
...
<div style='width:1200px; margin-left:30px;'>
Some kind of error for the third transaction
</div>
</br>
