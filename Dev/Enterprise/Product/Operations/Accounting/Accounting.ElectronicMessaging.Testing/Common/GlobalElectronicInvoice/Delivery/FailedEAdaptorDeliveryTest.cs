...
{
	public class FailedEAdaptorDeliveryTest : TestCaseWithFactory
	{
		public void TestCreateEAdaptorMessage()
		{
  ...
  <Payload>![CDATA[Test Payload]]</Payload>
				...
				using (var stream = (SubStreamableStream)new MemoryStream(Encoding.UTF8.GetBytes(messageBody)))
				{
					...
					var delivery = new FailedGEIEAdaptorDelivery();
		...
		protected override void SetUp()
		{
			...
			ediCommunication.EK_CommunicationsTransport = "EDP";
