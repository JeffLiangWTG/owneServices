...
{
	public class GEIErrorNotificationEmailForComplianceDocumentTest : EInvoicingTransactionErrorNotificationEmailTest
	{
		protected override EInvoicingTransactionErrorNotificationEmail GetNewBusinessObject()
		{
			...
			complianceDocument.ADH_TransactionType = ZArchitecture.Core.TransactionTypes.Invoice;
			var incorrectTransactionDetails = IncorrectTransactionDetails.FromBizo(complianceDocument, errors);
			return new GEIErrorNotificationEmail(ediMessage, incorrectTransactionDetails);
		}

		protected override ZString GetExpectedSubject()
		{
			return "E-Reporting error notification for Compliance Document AA00000001 [EDI]";
		}
		...
		protected override IEnumerable<ZString> GetExpectedBodyParts()
		{
			...
			parts.Add(@"<html><body>
The following compliance document was not successfully submitted to E-Reporting authority:
<br/><br/>
<a href='edient:Command=ShowViewForm&LicenceCode=EDIEDIDAT&ControllerID=ARComplianceDocument&BusinessEntityPK=");
			parts.Add(@">AA00000001</a><br/>
<br/>
If you wish to re-submit the compliance document, please reset the status of each compliance document to Queued in the Receivables Compliance Documents module.
<br/><br/>
<b>
