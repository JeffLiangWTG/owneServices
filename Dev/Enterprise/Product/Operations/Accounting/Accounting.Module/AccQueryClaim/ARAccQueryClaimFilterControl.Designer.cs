...
{
	public partial class ARAccQueryClaimFilterControl
	{
		...
		private void InitializeComponent()
		{
			...
			// FilteredGrid
			//
			zGuidFindBoxColumnStyleInfo1.CaptionResourceString = Enterprise.Accounting.Module.Res.GetData("ARAccQueryClaimFilterControl|ba7f7262-c035-4fbc-a943-232ff4da9e02", "Debtor");
			...
			//
			// ARAccQueryClaimFilterControl
			//
			this.Name = "ARAccQueryClaimFilterControl";
