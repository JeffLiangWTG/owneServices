...
{
	public class JobInvoicingConsolController : ZController
	{
		public override bool MakeUrlsOnlyOpenableForCurrentCompany => true;

		public override ControllerID ID
		{
			get { return ControllerIDs.JobInvoicingConsol; }
		}
		...
		public override ResourceStringData PluginTabPageCaption { get { return Enterprise.Accounting.Module.Res.GetData("PlugInTabPage|JobInvoicingConsol", "AR and AP Invoices", "The Invoice Printing tab."); } }

		protected override ZArchitecture.PlugIn.ZPlugIn GetPlugIn(IBusiness businessEntity)
		{
			return new InvoicingPluginToConsol(businessEntity);
		}
