...
{
	public class QuickBookingJobForTaxBranchFact : QuickBookingJobFact, IQuickBookingJobFactForTaxBranch
	{
		...
		public QuickBookingJobForTaxBranchFact(
			...
			IOrganisationWithMainAddressFact consolReceivingAgentFact = null)
			: base(jobPlugin: jobPlugin,
