...
{
	class SendARInvoiceProcessorCreator : ISendARInvoiceProcessorCreator
	{
		public IProcessor CreateSendARInvoiceProcessor(IWorkflowProvider provider)
		{
			...
			{
				result = new SendARInvoiceProcessor(invoice);
			}
			return result;
		}
	}
