...
{
	public class ARJournalCollection : ActiveBusinessObjectCollection<ARJournal>
	{
		public ARJournalCollection(BusinessObjectFactory factory, MatchingBase matchingBO, ICollectionRelationship relationship)
		...
		protected override void SetDefaultsForNewElementCore(ARJournal newElement)
		{
			...
			newElement.AH_AG = (Guid)AccountingConfigurationRegistry.Instance.ARJournalAccount.GetValueWithoutFallback(Guid.Empty, Guid.Empty, Guid.Empty);
		}

		public void SetUseJournalValidation(bool value)
		{
			foreach (ARJournal journal in this)
			{
