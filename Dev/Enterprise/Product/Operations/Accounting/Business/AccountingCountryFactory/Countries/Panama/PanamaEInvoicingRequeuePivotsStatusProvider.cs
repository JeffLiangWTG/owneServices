...
namespace Enterprise.Accounting.Business.AccountingCountryFactory.Countries.Panama
{
	class PanamaEInvoicingRequeuePivotsStatusProvider : IEInvoicingRequeuePivotsStatusProvider
	{
