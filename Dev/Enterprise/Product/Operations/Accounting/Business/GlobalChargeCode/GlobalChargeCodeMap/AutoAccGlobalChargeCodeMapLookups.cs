...
namespace Enterprise.Accounting.Business.GlobalChargeCode
{
	...
	public abstract class AutoAccGlobalChargeCodeMapLookups : ZLookups
	{
		protected AutoAccGlobalChargeCodeMapLookups(AutoAccGlobalChargeCodeMap Parent) : base(Parent)
		{
		}
