...
{
	public interface IShareSequentialTransactionNumbers
	{
		ZBool Value { get; }
	}

	[XmlSerializerAssembly("Enterprise.Accounting.Business.XmlSerializers")]
	public class ShareSequentialTransactionNumbers : RegistryBusinessObjectTemplate, IShareSequentialTransactionNumbers
	{
