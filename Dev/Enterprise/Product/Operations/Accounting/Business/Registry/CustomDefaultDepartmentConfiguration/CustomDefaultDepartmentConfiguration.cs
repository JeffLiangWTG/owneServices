...
namespace Enterprise.Accounting.Registry.Business
{
	...
	public class CustomDefaultDepartmentConfiguration : RegistryBusinessObjectTemplate
	{
		public CustomDefaultDepartmentConfiguration(FallbackLevel fallbackLevel, BusinessObjectFactory factory)
			: base(fallbackLevel, factory)
		{
		}

		public CustomDefaultDepartmentConfiguration()
			: base()
		{
		}
		...
		protected override void CopyValuesToClone(RegistryBusinessObjectTemplate clone)
		{
			...
			CustomDefaultDepartmentConfiguration castedClone = (CustomDefaultDepartmentConfiguration)clone;
