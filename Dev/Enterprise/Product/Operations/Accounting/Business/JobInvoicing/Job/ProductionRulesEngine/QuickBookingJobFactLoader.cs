...
{
	public class QuickBookingJobFactLoader : BaseJobFactLoader, IQuickBookingJobFactLoader
	{
		public QuickBookingJobFactLoader(RulesContextType rulesContextType)
	...
	protected override IEnumerable<IInputFact> GetFactsCore(IJobInvoicingPlugIn parentPlugin, FactAccumulator factAccumulator)
	{
		...
		var jobFact = RulesContextType == RulesContextType.JobBillingTaxBranchDefaulting
			? new QuickBookingJobForTaxBranchFact(parentPlugin,
				EnvironmentFact,
			...
			: new QuickBookingJobFact(parentPlugin,
				EnvironmentFact,
				localClientFact: LocalClientFact,
				salesRepFact: SalesRepFact,
				origin: origin,
