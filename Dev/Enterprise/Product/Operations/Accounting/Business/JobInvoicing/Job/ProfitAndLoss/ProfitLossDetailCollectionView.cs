...
{
	public class ProfitLossDetailCollectionView : ProfitLossDetailCollectionBaseView
	{
		public ProfitLossDetailCollectionView(ProfitLossCollectionBase profitLossCollectionToFilter, IJobCostingPlugIn plugin)
			: base(profitLossCollectionToFilter, plugin)
		{
		}

		public override void FilterProfitLossCollection()
		{
			RemoveAndDeleteAll();
			AddRange(profitLossCollectionToFilter.Where(x => IsAllowedToViewJobFromCurrentBranch(x.Job as Job, x.Branch, x.Department)).Select(e => new ProfitLossDetailView(e)));
		}
