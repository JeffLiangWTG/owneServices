...
{
	public class JobRevenueQueuePoster : JobRevenuePoster
	{
		public JobRevenueQueuePoster(IJobInvoicingPlugIn plugIn, IEnumerable<Charge> jobCharges, IEnumerable<IJobChargePostingQueue> queueEntries)
			: base(plugIn)
		{
		...
		protected override PostManagerValidation CreatePostManagerValidation(IEnumerable<Job> jobs)
		{
			...
			return new JobChargeQueuePostManagerValidation(jobs, JobInvoicingPostingOption.Revenue, jobsWithSelectedCharges, QueueEntries);
		}
	}
}