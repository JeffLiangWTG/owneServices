...
{
	public class FijiAdditionalAccTransactionHeaderAuthorisationRecordInfoForDocWrapperTest
		: AdditionalAccTransactionHeaderAuthorisationRecordInfoForDocWrapperTest
	{
		...
		public override void TestProperties()
		{
			...
			currentAHFRecord = CreateFijiAHFBizo();
			base.TestProperties();
		...
		public void TestOriginalTransactionReferenceNumberWhenOriginalTransactionIsBeforeComplianceDate()
		{
			...
			TestObjectCreator.SetCustomsCodeForOrgHeader(TestObjectCreator.Debtor, OrgCusCode.CodeTypes.TaxFileCode, Core.Constants.CountryCodes.Fiji, "12345678798");
			Factory.Save();
		...
		FijiAccTransactionHeaderAuthorisationRecord CreateFijiAHFBizo()
		{
			var authorizationRecord = Factory.NewWithValidTestData<FijiAccTransactionHeaderAuthorisationRecord>();
			authorizationRecord.BusinessName = "FijiBusiness";
			authorizationRecord.LocationName = "FijiLocation";
			authorizationRecord.Address = "FijiAddress";
			authorizationRecord.District = "FijiDistrict";
		...
		FijiAccTransactionHeaderAuthorisationRecord currentAHFRecord;
