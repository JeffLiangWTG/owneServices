...
{
	public abstract class DynamicTransactionCreatorSingleLedgerTest : DynamicTransactionCreatorTest
	{
		protected OrgHeader Org1;
		protected OrgHeader Org2;
		protected OrgHeader Org3;
		protected OrgHeader TestPrimaryOrg;
		...
		protected override void SetUp()
		{
			...
			TestPrimaryOrg = Factory.NewWithValidTestData<OrgHeader>();
		}
	}
}