...
{
	[TestedType(typeof(ReconciledStatementCollectionView))]
	public class ReconciledStatementCollectionViewTest : BusinessObjectCollectionViewTestCase<ReconciledStatementCollectionView>
	{
		public void TestIsThisPartOfTheCollection()
		{
			...
			var view = new ReconciledStatementCollectionView(collection);
		...
		protected override ReconciledStatementCollectionView GetCollectionToTest()
		{
			StatementCollection = new StatementCollection(Factory.New<BankStatement>(), Factory);
			return new ReconciledStatementCollectionView(StatementCollection);
		}
