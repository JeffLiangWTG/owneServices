...
{
	public class UnitedKingdomAccountingCountryFactoryTest : TestCaseWithFactory
	{
		...
		static IAccountingCountryFactory GetCountryFactoryForThisCountry()
			=> ObjectFactory.Get<IGlobalAccountingCountryFactory>().GetCountryFactory(Constants.CountryCodes.UnitedKingdom);
	}
}
