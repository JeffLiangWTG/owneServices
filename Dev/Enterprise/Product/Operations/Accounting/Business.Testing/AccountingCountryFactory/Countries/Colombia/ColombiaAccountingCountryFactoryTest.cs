...
{
	public class ColombiaAccountingCountryFactoryTest : TestCaseWithFactory
	{
		...
		static IAccountingCountryFactory GetCountryFactoryForThisCountry()
			=> ObjectFactory.Get<IGlobalAccountingCountryFactory>().GetCountryFactory(Constants.CountryCodes.Colombia);
	}
}
