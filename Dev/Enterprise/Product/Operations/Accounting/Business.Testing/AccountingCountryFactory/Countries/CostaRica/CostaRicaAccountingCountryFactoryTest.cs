...
{
	public class CostaRicaAccountingCountryFactoryTest : TestCaseWithFactory
	{
		...
		static IAccountingCountryFactory GetCountryFactoryForThisCountry()
			=> ObjectFactory.Get<IGlobalAccountingCountryFactory>().GetCountryFactory(Constants.CountryCodes.CostaRica);
	}
}
