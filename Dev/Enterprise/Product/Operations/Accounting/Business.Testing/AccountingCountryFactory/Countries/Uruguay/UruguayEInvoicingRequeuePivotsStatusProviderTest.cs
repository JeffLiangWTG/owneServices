...
{
	public class UruguayEInvoicingRequeuePivotsStatusProviderTest : TestCaseWithFactory
	{
		...
		IEInvoicingRequeuePivotsStatusProvider GetInstance() => (ObjectFactory.Get<IGlobalAccountingCountryFactory>().GetCountryFactory(Constants.CountryCodes.Uruguay) as IInstanceProvider<IEInvoicingRequeuePivotsStatusProvider>).Get();
	}
}
