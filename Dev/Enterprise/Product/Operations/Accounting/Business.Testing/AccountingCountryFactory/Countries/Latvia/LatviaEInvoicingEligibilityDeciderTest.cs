...
{
	public class LatviaEInvoicingEligibilityDeciderTest : EInvoicingEligibilityDeciderTestBase
	{
		protected override string CountryCode => CountryCodes.Latvia;
		...
		protected override FakeEligibilityLiteTransaction CreateEligibleTransaction()
			...
			{
				CountryCode = CountryCodes.Latvia,
