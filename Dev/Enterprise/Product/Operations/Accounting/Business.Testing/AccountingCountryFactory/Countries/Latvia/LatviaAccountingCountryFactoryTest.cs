...
{
	public class LatviaAccountingCountryFactoryTest : TestCaseWithFactory
	{
		...
		static IAccountingCountryFactory GetCountryFactoryForThisCountry()
			=> ObjectFactory.Get<IGlobalAccountingCountryFactory>().GetCountryFactory(Constants.CountryCodes.Latvia);
	}
}
