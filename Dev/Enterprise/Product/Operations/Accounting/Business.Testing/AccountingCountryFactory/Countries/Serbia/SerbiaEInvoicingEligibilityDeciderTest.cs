...
{
	public class SerbiaEInvoicingEligibilityDeciderTest : EInvoicingEligibilityDeciderTestBase
	{
		protected override string CountryCode => CountryCodes.Serbia;
		...
		protected override FakeEligibilityLiteTransaction CreateEligibleTransaction() =>
			...
			{
				CountryCode = CountryCodes.Serbia,
