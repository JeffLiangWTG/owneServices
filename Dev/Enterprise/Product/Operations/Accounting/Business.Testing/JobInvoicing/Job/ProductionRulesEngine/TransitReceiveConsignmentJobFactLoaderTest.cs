...
{
	public class TransitReceiveConsignmentJobFactLoaderTest : FactLoaderBaseTest<TransitReceiveConsignmentJobFact>
	{
		...
		{
			return new TransitReceiveConsignmentJobFactLoader(contextType);
		}
	}
}
