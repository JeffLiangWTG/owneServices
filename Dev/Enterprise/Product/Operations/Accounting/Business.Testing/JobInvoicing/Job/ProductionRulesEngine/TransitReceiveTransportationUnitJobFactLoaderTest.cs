...
{
	public class TransitReceiveTransportationUnitJobFactLoaderTest : FactLoaderBaseTest<TransitReceiveTransportationUnitJobFact>
	{
		...
		{
			return new TransitReceiveTransportationUnitJobFactLoader(contextType);
		}
	}
}
