...
{
	[TestedType(typeof(AccCollectionBatchWorkflowDescriptor))]
	public class AccCollectionBatchWorkflowDescriptorTest : WorkflowDescriptorTestCase<AccCollectionBatchWorkflowDescriptor>
	{
		public override void TestID()
		{
			AssertEquals("Correct Code", "CBW", WorkflowDescriptor.Code);
		}

		public override void TestDescription()
		{
			AssertEquals("Correct Desc", "Collection Batch", WorkflowDescriptor.Description);
		}
		...
		{
			return new IWorkflowProvider[] { Factory.New<AccCollectionBatch>() };
		}
	}
}
