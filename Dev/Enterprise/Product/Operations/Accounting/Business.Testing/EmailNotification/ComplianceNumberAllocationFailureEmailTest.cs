...
{
	public class ComplianceNumberAllocationFailureEmailTest : AccountingEmailDefTest
	{
		protected override Type EmailDefType
		{
			get
			{
				return typeof(ComplianceNumberAllocationFailureEmail);
			}
		}
...
If required, please configure / activate a new Compliance Invoice Book.", GlbBranch.CurrentBranch.GB_Code, "TXI", Env.CurrentUser.FullName, "1");
