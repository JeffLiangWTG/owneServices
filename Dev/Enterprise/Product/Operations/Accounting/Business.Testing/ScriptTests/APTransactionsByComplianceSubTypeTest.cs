...
{
	class APTransactionsByComplianceSubTypeTest : TransactionsByComplianceSubTypeCoreTest
	{
		protected override Type TransactionType => typeof(APInvoice);

		public override bool ShouldTestComplianceNumber => false;
		...
		public void TestTransactionLocalAmountWithOtherTaxes()
		{
			...
			var result = RunScript(ZDateTime.Today.AddDays(-1).ToString("yyyy-MM-dd"), ZDateTime.Today.AddDays(1).ToString("yyyy-MM-dd"), "", "", "", "");
		...
		public void TestSimpleRun()
		{
			...
			var headers = new[]
			{
				...
				"TransactionOrgName", "TransactionUNLOCO"
			};
...
SELECT * FROM APTransactionsByComplianceSubType(
	'{0}',				-- CurrentCountry
	'{1}',				-- Company
