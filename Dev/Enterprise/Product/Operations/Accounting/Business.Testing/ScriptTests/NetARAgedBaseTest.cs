...
{
	public class NetARAgedBaseTest : ScriptTest
	{
		[TestDate(2020, 12, 30)]
		...
		public void TestGetAdditionalCompanyName()
		{
			using (GlbCompany.CurrentCompany.TemporarilySetCountry(Constants.CountryCodes.China))
			{
				...
				Assert(!orgAddress.AddressCapability.GetCapabilityEnabled(OrgAddressType.Payables));
