...
{
	class BalanceSheetOrProfitAndLossWithReportCategories_UserDefinedTest : ScriptTest
	{
		[TestDate(2018, 01, 01)]
		public void TestBalanceSheetOrProfitAndLoss_UserDefinedReportType()
		{
			...
			testObjectCreator.CreateGLDescriptorPivot(accGLAccountDescriptor, glHeader1PNL, "AAA", "D11");
			...
			testObjectCreator.CreateGLDescriptorPivot(accGLAccountDescriptor, glHeader2PNL, "AAA", "D11");
			...
			testObjectCreator.CreateGLDescriptorPivot(accGLAccountDescriptor, glHeader3PNL, "AAA", "D12");
			...
			testObjectCreator.CreateGLDescriptorPivot(testAccGLAccountDescriptor4PNL, glHeader4PNL, "AAA", "D13");
			...
			testObjectCreator.CreateGLDescriptorPivot(testObjectCreator.CreateAccountDescriptor(glHeader1, "53000.95", "COA", "BSH", Core.SharedConstants.Languages.ChineseSimplified, "", "CN", Constants.DebitCredit.Debit), glHeader1, "BBB", "D01");
			testObjectCreator.CreateGLDescriptorPivot(testObjectCreator.CreateAccountDescriptor(glHeader2, "53000.96", "COA", "BSH", Core.SharedConstants.Languages.ChineseSimplified, "", "CN", Constants.DebitCredit.Debit), glHeader2, "BBB", "D01");
			...
			testObjectCreator.CreateGLDescriptorPivot(testObjectCreator.CreateAccountDescriptor(glHeader3, "53000.97", "COA", "BSH", Core.SharedConstants.Languages.ChineseSimplified, "", "CN", Constants.DebitCredit.Debit), glHeader3, "BBB", "D02");
			...
			testObjectCreator.CreateGLDescriptorPivot(testAccGLAccountDescriptor4, glHeader4, "BBB", "D03");
			...
			DataTable results = RunScript(200912, "BSS", "BSS");
		...
		DataTable RunScript(int period, string repotType,string accountType)
		{
			DataTable table = DataUtils.GetDataTableFromQuery(Db.Connection,
									string.Format(@"EXEC BalanceSheetOrProfitAndLossWithReportCategories_UserDefined '{0}','{1}',{2},'{3}','','{4}','D01, D02, D03, D11, D12, D13, D01_YED, D02_YED, D03_YED, D11_YED, D12_YED, D13_YED','ZH-CN','CN'",
													repotType,
													accountType,
													period,
