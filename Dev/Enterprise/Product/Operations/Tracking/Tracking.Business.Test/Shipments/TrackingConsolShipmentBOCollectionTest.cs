...
{
	[TestedType(typeof(TrackingConsolShipmentCollection))]
	sealed class TrackingConsolShipmentBOCollectionTest : BusinessObjectCollectionTestCase
	{
		protected override BusinessObjectCollection GetCollectionToTest()
		{
			TrackingConsol trackingConsol = Factory.New<TrackingConsol>();
			return trackingConsol.Shipments;
		}

		protected override BusinessObject GetNewElementToAddToTheCollection()
		{
			return Factory.New(typeof(TrackingShipment));
		}
		...
		{
			AssertEquals("Test the correct collection", typeof(TrackingConsolShipmentCollection), GetCollectionToTest().GetType());
		}
	}
}
