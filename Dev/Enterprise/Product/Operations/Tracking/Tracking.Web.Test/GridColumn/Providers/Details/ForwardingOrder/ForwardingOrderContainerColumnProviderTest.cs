...
{
	[TestedType(typeof(ForwardingOrderContainerColumnProvider))]
	sealed class ForwardingOrderContainerColumnProviderTest : GridColumnProviderTest
	{
		...
		{
			return new ForwardingOrderContainerColumnProvider();
		}
	}
}
