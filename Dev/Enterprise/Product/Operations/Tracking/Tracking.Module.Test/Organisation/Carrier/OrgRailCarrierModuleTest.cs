...
{
	[TestedType(typeof(OrgRailCarrierModule))]
	sealed class OrgRailCarrierModuleTest : OrganisationModule_Test
	{
		...
		public override FilterBusinessObjectDefault[] GetArrExpectedFilterBusinessObjectDefault()
		{
			...
			defaults.Add(new FilterBusinessObjectDefault(AutoOrganisationFilterBusinessObject.Schema.OH_IsRailProvider, ZBool.True));
