...
{
	[TestedType(typeof(OrgRoadCarrierModule))]
	sealed class OrgRoadCarrierModuleTest : OrganisationModule_Test
	{
		...
		public override FilterBusinessObjectDefault[] GetArrExpectedFilterBusinessObjectDefault()
		{
			...
			defaults.Add(new FilterBusinessObjectDefault(AutoOrganisationFilterBusinessObject.Schema.OH_IsLineHaulProvider, ZBool.True));
