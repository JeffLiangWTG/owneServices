...
{
	[TestedType(typeof(OrgSeaCarrierModule))]
	sealed class OrgSeaCarrierModuleTest : OrganisationModule_Test
	{
		...
		public override FilterBusinessObjectDefault[] GetArrExpectedFilterBusinessObjectDefault()
		{
			...
			defaults.Add(new FilterBusinessObjectDefault(AutoOrganisationFilterBusinessObject.Schema.OH_IsShippingLine, ZBool.True));
