...
{
	[TestedType(typeof(OrgCarrierModule))]
	sealed class OrgCarrierModuleTest : OrganisationModule_Test
	{
		...
		protected override WebModuleID TestID => WebModuleIDs.OrgCarrierTracking;
