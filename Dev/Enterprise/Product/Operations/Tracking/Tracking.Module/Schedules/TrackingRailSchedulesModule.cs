...
{
	public class TrackingRailSchedulesModule : ZFilterStripGridModule
	{
		public TrackingRailSchedulesModule(BusinessObjectFactory factory, ZPage page) : base(factory, page) { }

		public override ModuleIdentifier ID => WebModuleIDs.TrackingRailSchedules;

		protected override FilterLayoutCodePairRegistryItem DefaultLayoutRegistryItem => WebDataRegistry.Instance.DefaultFilterLayoutForwardingRailSchedules;
		...
		protected override FilterStripBusinessObject GetNewFilterStripBusinessObject() => new JobRailSailingFilterBusinessObject { UserIsLoggedIn = Page.SiteUser.IsLoggedIn };
