...
{
	/// <summary>
	/// Summary description for TrackingHAWBModule.
	/// </summary>
	public class TrackingHAWBModule : ZFilterStripGridModule
	{
		public TrackingHAWBModule(BusinessObjectFactory factory, ZPage page)
			: base(factory, page)
		{
		}
		...
		protected override FilterLayoutCodePairRegistryItem DefaultLayoutRegistryItem
		{
			get
			{
				return WebDataRegistry.Instance.DefaultFilterLayoutHAWB;
			}
		}
		...
		{
			var result = new TrackingHAWBFilterBusinessObject();
		...
		{
			get { return WebModuleIDs.TrackingHAWB.Name; }
		}
