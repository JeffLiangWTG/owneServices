...
{
	public class OrgAirCarrierModule : ZArchitecture.Web.Modules.OrganisationModule
	{
		public OrgAirCarrierModule(BusinessObjectFactory factory, ZPage page) : base(factory, page) { }
		...
		protected override FilterBusinessObjectDefaults GetNewFilterBusinessObjectDefaults()
		{
			...
			fFilterBusinessObjectDefaults.Add(new FilterBusinessObjectDefault(AutoOrganisationFilterBusinessObject.Schema.OH_IsAirLine, ZBool.True));
