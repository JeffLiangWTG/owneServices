...
{
	public abstract class WarehouseDocketLineGridAddOn : ZDataGridAddOn, IWebServiceMethodsCaller
	{
		public string ProductBindTo { get; set; }
		public string DescriptionBindTo { get; set; }
		public string PacksBindTo { get; set; }
		public string PacksUQBindTo { get; set; }
		public string QuantityBindTo { get; set; }
		public string ProductUQBindTo { get; set; }
		public string Attribute1BindTo { get; set; }
		public string Attribute2BindTo { get; set; }
		public string Attribute3BindTo { get; set; }
		public string SerialNumberBindTo { get; set; }
		...
		protected override void AddScripts(DataGridItem item)
		{
			...
			if (Grid != null)
			{
				...
				{
					var orderRef = Page.DataSourceIndexer;
					...
					if (!string.IsNullOrEmpty(lineRef))
					{
						...
						AddScripts(orderRef, lineRef, cellControls);
					}
				}
			}
		}
