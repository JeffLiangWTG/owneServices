...
<%@ Page language="c#" Codebehind="WarehouseReceipts.aspx.cs" AutoEventWireup="True" Inherits="Enterprise.Tracking.Web.WarehouseReceipts" %>
	...
	<body id="DefaultBody" runat="server">
		<form id="Form1" method="post" runat="server">
			<div id="OuterContentPane" runat="server">
				<DIV id="Title">
					<edi:ZTextLabel id="TitleLabel" runat="server" CssClass="PageTitle">Warehouse Receipts</edi:ZTextLabel>
				</DIV>
