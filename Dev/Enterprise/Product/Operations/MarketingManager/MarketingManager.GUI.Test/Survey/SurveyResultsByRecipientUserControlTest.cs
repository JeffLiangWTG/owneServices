...
namespace Enterprise.MarketingManager.GUI.Testing
{
	...
	class SurveyResultsByRecipientUserControlTest : ZFormBasherTest
	{
		...
		ZForm GetTestForm(GlbCompanyCampaign campaign)
		{
			...
			var userControl = new SurveyResultsByRecipientUserControl(campaign);
			userControl.Name = "SurveyResultsByRecipientUserControl";
