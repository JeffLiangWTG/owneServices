...
namespace Enterprise.MarketingManager.GUI.Testing
{
	...
	class VoteResultsByQuestionUserControlTest : ZFormBasherTest
	{
		...
		ZForm GetTestForm(GlbCompanyCampaign campaign)
		{
			...
			VoteResultsByQuestionUserControl userControl = new VoteResultsByQuestionUserControl();
			userControl.Name = "VoteResultsByQuestionUserControl";
