...
{
	[TestedType(typeof(SalesTradeLanesSynchronisationControl))]
	class SalesTradeLanesSynchronisationControlTest : ZFormBasherTest
	{
		...
		{
			return (ZUserControl)Activator.CreateInstance(typeof(SalesTradeLanesSynchronisationControl), null);
		}
		...
		public override Type FormToBashType => typeof(ZEmptyFormForBasherTest);
	}
}
