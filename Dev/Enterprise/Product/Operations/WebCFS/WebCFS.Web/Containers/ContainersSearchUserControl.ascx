<%@ Control Language="c#" AutoEventWireup="True" Codebehind="ContainersSearchUserControl.ascx.cs" Inherits="Enterprise.WebCFS.Web.ContainersSearchUserControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<table class="ResultsTable" id="Table2">
	<tbody>
		<tr>
			...
			<td noWrap colspan="3"><edi:ztextbox id="ContainerNumber" runat="server" BindTo="LCV_ContainerNum" width="100%"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td noWrap colspan="3"><edi:ztextbox id="Vessel" runat="server" BindTo="LCV_Vessel" Width="100%" /></td>
		</tr>
		<tr>
			<td noWrap><edi:ZTextLabel id="Zlabel6" runat="server">Voyage:</edi:ZTextLabel></td>
			<td noWrap colspan="3"><edi:ztextbox id="Voyage" runat="server" BindTo="LCV_VoyageFlight" Width="100%" /></td>
		</tr>
	</tbody>
</table>
