...
namespace Enterprise.WebCFS.Web
{
	...
	/// </summary>
	public partial class Fumigation : BasePage
	{
		#region DataSource
		...
		protected override BusinessObject GetNewDataSource()
		{
			...
			return filterFactory.New(typeof(FumigationFilterBusinessObject));
		}
		...
		void SetupSearchControl()
		{
			...
			SearchControl.ModuleID = WebModuleIDs.CFSFumigation;
