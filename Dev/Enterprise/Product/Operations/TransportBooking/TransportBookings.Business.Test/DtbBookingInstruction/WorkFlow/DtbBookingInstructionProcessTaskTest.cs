...
{
	[TestedType(typeof(DtbBookingInstructionProcessTask))]
	public class DtbBookingInstructionProcessTaskTest : ProcessTaskTest
	{
		...
		protected override BusinessObject GetNewBusinessObject()
		{
			...
			return ((IWorkflowProvider)booking.Instructions[0]).WorkflowItems.AddNew();
		}
