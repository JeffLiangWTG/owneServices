...
{
	class DtbBookingInstructionPkgDivotDataObjectReaderForPackage : DtbBookingInstructionPkgDivotDataObjectReader<InstructionPackingLineLink>
	{
		public DtbBookingInstructionPkgDivotDataObjectReaderForPackage(InstructionPackingLineLink confirmationParentDivotDataObject, IXmlImportLogger logger,
		...
		{
			return dataObject.PackingLineLink.GetValueOrDefault();
		}
	}
}
