...
{
	[TestedType(typeof(TransportBookingDocumentForm))]
	public class TransportBookingDocumentFormTest : ZFormBasherTest
	{
		protected override Form GetFormToBashCore()
		{
			...
			return new TransportBookingDocumentForm(options);
		}
	}
}
