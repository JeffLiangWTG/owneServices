...
{
	partial class EDIMessagePurposeForm : Enterprise.ZArchitecture.GUI.ZTemplateForm
	{
		/// <summary>
		...
		{
			this.zUserControl1 = new Enterprise.Workflow.GUI.EDIMessagePurposeUserControl();
			...
			this.DataSourceType = typeof(Enterprise.Workflow.Business.EDIMessagePurpose);
			this.MinimumSize = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(690, 429, true);
			this.Name = "EDIMessagePurposeForm";
		...
		private EDIMessagePurposeUserControl zUserControl1;
	}
}
