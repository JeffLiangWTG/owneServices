...
{
	sealed class OceanCarrierModuleTest : TransactionedTestCase
	{
		public void TestModule()
		{
			using (var module = new OceanCarrierPortalModule())
			{
				AssertEquals(ModuleIDs.OceanCarrierPortal, module.ID);
...
Registry: GLOW/Services/GLOW Portals Root URL", UnitTestUserNotification.Instance.LastMessage.Text);
		...
		public void TestModule_Show()
		{
			...
			using (var module = new OceanCarrierPortalModule())
			{
				...
				AssertEquals("/OCS", uri.AbsolutePath);
			}
		}
	}
}
