...
{
	sealed class RouteSegmentsModuleTest : TransactionedTestCase
	{
		public void TestCreateModule()
		{
			using (var module = new RouteSegmentsModule())
			{
				AssertEquals(ModuleIDs.RouteSegments, module.ID);
...
Registry: GLOW/Services/GLOW Portals Root URL", UnitTestUserNotification.Instance.LastMessage.Text);
		...
		public void TestModule_Show()
		{
			...
			using (var module = new RouteSegmentsModule())
			{
				...
				AssertEquals("/goto/RouteSegments", uri.AbsolutePath);
			}
		}
	}
}
