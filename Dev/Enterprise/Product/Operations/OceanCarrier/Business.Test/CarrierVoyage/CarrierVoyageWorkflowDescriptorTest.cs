...
{
	[TestedType(typeof(CarrierVoyageWorkflowDescriptor))]
	sealed class CarrierVoyageWorkflowDescriptorTest : WorkflowDescriptorTestCase<CarrierVoyageWorkflowDescriptor>
	{
		public override void TestID() => AssertEquals("Expected Workflow Descriptor Code", "VOY", WorkflowDescriptor.Code);

		public override void TestDescription() => AssertEquals("Expected Workflow Descriptor Description", "Ocean Carrier Voyage", WorkflowDescriptor.Description);

		public override void TestSubTypes()
		{
			AssertEquals("we have 1 selection criterias", 1, WorkflowDescriptor.SubTypeInformation.Length);
			AssertEquals("Published", WorkflowDescriptor.SubTypeInformation[0].Description);
		...
		protected override IWorkflowProvider[] GetParentsWithConfiguredOrganisationPartiesForTest()
		{
			...
			voyage.CVO_VoyageNumber = "VOY001";
