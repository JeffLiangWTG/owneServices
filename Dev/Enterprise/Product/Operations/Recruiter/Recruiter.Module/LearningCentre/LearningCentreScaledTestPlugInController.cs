...
{
	public class LearningCentreScaledTestPlugInController : SurveyCampaignPlugInController
	{
		public override ControllerID ID
		{
			get { return ControllerIDs.LearningCentreScaledTestPlugIn; }
		}

		protected override VoteExamSurveyPlugIn GetVoteExamSurveyPlugIn(GlbCompanyCampaign campaign)
		{
			return new LearningCentreScaledTestPlugIn((LearningCentreCampaign)campaign);
		}

		public override ResourceStringData PluginTabPageCaption { get { return Res.GetData("PlugInTabPage|LearningCentreScaledTestPlugIn", "Assessment"); } }
