...
{
	public class SIDRateEntryCollection : RateEntryCollection
	{
		public SIDRateEntryCollection(BusinessObject master, BusinessObjectFactory factory)
			: base(master, factory) { }
		...
		{
			var chargeCodePK = LinerAgencyDataRegistry.Instance.ImportDetentionChargeCode.GetFallBackValueAtAllLevels(Env.CurrentCompany.PK, Env.CurrentBranch.PK, Env.CurrentDepartment.PK);
