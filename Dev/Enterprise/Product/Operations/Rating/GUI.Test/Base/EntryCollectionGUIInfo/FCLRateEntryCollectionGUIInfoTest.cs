...
{
	public class FCLRateEntryCollectionGUIInfoTest : BaseRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(FCLRateEntryCollectionGUIInfo);
		protected override string RateCategory => RatingConstants.RateCategory.FCL;

		// check CFCRateEntryCollectionGUIInfoTest.cs for updating its tests too
