...
{
	public sealed class TBCRateEntryCollectionGUIInfoTest : BaseRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(TBCRateEntryCollectionGUIInfo);
		protected override string RateCategory => RatingConstants.RateCategory.TBC;
...
{RateEntry.Schema.TI_TZ_OriginZone}
{RateEntry.Schema.OriginSuburbPK}
{RateEntry.Schema.TI_TZ_DestinationZone}
{RateEntry.Schema.DestinationSuburbPK}
...
{RateEntry.Schema.TI_OA_CartageDeliveryAddressOverride}
...
";
		...
		public override void TestQuotationRateColumns()
		{
			...
			var expectedForNonSupportUser = $@"{RateEntry.Schema.TI_OriginLRC}
{RateEntry.Schema.TI_TZ_OriginZone}
{RateEntry.Schema.OriginSuburbPK}
{RateEntry.Schema.TI_TZ_DestinationZone}
{RateEntry.Schema.DestinationSuburbPK}
