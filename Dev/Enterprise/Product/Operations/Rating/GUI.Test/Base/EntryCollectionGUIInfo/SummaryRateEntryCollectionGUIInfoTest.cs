...
{
	public sealed class SummaryRateEntryCollectionGUIInfoTest : BaseRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(SummaryRateEntryCollectionGUIInfo);
		protected override string RateCategory => "";
...
";
		...
		public void TestCompanyTariffColumns()
		{
