...
{
	public class DSTRateEntryCollectionGUIInfoTest : BaseRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(DSTRateEntryCollectionGUIInfo);
		protected override string RateCategory => RatingConstants.RateCategory.DST;

		// check CDSRateEntryCollectionGUIInfoTest.cs for updating its tests too
