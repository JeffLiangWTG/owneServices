...
{
	public class LCLRateEntryCollectionGUIInfoTest : BaseRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(LCLRateEntryCollectionGUIInfo);
		protected override string RateCategory => RatingConstants.RateCategory.LCL;

		// check CLCRateEntryCollectionGUIInfoTest.cs for updating its tests too
