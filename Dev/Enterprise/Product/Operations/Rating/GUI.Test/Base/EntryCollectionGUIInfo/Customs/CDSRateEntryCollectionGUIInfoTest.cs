...
{
	public sealed class CDSRateEntryCollectionGUIInfoTest : DSTRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(CDSRateEntryCollectionGUIInfo);

		protected override string RateCategory => RatingConstants.RateCategory.CDS;
