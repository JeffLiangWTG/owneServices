...
{
	public sealed class CFCRateEntryCollectionGUIInfoTest : FCLRateEntryCollectionGUIInfoTest
	{
		protected override Type GUIInfoType => typeof(CFCRateEntryCollectionGUIInfo);

		protected override string RateCategory => RatingConstants.RateCategory.CFC;
