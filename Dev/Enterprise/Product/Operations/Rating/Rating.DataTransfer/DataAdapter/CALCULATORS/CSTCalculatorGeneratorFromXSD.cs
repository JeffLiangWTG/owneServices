...
{
	public class CSTCalculatorGeneratorFromXSD : RateCalculatorGeneratorFromXSD<CompanyTariffOrCostBasedCalculator, Xsd.CSTCalculator>
	{
		#region Import

		protected override void ImportFromValueObjectCore(RateLine rateLine, CompanyTariffOrCostBasedCalculator calculator, Xsd.CSTCalculator calculatorXSD, IValueObjectImportContext context)
		{
		...
		protected override void ExportToValueObjectCore(RateLine rateLine, CompanyTariffOrCostBasedCalculator calculator, Xsd.CSTCalculator calculatorXSD, INotifications notifications)
		{
		...
		{
			get { return RatingXmlSchemaDefinitions.Instance.CSTCalculatorSchema; }
		}
