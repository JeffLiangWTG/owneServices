...
{
	class QuotationLineListHelperCostingTest : QuotationLineListHelperBaseTest
	{
...
";
		...
		// Header "Origin Document Fee" is shown 2x because CarrierServiceLevel is used as GroupBy in DocStrip "Forwarding Non-Quote Rate Table Loose (Landscape)" and "Forwarding Non-Quote Rate Table Non-Loose (Landscape)"
...
";
		...
		// Header "Origin Document Fee" is shown 2x because TransportProvider is used as GroupBy in DocStrip "Forwarding Non-Quote Rate Table Loose (Landscape)" and "Forwarding Non-Quote Rate Table Non-Loose (Landscape)"
...
";
		...
		protected override RatingHeader RatingHeader => costing ?? (costing = TestHelper.NewCosting(TestHelper.NewOrgHeader(1)));
		Costing costing;
	}
}
