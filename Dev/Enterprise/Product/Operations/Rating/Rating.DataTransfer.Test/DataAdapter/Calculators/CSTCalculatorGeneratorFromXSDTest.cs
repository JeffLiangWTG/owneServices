...
{
	public class CSTCalculatorGeneratorFromXSDTest : RateCalculatorGeneratorFromXSDTest<CompanyTariffOrCostBasedCalculator, Xsd.CSTCalculator>
	{
		#region Override ImportCore Method

		protected override void ImportFromValueObjectCore()
		{
			Xsd.CSTCalculator calculatorXSD = CalculatorXSDForTest(false);
		...
		{
			Xsd.CSTCalculator calculatorXSD = new Xsd.CSTCalculator();
			...
			calculatorXSD = new Xsd.CSTCalculator();
			CalculatorGenerator.ExportToValueObject(RateLineForCalculatorTest, calculatorXSD, new NotificationBuffer());
		...
		{
			get { return CompanyTariffOrCostBasedCalculator.CostBasedCode; }
		}

		protected override Type ExpectedGeneratorType
		{
			get { return typeof(CSTCalculatorGeneratorFromXSD); }
		}

		protected override RateCalculatorGeneratorFromXSD<CompanyTariffOrCostBasedCalculator, Xsd.CSTCalculator> CalculatorGenerator
		{
			get { return new CSTCalculatorGeneratorFromXSD(); }
		}
		...
		protected override Xsd.CSTCalculator CalculatorXSDForTest(bool specified)
		{
			calculatorXSD = new Xsd.CSTCalculator();
