...
{
	sealed class SecondaryHeadingCellStylizerTest : CellStylizerTest<SecondaryHeadingCellStylizer>
	{
		public override void TestCanStylize()
		{
			...
			var cellStylizerForNormalCell = new SecondaryHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForNormalCell.CanStylize", false, cellStylizerForNormalCell.CanStylizeForTesting(WorkSheet, 0, 0));

			var cellStylizerFordocumentHeading = new SecondaryHeadingCellStylizer(stylizer);
			...
			var cellStylizerForPageNumberHeading = new SecondaryHeadingCellStylizer(stylizer);
			...
			var cellStylizerForPrimaryHeading = new SecondaryHeadingCellStylizer(stylizer);
			...
			var cellStylizerForPrimaryBody = new SecondaryHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForPrimaryBody.CanStylize", false, cellStylizerForPrimaryBody.CanStylizeForTesting(WorkSheet, 6, 3));

			var cellStylizerForSecondaryHeading = new SecondaryHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForSecondaryHeading.CanStylize", true, cellStylizerForSecondaryHeading.CanStylizeForTesting(WorkSheet, 8, 2));

			var cellStylizerForSecondaryBody = new SecondaryHeadingCellStylizer(stylizer);
		...
		public override void TestStylize()
		{
			...
			theme.SecondaryHeading.Color1 = Color.Red;
			theme.SecondaryHeading.Color2 = Color.Blue;
			theme.SecondaryHeading.Font = new Font("Courier New", 18, FontStyle.Bold | FontStyle.Italic);
			theme.SecondaryHeading.FontColor = Color.Green;

			var templateStylizer = new TemplateStylizer(WorkSheet.ParentExcelInterface, theme);
			var cellStylizer = new SecondaryHeadingCellStylizer(templateStylizer);
			var cellManager = templateStylizer.GetCellManager(WorkSheet, 8, 2);
