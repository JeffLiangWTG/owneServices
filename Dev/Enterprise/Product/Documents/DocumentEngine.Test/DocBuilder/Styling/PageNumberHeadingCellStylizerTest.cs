...
{
	sealed class PageNumberHeadingCellStylizerTest : CellStylizerTest<PageNumberHeadingCellStylizer>
	{
		public override void TestCanStylize()
		{
			...
			var cellStylizerForNormalCell = new PageNumberHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForNormalCell.CanStylize", false, cellStylizerForNormalCell.CanStylizeForTesting(WorkSheet, 0, 0));

			var cellStylizerFordocumentHeading = new PageNumberHeadingCellStylizer(stylizer);
			...
			var cellStylizerForPageNumberHeading = new PageNumberHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForPageNumberHeading.CanStylize", true, cellStylizerForPageNumberHeading.CanStylizeForTesting(WorkSheet, 4, 3));

			var cellStylizerForPrimaryHeading = new PageNumberHeadingCellStylizer(stylizer);
			...
			var cellStylizerForPrimaryBody = new PageNumberHeadingCellStylizer(stylizer);
			AssertEquals("cellStylizerForPrimaryBody.CanStylize", false, cellStylizerForPrimaryBody.CanStylizeForTesting(WorkSheet, 6, 3));

			var cellStylizerForSecondaryHeading = new PageNumberHeadingCellStylizer(stylizer);
			...
			var cellStylizerForSecondaryBody = new PageNumberHeadingCellStylizer(stylizer);
		...
		public override void TestStylize()
		{
			...
			theme.PageNumberHeading.Color1 = Color.Red;
			theme.PageNumberHeading.Color2 = Color.Blue;
			theme.PageNumberHeading.Font = new Font("Courier New", 18, FontStyle.Bold | FontStyle.Italic);
			theme.PageNumberHeading.FontColor = Color.Green;
			...
			var cellManager = templateStylizer.GetCellManager(WorkSheet, 4, 3);
