...
{
	sealed class GetMetricTargetRangeMinFunctionExtractorTest : Core.Testing.BaseFunctionExtractorTest
	{
		public void TestConstructor()
		{
			var extractor = GetMetricTargetRangeMinFunctionExtractor.ParseAndExtract("GetMetricTargetRangeMin(\"code\")");
