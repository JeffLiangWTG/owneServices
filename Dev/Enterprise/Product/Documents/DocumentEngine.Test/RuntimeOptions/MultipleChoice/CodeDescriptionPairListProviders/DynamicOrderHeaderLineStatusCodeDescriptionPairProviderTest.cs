...
{
	sealed class DynamicOrderHeaderLineStatusCodeDescriptionPairProviderTest : DynamicKeyedCodePairListProviderTest<ZGuid, DynamicOrderLineStatusCodeDescriptionPairProvider>
	{
		protected override void SetupDataForFirstKey(BusinessObjectFactory factory)
		{
			Client1.MiscServ.OrderLineStatusList = Client1ListBlob;
		}

		protected override void SetupDataForSecondKey(BusinessObjectFactory factory)
		{
			Client2.MiscServ.OrderLineStatusList = Client2ListBlob;
		}
		...
		protected override DynamicOrderLineStatusCodeDescriptionPairProvider GetListProvider()
		{
			return new DynamicOrderLineStatusCodeDescriptionPairProvider(Factory);
		}
		...
		CodeDescriptionPairList GetExpectedForClient(ReadOnlyCodeDescriptionPairList client)
		{
			...
			CodeDescriptionPairList list = listProvider.GetOrderLineStatusList();
		...
		ReadOnlyCodeDescriptionPairList GetClient1List()
		{
			...
			list.AddPair("PLC", "Client 1 Test1 (PLC) -- should override any system or registry settings");
