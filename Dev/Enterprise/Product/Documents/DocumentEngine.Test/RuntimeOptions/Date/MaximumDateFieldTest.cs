...
{
	[TestedType(typeof(MaximumDateField))]
	sealed class MaximumDateFieldTest : DateFieldTest
	{
		public void TestJsonConverter_MaximumDateField()
		{
			...
			var deserialisedField = JsonConverterHelper.Deserialize<MaximumDateField>(result);
		...
		public void TestWhereClause()
		{
			...
			AssertEquals("Param 1's value should be set", new DateTime(2003, 1, 26), Field.SqlParameters()[0].Value);
		}
