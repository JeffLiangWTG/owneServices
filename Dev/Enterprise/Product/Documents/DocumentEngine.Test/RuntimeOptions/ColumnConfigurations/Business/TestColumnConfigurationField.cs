...
namespace Enterprise.DocumentEngine.RuntimeOptions.Testing
{
	...
	sealed class TestColumnConfigurationField : FilterFieldTest
	{
		...
		{
			ColumnConfigurationField originalColumnConfigurationField = new ColumnConfigurationField(Factory);
			...
			ColumnConfigurationManager deserialisedManager = deserialisedColumnConfigurationField.Value;
		...
		{
			var serializedColumnConfigurationField =
				@"
				{
			...
			var deserialisedColumnConfigurationField = JsonConverterHelper.Deserialize<ColumnConfigurationField>(serializedColumnConfigurationField);
			ColumnConfigurationManager deserialisedManager = deserialisedColumnConfigurationField.Value;
