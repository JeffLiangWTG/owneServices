...
namespace Enterprise.DocumentEngine.GUI.RuntimeOptions.Testing
{
	...
	sealed class SchedulableDateTimeOffsetEditTest : ZFormBasherTest
	{
		[GuiTest]
		public void TestControlDoesntGetCutOffWhenYouGoToLongDate()
		{
			using (SchedulableDateTimeOffsetEdit control = new SchedulableDateTimeOffsetEdit())
			{
			...
			using (var control = new SchedulableDateTimeOffsetEdit())
			{
		...
		protected override Form GetFormToBashCore()
		{
			...
			var control = new SchedulableDateTimeOffsetEdit();
			control.ValueDateEdit_Exposed.DateTimeFormat = ZDateTimePickerFormat.Short;
