...
namespace Enterprise.DocumentEngine.GUI.RuntimeOptions.Testing
{
	...
	sealed class DateFieldUserControlFormBasherTest : ZFormBasherTest
	{
		public void TestSetFilter()
		{
			using (DateFieldUserControl control = new DateFieldUserControl())
			{
				DateField filter = new DateField(Factory);
		...
		protected override Form GetFormToBashCore()
		{
			...
			result.Controls.Add(new DateFieldUserControl());
			return result;
		}
	}
}
