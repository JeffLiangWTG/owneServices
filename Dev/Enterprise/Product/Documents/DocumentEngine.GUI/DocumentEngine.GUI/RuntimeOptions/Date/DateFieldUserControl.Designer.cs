...
{
	partial class DateFieldUserControl
	{
		/// <summary> 
		...
		{
            this.FieldDateEdit = new Enterprise.DocumentEngine.GUI.RuntimeOptions.SchedulableDateEdit();
            ...
            // BindingSource
            // 
            this.BindingSource.DataSourceType = typeof(Enterprise.DocumentEngine.RuntimeOptions.DateField);
            // 
            // FieldDateEdit
            // 
            ...
            this.Name = "DateFieldUserControl";
		...
		internal Enterprise.DocumentEngine.GUI.RuntimeOptions.SchedulableDateEdit FieldDateEdit;
	}
}
