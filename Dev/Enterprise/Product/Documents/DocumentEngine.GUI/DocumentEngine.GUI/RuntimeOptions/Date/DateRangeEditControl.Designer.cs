...
{
	partial class DateRangeEditControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
            ...
            this.FromDateEdit = new Enterprise.DocumentEngine.GUI.RuntimeOptions.SchedulableDateEdit();
            this.ToLabel = new Enterprise.ZArchitecture.ZLabel();
            this.ToDateEdit = new Enterprise.DocumentEngine.GUI.RuntimeOptions.SchedulableDateEdit();
            ...
            // FromLabel
            // 
            this.FromLabel.CaptionResourceString = Enterprise.DocumentEngine.GUI.Res.GetData("DateRangeFieldUserControl|e576fb7f-c061-463d-8d69-8440d39aee4c", "From");
            ...
            // ToLabel
            // 
            this.ToLabel.CaptionResourceString = Enterprise.DocumentEngine.GUI.Res.GetData("DateRangeFieldUserControl|855bb905-c365-4759-ba65-74408fa4ef5d", "To");
            ...
            this.Name = "DateRangeEditControl";
		...
		public SchedulableDateEdit FromDateEdit;
		public ZArchitecture.ZLabel ToLabel;
		public SchedulableDateEdit ToDateEdit;
	}
}
