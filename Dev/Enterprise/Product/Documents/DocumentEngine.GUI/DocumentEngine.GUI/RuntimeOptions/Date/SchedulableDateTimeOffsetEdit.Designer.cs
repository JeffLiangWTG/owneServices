...
{
	partial class SchedulableDateTimeOffsetEdit
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.ValueDateEdit = new ZDateTimeOffsetEditWithShortFormatAndLongBox();
			...
			// EditButton
			// 
			this.EditButton.CaptionResourceString = Enterprise.DocumentEngine.GUI.Res.GetData("SchedulableDateTimeOffsetEdit|d1962f5d-436f-4a9f-a224-da36556877a7", "Edit");
			...
			// 
			// SchedulableDateTimeOffsetEdit
			// 
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.ValueDateEdit);
			this.Controls.Add(this.EditButton);
			this.Name = "SchedulableDateTimeOffsetEdit";
		...
		internal ZDateTimeOffsetEditWithShortFormatAndLongBox ValueDateEdit;
	}
}
