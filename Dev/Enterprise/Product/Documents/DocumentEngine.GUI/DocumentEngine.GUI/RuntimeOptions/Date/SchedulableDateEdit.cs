...
{
	public partial class SchedulableDateEdit : ZUserControl, IBindTo
	{
		public SchedulableDateEdit()
		{
			InitializeComponent();
		}
		...
		internal class ZDateEditWithShortFormatAndLongBox : ZDateEdit
		{
		...
		#region Test
#if DEBUG
		internal ZDateEditWithShortFormatAndLongBox ValueDateEdit_Exposed
		{
