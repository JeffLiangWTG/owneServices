...
{
	[TestedType(typeof(DocumentUDFFieldPropertiesWrapperCollection))]
	sealed class DocumentUDFFieldPropertiesWrapperCollectionTest : GenericWrapperCollectionTest<DocumentUDFFieldPropertiesWrapperCollection>
	{
		...
		protected override DocumentUDFFieldPropertiesWrapperCollection GetNewDocumentWrapperCollection()
		{
			var collection = new DocumentUDFFieldPropertiesWrapperCollection(Factory);
			return collection;
		}
	}
}
