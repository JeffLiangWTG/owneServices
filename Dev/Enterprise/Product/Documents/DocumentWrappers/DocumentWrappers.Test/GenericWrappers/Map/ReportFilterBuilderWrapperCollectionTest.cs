...
{
	[TestedType(typeof(ReportFilterBuilderWrapperCollection))]
	sealed class ReportFilterBuilderWrapperCollectionTest : GenericWrapperCollectionTest<ReportFilterBuilderWrapperCollection>
	{
		...
		protected override ReportFilterBuilderWrapperCollection GetNewDocumentWrapperCollection()
		{
			var collection = new ReportFilterBuilderWrapperCollection(Factory);
			return collection;
		}
	}
}
