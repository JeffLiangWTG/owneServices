...
{
	[TestedType(typeof(ExportAgentOrganisationWrapper))]
	sealed class ExportAgentOrganisationWrapperTest : Base.Testing.GenericWrapperTest
	{
		public void TestCompanyNameWithSpaces()
		{
			var companyName = "SPACELY         SPROCKETS with more spacelys and less sprockets";
			OrgHeader organisation = OrgTestHelper.GetNewOrganisation("SPASPROC", companyName,
			...
			ExportAgentOrganisationWrapper wrapperFull = new ExportAgentOrganisationWrapper(OrganisationUsageType.ExportAgent, address, ContactType.FreightAgent, Factory);
			var companyNameAndAddress = "SPACELY SPROCKETS with more spacelys and less sprockets\n'Impressive Tower' Building\n344 red crayon road\nManlyvale Vic 2354\nAustralia";
			AssertMultilineASCIIEquals("wrapperFull.CompanyNameAndAddress", companyNameAndAddress.ToUpper(), wrapperFull.CompanyNameAndAddress);
		}
		...
		public void TestCompanyNameAndAddressBothWithAddress()
		{
			...
			ExportAgentOrganisationWrapper wrapper = new ExportAgentOrganisationWrapper(OrganisationUsageType.Test, header, ContactType.All, Factory);
...
";
		...
		{
			return new ExportAgentOrganisationWrapper(OrganisationUsageType.Test, (OrgHeader)null, ContactType.All, Factory);
		}
