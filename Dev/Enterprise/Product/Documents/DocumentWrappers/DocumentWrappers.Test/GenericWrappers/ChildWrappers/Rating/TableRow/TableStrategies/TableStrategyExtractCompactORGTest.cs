...
{
	sealed class TableStrategyExtractCompactORGTest : TableStrategyExtractBaseTest
	{
...
@"[Page 0]
  ...
  [Row 2]
    [Entry [Empty Service Level]-GEN-FCL AUSYD => USLAX, Contract Number: CONT3]
    [SubRow 0, '[Empty Currency]', '[Empty Charge]']
      [Split 20GP]
      [Column 'ODOC(AUD)' = '22.00']";
...
@"[Page 0]
  ...
  [Row 2]
    [Entry [Empty Service Level]-GEN-FCL AUSYD => USLAX, Frequency: 1 per Week]
    [SubRow 0, '[Empty Currency]', '[Empty Charge]']
      [Split 20GP]
      [Column 'ODOC(AUD)' = '22.00']";
...
[Row 0]
  ...
  [SubRow 0, '[Empty Currency]', '[Empty Charge]']
    [Split 20GP]
    [Column 'ODOC(AUD)' = '11.00']

[Row 1]
  [Entry [Empty Service Level]-GEN-FCL AUSYD => USLAX, Contract Number: CONTRACT1]
  [SubRow 0, '[Empty Currency]', '[Empty Charge]']
    [Split 40GP]
    [Column 'ODOC(AUD)' = '12.00']
...
[Row 3]
  ...
  [SubRow 0, '[Empty Currency]', '[Empty Charge]']
    [Split 20GP]
    [Column 'ODOC(AUD)' = '31.00']

[Row 4]
  [Entry [Empty Service Level]-GEN-FCL AUSYD => USLAX, Contract Number: CONTRACT3]
  [SubRow 0, '[Empty Currency]', '[Empty Charge]']
    [Split 40GP]
    [Column 'ODOC(AUD)' = '32.00']
";
...
";
		...
		protected override string Category => RatingConstants.RateCategory.ORG;
		protected override string Mode => Core.Constants.RateMode.FCL;
		protected override string ChargeCode => "ODOC";

		protected override BaseTableStrategy Strategy => strategy ?? (strategy = new CompactTableStrategy(Factory, new PricingPageRateLineFactory(EntryTypes.Origin)));
