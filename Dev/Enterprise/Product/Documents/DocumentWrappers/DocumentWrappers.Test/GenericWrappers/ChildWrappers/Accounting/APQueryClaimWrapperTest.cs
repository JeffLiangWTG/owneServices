...
namespace Enterprise.DocumentWrappers.GenericWrappers.Testing
{
	...
	sealed class APQueryClaimWrapperTest : QueryClaimWrapperTest
	{
		public override void TestAccountType()
		{
			QueryClaimWrapper wrapper = (QueryClaimWrapper)GetNewDocumentWrapper();
			AssertEquals("CREDITOR", wrapper.AccountType);
		}

		protected override GenericWrapper GetSetupWrapperForDefaultFormatting()
		{
			return new QueryClaimWrapper(Factory.New<APAccQueryClaim>(), Factory);
		}
		...
		{
			APAccQueryClaim queryClaim = Factory.New<APAccQueryClaim>();
