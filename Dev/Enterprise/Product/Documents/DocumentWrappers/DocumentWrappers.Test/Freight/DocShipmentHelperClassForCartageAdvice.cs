...
{
	#region DocShipmentHelperClassForCartageAdvice

	internal class DocShipmentHelperClassForCartageAdvice : DocShipment
	{
		public DocShipmentHelperClassForCartageAdvice(CommonShipment shipment, BusinessObjectFactory factoryToWrap)
		...
		public override DocDocAddress PickUpFromAddressForExport
		{
			get { return DocDocAddress.New(Header.Addresses[0], Factory); }
		}

		public override DocDocAddress PickUpFromAddressForImport
		{
			get { return DocDocAddress.New(Header.Addresses[0], Factory); }
		}

		public override DocDocAddress DeliverToAddressForExport
		{
			get { return DocDocAddress.New(Header.Addresses[0], Factory); }
		}

		public override DocDocAddress DeliverToAddressForImport
		{
			get { return DocDocAddress.New(Header.Addresses[0], Factory); }
		}
		...
		public override DocDocAddress JourneyTwoPickUpAddressForExport
		{
			get
			{
				...
				{
					fJourneyTwoPickUpAddressForExport = DocDocAddress.New(Header.Addresses[0], Factory);
				}
