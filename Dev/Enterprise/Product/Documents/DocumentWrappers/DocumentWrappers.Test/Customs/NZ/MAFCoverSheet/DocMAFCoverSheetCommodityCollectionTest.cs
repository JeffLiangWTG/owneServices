...
{
	[TestedType(typeof(DocMAFCoverSheetCommodityCollection))]
	sealed class DocMAFCoverSheetCommodityCollectionTest : DocBaseWrapperCollectionTest<DocMAFCoverSheetCommodityCollection>
	{
		protected override DocMAFCoverSheetCommodityCollection GetNewDocumentWrapperCollection()
		{
			AssertEquals("ZOMG A COMMODITY", Commodity.D1_CommodityOrSpecies);
			return new DocMAFCoverSheetCommodityCollection(CoverSheet.Commodities, 1, 5);
		}
