...
{
	internal class SettlementGroupCollectionProvider : CollectionProvider
	{
		public SettlementGroupCollectionProvider(BusinessObjectFactory businessObjectFactory)
