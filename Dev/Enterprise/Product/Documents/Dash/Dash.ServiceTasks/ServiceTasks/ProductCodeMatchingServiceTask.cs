...
[assembly: HostedService(
	WTG.Shared.Dash.Common.Constants.DataProcessingType.Code.ProductCodeMatching,
	"Document Ingestion Product Matching Service Task",
	"DOC",
	typeof(ProductCodeMatchingServiceTask),
...
{
	public class ProductCodeMatchingServiceTask : DashMessageProcessingTask
	{
		public ProductCodeMatchingServiceTask()
		{
		}

		public ProductCodeMatchingServiceTask(ProductCodeMatchingMessageProcessor dashMessageProcessor)
		{
		...
		protected override DashMessageProcessor DashMessageProcessor
		{
			get
			{
				dashMessageProcessor ??= new ProductCodeMatchingMessageProcessor(
