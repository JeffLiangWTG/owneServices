...
{
	[TestedType(typeof(DashOrgCandidateName))]
	sealed class DashOrgCandidateNameTest : EnterpriseBusinessObjectTestCase
	{
		...
		protected override BusinessObject GetNewBusinessObject()
		{
			...
			var dashOrgCandidateName = helpers.CreateDashOrgCandidateName(dashOrgCandidate.PK, "Acme Shipping");
