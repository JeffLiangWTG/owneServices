...
{
	public class DocumentParsingTokenManagerForTest : DocumentParsingTokenManager
	{
		...
		public DocumentParsingTokenManagerForTest()
		{
		}
...
#pragma warning restore CS0618 // To be replaced with S2ST library once WI00771920 is implemented
		...
		//public override bool ValidateCachedToken(ISystemToSystemTrustInfo systemToSystemTrustInfo) => shouldClearCachedToken || base.ValidateCachedToken(systemToSystemTrustInfo);
