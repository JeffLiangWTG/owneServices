...
{
	[TestedType(typeof(OrganizationMatchingServiceTask))]
	public class OrganizationMatchingServiceTaskTest : ServiceTaskTestCase<OrganizationMatchingServiceTask>
	{
		...
		public void Test_RunTask_Calls_DashMessageProcessor()
		{
			using (DocManagerRegistry.Instance.EnableCommercialInvoiceDocumentParsing.SetTemporaryValue(Guid.Empty, Guid.Empty, Guid.Empty, true))
			{
				...
				var messageProcessor = new OrganizationMatchingMessageProcessor(factoryMock.Object, loggerMock.Object, dashGlowService.Object, shipamaxService.Object, dashErrorReporter.Object);
				var dashMessageProcessorTask = new OrganizationMatchingServiceTask(messageProcessor);
