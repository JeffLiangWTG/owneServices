...
namespace Enterprise.ArchiveManager.Test.StageDescriptors.OPS
{
	class OPSArchiveStageDescriptorTest : JobHeaderArchiveStageDescriptorTest
	{
		protected override IArchiveStageDescriptor StageDescriptor => new OPSArchiveStageDescriptor();

		protected override IArchiveSystemDescriptor SystemDescriptor => new OPSArchiveSystemDescriptor();

		protected override string ExpectedName
			=> "Operational Jobs Archive";
		...
		{
			var archiveStage = new OPSArchiveStageDescriptor();
