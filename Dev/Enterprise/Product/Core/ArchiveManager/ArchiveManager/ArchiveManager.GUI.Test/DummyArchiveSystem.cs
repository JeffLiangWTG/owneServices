...
{
	sealed class DummyArchiveSystem : IArchiveSystemDescriptor
	{
		...
		public MultilingualString Name => ResString.GetMultilingualString("C881A919-C7BD-4ECC-8EC4-C35BCBE9C352", "Dummy Archive System");
