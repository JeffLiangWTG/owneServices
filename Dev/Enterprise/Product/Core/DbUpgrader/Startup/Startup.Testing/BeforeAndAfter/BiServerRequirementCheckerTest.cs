...
{
	sealed class BiServerRequirementCheckerTest : TransactionedTestCase
	{
		[ExpectNoExceptions()]
		public void TestCheckServicePackVersions()
		{
			var testChecker = new BiServerRequirementCheckerForTest();
		...
		public void TestDatabaseCollation()
		{
			...
			new BiServerRequirementCheckerForTest().FixDbCollations_Exposed(TestConnection);
