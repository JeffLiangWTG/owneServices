...
{
	public partial class ChargeLine : ISettableWriterStrategy
	{
		...
		public bool SetCostRatingBasisCollection(Func<List<RatingBasis>> value)
		{
			if (IsAllowSet(nameof(CostRatingBasisCollection)))
			{
				CostRatingBasisCollection = value();
				return true;
			}
			else
			{
		...
		public bool SetSellRatingBasisCollection(Func<List<RatingBasis>> value)
		{
			if (IsAllowSet(nameof(SellRatingBasisCollection)))
			{
				SellRatingBasisCollection = value();
				return true;
			}
			else
			{
