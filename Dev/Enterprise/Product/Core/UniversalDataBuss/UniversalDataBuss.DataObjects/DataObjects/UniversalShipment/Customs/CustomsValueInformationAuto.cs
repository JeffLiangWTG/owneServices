...
{
	public partial class CustomsValueInformation : ISettableWriterStrategy
	{
		...
		public bool SetCustomsValueDetailCollection(Func<List<CustomsValueDetail>> value)
		{
			if (IsAllowSet(nameof(CustomsValueDetailCollection)))
			{
				CustomsValueDetailCollection = value();
				return true;
			}
			else
			{
