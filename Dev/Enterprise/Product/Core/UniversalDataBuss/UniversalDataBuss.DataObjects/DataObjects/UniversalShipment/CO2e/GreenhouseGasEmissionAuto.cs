...
{
	public partial class GreenhouseGasEmission : ISettableWriterStrategy
	{
		...
		public bool SetGreenhouseGasCollection(Func<List<GreenhouseGas>> value)
		{
			if (IsAllowSet(nameof(GreenhouseGasCollection)))
			{
				GreenhouseGasCollection = value();
				return true;
			}
			else
			{
