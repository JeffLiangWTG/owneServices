...
{
	public partial class Workflow : ISettableWriterStrategy
	{
		...
		public bool SetRecipientRoleCollection(Func<List<RecipientRole>> value)
		{
			if (IsAllowSet(nameof(RecipientRoleCollection)))
			{
				RecipientRoleCollection = value();
				return true;
			}
			else
			{
