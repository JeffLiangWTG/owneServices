...
{
	public partial class Context : ISettableWriterStrategy
	{
		...
		public bool SetSubContextCollection(Func<List<Context>> value)
		{
			if (IsAllowSet(nameof(SubContextCollection)))
			{
				SubContextCollection = value();
				return true;
			}
			else
			{
