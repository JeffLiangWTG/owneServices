...
{
	public partial class ImportMetaData : ISettableWriterStrategy
	{
		...
		public bool SetMatchingCriteriaCollection(Func<List<MatchingCriteria>> value)
		{
			if (IsAllowSet(nameof(MatchingCriteriaCollection)))
			{
				MatchingCriteriaCollection = value();
				return true;
			}
			else
			{
