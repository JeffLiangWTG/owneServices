...
{
	public class DataFileForTest : EmbeddedDataFile
	{
		public DataFileForTest()
				: base(FilePathHelperTest.TestDataFilePath, "StmMenuTemplatePivot", "StmTemplate", "StmMenuItem")
		{
		}
