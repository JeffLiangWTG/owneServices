...
{
	[Serializable]
	class MockEventSubscriber : LogSubscriber
	{
		public MockEventSubscriber(string name, string[] eventTypes, string[] tableNames)
			: base()
		{
			this.name = name;
		...
		public MockEventSubscriber(string name)
		...
		public static StmJobQueue QueueNewLogForTestSubscriber(BusinessObjectFactory factory)
		{
			...
			return QueueNewLogForGivenSubscriber(factory, MockEventSubscriber.TestSubscriberName, evt);
		}
		...
		public static StmJobQueue QueueNewLogForGivenSubscriber(BusinessObjectFactory factory, string subscriberName, BusinessObject parent)
		{
			...
			log.SJ_SE_NKEvent = MockEventSubscriber.TestEventType;
			return log;
		}
		...
		public static StmALog CreateNewLog(BusinessObjectFactory factory, ZString eventCode, BusinessObject parent)
		{
			...
			using (log.LockForUpdatingKeyFieldsForTesting())
			{
				...
				log.SL_EventTimeUtc = ZDateTime.MinSmallDateTimeValue;
