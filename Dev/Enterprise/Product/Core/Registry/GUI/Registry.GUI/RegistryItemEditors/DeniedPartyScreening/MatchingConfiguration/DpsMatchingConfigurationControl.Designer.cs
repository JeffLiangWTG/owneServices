...
{
	partial class DpsMatchingConfigurationControl
	{
		/// <summary> 
		...
		void InitializeComponent()
		{
			...
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.Registry.Business.DpsMatchingConfigurationBusinessObject);
			// 
			// StrictRadioButton
			// 
			...
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Registry.Business.DpsMatchingConfigurationBusinessObject)(null)).StrictRadioButtonSelection)));
			this.StrictRadioButton.CaptionResourceString = Enterprise.Registry.GUI.Res.GetData("db201ab7-4b98-4dbe-997b-6915d8a74633", "Strict - This setting uses close to exact matching to find potential matched. There is a limited number of false positives but with an increased risk of false negatives.");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Registry.Business.DpsMatchingConfigurationBusinessObject)(null)).BalancedRadioButtonSelection)));
			this.BalancedRadioButton.CaptionResourceString = Enterprise.Registry.GUI.Res.GetData("6a34abf2-622f-44d1-9dfb-08fe2e1272b4", "Balanced - This setting uses limited fuzzy matching to find potential matches. There is a reduced risk of false negatives but returns more false positives.");
			...
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.Registry.Business.DpsMatchingConfigurationBusinessObject)(null)).ComprehensiveRadioButtonSelection)));
			this.ComprehensiveRadioButton.CaptionResourceString = Enterprise.Registry.GUI.Res.GetData("1412a988-cf5a-4100-a0d7-5c1cb30a386f", "Comprehensive - This setting uses broad matching criteria to find potential matches. This greatly reduces the potential for false negatives while returning a much larger number of false positives.");
			...
			this.Name = "DpsMatchingConfigurationControl";
