...
namespace Enterprise.Registry.GUI
{
	public partial class QuoteValidityControl : ZUserControl
	{
		...
		public
#endif
		Enterprise.ZArchitecture.GUI.ZCheckBox BlankValueCheckbox;
		...
		void InitializeComponent()
		{
			...
			this.BlankValueCheckbox = new Enterprise.ZArchitecture.GUI.ZCheckBox();
			...
			this.RateValidityCalcEdit.TabIndex = 1;
			this.RateValidityCalcEdit.Text = "0";
			this.RateValidityCalcEdit.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// BlankCheckbox
			// 
			this.BlankValueCheckbox.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.BlankValueCheckbox.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(0, 64, true);
			this.BlankValueCheckbox.Name = "BlankCheckbox";
			this.BlankValueCheckbox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(168, 24, true);
			this.BlankValueCheckbox.TabIndex = 3;
			this.BlankValueCheckbox.CaptionResourceString = Res.GetData("e165dde2-f76c-469d-9486-3ee343d50a27", "Leave Blank");
			this.BlankValueCheckbox.CheckedChanged += new System.EventHandler(this.BlankCheckbox_CheckedChanged);
			// 
			// RateValidityControl
			// 
			this.Controls.Add(this.BlankValueCheckbox);
