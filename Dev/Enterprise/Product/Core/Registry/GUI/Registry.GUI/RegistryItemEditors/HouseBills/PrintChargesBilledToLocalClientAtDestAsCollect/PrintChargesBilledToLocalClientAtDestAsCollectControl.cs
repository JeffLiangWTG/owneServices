...
{
	sealed partial class PrintChargesBilledToLocalClientAtDestAsCollectControl : RegistryZUserControl
	{
		public PrintChargesBilledToLocalClientAtDestAsCollectControl()
		{
			InitializeComponent();
		}
