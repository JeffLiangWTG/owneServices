...
{
	[TestedType(typeof(CargoImpVersionRegistryItemEditor))]
	sealed class CargoImpVersionRegistryItemEditorTest : RegistryItemEditorTestCase
	{
		protected override RegistryItemEditor GetEditor()
		{
			return new CargoImpVersionRegistryItemEditor(RegistryItem.DataType, new FallbackLevel(GlbCompany.CurrentCompany.PK.ToGuid(), Guid.Empty, Guid.Empty), null);
		}

		protected override bool GetEditorPaneEnabledState(Control editorPane)
		{
			return !((CargoImpVersionControl)editorPane).ReadOnly;
		}

		protected override Type GetExpectedEditorPaneType()
		{
			return typeof(CargoImpVersionControl);
		}
		...
		{
			return new object[] { new CargoImpVersionConfiguration() };
		}
