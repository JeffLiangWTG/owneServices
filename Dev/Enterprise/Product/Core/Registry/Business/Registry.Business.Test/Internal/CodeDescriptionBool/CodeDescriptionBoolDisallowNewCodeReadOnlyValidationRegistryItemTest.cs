...
{
	[TestedType(typeof(CodeDescriptionBoolDisallowNewCodeReadOnlyValidationRegistryItem))]
	sealed class CodeDescriptionBoolDisallowNewCodeReadOnlyValidationRegistryItemTest : StronglyTypedRegistryItemTestCase<CodeDescriptionBoolCollection, CodeDescriptionBoolCollection>
	{
		public void TestConstructor()
		{
			var item = new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationRegistryItem("Name", (NoResString)"Category", (NoResString)"Caption", (NoResString)"Hint",
				RegistryStorageFlags.System, new CodeDescriptionBoolRegistryEditorInfo((NoResString)"Bool"), new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationCollection(DataRegistry.Instance.OrgStaffMemberAssignmentRoles));
			...
			var expectedDefaultValue = new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationCollection(DataRegistry.Instance.OrgStaffMemberAssignmentRoles);

			var defaultValue = (CodeDescriptionBoolDisallowNewCodeReadOnlyValidationCollection)item.DefaultValue;
		...
		public void TestGetCaptionsInEnglish()
		{
			using (var chsMockData = Res.GetLanguageInstance(Core.SharedConstants.Languages.ChineseSimplified).UseMockData())
			{
				...
				var list = new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationCollection
				{
					codeDescriptionBoolDisallowNew1,
					codeDescriptionBoolDisallowNew2
				};
				var registryItem = new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationRegistryItem("Name", (NoResString)"Category",
		...
		protected override StronglyTypedRegistryItem<CodeDescriptionBoolCollection, CodeDescriptionBoolCollection> GetNewRegistryItem() =>
			new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationRegistryItem("", null, null, null, RegistryStorageFlags.System, new CodeDescriptionBoolRegistryEditorInfo((NoResString)""), new CodeDescriptionBoolDisallowNewCodeReadOnlyValidationCollection(DataRegistry.Instance.OrgStaffMemberAssignmentRoles));
	}
}
