...
{
	[TestedType(typeof(CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString))]
	sealed class CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraStringTest : CodeDescriptionBoolDisallowNewTest
	{
		protected override void AssertCloneValues(RegistryBusinessObject clone1)
		{
			var clone = clone1 as CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString;
		...
		{
			var result = (CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString)GetNewBusinessObject();
		...
		{
			var item = (CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString)GetNewBusinessObject();
			item.Code = "C01";
			...
			item = (CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString)GetNewBusinessObject();
			item.Code = "SEL";
		...
		protected override void CheckAllPropertiesAreEqual(RegistryBusinessObjectTemplate originalBusinessObject, RegistryBusinessObjectTemplate newBusinessObject, bool isClone)
		{
			...
			AssertEquals("SystemDefined", ((CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString)originalBusinessObject).SystemDefined, ((CodeDescriptionBoolDisallowNewCodeReadOnlyWithExtraString)newBusinessObject).SystemDefined);
		}
