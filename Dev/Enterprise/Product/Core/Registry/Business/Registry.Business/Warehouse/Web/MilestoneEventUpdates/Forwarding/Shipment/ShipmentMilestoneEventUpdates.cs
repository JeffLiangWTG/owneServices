...
namespace Enterprise.Registry.Business
{
	...
	public class ShipmentMilestoneEventUpdates : MilestoneEventUpdates
	{
		#region Schema
		...
		public ShipmentMilestoneEventUpdates() : base() { }

		public ShipmentMilestoneEventUpdates(ZString eventType)
			: base(eventType)
		{
		}
		...
		public new ShipmentMilestoneEventUpdatesCollection Parent
		{
			get
			{
				return (ShipmentMilestoneEventUpdatesCollection)base.Parent;
			}
		}
