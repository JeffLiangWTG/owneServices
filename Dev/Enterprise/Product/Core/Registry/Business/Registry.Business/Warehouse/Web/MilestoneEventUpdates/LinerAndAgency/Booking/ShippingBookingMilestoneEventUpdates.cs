...
namespace Enterprise.Registry.Business
{
	...
	public class ShippingBookingMilestoneEventUpdates : MilestoneEventUpdates
	{
		#region Schema
		...
		public ShippingBookingMilestoneEventUpdates() : base() { }

		public ShippingBookingMilestoneEventUpdates(ZString eventType)
			: base(eventType)
		{
		}
