...
{
	internal sealed class ShippingOutstandingInvoiceAndCreditNoteIntegrationTest : TransactionedTestCase
	{
		[TestDate(2020, 01, 01)]
		public void TestShippingOutstandingInvoiceAndCreditNote_TotalLocal()
		{
			...
			var sqlQuery = $"select * from ShippingOutstandingInvoiceAndCreditNote('{companyPK}', 'AR', '2020-02-01', null, null, null, null, null, null, 'ALL', null, null, null, null, null, null, null, GETDATE()) order by TransactionNum";
