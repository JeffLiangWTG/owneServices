...
{
	class LegacyStatisticsServiceSummariseIntegrationTest : TransactionedTestCase
	{
		public void TestTopRowCount()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.001m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "2.2.2.2", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.001m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "3.3.3.3", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.001m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "4.4.4.4", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.001m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "5.5.5.5", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.001m);

			var expectedTableCounts = StatisticsTestHelper.FormatTableCounts(5, 5, 5, 0, 0, 0, 0);
			AssertEquals("Precondition", expectedTableCounts, StatisticsTestHelper.SelectTableCounts());

			var performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 2, performed);

			expectedTableCounts = StatisticsTestHelper.FormatTableCounts(5, 5, 3, 1, 2, 1, 2);
			AssertEquals("Should create statistics", expectedTableCounts, StatisticsTestHelper.SelectTableCounts());

			performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 2, performed);

			expectedTableCounts = StatisticsTestHelper.FormatTableCounts(5, 5, 1, 1, 4, 1, 4);
			AssertEquals("Should create statistics", expectedTableCounts, StatisticsTestHelper.SelectTableCounts());

			performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 1, performed);

			expectedTableCounts = StatisticsTestHelper.FormatTableCounts(5, 5, 0, 1, 5, 1, 5);
			AssertEquals("Should create statistics", expectedTableCounts, StatisticsTestHelper.SelectTableCounts());

			performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 0, performed);
			AssertEquals("Nothing to create", StatisticsTestHelper.FormatTableCounts(5, 5, 0, 1, 5, 1, 5), StatisticsTestHelper.SelectTableCounts());
		}
		...
		public void TestGroupByPeriod()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(from, to_1.AddMilliseconds(100), "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(from.AddHours(1), to_1.AddMilliseconds(200), "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(from, to_2.AddSeconds(1), "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(from, to_2.AddSeconds(2), "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(from, to_3.AddSeconds(10), "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);

			AssertEquals("Precondition", StatisticsTestHelper.FormatTableCounts(5, 5, 5, 0, 0, 0, 0), StatisticsTestHelper.SelectTableCounts());

			var performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 5, performed);
			AssertEquals("Should create statistics", StatisticsTestHelper.FormatTableCounts(5, 5, 0, 3, 1, 1, 3), StatisticsTestHelper.SelectTableCounts());
			...
			performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 0, performed);
			AssertEquals("Nothing to create", StatisticsTestHelper.FormatTableCounts(5, 5, 0, 3, 1, 1, 3), StatisticsTestHelper.SelectTableCounts());
		}
		...
		public void TestGroupByVersion()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "3.3.3.3", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "2.2.2.2", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "2.2.2.2", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1", 1, 0.002m);

			AssertEquals("Precondition", StatisticsTestHelper.FormatTableCounts(6, 6, 6, 0, 0, 0, 0), StatisticsTestHelper.SelectTableCounts());

			var performed = StatisticsTestHelper.ExecLegacyStatisticsServiceSummarise(topRowCount);
			AssertEquals("Number of performed rows", 6, performed);

			AssertEquals("Should create statistics", StatisticsTestHelper.FormatTableCounts(6, 6, 0, 1, 3, 1, 3), StatisticsTestHelper.SelectTableCounts());
		...
		public void TestGroupByCompanyCode()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_2", "B_2", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_2", "B_2", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			...
			AssertEquals("Should create statistics", StatisticsTestHelper.FormatTableCounts(5, 5, 0, 1, 1, 1, 2), StatisticsTestHelper.SelectTableCounts());
		...
		public void TestGroupByBranchCode()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_2", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_2", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
		...
		public void TestGroupByStaffCode()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "F", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "F", "Name 1", "SubName 1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "C_1", "B_1", "E", "Name 1", "SubName 1", 1, 0.002m);
		...
		public void TestGroupByActionKey()
		{
			...
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1.1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1.2", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 2", "SubName 2.1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 2", "SubName 2.1", 1, 0.002m);
			StatisticsTestHelper.SetLegacyUserData(now, now, "1.1.1.1", "EDI", "BNE", "E", "Name 1", "SubName 1.1", 1, 0.002m);
			...
			AssertEquals("Should create statistics", StatisticsTestHelper.FormatTableCounts(5, 5, 0, 1, 1, 3, 3), StatisticsTestHelper.SelectTableCounts());
