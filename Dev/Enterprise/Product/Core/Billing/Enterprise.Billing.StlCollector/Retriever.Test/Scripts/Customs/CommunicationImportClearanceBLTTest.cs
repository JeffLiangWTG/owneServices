...
{
	[TestedType(typeof(CommunicationImportClearanceBLT))]
	sealed class CommunicationImportClearanceBLTTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			var sqlText = $@"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ApplicationCode, JE_ClusterKey) VALUES
					...
					('{JE2}', 'IE', 'DEC19', 'IMP', @GbPkIe, @GcPkIe, '2010-02-27', 'US0', 'V2', 19);
				...
				INSERT dbo.JobHeader (JH_PK, JH_GC, JH_ParentID, JH_JobNum, JH_SystemCreateTimeUtc, JH_GB, JH_GE, JH_SystemCreateUser, JH_Status, JH_IsDisbursement) VALUES
					('{JH1}', @GcPkIe, @IEJePk01, 'JE01', '2010-02-02', @GbPkIe, @GePk, 'US1', 'WRK', 1),
					('{JH2}', @GcPkIe, '{JE2}', 'JE02', '2010-02-02', @GbPkIe, @GePk, 'US2', 'WRK', 0);
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			CombineAssertions(() =>
			{
				...
				AssertRowMatchingRef1AndRef2(transactions, "18", "IEN", "IEB", new DateTime(2010, 2, 27), "US0", 1, "DEC18", null, "IE", transactionReference04: JH1.ToString().ToUpper());
				AssertRowMatchingRef1(transactions, "19", "IEN", "IEB", new DateTime(2010, 2, 27), "US0", 1, "DEC19", null, "IE");
				AssertRowMatchingRef1AndRef2(transactions, "20", "IEN", "IEB", new DateTime(2010, 2, 28), "US0", 1, "DEC18", "BGM Reference IE2", "IE", transactionReference04: JH1.ToString().ToUpper());
			});
		}
