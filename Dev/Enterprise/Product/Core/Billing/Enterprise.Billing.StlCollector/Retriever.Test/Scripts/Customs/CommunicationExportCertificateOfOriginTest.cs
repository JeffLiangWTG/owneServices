...
{
	[TestedType(typeof(CommunicationExportCertificateOfOrigin))]
	sealed class CommunicationExportCertificateOfOriginTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = $@"
				...
				(newid(), @GcPkSg, @JsPk, 'SHP01', '2014-03-10', @GbPkSg, @GePk, 'US1', 'WRK', 1);
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey, JE_JS) VALUES
					(@JePk, 'SG', 'DEC01', 'COO', @GbPkSg, @GcPkSg, '2014-03-10', 'US1', 1, null),
					(@JePk2, 'SG', 'DEC01X', 'COO', @GbPkSg, @GcPkSg, '2014-03-11', 'US1', 5, @JsPK),
					(newid(), 'AU', 'DEC02', 'COO', @GbPkAu, @GcPkAu, '2014-03-01', 'US2', 2, null),
					(newid(), 'SG', 'DEC03', 'COO', @GbPkSg, @GcPkSg, '2014-04-01', 'US3', 3, null),
