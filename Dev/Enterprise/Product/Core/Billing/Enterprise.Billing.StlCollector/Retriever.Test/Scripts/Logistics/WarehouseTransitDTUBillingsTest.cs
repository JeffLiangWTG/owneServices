...
{
	[TestedType(typeof(WarehouseTransitDTUBillings))]
	sealed class WarehouseTransitDTUBillingsTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			var dtu1 = new WhsItemDispatchTransportationUnit(whs1, "DTU1").InsertAndReturnObject(TestConnection);
			var dtu2 = new WhsItemDispatchTransportationUnit(whs1, "DTU2").InsertAndReturnObject(TestConnection);
			var dtu3 = new WhsItemDispatchTransportationUnit(whs1, "DTU3").InsertAndReturnObject(TestConnection);
			var dtu4 = new WhsItemReceiveTransportationUnit(whs1, "DTU4", location1, "VEH4").InsertAndReturnObject(TestConnection);

			var jobHeader1 = new JobHeader("WRK", branch.PK, department.PK, company.PK, dtu1.PK, "WDH") { JH_JobNum = "dtu1", JH_SystemCreateTimeUtc = TestDateTimeRange.StartDateTimeInclusive }
				.InsertAndReturnObject(TestConnection);
			var jobHeader2 = new JobHeader("WRK", branch.PK, department.PK, company.PK, dtu2.PK, "WDH") { JH_JobNum = "dtu2", JH_SystemCreateTimeUtc = TestDateTimeRange.StartDateTimeInclusive.AddDays(15) }
				.InsertAndReturnObject(TestConnection);
			var jobHeader3 = new JobHeader("WRK", branch.PK, department.PK, company.PK, dtu3.PK, "WDH") { JH_JobNum = "dtu3", JH_SystemCreateTimeUtc = TestDateTimeRange.StartDateTimeInclusive.AddDays(27) }
				.InsertAndReturnObject(TestConnection);
			var jobHeaderOld = new JobHeader("WRK", branch.PK, department.PK, company.PK, dtu4.PK, "WDH") { JH_JobNum = "dtu4", JH_SystemCreateTimeUtc = TestDateTimeRange.StartDateTimeInclusive.AddMonths(-1) }
				.InsertAndReturnObject(TestConnection);
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertRow(transactions, 0, "DEM", "DEM", "GDS", 1, "WH1", "DTU1", "dtu1", "1", jobCharge1Pk, transaction1Date, additionalRefs1);

			var additionalRefs2 = "{" + "\"ChargeCode\":\"FRT\",\"ChargeDesc\":\"description - 2\",\"ChargeGroup\":\"TWH\",\"ChargeSubGroup\":\"QUP\"" + "}";
			AssertRow(transactions, 1, "DEM", "DEM", "GDS", 1, "WH1", "DTU2", "dtu2", "1", jobCharge2Pk, transaction2Date, additionalRefs2);

			var additionalRefs3 = "{" + "\"ChargeCode\":\"FRT\",\"ChargeDesc\":\"description - 3\",\"ChargeGroup\":\"TWH\",\"ChargeSubGroup\":\"QUP\"" + "}";
			AssertRow(transactions, 2, "DEM", "DEM", "GDS", 1, "WH1", "DTU3", "dtu3", "0", jobCharge3Pk, transaction3Date, additionalRefs3);
		}
