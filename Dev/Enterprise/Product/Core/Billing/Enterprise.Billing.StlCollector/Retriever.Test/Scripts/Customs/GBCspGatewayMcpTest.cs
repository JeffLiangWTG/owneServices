...
{
	[TestedType(typeof(GBCspGatewayMcpDeclarations))]
	sealed class GBCspGatewayMcpDeclarationsTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_AddInfo, JE_DeclarationReference, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey, JE_MessageType) VALUES
					(newid(), 'GB', 'Gateway=MCP', 'DEC01', @GbPkGb, @GcPkGb, '2014-03-10', 'US1', 1, 'IMP'),
					(newid(), 'AU', 'Gateway=MCP', 'DEC02', @GbPkAu, @GcPkAu, '2014-03-10', 'US2', 2, 'IMP'),
					(newid(), 'GB', 'Gateway=MCP', 'DEC03', @GbPkGb, @GcPkGb, '2014-04-10', 'US3', 3, 'IMP'),
