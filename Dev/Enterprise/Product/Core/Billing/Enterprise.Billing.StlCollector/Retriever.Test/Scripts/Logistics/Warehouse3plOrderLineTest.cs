...
{
	[TestedType(typeof(Warehouse3plOrderLine))]
	sealed class Warehouse3plOrderLineTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			var parentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U13", "DEP", 12, 1);
			var componentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U13", "DEP", 12, 2, parentLine: parentLine);
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction7 = FindRowByRef2(transactions, "#13.1");
			...
			AssertEquals("[T7] UserCode", "U14", transaction7.ClientStaffCode);
			...
			AssertEquals("[T7] TransactionReference03", "WD13", transaction7.Reference3);

			var transaction8 = FindRowByRef2(transactions, "#13.2");
