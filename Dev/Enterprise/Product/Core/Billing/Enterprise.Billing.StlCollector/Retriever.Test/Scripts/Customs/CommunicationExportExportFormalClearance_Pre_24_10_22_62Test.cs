...
{
	[TestedType(typeof(CommunicationExportExportFormalClearance_Pre_24_10_22_62))]
	sealed class CommunicationExportExportFormalClearance_Pre_24_10_22_62Test : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_TransportMode, JE_ApplicationCode, JE_ClusterKey) VALUES
					(newid(), 'US', 'DEC09US', 'EXP', @GbPkUS, @GcPkUS, '2014-02-11', 'US1', 'SEA', '', 9),
					(newid(), 'PR', 'DEC10PR', 'EXP', @GbPkPR, @GcPkPR, '2014-02-11', 'PR1', 'SEA', '', 10),
					(newid(), 'GB', 'DEC11GB', 'EXP', @GbPkGB, @GcPkGB, '2014-02-11', 'GB1', 'SEA', '', 11),
					(newid(), 'CA', 'DEC12CA', 'EXP', @GbPkCA, @GcPkCA, '2014-02-11', 'CA1', 'SEA', '', 12),
					(newid(), 'DE', 'DEC13DE', 'EXP', @GbPkDE, @GcPkDE, '2014-02-11', 'DE1', 'SEA', '', 13),
					(newid(), 'DE', 'DEC14DE', 'IMP', @GbPkDE, @GcPkDE, '2014-02-11', 'DE2', 'SEA', 'BLT', 14),
					(newid(), 'DE', 'DEC15DE', 'EXP', @GbPkDE, @GcPkDE, '2014-02-11', 'DE3', 'SEA', 'BLT', 15),
					(newid(), 'DE', 'DEC16DE', 'EXP', @GbPkDE, @GcPkDE, '2014-02-11', 'DE4', 'SEA', 'ITF', 16);";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			CombineAssertions(() =>
			{
				...
				AssertRowMatchingRef1(transactions, "5", "PRN", "PRB", new DateTime(2014, 2, 11), "PR1", 1, "DEC10PR", "PR");
				AssertRowMatchingRef1(transactions, "6", "SIN", "SIN", new DateTime(2014, 2, 13), "US1", 1, "DEC01", "SG");
