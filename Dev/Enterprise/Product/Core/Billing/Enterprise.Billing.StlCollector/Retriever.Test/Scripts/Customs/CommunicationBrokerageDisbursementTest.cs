...
{
	[TestedType(typeof(CommunicationBrokerageDisbursement))]
	sealed class CommunicationBrokerageDisbursementTest : RefStlScriptWithDefaultsTest
	{
...
DECLARE @JePk05 UNIQUEIDENTIFIER = newid();
DECLARE @JePk06 UNIQUEIDENTIFIER = newid();
...
INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_MessageSubType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ApplicationCode, JE_ClusterKey) VALUES
	(@JePk01, 'SG', 'SHP01', 'OUT', 'XXX', @GbPk, @GcPk, '2013-12-01', 'US1', '', 1),
	(@JePk02, 'AU', 'SHP02', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-02', 'US1', '', 2),
	(newid(), 'AU', 'SHP03', 'EXP', 'NOR', @GbPk, @GcPk, '2013-12-03', 'US1', '', 3),
	(@JePk03, 'NZ', 'SHP04', 'XXX', 'XXX', @GbPk, @GcPk, '2013-12-04', 'US1', '', 4),
	(@JePk04, 'ZA', 'SHP05', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-04', 'US1', '', 5),
	(newid(), 'NZ', 'SHP06', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-05', 'US1', '', 6),
	(@JePk05, 'SG', 'SHP07', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-06', 'US1', '', 7),
	(@JePk06, 'ZA', 'SHP08', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-07', 'US1', '', 8),
	(newid(), 'AU', 'SHP09', 'EXP', 'XXX', @GbPk, @GcPk, '2013-12-08', 'US1', '', 9);
INSERT dbo.JobHeader (JH_PK, JH_GC, JH_ParentID, JH_JobNum, JH_SystemCreateTimeUtc, JH_GB, JH_GE, JH_SystemCreateUser, JH_Status, JH_IsDisbursement, JH_Direction) VALUES
	(newid(), @GcPk, @JePk01, 'SHP01', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0, 'DOM'),
	(newid(), @GcPk, @JePk02, 'SHP02', '2013-12-04', @GbPk, @GePk, 'US2', 'WRK', 1, ''),
	(newid(), @GcPk, @JePk03, 'SHP04', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0, ''),
	(@JobHeaderPK, @GcPk, @JePk04, 'SHP05', '2013-12-04', @GbPk, @GePk, 'US2', 'WRK', 1, 'IMP'),
	(newid(), @GcPk, @JePk05, 'SHP07', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0, 'EXP'),
	(newid(), @GcPk, @JePk06, 'SHP08', '2013-12-04', @GbPk, @GePk, 'US2', 'WRK', 1, '');
