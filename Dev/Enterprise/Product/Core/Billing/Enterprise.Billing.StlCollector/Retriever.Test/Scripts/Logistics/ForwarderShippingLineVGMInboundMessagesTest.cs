...
{
	[TestedType(typeof(ForwarderShippingLineVGMInboundMessages))]
	sealed class ForwarderShippingLineVGMInboundMessagesTest : RefStlScriptWithDefaultsTest
	{
...
INSERT dbo.RefShippingLine (RSL_PK, RSL_CarrierName, RSL_CargoWiseOneCode, RSL_IsSystem, RSL_IsActive, RSL_IsNVO, RSL_IsShippingLine, RSL_VerifiedGrossContainerWeightAvailable) VALUES
	(@RslPk01, 'Yusen01', 'Y01', 0, 1, 0, 1, 1),
	(@RslPk02, 'DHL01', 'D01', 0, 1, 0, 1, 1),
	(@RslPk03, 'DNN01', 'D02', 0, 1, 1, 0, 0),
	(@RslPk07, 'JD', 'JD', 0, 1, 0, 1, 0),
	(@RslPk08, 'SF', 'SF', 0, 1, 0, 1, 1),
	(@RslPk09, 'IQ', 'IQ', 0, 1, 1, 1, 1);
...
INSERT dbo.OrgHeader (OH_PK, OH_IsActive, OH_Code, OH_FullName, OH_IsShippingLine, OH_RSL_ShippingLine) VALUES
	...
	(@OhPk07, 1, 'JD', 'JD C1C', 1, @RslPk07),
	(@OhPk08, 1, 'SF', 'SF C1C', 1, @RslPk08),
	(@OhPk09, 1, 'IQ', 'IQ C1C', 1, @RslPk09);
...
INSERT dbo.OrgAddress (OA_PK, OA_OH, OA_IsActive, OA_Address1, OA_Address2, OA_City, OA_PostCode, OA_RN_NKCountryCode) VALUES
	...
	(@OaPk7, @OhPk07, 1, '30', 'JD', 'JD', 3000, 'AU'),
	(@OaPk8, @OhPk08, 1, '30', 'SF', 'SF', 3000, 'AU'),
	(@OaPk9, @OhPk09, 1, '30', 'IQ', 'IQ', 3000, 'AU');
...
INSERT dbo.OrgCusCode (OK_PK, OK_IsValid, OK_CustomsRegNo, OK_CodeType, OK_RN_NKCodeCountry, OK_OH) VALUES
	...
	(NEWID(), 1, 'JD', 'C1C', 'AU', @OhPk07),
	(NEWID(), 1, 'SF', 'C1C', 'AU', @OhPk08),
	(NEWID(), 1, 'IQ', 'C1C', 'AU', @OhPk09);
...
INSERT dbo.JobContainer (JC_PK, JC_JK, JC_RC, JC_ContainerNum, JC_SystemCreateTimeUtc, JC_SystemCreateUser) VALUES
	...
	(@JcPk11, @JkPk02, @RcPk02, 'HLCJ011', '2021-03-01', 'US2'),
	...
	(@JcPk12, @JkPk12, @RcPk03, 'HLCJ012', '2021-03-01', 'US0'),
	(@JcPk13, @JkPk13, @RcPk03, 'HLCJ013', '2021-03-01', 'US0'),
	(@JcPk14, @JkPk14, @RcPk03, 'HLCJ014', '2021-03-01', 'US0'),
	(@JcPk15, @JkPk15, @RcPk03, 'HLCJ015', '2021-03-01', 'US0');
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk01, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 01:23:00', @JcPk01, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-09 02:23:00', @JcPk02, 'MSN', 'MST=VERIFIED GROSS CONTAINER WEIGHT', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk02, 'MRJ', 'MST=VERIFIED GROSS CONTAINER WEIGHT', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 03:23:00', @JcPk11, 'MSN', 'MST=verified gross container weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 04:23:00', @JcPk11, 'MWA', 'MST=verified gross container weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-08 02:23:00', @JcPk03, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-09 02:23:00', @JcPk03, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 01:23:00', @JcPk04, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk04, 'MRJ', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 02:23:00', @JcPk05, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk05, 'MWA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-04-09 01:23:00', @JcPk06, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-04-09 02:23:00', @JcPk06, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 02:23:00', @JcPk07, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk07, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 01:23:00', @JcPk08, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk08, 'MRJ', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-07 01:23:00', @JcPk09, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 01:23:00', @JcPk09, 'MWA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-01-08 00:23:00', @JcPk10, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk10, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk12, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 12:23:00', @JcPk12, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk13, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'Y'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:00', @JcPk13, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'Y'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:01', @JcPk14, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:01', @JcPk14, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:02', @JcPk15, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:02', @JcPk15, 'MAA', 'MST=Verified Gross Container Weight', 'SY1', 'N');
...
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			Assert("CON03's VGM response message PostedTime is not in DateTime range", !transactions.Any(t => t.Reference1 == "CON03"));
			...
			Assert("CON06's VGM response message PostedTime is not in DateTime range", !transactions.Any(t => t.Reference1 == "CON06"));
			Assert("CON07 hasn't received MAA|MRJ|MWA event with MST=Verified Gross Container Weight event", !transactions.Any(t => t.Reference1 == "CON07"));
			...
			Assert("CON10 doesn't have MSN event in one month before ISN", !transactions.Any(t => t.Reference1 == "CON10"));
			Assert("CON12's RSL_VerifiedGrossContainerWeightAvailable is false", !transactions.Any(t => t.Reference1 == "CON12"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-0] TransactionReference03", "HLCJ001", transaction1.Reference3);
				AssertEquals("[Row-0] TransactionReference04", "Verified Gross Container Weight/MAA", transaction1.Reference4);
				AssertEquals("[Row-0] AdditionalRefs", "{\"ConsolNumber\":\"CON01\",\"ContainerNumber\":\"HLCJ001\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B01\",\"CoLoadBookingConfirmationReference\":\"CB01\",\"CoLoadMasterBillNumber\":\"CM01\",\"WayBillNumber\":\"M01\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"VMLCCC\",\"C1CCode\":\"HLCU\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-1] TransactionReference02", "B02", transaction2.Reference2);
				AssertEquals("[Row-1] TransactionReference03", "HLCJ002", transaction2.Reference3);
				AssertEquals("[Row-1] TransactionReference04", "Verified Gross Container Weight/MRJ", transaction2.Reference4);
				AssertEquals("[Row-1] AdditionalRefs", "{\"ConsolNumber\":\"CON02\",\"ContainerNumber\":\"HLCJ002\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B02\",\"CoLoadBookingConfirmationReference\":\"CB02\",\"CoLoadMasterBillNumber\":\"CM02\",\"WayBillNumber\":\"M02\",\"CoLoadWith\":{\"OrgCode\":\"KMJC1C\",\"C1CCode\":\"DYUI\"},\"ShippingLine\":{\"OrgCode\":\"VMLC1C\",\"C1CCode\":\"XXCU\"},\"IsNVO\":0}",
					transaction2.AdditionalRefs);

				var transaction3 = FindRowByOccured(transactions, new DateTime(2021, 3, 9, 4, 23, 0));
				...
				AssertEquals("[Row-2] TransactionReference03", "HLCJ011", transaction3.Reference3);
				AssertEquals("[Row-2] TransactionReference04", "Verified Gross Container Weight/MWA", transaction3.Reference4);
				AssertEquals("[Row-2] AdditionalRefs", "{\"ConsolNumber\":\"CON02\",\"ContainerNumber\":\"HLCJ011\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B02\",\"CoLoadBookingConfirmationReference\":\"CB02\",\"CoLoadMasterBillNumber\":\"CM02\",\"WayBillNumber\":\"M02\",\"CoLoadWith\":{\"OrgCode\":\"KMJC1C\",\"C1CCode\":\"DYUI\"},\"ShippingLine\":{\"OrgCode\":\"VMLC1C\",\"C1CCode\":\"XXCU\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-3] TransactionReference03", "HLCJ013", transaction4.Reference3);
				AssertEquals("[Row-3] TransactionReference04", "Verified Gross Container Weight/MAA", transaction4.Reference4);
				AssertEquals("[Row-3] AdditionalRefs", "{\"ConsolNumber\":\"CON13\",\"ContainerNumber\":\"HLCJ013\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B13\",\"CoLoadBookingConfirmationReference\":\"CB13\",\"CoLoadMasterBillNumber\":\"CM13\",\"WayBillNumber\":\"M13\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"SF\",\"C1CCode\":\"SF\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-4] TransactionReference03", "HLCJ015", transaction5.Reference3);
				AssertEquals("[Row-4] TransactionReference04", "Verified Gross Container Weight/MAA", transaction5.Reference4);
				AssertEquals("[Row-4] AdditionalRefs", "{\"ConsolNumber\":\"CON15\",\"ContainerNumber\":\"HLCJ015\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B15\",\"CoLoadBookingConfirmationReference\":\"CB15\",\"CoLoadMasterBillNumber\":\"CM15\",\"WayBillNumber\":\"M15\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"IQ\",\"C1CCode\":\"IQ\"},\"IsNVO\":0}",
