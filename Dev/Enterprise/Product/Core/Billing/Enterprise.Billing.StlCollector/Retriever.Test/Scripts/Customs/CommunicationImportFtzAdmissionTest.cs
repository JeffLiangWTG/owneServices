...
{
	[TestedType(typeof(CommunicationImportFtzAdmission))]
	sealed class CommunicationImportFtzAdmissionTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey) VALUES
					(newid(), 'US', 'DEC01', 'FTZ', @GbPkUs, @GcPkUs, '2014-03-10', 'US1', 1),
					(newid(), 'SG', 'DEC02', 'FTZ', @GbPkSg, @GcPkSg, '2012-03-01', 'US2', 2),
					(@JePk  , 'US', 'DEC03', 'FTZ', @GbPkUs, @GcPkUs, '2012-03-31', 'US3', 3),
					(newid(), 'US', 'DEC04', 'XXX', @GbPkUs, @GcPkUs, '2012-03-31', 'US4', 4);";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertEquals("TransactionDateUtc", new DateTime(2012, 3, 31), transaction1.ServiceOccuredUTC);
