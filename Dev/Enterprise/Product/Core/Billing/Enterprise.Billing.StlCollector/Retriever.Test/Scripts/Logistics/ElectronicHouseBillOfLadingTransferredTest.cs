...
{
	[TestedType(typeof(ElectronicHouseBillOfLadingTransferred))]
	sealed class ElectronicHouseBillOfLadingTransferredTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertNull("The TYP is not 'Original Bill Transferred'", transactions.FirstOrDefault(x => x.Reference1 == "JS06"));
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:30:58.563', @JsPk01 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'Y'),-- This is the first BLU Log for this Shipment @JsPk01 [0]
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:46:58.563', @JsPk01 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'Y'),-- This is not the first BLU Log for this Shipment @JsPk01
	...
	(NEWID(), 'JobShipment', getdate() , '2024-03-10 05:46:58.563', @JsPk02 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'Y'),-- This is the first BLU Log for this Shipment @JsPk02 [0]
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:46:58.563', @JsPk02 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- This is not the first BLU Log for this Shipment @JsPk02

	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:46:58.563', @JsPk03 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- This is the first BLU Log for this Shipment @JsPk03 [1]
	(NEWID(), 'JobShipment', getdate() , '2024-05-10 06:46:58.563', @JsPk03 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'),
	...
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:10:58.563', @JsPk04 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'),-- [2]
	...
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 05:55:58.563', @JsPk05 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- [3]
	...
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 03:46:58.563', @JsPk06 , 'BLU', '|DEP=Title Registry|TYP=Surrendered', 'GB0', 'N'), -- The TYP is not 'Original Bill Transferred' @JsPk06
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 03:46:58.563', @JsPk07 , 'BLU', '|DEP=Cargowise|TYP=Original Bill Transferred', 'GB0', 'N'), -- The DEP is not 'Title Registry' @JsPk07
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 03:46:58.563', @JsPk08 , 'ISN', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- The SL_SE_NKEvent is not 'BLU' @JsPk08
	(NEWID(), 'JobDocumentData', getdate() , '2024-04-10 03:46:58.563', @JsPk09 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- The SL_Table is not 'JobShipment' @JsPk09
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 04:46:58.000', @JsPk10 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'), -- The SL_PostedTimeUtc is not in the query time range. @JsPk10
	(NEWID(), 'JobShipment', getdate() , '2024-04-10 06:00:00.000', @JsPk11 , 'BLU', '|DEP=Title Registry|TYP=Original Bill Transferred', 'GB0', 'N'); -- The SL_PostedTimeUtc is not in the query time range. @JsPk11";
