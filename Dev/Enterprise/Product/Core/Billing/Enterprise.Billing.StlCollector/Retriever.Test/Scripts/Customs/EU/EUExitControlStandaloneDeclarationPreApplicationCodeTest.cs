...
[TestedType(typeof(EUExitControlStandaloneDeclarationPreApplicationCode))]
sealed class EUExitControlStandaloneDeclarationPreApplicationCodeTest : RefStlScriptWithDefaultsTest
{
	protected override void PrepareTestData()
	{
		var dropColumnSqlText = """
			...
			""";
		TestConnection.ExecuteNonQuery(dropColumnSqlText);
		var sqlText = """
				...
				INSERT dbo.GlbCompany (GC_PK, GC_Code, GC_Name, GC_RN_NKCountryCode) VALUES
					(@GcPk, 'DEC', 'DE company', 'DE');
				INSERT dbo.GlbBranch (GB_PK, GB_Code, GB_GC) VALUES
					(@GbPk, 'DEB', @GcPk);
				INSERT dbo.GlbCompany (GC_PK, GC_Code, GC_Name, GC_RN_NKCountryCode) VALUES
					(@GcPkOther, 'DC2', 'DE company', 'DE');
				INSERT dbo.GlbBranch (GB_PK, GB_Code, GB_GC) VALUES
				...
				INSERT dbo.CusExitHeader (CXH_PK, CXH_ClusterKey, CXH_ParentTableCode, CXH_ParentId, CXH_JobReference, CXH_GB_Branch, CXH_GC_Company, CXH_SystemCreateUser, CXH_SystemCreateTimeUtc, CXH_SystemLastEditUser, CXH_SystemLastEditTimeUtc)
				VALUES	(0x1, 1, '',	NULL, 'E0001', @GbPk,		@GcPk,		'U1', '2025-08-01', '~BP', '2025-09-01'),
						(0x2, 2, 'JS',	0x11, 'E0002', @GbPk,		@GcPk,		'U2', '2025-08-02', '~BP', '2025-09-02'),

						(0x3, 3, 'JE',	0x21, 'E0003', @GbPk,		@GcPk,		'U3', '2025-08-03', '~BP', '2025-09-03'), -- not selected, has JE parent

						(0x4, 4, '',	NULL, 'E0004', @GbPk,		@GcPk,		'U4', '2025-07-04', '~BP', '2025-09-04'), -- not selected, outside date range
						(0x5, 5, 'JS',	0x12, 'E0005', @GbPk,		@GcPk,		'U5', '2025-08-06', '~BP', '2025-09-06'), -- not selected, has Declaration in the same company context
						(0x6, 6, 'JS',	0x13, 'E0006', @GbPkOther,	@GcPkOther,	'U6', '2025-08-07', '~BP', '2025-09-07');
				""";
	...
	protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
	{
		CombineAssertions(() =>
		{
			AssertContainsExactElementsInAnyOrder("All elements", new[] { "E0001", "E0002", "E0006" }, transactions.Select(x => x.Reference1));
			...
			var transaction3 = transactions.Single(x => x.Reference1 == "E0006");
			AssertEquals("CompanyCode", "DC2", transaction3.GetCompanyCode());
			AssertEquals("BranchCode", "DB2", transaction3.GetBranchCode());
			AssertEquals("ClientStaffCode", "U6", transaction3.ClientStaffCode);
			AssertEquals("TransactionDateUtc", new DateTime(2025, 8, 7), transaction3.ServiceOccuredUTC);
			AssertEquals("TransactionGuidReference", "00000006-0000-0000-0000-000000000000", transaction3.Reference5);
		});
	}
	...
	public void TestVersions()
	{
		...
		{
			AssertEquals(string.Empty, ScriptToTest.MinCW1Version);
			AssertEquals("25.5.22.224", ScriptToTest.MaxCW1Version);
		});
	}
}
