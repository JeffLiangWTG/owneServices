...
{
	[TestedType(typeof(ForwarderShippingLineOutboundShippingOrder))]
	sealed class ForwarderShippingLineOutboundShippingOrderTest : RefStlScriptWithDefaultsTest
	{
...
INSERT dbo.RefShippingLine (RSL_PK, RSL_CarrierName, RSL_CargoWiseOneCode, RSL_IsSystem, RSL_IsActive, RSL_IsNVO, RSL_IsShippingLine, RSL_ShippingOrderAvailable) VALUES
	(@RslPk01, 'Yusen01', 'Y01', 0, 1, 0, 1, 1),
	(@RslPk02, 'DHL01', 'D01', 0, 1, 0, 1, 1),
	(@RslPk03, 'DNN01', 'D02', 0, 1, 1, 0, 0),
	(@RslPk07, 'JD', 'J02', 0, 1, 0, 1, 0),
	(@RslPk08, 'SF', 'S02', 0, 1, 0, 1, 1),
...
INSERT dbo.OrgHeader (OH_PK, OH_IsActive, OH_Code, OH_FullName, OH_IsShippingLine, OH_RSL_ShippingLine) VALUES
	...
	(@OhPk07, 1, 'JDC1C', 'JD C1C', 1, @RslPk07),
	(@OhPk08, 1, 'SFC1C', 'SF C1C', 1, @RslPk08),
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:00', @JkPk01, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk01, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk01, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 03:23:00', @JkPk01, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-09 02:23:00', @JkPk02, 'MSN', 'MST=SHIPPING ORDER', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk02, 'ISN', 'MST=SHIPPING ORDER', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-08 02:23:00', @JkPk03, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-09 02:23:00', @JkPk03, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 01:23:00', @JkPk04, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk04, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk05, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk05, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-04-09 01:23:00', @JkPk06, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-04-09 02:23:00', @JkPk06, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk07, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk07, 'MRJ', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 01:23:00', @JkPk08, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk08, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-07 01:23:00', @JkPk09, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk09, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-01-08 01:23:00', @JkPk10, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk10, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:00', @JkPk12, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 12:23:00', @JkPk12, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:00', @JkPk13, 'MSN', 'MST=Shipping Order', 'SY1', 'Y'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 13:23:00', @JkPk13, 'ISN', 'MST=Shipping Order', 'SY1', 'Y'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:01', @JkPk14, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 13:23:01', @JkPk14, 'ISN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:02', @JkPk15, 'MSN', 'MST=Shipping Order', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 13:23:02', @JkPk15, 'ISN', 'MST=Shipping Order', 'SY1', 'N');
...
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			Assert("CON07 container hasn't received ISN with MST=Shipping Order", !transactions.Any(t => t.Reference1 == "CON07"));
			...
			Assert("CON12's RSL_ShippingOrderAvailable is false", !transactions.Any(t => t.Reference1 == "CON12"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-0] TransactionReference04", "Shipping Order", transaction1.Reference4);
				...
				AssertEquals("[Row-1] TransactionReference04", "Shipping Order", transaction2.Reference4);
				...
				AssertEquals("[Row-2] TransactionReference04", "Shipping Order", transaction3.Reference4);
				...
				AssertEquals("[Row-3] TransactionReference04", "Shipping Order", transaction4.Reference4);
				AssertEquals("[Row-3] AdditionalRefs", "{\"ConsolNumber\":\"CON13\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B13\",\"CoLoadBookingConfirmationReference\":\"CB13\",\"WayBillNumber\":\"M13\",\"ShippingLine\":{\"OrgCode\":\"SFC1C\",\"C1CCode\":\"SF\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-4] TransactionReference04", "Shipping Order", transaction5.Reference4);
				AssertEquals("[Row-4] AdditionalRefs", "{\"ConsolNumber\":\"CON15\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B15\",\"CoLoadBookingConfirmationReference\":\"CB15\",\"WayBillNumber\":\"M15\",\"ShippingLine\":{\"OrgCode\":\"IQC1C\",\"C1CCode\":\"IQ\"},\"IsNVO\":0}",
