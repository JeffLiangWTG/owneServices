...
{
	[TestedType(typeof(GBGVMSManifestUsage))]
	sealed class GBGVMSManifestUsageTest : RefStlScriptWithDefaultsTest
	{
		protected override IDateTimeRange TestDateTimeRange => AusydMonthRange.New(2022, 8);

		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			AssertEquals("GB GVMS Usage Count", 1, transactions.Count());
			...
			AssertEquals("TransactionReference02", "GVM", transaction1.Reference2);
		...
		protected override void PrepareTestData()
		{
			string sqlText = $@"DECLARE @GcPkGB UNIQUEIDENTIFIER = newid();
											...
											('{amaPk01}', 'C0000ABC1', 'GVM', '2022-08-01', '2022-08-01', 'BOB', 'JOE', 1, 'GB', @GbPkGB),
											(newid(), 'C0000ABC2', 'XXX', '2022-08-01', '2022-08-01', 'BOB', 'JOE', 2, 'GB', @GbPkGB),
											(newid(), 'C0000ABC3', 'GVM', '2022-08-01', '2022-08-01', 'BOB', 'JOE', 3, 'AU', @GbPkAU),
											(newid(), 'C0000ABC4', 'GVM', '2022-09-01', '2022-09-01', 'BOB', 'JOE', 4, 'GB', @GbPkGB);";
