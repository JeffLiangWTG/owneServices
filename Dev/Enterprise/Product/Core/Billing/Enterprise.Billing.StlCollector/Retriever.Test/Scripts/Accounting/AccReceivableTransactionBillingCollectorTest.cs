...
{
	[TestedType(typeof(AccReceivableTransactionBillingCollector))]
	sealed class AccReceivableTransactionBillingCollectorTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			void assertARAPRows(string ledger, params string[] transactionTypes)
			{
				...
				var expectedCount = transactionTypes.Length * 2;
				...
				Assert("Transactions created at 12:59 have '002' Transaction Number", rows1259.All(t => t.Reference1 == "002"));
				Assert("Transactions created at 12:59 have '1000/02' Consolidated Invoice Ref", rows1259.All(t => t.Reference2 == "1000/02"));
			}
		}
...
INSERT INTO dbo.AccTransactionHeader (AH_PK, AH_GC, AH_GB, AH_GE, AH_InvoiceDate, AH_Ledger, AH_TransactionType, AH_TransactionNum, AH_ConsolidatedInvoiceRef, AH_SystemCreateTimeUtc, AH_SystemCreateUser, AH_RX_NKTransactionCurrency, AH_OSTotal, AH_InvoiceAmount, AH_GSTAmount, AH_TransactionCategory) VALUES");
			...
			foreach (var ledger in new[] { "AR", "AP" })
			{
				...
				{
					sqlBuilder.AppendFormat("(NEWID(), @EDICompanyPk, @SYDBranchPk, @DepartmentPk, '2022-4-20', '{0}', '{1}', '000', '1000/00', '2022-4-20 11:59', 'TST', 'USD', {2}75, {2}90, {2}10, 'FIN'),", ledger, transactionType, minus);
					sqlBuilder.AppendFormat("(NEWID(), @EDICompanyPk, @SYDBranchPk, @DepartmentPk, '2022-4-20', '{0}', '{1}', '001', '1000/01', '2022-4-20 12:00', 'TST', 'USD', {2}75, {2}90, {2}10, 'FIN'),", ledger, transactionType, minus);
					sqlBuilder.AppendFormat("(NEWID(), @EDICompanyPk, @SYDBranchPk, @DepartmentPk, '2022-4-20', '{0}', '{1}', '002', '1000/02', '2022-4-20 12:59', 'TST', 'USD', {2}75, {2}90, {2}10, 'FIN'),", ledger, transactionType, minus);
					sqlBuilder.AppendFormat("(NEWID(), @EDICompanyPk, @SYDBranchPk, @DepartmentPk, '2022-4-20', '{0}', '{1}', '003', '1000/03', '2022-4-20 13:00', 'TST', 'USD', {2}75, {2}90, {2}10, 'FIN'),", ledger, transactionType, minus);
				}
			}
