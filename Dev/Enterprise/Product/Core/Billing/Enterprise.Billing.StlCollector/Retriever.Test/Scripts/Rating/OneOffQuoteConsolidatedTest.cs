...
{
	[TestedType(typeof(OneOffQuoteConsolidated))]
	sealed class OneOffQuoteConsolidatedTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			...
			INSERT dbo.JobConsol(JK_PK, JK_UniqueConsignRef, JK_SystemCreateTimeUtc) VALUES(@JkPk03, 'con3', '2022-11-21 11:01');
			INSERT dbo.JobConsol(JK_PK, JK_UniqueConsignRef, JK_SystemCreateTimeUtc) VALUES(@JkPk04, 'con4', '2022-11-21 11:01');
			INSERT dbo.JobConsol(JK_PK, JK_UniqueConsignRef, JK_SystemCreateTimeUtc) VALUES(@JkPk05, 'con5', '2022-11-21 11:01');
			INSERT dbo.JobConsol(JK_PK, JK_UniqueConsignRef, JK_SystemCreateTimeUtc) VALUES(@JkPk06, 'con6', '2022-11-21 11:01');
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction1 = FindRowByRef1(transactions, "Consign1");
			AssertEquals(1, transaction1.BillableCount);
			var transaction2 = FindRowByRef1(transactions, "Consign2");
			AssertEquals(1, transaction2.BillableCount);
			var transaction3 = FindRowByRef1(transactions, "Consign5");
