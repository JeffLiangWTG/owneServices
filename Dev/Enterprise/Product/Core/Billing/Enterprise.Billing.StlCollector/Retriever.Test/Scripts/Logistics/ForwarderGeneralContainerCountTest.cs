...
{
	[TestedType(typeof(ForwarderGeneralContainerCount))]
	sealed class ForwarderGeneralContainerCountTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobConsol (JK_PK, JK_UniqueConsignRef, JK_IsForwarding) VALUES
					...
					(@JkPk03, 'CON03', 0),
					(newid(), 'CON04', 1);
				INSERT dbo.JobContainer (JC_PK, JC_JK, JC_ContainerNum, JC_SystemCreateTimeUtc, JC_SystemCreateUser) VALUES
					(newid(), @JkPk01, 'JC11', '2014-04-01', 'US1'),
					(newid(), @JkPk01, 'JC13', '2014-03-01', 'US2'),
					(newid(), @JkPk02, 'JC22', '2014-03-02', 'US3'),
					(newid(), @JkPk02, 'JC23', '2014-05-02', 'US4'),
					(newid(), @JkPk03, 'JC32', '2014-03-03', 'US5');";
