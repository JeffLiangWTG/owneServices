...
{
	[TestedType(typeof(ETradeCountTransaction))]
	sealed class ETradeCountTransactionTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			var sqlText = @"
				...
				(@AmaPk2, 'C0000ABC2', 'MAN', 'OUT', 2022-08-01, 2022-08-01, 'YGT', 'KNZ', 2, 'TR', @GbPkTr),
				(@AmaPk3, 'C0000ABC3', 'MAN', 'ETR', 2022-08-01, 2022-08-01, 'YGT', 'KNZ', 3, 'SG', @GbPkSg),
				(@AmaPk4, 'C0000ABC4', 'MAN', 'ETR', 2022-08-01, 2022-08-01, 'YGT', 'KNZ', 4, 'TR', @GbPkTr),
		...
		{
			CombineAssertions("Below test is for the number of transactions and the macthing rows as expected", () =>
			{
				...
				AssertRowMatchingRef1(transactions, "TR-Correct for second record", "~TR", "^TR", new DateTime(2022, 08, 01), "YGT", 1, "CEN05", "C0000ABC5", "BN005", null);
			});
		}
	}
}
