...
{
	[TestedType(typeof(BookingConfirmationSent))]
	sealed class BookingConfirmationSentTest : RefStlScriptWithDefaultsTest
	{
		protected override IDateTimeRange TestDateTimeRange => AusydMonthRange.New(2023, 04);

		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			AssertEquals(7, transactions.Count());
			...
			var row6 = transactions.Single(x => x.Reference1.StartsWith("JS00000000009"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-6] CompanyCode", "DK1", row6.GetCompanyCode());
				AssertEquals("[Row-6] BranchCode", "GB2", row6.GetBranchCode());
				AssertEquals("[Row-6] TransactionDateUtc", new DateTime(2023, 04, 12, 12, 02, 00), row6.ServiceOccuredUTC);
				AssertEquals("[Row-6] ItemCount", 1, row6.BillableCount);
				AssertEquals("[Row-6] TransactionReference01", "JS00000000009", row6.Reference1);
				AssertEquals("[Row-6] TransactionReference02", "BookingReference09", row6.Reference2);
				AssertEquals("[Row-6] TransactionReference03", "OH_FullName05", row6.Reference3);
				AssertEquals("[Row-6] TransactionReference04", null, row6.Reference4);
			});
		}
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(NEWID(), 'JobShipment', getdate(), '2023-04-02 12:01:00', @JsPk01, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=00', 'GB0', 'Y'), -- 00
	(NEWID(), 'JobShipment', getdate(), '2023-04-12 12:02:00', @JsPk01, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=01', 'GB0', 'N'),  -- 01
	(NEWID(), 'JobShipment', getdate(), '2023-03-01 12:03:00', @JsPk02, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=02', 'GB0', 'N'), -- Before date range
	(NEWID(), 'JobShipment', getdate(), '2023-05-01 12:04:00', @JsPk03, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=03', 'GB0', 'N'), -- After date range
	(NEWID(), 'JobShipment', getdate(), '2023-04-01 12:05:00', @JsPk04, 'XXX', '|NEW=BKD|TYP=Shipment Status|RES=04', 'GB0', 'N'), -- SL_SE_NKEvent is not STU

	(NEWID(), 'JobShipment', getdate(), '2023-04-12 12:02:00', @JsPk05, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=05', 'GB2', 'N'),  -- 02
	(NEWID(), 'JobShipment', getdate(), '2023-04-12 12:02:00', @JsPk06, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=06', 'GB3', 'N'),  -- 03
	(NEWID(), 'JobShipment', getdate(), '2023-04-12 12:02:00', @JsPk07, 'STU', '|NEW=BKD|TYP=Shipment Status|RES=07', 'GB4', 'N'),  -- 04
	(NEWID(), 'ViewQuotedBooking', getdate(), '2023-04-12 12:02:00', @JsPk08, 'STU', '|NEW=BKD|TYP=Shipment Status', 'GB2', 'N'),  -- 05
	(NEWID(), 'ViewQuotedBooking', getdate(), '2023-04-12 12:02:00', @ThPk01, 'STU', '|NEW=BKD|TYP=Shipment Status', 'GB2', 'N');  -- 06

INSERT dbo.RatingHeader(TH_PK, TH_RateType, TH_QuoteDate, TH_SystemLastEditTimeUtc, TH_SystemLastEditUser, TH_SystemCreateTimeUtc, TH_SystemCreateUser) VALUES
	(@ThPk01, 'QTE', getdate(), getdate(), '~BP', getdate(), '~BP');

INSERT dbo.JobShipment (JS_PK, JS_ShipmentType, JS_RL_NKOrigin, JS_UniqueConsignRef, JS_BookingReference, JS_IsBooking, JS_TH_OneTimeQuote) VALUES
	(@JsPk01, 'HVL', 'AUMEL', 'JS00000000001', 'BookingReference01', 0, null),
	(@JsPk02, 'STD', 'AUMEL', 'JS00000000002', 'BookingReference02', 0, null),
	(@JsPk03, 'STD', 'AUMEL', 'JS00000000003', 'BookingReference03', 0, null),
	(@JsPk04, 'STD', 'AUMEL', 'JS00000000004', 'BookingReference04', 0, null),
	(@JsPk05, 'STD', 'DKAAB', 'JS00000000005', 'BookingReference05', 0, null),
	(@JsPk06, 'STD', 'NZAKL', 'JS00000000006', 'BookingReference06', 0, null),
	(@JsPk07, 'STD', 'CNSHA', 'JS00000000007', 'BookingReference07', 0, null),
	(@JsPk08, 'STD', 'CNSZG', 'JS00000000008', 'BookingReference08', 1, null),
	(@JsPk09, 'STD', 'CNSZG', 'JS00000000009', 'BookingReference09', 1, @ThPk01);
...
INSERT dbo.JobDocAddress (E2_PK, E2_AddressOverride, E2_OA_Address, E2_ParentID, E2_AddressType, E2_ParentTableCode, E2_AddressSequence, E2_CompanyName, E2_ValidationStatus) VALUES
	...
	(NEWID(), 0, @OaPk05, @JsPk09, 'BKD','JS', 0, '', 'NRQ');";
