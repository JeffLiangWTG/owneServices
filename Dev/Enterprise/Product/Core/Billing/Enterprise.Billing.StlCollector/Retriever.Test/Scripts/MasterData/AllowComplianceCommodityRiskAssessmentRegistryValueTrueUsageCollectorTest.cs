...
namespace Enterprise.Billing.StlCollector.Retriever.Scripts.MasterData
{
	...
	class AllowComplianceCommodityRiskAssessmentRegistryValueTrueUsageCollectorTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertEquals("True", "True", transaction1.Reference1);
