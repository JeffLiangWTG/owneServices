...
{
	[TestedType(typeof(OneOffQuoteLinkedToBookingWithQuote))]
	sealed class OneOffQuoteLinkedToBookingWithQuoteTest : RefStlScriptWithDefaultsTest
	{
		protected override bool IsMandatoryForMilestones => false;

		protected override void PrepareTestData()
		{
			/* in this test, we have 3 OOQ (QBNE00001001 to QBNE00001003) and 4 BWQ (QBNE00001004 to QBNE00001007)
			 * we link OOQ QBNE00001001 to QBNE00001005 and link OOQ QBNE00001002 to QBNE00001006 and link BWQ QBNE00001004 to QBNE00001007 and
			...
			INSERT dbo.RatingHeader (TH_PK, TH_GC, TH_RateType, TH_QuoteNumber, TH_OneTimeQuote, TH_SystemCreateUser, TH_SystemCreateTimeUtc, TH_QuoteDate, TH_IsCancelled, TH_SystemLastEditTimeUtc, TH_SystemLastEditUser,TH_IsOneOffQuoteConsumed) VALUES
				(@ThPk01, @GcPk, 'QTE', 'QBNE00001001', 0, 'US1', GetUtcDate(),'2022-11-01', 0, '2022-11-01 01:00:00', '~BP',1),
				(@ThPk02, @GcPk, 'QTE', 'QBNE00001002', 0, 'US2', GetUtcDate(),'2022-11-01', 0, '2022-11-01 01:05:00', '~BP',1),
			...
			INSERT dbo.JobShipment (JS_PK, JS_ShipmentType, JS_RL_NKOrigin, JS_UniqueConsignRef, JS_IsBooking, JS_TH_OneTimeQuote) VALUES
				(@JsPk01, 'HVL', 'AUSYD', 'Consign4', 1, @ThPk04),
				(@JsPk02, 'STD', 'AUSYD', 'Consign5', 1, @ThPk05),
				(@JsPk03, 'STD', 'AUSYD', 'Consign6', 1, @ThPk06),
				(@JsPk04, 'STD', 'AUSYD', 'Consign7', 1, @ThPk07);
			...
			INSERT dbo.JobHeader (JH_PK, JH_GC, JH_ParentID, JH_GB, JH_GE, JH_Status, JH_SystemCreateUser, JH_JobNum, JH_TH_NKQuoteNumber, JH_ParentTableCode) VALUES
				(newid(), @GcPk, @ThPk05, @GbPk, @GePk, 'WRK', 'US1', 'JHS01', 'QBNE00001001', 'TH'),
				(newid(), @GcPk, @ThPk06, @GbPk, @GePk, 'WRK', 'US2', 'JHS02', 'QBNE00001002', 'TH'),
				(newid(), @GcPk, @ThPk07, @GbPk, @GePk, 'WRK', 'US3', 'JHS03', 'QBNE00001004', 'TH');";
