...
{
	[TestedType(typeof(AdvanceCargoInformationFilingILForwarderManifest))]
	sealed class AdvanceCargoInformationFilingILForwarderManifestTest : RefStlScriptWithDefaultsTest
	{
		protected override IDateTimeRange TestDateTimeRange => AusydMonthRange.New(2024, 9);
		...
		protected override void PrepareTestData()
		{
			...
			INSERT INTO dbo.GlbCompany(GC_PK, GC_RN_NKCountryCode, GC_Code, GC_Name) VALUES (@TWCompanyPk, 'IL', '~C1', 'IL company');
			...
			('00000001-0000-0000-0000-000000000000', 'NVC', 'MAN', 1, @TWBranchPk, 1, 'MAN00000001', 'IL', '2024-09-01 00:00:00.000', 'E', '2024-09-02 00:00:00.000', 'F'),
			('00000002-0000-0000-0000-000000000000', 'NVC', 'MAN', 2, @TWBranchPk, 1, 'MAN00000002', 'IL', '2024-09-02 00:00:00.000', 'A', '2024-09-03 00:00:00.000', 'G'),
			('00000003-0000-0000-0000-000000000000', 'NVC', 'MAN', 3, @TWBranchPk, 1, 'MAN00000003', 'IL', '2024-09-02 00:00:00.000', 'B', '2024-09-03 00:00:00.000', 'H'),
			('00000004-0000-0000-0000-000000000000', 'BCD', 'MAN', 4, @TWBranchPk, 1, 'MAN00000004', 'IL', '2024-09-02 00:00:00.000', 'C', '2024-09-03 00:00:00.000', 'I'),
			('00000006-0000-0000-0000-000000000000', 'NVC', 'MAN', 5, @TWBranchPk, 1, 'MAN00000006', 'US', '2024-09-02 00:00:00.000', 'E', '2024-09-03 00:00:00.000', 'K');
			...
			(newid(), '00000001-0000-0000-0000-000000000000', 1, 'ABL1234567', 'BOL', '2024-09-04 00:00:00.000', 'M5V', '2024-09-05 00:00:00.000', 'B'),
			(newid(), '00000002-0000-0000-0000-000000000000', 2, 'ABL8901234', 'BOL', '2024-09-06 00:00:00.000', 'M5V', '2024-09-07 00:00:00.000', 'C'),
			(newid(), '00000003-0000-0000-0000-000000000000', 3, 'ABL9012345', '', '2024-09-06 00:00:00.000', 'M5V', '2024-09-07 00:00:00.000', 'C'),
			(newid(), '00000004-0000-0000-0000-000000000000', 4, 'ABL0123456', 'BOL', '2024-09-06 00:00:00.000', 'M5V', '2024-09-07 00:00:00.000', 'C'),
			(newid(), '00000006-0000-0000-0000-000000000000', 5, 'ABL3456789', 'BOL', '2024-09-06 00:00:00.000', 'M5V', '2024-09-07 00:00:00.000', 'C')";
