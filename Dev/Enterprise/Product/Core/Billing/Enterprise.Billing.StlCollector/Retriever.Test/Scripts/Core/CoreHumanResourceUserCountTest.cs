...
{
	[TestedType(typeof(CoreHumanResourceUserCount))]
	sealed class CoreHumanResourceUserCountTest : CoreActiveStaffTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction1 = FindRowByRef1(transactions, "@#B");
			...
			AssertEquals("[T1] UserCode", "@#B", transaction1.ClientStaffCode);
			AssertEquals("[T1] ItemCount", 1, transaction1.BillableCount);
			AssertEquals("[T1] TransactionReference02", "staff.011", transaction1.Reference2);
			AssertEquals("[T1] TransactionReference03", "Staff011", transaction1.Reference3);

			var transaction2 = FindRowByRef1(transactions, "@#C");
			...
			AssertEquals("[T2] UserCode", "@#C", transaction2.ClientStaffCode);
			AssertEquals("[T2] ItemCount", 1, transaction2.BillableCount);
			AssertEquals("[T2] TransactionReference02", "staff.012", transaction2.Reference2);
			AssertEquals("[T2] TransactionReference03", "Staff012", transaction2.Reference3);

			var transaction3 = FindRowByRef1(transactions, "@#D");
			...
			AssertEquals("[T3] UserCode", "@#D", transaction3.ClientStaffCode);
			AssertEquals("[T3] ItemCount", 1, transaction3.BillableCount);
			AssertEquals("[T3] TransactionReference02", "staff.013", transaction3.Reference2);
			AssertEquals("[T3] TransactionReference03", "Staff013", transaction3.Reference3);
		}
	}
}
