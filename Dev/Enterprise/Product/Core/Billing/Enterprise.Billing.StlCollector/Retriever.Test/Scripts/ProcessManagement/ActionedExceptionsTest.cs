...
{
	[TestedType(typeof(ActionedExceptions))]
	[TestDate(2023, 01, 10, 10, 0, 0)]
	[TestTimeZoneUNLOCO("AUSYD")]
	class ActionedExceptionsTest : RefStlScriptWithDefaultsTest
	{
		protected override bool IsMandatoryForMilestones => false;

		const int ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedLastMonth_NotResolved = 2;
		const int ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedLastMonth_Resolved = 5;

		const int ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedCurrentMonth_NotResolved = 1;
		const int ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedCurrentMonth_Resolved = 7;

		const int ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedNextMonth_Resolved = 5;

		const int ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedLastMonth_NotResolved = 3;
		const int ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedLastMonth_Resolved = 11;

		const int ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedCurrentMonth_NotResolved = 4;
		const int ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedCurrentMonth_Resolved = 5;

		const int ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedNextMonth_Resolved = 7;

		const int ExceptionsCreatedByStaff_GGG_InCompany_AAA_CreatedCurrentMonth_Resolved = 2;
		...
		protected override void PrepareTestData()
		{
			...
			using (EnvProxy.Instance.SetTemporaryUserContext(staff1.GS_LoginName, branch1.PK.ToGuid(), department.PK.ToGuid()))
			{
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedLastMonth_NotResolved; i++)
				{
					((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
				}

				for (int i = 0; i < ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedLastMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedCurrentMonth_NotResolved; i++)
				{
					((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
				}

				for (int i = 0; i < ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedCurrentMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedNextMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
			...
			using (EnvProxy.Instance.SetTemporaryUserContext(staff2.GS_LoginName, branch2.PK.ToGuid(), department.PK.ToGuid()))
			{
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedLastMonth_NotResolved; i++)
				{
					((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
				}

				for (int i = 0; i < ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedLastMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedCurrentMonth_NotResolved; i++)
				{
					((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
				}

				for (int i = 0; i < ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedCurrentMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedNextMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
			...
			using (EnvProxy.Instance.SetTemporaryUserContext(staff3.GS_LoginName, branch1.PK.ToGuid(), department.PK.ToGuid()))
			{
				...
				for (int i = 0; i < ExceptionsCreatedByStaff_GGG_InCompany_AAA_CreatedCurrentMonth_Resolved; i++)
				{
					var exception = ((IWorkflowProvider)jobHeader1.Parent).WorkflowItems.Exceptions.AddNew();
					exception.IsExceptionActioned = true;
				}
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertRow(transactions, 0, "AAA", "CCC", "EEE", ExceptionsCreatedByStaff_EEE_InCompany_AAA_CreatedCurrentMonth_Resolved);
			AssertRow(transactions, 1, "BBB", "DDD", "FFF", ExceptionsCreatedByStaff_FFF_InCompany_BBB_CreatedCurrentMonth_Resolved);
			AssertRow(transactions, 2, "AAA", "CCC", "GGG", ExceptionsCreatedByStaff_GGG_InCompany_AAA_CreatedCurrentMonth_Resolved);
		}
