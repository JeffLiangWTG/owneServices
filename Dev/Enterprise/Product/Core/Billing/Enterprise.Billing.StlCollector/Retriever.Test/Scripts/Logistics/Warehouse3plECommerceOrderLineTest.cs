...
{
	[TestedType(typeof(Warehouse3plECommerceOrderLine))]
	sealed class Warehouse3plECommerceOrderLineTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			CreateDocketLineForDocket(physicalOrder11, "U12", "DEP", 11, 1);
			CreateDocketLineForDocket(physicalOrder12, "U13", "FIN", 12, 1);
			CreateDocketLineForDocket(virtualOrder1, "U14", "DEP", 13, 1);

			var parentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U15", "DEP", 14, 1);
			var componentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U15", "DEP", 14, 2, parentLine: parentLine);
			CreateReceiveFromPickByBOM(orgHeader.PK, whs1, "REC02", physicalPick1);

			var parentLine2 = CreateDocketLineForDocket(pickedOnSaleOrder2, "U16", "DEP", 15, 1);
			var componentLine2 = CreateDocketLineForDocket(pickedOnSaleOrder2, "U16", "DEP", 15, 2, parentLine: parentLine2);
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction7 = FindRowByRef2(transactions, "#15.1");
			...
			AssertEquals("[T7] UserCode", "U16", transaction7.ClientStaffCode);
			...
			AssertEquals("[T7] TransactionReference03", "WD15", transaction7.Reference3);
			AssertEquals("AdditionalRefs should be as expected",
				"{\"Warehouse Name\":\"Warehouse 1\"}"
				, transaction7.AdditionalRefs);

			var transaction8 = FindRowByRef2(transactions, "#15.2");
