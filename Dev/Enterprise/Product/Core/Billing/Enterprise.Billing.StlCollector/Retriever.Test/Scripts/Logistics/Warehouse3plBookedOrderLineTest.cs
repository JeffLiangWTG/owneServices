...
{
	[TestedType(typeof(Warehouse3plBookedOrderLine))]
	sealed class Warehouse3plBookedOrderLineTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			CreateDocketLineForDocket(physicalOrder1, "U01", "DEP", 11, 1);
			CreateDocketLineForDocket(physicalOrder1, "U02", "DEP", 11, 2);
			CreateDocketLineForDocket(physicalOrder2, "U03", "DEP", 12, 1);
			CreateDocketLineForDocket(physicalOrder3, "U04", "DEP", 13, 1);
			CreateDocketLineForDocket(physicalOrder4, "U05", "DEP", 14, 1);
			CreateDocketLineForDocket(physicalOrder5, "U06", "FIN", 15, 1);
			CreateDocketLineForDocket(physicalOrder6, "U07", "DEP", 16, 1);
			CreateDocketLineForDocket(physicalOrder7, "U08", "DEP", 17, 1);
			CreateDocketLineForDocket(physicalOrder8, "U09", "DEP", 18, 1);
			CreateDocketLineForDocket(physicalOrder9, "U010", "", 19, 1, isFinalised: false);
			CreateDocketLineForDocket(physicalOrder10, "U11", "DEP", 110, 1);
			CreateDocketLineForDocket(physicalOrder11, "U12", "DEP", 111, 1);
			CreateDocketLineForDocket(physicalOrder12, "U13", "FIN", 112, 1);

			var parentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U14", "DEP", 30, 1);
			var componentLine = CreateDocketLineForDocket(pickedOnSaleOrder1, "U14", "DEP", 30, 2, parentLine: parentLine);
			CreateReceiveFromPickByBOM(orgHeader.PK, whs1, "REC01", physicalPick1);

			var parentLine2 = CreateDocketLineForDocket(pickedOnSaleOrder2, "U15", "DEP", 31, 1);
			var componentLine2 = CreateDocketLineForDocket(pickedOnSaleOrder2, "U15", "DEP", 31, 2, parentLine: parentLine2);
			...
			CreateDocketLineForDocket(virtualOrder1, "U01", "DEP", 21, 1);
			CreateDocketLineForDocket(virtualOrder1, "U02", "DEP", 21, 2);
			CreateDocketLineForDocket(virtualOrder2, "U03", "DEP", 22, 1);
			CreateDocketLineForDocket(virtualOrder3, "U04", "DEP", 23, 1);
			CreateDocketLineForDocket(virtualOrder4, "U05", "DEP", 24, 1);
			CreateDocketLineForDocket(virtualOrder5, "U06", "FIN", 25, 1);
			CreateDocketLineForDocket(virtualOrder6, "U07", "DEP", 26, 1);
			CreateDocketLineForDocket(virtualOrder7, "U08", "DEP", 27, 1);
			CreateDocketLineForDocket(virtualOrder8, "U09", "DEP", 28, 1);
			CreateDocketLineForDocket(virtualOrder9, "U10", "", 29, 1, isFinalised: false);
			CreateDocketLineForDocket(virtualOrder10, "U11", "DEP", 210, 1);
			CreateDocketLineForDocket(virtualOrder11, "U12", "DEP", 211, 1);
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction10 = FindRowByRef2(transactions, "#31.1");
			AssertEquals("[T10] CompanyCode", "DEM", transaction10.GetCompanyCode());
			AssertEquals("[T10] BranchCode", "DEM", transaction10.GetBranchCode());
			AssertEquals("[T10] TransactionDateUtc", new DateTime(Now.Year, Now.Month, Now.Day, 1, 25, 0), transaction10.ServiceOccuredUTC);
			AssertEquals("[T10] UserCode", "U15", transaction10.ClientStaffCode);
			...
			AssertEquals("[T10] TransactionReference03", "WDP14", transaction10.Reference3);
			AssertEquals("AdditionalRefs should be as expected",
				"{\"Warehouse Name\":\"Warehouse 1\"}"
				, transaction10.AdditionalRefs);

			var transaction11 = FindRowByRef2(transactions, "#31.2");
