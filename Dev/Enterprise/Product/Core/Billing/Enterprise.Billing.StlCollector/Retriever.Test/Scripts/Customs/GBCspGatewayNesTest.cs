...
namespace Enterprise.Billing.StlCollector.Retriever.Customs
{
	[TestedType(typeof(GBCspGatewayNesDeclarations))]
	sealed class GBCspGatewayNesDeclarationsTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_AddInfo, JE_DeclarationReference, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey) VALUES
					(newid(), 'GB', 'Gateway=NES', 'DEC01', @GbPkGb, @GcPkGb, '2014-03-10', 'US1', 1),
					(newid(), 'AU', 'Gateway=NES', 'DEC02', @GbPkAu, @GcPkAu, '2014-03-10', 'US2', 2),
					(newid(), 'GB', 'Gateway=NES', 'DEC03', @GbPkGb, @GcPkGb, '2014-04-10', 'US3', 3),
					(newid(), 'GB', 'Gateway=XXX', 'DEC04', @GbPkGb, @GcPkGb, '2014-03-10', 'US4', 4);";
