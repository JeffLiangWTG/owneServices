...
{
	[TestedType(typeof(ForwarderGeneralShipmentDisbursement_Pre_24_11_28_88))]
	sealed class ForwarderGeneralShipmentDisbursement_Pre_24_11_28_88Test : RefStlScriptWithDefaultsTest
	{
...
INSERT dbo.JobHeader (JH_PK, JH_GC, JH_ParentID, JH_JobNum, JH_SystemCreateTimeUtc, JH_GB, JH_GE, JH_SystemCreateUser, JH_Status, JH_IsDisbursement) VALUES
	(newid(), @GcPk, @JsPk01, 'SHP01', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0),
	(newid(), @GcPk, @JsPk02, 'SHP02', '2013-12-04', @GbPk, @GePk, 'US2', 'WRK', 1),
	(newid(), @GcPk, @JsPk03, 'SHP04', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0),
	(@JobHeaderPK, @GcPk, @JsPk04, 'SHP05', '2013-12-04', @GbPk, @GePk, 'US2', 'WRK', 1),
	(newid(), @GcPk, @JsPk05, 'SHP07', '2014-01-01', @GbPk, @GePk, 'US1', 'WRK', 0),
