...
{
	[TestedType(typeof(AgencyContainerCount))]
	sealed class AgencyContainerCountTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobShipment (JS_PK, JS_UniqueConsignRef, JS_IsShipping, JS_IsForwardRegistered, JS_IsCFSRegistered) VALUES
					...
					(@JsPk05, 'SHP05', 1, 0, 0),
					(newid(), 'SHP06', 1, 0, 0);
				INSERT dbo.JobContainer (JC_PK, JC_JS_FCLBookingOnlyLink, JC_ContainerNum, JC_SystemCreateTimeUtc, JC_SystemCreateUser) VALUES
					(newid(), @JsPk01, 'JC11', '2014-04-01', 'US1'),
					(newid(), @JsPk01, 'JC13', '2014-04-01', 'US2'),
					(newid(), @JsPk02, 'JC21', '2014-04-02', 'US3'),
					(newid(), @JsPk02, 'JC22', '2014-04-02', 'US4'),
					(newid(), @JsPk03, 'JC32', '2014-04-03', 'US5'),
					(newid(), @JsPk04, 'JC42', '2014-04-04', 'US6'),
					(newid(), @JsPk05, 'JC51', '2014-05-05', 'US7');";
