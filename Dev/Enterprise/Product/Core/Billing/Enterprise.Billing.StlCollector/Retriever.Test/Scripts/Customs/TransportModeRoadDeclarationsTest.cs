...
{
	[TestedType(typeof(TransportModeRoadDeclarations))]
	sealed class TransportModeRoadDeclarationsTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
					...
					INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_TransportMode, JE_DeclarationReference, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey, JE_MessageType) VALUES
						(newid(), 'GB', 'ROA', 'DEC01', @GbPkGb, @GcPkGb, '2014-03-10', 'US1', 1, 'IMP'),
						(newid(), 'AU', 'ROA', 'DEC02', @GbPkAu, @GcPkAu, '2014-03-10', 'US2', 2, 'IMP'),
						(newid(), 'GB', 'ROA', 'DEC03', @GbPkGb, @GcPkGb, '2014-04-10', 'US3', 3, 'IMP'),
						(newid(), 'GB', 'SEA', 'DEC04', @GbPkGb, @GcPkGb, '2014-03-10', 'US4', 4, 'IMP'),
						(newid(), 'GB', 'TRK', 'DEC05', @GbPkGb, @GcPkGb, '2014-03-10', 'US5', 5, 'IMP');";
