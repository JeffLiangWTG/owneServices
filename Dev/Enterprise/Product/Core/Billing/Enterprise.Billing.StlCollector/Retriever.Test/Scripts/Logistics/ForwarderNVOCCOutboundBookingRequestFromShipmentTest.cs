...
{
	[TestedType(typeof(ForwarderNVOCCOutboundBookingRequestFromShipment))]
	sealed class ForwarderNVOCCOutboundBookingRequestFromShipmentTest : RefStlScriptWithDefaultsTest
	{
...
INSERT dbo.RefShippingLine (RSL_PK, RSL_CarrierName, RSL_CargoWiseOneCode, RSL_IsSystem, RSL_IsActive, RSL_IsNVO, RSL_IsShippingLine, RSL_BookingRequestAvailable) VALUES
	...
	(@RslPk04, 'SF', 'SF1', 0, 1, 1, 0, 0),
	(@RslPk05, 'JD', 'JD1', 0, 1, 1, 0, 1),
...
INSERT dbo.OrgHeader (OH_PK, OH_IsActive, OH_Code, OH_FullName, OH_IsShippingLine, OH_IsSeaWholesaler, OH_RSL_ShippingLine) VALUES
	...
	(@OhPk04, 1, 'SFC1C', 'SF C1C', 0, 1, @RslPk04),
	(@OhPk05, 1, 'JDC1C', 'JD C1C', 0, 1, @RslPk05),
	(@OhPk06, 1, 'ABC1C', 'AB C1C', 1, 1, @RslPk06);
...
INSERT dbo.OrgAddress (OA_PK, OA_OH, OA_IsActive, OA_Address1, OA_Address2, OA_City, OA_PostCode, OA_RN_NKCountryCode) VALUES
	...
	(@OaPk4, @OhPk04, 1, '20', 'SF', 'leM', 4000, 'AU'),
	(@OaPk5, @OhPk05, 1, '20', 'JD', 'elM', 4000, 'AU'),
	(@OaPk6, @OhPk06, 1, '20', 'JD', 'elM', 4000, 'AU');
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	...
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 01:23:00', @JsPk01, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-02-09 02:23:00', @JsPk02, 'MSN', '|DEP=WiseTechGlobal|MST=BOOKING REQUEST', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk02, 'ISN', '|DEP=WiseTechGlobal|MST=BOOKING REQUEST', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 03:23:00', @JsPk02, 'MSN', '|DEP=WiseTechGlobal|MST=booking request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 03:23:00', @JsPk02, 'ISN', '|DEP=WiseTechGlobal|MST=booking request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 00:00:00', @JsPk03, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 01:00:00', @JsPk03, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 01:23:00', @JsPk04, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk04, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 02:23:00', @JsPk05, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk05, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-02-08 02:23:00', @JsPk06, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-02-09 02:23:00', @JsPk06, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-04-09 01:23:00', @JsPk07, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-04-09 02:23:00', @JsPk07, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 02:23:00', @JsPk08, 'MSN', '|DEP=WiseTechGlobal|MST=Shipping Instruction', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk08, 'ISN', '|DEP=WiseTechGlobal|MST=Shipping Instruction', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 01:23:00', @JsPk09, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk09, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-01-09 02:23:00', @JsPk10, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-09 02:23:00', @JsPk10, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 00:23:00', @JsPk11, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 11:23:00', @JsPk11, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 00:23:00', @JsPk12, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'Y'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 12:23:00', @JsPk12, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'Y'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 00:23:01', @JsPk13, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 12:23:01', @JsPk13, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 00:23:02', @JsPk14, 'MSN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N'),
	(NEWID(), 'JobShipment', getdate(), '2021-03-08 12:23:02', @JsPk14, 'ISN', '|DEP=WiseTechGlobal|MST=Booking Request', 'SY1', 'N');
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			Assert("SHP08 hasn't received ISN Booking Request event", transactions.All(t => t.Reference1 != "SHP08"));
			Assert("SHP09 is not SEA shipment", transactions.All(t => t.Reference1 != "SHP09"));
			Assert("SHP10 doesn't have MSN event in one month before ISN", transactions.All(t => t.Reference1 != "SHP10"));
			Assert("SHP11's RSL_BookingRequestAvailable is false", transactions.All(t => t.Reference1 != "SHP11"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-3] TransactionReference01", "SHP12", transaction4.Reference1);
				AssertEquals("[Row-3] TransactionReference02", "REF12", transaction4.Reference2);
				AssertEquals("[Row-3] TransactionReference03", "HB12", transaction4.Reference3);
				AssertEquals("[Row-3] TransactionReference04", "Booking Request", transaction4.Reference4);
				AssertEquals("[Row-3] AdditionalRefs", "{\"ShipmentNumber\":\"SHP12\",\"ShipmentType\":\"STD\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"LCL\",\"Origin\":\"AUSYD\",\"Destination\":\"USLAX\",\"ReferenceNumber\":\"REF12\",\"HouseBillNumber\":\"HB12\",\"Carrier\":{\"OrgCode\":\"JDC1C\",\"C1CCode\":\"JDCU\"},\"IsNVO\":1}"
					, transaction4.AdditionalRefs);

				var transaction5 = FindRowByOccured(transactions, new DateTime(2021, 3, 8, 12, 23, 02));
				...
				AssertEquals("[Row-4] AdditionalRefs", "{\"ShipmentNumber\":\"SHP14\",\"ShipmentType\":\"STD\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"LCL\",\"Origin\":\"AUSYD\",\"Destination\":\"USLAX\",\"ReferenceNumber\":\"REF14\",\"HouseBillNumber\":\"HB14\",\"Carrier\":{\"OrgCode\":\"ABC1C\",\"C1CCode\":\"JDCU\"},\"IsNVO\":1}"
