...
{
	[TestedType(typeof(OneOffQuoteLinkedToBooking))]
	sealed class OneOffQuoteLinkedToBookingTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			...
			INSERT dbo.JobShipment (JS_PK, JS_ShipmentType, JS_RL_NKOrigin, JS_UniqueConsignRef, JS_IsBooking, JS_TH_OneTimeQuote) VALUES
				(@JsPk01, 'HVL', 'AUSYD', 'Consign1', 1, null),
				(@JsPk02, 'STD', 'AUSYD', 'Consign2', 1, null),
				(@JsPk03, 'STD', 'AUSYD', 'Consign3', 1, null),
				(@JsPk04, 'STD', 'AUSYD', 'Consign4', 1, @ThPk07);
