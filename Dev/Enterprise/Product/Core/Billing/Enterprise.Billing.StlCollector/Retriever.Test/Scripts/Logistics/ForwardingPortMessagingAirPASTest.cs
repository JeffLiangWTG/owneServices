...
{
	[TestedType(typeof(ForwardingPortMessagingAirPAS))]
	sealed class ForwardingPortMessagingAirPASTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-1] TransactionReference03", "STU - TYP01", row1.Reference3);
				AssertEquals("[Row-1] TransactionReference04", "JK_MasterBillNum_01 - CRF01", row1.Reference4);
				...
				AssertEquals("[Row-2] TransactionReference03", "STU - TYP02", row2.Reference3);
				...
				AssertEquals("[Row-3] TransactionReference04", "JK_MasterBillNum_02 - CRF03", row3.Reference4);
				...
				AssertEquals("[Row-4] TransactionReference03", "MAA - TYP04", row4.Reference3);
				AssertEquals("[Row-4] TransactionReference04", "JK_MasterBillNum_02 - CRF04", row4.Reference4);
				...
				AssertEquals("[Row-5] TransactionReference03", "STU - TYP05", row5.Reference3);
				AssertEquals("[Row-5] TransactionReference04", "JK_MasterBillNum_02 - CRF05", row5.Reference4);
			});
		}
...
DECLARE @LogPK08 UNIQUEIDENTIFIER = 'C297DD28-2C6F-4D90-A2C9-9F522D09D3C9';
...
(@LogPK01, 'JobDocumentData', getdate(), '2023-01-10 00:00:01', @JddPk01, 'STU', '|MST=Export Notification (755)|LOC=CN001|TYP=TYP01|CRF=CRF01', 'GB1', 'N'), -- SL_GB_NKBranch condition[GB_RL_NKHomePort = JK_RL_NKLoadPort]        
(@LogPK02, 'JobDocumentData', getdate(), '2023-01-10 00:00:02', @JddPk02, 'STU', '|MST=Export Notification (755)|LOC=CN002|TYP=TYP02', 'GB1', 'N'), -- no CRF & SL_GB_NKBranch condition[GB_RL_NKHomePort = JS_RL_NKOrigin] 
(@LogPK03, 'JobDocumentData', getdate(), '2023-01-10 00:00:03', @JddPk03, 'MAA', '|MST=Export Notification (755)|LOC=CN003|CRF=CRF03', 'GB2', 'N'), -- no TYP & MAA & SL_GB_NKBranch condition[GY_RL_NKAdditionalBranchRelatedPort = JK_RL_NKLoadPort]
(@LogPK04, 'JobDocumentData', getdate(), '2023-01-10 00:00:04', @JddPk04, 'MAA', '|MST=Export Notification (755)|LOC=CN004|TYP=TYP04|CRF=CRF04', 'GB2', 'N'), -- MAA & SL_GB_NKBranch condition[GY_RL_NKAdditionalBranchRelatedPort = JS_RL_NKOrigin]
(@LogPK05, 'JobDocumentData', getdate(), '2023-01-10 00:00:05', @JddPk04, 'STU', '|MST=Export Notification (755)|LOC=CN005|TYP=TYP05|CRF=CRF05', 'XXX', 'N'), -- SL_GB_NKBranch query by MSN log
(@LogPK06, 'JobDocumentData', getdate(), '2023-01-09 00:00:05', @JddPk04, 'MSN', '|MST=Export Notification (755)|LOC=CN005|TYP=TYP05|CRF=CRF05', 'GB3', 'N'), -- MSN log
(@LogPK07, 'JobDocumentData', getdate(), '2023-01-09 00:00:07', @JddPk01, 'STU', '|MST=XXX1|STA=ORG|LOC=CN007|TYP=TYP01|CRF=CRF01', 'GB1', 'N'), -- not MST=Export Notification (755)
(@LogPK08, 'JobDocumentData', getdate(), '2023-01-09 00:00:09', @JddPk01, 'IRA', '|MST=Export Notification (755)|STA=XXX|LOC=CN009|TYP=TYP01|CRF=CRF01', 'GB1', 'N'); -- not in (STU, MAA)
