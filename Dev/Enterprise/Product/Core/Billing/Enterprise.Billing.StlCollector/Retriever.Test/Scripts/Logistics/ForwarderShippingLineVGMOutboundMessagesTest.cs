...
{
	[TestedType(typeof(ForwarderShippingLineVGMOutboundMessages))]
	sealed class ForwarderShippingLineVGMOutboundMessagesTest : RefStlScriptWithDefaultsTest
	{
...
DECLARE @RcPk05 UNIQUEIDENTIFIER = newid();
...
INSERT dbo.OrgAddress (OA_PK, OA_OH, OA_IsActive, OA_Address1, OA_Address2, OA_City, OA_PostCode, OA_RN_NKCountryCode) VALUES
	...
	(@OaPk7, @OhPk07, 1, '30', 'SF', 'SF', 3000, 'AU'),
	(@OaPk8, @OhPk08, 1, '30', 'JD', 'JD', 3000, 'AU'),
...
INSERT dbo.OrgCusCode (OK_PK, OK_IsValid, OK_CustomsRegNo, OK_CodeType, OK_RN_NKCodeCountry, OK_OH) VALUES
	...
	(NEWID(), 1, 'SF', 'C1C', 'AU', @OhPk07),
	(NEWID(), 1, 'JD', 'C1C', 'AU', @OhPk08),
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	...
	(newid(), 'JobContainer', getdate(), '2021-03-08 01:23:00', @JcPk01, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 02:23:00', @JcPk11, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 03:23:00', @JcPk11, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-09 02:23:00', @JcPk02, 'MSN', 'MST=VERIFIED GROSS CONTAINER WEIGHT', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk02, 'ISN', 'MST=VERIFIED GROSS CONTAINER WEIGHT', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-08 02:23:00', @JcPk03, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-02-09 02:23:00', @JcPk03, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 01:23:00', @JcPk04, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk04, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 02:23:00', @JcPk05, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk05, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-04-09 01:23:00', @JcPk06, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-04-09 02:23:00', @JcPk06, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 02:23:00', @JcPk07, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk07, 'MRJ', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 01:23:00', @JcPk08, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-09 02:23:00', @JcPk08, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-07 01:23:00', @JcPk09, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 01:23:00', @JcPk09, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-01-08 01:23:00', @JcPk10, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 01:23:00', @JcPk10, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk12, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 12:23:00', @JcPk12, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:00', @JcPk13, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'Y'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:00', @JcPk13, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'Y'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:01', @JcPk14, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:01', @JcPk14, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 00:23:02', @JcPk15, 'MSN', 'MST=Verified Gross Container Weight', 'SY1', 'N'),
	(newid(), 'JobContainer', getdate(), '2021-03-08 13:23:02', @JcPk15, 'ISN', 'MST=Verified Gross Container Weight', 'SY1', 'N');
...
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			Assert("CON03 container's VGM message PostedTime is not in DateTime range", !transactions.Any(t => t.Reference1 == "CON03"));
			...
			Assert("CON06 container's VGM message PostedTime is not in DateTime range", !transactions.Any(t => t.Reference1 == "CON06"));
			Assert("CON07 container hasn't received ISN with MST=Verified Gross Container Weight event", !transactions.Any(t => t.Reference1 == "CON07"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-0] TransactionReference04", "Verified Gross Container Weight", transaction1.Reference4);
				AssertEquals("[Row-0] AdditionalRefs", "{\"ConsolNumber\":\"CON01\",\"ContainerNumber\":\"HLCJ001\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B01\",\"CoLoadBookingConfirmationReference\":\"CB01\",\"WayBillNumber\":\"M01\",\"CoLoadMasterBillNumber\":\"CM01\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"VMLCCC\",\"C1CCode\":\"HLCU\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-1] TransactionReference03", "HLCJ011", transaction2.Reference3);
				AssertEquals("[Row-1] TransactionReference04", "Verified Gross Container Weight", transaction2.Reference4);
				AssertEquals("[Row-1] AdditionalRefs", "{\"ConsolNumber\":\"CON01\",\"ContainerNumber\":\"HLCJ011\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B01\",\"CoLoadBookingConfirmationReference\":\"CB01\",\"WayBillNumber\":\"M01\",\"CoLoadMasterBillNumber\":\"CM01\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"VMLCCC\",\"C1CCode\":\"HLCU\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-2] TransactionReference03", "HLCJ002", transaction3.Reference3);
				AssertEquals("[Row-2] TransactionReference04", "Verified Gross Container Weight", transaction3.Reference4);
				AssertEquals("[Row-2] AdditionalRefs", "{\"ConsolNumber\":\"CON02\",\"ContainerNumber\":\"HLCJ002\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B02\",\"CoLoadBookingConfirmationReference\":\"CB02\",\"WayBillNumber\":\"M02\",\"CoLoadMasterBillNumber\":\"CM02\",\"CoLoadWith\":{\"OrgCode\":\"KMJC1C\",\"C1CCode\":\"DYUI\"},\"ShippingLine\":{\"OrgCode\":\"VMLC1C\",\"C1CCode\":\"XXCU\"},\"IsNVO\":0}",
				...
				AssertEquals("[Row-3] TransactionReference04", "Verified Gross Container Weight", transaction4.Reference4);
				AssertEquals("[Row-3] AdditionalRefs", "{\"ConsolNumber\":\"CON13\",\"ContainerNumber\":\"HLCJ013\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B13\",\"CoLoadBookingConfirmationReference\":\"CB13\",\"WayBillNumber\":\"M13\",\"CoLoadMasterBillNumber\":\"CM13\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"JDC1C\",\"C1CCode\":\"JD\"},\"IsNVO\":0}",
			transaction4.AdditionalRefs);
				...
				AssertEquals("[Row-4] TransactionReference04", "Verified Gross Container Weight", transaction5.Reference4);
				AssertEquals("[Row-4] AdditionalRefs", "{\"ConsolNumber\":\"CON15\",\"ContainerNumber\":\"HLCJ015\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B15\",\"CoLoadBookingConfirmationReference\":\"CB15\",\"WayBillNumber\":\"M15\",\"CoLoadMasterBillNumber\":\"CM15\",\"CoLoadWith\":{\"OrgCode\":\"KMJCCC\",\"C1CCode\":\"GLOU\"},\"ShippingLine\":{\"OrgCode\":\"IQC1C\",\"C1CCode\":\"IQ\"},\"IsNVO\":0}",
