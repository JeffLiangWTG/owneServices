...
{
	[TestedType(typeof(ComplianceRiskCommoditiesUsageCollector))]
	class ComplianceRiskCommoditiesUsageCollectorTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction23 = FindRowsByRef1(transactions, "TH01");
			var transaction2 = FindRowByOccured(transaction23, new DateTime(2023, 3, 8));
			var transaction3 = FindRowByOccured(transaction23, new DateTime(2023, 3, 9));
			var transaction4 = FindRowByRef1(transactions, "TH02");
			var transaction567 = FindRowsByRef1(transactions, "SHP03");
			var transaction5 = FindRowByOccured(transaction567, new DateTime(2023, 3, 22));
			var transaction6 = FindRowByOccured(transaction567, new DateTime(2023, 3, 23));
			var transaction7 = FindRowByOccured(transaction567, new DateTime(2023, 3, 24));
			var transaction8 = FindRowByRef1(transactions, "SHP04");

			AssertRow(transaction1, "1", "DEM", "DEM", new DateTime(2023, 3, 1), "US1", 2, "SHP01", null, "2022-01-02", "JS");
			AssertRow(transaction2, "2", "DEM", "DEM", new DateTime(2023, 3, 8), "US2", 1, "TH01", "SHP02", "2022-01-03", "TH");
			AssertRow(transaction3, "3", "DEM", "DEM", new DateTime(2023, 3, 9), "US2", 9, "TH01", "SHP02", "2022-01-03", "TH");
			AssertRow(transaction4, "4", "DEM", "DEM", new DateTime(2023, 3, 15), "US3", 1, "TH02", null, "2022-01-04", "TH");
			AssertRow(transaction5, "5", null, null, new DateTime(2023, 3, 22), "US4", 1, "SHP03", null, null, "JS");
			AssertRow(transaction6, "6", null, null, new DateTime(2023, 3, 23), "US4", 2, "SHP03", null, null, "JS");
			AssertRow(transaction7, "7", null, null, new DateTime(2023, 3, 24), "US4", 1, "SHP03", null, null, "JS");
			AssertRow(transaction8, "8", null, null, new DateTime(2023, 3, 31), "US5", 1, "SHP04", null, null, "JS");
		}
		...
		protected override void PrepareTestData()
		{
			var sqlQuery = $@"
				...
				INSERT INTO dbo.[StmComplianceEvent] ([SCE_PK], [SCE_ParentTableCode], [SCE_ParentID], [SCE_EventType], [SCE_EventSubType], [SCE_EventReference], [SCE_ItemsCount], [SCE_EventTimeOffset], [SCE_SystemCreateUser], [SCE_SystemCreateTimeUtc], [SCE_SystemLastEditUser], [SCE_SystemLastEditTimeUtc])
				VALUES
				(newid(), 'JS', '{shipment1}', 'CVO', 'CPC', 'XXX', 2, '2023-03-01 00:00:00', 'US1', GetUtcDate(), 'US1', GetUtcDate()),
				(newid(), 'TH', '{ratingHeader1}', 'CVO', 'CPC', 'XXX', 1, '2023-03-08 00:00:00', 'US2', GetUtcDate(), 'US2', GetUtcDate()),
				(newid(), 'TH', '{ratingHeader1}', 'CVO', 'CPC', 'XXX', 9, '2023-03-09 00:00:00', 'US2', GetUtcDate(), 'US2', GetUtcDate()),
				(newid(), 'TH', '{ratingHeader2}', 'CVO', 'CPC', 'XXX', 1, '2023-03-15 00:00:00', 'US3', GetUtcDate(), 'US3', GetUtcDate()),
				(newid(), 'JS', '{shipment3}', 'CVO', 'CPC', 'XXX', 1, '2023-03-22 00:00:00', 'US4', GetUtcDate(), 'US4', GetUtcDate()),
				(newid(), 'JS', '{shipment3}', 'CVO', 'CPC', 'XXX', 2, '2023-03-23 00:00:00', 'US4', GetUtcDate(), 'US4', GetUtcDate()),
				(newid(), 'JS', '{shipment3}', 'CVO', 'CPC', 'XXX', 1, '2023-03-24 00:00:00', 'US4', GetUtcDate(), 'US4', GetUtcDate()),
				(newid(), 'JS', '{shipment4}', 'CVO', 'CPC', 'XXX', 1, '2023-03-31 00:00:00', 'US5', GetUtcDate(), 'US5', GetUtcDate()),
				(newid(), 'JS', NEWID(), 'CVO', 'CPC', 'XXX', 1, '2023-03-01 00:00:00', 'US1', GetUtcDate(), 'US1', GetUtcDate()),
				(newid(), 'JS', '{shipment5}', 'CVO', 'CPC', 'XXX', 1, '2023-02-28 00:00:00', 'US1', GetUtcDate(), 'US1', GetUtcDate()),
				(newid(), 'JS', '{shipment5}', 'CVO', 'CPC', 'XXX', 1, '2023-04-01 00:00:00', 'US1', GetUtcDate(), 'US1', GetUtcDate())
";
