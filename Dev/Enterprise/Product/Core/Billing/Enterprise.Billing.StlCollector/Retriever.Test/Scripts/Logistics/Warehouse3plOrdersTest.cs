...
{
	[TestedType(typeof(Warehouse3plOrders))]
	sealed class Warehouse3plOrdersTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			var physicalPick4 = new WhsPick(whs1, "4", "FIN") { WP_FinalizedDateUtc = new DateTime(beforeQueryPeriod.Year, beforeQueryPeriod.Month, 01), WP_GS_NKFinalizedBy = "A" }.InsertAndReturnObject(TestConnection);
			var physicalPick5 = new WhsPick(whs1, "5", "FIN") { WP_FinalizedDateUtc = new DateTime(afterQueryPeriod.Year, afterQueryPeriod.Month, 01), WP_GS_NKFinalizedBy = "A" }.InsertAndReturnObject(TestConnection);
			var physicalPick6 = new WhsPick(whs1, "6", "ENT") { WP_FinalizedDateUtc = null }.InsertAndReturnObject(TestConnection);
			var physicalPick7 = new WhsPick(whs1, "7", "FIN") { WP_FinalizedDateUtc = new DateTime(year, month, day, 02, 26, 00), WP_GS_NKFinalizedBy = "A" }.InsertAndReturnObject(TestConnection);
			...
			var physicalOrder2 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick2.PK, null, "ORD", "ORD", "BLK", "DEP", "WD02", "US2"); // pick finalised bulk order
			var physicalOrder3 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick3.PK, null, "ORD", "CUS", "BLK", "DEP", "WD03", "US3"); // pick finalised customs bulk order
			var physicalOrder4 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick4.PK, null, "ORD", "REP", "BLK", "DEP", "WD04", "US4"); // pick finalised bulk order, finalised date out of bounds - before query date
			var physicalOrder5 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick5.PK, null, "ORD", "ORD", "BLK", "DEP", "WD05", "US5"); // pick finalised bulk order, finalised date out of bounds - after query date
			var physicalOrder6 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick6.PK, null, "ORD", "ORD", "BLK", "ATP", "WD06", "US6"); // pick not finalised bulk order
			var physicalOrder7 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick2.PK, null, "ORD", "ORD", "ECO", "DEP", "WD07", "US7"); // pick finalised eCommerce order
			var physicalOrder8 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick2.PK, null, "ORD", "ORD", "UNK", "DEP", "WD08", "US8"); // pick finalised unknown order
			var physicalOrder9 = CreateDocketForPick(orgHeader.PK, whs1.PK, null, null, "ORD", "ORD", "", "ENT", "WD9", "US9", isFinalised: false); // unpicked order
			var physicalOrder10 = CreateDocketForPick(orgHeader.PK, whs1.PK, physicalPick7.PK, null, "ORD", "ORD", "BLK", "DEP", "WD10", "U10"); // pick finalised booked ecommerce order
			var virtualOrder1 = CreateDocketForPick(orgHeader.PK, whs2.PK, virtualPick1.PK, null, "ORD", "ORD", "BLK", "DEP", "WD11", "U11"); // virtual pick finalised bulk order
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			var transaction2 = FindRowByRef2(transactions, "WD10");
			AssertEquals("CompanyCode", "DEM", transaction2.GetCompanyCode());
			AssertEquals("BranchCode", "DEM", transaction2.GetBranchCode());
			AssertEquals("TransactionDateUtc", new DateTime(Now.Year, Now.Month, Now.Day, 2, 26, 0), transaction2.ServiceOccuredUTC);
			AssertEquals("UserCode", "U10", transaction2.ClientStaffCode);
			...
			var transaction3 = FindRowByRef2(transactions, "WD11");
			...
			AssertEquals("UserCode", "U11", transaction3.ClientStaffCode);
