...
{
	[TestedType(typeof(HVLVImportSeaFreightManifestConsignments))]
	sealed class HVLVImportSeaFreightManifestConsignmentsTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			...
			INSERT dbo.JobShipment (JS_PK, JS_ShipmentType, JS_TransportMode, JS_RL_NKDestination, JS_IsForwardRegistered, JS_UniqueConsignRef) VALUES 
				(@JsPk01, 'HLS', 'SEA', 'AUSYD', 1, 'Consign1'),
				(@JsPk02, 'STD', 'SEA', 'AUSYD', 1, 'Consign2'),
				(@JsPk03, 'HLS', 'SEA', 'USAAA', 1, 'Consign3'),
				(@JsPk04, 'HLS', 'AIR', 'AUSYD', 1, 'Consign4'),
				(@JsPk05, 'STD', 'SEA', 'AUSYD', 1, 'Consign5'),
				(@JsPk06, 'HLS', 'AIR', 'USAAA', 0, 'Consign6'),
				(@JsPk07, 'HLS', 'SEA', 'AUSYD', 1, 'Consign7'),
				(@JsPk08, 'STD', 'SEA', 'AUSYD', 1, 'Consign8'),
				(@JsPk09, 'HLS', 'SEA', 'USAAA', 1, 'Consign9'),
				(@JsPk10, 'HLS', 'SEA', 'AUSYD', 0, 'Consign10'),
				(@JsPk11, 'STD', 'SEA', 'AUSYD', 1, 'Consign11'),
			...
			INSERT dbo.SupplierBookingLine (DL_PK, DL_JS_ApprovedShipment, DL_ConsigneeReference, DL_SystemCreateUser, DL_DH_BookingHeader, DL_SystemCreateTimeUtc, DL_SystemLastEditTimeUtc) VALUES
				...
				(@DLPk06, @JsPk06, 'Consignee6', 'US6', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk07, @JsPk07, 'Consignee7', 'US7', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk08, @JsPk08, 'Consignee8', 'US8', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk09, @JsPk09, 'Consignee9', 'US9', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk10, @JsPk10, 'Consignee10', 'US9', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk11, @JsPk11, 'Consignee11', 'US9', @DhPk01, '2013-10-03', '2013-10-03'),
				(@DLPk12, @JsPk12, 'Consignee12', 'US9', @DhPk01, '2013-10-03', '2013-10-03');
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertEquals("[T2] TransactionDateUtc", new DateTime(2013, 10, 3), transaction2.ServiceOccuredUTC);
			AssertEquals("[T2] TransactionReference02", "Consign7", transaction2.Reference2);
			...
			AssertEquals("[T2] TransactionGuidReference", DLPk07, Guid.Parse(transaction2.Reference5));
