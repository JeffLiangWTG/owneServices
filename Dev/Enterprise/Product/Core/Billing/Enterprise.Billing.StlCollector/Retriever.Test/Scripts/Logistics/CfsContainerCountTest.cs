...
{
	[TestedType(typeof(CfsContainerCount))]
	sealed class CfsContainerCountTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobContainer (JC_PK, JC_JK, JC_ContainerNum, JC_SystemCreateTimeUtc, JC_SystemCreateUser) VALUES
					(newid(), @JkPk01, 'JC11', '2014-02-01', 'US1'),
					(newid(), @JkPk02, 'JC21', '2014-03-02', 'US2'),
					(newid(), @JkPk02, 'JC22', '2014-02-02', 'US3'),
					(newid(), @JkPk03, 'JC31', '2014-02-03', 'US4');";
