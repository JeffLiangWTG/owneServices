...
{
	[TestedType(typeof(eTailExportAirSeaFreightManifestConsignments))]
	sealed class eTailExportAirSeaFreightManifestConsignmentsTest : RefStlScriptWithDefaultsTest
	{
