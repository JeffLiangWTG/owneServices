...
{
	[TestedType(typeof(CargoReceiptAdviceSent))]
	sealed class CargoReceiptAdviceSentTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-0] TransactionReference04", "Cargo Receipt Advice - ORG", row0.Reference4);
				...
				AssertEquals("[Row-1] TransactionReference04", "Cargo Receipt Advice - WTH", row1.Reference4);
				...
				AssertEquals("[Row-2] TransactionReference04", "Cargo Receipt Advice - WTH", row2.Reference4);
				...
				AssertEquals("[Row-3] TransactionReference04", "Cargo Receipt Advice - WTH", row3.Reference4);
				...
				AssertEquals("[Row-4] TransactionReference04", "Cargo Receipt Advice - WTH", row4.Reference4);
				...
				AssertEquals("[Row-5] TransactionReference04", "Cargo Receipt Advice - WTH", row5.Reference4);
			});
		}
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(newid(), 'JobDocumentData', getdate(), '2023-04-03 12:01:00', @JddPk01, 'ISN', '|MST=Cargo Receipt Advice|STA=ORG|DEP=CargoWise', 'GB0', 'Y'), -- 00
	(newid(), 'JobDocumentData', getdate(), '2023-04-12 12:02:00', @JddPk01, 'ISN', '|MST=Cargo Receipt Advice|STA=WTH|DEP=CargoWise', 'GB0', 'N'),  -- 01
	(newid(), 'JobDocumentData', getdate(), '2023-03-01 12:03:00', @JddPk02, 'ISN', '|MST=Cargo Receipt Advice|STA=ORG|DEP=CargoWise', 'GB0', 'N'), -- Before date range
	(newid(), 'JobDocumentData', getdate(), '2023-05-01 12:04:00', @JddPk03, 'ISN', '|MST=Cargo Receipt Advice|STA=AMD|DEP=CargoWise', 'GB0', 'N'), -- After date range
	(newid(), 'JobDocumentData', getdate(), '2023-04-01 12:05:00', @JddPk04, 'XXX', '|MST=Cargo Receipt Advice|STA=ORG|DEP=CargoWise', 'GB0', 'N'), -- SL_SE_NKEvent is not ISN

	(newid(), 'JobDocumentData', getdate(), '2023-04-12 12:02:00', @JddPk05, 'ISN', '|MST=Cargo Receipt Advice|STA=WTH|DEP=CargoWise', 'GB0', 'N'),  -- 02
	(newid(), 'JobDocumentData', getdate(), '2023-04-12 12:02:00', @JddPk06, 'ISN', '|MST=Cargo Receipt Advice|STA=WTH|DEP=CargoWise', 'GB0', 'N'),  -- 03
	(newid(), 'JobDocumentData', getdate(), '2023-04-12 12:02:00', @JddPk07, 'ISN', '|MST=Cargo Receipt Advice|STA=WTH|DEP=CargoWise', 'GB0', 'N'),  -- 04
	(newid(), 'JobDocumentData', getdate(), '2023-04-12 12:02:00', @JddPk08, 'ISN', '|MST=Cargo Receipt Advice|STA=WTH|DEP=CargoWise', 'GB0', 'N'),  -- 05

	(newid(), 'JobDocumentData', getdate(), '2023-04-03 10:00:00', @JddPk01, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'), -- 00 MSN
	(newid(), 'JobAlien', getdate(), '2023-04-01 10:00:01', @JddPk01, 'MSN', 'MST=Cargo Receipt Advice', 'GB2', 'N'),
	(newid(), 'JobDocumentData', getdate(), '2023-04-10 10:00:00', @JddPk01, 'MSN', 'MST=Cargo Receipt Advice', 'GB2', 'Y'), -- 01 MSN
	(newid(), 'JobDocumentData', getdate(), '2023-04-13 10:00:00', @JddPk01, 'MSN', 'MST=Cargo Receipt Advice', 'GB3', 'N'),
	(newid(), 'JobDocumentData', getdate(), '2023-03-01 10:00:00', @JddPk02, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'),
	(newid(), 'JobDocumentData', getdate(), '2023-04-20 10:00:00', @JddPk03, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'),
	(newid(), 'JobDocumentData', getdate(), '2023-04-01 10:00:00', @JddPk04, 'MSN', 'MST=Cargo Receipt Advice', 'GB2', 'N'),

	(newid(), 'JobDocumentData', getdate(), '2023-04-01 10:00:00', @JddPk05, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'), -- 02 MSN
	(newid(), 'JobDocumentData', getdate(), '2023-04-01 10:00:00', @JddPk06, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'), -- 03 MSN
	(newid(), 'JobDocumentData', getdate(), '2023-04-01 10:00:00', @JddPk07, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'), -- 04 MSN
	(newid(), 'JobDocumentData', getdate(), '2023-04-01 10:00:00', @JddPk08, 'MSN', 'MST=Cargo Receipt Advice', 'GB1', 'N'); -- 05 MSN
