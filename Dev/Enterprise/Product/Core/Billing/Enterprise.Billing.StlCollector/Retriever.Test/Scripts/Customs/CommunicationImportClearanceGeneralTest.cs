...
{
	[TestedType(typeof(CommunicationImportClearanceGeneral))]
	sealed class CommunicationImportClearanceGeneralTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = $@"
				...
				INSERT dbo.JobHeader (JH_PK, JH_GC, JH_ParentID, JH_JobNum, JH_SystemCreateTimeUtc, JH_GB, JH_GE, JH_SystemCreateUser, JH_Status, JH_IsDisbursement) VALUES
					('{JH1}', @GcPkUs, '{JE1}', 'JE01', '2010-02-02', @GbPkPr, @GePk, 'US1', 'WRK', 1),
					('{JH2}', @GcPkUs, '{JE2}', 'JE02', '2010-02-02', @GbPkPr, @GePk, 'US2', 'WRK', 0);
...
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			CombineAssertions(() =>
			{
				...
				AssertRowMatchingRef1(transactions, "7", "USN", "USB", new DateTime(2010, 02, 02), "US9", 1, "DECUS1", "US", transactionReference04: JH1.ToString().ToUpper());
