...
{
	[TestedType(typeof(PortTransportContainerCount))]
	sealed class PortTransportContainerCountTest : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			...
			string sqlText = @"
				...
				INSERT dbo.JobContainer (JC_PK, JC_ContainerNum, JC_SystemCreateTimeUtc, JC_SystemCreateUser) VALUES
					(@jcPk01, 'JC01', '2012-02-01', 'US1'),
					(@jcPk02, 'JC02', '2012-03-02', 'US2'),
					(@jcPk03, 'JC03', '2012-02-03', 'US3'),
					(@jcPk04, 'JC04', '2012-02-04', 'US4');
