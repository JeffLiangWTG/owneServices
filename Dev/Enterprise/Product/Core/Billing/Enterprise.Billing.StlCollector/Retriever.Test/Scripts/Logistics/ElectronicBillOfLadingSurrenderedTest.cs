...
{
	[TestedType(typeof(ElectronicBillOfLadingSurrendered))]
	sealed class ElectronicBillOfLadingSurrenderedTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			AssertNull("The TYP is not 'Surrendered'", transactions.FirstOrDefault(x => x.Reference1 == "JK06"));
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(newid(),'JobConsol', getdate() ,'2024-04-10 05:30:58.563', @JkPk01 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','Y'), -- This is the first BLU Log for this Consol @JkPk01 [0]
	(newid(),'JobConsol', getdate() ,'2024-04-10 05:46:58.563', @JkPk01 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','Y'), -- This is not the first BLU Log for this Consol @JkPk01
	(newid(),'JobConsol', getdate() ,'2024-03-10 04:46:58.563', @JkPk01 ,'ADD','','GB1','N'),

	(newid(),'JobConsol', getdate() ,'2024-03-10 05:46:58.563', @JkPk02 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','Y'),
	(newid(),'JobConsol', getdate() ,'2024-04-10 05:46:58.563', @JkPk02 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- This is not the first BLU Log for this Consol @JkPk02

	(newid(),'JobConsol', getdate() ,'2024-04-10 05:46:58.563', @JkPk03 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- This is the first BLU Log for this Consol @JkPk03 [1]
	(newid(),'JobConsol', getdate() ,'2024-05-10 06:46:58.563', @JkPk03 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'),
	...
	(newid(),'JobConsol', getdate() ,'2024-04-10 05:10:58.563', @JkPk04 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- [2]
	(newid(),'JobConsol', getdate() ,'2024-03-10 04:46:58.563', @JkPk04 ,'ADD','','GB3','N'),

	(newid(),'JobConsol', getdate() ,'2024-04-10 05:55:58.563', @JkPk05 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- [3]
	(newid(),'JobConsol', getdate() ,'2024-03-10 04:46:58.563', @JkPk05 ,'ADD','','GB4','N'),

	(newid(),'JobConsol', getdate() ,'2024-04-10 03:46:58.563', @JkPk06 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- The TYP is not 'Surrendered' @JkPk06
	(newid(),'JobConsol', getdate() ,'2024-04-10 03:46:58.563', @JkPk07 ,'BLU','|DEP=Cargowise|TYP=Surrendered','GB0','N'), -- The DEP is not 'Carrier' @JkPk07
	(newid(),'JobConsol', getdate() ,'2024-04-10 03:46:58.563', @JkPk08 ,'ISN','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- The SL_SE_NKEvent is not 'BLU' @JkPk08
	(newid(),'JobDocumentData', getdate() ,'2024-04-10 03:46:58.563', @JkPk09 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- The SL_Table is not 'JobConsol' @JkPk09
	(newid(),'JobConsol', getdate() ,'2024-04-10 04:46:58.000', @JkPk10 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'), -- The SL_PostedTimeUtc is not in the query time range. @JkPk10
	(newid(),'JobConsol', getdate() ,'2024-04-10 06:00:00.000', @JkPk11 ,'BLU','|DEP=Carrier|TYP=Surrendered','GB0','N'); -- The SL_PostedTimeUtc is not in the query time range. @JkPk11
