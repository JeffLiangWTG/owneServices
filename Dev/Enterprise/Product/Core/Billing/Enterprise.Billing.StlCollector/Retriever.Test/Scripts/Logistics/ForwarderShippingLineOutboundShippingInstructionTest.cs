...
{
	[TestedType(typeof(ForwarderShippingLineOutboundShippingInstruction))]
	sealed class ForwarderShippingLineOutboundShippingInstructionTest : RefStlScriptWithDefaultsTest
	{
...
INSERT dbo.RefShippingLine (RSL_PK, RSL_CarrierName, RSL_CargoWiseOneCode, RSL_IsSystem, RSL_IsActive, RSL_IsNVO, RSL_IsShippingLine, RSL_ShippingInstructionAvailable) VALUES
	...
	(@RslPk07, 'SF', 'S02', 0, 1, 0, 1, 1),
	(@RslPk08, 'JD', 'J02', 0, 1, 0, 1, 0),
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	...
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk01, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk01, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 03:23:00', @JkPk01, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-09 02:23:00', @JkPk02, 'MSN', 'MST=SHIPPING INSTRUCTION', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk02, 'ISN', 'MST=SHIPPING INSTRUCTION', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-08 02:23:00', @JkPk03, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-02-09 02:23:00', @JkPk03, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 01:23:00', @JkPk04, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk04, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk05, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk05, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-04-09 01:23:00', @JkPk06, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-04-09 02:23:00', @JkPk06, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 02:23:00', @JkPk07, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk07, 'MRJ', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 01:23:00', @JkPk08, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-09 02:23:00', @JkPk08, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-07 01:23:00', @JkPk09, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk09, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-01-08 01:23:00', @JkPk10, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 01:23:00', @JkPk10, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:00', @JkPk12, 'MSN', 'MST=Shipping Instruction', 'SY1', 'Y'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 12:23:00', @JkPk12, 'ISN', 'MST=Shipping Instruction', 'SY1', 'Y'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:00', @JkPk13, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 13:23:00', @JkPk13, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:01', @JkPk14, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 12:23:01', @JkPk14, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 00:23:02', @JkPk15, 'MSN', 'MST=Shipping Instruction', 'SY1', 'N'),
	(newid(), 'JobConsol', getdate(), '2021-03-08 12:23:02', @JkPk15, 'ISN', 'MST=Shipping Instruction', 'SY1', 'N');
...
";
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			Assert("CON07 container hasn't received ISN with MST=Shipping Instruction", !transactions.Any(t => t.Reference1 == "CON07"));
			...
			Assert("CON11's RSL_ShippingInstructionAvailable is false", !transactions.Any(t => t.Reference1 == "CON11"));
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-3] AdditionalRefs", "{\"ConsolNumber\":\"CON12\",\"ConsolType\":\"AGT\",\"TransportMode\":\"SEA\",\"ContainerMode\":\"FCL\",\"FirstLoadPort\":\"\",\"LastDiscPort\":\"\",\"CarrierBookingReference\":\"B12\",\"CoLoadBookingConfirmationReference\":\"CB12\",\"WayBillNumber\":\"M12\",\"ShippingLine\":{\"OrgCode\":\"SFC1C\"},\"IsNVO\":0}",
					transaction4.AdditionalRefs);

				var transaction5 = FindRowByOccured(transactions, new DateTime(2021, 3, 8, 12, 23, 2));
				...
				AssertEquals("[Row-4] TransactionReference04", "Shipping Instruction", transaction5.Reference4);
