...
{
	[TestedType(typeof(WarehouseTransitPackagesReceivedAcrossWarehouses_Pre_24_8_10_159))]
	sealed class WarehouseTransitPackagesReceivedAcrossWarehouses_Pre_24_8_10_159Test : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.WhsItemPackageState (WPS_PK, WPS_KP_Package, WPS_WW_Warehouse, WPS_WRC_TransitReceiveConsignment, WPS_Status, WPS_WRH_TransitReceiveHeader, WPS_WL_LastLocation, WPS_UnloadedTime, WPS_UnloadedNotYetProcessedTime, WPS_AdjustedOut, WPS_SystemCreateTimeUtc, WPS_SystemCreateUser, WPS_SystemLastEditTimeUtc, WPS_SystemLastEditUser, WPS_ReceivedAs, WPS_IsHandlingUnit, WPS_UnitType) VALUES
					...
					(newid(), @KP07PackagePK, @Warehouse2PK, @RCN3PK, 'ARV', @RTUWithPackagesAssignedToRCNPK, @LocationPK, '2014-09-30 15:00:00 +00:00', '2014-09-30 15:00:00 +00:00', '', GetUtcDate(), '~BP', GetUtcDate(), '~BP', 'SCN', 0, 'PKG'),
