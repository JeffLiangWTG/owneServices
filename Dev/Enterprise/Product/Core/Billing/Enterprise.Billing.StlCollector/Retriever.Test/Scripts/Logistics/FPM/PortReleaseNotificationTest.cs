...
{
	[TestedType(typeof(PortReleaseNotification))]
	sealed class PortReleaseNotificationTest : RefStlScriptWithDefaultsTest
	{
		...
		protected override void AssertResultSet(IEnumerable<IStlTransaction> transactions)
		{
			...
			CombineAssertions(() =>
			{
				...
				AssertEquals("[Row-0] TransactionReference03", "ATH - aaaaa", row0.Reference3);
				...
				AssertEquals("[Row-1] TransactionReference03", "ATH - bbbbb", row1.Reference3);
				...
				AssertEquals("[Row-2] TransactionReference03", "ATH - zzzzz", row2.Reference3);
				...
				AssertEquals("[Row-3] TransactionReference03", "ATH", row3.Reference3);
				...
				AssertEquals("[Row-4] TransactionReference03", "ATH - fffff", row4.Reference3);
				...
				AssertEquals("[Row-5] TransactionReference03", "ATH - ggggg", row5.Reference3);
...
INSERT dbo.StmALog (SL_PK, SL_Table, SL_EventTime, SL_PostedTimeUtc, SL_Parent, SL_SE_NKEvent, SL_Reference, SL_GB_NKBranch, SL_IsCancelled) VALUES
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=A|LOC=DKAAB|EQN=EQN01|STA=aaaaa|MST=Port', 'GB0', 'N'), -- Org Proxy, Home Port
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|LOC=MARS1|EQN=EQN02|STA=bbbbb|MST=Release', 'GB0', 'N'),
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=Z|EQN=EQN0Z|STA=zzzzz|MST=Notification', 'GB0', 'N'),
	(NEWID(), 'JobContainer', GETDATE(), '2022-12-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=C|LOC=CNSHG|EQN=EQN03|STA=ccccc', 'GB0', 'N'), -- Before
	(NEWID(), 'JobContainer', GETDATE(), '2023-02-02 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=D|LOC=CNSHG|EQN=EQN01|STA=aaaaa', 'GB0', 'N'), -- After
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATW', 'DEP=Terminal|TYP=Container Release|RFN=D|LOC=CNSHG|EQN=EQN01|STA=aaaaa', 'GB0', 'N'), -- SL_SE_NKEvent != 'ATH'
	(NEWID(), 'JobShipment', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=D|LOC=CNSHG|EQN=EQN01|STA=aaaaa', 'GB0', 'N'), -- SL_Table != 'JobContainer'
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=WTG|TYP=Container Release|RFN=D|LOC=CNSHG|EQN=EQN01|STA=aaaaa', 'GB0', 'N'), -- DEP != 'Terminal'
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-10 12:00:00', @JcPk01, 'ATH', 'DEP=Terminal|TYP=Alien|RFN=D|LOC=CNSHG|EQN=EQN01|STA=aaaaa', 'GB0', 'N'), -- TYP != 'Container Release'

	(NEWID(), 'JobContainer', GETDATE(), '2023-01-11 12:00:00', @JcPk02, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=Assens|MST=Withdrawal|LOC=DKASN|EQN=EQN05', 'GB0', 'N'), -- Org Proxy, Additional Related Ports
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-12 12:00:00', @JcPk03, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=Achim|MST=Proxy|LOC=DKCNL|EQN=EQN06|STA=fffff', 'GB0', 'N'), -- Home Port
	(NEWID(), 'JobContainer', GETDATE(), '2023-01-13 12:00:00', @JcPk04, 'ATH', 'DEP=Terminal|TYP=Container Release|RFN=Altdorf|LOC=DKFBG|STA=ggggg', 'GB0', 'N'); -- Additional Related Ports
