...
{
	[TestedType(typeof(CommunicationImportTranshipment_Pre_24_10_22_62))]
	sealed class CommunicationImportTranshipment_Pre_24_10_22_62Test : RefStlScriptWithDefaultsTest
	{
		protected override void PrepareTestData()
		{
			string sqlText = @"
				...
				INSERT dbo.JobDeclaration (JE_PK, JE_DataModel, JE_DeclarationReference, JE_MessageType, JE_GB, JE_GC, JE_SystemCreateTimeUtc, JE_SystemCreateUser, JE_ClusterKey) VALUES
					(@JePk  , 'SG', 'DEC01', 'TNP', @GbPkSg, @GcPkSg, '2014-03-10', 'US1', 1),
					(newid(), 'AU', 'DEC02', 'TNP', @GbPkAu, @GcPkAu, '2014-03-01', 'US2', 2),
					(newid(), 'SG', 'DEC03', 'TNP', @GbPkSg, @GcPkSg, '2014-04-01', 'US3', 3),
