...
{
	public class EHubMessageBuilderForHKCustoms : EHubMessageBuilder
	{
		public EHubMessageBuilderForHKCustoms(EDIInterchange interchange, INotifications notifier)
