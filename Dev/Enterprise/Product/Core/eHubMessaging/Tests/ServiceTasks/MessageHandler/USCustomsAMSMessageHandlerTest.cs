...
{
	class USCustomsAMSMessageHandlerTest : TestCaseWithFactory
	{
		public void TestCreateInterchangeCore()
		{
			...
			var handler = new USCustomsAMSMessageHandler();
			...
			AssertEquals(ApplicationCodeList.Codes.USAMS, interchange.EI_ApplicationCode);
