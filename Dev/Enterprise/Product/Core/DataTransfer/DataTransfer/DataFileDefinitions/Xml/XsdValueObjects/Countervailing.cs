...
namespace Enterprise.DataTransfer.Xml.XsdVersion1
{
	...
	[ValueObjectSubclassAttribute("Enterprise.DataTransfer.Xml.XsdVersion1.AutoCountervailing")]
	public class Countervailing : Xsd.AutoCountervailing
	{
		public Countervailing()
		{
		}
