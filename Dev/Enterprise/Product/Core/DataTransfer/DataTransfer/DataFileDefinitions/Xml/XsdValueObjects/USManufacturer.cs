...
namespace Enterprise.DataTransfer.Xml.XsdVersion1
{
	...
	[ValueObjectSubclass("Enterprise.DataTransfer.Xml.XsdVersion1.AutoManufacturerType")]
	public class USManufacturer : AutoManufacturerType, IOrganisationOrIDSupporterValueObject
	{
		[XmlIgnore]
