...
namespace Enterprise.DataTransfer.Xml.XsdVersion1
{
	...
	[ValueObjectSubclass("Enterprise.DataTransfer.Xml.XsdVersion1.AutoUSFDAEstablismentID")]
	public class USFDAEstablismentID : AutoUSFDAEstablismentID, IOrganisationOrIDSupporterValueObject
	{
		[XmlIgnore]
