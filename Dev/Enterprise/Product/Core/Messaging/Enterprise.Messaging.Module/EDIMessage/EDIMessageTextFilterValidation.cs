...
{
	public class EDIMessageTextFilterValidation : ModuleTextFilterValidation
	{
		internal EDIMessageTextFilterValidation(EDIMessageTextFilter parent, FilterStripBusinessObject filterBusinessObject)
			: base(parent)
		{
