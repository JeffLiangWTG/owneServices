...
{
	sealed class BranchInboundInterchangeProcessorTest : TestCaseWithFactory
	{
		public void TestMessageFilter()
		{
			...
			var processor = new BranchInboundInterchangeProcessorTestHelper(new string[] { "MT1", "MT3" });
		...
		EDIInterchange CreateInterchange(ZString applicationCode, ZGuid branchPK)
		{
