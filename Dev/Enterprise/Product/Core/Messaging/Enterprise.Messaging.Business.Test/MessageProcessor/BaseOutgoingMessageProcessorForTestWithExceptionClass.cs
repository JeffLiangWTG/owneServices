...
{
	class BaseOutgoingMessageProcessorForTestWithExceptionClass : BaseOutgoingMessageProcessorForTest
	{
		public BaseOutgoingMessageProcessorForTestWithExceptionClass(LoggingInformation logger)
			: base(logger)
		{
		}
