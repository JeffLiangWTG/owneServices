...
{
	public class StandardXMLMessageProcessor : StandardXmlProcessor
	{
		...
		static void AddCommonSqlParameters(ZSqlParameterCollection sqlParams)
		{
			...
			sqlParams.Add(ZSqlParameter.New("@IsActive", true, EDIMessageSchema.EM_IsActive));
		}
	}
}
