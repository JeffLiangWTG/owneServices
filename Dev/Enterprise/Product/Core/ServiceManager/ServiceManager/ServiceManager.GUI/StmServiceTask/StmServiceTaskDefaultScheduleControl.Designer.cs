...
{
	partial class StmServiceTaskDefaultScheduleControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.DefaultScheduleMonthlyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleSecondlyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleMinuteRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleHourlyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleWeeklyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleDailyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			this.DefaultScheduleYearlyRandomStartOffset = new Enterprise.ZArchitecture.ZTextBox();
			...
			this.DefaultScheduleSecondlyRandomStartOffset.SuspendLayout();
			this.DefaultScheduleMinuteRandomStartOffset.SuspendLayout();
			this.DefaultScheduleHourlyRandomStartOffset.SuspendLayout();
			this.DefaultScheduleDailyRandomStartOffset.SuspendLayout();
			this.DefaultScheduleWeeklyRandomStartOffset.SuspendLayout();
			this.DefaultScheduleMonthlyRandomStartOffset.SuspendLayout();
			this.DefaultScheduleYearlyRandomStartOffset.SuspendLayout();
			this.SuspendLayout();
			// 
			// BindingSource
			// 
			this.BindingSource.DataSourceType = typeof(Enterprise.ServiceManager.Business.StmServiceTaskAdapter);
			// 
			// MainGroupBox
			//
			this.MainGroupBox.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|33C100D9-DE38-4936-852C-19CDA82AD115", "Default Schedule");
			...
			this.MainGroupBox.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(651, 215);
			...
			this.SecondPanel.Controls.Add(this.DefaultScheduleSecondlyRandomStartOffset);
			this.SecondPanel.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(158, 19, true);
			this.SecondPanel.Name = "SecondPanel";
			this.SecondPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.EndTimeSecond, "DefaultSchedule+CalcDailyEndTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.StartTimeSecond, "DefaultSchedule+CalcDailyStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.EverySecond, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			// 
			// SecondlyRandomStartOffset
			// 
			this.DefaultScheduleSecondlyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleSecondlyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleSecondlyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleSecondlyRandomStartOffset.Enabled = false;
			this.DefaultScheduleSecondlyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleSecondlyRandomStartOffset.Name = "SecondlyRandomStartOffset";
			this.DefaultScheduleSecondlyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleSecondlyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// MinutePanel
			// 
			...
			this.MinutePanel.Controls.Add(this.DefaultScheduleMinuteRandomStartOffset);
			...
			this.MinutePanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.MinuteEndLocal, "DefaultSchedule+CalcDailyEndTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.MinuteStartLocal, "DefaultSchedule+CalcDailyStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.EndTimeMinute, "DefaultSchedule+CalcDailyEndTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.StartTimeMinute, "DefaultSchedule+CalcDailyStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.EveryMinute, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			// 
			// MinuteRandomStartOffset
			// 
			this.DefaultScheduleMinuteRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleMinuteRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleMinuteRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleMinuteRandomStartOffset.Enabled = false;
			this.DefaultScheduleMinuteRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(230, 122, true);
			this.DefaultScheduleMinuteRandomStartOffset.Name = "MinuteRandomStartOffset";
			this.DefaultScheduleMinuteRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleMinuteRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// PeriodPanel
			// 
			...
			this.BindingSource.SetBindingMember(this.SecondRadioButton, "DefaultSchedule+SecondsRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).SecondsRange)));
			...
			this.BindingSource.SetBindingMember(this.MinuteRadioButton, "DefaultSchedule+MinutesRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MinutesRange)));
			...
			this.BindingSource.SetBindingMember(this.HourlyRadioButton, "DefaultSchedule+HoursRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).HoursRange)));
			...
			this.BindingSource.SetBindingMember(this.YearlyRadioButton, "DefaultSchedule+YearsRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).YearsRange)));
			...
			this.BindingSource.SetBindingMember(this.MonthlyRadioButton, "DefaultSchedule+MonthsRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MonthsRange)));
			...
			this.BindingSource.SetBindingMember(this.DailyRadioButton, "DefaultSchedule+DaysRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).DaysRange)));
			...
			this.BindingSource.SetBindingMember(this.WeeklyRadioButton, "DefaultSchedule+WeeksRange");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).WeeksRange)));
			...
			this.BindingSource.SetBindingMember(this.WeeklyNextRuntimeLocal, "DefaultSchedule+RecurringStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.hourlyEndLocal, "DefaultSchedule+CalcDailyEndTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.hourlyStartLocal, "DefaultSchedule+CalcDailyStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.SecondlyEndLocal, "DefaultSchedule+CalcDailyEndTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.SecondlyStartLocal, "DefaultSchedule+CalcDailyStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeLocalText)));
			...
			this.MonthlyPanel.Controls.Add(this.DefaultScheduleMonthlyRandomStartOffset);
			...
			this.MonthlyPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.MonthlyNextRunTimeLocal, "DefaultSchedule+RecurringStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.MonthlyRecurringStartTimeEdit, "DefaultSchedule+RecurringStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.MonthLastDay, "DefaultSchedule+MonthsLastDay");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MonthsLastDay)));
			...
			this.BindingSource.SetBindingMember(this.MonthlyWeekDay, "DefaultSchedule+MonthlyWeekDay");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MonthlyWeekDay)));
			...
			// MonthlyNumWeek
			// 
			this.BindingSource.SetBindingMember(this.MonthlyNumWeek, "DefaultSchedule+WeekCountAsString");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).WeekCountAsString)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.WeekCounts)));
			...
			this.BindingSource.SetBindingMember(this.MonthlyNumMonth, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			this.BindingSource.SetBindingMember(this.MonthlyDate, "DefaultSchedule+DayOfMonth");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).DayOfMonth)));
			...
			// 
			this.BindingSource.SetBindingMember(this.MonthlyWeekDayDropEdit, "DefaultSchedule+DayName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).DayName)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.WeekDays)));
			this.MonthlyWeekDayDropEdit.BindToList = "DefaultSchedule+Lookups+WeekDays";
			...
			this.BindingSource.SetBindingMember(this.MonthlyDay, "DefaultSchedule+MonthlyDay");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MonthlyDay)));
			...
			// 
			// MonthlyRandomStartOffset
			// 
			this.DefaultScheduleMonthlyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleMonthlyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleMonthlyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleMonthlyRandomStartOffset.Enabled = false;
			this.DefaultScheduleMonthlyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleMonthlyRandomStartOffset.Name = "MonthlyRandomStartOffset";
			this.DefaultScheduleMonthlyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleMonthlyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// HourlyPanel
			// 
			...
			this.HourlyPanel.Controls.Add(this.DefaultScheduleHourlyRandomStartOffset);
			...
			this.HourlyPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.EndTimeHour, "DefaultSchedule+CalcDailyEndTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyEndTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.StartTimeHour, "DefaultSchedule+CalcDailyStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).CalcDailyStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.EveryHour, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			// 
			// HourlyRandomStartOffset
			// 
			this.DefaultScheduleHourlyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleHourlyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleHourlyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleHourlyRandomStartOffset.Enabled = false;
			this.DefaultScheduleHourlyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleHourlyRandomStartOffset.Name = "HourlyRandomStartOffset";
			this.DefaultScheduleHourlyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleHourlyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// WeeklyPanel
			// 
			...
			this.WeeklyPanel.Controls.Add(this.DefaultScheduleWeeklyRandomStartOffset);
			...
			this.WeeklyPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.WeeklyRecurringStartTimeEdit, "DefaultSchedule+RecurringStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.SundayCheckBox, "DefaultSchedule+Sunday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Sunday)));
			...
			this.BindingSource.SetBindingMember(this.SaturdayCheckBox, "DefaultSchedule+Saturday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Saturday)));
			...
			this.BindingSource.SetBindingMember(this.FridayCheckBox, "DefaultSchedule+Friday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Friday)));
			...
			this.BindingSource.SetBindingMember(this.ThursdayCheckBox, "DefaultSchedule+Thursday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Thursday)));
			...
			this.BindingSource.SetBindingMember(this.WednesdayCheckBox, "DefaultSchedule+Wednesday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Wednesday)));
			...
			this.BindingSource.SetBindingMember(this.TuesdayCheckBox, "DefaultSchedule+Tuesday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Tuesday)));
			...
			this.BindingSource.SetBindingMember(this.MondayCheckBox, "DefaultSchedule+Monday");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Monday)));
			...
			this.BindingSource.SetBindingMember(this.RecurEveryWeekTextBox, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			// 
			// WeeklyRandomStartOffset
			// 
			this.DefaultScheduleWeeklyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleWeeklyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleWeeklyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleWeeklyRandomStartOffset.Enabled = false;
			this.DefaultScheduleWeeklyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleWeeklyRandomStartOffset.Name = "WeeklyRandomStartOffset";
			this.DefaultScheduleWeeklyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleWeeklyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// DailyPanel
			// 
			...
			this.DailyPanel.Controls.Add(this.DefaultScheduleDailyRandomStartOffset);
			...
			this.DailyPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			this.DailyPanel.TabIndex = 18;
			// 
			// DailyNextRunTimeLocal
			// 
			this.DailyNextRunTimeLocal.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DailyNextRunTimeLocal, "DefaultSchedule+RecurringStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.DailyRecurringStartTimeEdit, "DefaultSchedule+RecurringStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeUtc)));
			...
			this.BindingSource.SetBindingMember(this.DailyDaysNumber, "DefaultSchedule+Period");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Period)));
			...
			this.BindingSource.SetBindingMember(this.DailyWeekDay, "DefaultSchedule+WeekDaysOnly");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).WeekDaysOnly)));
			...
			this.BindingSource.SetBindingMember(this.DailyDay, "DefaultSchedule+DailyDay");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).DailyDay)));
			...
			// 
			// DailyRandomStartOffset
			// 
			this.DefaultScheduleDailyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleDailyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleDailyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleDailyRandomStartOffset.Enabled = false;
			this.DefaultScheduleDailyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleDailyRandomStartOffset.Name = "DailyRandomStartOffset";
			this.DefaultScheduleDailyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleDailyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// YearlyPanel
			// 
			...
			this.YearlyPanel.Controls.Add(this.DefaultScheduleYearlyRandomStartOffset);
			...
			this.YearlyPanel.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(487, 159, true);
			...
			this.BindingSource.SetBindingMember(this.YearlyNextRunTimeLocal, "DefaultSchedule+RecurringStartTimeLocalText");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeLocalText)));
			...
			this.BindingSource.SetBindingMember(this.YearlyRecurringStartTimeEdit, "DefaultSchedule+RecurringStartTimeUtc");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RecurringStartTimeUtc)));
			...
			// YearlyMonth
			// 
			this.BindingSource.SetBindingMember(this.YearlyMonth, "DefaultSchedule+EveryMonthNumberDayAsString");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).EveryMonthNumberDayAsString)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.Months)));
			this.YearlyMonth.BindToList = "DefaultSchedule+Lookups+Months";
			...
			// YearlyWeekDayMonth
			// 
			this.BindingSource.SetBindingMember(this.YearlyWeekDayMonth, "DefaultSchedule+MonthNumberAsString");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).MonthNumberAsString)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.Months)));
			this.YearlyWeekDayMonth.BindToList = "DefaultSchedule+Lookups+Months";
			...
			this.BindingSource.SetBindingMember(this.YearlyWeekDay, "DefaultSchedule+YearlyWeekDay");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).YearlyWeekDay)));
			...
			// YearlyWeekNum
			// 
			this.BindingSource.SetBindingMember(this.YearlyWeekNum, "DefaultSchedule+WeekCountAsString");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).WeekCountAsString)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.WeekCounts)));
			...
			this.BindingSource.SetBindingMember(this.YearlyDay, "DefaultSchedule+DayOfMonth");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.INumericZType)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).YearlyDay)));
			...
			// 
			this.BindingSource.SetBindingMember(this.YearlyWeekDayDropEdit, "DefaultSchedule+DayName");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((object)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).DayName)));
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((System.Collections.IList)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).Lookups.WeekDays)));
			this.YearlyWeekDayDropEdit.BindToList = "DefaultSchedule+Lookups+WeekDays";
			...
			this.BindingSource.SetBindingMember(this.YearlyEvery, "DefaultSchedule+YearlyEvery");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZBool)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).YearlyEvery)));
			...
			// 
			// YearlyRandomStartOffset
			// 
			this.DefaultScheduleYearlyRandomStartOffset.BackColor = System.Drawing.SystemColors.Window;
			this.BindingSource.SetBindingMember(this.DefaultScheduleYearlyRandomStartOffset, "DefaultSchedule+RandomStartOffset");
			// The line(s) below are a compile-time check for a binding member. Reflection is used to determine the return type of collection indexes and may require an up to date compilation of your solution. If compilation fails below, try removing them and rebuild your solution. Then, open the form, move a control up and then down, and re-compile again.
			CargoWise.ComponentModel.Design.CompileTimeCheckBindingMember.Check(((CargoWise.Types.ZString)(((Enterprise.ServiceManager.Business.StmServiceTaskAdapter)(null)).RandomStartOffset)));
			this.DefaultScheduleYearlyRandomStartOffset.CaptionResourceString = Enterprise.ServiceManager.GUI.Res.GetData("DefaultScheduleControl|6DD273A8-C135-44E2-8A21-F8B6D5FBED35", "Start Time Random Factor");
			this.DefaultScheduleYearlyRandomStartOffset.Enabled = false;
			this.DefaultScheduleYearlyRandomStartOffset.Location = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledPoint(223, 122, true);
			this.DefaultScheduleYearlyRandomStartOffset.Name = "YearlyRandomStartOffset";
			this.DefaultScheduleYearlyRandomStartOffset.Size = CargoWise.Windows.UI.ControlDpiScalingHelper.NewScaledSize(45, 20, true);
			this.DefaultScheduleYearlyRandomStartOffset.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// StmServiceTaskDefaultScheduleControl
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.CaptionRenderingEnabled = true;
			this.Controls.Add(this.MainGroupBox);
			this.Name = "StmServiceTaskDefaultScheduleControl";
			...
			this.DefaultScheduleSecondlyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleSecondlyRandomStartOffset.PerformLayout();
			this.DefaultScheduleMinuteRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleMinuteRandomStartOffset.PerformLayout();
			this.DefaultScheduleHourlyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleHourlyRandomStartOffset.PerformLayout();
			this.DefaultScheduleDailyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleDailyRandomStartOffset.PerformLayout();
			this.DefaultScheduleWeeklyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleWeeklyRandomStartOffset.PerformLayout();
			this.DefaultScheduleMonthlyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleMonthlyRandomStartOffset.PerformLayout();
			this.DefaultScheduleYearlyRandomStartOffset.ResumeLayout(true);
			this.DefaultScheduleYearlyRandomStartOffset.PerformLayout();
		...
		private ZTextBox DefaultScheduleSecondlyRandomStartOffset;
		private ZTextBox DefaultScheduleMinuteRandomStartOffset;
		private ZTextBox DefaultScheduleHourlyRandomStartOffset;
		private ZTextBox DefaultScheduleDailyRandomStartOffset;
		private ZTextBox DefaultScheduleWeeklyRandomStartOffset;
		private ZTextBox DefaultScheduleMonthlyRandomStartOffset;
		private ZTextBox DefaultScheduleYearlyRandomStartOffset;
	}
}
