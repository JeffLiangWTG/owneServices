...
{
	sealed class FilterCheckGreaterThanOrEqual : FilterCheck
	{
		public FilterCheckGreaterThanOrEqual(IFilterOperand lhs, IFilterOperand rhs)
			: base(lhs, rhs) { }
		...
		{
			return new FilterCheckGreaterThanOrEqual(lhs, rhs);
		}
