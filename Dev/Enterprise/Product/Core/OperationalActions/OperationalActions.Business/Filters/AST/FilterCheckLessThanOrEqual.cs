...
{
	sealed class FilterCheckLessThanOrEqual : FilterCheck
	{
		public FilterCheckLessThanOrEqual(IFilterOperand lhs, IFilterOperand rhs)
			: base(lhs, rhs) { }
		...
		{
			return new FilterCheckLessThanOrEqual(lhs, rhs);
		}
