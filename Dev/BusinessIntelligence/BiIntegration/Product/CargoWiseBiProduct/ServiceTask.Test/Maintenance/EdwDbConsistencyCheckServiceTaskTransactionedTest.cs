...
{
	[TestedType(typeof(EdwDbConsistencyCheckServiceTask))]
	class EdwDbConsistencyCheckServiceTaskTransactionedTest : ServiceTaskTestCase<EdwDbConsistencyCheckServiceTask>
	{
		public void TestInitialiseSchedule()
		{
			var testTask = new EdwDbConsistencyCheckServiceTask();
			...
			Assert("WeekDayOccurrenceNumber", taskSchedule.Recurrence.Sunday);
