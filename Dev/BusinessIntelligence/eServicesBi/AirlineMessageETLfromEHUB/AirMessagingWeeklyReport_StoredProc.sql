...
/****** Object:  StoredProcedure [dbo].[AirMessagingWeeklyReport]    Script Date: 28/05/2019 2:35:39 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[AirMessagingWeeklyReport]
...
SELECT LEFT([Sender ID], 3) + RIGHT([Sender ID], 3) AS [Client System Code]
			  ...
			  Where AM_ApplicationCode = 'CIM' )myTable)myTable2)MyTable3
...
where AM_ApplicationCode = 'biz' and [Recipient EnterpriseClient] = 'Enterprise')MyTable )MyTable2
