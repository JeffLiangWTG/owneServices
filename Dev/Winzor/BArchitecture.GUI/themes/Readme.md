...
CSS naming style we use, is [Block Element Modifier BEM](http://getbem.com/naming/).
...
**Example**
	...
	<form class="form form--theme-xmas form--simple">
	  ...
	  <input ="form__submit form__submit--disabled" ="submit" />
	</form>
...
**HTML** 
DOM node can be a block if it accepts a class name.

<div class="block">...</div>

**CSS** 
class name selector only tag name or ids dependency on other blocks/elements on a page *.block { color: #042; }*
...
CSS class name selector only No tag name or ids dependency on other blocks/elements on a page
...
**Good**
	...
	<div class="block block--size-big--shadow-yes">...</div>
**Bad**
