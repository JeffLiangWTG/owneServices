...
{
	/// <summary>
	/// Represents the constructor for Padding that takes a single integer parameter.
	/// </summary>
	static readonly Lazy<ConstructorInfo> _constructorPaddingSerializeAll =
		new Lazy<ConstructorInfo>(() => typeof(Padding).GetConstructor(new Type[] { typeof(int) }));

	/// <summary>
	/// Represents the constructor for Padding that takes four integer parameters.
	/// </summary>
	static readonly Lazy<ConstructorInfo> _constructorPadding =
		new Lazy<ConstructorInfo>(() => typeof(Padding).GetConstructor(new Type[] { typeof(int), typeof(int), typeof(int), typeof(int) }));
			...
			else if (destinationType == typeof(InstanceDescriptor))
			{
				if (padding.ShouldSerializeAll())
				{
					return new InstanceDescriptor(
						_constructorPaddingSerializeAll.Value, new object[] { padding.All }
					);
				}
				else
				{
					return new InstanceDescriptor(
						_constructorPadding.Value,
