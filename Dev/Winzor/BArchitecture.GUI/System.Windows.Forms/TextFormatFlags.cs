...
public enum TextFormatFlags
{
	...
	//
	// Summary:
	//     Aligns the text on the bottom of the bounding rectangle. Applied only when the
	...
	//     System.Windows.Forms.TextFormatFlags.WordEllipsis, System.Windows.Forms.TextFormatFlags.PathEllipsis,
	//     and System.Windows.Forms.TextFormatFlags.EndEllipsis values cannot be used with
	//     System.Windows.Forms.TextFormatFlags.ExpandTabs.
	ExpandTabs = 64,
	//
	// Summary:
	//     Allows the overhanging parts of glyphs and unwrapped text reaching outside the
	//     formatting rectangle to show.
	NoClipping = 256,
	//
	// Summary:
	...
	//     character is interpreted as a directive to underscore the character that follows,
	//     and the double-ampersand (&&) mnemonic-prefix characters as a directive to print
	//     a single ampersand. By specifying System.Windows.Forms.TextFormatFlags.NoPrefix,
	//     this processing is turned off. For example, an input string of "A&bc&&d" with
	//     System.Windows.Forms.TextFormatFlags.NoPrefix applied would result in output
	//     of "A&bc&&d".
	NoPrefix = 2048,
	//
	// Summary:
	...
	//
	// Summary:
	//     Trims the line to the nearest word and an ellipsis is placed at the end of a
	//     trimmed line.
	WordEllipsis = 262144,
	//
	// Summary:
