...
// SLIGHTLY MODIFIED FROM ORIGINAL SOURCE FILE
// _owner was renamed to owner to support CW1 reflection
// owner._tabPageCount was replaced with owner.tabPages.Count
	...
	public partial class TabControl
	{
		public class TabPageCollection : IList
		{
			...
			public virtual TabPage this[int index]
			{
				...
				set => owner.SetTabPage(index, value);
			}
			...
			[Browsable(false)]
			public int Count => owner.TabCount;
			...
			public virtual void Clear() => owner.RemoveAll();
			void ICollection.CopyTo(Array dest, int index)
			{
				if (Count > 0)
				{
					Array.Copy(owner.GetTabPages(), 0, dest, index, Count);
				}
			}
