...
public class DataGridTextBox : TextBox
{
	...
	bool isInEditOrNavigateMode = true;
	...
	internal override void ProcessKeyEvent(KeyEventType eventType, WinzorKeyboardEventArgs e)
	{
		var key = e.GetKey();
		if (eventType == KeyEventType.KeyDown && ((e.CtrlKey && (key == Keys.V || key == Keys.X)) || (e.ShiftKey && key == Keys.Insert)))
		{
			IsInEditOrNavigateMode = false;
			dataGrid.ColumnStartedEditing(Bounds);
		}

		base.ProcessKeyEvent(eventType, e);
	}
