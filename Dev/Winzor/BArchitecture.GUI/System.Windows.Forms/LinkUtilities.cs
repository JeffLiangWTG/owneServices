...
{
	// IE fonts and colors
	static Color s_ielinkColor = Color.Empty;
	static Color s_ieactiveLinkColor = Color.Empty;
	static Color s_ievisitedLinkColor = Color.Empty;
	...
	/// </summary>
	static Color GetIEColor(string name)
	{
