...
namespace CargoWise.EntityFramework
{
	...
	public sealed class IDontMindLoadingASubclassInsteadAttribute : Attribute
	{
		public static bool HasAttribute(Type type)
		{
			...
			{
				result = type.GetCustomAttributes(typeof(IDontMindLoadingASubclassInsteadAttribute), true).Length > 0;
