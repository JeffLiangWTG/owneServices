...
{
	sealed class DecimalStringComparerTest : TestCaseWithFactory
	{
		public void TestCompare()
		{
			...
			var ascComparer = new DecimalStringComparer(dummy1.GetType(), "Z0_VarCharMax", ListSortDirection.Ascending);
			...
			var descComparer = new DecimalStringComparer(dummy1.GetType(), "Z0_VarCharMax", ListSortDirection.Descending);
