...
{
	sealed class ManyToManyRelationshipTest : TestCaseWithFactory
	{
		public void TestInitPivotsErrorReport()
		{
			...
			AssertContains($"Master business object of type 'CargoWise.EntityFramework.Testing.ManyToManyRelationshipTest+DummyBusinessObjectWithManyToMany', with PK '{master.PK}'", ErrorReporter.LastMessageReported);
		...
		public void TestNotRelatedPivotsAreNotLoaded()
		{
			...
			var manyToManyRelationship = new ManyToManyRelationship(dummy, typeof(DummyDependantBusinessObject), typeof(DummyPivot));
			manyToManyRelationship.LoadBusinessObjects(Factory, new ZQuery());
			AssertEquals(1, manyToManyRelationship.pivots.Count);
		}

		public void TestManyToManyRelationship_WhenElementPointsToPivotTable()
		{
			var master = Factory.New<DummyBusinessObject>();
			var relationship = new ElementFKtoPivotPKManyToManyRelationship(master, new ZQuery());
		...
		public void TestManyToManyRelationship_DeletedPivotsAreNotAdded_FromListChangedEvent()
		{
			((IBindingList)Collection).ListChanged += new ListChangedEventHandler(OnListChanged);
		...
		{
			AssertEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)));
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)),
				new ManyToManyRelationship(Master2, typeof(DummyDependantBusinessObject), typeof(DummyPivot)));
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyBusinessObject), typeof(DummyPivot)),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)));
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(AnotherPivot)));
		}

		public void TestHashCode()
		{
			AssertEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode(),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode());
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode(),
				new ManyToManyRelationship(Master2, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode());
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyBusinessObject), typeof(DummyPivot)).GetHashCode(),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode());
			AssertNotEquals(
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(DummyPivot)).GetHashCode(),
				new ManyToManyRelationship(Master, typeof(DummyDependantBusinessObject), typeof(AnotherPivot)).GetHashCode());
		}
		...
		{
			get { return collection ?? (collection = new ActiveBusinessObjectCollection<DummyDependantBusinessObject>(Master, typeof(DummyPivot))); }
		}
		ActiveBusinessObjectCollection<DummyDependantBusinessObject> collection;

		ManyToManyRelationship Relationship
		{
			get { return (ManyToManyRelationship)Collection.Relationship; }
		}
		...
		class AnotherPivot : DummyPivot
		{
			public AnotherPivot(BusinessObjectFactory factory, DataRow row)
				: base(factory, row)
			{
			}
		}
		...
		class ElementFKtoPivotPKManyToManyRelationship : ManyToManyRelationship<SchemaGuidColumn, ZGuid, SchemaGuidColumn, ZGuid>
		{
			public ElementFKtoPivotPKManyToManyRelationship(DummyBusinessObject master, ZQuery filter)
			 : base(master, typeof(DummyDependantBusinessObject), typeof(DummyPivot), filter
					 , (SchemaGuidColumn)ObjectFactory.Get<IApplicationSchemaResolver>().GetSchemaColumn(DummyPivot.Schema.ZDP_Z0, DummyPivot.Schema.TableName)
					 , (SchemaGuidColumn)ObjectFactory.Get<IApplicationSchemaResolver>().GetSchemaColumn(DummyBusinessObject.Schema.PK, DummyBusinessObject.Schema.TableName)
					 , (SchemaGuidColumn)ObjectFactory.Get<IApplicationSchemaResolver>().GetSchemaColumn(DummyPivot.Schema.PK, DummyPivot.Schema.TableName)
					 , (SchemaGuidColumn)ObjectFactory.Get<IApplicationSchemaResolver>().GetSchemaColumn(DummyDependantBusinessObject.Schema.ZD1_NumberUnit, DummyDependantBusinessObject.Schema.TableName))
			{
			}
