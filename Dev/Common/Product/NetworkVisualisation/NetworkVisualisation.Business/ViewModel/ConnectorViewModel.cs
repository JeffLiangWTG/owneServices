...
namespace CargoWise.NetworkVisualisation.Business
{
	...
	public sealed class ConnectorViewModel : ViewModelBase
	{
		...
		/// </summary>
		ImpObservableCollection<ConnectionViewModel> attachedConnections;
		...
		/// </summary>
		void attachedConnections_ItemsAdded(object sender, CollectionItemsChangedEventArgs e)
		{
		...
		/// </summary>
		void attachedConnections_ItemsRemoved(object sender, CollectionItemsChangedEventArgs e)
		{
			foreach (ConnectionViewModel connection in e.Items)
			{
				connection.ConnectionChanged -= new EventHandler<EventArgs>(connection_ConnectionChanged);
		...
		/// </summary>
		void connection_ConnectionChanged(object sender, EventArgs e)
		{
			OnPropertyChanged(nameof(IsConnectionAttached));
			OnPropertyChanged(nameof(IsConnected));
		}
