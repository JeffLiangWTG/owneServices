...
namespace CargoWise.NetworkVisualisation.GUI
{
	...
	public partial class NetworkView
	{
		...
		/// </summary>
		FrameworkElementAdorner feedbackAdorner;
		...
		/// </summary>
		void ConnectorItem_DragStarted(object source, ConnectorItemDragStartedEventArgs e)
		{
			this.Focus();
			...
			this.draggedOutNodeDataContext = nodeItem.DataContext ?? nodeItem;
			this.draggedOutConnectorDataContext = this.draggedOutConnectorItem.DataContext ?? this.draggedOutConnectorItem;
		...
		/// </summary>
		void ConnectorItem_Dragging(object source, ConnectorItemDraggingEventArgs e)
		{
			e.Handled = true;
		...
		/// </summary>
		void ConnectorItem_DragCompleted(object source, ConnectorItemDragCompletedEventArgs e)
		{
			e.Handled = true;

			NetworkVisualisationErrorReporter.ReportIfAssertionFailed((ConnectorItem)e.OriginalSource == this.draggedOutConnectorItem);
		...
		/// </summary>
		bool DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out object connectorDataContextDraggedOver)
		{
		...
		/// </summary>
		void AddFeedbackAdorner(FrameworkElement adornedElement, object indicator)
		{
