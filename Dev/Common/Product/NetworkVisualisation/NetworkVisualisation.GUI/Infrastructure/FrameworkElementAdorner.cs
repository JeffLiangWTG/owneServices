...
namespace CargoWise.NetworkVisualisation.GUI
{
	...
	public class FrameworkElementAdorner : Adorner
	{
		...
		//
		readonly AdornerPlacement horizontalAdornerPlacement = AdornerPlacement.Inside;
		readonly AdornerPlacement verticalAdornerPlacement = AdornerPlacement.Inside;
		...
		readonly OverridableMouse overridableMouse;
		...
		public FrameworkElementAdorner(FrameworkElement adornerChildElement, FrameworkElement adornedElement,
									   ...
									   double offsetX, double offsetY, OverridableMouse overridableMouse)
			: base(adornedElement)
		{
			if (adornedElement == null)
			{
			...
			this.overridableMouse = overridableMouse;
		}
				...
				case HorizontalAlignment.Left:
					{
						if (horizontalAdornerPlacement == AdornerPlacement.Mouse)
						{
							...
							Point position = overridableMouse.GetPosition(AdornerLayer.GetAdornerLayer(AdornedElement));
				...
				case HorizontalAlignment.Right:
					{
						if (horizontalAdornerPlacement == AdornerPlacement.Mouse)
						{
							Point position = overridableMouse.GetPosition(AdornedElement);
