...
(
	...
	[CH_DatabaseNumber] ASC,
	[CH_CompanyNumber] ASC,
	[CH_Reference1] ASC,
	[CH_Reference2] ASC,
	[CH_Reference3] ASC,
	[CH_Reference4] ASC,
...
ALTER TABLE [edi].[Chargeable] SWITCH PARTITION 2 TO [edi].[ToDrop]

SELECT COUNT_BIG(*)
	FROM [edi].[ToDrop]
	WHERE 201701 <= CH_Period AND CH_Period < 201801
...
ALTER TABLE [edi].[Usage] SWITCH PARTITION 2 TO [edi].[ToDrop]

SELECT COUNT_BIG(*)
    FROM [edi].[ToDrop]
    WHERE 201701 <= US_Period AND US_Period < 201801

DROP TABLE [edi].[ToDrop]

DBCC SHRINKFILE (N'Year2017', 0)
