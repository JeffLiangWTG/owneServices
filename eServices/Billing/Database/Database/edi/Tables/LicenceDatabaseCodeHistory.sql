CREATE TABLE edi.LicenceDatabaseCodeHistory
(
...
CREATE UNIQUE CLUSTERED INDEX UX_LicenceDatabaseCodeHistory ON edi.LicenceDatabaseCodeHistory (EnterpriseCode, ServerCode, ValidFromUtc, TenantID, Product)
