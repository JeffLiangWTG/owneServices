CREATE PROCEDURE edi.ProduceAccountsReceivableMonthlyChargeables
	@period int
AS
...
(
	SELECT *
	FROM edi.Usage
	INNER JOIN edi.BillingRules BR ON BR_SPName = 'ProduceAccountsReceivableMonthlyChargeables'
		AND (
