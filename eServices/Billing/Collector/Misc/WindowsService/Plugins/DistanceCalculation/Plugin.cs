...
namespace CargoWise.eServices.Billing.Collector.Misc.WindowsService.Plugins.DistanceCalculation
{
	public class Plugin : SqlBillingTransactionsPlugin
	{
		protected override sealed string QueryName
		{
			get { return "CargoWise.eServices.Billing.Collector.Misc.WindowsService.Plugins.DistanceCalculation.Query.sql"; }
		}
