...
public class CustomerCodeIP
{
    ...
    public List<string> CustomerCodeCollection { get; set; } = new();
...
{
    public static Dictionary<string, List<string>> ProcessReferenceFile(string refFilePath, ILogger log)
    {
        ...
        if (hasErrors)
        {
            log.LogInformation("Reference file has invalid lines. Check log for which lines are invalid.");
        }
    ...
    static Dictionary<string, List<string>> ReadandProcessRawContentFromReferenceFile(StreamReader reader, ILogger log, ref bool hasErrors)
    {
        ...
        while (!reader.EndOfStream)
        {
            ...
            if (ValidateLineFormat(line.Replace(" ", string.Empty)))
            {
    ...
    public static Dictionary<string, List<string>> ProcessRawContent(CustomerCodeIP item, ILogger log, Dictionary<string, List<string>> customerCodeIPCollection, ref bool hasErrors)
    {
        ...
        {
            hasErrors = true;
            customerCodeIPCollection[item.CustomerIP] = new List<string> { "XXXXXX" };
