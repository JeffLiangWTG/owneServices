...
{
    public partial class eHubOutboxMessage
    {
        ...
        public eHubClient OI_CC_RecipientNavigation { get; set; }
        public eHubClient OI_CC_SenderNavigation { get; set; }
        public eHubMessageType OI_DT_TargetNavigation { get; set; }
    }
}
