...
namespace FluentFTP {
	...
	public class FtpClient : IDisposable, IFtpClient {
        ...
        /// <summary>
        /// Trace listener for capturing control dialog.
        /// </summary>
        /// <customization>
        /// Added for logging.
        /// </customization>
		...
		protected FtpClient CloneConnection() {
            ...
            conn.ControlDialogTrace = ControlDialogTrace;
        ...
        /// <customization>
        /// Initialize ControlDialogTrace on FtpSocketStream.
        /// </customization>
        public virtual void Connect()
        {
			...
			lock (m_lock) {
				...
				if (m_stream == null) {
                    ...
                    #region customization
                    m_stream.ControlDialogTrace = m_controlDialogTrace;
                    #endregion
                }
                else
					if (IsConnected)
