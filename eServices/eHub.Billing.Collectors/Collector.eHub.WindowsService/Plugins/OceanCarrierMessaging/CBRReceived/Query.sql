...
WHERE @startUTC < AM_ArchivedUTC AND AM_ArchivedUTC <= @endUTC
	...
	AND AM_RecipientMessageXML.value('(/*:UniversalInterchange/*:Body/*:UniversalShipment/*:Shipment/*:DataContext/*:RecipientRoleCollection/*:RecipientRole/*:ServiceCode)[1]', 'varchar(50)') IN ('BRQ')
OPTION(RECOMPILE)
