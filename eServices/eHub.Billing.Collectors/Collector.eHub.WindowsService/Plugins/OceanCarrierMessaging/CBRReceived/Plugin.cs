...
namespace CargoWise.eServices.Billing.Collector.eHub.WindowsService.Plugins.OceanCarrierMessaging.CBRReceived
{
	public class Plugin : SqlBillingTransactionsPlugin
	{
		protected override string QueryName
		{
			get
			{
				return "CargoWise.eServices.Billing.Collector.eHub.WindowsService.Plugins.OceanCarrierMessaging.CBRReceived.Query.sql";
			}
		}
