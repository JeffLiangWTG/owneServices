...
{
    internal class CreateSendHandlerCommand : AbstractCommand
    {
        internal CreateSendHandlerCommand(string[] args) : base(args) { }
        ...
        internal override void Execute()
        {
            ...
            try
            {
                ...
                using (ManagementClass handlerManager = new ManagementClass(scope, "MSBTS_SendHandler2", null))
                {
                    ...
                    _output.Add(String.Format("Send handler created.  Adapter: {0} associated with Host: {1}", adapterName, hostName));
                }
            }
            catch (Exception ex)
            {
        ...
        protected override void ReportUsage()
        {
            ...
            usage.Add(base.GetExeName() + " " + CommandType.CreateSendHandler.ToString() +
            ...
            usage.Add("Examples:");
            usage.Add(string.Empty);
            usage.Add(base.GetExeName() + " " + CommandType.CreateSendHandler.ToString() + " -AdapterName:WCF-SQL -HostName:SendHost_WCFSQL");
            usage.Add(base.GetExeName() + " " + CommandType.CreateSendHandler.ToString() + " -AdapterName:FTP -HostName:SendHost_FTP " +
