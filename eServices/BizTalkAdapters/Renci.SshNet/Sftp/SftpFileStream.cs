...
namespace Renci.SshNet.Sftp
{
    ...
    public class SftpFileStream : Stream
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1065:DoNotRaiseExceptionsInUnexpectedLocations", Justification = "By design this is the exception that stream need to throw.")]
