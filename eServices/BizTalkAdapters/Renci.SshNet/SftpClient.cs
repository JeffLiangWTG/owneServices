...
namespace Renci.SshNet
{
    ...
    public partial class SftpClient : BaseClient, ISftpClient
    {
		...
		/// Added for logging. 
		/// </customisation>
		public TraceListener TraceLog { get; set; }
		...
		/// Added for testing. 
		/// </customisation>
		public IEnumerable<ISftpFile> ListDirectoryI(string path)
		{
        ...
        protected override void OnConnected()
        {
			...
			_sftpSession = ServiceFactory.CreateSftpSession(Session, OperationTimeout, ConnectionInfo.Encoding, TraceLog); 
			#endregion
