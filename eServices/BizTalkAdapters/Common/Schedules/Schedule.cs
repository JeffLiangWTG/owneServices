...
namespace CargoWise.eHub.BizTalkAdapters.Common.Schedules
{
    ...
    public abstract class Schedule : Microsoft.BizTalk.Scheduler.ISchedule
    {
        ...
        {
            string s = Extract(document, path, required);
            return (CargoWise.eHub.BizTalkAdapters.Common.Schedules.ScheduleDay)Enum.Parse(typeof(CargoWise.eHub.BizTalkAdapters.Common.Schedules.ScheduleDay), s);
        }
        /// <summary>
        /// Used internally to read schedule configuration from Xml document
        /// </summary>
        ...
        {
            string s = Extract(document, path, required);
            return (CargoWise.eHub.BizTalkAdapters.Common.Schedules.ScheduleMonth)Enum.Parse(typeof(CargoWise.eHub.BizTalkAdapters.Common.Schedules.ScheduleMonth), s);
        }
        //
        // Utility Methods
        //
