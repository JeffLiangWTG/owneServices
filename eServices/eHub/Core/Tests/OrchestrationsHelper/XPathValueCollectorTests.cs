...
{
	[TestClass]
	public class XPathValueCollectorTests
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestCollect()
		{
			#region originalMessage
			var originalMessage = @"<?xml version=""1.0"" encoding=""utf-8""?>
<ns0:EDIFACTEnvelope xmlns:ns0=""http://wisetechglobal.com/eHub/Products/SGCustoms/MHAccess/2017/08/EDIFACTEnvelope"">
	<EDIFACTs>
		...
		<gen0:EFACT_D99A_APERAK xmlns:gen0=""http://schemas.microsoft.com/BizTalk/EDI/EDIFACT/2006"">
			...
			#endregion originalMessage

			var expected = new List<Tuple<int, string, string>>() {
				new Tuple<int,string,string>(0,"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='BGM']/*[local-name()='C106']/*[local-name()='C10601']", "C10601"),
				new Tuple<int,string,string>(1,"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='DTM']/*[local-name()='C507']/*[local-name()='C50701']", "10"),
				new Tuple<int,string,string>(0,"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='BGM']/*[local-name()='C106']/*[local-name()='C10601']", "C106011"),
				new Tuple<int,string,string>(1,"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='DTM']/*[local-name()='C507']/*[local-name()='C50701']", "11")
			};

			var collector = new XPathValueCollector(
				"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='BGM']/*[local-name()='C106']/*[local-name()='C10601']",
				"/*[local-name()='EDIFACTEnvelope']/*[local-name()='EDIFACTs']/*[local-name()='EFACT_D99A_APERAK']/*[local-name()='DTM']/*[local-name()='C507']/*[local-name()='C50701']");
			var actual = collector.Collect(originalMessage);

			AssertEqual(expected, actual);
		}

		void AssertEqual(List<Tuple<int, string, string>> tuples1, List<Tuple<int, string, string>> tuples2)
		{
			Assert.AreEqual(tuples1.Count, tuples2.Count);
			foreach (var tuple1 in tuples1)
			{
				Assert.IsTrue(tuples2.Any(t => t.Item1 == tuple1.Item1 && t.Item2 == tuple1.Item2 && t.Item3 == tuple1.Item3));
			}
		}
	}
}
