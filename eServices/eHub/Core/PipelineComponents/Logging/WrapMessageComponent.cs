...
namespace CargoWise.eHub.Core.PipelineComponents
{
	...
	[Guid("97CF340A-0872-47A9-995D-36C56DCF85FB")]
	public class WrapMessageComponent : IBaseComponent, IComponentUI, IComponent, IPersistPropertyBag
	{
		...
		public string Name
		{
			get { return "WrapMessageComponent"; }
		}
		...
		{
			classID = new Guid("97CF340A-0872-47A9-995D-36C56DCF85FB");
		}
