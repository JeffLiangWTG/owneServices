...
namespace CargoWise.eHub.Core.PipelineComponents
{
	...
	[Guid("DBBA8578-5CC0-422e-81F2-6E89154B8FD7")]
	public class BodyPropertyWriter : IBaseComponent, IComponentUI, IComponent, IPersistPropertyBag
	{
		#region IBaseComponent Members

		public string Description
		{
			get { return "Writes Message Body Property."; }
		}

		public string Name
		{
			get { return "Message Body Propery Writer"; }
		}
		...
		public IBaseMessage Execute(IPipelineContext pipelineContext, IBaseMessage message)
		{
			...
			try
			{
				...
				string value = (string)message.Context.Read(contextProperty.Name, contextProperty.Namespace);
				if (string.IsNullOrEmpty(value))
					throw new ApplicationException(string.Format("Context Property '{0}#{1}' missing in message context", contextProperty.Namespace, contextProperty.Name));

				message.BodyPart.PartProperties.Write(bodyBroperty.Name, bodyBroperty.Namespace, string.Format(Format, value));
		...
		{
			classID = new Guid("DBBA8578-5CC0-422e-81F2-6E89154B8FD7");
		}
