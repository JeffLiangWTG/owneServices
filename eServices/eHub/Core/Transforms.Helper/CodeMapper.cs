...
{
	/// <summary>
	/// This class is currently a stub for the actual call out to the database to retrieve code maps.
	/// </summary>
	public class CodeMapper
	{
		...
		{
			TransformAccessor ta = new TransformAccessor();
			return ta.GetRecipientCode(senderClientCode, recipientClientCode, transformationName, codeSet, resultField, key1, key2, key3, key4, key5) ?? String.Empty;
		}

		public virtual string GetUNLOCOfromIATA(string IATACode)
		{
			TransformAccessor ta = new TransformAccessor();
			return ta.GetUNLOCOFromIATA(IATACode) ?? String.Empty;
		}

		public virtual string GetStateFromUNLOCO(string UNLOCO)
		{
			TransformAccessor ta = new TransformAccessor();
			return ta.GetStateFromUNLOCO(UNLOCO) ?? String.Empty;
		}
		...
		{
			TransformAccessor ta = new TransformAccessor();
			return ta.CallActionProcedure(procedure, outputParm, inputParms) ?? String.Empty;
		}
	}
}
