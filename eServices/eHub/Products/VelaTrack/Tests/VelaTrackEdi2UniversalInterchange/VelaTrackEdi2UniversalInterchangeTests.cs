...
{
	[TestClass]
	public class VelaTrackEdi2UniversalInterchangeTests
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVelaTrackEdi2UniversalInterchange_Client()
		{
		...
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVelaTrackEdi2UniversalInterchange_Client_Consol()
		{
		...
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVelaTrackEdi2UniversalInterchange_Reference_Client()
		{
			var sourceFile = "VelaTrackEdi2UniversalInterchange.TestFiles.SEA_Reference_Client_Input.xml";
			var expectedFile = "VelaTrackEdi2UniversalInterchange.TestFiles.SEA_Reference_Client_Output.xml";
			InitilizeAndExecute("4CA3114E-5783-4671-85C9-E4E123971C5F", sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVelaTrackEdi2UniversalInterchange_Reference_Client_Consol()
		{
			var sourceFile = "VelaTrackEdi2UniversalInterchange.TestFiles.SEA_Reference_Client_Consol_Input.xml";
			var expectedFile = "VelaTrackEdi2UniversalInterchange.TestFiles.SEA_Reference_Client_Consol_Output.xml";
			InitilizeAndExecute("4CA3114E-5783-4671-85C9-E4E123971C5F", sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVelaTrackEdi2UniversalInterchange_EmptyReference()
		{
		...
		static void InitilizeAndExecute(string recipientId, string inputFile, string outputFile)
		{
			...
			mapTester.Execute<VelaTrackEdi2UniversalInterchange>(inputFile, outputFile);
