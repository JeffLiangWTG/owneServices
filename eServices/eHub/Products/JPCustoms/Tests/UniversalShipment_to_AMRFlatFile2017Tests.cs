...
using CargoWise.eHub.Products.JPCustoms.Transforms.UniversalShipment2AMRFlatFile2017;
...
{
    [TestClass]
    public class UniversalShipment_to_AMRFlatFile2017Tests
    {
        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void UniversalShipment_to_AMRFlatFile_TestDetailedDescription()
        {
            InitialiseMessageTestingContext();
            InitialiseCodeMapsTestingContext();

            string sourceFile = "UniversalShipment_to_AMRFlatFileTests_input.input2017_DetailedDescription.xml";
            string outputFile = "UniversalShipment_to_AMRFlatFileTests_output.output2017_DetailedDescription.xml";
        ...
        {
            TestMap("UniversalShipment_to_AMRFlatFileTests_input.input2017_1.xml", "UniversalShipment_to_AMRFlatFileTests_output.output2017_1.xml");
        }
        ...
        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void UniversalShipment_to_AMRFlatFile_TestUserNamePassword()
        {
            InitialiseMessageTestingContext();
            InitialiseCodeMapsTestingContext();

            string sourceFile = "UniversalShipment_to_AMRFlatFileTests_input.input2017_UserNamePassword.xml";
            string outputFile = "UniversalShipment_to_AMRFlatFileTests_output.output2017_UserNamePassword.xml";
