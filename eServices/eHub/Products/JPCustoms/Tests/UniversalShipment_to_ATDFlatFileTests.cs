...
using CargoWise.eHub.Products.JPCustoms.Transforms.UniversalShipment2ATDFlatFile;
...
{
    [TestClass]
    public class UniversalShipment_to_ATDFlatFileTests
    {

        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void UniversalShipment_to_ATDFlatFile_Test1()
        {
            InitialiseMessageTestingContext();
            InitialiseCodeMapsTestingContext();

            string sourceFile = "UniversalShipment_to_ATDFlatFileTests_input.input_1.xml";
            string outputFile = "UniversalShipment_to_ATDFlatFileTests_output.output_1.xml";
            ...
            mapTester.Execute<UniversalShipment_to_ATDFlatFile>(sourceFile, outputFile);
        }

        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void UniversalShipment_to_ATDFlatFile_Test2()
        {
            TestMap("UniversalShipment_to_ATDFlatFileTests_input.input_2.xml", "UniversalShipment_to_ATDFlatFileTests_output.output_2.xml");
        }

        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void UniversalShipment_to_ATDFlatFile_TestUserNamePassword()
        {
            InitialiseMessageTestingContext();
            InitialiseCodeMapsTestingContext();

            string sourceFile = "UniversalShipment_to_ATDFlatFileTests_input.input_UserNamePassword.xml";
            string outputFile = "UniversalShipment_to_ATDFlatFileTests_output.output_UserNamePassword.xml";
