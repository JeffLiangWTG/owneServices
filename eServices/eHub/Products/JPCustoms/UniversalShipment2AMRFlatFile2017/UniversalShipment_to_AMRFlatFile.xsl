...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/s0:UniversalShipment">
		<xsl:element name="ns0:AMRFlatFileSchemaEnvelope">
      ...
      <xsl:variable name="userPassword" select="ScriptNS3:GetPassword($sourceParty)" />
			<xsl:for-each select="//*[local-name()='UniversalShipment']/*[local-name()='Shipment']/*[local-name()='SubShipmentCollection']/*[local-name()='SubShipment']">
				<xsl:element name="ns0:AMRInput">
					...
					<xsl:element name="ns0:InputCommonField">
						...
						<xsl:element name="ns0:ProcedureCode">
							<xsl:choose>
								<xsl:when test="normalize-space(./*[local-name()='DataContext']/*[local-name()='ActionPurpose']/*[local-name()='Code']) = 'REG'">AMR</xsl:when>
								<xsl:otherwise>CMR</xsl:otherwise>
							</xsl:choose>
						</xsl:element>
              ...
              <xsl:value-of select="ScriptNS3:GetSPPassword()" />
					...
					<xsl:element name="ns0:DeleteReasonCode">
						<xsl:variable name="DeleteReasonCode" select="*[local-name()='AddInfoCollection']/*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPDeleteReasonCode'][1]/*[local-name()='Value']" />
						<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($DeleteReasonCode/text()),1)"/>
					</xsl:element>
					<xsl:element name="ns0:DeleteReasonText">
						<xsl:variable name="DeleteReasonText" select="*[local-name()='AddInfoCollection']/*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPDeleteReasonText'][1]/*[local-name()='Value']" />
						<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($DeleteReasonText/text()), 210)"/>
					</xsl:element>
					...
					<xsl:element name="ns0:OperatingCarrierVoyageNo">
						<xsl:variable name="OperatingCarrierVoyageNo" select="../../*[local-name()='AddInfoCollection']/*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPOperatingCarrierVoyageNo'][1]/*[local-name()='Value']" />
						<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($OperatingCarrierVoyageNo),10)"/>
					</xsl:element>
					...
					<xsl:if test="$BillOfLadingNumber">
						<xsl:element name="ns0:HouseBillInfo">
							<xsl:element name="ns0:BillOfLadingNumber">
                        ...
                        /*[local-name()='Value']/text())='Y'" >
							...
							<xsl:element name="ns0:MasterBillIdentifier">
								<xsl:value-of select="normalize-space(*[local-name()='AddInfoCollection']
                        /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPMasterBillIdentifier'][1]
                        /*[local-name()='Value']/text())" />
							</xsl:element>
							...
							<xsl:element name="ns0:PortOfDischargeSuffix">
								<xsl:value-of select ="userCSharp:StringMaxAllowed(
                            normalize-space(../../*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPPortOfDischargeSuffix'][1]
                            /*[local-name()='Value']/text()),1)"/>
							</xsl:element>
							...
							<!-- Segment: AI -->
							<xsl:element name="ns0:ContainerOperatorCode">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space(*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPContainerOperatorCode'][1]
                            /*[local-name()='Value']/text()),5)"/>
							</xsl:element>
							...
							<xsl:element name="ns0:GoodsDescription">
								<xsl:variable name="DetailedDescription" select="userCSharp:StringLeftBytes(normalize-space($packingLine/*[local-name()='DetailedDescription']/text()),350)"/>
								<xsl:choose>
							...
							<xsl:element name="ns0:SpecialCargoCode">
								<xsl:variable name="SpecialCargoCode" select="*[local-name()='AddInfoCollection']/*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPSPCCode'][1]/*[local-name()='Value']" />
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($SpecialCargoCode/text()),3)"/>
							</xsl:element>
							<xsl:variable name="UNDGData1" select ="$packingLine/*[local-name()='UNDGCollection']/*[local-name()='UNDG'][1]"/>
							<xsl:variable name="UNDGData2" select ="$packingLine/*[local-name()='UNDGCollection']/*[local-name()='UNDG'][2]"/>
							<xsl:variable name="UNDGData3" select ="$packingLine/*[local-name()='UNDGCollection']/*[local-name()='UNDG'][3]"/>
							<xsl:variable name="UNDGData4" select ="$packingLine/*[local-name()='UNDGCollection']/*[local-name()='UNDG'][4]"/>
							<xsl:variable name="UNDGData5" select ="$packingLine/*[local-name()='UNDGCollection']/*[local-name()='UNDG'][5]"/>
							<xsl:element name="ns0:IMDGClass1">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($UNDGData1/*[local-name()='IMOClass']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:UNNo1">
								<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($UNDGData1/*[local-name()='UNDGCode']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:IMDGClass2">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($UNDGData2/*[local-name()='IMOClass']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:UNNo2">
								<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($UNDGData2/*[local-name()='UNDGCode']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:IMDGClass3">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($UNDGData3/*[local-name()='IMOClass']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:UNNo3">
								<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($UNDGData3/*[local-name()='UNDGCode']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:IMDGClass4">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($UNDGData4/*[local-name()='IMOClass']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:UNNo4">
								<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($UNDGData4/*[local-name()='UNDGCode']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:IMDGClass5">
								<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space($UNDGData5/*[local-name()='IMOClass']/text()),4)"/>
							</xsl:element>
							<xsl:element name="ns0:UNNo5">
								<xsl:value-of select="userCSharp:StringLeftBytes(normalize-space($UNDGData5/*[local-name()='UNDGCode']/text()),4)"/>
							</xsl:element>
                        ...
                        and *[local-name()='ChargeType']/*[local-name()='Code']/text()='OFT'][1]" />
							...
							<xsl:variable name="generalCustomsTransitApprovalNumber" select="userCSharp:StringMaxAllowed(normalize-space(*[local-name()='AddInfoCollection']/*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPGeneralCustomsTransitApprovalNumber'][1]/*[local-name()='Value']/text()),11)"/>
							<xsl:element name="ns0:GeneralCustomsTransitApprovalNumber">
								<xsl:value-of select="$generalCustomsTransitApprovalNumber"/>
							</xsl:element>
	...
	<xsl:template name="OrgAddress" match="*[local-name()='OrganizationAddressCollection']">
		...
		<xsl:element name="{concat('ns0:',$targetAddressType,'Code')}">
			<xsl:if test="($sourceAddress/*[local-name()='GovRegNumType']/*[local-name()='Code']='REG')" >
				<xsl:value-of select="userCSharp:StringMaxAllowed(normalize-space(*[local-name()='GovRegNum']/text()),17)"/>
			</xsl:if>
		</xsl:element>
		...
		<xsl:choose>
			<xsl:when test="$targetAddress2 = '' or string-length(normalize-space($targetAddress1to4)) &lt; 175">
	...
	<xsl:template name="ContainerInfo" match="*[local-name()='Container']">
		<xsl:element name="ns0:ContainerInfo">
			...
			<xsl:element name="ns0:ServiceTypeOnDeliveryCode">
				<xsl:value-of select="userCSharp:StringMaxAllowed(
                            normalize-space(*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPContainerTypeOfService'][1]
                            /*[local-name()='Value']/text()),2)"/>
			</xsl:element>
			<xsl:element name="ns0:ContainerOwnershipCode">
				<xsl:value-of select="userCSharp:StringMaxAllowed(
                            ...
                            /*[local-name()='Value']/text()),3)"/>
			</xsl:element>
			<xsl:element name="ns0:VanningTypeCode">
				<xsl:value-of select="userCSharp:StringMaxAllowed(
                            normalize-space(*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPContainerVanningType'][1]
                            /*[local-name()='Value']/text()),3)"/>
			</xsl:element>
			<xsl:element name="ns0:CCCApplicationId">
				<xsl:value-of select="userCSharp:StringMaxAllowed(
                            normalize-space(*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPContainerCCCApplicationId'][1]
                            /*[local-name()='Value']/text()),1)"/>
			</xsl:element>
			<xsl:element name="ns0:SearchExclusionId">
				<xsl:variable name="searchExclusionId" select="userCSharp:StringMaxAllowed(
                            normalize-space(*[local-name()='AddInfoCollection']
                            /*[local-name()='AddInfo' and *[local-name()='Key']/text()='JPContainerSearchExclusionId'][1]
                            /*[local-name()='Value']/text()),1)"/>
				<xsl:if test="$searchExclusionId = 'A'">
