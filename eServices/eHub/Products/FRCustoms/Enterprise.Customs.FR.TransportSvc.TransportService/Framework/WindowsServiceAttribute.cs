...
namespace Enterprise.Customs.FR.TransportSvc.TransportService.Framework
{
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1019:CSharpDefineAccessorsForAttributeArgumentsAnalyzer")]
	public sealed class WindowsServiceAttribute : Attribute
	{
		...
		public WindowsServiceAttribute(string name)
		{
			...
			ServiceDependsOn = Array.Empty<string>();
			CanStop = true;
			CanShutdown = true;
