...
{
  [TestClass]
  public class UShipment2CAED_Tests
  {
    const string filePath = "APPLUS.CAED.TestFiles.";

    [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
    public void TestUShipment2CAED()
    {
    ...
    void AssertMapping(string inputFile, string expectedOutputFile, string serviceProvider, bool isExport, string routingPartyValue = "")
    {
      ...
      mockContextAccessor.Expect(x => x.SetContextProperty("OverrideFilename", "http://cargowise.com/ehub/processing/2010/06", "CAED_TESTSENDER_1"));
      ...
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue(serviceProviderMSGID, serviceProvider, "TESTSENDER", formattedInterchangeNumber, "Customs Pre-Check (CAED) - " + (isExport ? "Export" : "Import"), "DocumentName"));
      ...
      mapTester.ExecuteCompiled<UShipment2CAED>(input, expectedOutput);
