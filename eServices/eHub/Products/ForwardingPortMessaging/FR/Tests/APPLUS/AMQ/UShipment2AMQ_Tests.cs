...
{
  [TestClass]
  public class UShipment2AMQ_Tests
  {
    const string filePath = "APPLUS.AMQ.TestFiles.";

    [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
    public void TestUShipment2AMQ()
    {
      ...
      AssertSchema("Test1_SOGET_previousMessageIdentifier_output.xml");
      AssertSchema("Test1_MGI_previousMessageIdentifier_output.xml");
      AssertSchema("Test2_output.xml");
      AssertSchema("Test3_output.xml");
    ...
    public void AssertSchema(string expectedOutputFile)
    {
      ...
      var schemaValidator = XMLValidator.Validate<amq>(expectedOutput);
      Assert.AreEqual(string.Empty, schemaValidator, "UShipment2AMQ is not valid: \r\n " + schemaValidator);
    }
    ...
    void AssertMapping(string inputFile, string expectedOutputFile, string serviceProvider, string routingPartyValue = "", string previousMessageIdentifier = "")
    {
      ...
      mockContextAccessor.Expect(x => x.SetContextProperty("OverrideFilename", "http://cargowise.com/ehub/processing/2010/06", "AMQ_TESTSENDER_1"));
      ...
      mockCodeMapper.Expect(x => x.CallActionProcedureHelper("SelectSubscribedReference", "@reference", "@senderId", serviceProvider, "@recipientId", "TESTSENDER", "@ST_ID", serviceProviderMSGID, "@value", "C00001266_CONT1111111_AMQ", "@referenceType", "MessageReference")).Return(previousMessageIdentifier).Repeat.Any();
      mockCodeMapper.Expect(x => x.CallActionProcedureHelper("SelectSubscribedReference", "@reference", "@senderId", serviceProvider, "@recipientId", "TESTSENDER", "@ST_ID", serviceProviderMSGID, "@value", "C00001266_CONT2222222_AMQ", "@referenceType", "MessageReference")).Return(previousMessageIdentifier).Repeat.Any();
      ...
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue(serviceProviderMSGID, serviceProvider, "TESTSENDER", messageIdentifier, "Container Advice to Booking (AMQ)", "DocumentName")).Repeat.Any();
      ...
      foreach (var containerNumber in containerNumbers)
      {
        ...
        {
          mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue(serviceProviderMSGID, serviceProvider, "TESTSENDER", string.Concat("C00001266_", containerNumber, "_AMQ"), messageIdentifier, "MessageReference")).Repeat.Any();
        }
      }
      ...
      mockCodeMapper.Expect(x => x.CallActionProcedureHelper("SelectSubscribedReference", "@reference", "@senderId", serviceProvider, "@recipientId", "TESTSENDER", "@ST_ID", serviceProviderMSGID, "@value", "C00001266_CONT1111111", "@referenceType", "ContainerRank")).Return("1").Repeat.Any();
      mockCodeMapper.Expect(x => x.CallActionProcedureHelper("SelectSubscribedReference", "@reference", "@senderId", serviceProvider, "@recipientId", "TESTSENDER", "@ST_ID", serviceProviderMSGID, "@value", "C00001266_CONT2222222", "@referenceType", "ContainerRank")).Return("").Repeat.Any();
      //var containerRankCounter = 1;
      mockCodeMapper.Expect(x => x.CallActionProcedureHelper("SelectSubscribedReference", "@reference", "@senderId", serviceProvider, "@recipientId", "TESTSENDER", "@ST_ID", serviceProviderMSGID, "@value", "C00001266", "@referenceType", "ContainerRankCounter")).Return("1").Repeat.Any();
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue(serviceProviderMSGID, serviceProvider, "TESTSENDER", "C00001266", "2", "ContainerRankCounter")).Repeat.Any();
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue(serviceProviderMSGID, serviceProvider, "TESTSENDER", "C00001266_CONT2222222", "2", "ContainerRank")).Repeat.Any();
      ...
      mapTester.ExecuteCompiled<UShipment2AMQ>(input, expectedOutput);
