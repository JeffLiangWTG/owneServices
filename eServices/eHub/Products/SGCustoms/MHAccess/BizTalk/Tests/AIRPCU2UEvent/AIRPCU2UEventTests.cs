...
using CargoWise.eHub.Products.SGCustoms.MHAccess.BizTalk.Send.Maps.AIRPCU2UEvent;
...
namespace CargoWise.eHub.Products.SGCustoms.MHAccess.BizTalk.Tests
{
	...
	public class AIRPCU2UEventTests
	{
		...
		public void Test2_failure()
		{
			...
			var subscriptionInput = ReadResource("AIRPCU2UEvent.TestFiles.Test2_subscription_Input.xml");
			var subscriptionOutput = ReadResource("AIRPCU2UEvent.TestFiles.Test2_subscription_Output_failure.xml");
			...
			mapTester.ExecuteCompiled<AIRPCU2UEvent>(input, expectedOutput);
		...
		public void Test2_success()
		{
			...
			var subscriptionInput = ReadResource("AIRPCU2UEvent.TestFiles.Test2_subscription_Input.xml");
			var subscriptionOutput = ReadResource("AIRPCU2UEvent.TestFiles.Test2_subscription_Output_success.xml");
