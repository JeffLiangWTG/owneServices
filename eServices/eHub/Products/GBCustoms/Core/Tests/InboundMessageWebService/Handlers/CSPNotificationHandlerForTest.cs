...
{
	public class CSPNotificationHandlerForTest : CSPNotificationHandler
	{
		public CSPNotificationHandlerForTest(ProviderType provider) : base(provider)
		{
		}
		...
		protected internal override string GetSubscription(SqlTransaction transaction, string recipient, string value, string subscriptionType)
		{
