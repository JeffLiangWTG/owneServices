...
namespace CargoWise.eHub.Products.GBCustoms.CNS.InboundMessageWebService
{
    public class InboundMessageWebServiceHealthCheckItemProvider : IHealthCheckItemProvider
    {
        public string Name { get { return "GBCustomsCNSNotificationWebService"; } }
		...
		string CheckCreatingServiceInstance()
		{
			try
			{
				var instance = new CNSNotificationController();
