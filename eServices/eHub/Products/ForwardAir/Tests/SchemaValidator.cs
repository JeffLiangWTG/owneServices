...
namespace CargoWise.eHub.Products.ForwardAir.Tests
{
  ...
  {
    public static void ValidateSchema<T>(string expectedOutput, List<string> errorWhiteList) where T : SchemaBase, new()
    {
    ...
    internal static bool ContainsAny(string input, List<string> containsKeywords)
    {
