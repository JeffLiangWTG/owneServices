...
{
	[TestClass]
	public class UniversalInterchange_VGMMultipleRecipientsSplitTests
	{
		const string filePath = "UniversalInterchange_VGMMultipleRecipientsSplit.TestFiles.";

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void UniversalInterchange_VGMMultipleRecipientsSplit()
		{
        ...
        void AssertMapping(string inputFile, string expectedOutputFile)
		{
			...
			mapTester.Execute<UniversalInterchange_VGMMultipleRecipientsSplit>(input, expectedOutput);
