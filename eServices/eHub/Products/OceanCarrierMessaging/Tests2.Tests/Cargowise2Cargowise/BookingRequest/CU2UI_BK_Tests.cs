...
{
  [TestClass]
  public class Cargowise2Cargowise_CU2UI_BK_Tests
  {
    const string filePath = "Cargowise2Cargowise.BookingRequest.TestFiles.";

    [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
    public void TestCU2UI_BK()
    {
      AssertMapping("Test1_CLD_input.xml", "Test1_CLD_output.xml", "C00001001", "", "NVOCC", "ForwardingConsol");
      AssertMapping("Test2_AGT_input.xml", "Test2_AGT_output.xml", "C00001002", "WTG0000000098", "ShippingLine", "ForwardingConsol");
      ...
      AssertMapping("Test5_CLD_Shipment_input.xml", "Test5_CLD_Shipment_output.xml", "S00001002", "WTG0000000098", "ShippingLine", "ForwardingShipment", formVersion: "1.0.0");
      AssertMapping("Test6_CLD_input.xml", "Test6_CLD_output.xml", "C00001001", "", "NVOCC", "ForwardingOther");
      AssertMapping("Test7_CLD_Shipment_input.xml", "Test7_CLD_Shipment_output.xml", "S00001002", "", "ShippingLine", "ForwardingShipment", formVersion: "1.0.0");
      AssertMapping("Test8_NVOCC_WTH_input.xml", "Test8_NVOCC_WTH_output.xml", "C00001001", "", "NVOCC", "ForwardingConsol");
      AssertMapping("Test9_Carrier_WTH_input.xml", "Test9_Carrier_WTH_output.xml", "C00001001", "", "ShippingLine", "ForwardingConsol");

      AssertMapping("Test10_GroupingMethod_input.xml", "Test10_GroupingMethod_output.xml", "C00001001", "", "NVOCC", "ForwardingConsol", formVersion:"3.0.0");
    }

    [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
    public void TestCU2UI_BK_RecipientIDNotFound()
    {
    ...
    void AssertMapping(string inputFile, string expectedOutputFile, string consolNumber, string previousSubscriptReference, string ehubPartyType, string forwardingType = "", string registeredClientID = "HYEDAUUG1", string formVersion = "")
    {
      ...
      mockContextAccessor.Expect(x => x.GetContextProperty("DestinationParty", "http://schemas.microsoft.com/BizTalk/2003/system-properties")).Return("CARGOWISE_BK1");
      ...
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue("CW1MSG", "HYEDAUUG1", "HYEUAT001", consolReference, "WTH", "ActionPurpose")).Repeat.Any();
      ...
      mockDataModelAccessor.Expect(x => x.InsertSubscriptionValue("CW1MSG", "HYEDAUUG1", "HYEUAT001", consolReference, "Booking Request", "DocumentName")).Repeat.Any();
      ...
      mockOCMHelper.Expect(x => x.IsCoLoad("STD")).Return("FALSE").Repeat.Any();
      ...
      mapTester.ExecuteCompiled<CU2UI_BK>(input, expectedOutput);
