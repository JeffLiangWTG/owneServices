...
"%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministratorsDev -View:eHubGatewayLogView
REM "%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministratorsDev -View:ExcAll
REM "%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministratorsDev -View:ExcByApplication
