...
"%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministrators -View:eHubGatewayLogView
REM "%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministrators -View:ExcAll
REM "%PROGRAMFILES(X86)%\Microsoft BizTalk Server 2013 R2\Tracking\bm.exe" add-account -AccountName:CORPORATE\BizTalkAdministrators -View:ExcByApplication
