...
@IF '%1' NEQ '' (
	ECHO ERROR: This process does not do deployments.
	GOTO :END
)
...
%MSBuild% %Properties% %Logger% /t:StopApplication;StopHostInstances
if ERRORLEVEL 1 GOTO :RESTART
GOTO :END

:RESTART
%MSBuild% %Properties% %Logger% /t:StartHostInstances,StartApplication
