...
using CargoWise.eHub.Clients.RKG.Transforms.UniTrans_2_X12_210_LAM;
using CargoWise.eHub.DataAccess.Models.CodeMapsTesting;
using CargoWise.eHub.DataAccess.Sql;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace CargoWise.eHub.Clients.RKG.Tests
{
    [TestClass]
    public class UniTrans_2_X12_210_LAMTests
    {
        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void TestUniTrans_2_X12_210_LAM()
        {
            InitialiseCodeMapsTestingContext();
            MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

            string sourceFile = "UniTrans_2_X12_210_LAM.TestFiles.1_Input.xml";
            string expectedFile = "UniTrans_2_X12_210_LAM.TestFiles.1_Output.xml";
            mapTester.ExecuteCompiled<UniTrans_2_X12_210_LAM>(sourceFile, expectedFile);

            sourceFile = "UniTrans_2_X12_210_LAM.TestFiles.2_Input.xml";
            expectedFile = "UniTrans_2_X12_210_LAM.TestFiles.2_Output.xml";
            mapTester.ExecuteCompiled<UniTrans_2_X12_210_LAM>(sourceFile, expectedFile);

            sourceFile = "UniTrans_2_X12_210_LAM.TestFiles.3_Input.xml";
            expectedFile = "UniTrans_2_X12_210_LAM.TestFiles.3_Output.xml";
            mapTester.ExecuteCompiled<UniTrans_2_X12_210_LAM>(sourceFile, expectedFile);
        }
        ...
        static void InitialiseCodeMapsTestingContext()
        {
            ...
            ctx.eHubClients.Add(new eHubClient { CC_ID = "RKGSJCLAX" });
            ctx.eHubClients.Add(new eHubClient { CC_ID = "RKGSJCLAX_LAM" });
            ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "SSUI 210 LAM Research - Send AR Invoices", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
            ...
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "RKLG" });
            ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "POD03 Fallback" });
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "NO SIGNATURE AVAILABLE" });
            ...
            ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "Transport Mode - R304" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 2, CK_Key1Value = "ROA" });
            ...
            ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "Service Type - R311" });
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "STD" });
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "DA" });
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 99, CK_Key1Value = "%" });
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "LBFRT" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "AES" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 2, CK_Key1Value = "FOB" });
