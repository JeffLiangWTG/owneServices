...
using CargoWise.eHub.Clients.W43.Transforms.PackingScheduleCsv_2_UniShip;
using CargoWise.eHub.DataAccess.Models.CodeMapsTesting;
using CargoWise.eHub.DataAccess.Sql;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace CargoWise.eHub.Clients.W43.Tests
{
    [TestClass]
    public class PackingScheduleCsv_2_UniShipTests
    {
        ...
        static void InitialiseCodeMapsTestingContext()
        {
            ...
            ctx.eHubClients.Add(new eHubClient { CC_ID = "W43MELPRD_PAC" });
            ctx.eHubClients.Add(new eHubClient { CC_ID = "W43MELPRD" });
