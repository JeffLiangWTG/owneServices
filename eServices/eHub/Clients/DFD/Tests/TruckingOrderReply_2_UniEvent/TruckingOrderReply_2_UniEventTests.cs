...
using CargoWise.eHub.Clients.DFD.Transforms.TruckingOrderReply_2_UniEvent;
...
namespace CargoWise.eHub.Clients.DFD.Tests
{
	...
	public class TruckingOrderReply_2_UniEventTests
	{
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "ExWorks XML - Receive Response Events", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
