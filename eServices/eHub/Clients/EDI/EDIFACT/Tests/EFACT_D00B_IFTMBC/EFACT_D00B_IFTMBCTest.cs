...
{
	[TestClass]
	public class EFACT_D00B_IFTMBCTest
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestTheMaxOccursOfFTX3GreaterThan9()
		{
			XmlSchemaSet schemas = new EFACT_D00B_IFTMBC().SchemaSet;
			XDocument doc = XDocument.Parse(GetResourceAsString("EFACT_D00B_IFTMBC.TestFiles.EFACT_D00B_IFTMBC_FTX3GreaterThan9.xml"));
			string msg = "";
