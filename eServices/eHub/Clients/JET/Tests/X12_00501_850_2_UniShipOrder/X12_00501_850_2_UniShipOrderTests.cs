...
using CargoWise.eHub.Clients.JET.Transforms.X12_00501_850_2_UniShipOrder;
...
{
	[TestClass]
	public class X12_00501_850_2_UniShipOrderTests
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestX12_00501_850_2_UniShipOrder()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "X12_00501_850_2_UniShipOrder.TestFiles.Input.xml";
			string expectedFile = "X12_00501_850_2_UniShipOrder.TestFiles.Output.xml";
			mapTester.Execute<X12_00501_850_2_UniShipOrder>(sourceFile, expectedFile);

			sourceFile = "X12_00501_850_2_UniShipOrder.TestFiles.Header_Input.xml";
			expectedFile = "X12_00501_850_2_UniShipOrder.TestFiles.Header_Output.xml";
			mapTester.Execute<X12_00501_850_2_UniShipOrder>(sourceFile, expectedFile);
		}
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "JETORDENT_I85" });
			ctx.eHubClients.Add(new eHubClient { CC_ID = "JETORDENT" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "ILTC 850 - Receive OrderManager Orders", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
			...
			ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "JETSPEORD" });
			...
			ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "IN" });
			...
			ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 2, CK_Key1Value = "EA" });
