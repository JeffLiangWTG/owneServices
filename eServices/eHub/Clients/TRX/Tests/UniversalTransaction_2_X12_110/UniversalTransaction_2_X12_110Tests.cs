...
using CargoWise.eHub.Clients.TRX.Transforms.UniversalTransaction_2_X12_110;
...
{
	[TestClass]
	public class UniversalTransaction_2_X12_110Tests
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestUniversalTransaction_2_X12_110()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "UniversalTransaction_2_X12_110.TestFiles.UniversalTransaction_2_X12_110_input.xml";
			string expectedFile = "UniversalTransaction_2_X12_110.TestFiles.UniversalTransaction_2_X12_110_output.xml";
			mapTester.Execute<UniversalTransaction_2_X12_110>(sourceFile, expectedFile);

			sourceFile = "UniversalTransaction_2_X12_110.TestFiles.UniversalTransaction_2_X12_110_Dom_input.xml";
			expectedFile = "UniversalTransaction_2_X12_110.TestFiles.UniversalTransaction_2_X12_110_Dom_output.xml";
			mapTester.Execute<UniversalTransaction_2_X12_110>(sourceFile, expectedFile);
		}
		...
		private static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRXELPELP_SPR" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "Sprint Wireless 110 - Export A/R Invoices", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
			...
			ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "TXAP" });
			ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "Goods Signed By" });
