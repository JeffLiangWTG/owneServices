...
using CargoWise.eHub.Clients.MC4.Transforms.NichiboTsv_202106_2_UniShip;
...
{
    [TestClass]
    public class NichiboTsv_202106_2_UniShipTests
    {
        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void TestNichiboTsv_202106_2_UniShip_202106()
        {
            ...
            string sourceFile = "NichiboTsv_202106_2_UniShip.TestFiles.202106_Input.xml";
            string expectedFile = "NichiboTsv_202106_2_UniShip.TestFiles.202106_Output.xml";
            mapTester.ExecuteCompiled<NichiboTsv_202106_2_UniShip>(sourceFile, expectedFile);
        }

        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void TestNichiboTsv_202106_2_UniShip_New()
        {
            InitialiseCodeMapsTestingContext();
            ...
            string sourceFile = "NichiboTsv_202106_2_UniShip.TestFiles.New_Input.xml";
            string expectedFile = "NichiboTsv_202106_2_UniShip.TestFiles.New_Output.xml";
            mapTester.ExecuteCompiled<NichiboTsv_202106_2_UniShip>(sourceFile, expectedFile);
        }

        [TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
        public void TestNichiboTsv_202106_2_UniShip_Fallback()
        {
            InitialiseCodeMapsTestingContext();
            ...
            string sourceFile = "NichiboTsv_202106_2_UniShip.TestFiles.Fallback_Input.xml";
            string expectedFile = "NichiboTsv_202106_2_UniShip.TestFiles.Fallback_Output.xml";
            mapTester.ExecuteCompiled<NichiboTsv_202106_2_UniShip>(sourceFile, expectedFile);
        }
        ...
        private static void InitialiseCodeMapsTestingContext()
        {
            ...
            ctx.eHubClients.Add(new eHubClient { CC_ID = "MC4AKLAKL_M01" });
            ctx.eHubClients.Add(new eHubClient { CC_ID = "MC4AKLAKL" });
            ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "Nichibo tab-file - Receive Consols CusDec&Inv-NEW", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
            ...
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "NICHIBO" });
            ...
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "AB1" });
            ...
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "VE" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 6, CK_Key1Value = "%VOLKSWAGEN%" });
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "DE" });
            ...
            ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "1%", CK_Key2Value = "PETROL", CK_Key3Value = "SEDAN", CK_Key4Value = "%" });
            ...
            ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "VD" });
