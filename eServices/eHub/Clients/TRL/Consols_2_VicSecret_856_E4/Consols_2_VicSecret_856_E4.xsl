    ...
    <ns0:X12_00401_856>
      ...
      <ns0:BSN>
        ...
        <xsl:element name="BSN01">
          <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data', 'Trigger Purpose', 'Purpose Code - BSN01', $Purpose)"/>
        </xsl:element>
      ...
      <xsl:element name ="ns0:HLLoop1">
        ...
        <xsl:if test="$Chargeable > 0">
          <xsl:element name="ns0:TD1">
            ...
            <TD108>
              <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Measurement Code' , 'Output Code' , $Chargeable/@*[local-name()='DimensionType'])" />
            </TD108>
          </xsl:element>
        </xsl:if>
        ...
        <xsl:if test="$Weight > 0">
          <xsl:element name="ns0:TD1">
            ...
            <TD108>
              <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Measurement Code' , 'Output Code' , $Weight/@*[local-name()='DimensionType'])" />
            </TD108>
          </xsl:element>
        </xsl:if>
        ...
        <xsl:element name="ns0:TD5">
          ...
          <TD504>
            <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Transport Mode' , 'Output Code' , $TransportMode)" />
          </TD504>
          <TD507>OR</TD507>
          <TD508>
        ...
        <xsl:element name="ns0:TD5">
          ...
          <TD508>
            ...
            <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Schedule D Code' , 'Output Code' , $DischargePort)" />
          </TD508>
        </xsl:element>
        ...
        <xsl:if test="$TransportMode = 'AIR' and $EntryPort != ''">
          <xsl:element name="ns0:TD5">
            ...
            <TD507>PE</TD507>
            <TD508>
              <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Schedule D Code' , 'Output Code' , $EntryPort)" />
            </TD508>
          </xsl:element>
        </xsl:if>
        ...
        <xsl:variable name="XE" select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'REF XE' , 'XE' , $ServiceLevel)" />
        <xsl:if test="$XE != ''">
          <xsl:element name="ns0:REF" >
            <REF01>XE</REF01>
            <REF02>
        ...
        <xsl:variable name="RB" select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'REF RB' , 'RB' , $XE,
      ...
      <xsl:for-each select="$Shipment/*[local-name()='Orders']/*[local-name()='Order']">
        ...
        <xsl:element name ="ns0:HLLoop1">
          ...
          <xsl:element name="ns0:TD1">
            <TD101>
              <xsl:value-of select="ScriptNS0:GetRecipientCodeUnkeyed('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Defaults' , 'Packing Code')" />
            </TD101>
            <TD102>
            ...
            <xsl:if test="$TotalWeight > 0">
              ...
              <TD108>
                <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Measurement Code' , 'Output Code' , $TotalWeight/@*[local-name()='DimensionType'])" />
              </TD108>
            </xsl:if>
          </xsl:element>
...
public int GetREF01Number()
{
  ...
  <xsl:template name="generateIATACode">
    ...
    <xsl:variable name="IATACode" select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'IATA Code' , 'Output Code' , $Port)" />
    <xsl:choose>
    ...
    <xsl:element name="ns0:TD1">
      ...
      <xsl:choose>
        <xsl:when test="$Weight > 0">
          ...
          <TD108>
            <xsl:value-of select="ScriptNS0:GetRecipientCode('TRLVSRTRI' , 'TRLVSRTRI_VS2' , 'VS 856 - Export Shipment &amp; Order data' , 'Measurement Code' , 'Output Code' , *[local-name()='OrderDetail']/*[local-name()='ShipmentPlanning']/*[local-name()='Weight']/@*[local-name()='DimensionType'])" />
          </TD108>
        </xsl:when>
        <xsl:otherwise>
          <TD107>
