...
>
  ...
  <xsl:template name="generateIATACode">
    ...
    <xsl:variable name="IATACode" select="ScriptNS0:GetRecipientCode(&quot;TRLVSRTRI&quot; , &quot;TRLVSRTRI_VS3&quot; , &quot;VS 810 - Export A/R Invoices&quot; , &quot;IATA Code&quot; , &quot;Output Code&quot; , $Port)" />
    <xsl:choose>
  ...
  and *[local-name()='DataContext']
    ...
    <xsl:variable name="FreightChargeCode" select="ScriptNS0:GetRecipientCodeUnkeyed('TRLVSRTRI' , 'TRLVSRTRI_VS3' , 'VS 810 - Export A/R Invoices', 'Defaults', 'Freight Charge Codes')"/>
      ...
      <xsl:element name ="ns0:SACLoop1">
        <xsl:element name ="ns0:SAC">
          ...
          <SAC04>
            ...
            <xsl:value-of select="ScriptNS0:GetRecipientCode(&quot;TRLVSRTRI&quot; , &quot;TRLVSRTRI_VS3&quot; , &quot;VS 810 - Export A/R Invoices&quot; , &quot;Charge Code&quot; , &quot;Output Code&quot; , string($ChargeCode))"/>
          </SAC04>
          <SAC05>
          ...
          <SAC09>
            <xsl:variable name="MeasurementCode" select="//*[local-name()='TransactionInfo']
                          ...
                          /*[local-name()='Code']"/>
            <xsl:value-of select="ScriptNS0:GetRecipientCode(&quot;TRLVSRTRI&quot; , &quot;TRLVSRTRI_VS3&quot; , &quot;VS 810 - Export A/R Invoices&quot; , &quot;Measurement Unit&quot; , &quot;Output Code&quot; , string($MeasurementCode))"/>
          </SAC09>
          <SAC10>1</SAC10>
