...
using CargoWise.eHub.Clients.TRL.Transforms.Consols_2_VicSecret_856_E4;
using CargoWise.eHub.Clients.TRL.Transforms.Shipments_2_VicSecret_856_E1;
...
{
	[TestClass]
	public class ConsolsInternal_2_VicSecret_856Test
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestShipments_2_VicSecret_856_E1()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Shipments_2_VicSecret_856_E1_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Shipments_2_VicSecret_856_E1_output.xml";
			mapTester.Execute<Shipments_2_VicSecret_856_E1>(sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestConsols_2_VicSecret_856_E4_Sea()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_Sea_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_Sea_output.xml";
			mapTester.Execute<Consols_2_VicSecret_856_E4>(sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestConsols_2_VicSecret_856_E4_Air()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_Air_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_Air_output.xml";
			mapTester.Execute<Consols_2_VicSecret_856_E4>(sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestConsolsInternal_2_VicSecret_856_MultiCPO()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_MultiCPO_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_VicSecret_856.TestFiles.Consols_2_VicSecret_856_E4_MultiCPO_output.xml";
			mapTester.Execute<Consols_2_VicSecret_856_E4>(sourceFile, expectedFile);
		}
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_VS2" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "VS 856 - Export Shipment & Order data", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
			...
			//REF XE
			ctx.eHubCodeSets.Add(new eHubCodeSet { CS_Name = "REF XE", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1], eHubTransformationSet = ctx.eHubTransformationSets[0] });
			ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "XE" });
			...
			ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 2, CK_Key1Value = "T01" });
			ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "T01" });
			...
			//REF RB
			ctx.eHubCodeSets.Add(new eHubCodeSet { CS_Name = "REF RB", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1], eHubTransformationSet = ctx.eHubTransformationSets[0] });
			ctx.eHubCodeSetResults.Add(new eHubCodeSetResult { eHubCodeSet = ctx.eHubCodeSets.Last(), CR_Order = 1, CR_Name = "RB" });
			ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 1, CK_Key1Value = "STD", CK_Key2Value = "" });
			...
			ctx.eHubCodeMapKeys.Add(new eHubCodeMapKey { eHubCodeSet = ctx.eHubCodeSets.Last(), CK_Order = 2, CK_Key1Value = "STD", CK_Key2Value = "%" });
