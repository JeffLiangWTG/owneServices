...
using CargoWise.eHub.Clients.TRL.Transforms.TRLX12_4010_850_2_OrdersInternal;
using System.Collections.Generic;

namespace CargoWise.eHub.Clients.TRL.Tests
{
	[TestClass]
	public class TRLX12_4010_850_2_OrdersInternalTest
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestTRLX12_4010_850_2_OrdersInternal()
		{
			...
			string sourceFile = "TRLX12_4010_850_2_OrdersInternal.TestFiles.TRLX12_4010_850_2_OrdersInternal_input.xml";
			string expectedFile = "TRLX12_4010_850_2_OrdersInternal.TestFiles.TRLX12_4010_850_2_OrdersInternal_output.xml";
			mapTester.Execute<TRLX12_4010_850_2_OrdersInternal>(sourceFile, expectedFile);
		}

		static void InitialiseCodeMapsTestingContext()
		{
			CodeMapsTestingContext ctx = new CodeMapsTestingContext();
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_L50" });
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "LTD 850 - Import of OrderManager Orders", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
