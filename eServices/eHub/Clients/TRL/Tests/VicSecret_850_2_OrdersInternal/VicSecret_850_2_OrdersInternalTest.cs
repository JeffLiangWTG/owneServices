...
using CargoWise.eHub.Clients.TRL.Transforms.VicSecret_850_2_OrdersInternal;
using System.Collections.Generic;

namespace CargoWise.eHub.Clients.TRL.Tests
{
	[TestClass]
	public class VicSecret_850_2_OrdersInternalTest
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestVicSecret_850_2_OrdersInternal()
		{
			...
			string sourceFile = "VicSecret_850_2_OrdersInternal.TestFiles.VicSecret_850_2_OrdersInternal_input.xml";
			string expectedFile = "VicSecret_850_2_OrdersInternal.TestFiles.VicSecret_850_2_OrdersInternal_output.xml";
			mapTester.Execute<VicSecret_850_2_OrdersInternal>(sourceFile, expectedFile);
		}

		static void InitialiseCodeMapsTestingContext()
		{
			CodeMapsTestingContext ctx = new CodeMapsTestingContext();
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_VS1" });
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "VS 850 - Import of OrderManager Orders", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
			...
			ctx.eHubCodeMapValues.Add(new eHubCodeMapValue { eHubCodeMapKey = ctx.eHubCodeMapKeys.Last(), eHubCodeSetResult = ctx.eHubCodeSetResults.Last(), CV_OutputCode = "VICTORIASECRET" });
