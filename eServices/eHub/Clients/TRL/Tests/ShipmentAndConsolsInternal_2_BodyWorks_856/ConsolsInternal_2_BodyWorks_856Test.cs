...
using CargoWise.eHub.Clients.TRL.Transforms.Consols_2_BodyWorks_856_E4;
using CargoWise.eHub.Clients.TRL.Transforms.Shipments_2_BodyWorks_856_E1;
...
{
	[TestClass]
	public class ConsolsInternal_2_BodyWorks_856Test
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestShipments_2_BodyWorks_856_E1()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Shipments_2_BodyWorks_856_E1_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Shipments_2_BodyWorks_856_E1_output.xml";
			mapTester.Execute<Shipments_2_BodyWorks_856_E1>(sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestConsols_2_BodyWorks_856_E4_Sea()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_Sea_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_Sea_output.xml";
			mapTester.Execute<Consols_2_BodyWorks_856_E4>(sourceFile, expectedFile);
		}

		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestConsols_2_BodyWorks_856_E4_Air()
		{
			InitialiseCodeMapsTestingContext();

			MapTester mapTester = new MapTester(Assembly.GetExecutingAssembly());

			string sourceFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_Air_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_Air_output.xml";
			mapTester.Execute<Consols_2_BodyWorks_856_E4>(sourceFile, expectedFile);
		}
		...
		public void TestConsolsInternal_2_TRLX12_4010_856_MultiCPO()
		{
			...
			string sourceFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_MultiCPO_input.xml";
			string expectedFile = "ShipmentAndConsolsInternal_2_BodyWorks_856.TestFiles.Consols_2_BodyWorks_856_E4_MultiCPO_output.xml";
			mapTester.Execute<Consols_2_BodyWorks_856_E4>(sourceFile, expectedFile);
		}
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_BW2" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "BW 856 - Export Shipment & Order data", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
