...
using CargoWise.eHub.Clients.TRL.Transforms.UniShip_2_Kontoor_GTNexus214;
...
{
	[TestClass]
	public class UniShip_2_Kontoor_GTNexus214Test
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestUniShip_2_Kontoor_GTNexus214()
		{
			...
			string sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.AF_Input.xml";
			string expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.AF_Output.xml";
            ctx.Write("GS03", "http://schemas.microsoft.com/BizTalk/2006/edi-properties", "VFCORP");

			mapTester.Execute<UniShip_2_Kontoor_GTNexus214>(sourceFile, expectedFile);

			sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.J1_Input.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.J1_Output.xml";
			mapTester.Execute<UniShip_2_Kontoor_GTNexus214>(sourceFile, expectedFile);
			...
			sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.X6_Input.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.X6_Output.xml";
            ctx.Write("GS03", "http://schemas.microsoft.com/BizTalk/2006/edi-properties", "VFCORP");
			...
			sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.B6_Input1.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.B6_Output1.xml";
			mapTester.Execute<UniShip_2_Kontoor_GTNexus214>(sourceFile, expectedFile);

			sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.B6_Input2.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.B6_Output2.xml";
			mapTester.Execute<UniShip_2_Kontoor_GTNexus214>(sourceFile, expectedFile);

			sourceFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.D1_Input.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus214.TestFiles.D1_Output.xml";
			mapTester.Execute<UniShip_2_Kontoor_GTNexus214>(sourceFile, expectedFile);
            Assert.AreEqual(ctx.Read("OverrideEDIHeader", "http://schemas.microsoft.com/BizTalk/2006/edi-properties"), "true");
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_K14" });
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_K14" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "KONTOOR 214 - Export Shipment Status", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
