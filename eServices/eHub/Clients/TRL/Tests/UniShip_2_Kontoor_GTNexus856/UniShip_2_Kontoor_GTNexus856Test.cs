...
using CargoWise.eHub.Clients.TRL.Transforms.UniShip_2_Kontoor_GTNexus856;
...
{
	[TestClass]
	public class UniShip_2_Kontoor_GTNexus856Test
	{
		[TestMethod, TestProperty("DAT:CapabilityRequirements", "BIZTALK2020")]
		public void TestUniShip_2_Kontoor_GTNexus856()
		{
    		...
    		string sourceFile = "UniShip_2_Kontoor_GTNexus856.TestFiles.Input.xml";
			string expectedFile = "UniShip_2_Kontoor_GTNexus856.TestFiles.Output.xml";
            ctx.Write("GS03", "http://schemas.microsoft.com/BizTalk/2006/edi-properties", "VFCORP");

			mapTester.Execute<UniShip_2_Kontoor_GTNexus856>(sourceFile, expectedFile);
			...
			sourceFile = "UniShip_2_Kontoor_GTNexus856.TestFiles.NoOrderRef_Input.xml";
			expectedFile = "UniShip_2_Kontoor_GTNexus856.TestFiles.NoOrderRef_Output.xml";
            ctx.Write("GS03", "http://schemas.microsoft.com/BizTalk/2006/edi-properties", "VFCORP");
			mapTester.Execute<UniShip_2_Kontoor_GTNexus856>(sourceFile, expectedFile);
		...
		static void InitialiseCodeMapsTestingContext()
		{
			...
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_K56" });
			ctx.eHubClients.Add(new eHubClient { CC_ID = "TRLVSRTRI_K56" });
			ctx.eHubTransformationSets.Add(new eHubTransformationSet { TS_Name = "KONTOOR 856 - Export Shipment & Order Data", eHubClient_Sender = ctx.eHubClients[0], eHubClient_Recipient = ctx.eHubClients[1] });
