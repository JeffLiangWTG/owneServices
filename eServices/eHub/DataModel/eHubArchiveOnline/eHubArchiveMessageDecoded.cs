...
{
	public class eHubArchiveMessageDecoded
	{
		[Key]
		...
		public string AM_SenderMessageRawDecoded { get; set; }
		[Column(TypeName = "xml")]
		public string AM_SenderMessageXml { get; set; }
		public string AM_SenderMessageXmlDecoded { get; set; }
		public string AM_RecipientMessageRaw { get; set; }
		public string AM_RecipientMessageRawDecoded { get; set; }
		[Column(TypeName = "xml")]
		public string AM_RecipientMessageXml { get; set; }
		public string AM_RecipientMessageXmlDecoded { get; set; }
