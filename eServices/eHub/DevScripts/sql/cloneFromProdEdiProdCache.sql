...
BEGIN
	...
	SET @sqlCommand = 'SET QUOTED_IDENTIFIER ON; INSERT INTO @TableName (@ColumnsInto) SELECT * FROM OPENQUERY([ehubtransactions.db.wisegrid.net], ''SELECT @ColumnsSelect FROM [ediProdCache].[dbo].[@TableName] WITH (NOLOCK)'')'
