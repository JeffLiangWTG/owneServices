...
namespace CargoWise.eHub.Selenium.IntegrationTests.Core
{
	...
	public abstract class GenericTestBase
	{
		...
		public void ClassInitialize()
		{
			try
			{
				TestDataController = new TestDataController(TestAssembly, TestDataLocation, TestDataSchemaLocation, GetType().Name, ConnectionStringPattern, TestClassLocationPattern);
		...
		protected virtual string TestDataLocation { get { return null; } }
