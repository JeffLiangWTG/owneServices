...
namespace CargoWise.eHub.Portal.IntegrationTests.Views
{
	[TestFixture]
	[WithPortalService]
	public class TWCustomsClientRegistrationTests : SeleniumTestBase
	{
		protected override string TestDataLocation { get { return ".Views.ClientRegistrationTests.TWCustoms.Data."; } }
		...
		[Test]
		public void Test_TWCustomsAccount()
		{
			...
			CompareHtmlDocuments(ReadEmbeddedHtml("Views.ClientRegistrationTests.TWCustoms.ExpectedPage.ClientRegistration_BeforeSelectPage.html"), SnapShotPage());

			selectOption.SelectByText("TWCustomsAccount - Taiwan Customs Account");
			WaitUntilFindElement(By.Id("registrationsTable"));
			WaitUntilFindElement(By.Id("00000000-1111-0000-0000-000000000000"));
			CompareHtmlDocuments(ReadEmbeddedHtml("Views.ClientRegistrationTests.TWCustoms.ExpectedPage.ClientRegistration_FinalPage.html"), SnapShotPage());
		}
	}
}
