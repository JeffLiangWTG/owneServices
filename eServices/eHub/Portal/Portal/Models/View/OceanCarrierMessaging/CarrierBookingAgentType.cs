...
{
	public class CarrierBookingAgentType : DefaultCarrierType
	{
		public CarrierBookingAgentType(Controller controller, eHubTransactionsContext context)
		...
		{
			get { return "2nd Phase"; }
		}

		public override string Name
		{
			get { return "Carrier Booking Agent"; }
		}

		public override string ID
		{
			get { return OceanCarrierMessagingController.TypeNames.CarrierBookingAgent; }
		}

		public override string MatchingGroupRuleName
		{
			get { return "CarrierBookingAgent"; }
		}
		...
		{
			if (column == Row.RowNames.carrierAgent) return "Booking Agent C1C";
