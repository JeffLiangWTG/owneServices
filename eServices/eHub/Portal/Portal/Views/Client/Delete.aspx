...
<asp:Content ID="BreadcrumbContent" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    <ol class="breadcrumb">
        ...
        <li><%: Html.ActionLink(Model.CC_FriendlyName, "Details", new {id=Model.CC_PK}, null)%></li>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        Please confirm you want to delete the Client with name: <i> <%:Model.CC_FriendlyName%> </i>
    </div>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <div id="actionBlock">
            ...
            <div class="rightActionButton"><%: Html.ActionLink("Cancel", "Details", new { id = Model.CC_PK })%></div>
            <div class="clear"></div>
        </div>
    <% } %>
