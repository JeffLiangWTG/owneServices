...
{
	public class CreatedJobWorkflows : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "WJC";
		...
		public override string FeatureName => "Created Job Workflows";
...
FROM (
	...
	FROM (
		SELECT SL_GB_NKBranch,
			SL_GS_NKUser
		FROM dbo.ProcessHeader
		INNER JOIN dbo.StmALog ON FH_PK = SL_Parent
		WHERE FH_FH_ParentHeader IS NULL
			AND SL_SE_NKEvent = 'JOP'
