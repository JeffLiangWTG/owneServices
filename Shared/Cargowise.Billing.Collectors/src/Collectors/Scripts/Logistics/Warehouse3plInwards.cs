namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plInwards : RefStlScriptWithDefaults
	{
	...
	(SELECT ww.WW_WarehouseName AS [Warehouse Name] FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)))";
		...
		public override string WhereClause => @"
					...
					AND wd.WD_WP_ParentPickForReceive IS NULL
					AND (wd2.WD_PK is null OR wd2.WD_DocketType not in ('WOR', 'DWO'))
					AND NOT(wd.WD_DocketSubType = 'RET' AND wd.WD_WD_ParentDocket IS NOT NULL)";
