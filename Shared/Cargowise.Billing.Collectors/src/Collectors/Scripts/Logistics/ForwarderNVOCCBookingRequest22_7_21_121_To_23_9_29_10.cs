namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class ForwarderNVOCCBookingRequest22_7_21_121_To_23_9_29_10 : RefStlScriptWithDefaults
	{
...
LEFT JOIN dbo.RefShippingLine rslCoLoadWith ON Creditor.OH_RSL_ShippingLine = rslCoLoadWith.RSL_PK";
	...
	(
		jk.JK_AgentType = 'CLD'
		AND Creditor.OH_IsSeaWholesaler = 1
		AND rslCoLoadWith.RSL_IsNVO = 1
		AND rslCoLoadWith.RSL_BookingRequestAvailable = 1
	)
	OR
	(
		jk.JK_AgentType != 'CLD'
		AND ShippingLine.OH_IsSeaWholesaler = 1
