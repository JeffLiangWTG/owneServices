namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class LandTransportCubicMetresMoved : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "LTC";
		...
		public override string FeatureName => "Local Transport Engine (Cubic Metres Moved)";
		...
		public override string FromClause => @"
					...
					CROSS APPLY dbo.ConvertVolume(jc.JC_GrossVolume, jc.JC_GrossVolumeUQ, 'M3') VolumeM3";
		public override string WhereClause => @"
					jc.JC_GrossVolume > 0
					AND VolumeM3.Value <= 2147483647";
		public override string TransactionCount => "VolumeM3.Value";
