namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class ForwarderShippingLineOutboundShippingInstruction22_7_21_121_To_23_9_29_10 : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "SSI";
		public override string RoleName => "Forwarding Consolidation";
		public override string ModuleName => "Forwarder";
		public override string FunctionName => "Shipping Line Shipping Instruction Sent";
		public override string FeatureName => "Shipping Line Shipping Instruction Sent";
...
AND rsl.RSL_IsNVO = 0
AND rsl.RSL_ShippingInstructionAvailable = 1";
