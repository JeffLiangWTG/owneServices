namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class CustomsPortMessagingOutboundDataRecord : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "PMF";
		...
		public override string FeatureName => "Port Messaging Data Record";
		...
		public override string BillingReference4 => "NULL";
...
(
	...
	WHERE
		...
		AND SL_Reference LIKE '%MST=File Creation Request (DOS)%'
...
(
	SELECT
		...
		SL_PostedTimeUtc,
		EM_PK,
		ForwardingId = IIF(LEN(ForwardingConsol) > 0, ForwardingConsol, ForwardingShipment),
...
(
	...
	(
		...
		WHERE
			...
			AND MSN.SL_Reference LIKE '%MST=File Creation Request (DOS)%'
