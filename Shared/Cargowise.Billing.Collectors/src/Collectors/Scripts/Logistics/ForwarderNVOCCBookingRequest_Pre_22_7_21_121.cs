namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class ForwarderNVOCCBookingRequest_Pre_22_7_21_121 : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "NBK";
		public override string RoleName => "Forwarding Consolidation";
		public override string ModuleName => "Forwarder";
		public override string FunctionName => "NVOCC Booking Request sent";
		public override string FeatureName => "NVOCC Booking Request sent";
...
JOIN BookingRequestSent bk ON jk.JK_PK = bk.JK_PK
