namespace CargoWise.Billing.Collectors.Logistics
{
	...
	sealed public class ShippingInstructionReceivedByNVOCC : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CSI";
		public override string RoleName => "Forwarding Shipment/Liner & Agency Bill Of Lading";
		public override string ModuleName => "Forwarder-Liner and Agency";
		public override string FunctionName => "Ocean Carrier Messaging - Shipping Instruction";
		public override string FeatureName => "CargoWise to CargoWise Shipping Instruction Received";
	...
	LEFT JOIN dbo.OrgHeader ON OrgAddress.OA_OH = OrgHeader.OH_PK)";
		...
		public override string BillingReference4 => "CONCAT(REPLACE(RES, 'Electronic ', ''), ' - ', EventReference)";
