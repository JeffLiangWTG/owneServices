namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class CargoReceiptAdviceSent : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CRS";
		...
		public override string FeatureName => "CargoWise to CargoWise Cargo Receipt Advice Sent";
	...
	LEFT JOIN dbo.OrgHeader ON OrgAddress.OA_OH = OrgHeader.OH_PK)";
		public override string BillingReference4 => "CONCAT('Cargo Receipt Advice', IIF(LEN(STA) > 0, ' - ', ''), STA)";
	...
	SELECT
		...
		(
			...
			WHERE
				...
				AND MSN.SL_Reference LIKE '%MST=Cargo Receipt Advice%'
			ORDER BY
