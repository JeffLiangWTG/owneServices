namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class BookingConfirmationSent : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "BCS";
		...
		public override string FunctionName => "Ocean Carrier Messaging - Booking Confirmation";
		public override string FeatureName => "CargoWise to CargoWise Booking Confirmation Sent";
