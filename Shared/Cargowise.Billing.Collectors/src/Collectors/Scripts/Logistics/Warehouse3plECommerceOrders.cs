namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plECommerceOrders : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "ECD";
		...
		public override string FeatureName => "Contract (Product) Warehouse (3PL eCommerce Orders)";
	...
	(SELECT ww.WW_WarehouseName AS [Warehouse Name] FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)))";
		...
		public override string WhereClause => @"
					...
					AND wd.WD_BookedWithCBADateTimeUtc IS NULL
