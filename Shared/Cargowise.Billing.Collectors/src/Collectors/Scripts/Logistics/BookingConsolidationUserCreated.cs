namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class BookingConsolidationUserCreated : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "BKU";
		...
		public override string FeatureName => "Inward eBooking / Inbound Shipment / Consignment or Job Registration (User)";
