namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class WarehouseTransitUnlabelledPacklinesReceived : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "WTL";
		...
		public override string FeatureName => "Unlabelled (Un-Tracked) Packlines Received";
