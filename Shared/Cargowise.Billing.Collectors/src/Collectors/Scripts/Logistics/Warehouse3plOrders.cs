namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plOrders : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "WOD";
		...
		public override string FeatureName => "Contract (Product) Warehouse (3PL Orders)";
