namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plAdjustments : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "WAD";
		...
		public override string FeatureName => "Contract (Product) Warehouse (3PL Adjustments)";
