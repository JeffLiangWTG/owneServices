namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class ForwarderShippingLineOutboundShippingOrder22_7_21_121_To_23_9_29_10 : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "SSO";
		public override string RoleName => "Forwarding Consolidation";
		public override string ModuleName => "Forwarder";
		public override string FunctionName => "Shipping Line Shipping Order Sent";
		public override string FeatureName => "Shipping Line Shipping Order Sent";
		...
		public override string BillingReference4 => "'Shipping Order'";
	...
	SELECT
		...
		(
			...
			WHERE
				...
				AND SL_IsEstimate = 'N'
				AND SL_Reference LIKE '%MST=Shipping Order%'
...
AND rsl.RSL_IsNVO = 0
AND rsl.RSL_ShippingOrderAvailable = 1";
