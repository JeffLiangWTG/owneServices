namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plBillOfMaterials : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "WBM";
		...
		public override string FeatureName => "Contract (Product) Warehouse (3PL Bill of Materials)";
