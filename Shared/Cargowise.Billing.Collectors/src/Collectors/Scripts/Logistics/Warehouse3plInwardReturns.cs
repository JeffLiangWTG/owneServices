namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plInwardReturns : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "WRT";
		...
		public override string FeatureName => "Contract (Product) Warehouse (3PL Inward Returns)";
	...
	(SELECT ww.WW_WarehouseName AS [Warehouse Name] FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)))";
		...
		public override string WhereClause => @"
					...
					AND wd.WD_DocketSubType = 'RET'
					AND wd.WD_WD_ParentDocket IS NOT NULL";
		public override string TransactionCount => "1";
		public override bool WithOptionRecompile => false;
		public override string DataGranularity => RefStlItemGrain.Transactional;
		public override string DateType => RefStlDateType.DateTime;
		public override string MinCW1Version => "25.3.22.11";
	}
