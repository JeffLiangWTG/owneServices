namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class AgencyBillOfLading : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "BOL";
		...
		public override string FeatureName => "Booking/Bill of Lading (Bill)";
		...
		public override string WhereClause => @"
					...
					AND js.JS_ShipmentStatus in ('WFI', 'CNF')";
