namespace CargoWise.Billing.Collectors.Logistics
{
	...
	sealed public class ContainerLoadPlanLineUsage : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "CPL";
		public override string ModuleName => "Order Manager";
		public override string RoleName => "Order Manager Usage";
		public override string FunctionName => "Container Load Plan Line Usage Collectors";
		public override string FeatureName => "Order Manager Container Load Plan Line Usage Collector";
		...
		public override string WhereClause => "log.SL_SE_NKEvent = 'ADD' AND containerLoadListLine.CLL_LoadMode = 'CFS'";
