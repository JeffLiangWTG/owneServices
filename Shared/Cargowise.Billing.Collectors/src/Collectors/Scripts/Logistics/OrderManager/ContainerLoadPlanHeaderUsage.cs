namespace CargoWise.Billing.Collectors.Logistics
{
	...
	sealed public class ContainerLoadPlanHeaderUsage : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "CPH";
		public override string ModuleName => "Order Manager";
		public override string RoleName => "Order Manager Usage";
		public override string FunctionName => "Container Load Plan Header Usage Collectors";
		public override string FeatureName => "Order Manager Container Load Plan Header Usage Collector";
		...
		public override string WhereClause => "log.SL_SE_NKEvent = 'ADD' AND containerLoadListHeader.CLH_LoadMode = 'CFS'";
