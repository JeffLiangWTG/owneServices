namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class Warehouse3plPickByBOMOrderLine : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "WBL";
		...
		public override string FeatureName => "Pick BOM on Sales Order";
	...
	(SELECT ww.WW_WarehouseName AS [Warehouse Name] FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)))";
		...
		public override string FromClause => @"
					...
					INNER JOIN dbo.WhsDocket receive ON receive.WD_WP_ParentPickForReceive = wp.WP_PK
		...
		public override string WhereClause => @"
					...
					AND we.WE_WE_ParentDocketLine IS NOT NULL";
