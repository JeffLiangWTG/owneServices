namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class HVLVItemUsageByOtherTransportMode : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "HTO";
		public override string RoleName => "Ecommerce Transport Modes";
		public override string ModuleName => "Ecommerce";
		public override string FunctionName => "Ecommerce Other";
		public override string FeatureName => "Ecommerce Other Transport Mode";
...
JOIN dbo.JobShipment ON JS_PK = HVI_JS_LoadedOnShipment";
		public override string WhereClause => "JobShipment.JS_TransportMode not in ('AIR', 'SEA', 'ROA')";
