namespace CargoWise.Billing.Collectors.Logistics
{
	...
	public class HVLVItemUsageByRoadFreight : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "HTR";
		public override string RoleName => "Ecommerce Transport Modes";
		public override string ModuleName => "Ecommerce";
		public override string FunctionName => "Ecommerce Road";
		public override string FeatureName => "Ecommerce Road Freight Transport Mode";
...
JOIN dbo.JobShipment ON JS_PK = HVI_JS_LoadedOnShipment";
		public override string WhereClause => "JobShipment.JS_TransportMode = 'ROA'";
