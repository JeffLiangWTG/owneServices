namespace CargoWise.Billing.Collectors.Core
{
	...
	public class CoreDeviceOnlyUserCountDaily : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "DO2";
		...
		public override string FeatureName => "Device-Only User Count Daily";
