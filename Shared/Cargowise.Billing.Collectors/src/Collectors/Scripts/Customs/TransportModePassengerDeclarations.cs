...
{
	public class TransportModePassengerDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T12";
		...
		public override string FeatureName => "Passenger Hand Carried Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'PHC'";
