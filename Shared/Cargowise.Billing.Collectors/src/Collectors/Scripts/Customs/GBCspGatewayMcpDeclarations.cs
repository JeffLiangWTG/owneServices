...
{
	public class GBCspGatewayMcpDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CS4";
		...
		public override string FeatureName => "MCP - Maritime Cargo Processing Count";
		...
		public override string WhereClause => @"gc.GC_RN_NKCountryCode = 'GB' AND csp.Value = 'MCP'";
