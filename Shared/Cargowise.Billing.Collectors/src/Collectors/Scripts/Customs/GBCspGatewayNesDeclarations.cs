...
{
	public class GBCspGatewayNesDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CS5";
		...
		public override string FeatureName => "NES - New Export System Count";
		...
		public override string WhereClause => @"gc.GC_RN_NKCountryCode = 'GB' AND csp.Value = 'NES'";
