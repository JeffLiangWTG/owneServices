...
{
	public class TransportModePedestrianDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T11";
		...
		public override string FeatureName => "Pedestrian Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'PED'";
