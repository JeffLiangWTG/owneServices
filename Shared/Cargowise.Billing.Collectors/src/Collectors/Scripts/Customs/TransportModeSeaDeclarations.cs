...
{
	public class TransportModeSeaDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T16";
		...
		public override string FeatureName => "Sea Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'SEA'";
