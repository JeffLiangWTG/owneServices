namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class OtherPartiesForwarderAirCargoReportExport : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "ACX";
		...
		public override string FeatureName => "Import/Export Air Cargo Report (Export Air)";
