...
{
	public class TransportModeOwnDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T10";
		...
		public override string FeatureName => "Own Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'OWN'";
