...
{
	public class TransportModeFixedDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T07";
		...
		public override string FeatureName => "Fixed Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'FIX'";
