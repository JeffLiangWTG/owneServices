namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class OtherPartiesForwarderSeaCargoExportZA : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "ZX5";
		...
		public override string FeatureName => "ZA Sea Outturn and Gate In/Out functions";
		...
		public override string BillingReference3 => "ama.AMA_ContainerMode";
