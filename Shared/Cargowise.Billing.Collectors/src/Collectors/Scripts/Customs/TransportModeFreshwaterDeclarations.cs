...
{
	public class TransportModeFreshwaterDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T01";
		...
		public override string FeatureName => "Freshwater Count";
		...
		public override string WhereClause => @"je.JE_TransportMode IN ('BWB','IWT','LAK','RIV')";
