...
{
	public class GBCspGatewayCdsDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CS2";
		...
		public override string FeatureName => "Direct to CDS via eHub Count";
		...
		public override string WhereClause => @"gc.GC_RN_NKCountryCode = 'GB' AND csp.Value = 'CDS'";
