...
{
	public class TransportModeRoRoDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T14";
		...
		public override string FeatureName => "RoRo Freight Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'ROR'";
