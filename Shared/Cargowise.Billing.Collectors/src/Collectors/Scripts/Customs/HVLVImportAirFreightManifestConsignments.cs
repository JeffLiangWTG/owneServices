namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class HVLVImportAirFreightManifestConsignments : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "HLA";
		public override string RoleName => "HVLV Import Air Freight Consignments";
		public override string ModuleName => "HVLV Import Air Freight Manifest Consignments";
		public override string FunctionName => "HVLV Portal and Air Customs Functions";
		public override string FeatureName => "HVLV Import Air Cargo Reporting";
