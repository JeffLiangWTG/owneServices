...
{
	public class TransportModeAirDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T04";
		...
		public override string FeatureName => "Air Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'AIR'";
