namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class OtherPartiesForwarderAirCargoEciExport : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "ECE";
		...
		public override string FeatureName => "Import/Export Air Cargo Report (Export ECI)";
