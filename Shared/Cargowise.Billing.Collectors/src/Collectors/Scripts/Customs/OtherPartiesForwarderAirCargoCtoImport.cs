namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class OtherPartiesForwarderAirCargoCtoImport : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "CTI";
		...
		public override string FeatureName => "Import/Export Air Cargo CFS/CTO Customs Functions (Import)";
