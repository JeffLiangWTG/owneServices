...
{
	public class TransportModeUnknownDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T15";
		...
		public override string FeatureName => "Unknown Count";
		...
		public override string WhereClause => @"je.JE_TransportMode NOT IN ('TRK','SEA','ROR','ROA','RIV','RAI','PST','PHC','PED','OWN','OTH','NOC','MAI','LAK','IWT','FIX','COU','BWB','AUT','AIR')";
