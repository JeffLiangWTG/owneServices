...
{
	public class TransportModeRoadDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T03";
		...
		public override string FeatureName => "Road/Truck Count";
		...
		public override string WhereClause => @"je.JE_TransportMode IN ('ROA','TRK')";
