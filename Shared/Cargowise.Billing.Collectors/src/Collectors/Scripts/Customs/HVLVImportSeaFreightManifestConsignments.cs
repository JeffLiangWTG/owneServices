namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class HVLVImportSeaFreightManifestConsignments : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "HLS";
		public override string RoleName => "HVLV Import Sea Freight Consignments";
		public override string ModuleName => "HVLV Import Sea Freight Manifest Consignments";
		public override string FunctionName => "HVLV Portal and Sea Customs Functions";
		public override string FeatureName => "HVLV Import Sea Cargo Reporting";
