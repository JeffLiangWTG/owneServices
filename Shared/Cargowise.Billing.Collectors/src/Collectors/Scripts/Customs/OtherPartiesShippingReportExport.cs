namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class OtherPartiesShippingReportExport : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "SRE";
		...
		public override string FeatureName => "Import/Export Shipping Customs Report (Export)";
		...
		public override string WhereClause => @"ed.ED_TransportMode = 'SEA'";
