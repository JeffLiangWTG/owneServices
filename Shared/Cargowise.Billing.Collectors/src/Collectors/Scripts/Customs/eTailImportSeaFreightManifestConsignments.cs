namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class eTailImportSeaFreightManifestConsignments : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "ETS";
		public override string RoleName => "eTail Import Sea Freight Consignments";
		public override string ModuleName => "eTail Import Sea Freight Manifest Consignments";
		public override string FunctionName => "eTail Portal and Customs Functions";
		public override string FeatureName => "eTail Import Sea Cargo Reporting";
