namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class CommunicationImportClearanceNonIntegrated : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "IFI";
		public override string RoleName => "Customs & Country Specific Integrations";
		public override string ModuleName => "Customs & Other Government Communication";
		public override string FunctionName => "Import Formal Clearance/Fiscal Report";
		public override string FeatureName => "Core Customs Processing (Import Clearance Non-Integrated)";
		...
		public override string WhereClause => @"
				( 
					...
					(
						...
						OR (gc.GC_RN_NKCountryCode = 'ZA' AND je.JE_MessageType NOT IN ('MSC', 'IMX', 'EXP'))
					)
