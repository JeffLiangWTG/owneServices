...
public class EUExitControlStandaloneDeclarationPreApplicationCode : RefStlScriptWithDefaults
{
...
";
	...
	public override string WhereClause => "CXH_ParentTableCode <> 'JE' AND JE_PK IS NULL";

	public override string MaxCW1Version => "25.5.22.224";
}
