...
{
	public class GBCspGatewayPentantDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CS6";
		...
		public override string FeatureName => "Pentant Count";
		...
		public override string WhereClause => @"gc.GC_RN_NKCountryCode = 'GB' AND csp.Value = 'PNT'";
