...
{
	public class TransportModeOtherDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T09";
		...
		public override string FeatureName => "Other Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'OTH'";
