...
{
	public class TransportModeNoCarrierDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T08";
		...
		public override string FeatureName => "No Carrier Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'NOC'";
