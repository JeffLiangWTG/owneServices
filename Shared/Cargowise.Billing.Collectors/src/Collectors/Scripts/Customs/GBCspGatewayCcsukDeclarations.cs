...
{
	public class GBCspGatewayCcsukDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "CS1";
		...
		public override string FeatureName => "CCS-UK - Cargo Community System Count";
		...
		public override string WhereClause => @"gc.GC_RN_NKCountryCode = 'GB' AND csp.Value = 'CCSUK'";
