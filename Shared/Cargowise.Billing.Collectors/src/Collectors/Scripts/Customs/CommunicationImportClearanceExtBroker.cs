namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class CommunicationImportClearanceExtBroker : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "IFB";
		...
		public override string FeatureName => "Import Clearance Full / Detailed Formal Entry / Fiscal Report (Ext. Broker)";
		...
		public override string WhereClause => @"
					je.JE_MessageType = 'IMX'
					AND gc.GC_RN_NKCountryCode in ('US', 'PR', 'ZA')";
