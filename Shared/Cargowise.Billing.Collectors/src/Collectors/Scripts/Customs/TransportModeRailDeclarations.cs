...
{
	public class TransportModeRailDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T13";
		...
		public override string FeatureName => "Rail Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'RAI'";
