...
{
	public class TransportModeAutoDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T05";
		...
		public override string FeatureName => "Auto Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'AUT'";
