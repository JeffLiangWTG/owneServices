namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class CommunicationImportFtzAdmission : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "FTZ";
		...
		public override string FeatureName => "FTZ Admission";
