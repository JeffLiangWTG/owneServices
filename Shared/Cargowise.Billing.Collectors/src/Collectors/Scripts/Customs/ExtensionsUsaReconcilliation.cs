namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class ExtensionsUsaReconcilliation : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "URC";
		public override string RoleName => "Customs & Country Specific Integrations";
		public override string ModuleName => "ediCustomsExtensions";
		public override string FunctionName => "US Customs";
		public override string FeatureName => "Reconcilliation";
