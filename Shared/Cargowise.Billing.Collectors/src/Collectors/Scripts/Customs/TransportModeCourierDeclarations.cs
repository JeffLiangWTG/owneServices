...
{
	public class TransportModeCourierDeclarations : RefStlScriptWithDefaults
	{
		public override string FeatureCode => "T06";
		...
		public override string FeatureName => "Courier Count";
		...
		public override string WhereClause => @"je.JE_TransportMode = 'COU'";
