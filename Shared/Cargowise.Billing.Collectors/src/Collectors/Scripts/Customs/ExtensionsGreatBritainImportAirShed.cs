namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class ExtensionsGreatBritainImportAirShed : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "ACS";
		public override string RoleName => "Customs & Country Specific Integrations";
		public override string ModuleName => "ediCustomsExtensions";
		public override string FunctionName => "GB Customs";
		public override string FeatureName => "Import Air Cargo Shed";
		...
		public override string WhereClause => @"
					...
					AND cs.CS_FolioReference like 'CUKAIR98%'
