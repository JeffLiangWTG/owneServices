namespace CargoWise.Billing.Collectors.Customs
{
	...
	public class CommunicationImportMiscellaneous : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => true;
		public override string FeatureCode => "MSC";
		...
		public override string FeatureName => "Miscellaneous Declarations";
		...
		public override string WhereClause => @"
					je.JE_MessageType = 'MSC'
					AND gc.GC_RN_NKCountryCode in ('US', 'PR', 'AU', 'NZ', 'GB', 'CA', 'ZA')";
