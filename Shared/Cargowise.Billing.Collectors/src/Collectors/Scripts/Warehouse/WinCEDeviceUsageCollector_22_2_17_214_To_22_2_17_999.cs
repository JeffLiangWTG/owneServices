namespace CargoWise.Billing.Collectors.Warehouse
{
	...
	public class WinCEDeviceUsageCollector_22_2_17_214_To_22_2_17_999 : RefStlScriptWithDefaults
	{
...
(
	...
	WHERE
		...
		public override string MinCW1Version => "22.2.17.214";
		public override string MaxCW1Version => "22.2.17.999";
