...
{
	public class RFDeviceModelCollector : RefStlScriptWithDefaults
	{
...
(
	...
	GROUP BY
		...
		public override string MinCW1Version => "24.10.31.119"; // Minimum CW1 version that contains s7_DeviceDetails column
