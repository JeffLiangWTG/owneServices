namespace CargoWise.Billing.Collectors.Rating
{
	...
	public class OneOffQuoteLinkedToShipment : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "OOS";
		public override string RoleName => "Rating";
		public override string ModuleName => "One Off Quote";
		public override string FunctionName => "Linked to Shipment Count";
		public override string FeatureName => "Linked to Shipment Count";
