namespace CargoWise.Billing.Collectors.eServices
{
	...
	public class EAdaptorSummaryScript : RefStlScriptWithDefaults
	{
		public override bool UsedInBilling => false;
		public override string FeatureCode => "EAS";
		public override string RoleName => "eServices";
		public override string ModuleName => "eAdaptor";
		public override string FunctionName => "eAdaptor summary";
		public override string FeatureName => "eAdaptor summary";
...
(
	...
	LEFT JOIN (
		dbo.EDICommunicationPartyConfig ec
		INNER JOIN dbo.EDICommunicationParty ep ON ep.ECP_PK = ec.ECC_ECP_Party
	) on ec.ECC_PK = EM_ECC_CommunicationPartyConfig

	WHERE EM_ReceiveTransmit In('RCV','TRX') AND EM_TransportType = 'EAD' AND EM_SystemCreateTimeUtc >= {Constants.StartDateTimeInclusiveParamName} AND EM_SystemCreateTimeUtc < {Constants.EndDateTimeExclusiveParamName}

	GROUP BY gc.GC_Code, EM_ReceiveTransmit, EM_ApplicationCode, EM_MessageType, EM_MessageSubType, EM_TransportType, ep.ECP_Name
) AggregatedMessage";
		...
		public override string BillingReference1 => "AggregatedMessage.EM_TransportType + '.' + AggregatedMessage.EM_ReceiveTransmit";
		public override string BillingReference2 => "AggregatedMessage.EDIClientName";
		public override string BillingReference3 => "AggregatedMessage.EM_ApplicationCode + '.' + AggregatedMessage.EM_MessageType + '.' + AggregatedMessage.EM_MessageSubType";
...
(
	...
	FOR JSON PATH, WITHOUT_ARRAY_WRAPPER
		...
		public override string MinCW1Version => "25.4.1.231";
	}
