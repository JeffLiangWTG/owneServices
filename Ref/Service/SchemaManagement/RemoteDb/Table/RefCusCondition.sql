...
CONSTRAINT [PK_RefCusCondition] PRIMARY KEY NONCLUSTERED( [ZX1_PK] ASC ),
...
GO
CREATE NONCLUSTERED INDEX IX_RefCusCondition_ZX1_ZZS_Preference ON RefCusCondition (ZX1_ZZS_Preference)
GO
...
GO
CREATE NONCLUSTERED INDEX IX_RefCusCondition_ZX1_ZZZ_NKDataGrouping ON RefCusCondition (ZX1_ZZZ_NKDataGrouping)
GO
