...
SELECT ZZW_PK ZZ1_PK
	...
	, CASE WHEN ZZW_StartDate > ZZ1_StartDate THEN ZZW_StartDate ELSE ZZ1_StartDate END AS ZZ1_StartDate
	, CASE WHEN ZZW_EndDate < ZZ1_EndDate THEN ZZW_EndDate ELSE ZZ1_EndDate END AS ZZ1_EndDate
	, CASE WHEN ZZW_PublishedDate > ZZ1_PublishedDate THEN ZZW_PublishedDate ELSE ZZ1_PublishedDate END AS ZZW_PublishedDate
