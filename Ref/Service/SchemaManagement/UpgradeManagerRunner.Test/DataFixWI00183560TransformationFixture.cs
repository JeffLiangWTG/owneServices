...
{
	class DataFixWI00183560TransformationFixture : TransformationFixture
	{
		protected override void AssertTransformationResults()
		{
			using (var cmd = Connection.CreateCommand())
			{
				...
				cmd.CommandText = @"Select Count(1) from RefCusRate t Where ZZ2_ZZ1_Tariff = 'C0CB362C-26C2-40CF-9B99-846503F705B8' and ZZ2_StartDate='2017-11-17 00:00:00'";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 0);
				cmd.CommandText = @"Select Count(1) from RefCusRate t Where ZZ2_ZZ1_Tariff = 'C0CB362C-26C2-40CF-9B99-846503F705B8' and ZZ2_StartDate='2015-01-01 00:00:00' and ZZ2_EndDate = '2079-06-06 23:59:00'";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 1);
				cmd.CommandText = @"Select count(1) from RefDbVersionControl where RVC_ParentPK = '85EBD672-A7E8-4578-A0B4-419A6731A75E'";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 1);
				cmd.CommandText = @"Select count(1) from RefCusRate where ZZ2_ZZ1_Tariff = '85EBD672-A7E8-4578-A0B4-419A6731A75E'";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 1);
				cmd.CommandText = @"Select count(1) from RefCusRate where ZZ2_ZZ1_Tariff = '67E46EEC-149E-4CBB-941F-1197F45CCB81'";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 1);
				cmd.CommandText = @"Select count(1) from RefCusRate where ZZ2_ZY1_RateCode is NULL";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 0);
				cmd.CommandText = @"Select count(1) From RefCusRate Where ZZ2_ZZ1_Tariff = '3759325B-B381-4894-B07D-8EA78294AE02' ";
				Assert.AreEqual(Convert.ToInt32(cmd.ExecuteScalar(), CultureInfo.InvariantCulture), 1);
			}
		}
		...
		{
			return new DataFixWI00183560Transformation(9);
		}
...
VALUES ('D987A1F5-AB3C-47AE-A6FA-4A6AABB8269A','C0CB362C-26C2-40CF-9B99-846503F705B8','2017-11-17 00:00:00','2079-06-06 23:59:00','0','','ZA');

INSERT INTO RefCusRate (ZZ2_PK,ZZ2_ZZ1_Tariff,ZZ2_StartDate,ZZ2_EndDate,ZZ2_RateFormula,ZZ2_SelectorFormula,ZZ2_ZZZ_NKDataGrouping)
VALUES ('F06D342F-01F6-4CB3-B85E-AFAF4A33E706','C0CB362C-26C2-40CF-9B99-846503F705B8','2015-01-01 00:00:00','2017-11-16 23:59:00','0','','ZA');

INSERT INTO RefCusRate (ZZ2_PK,ZZ2_ZZ1_Tariff,ZZ2_StartDate,ZZ2_EndDate,ZZ2_RateFormula,ZZ2_SelectorFormula,ZZ2_ZZZ_NKDataGrouping)
VALUES ('87D324DC-3499-4474-A4C2-2C26F530BBB6','C0CB362C-26C2-40CF-9B99-846503F705B8','2017-11-17 00:00:00','2079-06-06 23:59:00','0','','ZA');
...
INSERT INTO [dbo].[RefCusTariff] ([ZZ1_PK],[ZZ1_ZZI_TariffType],[ZZ1_TariffCode],[ZZ1_IAMUnique],[ZZ1_Description],[ZZ1_StartDate],[ZZ1_EndDate],[ZZ1_ZZF_NKTaxOrFeeCode],[ZZ1_ZZZ_NKDataGrouping],[ZZ1_CompositeKeyOnZZ5])
VALUES ('85EBD672-A7E8-4578-A0B4-419A6731A75E','4E70545B-4FE7-4EBC-91E4-A78108140A73','20041099',0,'Description','2016-05-27 00:00:00','2079-06-06 23:59:00','VAT','ZA','');
...
INSERT INTO [dbo].[RefCusTariff] ([ZZ1_PK],[ZZ1_ZZI_TariffType],[ZZ1_TariffCode],[ZZ1_IAMUnique],[ZZ1_Description],[ZZ1_StartDate],[ZZ1_EndDate],[ZZ1_ZZF_NKTaxOrFeeCode],[ZZ1_ZZZ_NKDataGrouping],[ZZ1_CompositeKeyOnZZ5])
VALUES ('67E46EEC-149E-4CBB-941F-1197F45CCB81','4E70545B-4FE7-4EBC-91E4-A78108140A73','85286990',0,'Description','2015-04-01 00:00:00','2079-06-06 23:59:00','VAT','ZA','');
...
INSERT INTO [dbo].[RefCusTariff] ([ZZ1_PK],[ZZ1_ZZI_TariffType],[ZZ1_TariffCode],[ZZ1_IAMUnique],[ZZ1_Description],[ZZ1_StartDate],[ZZ1_EndDate],[ZZ1_ZZF_NKTaxOrFeeCode],[ZZ1_ZZZ_NKDataGrouping],[ZZ1_CompositeKeyOnZZ5])
VALUES ('3759325B-B381-4894-B07D-8EA78294AE02','4E70545B-4FE7-4EBC-91E4-A78108140A73','311120304',0,'Description','1997-08-01 00:00:00','2017-12-28 23:59:00','VAT','ZA','');

INSERT INTO RefCusTariffRelationship (ZZH_PK,ZZH_ZZ1_Tariff,ZZH_ZZI_TariffType,ZZH_TariffCode)
VALUES (newid(),'3759325B-B381-4894-B07D-8EA78294AE02','4E70545B-4FE7-4EBC-91E4-A78108140A73','5407')

INSERT INTO RefCusRate (ZZ2_PK,ZZ2_ZZ1_Tariff,ZZ2_StartDate,ZZ2_EndDate,ZZ2_RateFormula,ZZ2_SelectorFormula,ZZ2_ZZZ_NKDataGrouping)
VALUES ('5D018D61-462D-4B84-851F-B76EE17AD23F','3759325B-B381-4894-B07D-8EA78294AE02','1997-08-01 00:00:00','2017-12-28 23:59:00','0','','ZA');

INSERT INTO RefCusApplicability (ZZT_PK,ZZT_ZZ2_Rate,ZZT_StartDate,ZZT_EndDate,ZZT_AdditionalCode,ZZT_OrderNumber)
VALUES (newid(),'5D018D61-462D-4B84-851F-B76EE17AD23F','1997-08-01 00:00:00','2017-12-28 23:59:00','Additional','OrderNO')

INSERT INTO RefCusRate (ZZ2_PK,ZZ2_ZZ1_Tariff,ZZ2_StartDate,ZZ2_EndDate,ZZ2_RateFormula,ZZ2_SelectorFormula,ZZ2_ZZZ_NKDataGrouping)
VALUES ('5EEE2603-FA12-415E-8AFF-CF91367D5406','3759325B-B381-4894-B07D-8EA78294AE02','1997-08-01 00:00:00','2017-12-28 23:59:00','0','','ZA');
