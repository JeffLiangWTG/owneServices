...
{
	[TestFixture]
	class RemoveDuplicateRefCusExcludedTradeGroupTransformationFixture : TransformationFixture
	{
		protected override void AssertTransformationResults()
		{
			var sql = @"SELECT COUNT(*) FROM RefCusExcludedTradeGroup WHERE ZZC_ZZT_Applicability = 'F8773DAD-1C92-410C-B086-E9DB9745FFD5'";
			Assert.AreEqual(1, DbHelper.ExecuteScalar(Transaction, sql));

			Assert.DoesNotThrow(() => DbHelper.ExecuteNonQuery(Transaction, @"ALTER INDEX IX_RefCusExcludedTradeGroup_ZZC_ZZT_Applicability_ZZC_ZZA_TradeGroup ON RefCusExcludedTradeGroup REBUILD;"));
		}

		protected override IDataTransformationTask GetTask()
		{
			return new RemoveDuplicateRefCusExcludedTradeGroupTransformation(0);
		}

		protected override void PrepareTestData()
		{
			var sql = @"ALTER INDEX IX_RefCusExcludedTradeGroup_ZZC_ZZT_Applicability_ZZC_ZZA_TradeGroup ON RefCusExcludedTradeGroup DISABLE
...
('5888261D-51B4-47CE-8743-6D8DFC587123', 'F8773DAD-1C92-410C-B086-E9DB9745FFD5', '59586763-668B-4127-9E34-56560C40FDE5', '7A230849-CF80-43D7-9123-E8F1B42A5F31', 'ZZ1')
";
