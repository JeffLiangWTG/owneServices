...
{
	class AddRulesWI00196189TransformationFixture : TransformationFixture
	{
		protected override void AssertTransformationResults()
		{
			using (var cmd = Connection.CreateCommand())
			{
				...
				cmd.CommandText = @"SELECT COUNT(1) FROM RefCusTariffRule t JOIN RefCusTariffUOMRule uom on uom.ZZ8_ZZ1_Tariff = t.ZZ1_PK and uom.ZZ8_Type = 'RU1' and uom.ZZ8_UOM = 'SM' and uom.ZZ8_ZZZ_NKDataGrouping = 'ZA' WHERE t.ZZ1_TariffCode = '48102905'";
		...
		{
			return new AddRulesWI00196189Transformation(16);
		}
