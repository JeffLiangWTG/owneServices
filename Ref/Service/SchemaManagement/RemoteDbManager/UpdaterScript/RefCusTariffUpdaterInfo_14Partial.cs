...
{
	public partial class RefCusTariffUpdaterInfo_14 : IUpdaterScriptInfo
	{
		public DataTableMapping Mapping => new DataTableMapping
		{
			...
			RelatedTableNames = new Dictionary<string, DataTableMapping>()
			{
				...
				{
					"RefCusTariffUOMs", RefCusTariffUOMMapping.Mapping2
				},
				{
					"RefCusTariffRelationships", RefCusTariffRelationshipMapping.Mapping1
				},
				{
				...
				{
					"RefCusTariffNationalCodes", RefCusTariffNationalCodeMapping.Mapping3
				},
				{
