...
{
	[TestFixture]
	class RefCusRateTypeUpdaterInfoFixture
	{
...
('56B11480-8664-4304-A665-EB74ACFAD13D', 'REA', 'REA - AY Tax Rebate', 0, 'ZA', '')
...
", trans);
					var info = new RefCusRateTypeUpdaterInfo_1();
					...
					TestDBHelper.ExecuteNonQuery(conn, $@"
INSERT INTO #TempRefCusRateType (ZZR_PK,ZZR_RateType,ZZR_Description,ZZR_IsPayable,ZZR_ZZZ_NKDataGrouping,ZZR_CustomsValueFormula, Deleted)
VALUES (NEWID(), 'DTY', 'Duty', 1, 'ZA', '', 1),
('AF911C38-C847-49C6-B276-3F8A543A4A51', 'REA', 'BBBB', 0, 'ZA', '', 0),
('EC024218-B784-4B21-95FF-112B0A3FC43A', 'CCC', 'CCCC', 0, 'ZA', '', 0)
