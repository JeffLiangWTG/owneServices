...
(NEWID(),'D','D','D','DDD','JTT','23D8BD6F-2421-47A9-BF7C-BB455012EF7A')", trans);
					var info = new UNDGSubstanceJTTUpdaterInfo_1();
...
(NEWID(),'C','C','C','CCC','JTT','0B358C81-9724-443C-B4DF-2C04EF7F9988')", trans);
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM UNDGSubstanceJTT WHERE JTT_UNNO = 'AAA' AND JTT_PSN = 'Test1111'", trans));
