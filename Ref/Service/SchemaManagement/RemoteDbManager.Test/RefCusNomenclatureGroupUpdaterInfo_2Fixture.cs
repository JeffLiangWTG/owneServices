...
{
	[TestFixture]
	class RefCusNomenclatureGroupUpdaterInfo_2Fixture
	{
		[TestCaseSource(typeof(TransactionedTestCaseAttribute), nameof(TransactionedTestCaseAttribute.RemoteDbTestCases))]
		[TransactionedTestCase]
		public void RefCusNomenclatureGroupUpdaterInfo_2(DbSchema dbSchema)
		{
...
", trans);
					var info = new RefCusNomenclatureGroupUpdaterInfo_2();
