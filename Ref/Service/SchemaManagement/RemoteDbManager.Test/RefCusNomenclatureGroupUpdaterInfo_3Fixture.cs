...
{
	[TestFixture]
	class RefCusNomenclatureGroupUpdaterInfo_3Fixture
	{
		[TransactionedTestCase]
		[TestCaseSource(typeof(TransactionedTestCaseAttribute), nameof(TransactionedTestCaseAttribute.RemoteDbTestCases))]
		public void RefCusNomenclatureGroupUpdaterInfo_3(DbSchema dbSchema)
		{
...
", trans);
					var info = new RefCusNomenclatureGroupUpdaterInfo_3();
