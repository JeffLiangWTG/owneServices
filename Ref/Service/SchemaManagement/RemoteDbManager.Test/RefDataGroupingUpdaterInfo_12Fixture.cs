...
VALUES (NEWID(), 'C0A94205-BCA9-4E0F-A216-E6A3F0380D21', '9', '2025-02-01 00:00:00', 'Z')
...
", trans);
					var info = new RefDataGroupingUpdaterInfo_12();
...
", trans);
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefVesselArrival WHERE ZYA_VoyageNumber = '9'", trans));
