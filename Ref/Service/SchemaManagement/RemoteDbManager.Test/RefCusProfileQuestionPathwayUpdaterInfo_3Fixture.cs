...
namespace CargoWise.RefDbRepo.RemoteDbManager.Test
{
	...
	class RefCusProfileQuestionPathwayUpdaterInfo_3Fixture
	{
		[Test]
		public void Mapping()
		{
			var mapping = new RefCusProfileQuestionPathwayUpdaterInfo_3().Mapping;
		...
		public void RefCusProfileQuestionPathwayUpdaterInfo_3(DbSchema dbSchema)
		{
...
INSERT INTO RefCusProfileQuestionPathway(XQP_PK,XQP_XQ2_QuestionParent,XQP_XQ2_QuestionChild,XQP_Description,XQP_StartDate,XQP_EndDate,XQP_AllowMultipleAnswers,XQP_IsAnswerMandatory)
VALUES (NEWID(),'C673520E-9D5E-4388-AF33-03166005DC19','39ACB8BB-A802-4784-93B0-74DA96C675E0','desc 1','2024-01-01 00:00:00.000','2079-06-06 23:59:00.000',1,1),
(NEWID(),'39ACB8BB-A802-4784-93B0-74DA96C675E0','62CE5344-9EB4-450F-AF2F-5747DBD3E309','desc 2','2024-01-01 00:00:00.000','2079-06-06 23:59:00.000',0,0);
", trans);

					var info = new RefCusProfileQuestionPathwayUpdaterInfo_3();
					foreach (var script in info.PrepareTemporaryTablesScripts)
					{
						TestDBHelper.ExecuteNonQuery(conn, script.Value, trans);
					}
					TestDBHelper.ExecuteNonQuery(conn, $@"
INSERT INTO #TempRefCusProfileQuestionPathway(XQP_PK,XQP_XQ2_QuestionParent,XQP_XQ2_QuestionChild,XQP_Description,XQP_StartDate,XQP_EndDate,XQP_ConditionToProceedFormula,XQP_AllowMultipleAnswers,XQP_IsAnswerMandatory,Deleted)
VALUES (NEWID(),'62CE5344-9EB4-450F-AF2F-5747DBD3E309','C673520E-9D5E-4388-AF33-03166005DC19','Inserted','2023-01-01 00:00:00.000','2079-06-06 23:59:00.000','',1,1,0),
(NEWID(),'C673520E-9D5E-4388-AF33-03166005DC19','39ACB8BB-A802-4784-93B0-74DA96C675E0','Updated','2024-01-01 00:00:00.000','2079-06-06 23:59:00.000','',1,0,0),
(NEWID(),'39ACB8BB-A802-4784-93B0-74DA96C675E0','62CE5344-9EB4-450F-AF2F-5747DBD3E309','desc 2','2024-01-01 00:00:00.000','2079-06-06 23:59:00.000','',1,0,1);
", trans);
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway WHERE XQP_AllowMultipleAnswers = 1 AND XQP_IsAnswerMandatory = 1", trans));
				}
			}
		}
	}
