...
VALUES (NEWID(), 'FDCA07B0-8E98-4A44-A609-D441FCF0E585', 'CU2', 'A1', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', NULL, 'EUN', '4F367102-358F-41D6-84F4-A8C33BF9EFEC','2019-12-14 00:00:00', '2079-06-06 23:59:00'),
(NEWID(), NULL, 'CU2', 'A2', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '8F6E0739-434F-4D9A-95B6-E93EA040ABC8', 'EUN', '4F367102-358F-41D6-84F4-A8C33BF9EFEC','2019-12-14 00:00:00', '2079-06-06 23:59:00')
...
('7558A41B-F5AE-46A0-AB6E-510117207DF1', NULL, '8F6E0739-434F-4D9A-95B6-E93EA040ABC8', 'AAA', 'A2', 'A', 'AAA', 'A',1, 'EUN')
...
VALUES('35ADE662-1BC5-4303-8856-D72AE06A24E0', 'BBB', 'code description', 'EUN')
...
INSERT INTO RefCusCondition (ZX1_PK, ZX1_ZX2_ConditionType, ZX1_ZZ1_Tariff, ZX1_StartDate, ZX1_EndDate, ZX1_ZZZ_NKDataGrouping, ZX1_Source, ZX1_Comment, ZX1_IsImport, ZX1_IsExport, ZX1_ConditionValueTrueMeansStop, ZX1_LogicalANDWithinGroup, ZX1_ZY7_NKConditionCode, ZX1_AdditionalComment, ZX1_Severity)
VALUES ('C2CD44CA-A4D1-45B2-A3F6-5769FB817A45', 'A5B026EA-ECF3-4844-9856-A0C11A0CBCE1', 'FDCA07B0-8E98-4A44-A609-D441FCF0E585', '2019-12-14 00:00:00', '2079-06-06 23:59:00', 'EUN', 'A', '', 1, 0, 1, 1, 'BBB', 'comment', 'MSG')
...
VALUES(NEWID(), 'DE', 'A', 'A','C2CD44CA-A4D1-45B2-A3F6-5769FB817A45', 'comment 1')

INSERT INTO RefCusTariffRelationship (ZZH_PK,ZZH_ZZ1_Tariff,ZZH_ZZI_TariffType,ZZH_TariffCode)
VALUES ('6B443D4E-8729-4838-B0B0-6A094F93EAA5', 'FDCA07B0-8E98-4A44-A609-D441FCF0E585', '7EABDFE4-F6F0-4F33-BC3A-D20863ED5075', 'Test')

INSERT INTO RefCusApplicability (ZZT_PK,ZZT_ZX1_Conditions,ZZT_ZZ2_Rate,ZZT_ZY2_AdditionalCode,ZZT_ZZH_TariffRelationship,ZZT_StartDate,ZZT_EndDate,ZZT_ZZA_TradeGroup,ZZT_AdditionalCode,ZZT_OrderNumber,ZZT_ZZA_SecondTradeGroup)
VALUES ('236353D1-77F3-4F1A-A262-68548903FBC1','C2CD44CA-A4D1-45B2-A3F6-5769FB817A45', NULL, NULL,NULL,'1901-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL),
('236353D1-77F3-4F1A-A262-68548903FBC2',NULL, 'D83003BA-A3B6-437B-8312-9079C190BB3C',NULL,NULL,'1902-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL),
('236353D1-77F3-4F1A-A262-68548903FBC3',NULL, NULL,'7558A41B-F5AE-46A0-AB6E-510117207DFF',NULL,'1903-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL),
('236353D1-77F3-4F1A-A262-68548903FBC4',NULL, 'D83003BA-A3B6-437B-8312-9079C190BB3D', NULL,NULL,'1904-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL),
('236353D1-77F3-4F1A-A262-68548903FBC5',NULL, NULL,'7558A41B-F5AE-46A0-AB6E-510117207DF1',NULL,'1905-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL),
('236353D1-77F3-4F1A-A262-68548903FBC6',NULL, NULL,NULL,'6B443D4E-8729-4838-B0B0-6A094F93EAA5','1906-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','',NULL)
...
(NEWID(), '236353D1-77F3-4F1A-A262-68548903FBC6','879DD842-4D80-46AB-9EFA-73DC72C5D5A8')
", trans);
					var info = new RefCusTariffUpdaterInfo_14();
...
INSERT INTO #TempRefCusTariffUOM (ZZ8_PK,ZZ8_ZZ1_Tariff,ZZ8_Type,ZZ8_UOM,ZZ8_ZZA_TradeGroup,ZZ8_ZZW_TariffNationalCode,ZZ8_ZZZ_NKDataGrouping,ZZ8_ZZA_SecondTradeGroup,ZZ8_StartDate,ZZ8_EndDate)
VALUES (NEWID(), 'FDCA07B0-8E98-4A44-A609-0441FCF0E585', 'CU3', 'C1', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', NULL, 'EUN', '4F367102-358F-41D6-84F4-A8C33BF9EFEC','2019-12-14 00:00:00', '2079-06-06 23:59:00'),
(NEWID(), NULL, 'CU3', 'C2', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '8F6E0739-434F-4D9A-95B6-093EA040ABC8', 'EUN', '4F367102-358F-41D6-84F4-A8C33BF9EFEC','2019-12-14 00:00:00', '2079-06-06 23:59:00')

INSERT INTO #TempRefCusTariffAdditionalCode (ZY2_PK,ZY2_ZZ1_Tariff,ZY2_ZZW_NationalCode,ZY2_AdditionalCode,ZY2_Description,ZY2_ZY3_NKCategory,ZY2_ParentAdditionalCode,ZY2_ZY3_NKParentCategory,ZY2_IsMandatory,ZY2_ZZZ_NKDataGrouping)
...
INSERT INTO #TempRefCusVATApplicability (ZX5_PK,ZX5_ZZ1_Tariff,ZX5_ZZW_TariffNationalCode,ZX5_ZZF_NKTaxOrFeeCode,ZX5_StartDate,ZX5_EndDate,ZX5_AdditionalCode,ZX5_Description,ZX5_ZZZ_NKDataGrouping,ZX5_ZZA_TradeGroup,ZX5_VATCategory,ZX5_DataSetId)
VALUES ('7558A41B-F5AE-46A0-AB6E-010117207DFF', 'FDCA07B0-8E98-4A44-A609-0441FCF0E585', NULL, '', '1900-01-01','2079-06-06', 'C', 'C1', 'EUN', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '',23),
('7558A41B-F5AE-46A0-AB6E-010117207DF1', NULL, '8F6E0739-434F-4D9A-95B6-093EA040ABC8', '', '1900-01-01','2079-06-06', 'C', 'C2', 'EUN', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '',201)
...
INSERT INTO #TempRefCusCondition (ZX1_PK, ZX1_ZX2_ConditionType, ZX1_ZZ1_Tariff, ZX1_StartDate, ZX1_EndDate, ZX1_ZZZ_NKDataGrouping, ZX1_Source, ZX1_Comment, ZX1_IsImport, ZX1_IsExport, ZX1_ConditionValueTrueMeansStop, ZX1_LogicalANDWithinGroup, ZX1_ZY7_NKConditionCode, ZX1_AdditionalComment, ZX1_Severity)
VALUES ('C2CD44CA-A4D1-45B2-A3F6-0769FB817A45', 'A5B026EA-ECF3-4844-9856-A0C11A0CBCE1', 'FDCA07B0-8E98-4A44-A609-0441FCF0E585', '2019-12-14 00:00:00', '2079-06-06 23:59:00', 'EUN', 'C', '', 1, 0, 1, 1, 'BBB', 'comment', 'MSG')
...
VALUES(NEWID(), 'DE', 'C', 'C','C2CD44CA-A4D1-45B2-A3F6-0769FB817A45', 'D')

INSERT INTO #TempRefCusTariffRelationship (ZZH_PK, ZZH_ZZ1_Tariff, ZZH_ZZI_TariffType, ZZH_TariffCode)
VALUES ('6B443D4E-8729-4838-B0B0-6A094F93EAA5', 'FDCA07B0-8E98-4A44-A609-0441FCF0E585', '7EABDFE4-F6F0-4F33-BC3A-D20863ED5071', 'CCCC')

INSERT INTO #TempRefCusApplicability (ZZT_PK,ZZT_ZX1_Conditions,ZZT_ZZ2_Rate,ZZT_ZY2_AdditionalCode,ZZT_ZZH_TariffRelationship,ZZT_StartDate,ZZT_EndDate,ZZT_ZZA_TradeGroup,ZZT_AdditionalCode,ZZT_OrderNumber,ZZT_ZZA_SecondTradeGroup)
VALUES ('236353D1-77F3-4F1A-A262-08548903FBC1','C2CD44CA-A4D1-45B2-A3F6-0769FB817A45', NULL, NULL,NULL,'1911-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC'),
('236353D1-77F3-4F1A-A262-08548903FBC2',NULL, 'D83003BA-A3B6-437B-8312-0079C190BB3C',NULL,NULL,'1912-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC'),
('236353D1-77F3-4F1A-A262-08548903FBC3',NULL, NULL,'7558A41B-F5AE-46A0-AB6E-010117207DFF',NULL,'1913-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC'),
('236353D1-77F3-4F1A-A262-08548903FBC4',NULL, 'D83003BA-A3B6-437B-8312-0079C190BB3D', NULL,NULL,'1914-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC'),
('236353D1-77F3-4F1A-A262-08548903FBC5',NULL, NULL,'7558A41B-F5AE-46A0-AB6E-010117207DF1',NULL,'1915-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC'),
('236353D1-77F3-4F1A-A262-08548903FBC6',NULL, NULL,NULL,'6B443D4E-8729-4838-B0B0-6A094F93EAA5','1916-01-01','2079-06-06','879DD842-4D80-46AB-9EFA-73DC72C5D5A8','','','4F367102-358F-41D6-84F4-A8C33BF9EFEC')
...
(NEWID(), '236353D1-77F3-4F1A-A262-08548903FBC6','879DD842-4D80-46AB-9EFA-73DC72C5D5A8')
", trans);
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1906-01-01'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusExcludedTradeGroup JOIN RefCusApplicability ON ZZC_ZZT_Applicability = ZZT_PK WHERE ZZT_StartDate = '1906-01-01'", trans));
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusTariffRelationship WHERE ZZH_TariffCode = 'Test'", trans));
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusVATApplicability WHERE ZX5_Description = 'C1' AND ZX5_DataSetId = 23", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusVATApplicability WHERE ZX5_Description = 'C2' AND ZX5_DataSetId = 201", trans));
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1911-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1912-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1913-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1914-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1915-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusApplicability WHERE ZZT_StartDate = '1916-01-01' AND ZZT_ZZA_SecondTradeGroup = '4F367102-358F-41D6-84F4-A8C33BF9EFEC'", trans));
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusExcludedTradeGroup JOIN RefCusApplicability ON ZZC_ZZT_Applicability = ZZT_PK WHERE ZZT_StartDate = '1916-01-01'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(*) FROM RefCusTariffRelationship WHERE ZZH_TariffCode = 'CCCC'", trans));
				}
			}
		}
	}
