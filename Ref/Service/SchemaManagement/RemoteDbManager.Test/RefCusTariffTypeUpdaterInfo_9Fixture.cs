...
VALUES ('6B443D4E-8729-4838-B0B0-6A094F93EAA5', 'FDCA07B0-8E98-4A44-A609-D441FCF0E585', '7EABDFE4-F6F0-4F33-BC3A-D20863ED5075', '1111111')
...
INSERT INTO RefCusApplicability (ZZT_PK,ZZT_ZX1_Conditions,ZZT_ZZ2_Rate,ZZT_ZY2_AdditionalCode,ZZT_ZZH_TariffRelationship,ZZT_StartDate,ZZT_EndDate,ZZT_ZZA_TradeGroup,ZZT_AdditionalCode,ZZT_OrderNumber)
VALUES ('236353D1-77F3-4F1A-A262-68548903FBC1', 'C2CD44CA-A4D1-45B2-A3F6-5769FB817A45', NULL, NULL, NULL, '1901-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', ''),
('236353D1-77F3-4F1A-A262-68548903FBC2', NULL, 'D83003BA-A3B6-437B-8312-9079C190BB3C', NULL, NULL, '1902-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', ''),
('236353D1-77F3-4F1A-A262-68548903FBC3', NULL, NULL, '7558A41B-F5AE-46A0-AB6E-510117207DFF', NULL, '1903-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', ''),
('236353D1-77F3-4F1A-A262-68548903FBC4', NULL, 'D83003BA-A3B6-437B-8312-9079C190BB3D', NULL, NULL, '1904-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', ''),
('236353D1-77F3-4F1A-A262-68548903FBC5', NULL, NULL, '7558A41B-F5AE-46A0-AB6E-510117207DF1', NULL, '1905-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', ''),
('236353D1-77F3-4F1A-A262-68548903FBC6', NULL, NULL, NULL, '6B443D4E-8729-4838-B0B0-6A094F93EAA5', '1906-01-01', '2079-06-06', '879DD842-4D80-46AB-9EFA-73DC72C5D5A8', '', '')
...
INSERT INTO RefCusProfileQuestion (XQ2_PK,XQ2_XXX_ProfileType,XQ2_QuestionCode,XQ2_AnswerDataType,XQ2_Name,XQ2_Text,XQ2_StartDate,XQ2_EndDate,XQ2_ZZZ_NKDataGrouping)
...
", trans);
					var info = new RefCusTariffTypeUpdaterInfo_9();
...
('5FC8D11D-34A3-4DC7-8A8D-1741F8E6D11A', 'BBB','EUN','{new string('B', 60)}','', 0),
('C98F13BC-F968-41A6-B7ED-98046B17ED4E', 'CCC','EUN','{new string('C', 100)}','', 0),
(NEWID(), 'DDD','EUN','DDD','', 0)
...
", trans);
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(1) FROM RefCusApplicability WHERE ZZT_StartDate = '1906-01-01'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(1) FROM RefCusExcludedTradeGroup JOIN RefCusApplicability ON ZZC_ZZT_Applicability = ZZT_PK WHERE ZZT_StartDate = '1906-01-01'", trans));
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(1) FROM RefCusTariffType WHERE ZZI_TariffType = 'BBB' AND ZZI_ZZZ_NKDataGrouping = 'EUN'", trans));
					Assert.AreEqual(60, TestDBHelper.ExecuteScalar(conn, @"SELECT LEN(ZZI_Description) FROM RefCusTariffType WHERE ZZI_TariffType = 'BBB' AND ZZI_ZZZ_NKDataGrouping = 'EUN'", trans));
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(1) FROM RefCusTariffType WHERE ZZI_TariffType = 'CCC' AND ZZI_ZZZ_NKDataGrouping = 'EUN'", trans));
					Assert.AreEqual(100, TestDBHelper.ExecuteScalar(conn, @"SELECT LEN(ZZI_Description) FROM RefCusTariffType WHERE ZZI_TariffType = 'CCC' AND ZZI_ZZZ_NKDataGrouping = 'EUN'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, @"SELECT COUNT(1) FROM RefCusProfileQuestion WHERE XQ2_QuestionCode = 'Code1'", trans));
