...
{
	[TestFixture]
	class RefCusProfileQuestionPathwayUpdaterInfo_2Fixture
	{
		[Test]
		public void Mapping()
		{
			var mapping = new RefCusProfileQuestionPathwayUpdaterInfo_2().Mapping;
		...
		public void RefCusProfileQuestionPathwayUpdaterInfo_2(DbSchema dbSchema)
		{
...
", trans);
					...
					var info = new RefCusProfileQuestionPathwayUpdaterInfo_2();
