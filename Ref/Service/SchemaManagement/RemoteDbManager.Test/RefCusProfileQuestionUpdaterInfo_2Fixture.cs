...
namespace CargoWise.RefDbRepo.RemoteDbManager.Test
{
	...
	class RefCusProfileQuestionUpdaterInfo_2Fixture
	{
		[Test]
		public void Mapping()
		{
		...
		public void RefCusProfileQuestionUpdaterInfo_2(DbSchema dbSchema)
		{
...
INSERT INTO RefCusProfileQuestion (XQ2_PK,XQ2_XXX_ProfileType,XQ2_QuestionCode,XQ2_AnswerDataType,XQ2_Name,XQ2_Text,XQ2_Note,XQ2_StartDate,XQ2_EndDate,XQ2_ZZZ_NKDataGrouping)
...
", trans);
					...
					var info = new RefCusProfileQuestionUpdaterInfo_2();
					foreach (var script in info.PrepareTemporaryTablesScripts)
					{
						TestDBHelper.ExecuteNonQuery(conn, script.Value, trans);
					}
					TestDBHelper.ExecuteNonQuery(conn, $@"
INSERT INTO #TempRefCusProfileQuestion (XQ2_PK,XQ2_XXX_ProfileType,XQ2_QuestionCode,XQ2_AnswerDataType,XQ2_Name,XQ2_Text,XQ2_Note,XQ2_StartDate,XQ2_EndDate,XQ2_ZZZ_NKDataGrouping,XQ2_AnswerMaxLength,XQ2_AnswerDecimalPlaces,XQ2_AnswerMask,XQ2_AllowMultipleAnswers,XQ2_IsAnswerMandatory,Deleted)
...
", trans);
					...
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestion WHERE XQ2_QuestionCode = 'Inserted' AND XQ2_ZZZ_NKDataGrouping = 'ZA'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestion WHERE XQ2_QuestionCode = 'Code2' AND XQ2_ZZZ_NKDataGrouping = 'ZA'", trans));
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestion WHERE XQ2_QuestionCode = 'Code3' AND XQ2_ZZZ_NKDataGrouping = 'ZA'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionAnswerList JOIN RefCusProfileQuestion ON XQ4_XQ2_Question = XQ2_PK WHERE XQ2_QuestionCode = 'Code3'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionAttribute JOIN RefCusProfileQuestion ON XQ3_XQ2_Question = XQ2_PK WHERE XQ2_QuestionCode = 'Code3'", trans));
					...
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionLanguage JOIN RefCusProfileQuestion ON XQL_XQ2_Question = XQ2_PK WHERE XQ2_QuestionCode = 'Code3'", trans));

					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionParent = XQ2_PK WHERE XQ2_QuestionCode = 'Code1'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionChild = XQ2_PK WHERE XQ2_QuestionCode = 'Code1'", trans));
					Assert.AreEqual(1, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionParent = XQ2_PK WHERE XQ2_QuestionCode = 'Code2'", trans));
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionChild = XQ2_PK WHERE XQ2_QuestionCode = 'Code2'", trans));
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionParent = XQ2_PK WHERE XQ2_QuestionCode = 'Code3'", trans));
					Assert.AreEqual(0, TestDBHelper.ExecuteScalar(conn, "SELECT COUNT(1) FROM RefCusProfileQuestionPathway JOIN RefCusProfileQuestion ON XQP_XQ2_QuestionChild = XQ2_PK WHERE XQ2_QuestionCode = 'Code3'", trans));
				}
			}
		}
	}
