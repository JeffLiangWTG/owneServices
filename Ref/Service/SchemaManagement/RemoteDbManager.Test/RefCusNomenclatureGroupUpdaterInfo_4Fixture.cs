...
{
	[TestFixture]
	class RefCusNomenclatureGroupUpdaterInfo_4Fixture
	{
		[TestCaseSource(typeof(TransactionedTestCaseAttribute), nameof(TransactionedTestCaseAttribute.RemoteDbTestCases))]
		[TransactionedTestCase]
		public void RefCusNomenclatureGroupUpdaterInfo_4(DbSchema dbSchema)
		{
...
", trans);
					var info = new RefCusNomenclatureGroupUpdaterInfo_4();
