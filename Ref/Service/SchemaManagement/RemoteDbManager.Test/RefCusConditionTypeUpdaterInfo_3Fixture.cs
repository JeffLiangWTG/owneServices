...
('99DD2453-AA65-44FC-AA93-90077980F5DB', 'CLASS', 'CCC', 'Test3', 'ZA')
...
VALUES(NEWID(), 'WW', 'A', 'A','C2CD44CA-A4D1-45B2-A3F6-5769FB817A45')", trans);
					var info = new RefCusConditionTypeUpdaterInfo_3();
