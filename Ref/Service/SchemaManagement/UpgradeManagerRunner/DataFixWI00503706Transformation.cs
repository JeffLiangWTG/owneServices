...
{
	public class DataFixWI00503706Transformation : DataTransformation, IDataTransformationTask
	{
		public DataFixWI00503706Transformation(int version) : base(version)
		{
		}
