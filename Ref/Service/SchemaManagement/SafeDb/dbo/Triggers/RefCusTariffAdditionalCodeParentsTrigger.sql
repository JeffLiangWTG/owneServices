CREATE TRIGGER [dbo].[RefCusTariffAdditionalCode_INS_UPD_Parents] ON [dbo].[RefCusTariffAdditionalCode]
FOR INSERT, UPDATE
AS
BEGIN
	...
	BEGIN
		...
		THROW 501092025, 'A RefCusTariffAdditionalCode was inserted/updated with invalid values in ZY2_ParentAdditionalCode or ZY2_ZY3_NKParentCategory which are not found in RefCusTariffAdditionalCode.ZY2_ZZ1_Tariff or RefCusTariffAdditionalCode.ZY2_ZZW_NationalCode having matched ZY2_AdditionalCode and ZY2_ZY3_NKCategory.', 1;
	END
END
