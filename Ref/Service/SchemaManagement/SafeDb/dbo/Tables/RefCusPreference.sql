CREATE TABLE RefCusPreference(
	...
	[ZZS_SysStartTime] DATETIME2 GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF_ZZS_SysStartTime] DEFAULT CONVERT(DATETIME2, '1900-01-01 0:0:0.0000000'),
	[ZZS_SysEndTime] DATETIME2 GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF_ZZS_SysEndTime] DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
	PERIOD FOR SYSTEM_TIME ([ZZS_SysStartTime], [ZZS_SysEndTime]),
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.RefCusPreferenceHistory))
GO
...
GO
ALTER TABLE RefCusPreference SET (LOCK_ESCALATION = DISABLE);
