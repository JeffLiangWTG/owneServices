...
(
	...
	[ZGF_SysStartTime] DATETIME2 GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF_ZGF_SysStartTime] DEFAULT CONVERT(DATETIME2, SYSUTCDATETIME()),
	[ZGF_SysEndTime] DATETIME2 GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF_ZGF_SysEndTime] DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
	PERIOD FOR SYSTEM_TIME ([ZGF_SysStartTime], [ZGF_SysEndTime]),
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.RefGlbReleaseNoteHistory))
GO
...
GO
ALTER TABLE [dbo].[RefGlbReleaseNote] SET (LOCK_ESCALATION = DISABLE);
