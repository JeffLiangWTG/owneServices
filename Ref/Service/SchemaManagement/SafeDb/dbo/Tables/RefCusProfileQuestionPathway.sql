...
(
	...
	XQP_SysStartTime DATETIME2 GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT DF_XQP_SysStartTime DEFAULT SYSUTCDATETIME(),
	XQP_SysEndTime DATETIME2 GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT DF_XQP_SysEndTime DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
	PERIOD FOR SYSTEM_TIME (XQP_SysStartTime, XQP_SysEndTime),
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.RefCusProfileQuestionPathwayHistory))
GO
