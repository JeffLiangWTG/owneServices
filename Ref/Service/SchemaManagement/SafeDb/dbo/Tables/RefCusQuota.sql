CREATE TABLE RefCusQuota(
	...
	[ZXQ_SysStartTime] DATETIME2 GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF_ZXQ_SysStartTime] DEFAULT CONVERT(DATETIME2, '1900-01-01 0:0:0.0000000'),
	[ZXQ_SysEndTime] DATETIME2 GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF_ZXQ_SysEndTime] DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
	PERIOD FOR SYSTEM_TIME ([ZXQ_SysStartTime], [ZXQ_SysEndTime]),
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.RefCusQuotaHistory))
GO
...
GO
ALTER TABLE RefCusQuota SET (LOCK_ESCALATION = DISABLE);
