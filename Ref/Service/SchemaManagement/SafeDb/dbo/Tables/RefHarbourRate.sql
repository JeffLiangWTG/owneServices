CREATE TABLE RefHarbourRate(
	...
	[ZXF_SysStartTime] DATETIME2 GENERATED ALWAYS AS ROW START NOT NULL CONSTRAINT [DF_ZXF_SysStartTime] DEFAULT CONVERT(DATETIME2, '1900-01-01 0:0:0.0000000'),
	[ZXF_SysEndTime] DATETIME2 GENERATED ALWAYS AS ROW END NOT NULL CONSTRAINT [DF_ZXF_SysEndTime] DEFAULT CONVERT(DATETIME2, '9999-12-31 23:59:59.9999999'),
	PERIOD FOR SYSTEM_TIME ([ZXF_SysStartTime], [ZXF_SysEndTime]), 
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE = dbo.RefHarbourRateHistory))
GO
...
GO
ALTER TABLE RefHarbourRate SET (LOCK_ESCALATION = DISABLE);
