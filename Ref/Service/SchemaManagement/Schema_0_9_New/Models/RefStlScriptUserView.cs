...
[Keyless]
public partial class RefStlScriptUserView
{
    ...
    public DateTime STL_SysStartTime { get; set; }

    public DateTime STL_SysEndTime { get; set; }

    public bool? STL_IsSystem { get; set; }

    public bool STL_IsPublished { get; set; }
}
