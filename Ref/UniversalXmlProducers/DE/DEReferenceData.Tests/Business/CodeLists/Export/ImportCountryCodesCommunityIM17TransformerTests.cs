...
{
	sealed class ImportCountryCodesCommunityIM17TransformerTests : CodeListsXMLTests<RefCusCodeList, IKeyValues>,
		...
		ITestInvalidDateErrorMessage
	{
		...
		protected override string CodeType => nameof(CodeListsConstants.Generic.CodeTypes.IM17_DESTINATION_COUNTRY_LIST);
		...
		protected override Func<string[], CodeListsParserXML<RefCusCodeList, IKeyValues>> ParserToRun => (downLoadLinks) => new ImportCountryCodesCommunityIM17Transformer(downLoadLinks);
