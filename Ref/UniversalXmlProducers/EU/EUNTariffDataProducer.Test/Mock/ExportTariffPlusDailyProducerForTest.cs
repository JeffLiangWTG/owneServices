...
{
	sealed class ExportTariffPlusDailyProducerForTest : ExportTariffPlusDailyProducer
	{
		public ExportTariffPlusDailyProducerForTest(DateTime publishTime,
		...
		public override bool DownloadFiles(IEnumerable<IWebFileInfo> webFileInfos)
		{
			...
			{
				var dutiesImportPath = TestHelper.CopyToDownloadPath(dataTestProvider.DutiesExportFile.Path, "Duties Export.xlsx", dataTestProvider.DutiesExportFile.PublicationDate);
				result.Add(new WebFileInfo("Duties Export.xlsx", dutiesImportPath, dataTestProvider.DutiesExportFile.PublicationDate));
