...
{
	public class TaxOfficeParser : BaseEntityConfigurationParser
	{
		public TaxOfficeParser(string configFilePath, string dataFilePath)
		...
		protected override void ExportToXmlFilesCore(string outputFilePath, DateTime publicationDate, EntityConfiguration configuration, IWorkbook workbook, string suffix)
		{
			...
			Helper.ExportToXMLFile(Constants.DataSources.TaxOffice, outputFilePath, writerConfiguration, publicationDate, refCusCodeList);
		}
	}
}
