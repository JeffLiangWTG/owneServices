...
{
	public class ForwarderIDsParser : BaseEntityConfigurationParser
	{
		public ForwarderIDsParser(string configFilePath, string dataFilePath)
		...
		protected override void ExportToXmlFilesCore(string outputFilePath, DateTime publicationDate, EntityConfiguration configuration, IWorkbook workbook, string suffix)
		{
			...
			Helper.ExportToXMLFile(Constants.DataSources.ForwarderIDs, outputFilePath, writerConfiguration, publicationDate, refCusCodeList);
		}
	}
}
