...
{
	public class CustomsDepartmentParser : BaseEntityConfigurationParser
	{
		public CustomsDepartmentParser(string configFilePath, string dataFilePath)
		...
		protected override void ExportToXmlFilesCore(string outputFilePath, DateTime publicationDate, EntityConfiguration configuration, IWorkbook workbook, string suffix)
		{
			...
			Helper.ExportToXMLFile(Constants.DataSources.CustomsDepartment, outputFilePath, writerConfiguration, publicationDate, refCusCodeList);
		}
	}
}
