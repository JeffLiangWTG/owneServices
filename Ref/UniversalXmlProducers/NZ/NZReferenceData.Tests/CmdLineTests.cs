...
namespace CargoWise.RefDbRepo.NZReferenceData.Tests.CmdLine
{
	[TestFixture]
	class CmdLineTests
	{
		...
		internal static void AssertArgumentError(string parameters, string expectedErrorMessage)
		{
			...
			var processStartInfo = new ProcessStartInfo(Path.Combine(binPath, "CargoWise.RefDbRepo.NZReferenceData.CmdLine.exe"), parameters)
			{
