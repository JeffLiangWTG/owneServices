...
{
	public class AHCONCodeListGenerator : XmlDrivenCodeListDataFileGenerator
	{
		protected override IEnumerable<string> InputFileNames
		{
			get
			{
				yield return ApplicationConfig.Instance.DeltaIELegalConditionsListForAdhocAuthorisationsCodesFileName;
			}
		}
		...
		protected override RefCusCodeTypeGenerator CodeTypeGenerator => new AHCONCodeTypeGenerator();
