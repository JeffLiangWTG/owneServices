...
{
	public class CL740CodeListGenerator : XmlDrivenCodeListDataFileGenerator
	{
		protected override IEnumerable<string> InputFileNames
		{
			get
			{
				yield return ApplicationConfig.Instance.DeltaIEImportRiskAreaCodeTypeCodesFileName;
			}
		}
		...
		protected override string CodeType => "CL740";
