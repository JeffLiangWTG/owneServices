...
{
	public class CL047CodeListGenerator : XmlDrivenCodeListDataFileGenerator
	{
		protected override IEnumerable<string> InputFileNames
		{
			get
			{
				yield return ApplicationConfig.Instance.DeltaIEImportTypeOfDiscrepanciesTypeCodesFileName;
			}
		}
		...
		protected override string CodeType => "CL047";
