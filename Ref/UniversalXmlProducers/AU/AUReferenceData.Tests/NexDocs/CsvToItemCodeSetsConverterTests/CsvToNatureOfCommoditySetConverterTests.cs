...
{
	class CsvToNatureOfCommoditySetConverterTests : CsvToItemCodeSetsConverterTests<CsvToNatureOfCommoditySetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToNatureOfCommoditySetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToNatureOfCommoditySetConverter();
			result.Code = "T1";
