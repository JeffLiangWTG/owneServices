...
{
	class CsvToPermitTypeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToPermitTypeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToPermitTypeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToPermitTypeSetConverter();
			result.Code = "T1";
