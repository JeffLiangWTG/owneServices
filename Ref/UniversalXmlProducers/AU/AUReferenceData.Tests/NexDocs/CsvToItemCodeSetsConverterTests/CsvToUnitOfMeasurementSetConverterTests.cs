...
{
	class CsvToUnitOfMeasurementSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToUnitOfMeasurementSetConverter>
	{
		protected override string ExpectedResult => @"CODE|string|T1
DESCRIPTION|string|T1 DESC
SYMBOL_CODE|string|SYM
SYSTEM_CODE|string|SYS
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToUnitOfMeasurementSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToUnitOfMeasurementSetConverter();
			result.Code = "T1";
			result.Description = "T1 DESC";
			result.SymbolCode = "SYM";
			result.SystemCode = "SYS";
