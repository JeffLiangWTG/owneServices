...
{
	class CsvToPackTypeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToPackTypeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToPackTypeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToPackTypeSetConverter();
			result.Code = "T1";
