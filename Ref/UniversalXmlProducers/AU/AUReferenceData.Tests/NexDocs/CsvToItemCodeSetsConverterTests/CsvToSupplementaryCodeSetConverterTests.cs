...
{
	class CsvToSupplementaryCodeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToSupplementaryCodeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToSupplementaryCodeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToSupplementaryCodeSetConverter();
			result.Code = "T1";
