...
{
	class CsvToCommodityTypeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToCommodityTypeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToCommodityTypeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToCommodityTypeSetConverter();
			result.Code = "T1";
