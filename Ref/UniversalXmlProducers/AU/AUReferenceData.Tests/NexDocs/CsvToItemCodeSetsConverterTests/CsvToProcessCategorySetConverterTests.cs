...
{
	class CsvToProcessCategorySetConverterTests : CsvToItemCodeSetsConverterTests<CsvToProcessCategorySetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToProcessCategorySetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToProcessCategorySetConverter();
			result.Code = "T1";
