...
{
	class CsvToPreservationTypeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToPreservationTypeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToPreservationTypeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToPreservationTypeSetConverter();
			result.Code = "T1";
