...
{
	class CsvToDocumentTypeSetConverterTests : CsvToItemCodeSetsConverterTests<CsvToDocumentTypeSetConverter>
	{
...
UPDATED_DATE|dateTime|2019-11-13T00:00:00.000";
		...
		protected override CsvToDocumentTypeSetConverter GetFullyPopulatedConverter()
		{
			var result = new CsvToDocumentTypeSetConverter();
			result.Code = "T1";
