...
{
	public class CsvToUnitOfMeasurementSetConverter : CsvToItemCodeSetsConverter
	{
		...
		[CodeSetName("SYMBOL_CODE", CodeSetValueType.@string)]
		public string SymbolCode { get; set; }

		[CodeSetName("SYSTEM_CODE", CodeSetValueType.@string)]
