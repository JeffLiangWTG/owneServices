...
{
	public class RefCusCodeListWithAttributeExportMapper : SimpleRefCusCodeListMapper
	{
		protected override RefCusCodeListAttribute[] GetRefCusCodeListAttributes()
		{
			return new[] { new RefCusCodeListAttribute { ZZE_Value = RefDataConstants.Export, ZZE_ZXE_NKName = RefDataConstants.Direction } };
		}
