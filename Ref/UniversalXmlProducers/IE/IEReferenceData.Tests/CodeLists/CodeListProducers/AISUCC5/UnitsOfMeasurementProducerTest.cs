...
using CargoWise.RefDbRepo.IEReferenceData.CodeLists.Services.AISUCC5.Tests;
...
namespace CargoWise.RefDbRepo.IEReferenceData.CodeLists.AISUCC5.Tests
{
	class UnitsOfMeasurementProducerTest : RevenueCodeListProducerAbstractTest
	{
		...
		protected override string ExpectedTestFileName => "AISUCC5.Expected_UnitsOfMeasurement";
