...
{
	class CombinedCodeListProducerTest : RevenueCodeListProducerAbstractTest
	{
		protected override string ExpectedTestFileName => "Expected_CombinedCodeList";
		protected override IRevenueCodeListDetails GetCodeListDetails() => new AdditionalReference();
		protected override IRevenueCodeListDetails GetCombinedCodeListDetails() => new AdditionalReferenceNational();
	}
}
