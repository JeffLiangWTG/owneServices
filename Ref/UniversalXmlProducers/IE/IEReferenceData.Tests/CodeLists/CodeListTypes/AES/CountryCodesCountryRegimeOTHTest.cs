...
{
	class CountryCodesCountryRegimeOTHTest : CodeLists.Tests.RevenueCodeListDetailsTest
	{
		...
		protected override string ExpectedCode => "CL140";
		protected override string ExpectedNameInFile => "CL140";
		...
		protected override IRevenueCodeListDetails GetCodeListDetails() => new CountryCodesCountryRegimeOTH();
	}
}
