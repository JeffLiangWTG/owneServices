-- Create new rule for 410.03.01.02/23
...
VALUES (@ZZ1_PK, '410030102', (select ZZI_PK FROM RefCusTariffType where ZZI_ZZZ_NKDataGrouping = 'ZA' AND ZZI_TariffType = '4P1'), 'ZA', 0)

INSERT INTO dbo.RefCusTariffAttributeRule([ZZ3_PK], [ZZ3_ZZ1_Tariff], [ZZ3_Name], [ZZ3_Value])
VALUES (NEWID(), @ZZ1_PK, 'CheckDigit', '23')
...
VALUES (NEWID(), @ZZ1_PK, '1P1+12A+12B+13A+13B+13C+13D+15A+15B', '', 'ZA', '(R4050) FULL DUTY EXCLUDING 13E')
