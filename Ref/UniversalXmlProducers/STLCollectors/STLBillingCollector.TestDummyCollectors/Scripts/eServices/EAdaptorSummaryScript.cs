namespace CargoWise.RefDbRepo.STLBillingCollector.TestDummyCollectors.eServices
{
...
(
	...
	WHERE EM_ReceiveTransmit In('RCV','TRX') AND EM_ApplicationCode In ('UDQ', 'NDQ', 'UDM', 'NDM', 'XMS') AND EM_SystemCreateTimeUtc >= {Constants.StartDateTimeInclusiveParamName} AND EM_SystemCreateTimeUtc < {Constants.EndDateTimeExclusiveParamName}
