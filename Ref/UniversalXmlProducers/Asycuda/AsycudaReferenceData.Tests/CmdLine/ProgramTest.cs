...
namespace CargoWise.RefDbRepo.AsycudaReferenceData.Tests;
...
sealed class ProgramTest
{
	...
	internal static void AssertArgumentError(string parameters, string expectedErrorMessage)
	{
		...
		var processStartInfo = new ProcessStartInfo(Path.Combine(binPath, "CargoWise.RefDbRepo.AsycudaReferenceData.CmdLine"), parameters)
		{
