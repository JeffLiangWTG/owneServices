...
{
	[TestFixture]
	public class ComplianceAlertListParserTestFixture
	{
		string ExportFilePath => GetTestFilePath("ComplianceCommodityAlertListParserTestOutput.xml");

		[Test]
		public void ComplianceCommodityAlertListParserTest()
		{
			var publicationDate = new DateTime(2025, 1, 1);
			var expectedFilePath = GetTestFilePath("ComplianceAlertListParserTestExpected.xml");

			var parser = new ComplianceCommodityAlertListParser(TestSourceList(), ExportFilePath, publicationDate);
			parser.ExportXml();
		...
		public static List<ComplianceCountryAlertDetailsResponseModel> TestSourceList()
		{
			var sourceList = new List<ComplianceCountryAlertDetailsResponseModel>();
			sourceList.Add(new ComplianceCountryAlertDetailsResponseModel
			{
				CountryCode = "CA",
