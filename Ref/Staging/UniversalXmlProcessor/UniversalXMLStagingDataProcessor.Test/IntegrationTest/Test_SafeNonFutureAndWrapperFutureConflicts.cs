...
{
	class Test_SafeNonFutureAndWrapperFutureConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test SafeDb has one non-future records that conflicts with XML contains one future record";
