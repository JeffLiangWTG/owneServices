...
{
	class Test_SafeFutureAndWrapperFutureConflicts_TopLevel : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test both SafeDb and XML contains one future record and future records are conflicting (top level)";
