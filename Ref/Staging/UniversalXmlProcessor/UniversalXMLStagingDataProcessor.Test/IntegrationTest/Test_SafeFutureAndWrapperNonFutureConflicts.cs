...
{
	class Test_SafeFutureAndWrapperNonFutureConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test SafeDb contains one future record, wrapper record not future but conflicts with future record in SafeDb";
