...
{
	class Test_Deletion_Rate_App_ExcludeTradeGroup : IXmlProcessIntegrationTest
	{
		public string[] FileNames => ["TestFiles\\Test_Deletion1_Rate_App_ExcludeTradeGroup.xml", "TestFiles\\Test_Deletion2_Rate_App_ExcludeTradeGroup.xml"];
		...
		public string TestDescription => "Test Deletion on RefCusRate, RefCusApplicability and RefCusExcludeTradeGroup";
