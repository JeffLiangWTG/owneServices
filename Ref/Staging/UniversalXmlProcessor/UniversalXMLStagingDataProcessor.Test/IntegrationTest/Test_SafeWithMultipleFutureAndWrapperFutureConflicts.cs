...
{
	class Test_SafeWithMultipleFutureAndWrapperFutureConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test both SafeDb and XML contains future record and wrapper future record conflict with multiple Safe future record";
