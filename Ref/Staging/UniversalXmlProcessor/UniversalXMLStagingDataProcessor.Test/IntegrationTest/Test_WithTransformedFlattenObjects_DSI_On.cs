...
{
	class Test_WithTransformedFlattenObjects_DSI_On : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test RefCusRate/RefCusApplicability auto expiration with NonPersistentObjectTransformer feature";
...
values(newid(), 'IntegrationTest',1)
";
...
";
		...
		void AssertResult_SafeDb_RefCusRate_AfterProcessingXml2(Safe.RefCusTariff[] tariffs, IDbCommand safeCommand)
		{
			...
			Assert.That(rateRelatedTariff_22031.ZZ2_EndDate.Date, Is.EqualTo(new DateTime(2022, 3, 18, 0, 0, 0)));
		}
		...
		void AssertResult_SafeDb_RefCusApplicability_AfterProcessingXml2(Safe.RefCusTariff[] tariffs, IDbCommand safeCommand)
		{
			...
			Assert.That(appRelatedTariff22031.ZZT_EndDate.Date, Is.EqualTo(new DateTime(2022, 3, 18, 0, 0, 0)));
		}
	}
}
