...
{
	class Test_SafeFutureAndWrapperFutureIdentical : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test both SafeDb and XML contains the same future record will neither delete nor recreate records";
