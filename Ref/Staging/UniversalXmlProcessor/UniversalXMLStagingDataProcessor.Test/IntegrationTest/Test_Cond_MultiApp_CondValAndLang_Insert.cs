...
{
	class Test_Cond_MultiApp_CondValAndLang_Insert : IXmlProcessIntegrationTest
	{
		public string[] FileNames => ["TestFiles\\Test_Cond_MultiApp_CondValAndLang.xml"];

		public XmlProcessIntegrationTestAssertResultHandler[] AssertResults => [AssertResult_AfterProcessingXml1];

		public string TestDescription => "Test Condition with multi Applicabilities, with ConditionValue/ConditionLang could be inserted";
