...
{
	class Test_WithAutoExpire_SafeWithMultipleFutureAndWrapperFutureConflicts : IXmlProcessIntegrationTest
	{
		public string[] FileNames => new string[] { "TestFiles\\Test_SafeWithMultipleFutureAndWrapperFutureConflicts_1.xml", "TestFiles\\Test_SafeWithMultipleFutureAndWrapperFutureConflicts_2.xml" };
		...
		public string TestDescription => "Test both SafeDb and XML contains future record and wrapper future record conflict with multiple Safe future record with auto expiration on";
