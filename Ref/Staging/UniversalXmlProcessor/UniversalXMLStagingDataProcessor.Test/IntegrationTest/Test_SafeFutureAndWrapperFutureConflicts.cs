...
{
	class Test_SafeFutureAndWrapperFutureConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test both SafeDb and XML contains one future record and future records are conflicting";
