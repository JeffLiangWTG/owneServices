...
{
	class Test_RateUOM_1_1_AutoExpiration : IXmlProcessIntegrationTest
	{
		public string[] FileNames => ["TestFiles\\Test_Rate_App_WithMultiUOM1.xml", "TestFiles\\Test_Rate_App_WithMultiUOM2.xml"];
		...
		public string TestDescription => "Test consilidating RefCusRate(single, haschange)/RefCusApplicability with a single new UOM when auto expiration is on";
