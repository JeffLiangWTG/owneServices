...
{
	class Test_Deletion_Rate_App_DataIsFalse_UOM : IXmlProcessIntegrationTest
	{
		public string[] FileNames => ["TestFiles\\Test_Deletion1_Rate_App_UOM.xml", "TestFiles\\Test_Deletion2_Rate_App_DataIsFalse_UOM.xml"];
		...
		public string TestDescription => "Test Deletion on RefCusRateUOM when RefCusRate and RefCusApplicability IsData=False";
