...
{
	class Test_SafeFutureAndWrapperNonFutureNotConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test SafeDb contains one future record, wrapper record not future and does not conflict with future record in SafeDb";
