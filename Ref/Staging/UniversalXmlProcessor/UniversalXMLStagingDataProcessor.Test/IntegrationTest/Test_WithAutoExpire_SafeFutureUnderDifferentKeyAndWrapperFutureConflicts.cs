...
{
	class Test_WithAutoExpire_SafeFutureUnderDifferentKeyAndWrapperFutureConflicts : IXmlProcessIntegrationTest
	{
		...
		public string TestDescription => "Test both SafeDb and XML contains one future record and besides one mentioned, Safe has another future records but under different key with auto expiration on";
