...
INSERT INTO RefUNLOCO (RL_PK,RL_Code,RL_GeoLocation) VALUES (NEWID(), 'XXXX1', CONVERT(geography, 'POINT (14.3 29.1)'))
INSERT INTO RefUNLOCO (RL_PK,RL_Code,RL_GeoLocation) VALUES (NEWID(), 'XXXX ', CONVERT(geography, 'POINT (12.3 29.1)'))";
				cmd.Transaction = Transaction;
				cmd.ExecuteNonQuery();
			}
		}
