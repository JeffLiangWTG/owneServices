...
module.exports = merge(common, {
	output: {
		publicPath: "/PortalEta/",
	},
	mode: "production",
	plugins: [
		new webpack.DefinePlugin({
			__SafeAPI__: JSON.stringify("//***updateService***/UpdateEta/odata/"),
			__StagingAPI__: JSON.stringify("//***updateService***/StagingEta/odata/"),
			BASENAME: JSON.stringify("/PortalEta"),
			...
			__RedirectUri__: JSON.stringify(
				"https://***updateService***/PortalEta/authenCallback"
			),
			__PostLogoutRedirectUri__: JSON.stringify("/PortalEta"),
			...
			__DeliveryServiceHealthCheckURL__: JSON.stringify(
				"//***deliveryService***/ServiceEta/wtg/status"
			),
			__UpdateServiceHealthCheckURL__: JSON.stringify(
				"//***updateService***/UpdateEta/wtg/status"
			),
			__QuartzHealthCheckURL__: JSON.stringify(
				"//***updateService***/QuartzEta/quartz/wtg/health"
			),
		}),
	],
});
