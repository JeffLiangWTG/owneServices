...
module.exports = merge(common, {
	...
	plugins: [
		new webpack.DefinePlugin({
			__SafeAPI__: JSON.stringify("//***updateService***/Update/odata/"),
			__StagingAPI__: JSON.stringify("//***updateService***/Staging/odata/"),
