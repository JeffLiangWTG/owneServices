...
module.exports = merge(common, {
	output: {
		publicPath: "/PortalDelta/",
	},
	mode: "production",
	plugins: [
		new webpack.DefinePlugin({
			__SafeAPI__: JSON.stringify("//***updateService***/UpdateDelta/odata/"),
			__StagingAPI__: JSON.stringify(
				"//***updateService***/StagingDelta/odata/"
			),
			BASENAME: JSON.stringify("/PortalDelta"),
			...
			__RedirectUri__: JSON.stringify(
				"https://***updateService***/PortalDelta/authenCallback"
			),
			__PostLogoutRedirectUri__: JSON.stringify("/PortalDelta"),
			...
			__DeliveryServiceHealthCheckURL__: JSON.stringify(
				"//***deliveryService***/ServiceDelta/wtg/status"
			),
			__UpdateServiceHealthCheckURL__: JSON.stringify(
				"//***updateService***/UpdateDelta/wtg/status"
			),
			__QuartzHealthCheckURL__: JSON.stringify(
				"//***updateService***/QuartzDelta/quartz/wtg/health"
			),
		}),
	],
});
