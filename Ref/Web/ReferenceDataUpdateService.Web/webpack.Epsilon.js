...
module.exports = merge(common, {
	output: {
		publicPath: "/PortalEpsilon/",
	},
	mode: "production",
	plugins: [
		new webpack.DefinePlugin({
			__SafeAPI__: JSON.stringify("//***updateService***/UpdateEpsilon/odata/"),
			__StagingAPI__: JSON.stringify(
				"//***updateService***/StagingEpsilon/odata/"
			),
			BASENAME: JSON.stringify("/PortalEpsilon"),
			...
			__RedirectUri__: JSON.stringify(
				"https://***updateService***/PortalEpsilon/authenCallback"
			),
			__PostLogoutRedirectUri__: JSON.stringify("/PortalEpsilon"),
			...
			__DeliveryServiceHealthCheckURL__: JSON.stringify(
				"//***deliveryService***/ServiceEpsilon/wtg/status"
			),
			__UpdateServiceHealthCheckURL__: JSON.stringify(
				"//***updateService***/UpdateEpsilon/wtg/status"
			),
			__QuartzHealthCheckURL__: JSON.stringify(
				"//***updateService***/QuartzEpsilon/quartz/wtg/health"
			),
		}),
	],
});
